    ...
    private static synchronized void getPhoneType() {
        synchronized (AssistManager.class) {
            try {
                ...
                ALog.e(TAG, "getPhoneType()", th, new Object[0]);
            }
        }
        return;
    }
        ...
        if (assistCallback != null) {
            ...
            if (!UtilityImpl.isMainProcess(context)) {
                ...
                ThreadPoolExecutorFactory.execute(new Runnable() {
                    /* class org.android.agoo.assist.AssistManager.AnonymousClass1 */
                        ...
                        try {
                            ...
                            if (!OrangeUtil.isAssistEnabled()) {
                                ...
                                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                                    /* class org.android.agoo.assist.AssistManager.AnonymousClass1.AnonymousClass1 */
