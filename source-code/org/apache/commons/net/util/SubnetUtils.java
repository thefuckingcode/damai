...
public class SubnetUtils {
    ...
    private void calculate(String str) {
        ...
        throw new IllegalArgumentException("Could not parse [" + str + jl1.ARRAY_END_STR);
    }
    ...
    private int rangeCheck(int i, int i2, int i3) {
        ...
        throw new IllegalArgumentException("Value [" + i + "] not in range (" + i2 + "," + i3 + jl1.ARRAY_END_STR);
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private String toCidrNotation(String str, String str2) {
