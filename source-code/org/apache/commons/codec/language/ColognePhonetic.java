...
public class ColognePhonetic implements StringEncoder {
    private static final char[] AEIJOUY = {YKUpsConvert.CHAR_A, u91.LEVEL_E, u91.LEVEL_I, 'J', 'O', 'U', 'Y'};
    private static final char[] AHKLOQRUX = {YKUpsConvert.CHAR_A, 'H', 'K', u91.LEVEL_L, 'O', 'Q', 'R', 'U', 'X'};
    ...
    private static final char[] TDX = {'T', u91.LEVEL_D, 'X'};
    private static final char[] WFPV = {u91.LEVEL_W, YKUpsConvert.CHAR_F, 'P', u91.LEVEL_V};
