...
public class FastDatePrinter implements Serializable, DatePrinter {
    ...
    public static class Iso8601_Rule implements Rule {
        ...
        public void appendTo(Appendable appendable, Calendar calendar) throws IOException {
            ...
            if (i3 >= 5) {
                if (i3 == 6) {
                    appendable.append(jl1.CONDITION_IF_MIDDLE);
                }
    ...
    public List<Rule> parsePattern() {
        ...
        while (i3 < length) {
            ...
            if (length2 == 2) {
                ...
                weekYear = selectNumberRule(i, length2);
            }
            if (charAt == 'Y') {
    ...
    public String toString() {
        return "FastDatePrinter[" + this.mPattern + "," + this.mLocale + "," + this.mTimeZone.getID() + jl1.ARRAY_END_STR;
    }
