...
public class MultilineRecursiveToStringStyle extends RecursiveToStringStyle {
    ...
    private void resetIndent() {
        setArrayStart(jl1.BLOCK_START_STR + System.lineSeparator() + ((Object) spacer(this.spaces)));
        ...
        setContentStart(jl1.ARRAY_START_STR + System.lineSeparator() + ((Object) spacer(this.spaces)));
        setFieldSeparator("," + System.lineSeparator() + ((Object) spacer(this.spaces)));
        setContentEnd(System.lineSeparator() + ((Object) spacer(this.spaces + -2)) + jl1.ARRAY_END_STR);
    }
