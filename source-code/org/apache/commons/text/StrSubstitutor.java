                    ...
                    if (i11 >= i6) {
                        ...
                        if (isMatch2 == 0) {
                            ...
                            if (valueDelimiterMatcher2 != null) {
                                ...
                                int i14 = 0;
                                while (true) {
                                    if (i14 >= charArray.length || (!isEnableSubstitutionInVariables && variablePrefixMatcher.isMatch(charArray, i14, i14, charArray.length) != 0)) {
                                        break;
                                    } else if (valueDelimiterMatcher2.isMatch(charArray, i14) != 0) {
                                        int isMatch3 = valueDelimiterMatcher2.isMatch(charArray, i14);
