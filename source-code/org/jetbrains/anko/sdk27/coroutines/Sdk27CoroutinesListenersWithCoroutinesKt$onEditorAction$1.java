...
public final class Sdk27CoroutinesListenersWithCoroutinesKt$onEditorAction$1 implements TextView.OnEditorActionListener {
    ...
    static final class AnonymousClass1 extends CoroutineImpl implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            ...
            AnonymousClass1 r0 = new AnonymousClass1(this.this$0, textView, i, keyEvent, continuation);
            r0.p$ = coroutineScope;
            return r0;
        }
    ...
    public final boolean onEditorAction(final TextView textView, final int i, final KeyEvent keyEvent) {
