...
public final class MemoryMetric$AndroidMemoryStats extends ExtendableMessageNano<MemoryMetric$AndroidMemoryStats> implements Cloneable {
    ...
    public final int computeSerializedSize() {
        int computeSerializedSize = MemoryMetric$AndroidMemoryStats.super.computeSerializedSize();
        ...
        while (true) {
            ...
            switch (readTag) {
                ...
                case AliMediaPlayer.UPLAYER_PROPERTY_TYPE_PATTAYA_MAX_GEAR_KEEP:
                    ...
                    break;
                default:
                    if (MemoryMetric$AndroidMemoryStats.super.storeUnknownField(codedInputByteBufferNano, readTag)) {
                        break;
                    } else {
                        return this;
                    }
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        MemoryMetric$AndroidMemoryStats.super.writeTo(codedOutputByteBufferNano);
    }

    @Override // java.lang.Object
    public final MemoryMetric$AndroidMemoryStats clone() {
        try {
