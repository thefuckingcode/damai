...
public class DMViewHolderHelper implements View.OnClickListener, View.OnLongClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public View getConvertView() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1494920694")) {
            return this.mConvertView;
        }
        return (View) ipChange.ipc$dispatch("1494920694", new Object[]{this});
    }

    public ImageView getImageView(@IdRes int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-573095239")) {
            return (ImageView) getView(i);
        }
        return (ImageView) ipChange.ipc$dispatch("-573095239", new Object[]{this, Integer.valueOf(i)});
    }

    public Object getObj() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-733925251")) {
            return this.mObj;
        }
        return ipChange.ipc$dispatch("-733925251", new Object[]{this});
    }
    ...
    public DMRecyclerViewHolder getRecyclerViewHolder() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "137132997")) {
            return this.mRecyclerViewHolder;
        }
        return (DMRecyclerViewHolder) ipChange.ipc$dispatch("137132997", new Object[]{this});
    }

    public TextView getTextView(@IdRes int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1735637749")) {
            return (TextView) getView(i);
        }
        return (TextView) ipChange.ipc$dispatch("-1735637749", new Object[]{this, Integer.valueOf(i)});
    }

    public <T extends View> T getView(@IdRes int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1822698868")) {
            return (T) ((View) ipChange.ipc$dispatch("-1822698868", new Object[]{this, Integer.valueOf(i)}));
        }
