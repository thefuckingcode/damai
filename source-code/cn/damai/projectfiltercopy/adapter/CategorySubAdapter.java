...
public class CategorySubAdapter extends RecyclerView.Adapter<SubVh> implements View.OnClickListener {
    ...
    public SubVh onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-930806316")) {
            return new SubVh(LayoutInflater.from(this.b).inflate(R$layout.copy_item_filter_category_new_sub, viewGroup, false));
        }
        return (SubVh) ipChange.ipc$dispatch("-930806316", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
