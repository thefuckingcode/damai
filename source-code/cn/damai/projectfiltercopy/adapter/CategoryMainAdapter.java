...
public class CategoryMainAdapter extends RecyclerView.Adapter<MainVH> implements View.OnClickListener {
    ...
    public class MainVH extends RecyclerView.ViewHolder {
        ...
        public void a(CategoryLevelOne categoryLevelOne) {
            ...
            if (TextUtils.isEmpty(categoryLevelOne.tag)) {
                ...
                if (wf2.INSTANCE.b(categoryLevelOne.tag)) {
                    this.b.setPadding(0, 0, 0, 0);
                } else {
                    int a2 = l42.a(AppInfoProviderProxy.getApplication(), 4.0f);
    ...
    public MainVH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1388379555")) {
            return new MainVH(LayoutInflater.from(this.b).inflate(R$layout.copy_item_filter_category_new_main, viewGroup, false));
        }
        return (MainVH) ipChange.ipc$dispatch("-1388379555", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
