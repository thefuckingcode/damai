...
public class CouponFragment extends DamaiBaseMvpFragment<CouponsListPresenter, CouponsListContract.Model> implements CouponsListContract.View, OnRefreshListener, OnLoadMoreListener {
    ...
    private boolean isPageFinish() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-479049879")) {
            return getActivity() == null || getActivity().isFinishing() || isDetached();
        }
        return ((Boolean) ipChange.ipc$dispatch("-479049879", new Object[]{this})).booleanValue();
    }
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-530673762")) {
            return R$layout.fragment_user_coupons;
        }
        return ((Integer) ipChange.ipc$dispatch("-530673762", new Object[]{this})).intValue();
    }
    ...
    public void refreshRequestCouponsList() {
        ...
        showLoading("");
        this.mPageIndex = 1;
        ((CouponsListPresenter) this.mPresenter).loadCouponsList(d20.E(), this.mCouponModel, true, this.mPageIndex, 10);
    }
    ...
    public void returnLoadCouponsList(CouponData.DiscountContainer discountContainer) {
        ...
        if (!isPageFinish() && discountContainer != null) {
            if (this.mPageIndex == 1) {
                if (xf2.e(discountContainer.coupons) == 0) {
                    showEmptyView();
                    return;
                } else {
            ...
            int e = xf2.e(discountContainer.coupons);
            if (e <= 0) {
                return;
            }
            if (e < 10) {
