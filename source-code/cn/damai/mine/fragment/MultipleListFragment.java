...
public class MultipleListFragment extends BaseFuncFragment implements UpLoadMorePanel.LoadMoreEventListener {
    ...
    public class b extends u3 {
        ...
        public void utNoteClick(NoteBean noteBean, int i) {
            ...
            cn.damai.common.user.c.e().x(ig1.m().o(i));
        }
    }
    ...
    public class c implements MultiAdapter.Exposure {
        ...
        public void exposureNote(View view, NoteBean noteBean, int i) {
            ...
            ig1.i(view, MultipleListFragment.this.mType.tabIndex, MultipleListFragment.this.mType.tabName, noteBean.id, i);
        }
        ...
        public void exposureProject(View view, ProjectItemBean projectItemBean, int i) {
            ...
            ig1.i(view, MultipleListFragment.this.mType.tabIndex, MultipleListFragment.this.mType.tabName, projectItemBean.id, i);
        }
    ...
    private void addItemDecorationIfNeed(DamaiRootRecyclerView damaiRootRecyclerView) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1371540006")) {
            ...
            damaiRootRecyclerView.addItemDecoration(new RecyclerView.ItemDecoration() {
                /* class cn.damai.mine.fragment.MultipleListFragment.AnonymousClass5 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // androidx.recyclerview.widget.RecyclerView.ItemDecoration
                public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1214683551")) {
                        ipChange.ipc$dispatch("1214683551", new Object[]{this, rect, view, recyclerView, state});
                        return;
                    }
    ...
    private boolean isStaggeredLayout() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-38080951")) {
            return PageType.RECORD == this.mType;
        }
        return ((Boolean) ipChange.ipc$dispatch("-38080951", new Object[]{this})).booleanValue();
    }

    private boolean isViewPrepared() {
        FragmentActivity fragmentActivity;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "712593937")) {
            return ((Boolean) ipChange.ipc$dispatch("712593937", new Object[]{this})).booleanValue();
        }
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1609008502")) {
            return R$layout.fragment_main_multiple_list;
        }
        return ((Integer) ipChange.ipc$dispatch("1609008502", new Object[]{this})).intValue();
    }

    @Override // cn.damai.mine.fragment.BaseFuncFragment
    public ViewGroup getMainView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "416608216")) {
            return this.mMainView;
        }
        return (ViewGroup) ipChange.ipc$dispatch("416608216", new Object[]{this});
    }
    ...
    public void initView() {
        ...
        FragmentActivity fragmentActivity = this.mActivity;
        MultiAdapter multiAdapter = new MultiAdapter(fragmentActivity, new s3(fragmentActivity, new b(this)));
