...
public class Wanna2SeeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "547610004")) {
            return layoutInflater.inflate(R$layout.fragment_live_see, viewGroup, false);
        }
        return (View) ipChange.ipc$dispatch("547610004", new Object[]{this, layoutInflater, viewGroup, bundle});
    }
