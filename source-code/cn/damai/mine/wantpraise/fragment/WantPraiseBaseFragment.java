...
public class WantPraiseBaseFragment extends DamaiBaseMvpFragment implements ILoginListener, OnLoadMoreListener, OnRefreshListener {
    ...
    private void initRecyclerView() {
        ...
        this.mRecyclerView.addItemDecoration(new RecyclerView.ItemDecoration() {
            /* class cn.damai.mine.wantpraise.fragment.WantPraiseBaseFragment.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.recyclerview.widget.RecyclerView.ItemDecoration
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1365106978")) {
                    ipChange.ipc$dispatch("1365106978", new Object[]{this, rect, view, recyclerView, state});
                    return;
                }
                ...
                if (((RecyclerView.LayoutParams) layoutParams).getViewAdapterPosition() > 1) {
                    rect.set(0, 0, 0, v50.a(WantPraiseBaseFragment.this.getContext(), 9.0f));
                } else {
                    rect.set(0, 0, 0, 0);
                }
            }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void netSuccess(WantPriseListResponse wantPriseListResponse) {
        IpChange ipChange = $ipChange;
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-693872656")) {
            return R$layout.layout_want_prasie_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("-693872656", new Object[]{this})).intValue();
    }
    ...
    public void requestInfoList(String str, String str2) {
        ...
        wantPriseListRequest.request(new DMMtopRequestListener<WantPriseListResponse>(WantPriseListResponse.class) {
            /* class cn.damai.mine.wantpraise.fragment.WantPraiseBaseFragment.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "490332675")) {
                    ipChange.ipc$dispatch("490332675", new Object[]{this, str, str2});
                    return;
                }
                WantPraiseBaseFragment.this.netFail(str, str2);
            }

            public void onSuccess(WantPriseListResponse wantPriseListResponse) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1183739243")) {
                    ipChange.ipc$dispatch("-1183739243", new Object[]{this, wantPriseListResponse});
                    return;
                }
