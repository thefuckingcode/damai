...
public class WantListAdapter extends RecyclerView.Adapter<ViewHolder> implements RelationRequestUtil.RelationRequestInter {
    ...
    public WantListAdapter(Context context, boolean z) {
        this.a = context;
        this.c = new RelationRequestUtil(this);
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        WantSeePraiseD wantSeePraiseD = (WantSeePraiseD) s41.d(jSONObject, WantSeePraiseD.class);
        if (wantSeePraiseD != null) {
            GaiaXBuilder gaiaXBuilder = new GaiaXBuilder();
            FrameLayout frameLayout = viewHolder.a;
            Context context = this.a;
            gaiaXBuilder.renderGaiaXSimple(frameLayout, context, "damai_wantsee_cell", jSONObject, ScreenUtils.INSTANCE.getScreenWidthPx(context) - ((float) v50.a(this.a, 24.0f)), i, new a(this.a, wantSeePraiseD, i), false, false);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "693863991")) {
        ...
        return (ViewHolder) ipChange.ipc$dispatch("693863991", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1817778113")) {
            return xf2.e(this.b);
        }
        return ((Integer) ipChange.ipc$dispatch("1817778113", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public long getItemId(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1917598597")) {
            return (long) i;
        }
        return ((Long) ipChange.ipc$dispatch("1917598597", new Object[]{this, Integer.valueOf(i)})).longValue();
    }
