...
public class WannaSeeModel extends AbsModel {
    ...
    public void load(final boolean z, final OnBizListener<PageData<List>> onBizListener) {
        ...
        this.mHolder.a(new Wanna2SeeRequest(this.mType.requestType, this.pageNo).request(new DMMtopRequestListener<WannaBean>(WannaBean.class) {
            /* class cn.damai.mine.model.WannaSeeModel.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1999773945")) {
                    ipChange.ipc$dispatch("-1999773945", new Object[]{this, str, str2});
                    return;
                }
            ...
            public void onSuccess(WannaBean wannaBean) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-495999783")) {
                    ipChange.ipc$dispatch("-495999783", new Object[]{this, wannaBean});
