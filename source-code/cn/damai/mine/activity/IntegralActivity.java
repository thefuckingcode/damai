...
public class IntegralActivity extends DamaiBaseActivity<IntegralPresenter, IntegralContract.Model> implements IntegralContract.View {
    ...
    public class AcquireAdapter extends BaseAdapter {
        ...
        public int getCount() {
            ...
            } else if (IntegralActivity.this.acquireScoreDtoList == null) {
                return 0;
            } else {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (acquireScoreModel != null) {
                ...
                textView2.setText(jl1.PLUS + acquireScoreModel.score);
    ...
    public class LostScoreAdapter extends BaseAdapter {
        ...
        public int getCount() {
            ...
            } else if (IntegralActivity.this.lostScoreDtoList == null) {
                return 0;
            } else {
    ...
    public class g implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            bundle.putString("title", bk2.b(IntegralActivity.this, R$string.main_header_01));
            bundle.putString("from", hf1.MODULE_BANNER);
    ...
    private void flushPointsAdapter() {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void flushSumptionAdapter() {
        IpChange ipChange = $ipChange;
    ...
    private void initData() {
        ...
        new v2().a(this.myActivity, this.pull_down_view, this.lv_list, new b()).b(this.myActivity, this.pull_down_view, this.lv_list, new a());
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void requestPointsIntegral() {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void requestSumptionIntegral() {
        IpChange ipChange = $ipChange;
    ...
    public void dealHeaderClick(int i2) {
        ...
        if (i2 == 10004) {
            Bundle bundle = new Bundle();
            bundle.putString("title", bk2.b(this, R$string.damai_more_aboutintegral));
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "285657675")) {
            return R$layout.integral_activity;
        }
        return ((Integer) ipChange.ipc$dispatch("285657675", new Object[]{this})).intValue();
    }
    ...
    public String setTitle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1951879551")) {
            return "我的积分";
        }
        return (String) ipChange.ipc$dispatch("1951879551", new Object[]{this});
    }
