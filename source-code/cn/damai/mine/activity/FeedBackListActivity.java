...
public class FeedBackListActivity extends DamaiBaseActivity<FeedBackPresenter, FeedBackContract.Model> implements FeedBackContract.View {
    ...
    private void addUTClickBuilder(FeedBack feedBack) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1925130219")) {
            ...
            c e2 = c.e();
            e2.x(yd1.x().v((long) i, feedBack.name + JSMethod.NOT_SET + feedBack.title));
        }
    }
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1673220980")) {
            return R$layout.activity_feed_back;
        }
        return ((Integer) ipChange.ipc$dispatch("1673220980", new Object[]{this})).intValue();
    }
    ...
    @Override // cn.damai.commonbusiness.base.BaseDamaiView, cn.damai.mine.contract.FeedBackContract.View
    ...
    public void returnFeedBackList(FeedBackList feedBackList) {
        ...
        } else if (xf2.e(this.mFeedBackList) == 0) {
    ...
    public String setTitle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-871620888")) {
            return "我要反馈";
        }
        return (String) ipChange.ipc$dispatch("-871620888", new Object[]{this});
    }
