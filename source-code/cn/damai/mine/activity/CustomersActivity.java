...
public class CustomersActivity extends DamaiBaseActivity {
    ...
    private void deleteCustomer(String str) {
        ...
        customerRemoveRequest.loginKey = d20.q();
        customerRemoveRequest.identityHash = str;
        customerRemoveRequest.request(new DMMtopRequestListener<CustomerRemoveResponse>(CustomerRemoveResponse.class) {
            /* class cn.damai.mine.activity.CustomersActivity.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-862763936")) {
                    ipChange.ipc$dispatch("-862763936", new Object[]{this, str, str2});
                    return;
                }
                CustomersActivity.this.deleteCustomerFailed(str, str2);
            }

            public void onSuccess(CustomerRemoveResponse customerRemoveResponse) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1332183350")) {
                    ipChange.ipc$dispatch("1332183350", new Object[]{this, customerRemoveResponse});
                    return;
                }
    ...
    private View getBottomDivider() {
        ...
        view.setLayoutParams(new ViewGroup.LayoutParams(-1, v50.a(this, 30.0f)));
    ...
    private View getTopDivider() {
        ...
        View view = new View(this);
        view.setLayoutParams(new ViewGroup.LayoutParams(-1, v50.a(this, 10.0f)));
        view.setBackgroundColor(getResources().getColor(R$color.color_F5F5F5));
        return view;
    }
    ...
    private void gotoAddContactPage() {
        ...
        DMNav.from(this).forResult(1009).withExtras(bundle).toUri(NavUri.b(gr.z));
    }
    ...
    private void requestAddCheck() {
        ...
        addCheckRequest.loginkey = d20.q();
        addCheckRequest.request(new DMMtopRequestListener<AddCustomerCheckBean>(AddCustomerCheckBean.class) {
            /* class cn.damai.mine.activity.CustomersActivity.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-855004577")) {
                    ipChange.ipc$dispatch("-855004577", new Object[]{this, str, str2});
                    return;
                }
            ...
            public void onSuccess(AddCustomerCheckBean addCustomerCheckBean) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1815259764")) {
                    ipChange.ipc$dispatch("-1815259764", new Object[]{this, addCustomerCheckBean});
                    return;
                }
    ...
    private void requestCustomerList() {
        ...
        customerListRequest.loginkey = d20.q();
        customerListRequest.request(new DMMtopRequestListener<CustomerListBean>(CustomerListBean.class) {
            /* class cn.damai.mine.activity.CustomersActivity.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-847245218")) {
                    ipChange.ipc$dispatch("-847245218", new Object[]{this, str, str2});
                    return;
                }
            ...
            public void onSuccess(CustomerListBean customerListBean) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "217063992")) {
                    ipChange.ipc$dispatch("217063992", new Object[]{this, customerListBean});
                    return;
                }
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1938850168")) {
            return R$layout.mine_customers_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("-1938850168", new Object[]{this})).intValue();
    }
