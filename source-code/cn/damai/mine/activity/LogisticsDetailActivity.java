...
public class LogisticsDetailActivity extends DamaiBaseActivity {
    ...
    private void getLogisticsDetailData() {
        ...
        logisticsDetailRequest.request(new DMMtopRequestListener<LogisticsDetailResponse>(LogisticsDetailResponse.class) {
            /* class cn.damai.mine.activity.LogisticsDetailActivity.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            private void updateUI(LogisticsDetailResponse logisticsDetailResponse) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1133150262")) {
                    ipChange.ipc$dispatch("1133150262", new Object[]{this, logisticsDetailResponse});
            ...
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1936479795")) {
                    ipChange.ipc$dispatch("-1936479795", new Object[]{this, str, str2});
                    return;
                }
            ...
            public void onSuccess(LogisticsDetailResponse logisticsDetailResponse) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-2114082401")) {
                    ipChange.ipc$dispatch("-2114082401", new Object[]{this, logisticsDetailResponse});
                    return;
                }
                LogisticsDetailActivity logisticsDetailActivity = LogisticsDetailActivity.this;
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1689419577")) {
            return R$layout.activity_logistics;
        }
        return ((Integer) ipChange.ipc$dispatch("1689419577", new Object[]{this})).intValue();
    }
    ...
    public String setTitle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1366609389")) {
            return "物流详情";
        }
        return (String) ipChange.ipc$dispatch("1366609389", new Object[]{this});
    }
}
