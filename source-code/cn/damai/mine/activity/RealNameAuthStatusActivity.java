...
public class RealNameAuthStatusActivity extends DamaiBaseActivity<RealNameAuthStatusPresenter, RealNameAuthStatusContract.Model> implements RealNameAuthStatusContract.View {
    ...
    private int getHeight(int i, int i2, int i3) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-257889609")) {
            return ((DisplayMetrics.getwidthPixels(n42.c(this)) - i3) * i2) / i;
        }
        return ((Integer) ipChange.ipc$dispatch("-257889609", new Object[]{this, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)})).intValue();
    }
    ...
    private void jumpRealNameAuthErrorPage() {
        IpChange ipChange = $ipChange;
    ...
    private void notifyServer(final RPSDK.AUDIT audit) {
        ...
        faceVerifyNextStepRequest.request(new DMMtopRequestListener<BaseFaceVerifyBean>(BaseFaceVerifyBean.class) {
            /* class cn.damai.mine.activity.RealNameAuthStatusActivity.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1829338957")) {
                    ipChange.ipc$dispatch("-1829338957", new Object[]{this, str, str2});
                    return;
                }
                ToastUtil.i(str2);
            }
            ...
            public void onSuccess(BaseFaceVerifyBean baseFaceVerifyBean) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1267889741")) {
                    ipChange.ipc$dispatch("-1267889741", new Object[]{this, baseFaceVerifyBean});
                    return;
                }
    ...
    public void getAuthStatus(RealNameAuthStatusBean realNameAuthStatusBean) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1487316057")) {
            ...
            if (TextUtils.isEmpty(this.isFrom) || !this.isFrom.equals("push")) {
                if (realNameAuthStatusBean.getAccountVerifyCode() == 5) {
                    refreshErrorView(realNameAuthStatusBean);
                    return;
                }
            } else if (realNameAuthStatusBean.getAccountVerifyCode() == 5 || (realNameAuthStatusBean.getAccountVerifyCode() == 3 && realNameAuthStatusBean.getFaceVerifyCode() == 5)) {
                refreshErrorView(realNameAuthStatusBean);
                return;
            } else if (realNameAuthStatusBean.getAccountVerifyCode() == 1) {
                jumpRealNameAuthPage();
                finish();
                return;
        ...
        if (realNameVerifyBean != null && !TextUtils.isEmpty(realNameVerifyBean.getVerifyToken())) {
            ...
            try {
                if (xs0.a() == null) {
                    ...
                    c.e().A(hashMap, "RPSDK_Application", yd1.REALNAME_AUTHCENTER_PAGE);
                    return;
                }
                pw1.a(xs0.a());
                if (RPSDK.getContext() == null) {
                    ...
                    c.e().A(hashMap2, "RPSDK_Context", yd1.REALNAME_AUTHCENTER_PAGE);
                    return;
                }
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1228128844")) {
            return R$layout.activity_realname_authcenter_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("-1228128844", new Object[]{this})).intValue();
    }
