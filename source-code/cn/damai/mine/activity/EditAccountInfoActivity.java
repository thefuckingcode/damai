...
public class EditAccountInfoActivity extends DamaiBaseActivity<EditAccountInfoPresenter, EditAccountInfoModel> implements EditAccountInfoContract.View {
    ...
    private void parseBirthDay(String str) {
        ...
        try {
            ...
            this.mBirthDate = new SimpleDateFormat("yyyy" + bk2.b(this, R$string.damai_modifyuserdata_year) + "MM" + bk2.b(this, R$string.damai_modifyuserdata_month) + "dd" + bk2.b(this, R$string.damai_modifyuserdata_day)).format(parse);
        } catch (ParseException e) {
            g91.d(e);
            this.birth = "1990-01-01";
            this.mBirthDate = "1990" + bk2.b(this, R$string.damai_modifyuserdata_year) + HiAnalyticsConstant.KeyAndValue.NUMBER_01 + bk2.b(this, R$string.damai_modifyuserdata_month) + HiAnalyticsConstant.KeyAndValue.NUMBER_01 + bk2.b(this, R$string.damai_modifyuserdata_day);
        }
    ...
    private void requestSaveAccountInfoMsg() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-2127062782")) {
            ...
            saveUserRequest.loginKey = d20.q();
    ...
    private void selectBirth() {
        ...
        new DatePickerDialog(this, this.dateListener, instance.get(1), instance.get(2), instance.get(5)).show();
    }
    ...
    private void selectSex() {
        ...
        selectDialog.e(bk2.b(this, R$string.damai_modifyuserdata_male), bk2.b(this, R$string.damai_modifyuserdata_girl));
    ...
    private void setUserSex(int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1711292058")) {
            ...
            this.sexText.setText(bk2.b(this, R$string.damai_modifyuserdata_girl));
        } else {
            this.sexText.setText(bk2.b(this, R$string.damai_modifyuserdata_male));
        }
    }
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "365707276")) {
            return R$layout.edit_account_info_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("365707276", new Object[]{this})).intValue();
    }
