...
public class MyFeedBackDetailActivity extends DamaiBaseActivity<MyFeedBackDetailPresenter, MyFeedBackDetailContract.Model> implements MyFeedBackDetailContract.View {
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1462123883")) {
            return R$layout.activity_my_feed_back_detail;
        }
        return ((Integer) ipChange.ipc$dispatch("-1462123883", new Object[]{this})).intValue();
    }
    ...
    @Override // cn.damai.commonbusiness.base.BaseDamaiView, cn.damai.mine.contract.MyFeedBackDetailContract.View
    ...
    public void returnFeedBack(MyFeedBackDetail myFeedBackDetail) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-582253975")) {
            ...
            for (int i = 0; i < xf2.e(myFeedBackDetail.replyDOs); i++) {
    ...
    public String setTitle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2097479753")) {
            return "反馈详情";
        }
        return (String) ipChange.ipc$dispatch("2097479753", new Object[]{this});
    }
