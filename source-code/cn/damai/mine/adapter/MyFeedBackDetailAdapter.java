...
public class MyFeedBackDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class MyFeedBackDetailViewHolder extends RecyclerView.ViewHolder {
        ...
        public void a(MyFeedBackDetailDO myFeedBackDetailDO) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "605897827")) {
                ...
                int e2 = xf2.e(myFeedBackDetailDO.imageAddrs);
                if (e2 <= 0) {
                ...
                for (int i = 0; i < e2; i++) {
                    if (!TextUtils.isEmpty(myFeedBackDetailDO.imageAddrs.get(i))) {
                        ...
                        DMImageCreator c2 = cn.damai.common.image.a.b().c(myFeedBackDetailDO.imageAddrs.get(i));
    ...
    public MyFeedBackDetailAdapter(Context context, List<MyFeedBackDetailDataHolder> list) {
        this.a = list;
        this.b = context;
        this.c = DisplayMetrics.getwidthPixels(n42.b(context)) / 6;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1772236918")) {
            return xf2.e(this.a);
        }
        return ((Integer) ipChange.ipc$dispatch("1772236918", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1247412195")) {
            return this.a.get(i).type;
        }
        return ((Integer) ipChange.ipc$dispatch("-1247412195", new Object[]{this, Integer.valueOf(i)})).intValue();
    }
