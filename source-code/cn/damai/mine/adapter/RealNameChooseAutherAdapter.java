...
public class RealNameChooseAutherAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1064400928")) {
            return new CustomerItemViewHolder(LayoutInflater.from(this.a).inflate(R$layout.customer_select_item, viewGroup, false));
        }
        return (RecyclerView.ViewHolder) ipChange.ipc$dispatch("-1064400928", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
}
