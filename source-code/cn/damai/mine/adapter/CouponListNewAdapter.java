...
public class CouponListNewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private int a;
    private int b;
    private int c = this.f.getResources().getColor(R$color.color_111111);
    private int d = this.f.getResources().getColor(R$color.color_888888);
    private int e = this.f.getResources().getColor(R$color.color_DDDDDD);
    private Context f;
    ...
    public class CouponsViewHolder extends RecyclerView.ViewHolder {
        ...
        public class a implements View.OnClickListener {
            ...
            public void onClick(View view) {
                ...
                if (AndroidInstantRuntime.support(ipChange, "-913144223")) {
                    ...
                    c.e().x(yd1.x().E(this.a.id, this.b));
        ...
        public class b implements View.OnClickListener {
            ...
            public void onClick(View view) {
                ...
                if (AndroidInstantRuntime.support(ipChange, "1198146146")) {
                    ...
                    DMNav.from(CouponListNewAdapter.this.f).forResult(1000).withExtras(bundle).toUri(gr.c());
                }
            }
        }
        ...
        public void a(CouponData.Coupon coupon, int i) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "706289370")) {
                ...
                if (i2 == 0 || i2 == 1) {
                    if (!xf2.j(coupon.effectiveTimeText)) {
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-488747338")) {
            return xf2.e(this.g);
        }
        return ((Integer) ipChange.ipc$dispatch("-488747338", new Object[]{this})).intValue();
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-741549869")) {
            return new CouponsViewHolder(this.f);
        }
        return (RecyclerView.ViewHolder) ipChange.ipc$dispatch("-741549869", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
}
