...
public class MyCollectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1812032828")) {
            return xf2.e(this.d);
        }
        return ((Integer) ipChange.ipc$dispatch("-1812032828", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1152611477")) {
            return this.d.get(i).type;
        }
        return ((Integer) ipChange.ipc$dispatch("-1152611477", new Object[]{this, Integer.valueOf(i)})).intValue();
    }
