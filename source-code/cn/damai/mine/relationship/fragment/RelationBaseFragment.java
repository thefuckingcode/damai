...
public class RelationBaseFragment extends DamaiBaseMvpFragment implements ILoginListener, OnLoadMoreListener, OnRefreshListener {
    ...
    private void initRecyclerView() {
        ...
        this.mRecyclerView.addItemDecoration(new RecyclerView.ItemDecoration() {
            /* class cn.damai.mine.relationship.fragment.RelationBaseFragment.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.recyclerview.widget.RecyclerView.ItemDecoration
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-306372897")) {
                    ipChange.ipc$dispatch("-306372897", new Object[]{this, rect, view, recyclerView, state});
                    return;
                }
                ...
                if (((RecyclerView.LayoutParams) layoutParams).getViewAdapterPosition() > 1) {
                    rect.set(0, 0, 0, v50.a(RelationBaseFragment.this.getContext(), 9.0f));
                } else {
                    rect.set(0, 0, 0, 0);
                }
            }
    ...
    private boolean isFirstPage() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1922575006")) {
            return this.requestPageNo == 1;
        }
        return ((Boolean) ipChange.ipc$dispatch("1922575006", new Object[]{this})).booleanValue();
    }

    private boolean isFollowType() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1089296554")) {
            return "1".equals(this.relationType);
        }
        return ((Boolean) ipChange.ipc$dispatch("1089296554", new Object[]{this})).booleanValue();
    }
        ...
        if (isFollowType()) {
            if (this.self) {
                if ("brand".equals(this.relationKind)) {
                    ...
                    str = "你还没有关注艺人哦，\n去发现一些吧";
                } else if (RELATION_TYPE_KIND_COSTOMER.equals(this.relationKind)) {
                    str = "你还没有关注任何人哦";
                }
    ...
    private void netFail(String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void netSuccess(RelationInfoListResponse relationInfoListResponse) {
        IpChange ipChange = $ipChange;
        ...
        stopProgressDialog();
        g91.c("RelationBaseFragment", "addObserver" + this.relationKind);
        if (arrayList != null) {
            if (arrayList.size() <= 0) {
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1817849204")) {
            return R$layout.layout_relation_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("1817849204", new Object[]{this})).intValue();
    }
    ...
    public void requestRelationInfoList(int i, String str, String str2) {
        ...
        relationInfoListRequest.request(new DMMtopRequestListener<RelationInfoListResponse>(RelationInfoListResponse.class) {
            /* class cn.damai.mine.relationship.fragment.RelationBaseFragment.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1260891136")) {
                    ipChange.ipc$dispatch("-1260891136", new Object[]{this, str, str2});
                    return;
                }
                RelationBaseFragment.this.netFail(str, str2);
            }

            public void onSuccess(RelationInfoListResponse relationInfoListResponse) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1234353837")) {
                    ipChange.ipc$dispatch("-1234353837", new Object[]{this, relationInfoListResponse});
                    return;
                }
    ...
    public void requestRelationSelfList(int i, String str, String str2) {
        ...
        relationSelfRequest.request(new DMMtopRequestListener<RelationInfoListResponse>(RelationInfoListResponse.class) {
            /* class cn.damai.mine.relationship.fragment.RelationBaseFragment.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1253131777")) {
                    ipChange.ipc$dispatch("-1253131777", new Object[]{this, str, str2});
                    return;
                }
                RelationBaseFragment.this.netFail(str, str2);
            }
            ...
            public void onSuccess(RelationInfoListResponse relationInfoListResponse) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-278832558")) {
                    ipChange.ipc$dispatch("-278832558", new Object[]{this, relationInfoListResponse});
                    return;
                }
                RelationBaseFragment.this.netSuccess(relationInfoListResponse);
            }
