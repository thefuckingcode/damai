...
public class EvaluateSuccessRenderRequest extends DMBaseMtopRequest {
    ...
    public String getApiName() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1354121424")) {
            return "mtop.damai.wireless.comment.success.render";
        }
        return (String) ipChange.ipc$dispatch("1354121424", new Object[]{this});
    }
    ...
    public String getVersion() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-773109149")) {
            return "1.0";
        }
        return (String) ipChange.ipc$dispatch("-773109149", new Object[]{this});
    }
}
