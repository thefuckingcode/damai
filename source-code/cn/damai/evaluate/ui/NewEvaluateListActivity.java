...
public class NewEvaluateListActivity extends DamaiBaseActivity implements EvaluateItemDataBinder.EvaluateItemUTReportListener {
    ...
    private void initExtras() {
        ...
        if (extras != null) {
            ...
            this.mIpId = extras.getString(p21.ISSUE_PARAM_IPID);
    ...
    private void replaceFragment() {
        ...
        EvaluateListFragment instance = EvaluateListFragment.getInstance(this.mItemId + "", this.mIpId, this.mTourId);
        this.evaluateListFragment = instance;
        instance.setEvalutateItemClickUTData(this);
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "415923303")) {
            return R$layout.new_evaluate_activity;
        }
        return ((Integer) ipChange.ipc$dispatch("415923303", new Object[]{this})).intValue();
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        setDamaiUTKeyBuilder(ik.I().z(d20.E()));
        c.e().K(this);
    }
    ...
    public void onReportImageInfoClickEvent(boolean z, CommentsItemBean commentsItemBean, int i, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1073404463")) {
            ...
            c.e().x(ik.I().B(commentsItemBean.getCommentId(), commentsItemBean.getUserDO().getDamaiUserId(), this.evaluateListFragment.getChooseLabel().getLabelName(), (i2 != 0 || commentsItemBean.getVideoDO() == null) ? "" : commentsItemBean.getVideoDO().getVideoId(), this.evaluateListFragment.getChooseLabel().getPos(), i, i2));
        }
    }
    ...
    public void onReportItemClickEvent(boolean z, CommentsItemBean commentsItemBean, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "196085262")) {
            ...
            c.e().x(ik.I().C(commentsItemBean.getCommentId(), commentsItemBean.getUserDO().getDamaiUserId(), this.mScriptId, this.evaluateListFragment.getChooseLabel().getLabelName(), this.evaluateListFragment.getChooseLabel().getPos(), i));
        }
    }
    ...
    public void onReportMoreInfoClickEvent(boolean z, CommentsItemBean commentsItemBean, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-2056799234")) {
            ...
            c.e().x(ik.I().G(commentsItemBean.getCommentId(), commentsItemBean.getUserDO().getDamaiUserId(), this.mScriptId, this.evaluateListFragment.getChooseLabel().getLabelName(), this.evaluateListFragment.getChooseLabel().getPos(), i));
        }
    }
    ...
    public void onReportPraiseViewClickEvent(boolean z, CommentsItemBean commentsItemBean, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1449815264")) {
            ...
            c.e().x(ik.I().E(commentsItemBean.getCommentId(), commentsItemBean.getUserDO().getDamaiUserId(), this.evaluateListFragment.getChooseLabel().getLabelName(), this.evaluateListFragment.getChooseLabel().getPos(), i));
        }
    }
    ...
    public void onReportReplyClickEvent(boolean z, CommentsItemBean commentsItemBean, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-305185135")) {
            ...
            c.e().x(ik.I().F(commentsItemBean.getCommentId(), commentsItemBean.getUserDO().getDamaiUserId(), this.evaluateListFragment.getChooseLabel().getLabelName(), this.evaluateListFragment.getChooseLabel().getPos(), i));
        }
    }
    ...
    public void onReportUserInfoClickEvent(boolean z, CommentsItemBean commentsItemBean, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1226164680")) {
            ...
            c.e().x(ik.I().H(commentsItemBean.getCommentId(), commentsItemBean.getUserDO().getDamaiUserId(), this.mScriptId, this.evaluateListFragment.getChooseLabel().getLabelName(), this.evaluateListFragment.getChooseLabel().getPos(), i));
        }
    }
