...
public class EvaluateSuccessActivity extends DamaiBaseActivity {
    ...
    public static Intent createIntent(Context context, String str, String str2, IssueResponse issueResponse2, EvaluteSuccessRenderResponse evaluteSuccessRenderResponse, DMShareMessage dMShareMessage) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "601422887")) {
            return (Intent) ipChange.ipc$dispatch("601422887", new Object[]{context, str, str2, issueResponse2, evaluteSuccessRenderResponse, dMShareMessage});
        }
        Intent intent = new Intent(context, EvaluateSuccessActivity.class);
        intent.putExtra("itemType", str);
        intent.putExtra("storeId", str2);
        intent.putExtra("issueResponse", issueResponse2);
    ...
    private void initData() {
        ...
        IssueResponse issueResponse2 = this.issueResponse;
        if (issueResponse2 != null) {
            this.headView.setData(this.itemType, issueResponse2.getCommentsDO() != null ? this.issueResponse.getCommentsDO().getCommentId() : "-1", this.storeId, this.renderResponse, xf2.e(this.issueResponse.getHotScriptInfoList()));
    ...
    private void share() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "2032322429")) {
            ...
            c.e().x(ik.I().O(this.itemType, this.issueResponse.getCommentsDO().getCommentId()));
        }
    }
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "746874164")) {
            return R$layout.evaluate_success_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("746874164", new Object[]{this})).intValue();
    }
