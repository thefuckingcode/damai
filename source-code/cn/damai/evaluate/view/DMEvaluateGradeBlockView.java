...
public class DMEvaluateGradeBlockView extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        setPadding(0, v50.a(context, 9.0f), 0, 0);
        setOrientation(1);
    }
    ...
    public void setData(List<CommentStatScoreBean> list) {
        ...
        if (xf2.e(list) > 0) {
            ...
            LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(-1, v50.a(this.mContext, 9.0f));
            layoutParams2.setMargins(0, v50.a(this.mContext, 9.0f), 0, 0);
