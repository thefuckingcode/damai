...
public class DMEvaluateProjectCardView extends RelativeLayout {
    ...
    public DMEvaluateProjectCardView(Context context2) {
        this(context2, null);
    }
    ...
    public DMEvaluateProjectCardView(Context context2, AttributeSet attributeSet) {
    ...
    public void setData(String str, String str2, String str3, int i) {
        ...
        if (i == 1) {
            this.ivProjectImage.getLayoutParams().width = s50.a(this.context, 41.0f);
            this.ivProjectImage.getLayoutParams().height = s50.a(this.context, 41.0f);
            this.ivProjectImage.setImageDrawable(getResources().getDrawable(R$drawable.store_defult_img));
        } else if (i == 2) {
            this.ivProjectImage.getLayoutParams().width = s50.a(this.context, 41.0f);
            this.ivProjectImage.getLayoutParams().height = s50.a(this.context, 55.0f);
            this.ivProjectImage.setImageDrawable(getResources().getDrawable(R$drawable.uikit_default_image_bg_grey));
        } else {
            this.ivProjectImage.getLayoutParams().width = s50.a(this.context, 32.0f);
            this.ivProjectImage.getLayoutParams().height = s50.a(this.context, 42.0f);
    ...
    public DMEvaluateProjectCardView(Context context2, AttributeSet attributeSet, int i) {
