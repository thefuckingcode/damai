...
public class DMEvaluateGradeCardView extends LinearLayout {
    ...
    public DMEvaluateGradeCardView(Context context2) {
        this(context2, null);
    }
    ...
    public DMEvaluateGradeCardView(Context context2, AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public DMEvaluateGradeCardView(Context context2, AttributeSet attributeSet, int i) {
        super(context2, attributeSet, i);
        this.context = context2;
        setPadding(v50.a(context2, 12.0f), v50.a(context2, 3.0f), v50.a(context2, 12.0f), v50.a(context2, 3.0f));
        initView();
    }
}
