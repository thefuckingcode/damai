...
public class DMEvaluateDetailHeadView extends RelativeLayout {
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            cn.damai.common.user.c.e().x(ik.I().J(this.a.getCommentId(), this.a.getUserDO().getDamaiUserId(), this.a.getScriptInfo().getId(), null, 1));
    ...
    public class e implements NineImgUtil.OnClickExtraListener {
        ...
        public void onExtraLister(int i) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "1853101738")) {
                ...
                cn.damai.common.user.c.e().x(ik.I().o(this.a.getCommentId(), this.a.getUserDO().getDamaiUserId(), i, this.b, this.a.getScriptInfo() != null ? this.a.getScriptInfo().getId() : ""));
            }
        }
    }
    ...
    private void gotoTarget(CommentsItemBean commentsItemBean, String str, String str2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "762437736")) {
            ...
            cn.damai.common.user.c.e().x(ik.I().u(str2, null, commentsItemBean.getCommentId(), commentsItemBean.getUserDO().getDamaiUserId(), null));
            ...
            cn.damai.common.user.c.e().x(ik.I().u(null, str2, commentsItemBean.getCommentId(), commentsItemBean.getUserDO().getDamaiUserId(), null));
            Bundle bundle2 = new Bundle();
            bundle2.putString(RepertoireDetailFragment.REPERTOIREID, str2);
            DMNav.from(this.mContext).withExtras(bundle2).toUri(NavUri.b(wz1.REPERTOITE));
        } else if ("3".equals(str)) {
            cn.damai.common.user.c.e().x(ik.I().J(commentsItemBean.getCommentId(), commentsItemBean.getUserDO().getDamaiUserId(), null, commentsItemBean.getStoreInfo().getStoreId(), 1));
            Bundle bundle3 = new Bundle();
            bundle3.putString("storeId", str2);
            DMNav.from(this.mContext).withExtras(bundle3).toUri(NavUri.b(gr.SCRIPT_SHOP_DETAIL));
    ...
    private void initView() {
        ...
        this.mStoreUi = new sr(inflate.findViewById(R$id.evaluate_store_info_v1));
        this.mScriptUi = new sr(findViewById);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void openScriptActivity(ScriptBean scriptBean) {
        IpChange ipChange = $ipChange;
    ...
    private void setNineImgs(CommentsItemBean commentsItemBean, String str) {
        ...
        e eVar = new e(this, commentsItemBean, str);
        NineImgUtil.a().b(this.mContext, ((int) up2.d(this.mContext)) - (up2.a(this.mContext, 21.0f) * 2), false, this.gridlayout, commentsItemBean, imageDOList, eVar);
    }
    ...
    private void setRatingBarData(CommentsItemBean commentsItemBean) {
        ...
        if (commentsItemBean.getItemType() == 1) {
            this.ratingBar.setStarSize(s50.a(getContext(), 12.0f));
            this.ratingBar.setStarDistance(s50.a(getContext(), 1.5f));
            this.ratingBar.setMarkDrawable(R$drawable.rating_fill_type_2, R$drawable.rating_empty_type_2);
        } else {
            this.ratingBar.setStarDistance(s50.a(getContext(), 1.0f));
            this.ratingBar.setStarSize(s50.a(getContext(), 8.0f));
    ...
    public void setData(CommentsItemBean commentsItemBean, CommentProjectInfoBean commentProjectInfoBean, CommentRepertoireInfoBean commentRepertoireInfoBean) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "817666528")) {
            ...
            View view = this.playedIcon;
            if (!commentsItemBean.hasPlayed) {
                i = 8;
            }
