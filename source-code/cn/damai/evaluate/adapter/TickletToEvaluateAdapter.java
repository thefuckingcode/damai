...
public class TickletToEvaluateAdapter extends RecyclerView.Adapter<TikletToEvaluateViewHolder> {
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            hashMap.put("titlelabel", gl2.TO_COMMENT);
            ...
            c e = c.e();
            a.b i = new a.b().i(sl2.TICKLET_MYCOMMENT_LIST_PAGE);
    ...
    private void d(ToEvaListResponse.EvaluateInfo evaluateInfo, String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    private void e(TikletToEvaluateViewHolder tikletToEvaluateViewHolder, String str, int i, boolean z) {
        ...
        if (z) {
            tikletToEvaluateViewHolder.a.getLayoutParams().height = v50.a(this.a, 78.0f);
            tikletToEvaluateViewHolder.a.getLayoutParams().width = v50.a(this.a, 78.0f);
            Context context = this.a;
            if (!(context == null || context.getResources() == null)) {
                tikletToEvaluateViewHolder.a.setImageDrawable(this.a.getResources().getDrawable(R$drawable.store_defult_img));
            }
        } else {
            tikletToEvaluateViewHolder.a.getLayoutParams().height = v50.a(this.a, 104.0f);
            tikletToEvaluateViewHolder.a.getLayoutParams().width = v50.a(this.a, 78.0f);
    ...
    private void i(TikletToEvaluateViewHolder tikletToEvaluateViewHolder, ToEvaListResponse.EvaluateInfo evaluateInfo, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1824453792")) {
            ...
            if (xf2.j(timeTitle) || evaluateInfo.isScriptmurderShop()) {
    ...
    public TikletToEvaluateViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-486484866")) {
            return new TikletToEvaluateViewHolder(LayoutInflater.from(this.a).inflate(R$layout.ticklet_perform_to_evaluate_item_layout, viewGroup, false));
        }
        return (TikletToEvaluateViewHolder) ipChange.ipc$dispatch("-486484866", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
