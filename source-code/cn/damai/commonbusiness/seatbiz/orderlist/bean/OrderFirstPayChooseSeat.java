...
public class OrderFirstPayChooseSeat implements Parcelable {
    ...
    public static final Parcelable.Creator<OrderFirstPayChooseSeat> CREATOR = new Parcelable.Creator<OrderFirstPayChooseSeat>() {
        /* class cn.damai.commonbusiness.seatbiz.orderlist.bean.OrderFirstPayChooseSeat.AnonymousClass1 */
        private static transient /* synthetic */ IpChange $ipChange;

        @Override // android.os.Parcelable.Creator
        public OrderFirstPayChooseSeat createFromParcel(Parcel parcel) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "1511609163")) {
                return new OrderFirstPayChooseSeat(parcel);
            }
            return (OrderFirstPayChooseSeat) ipChange.ipc$dispatch("1511609163", new Object[]{this, parcel});
        }

        @Override // android.os.Parcelable.Creator
        public OrderFirstPayChooseSeat[] newArray(int i) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-1610182322")) {
                return new OrderFirstPayChooseSeat[i];
            }
            return (OrderFirstPayChooseSeat[]) ipChange.ipc$dispatch("-1610182322", new Object[]{this, Integer.valueOf(i)});
        }
    };
