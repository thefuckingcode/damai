...
public class c {
    ...
    public static Integer b(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1268017979")) {
            return a.get(str);
        }
        return (Integer) ipChange.ipc$dispatch("1268017979", new Object[]{str});
    }
    ...
    public static Integer c(String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "36503929")) {
            ...
            } else if (!str.startsWith("rgb(") || !str.endsWith(jl1.BRACKET_END_STR)) {
                return b(str);
            } else {
    ...
    private static Integer e(int i, int i2, int i3) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2123971909")) {
            return Integer.valueOf(((i & 255) << 16) | ((i2 & 255) << 8) | (i3 & 255));
        }
        return (Integer) ipChange.ipc$dispatch("2123971909", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)});
    }
}
