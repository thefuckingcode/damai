...
public class SVGPaintData extends a {
    ...
    private void interceptColor(Paint paint, int i, List<h32> list) {
        IpChange ipChange = $ipChange;
    ...
    public Picture buildPicture(boolean z) {
        ...
        if (!this.isViewBoxBounds) {
            ...
            beginRecording.clipRect(0.0f, 0.0f, (float) this.width, (float) this.height);
                    ...
                    if (paint != null) {
                        ...
                        if (hashMap == null || (str = sVGRect.floorId) == null) {
                            ...
                            if (hashMap2 == null || sVGRect.rowId == null) {
                                ...
                                if (hashMap3 != null) {
                                    String str5 = hashMap3.get(sVGRect.rowId);
                    ...
                    if (paint4 != null) {
                        ...
                        if (hashMap4 == null || (str2 = sVGOval.floorId) == null) {
                            ...
                            if (hashMap5 == null || sVGOval.rowId == null) {
                                ...
                                if (hashMap6 != null) {
                                    String str7 = hashMap6.get(sVGOval.rowId);
                    ...
                    if (paint6 != null) {
                        ...
                        if (hashMap7 == null || (str3 = sVGPolygon.floorId) == null) {
                            ...
                            if (hashMap8 == null || sVGPolygon.rowId == null) {
                                ...
                                if (hashMap9 != null) {
                                    String str9 = hashMap9.get(sVGPolygon.rowId);
                            ...
                            String str10 = hashMap7.get(str3);
                    ...
                    if (paint8 != null) {
                        ...
                        if (hashMap10 == null || (str4 = sVGPath.floorId) == null) {
                            ...
                            if (hashMap11 == null || sVGPath.rowId == null) {
                                ...
                                if (hashMap12 != null) {
                                    String str11 = hashMap12.get(sVGPath.rowId);
                            ...
                            String str12 = hashMap10.get(str4);
    ...
    public Picture buildPriceFilterPicture2(SeatPrice seatPrice, RegionData regionData) {
        ...
        } else if (seatPrice == null || regionData == null) {
            return null;
        } else {
            Picture picture = new Picture();
            if (this.shapeList.isEmpty()) {
    ...
    public Picture buildStrokePicture(List<SeatPrice> list, RegionData regionData) {
        ...
        } else if (list == null || list.isEmpty() || regionData == null || this.shapeList.isEmpty()) {
            return null;
        } else {
            Picture picture = new Picture();
            resetPaintData();
    ...
    public int getRegionCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1890404154")) {
            return regionCount(this.rectList) + 0 + regionCount(this.ovalList) + regionCount(this.pathList) + regionCount(this.polygonList);
        }
        return ((Integer) ipChange.ipc$dispatch("-1890404154", new Object[]{this})).intValue();
    }

    @Override // cn.damai.commonbusiness.seatbiz.view.render.a
    public int getShapeCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "932380129")) {
            return xf2.e(this.rectList) + 0 + xf2.e(this.lineList) + xf2.e(this.ovalList) + xf2.e(this.pathList) + xf2.e(this.polygonList) + xf2.e(this.textList);
        }
        return ((Integer) ipChange.ipc$dispatch("932380129", new Object[]{this})).intValue();
    }

    public List<String> getUnrecognizedCommandList() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1815249011")) {
            return this.unrecognizedCommandList;
        }
        return (List) ipChange.ipc$dispatch("1815249011", new Object[]{this});
    }
    ...
    public Picture buildPicture() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "375698435")) {
            return buildPicture(false);
        }
        return (Picture) ipChange.ipc$dispatch("375698435", new Object[]{this});
    }
    ...
    public Picture buildPicture(@NonNull i32 i32) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1835930051")) {
            return (Picture) ipChange.ipc$dispatch("-1835930051", new Object[]{this, i32});
        }
        Picture picture = new Picture();
        if (this.shapeList.isEmpty()) {
            return picture;
