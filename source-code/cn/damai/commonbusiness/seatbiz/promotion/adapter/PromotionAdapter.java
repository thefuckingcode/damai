...
public class PromotionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final class ProjectPromotionViewHolder extends RecyclerView.ViewHolder {
        ...
        public void a(PromotionGroupBean promotionGroupBean) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-566470497")) {
            ...
            } else if (promotionGroupBean == null || TextUtils.isEmpty(promotionGroupBean.promotionGroupTypeDesc) || f92.d(promotionGroupBean.promotionList)) {
                ...
                for (GroupItemBean groupItemBean : promotionGroupBean.promotionList) {
                    if (groupItemBean != null && !f92.d(groupItemBean.promotionContentList) && !TextUtils.isEmpty(groupItemBean.promotionTag)) {
    ...
    private void a() {
        ...
        if (xf2.e(this.d) + xf2.e(this.e) > 0) {
            this.k++;
        ...
        for (int i2 = 0; i2 < e2; i2++) {
            CouponActivityBean couponActivityBean = this.e.get(i2);
    ...
    public int getItemViewType(int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "223510987")) {
            return ((Integer) ipChange.ipc$dispatch("223510987", new Object[]{this, Integer.valueOf(i2)})).intValue();
        }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1234246315")) {
            ipChange.ipc$dispatch("-1234246315", new Object[]{this, viewHolder, Integer.valueOf(i2)});
            return;
        }
        ...
        if (obj != null) {
            if (itemViewType == 1) {
                ((ProjectProfitViewHolder) viewHolder).g((CouponActivityBean) obj, this.h, this.i, this.j, i2 - this.k);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1461407809")) {
            return (RecyclerView.ViewHolder) ipChange.ipc$dispatch("1461407809", new Object[]{this, viewGroup, Integer.valueOf(i2)});
        } else if (i2 == 1) {
