...
public class HorizontalSimpleDateAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private static transient /* synthetic */ IpChange $ipChange;
        private View a = this.itemView.findViewById(R$id.left_view);
        private View b = this.itemView.findViewById(R$id.right_view);
        private View c = this.itemView.findViewById(R$id.view_bg);
        private TextView d = ((TextView) this.itemView.findViewById(R$id.tv_week));
        private TextView e = ((TextView) this.itemView.findViewById(R$id.tv_tag));
        private TextView f = ((TextView) this.itemView.findViewById(R$id.tv_date));
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "835780759")) {
            return new ViewHolder();
        }
        return (ViewHolder) ipChange.ipc$dispatch("835780759", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
