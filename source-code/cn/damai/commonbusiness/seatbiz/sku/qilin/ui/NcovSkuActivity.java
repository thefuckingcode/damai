...
public class NcovSkuActivity extends SimpleBaseActivity {
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2118379206")) {
            return R$layout.activity_sku_ncov;
        }
        return ((Integer) ipChange.ipc$dispatch("2118379206", new Object[]{this})).intValue();
    }
    ...
    public void initView() {
        ...
        setDamaiUTKeyBuilder(wb2.i().l(this.mItemId));
        c.e().K(this);
