...
public class HorizontalCanlendarAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private static transient /* synthetic */ IpChange $ipChange;
        private TextView a = ((TextView) this.itemView.findViewById(R$id.tv_date));
        ...
        public void a(MonthEntity monthEntity, int i) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-448074209")) {
                ...
                if (monthEntity.isShowYear) {
                    ...
                    textView.setText(monthEntity.year + "年" + xe.e(monthEntity.month) + "月");
                } else {
                    TextView textView2 = this.a;
                    textView2.setText(xe.e(monthEntity.month) + "月");
                }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "60947413")) {
            return new ViewHolder();
        }
        return (ViewHolder) ipChange.ipc$dispatch("60947413", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
