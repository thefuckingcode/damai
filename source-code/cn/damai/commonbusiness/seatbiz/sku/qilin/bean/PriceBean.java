...
public class PriceBean extends PromotionTag {
    ...
    public boolean isTypePromotion() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-501546834")) {
            return this.packagesFlag || this.hasPromotion;
        }
        return ((Boolean) ipChange.ipc$dispatch("-501546834", new Object[]{this})).booleanValue();
    }
