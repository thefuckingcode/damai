...
public class SkuPrice {
    ...
    public boolean isCanShowDashPrice() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-544719597")) {
            return ((Boolean) ipChange.ipc$dispatch("-544719597", new Object[]{this})).booleanValue();
        } else if (TextUtils.isEmpty(this.dashPrice) || getOriginPrice() == this.price) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean isSelected() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2050570942")) {
            return this.isSelected;
        }
        return ((Boolean) ipChange.ipc$dispatch("-2050570942", new Object[]{this})).booleanValue();
    }
