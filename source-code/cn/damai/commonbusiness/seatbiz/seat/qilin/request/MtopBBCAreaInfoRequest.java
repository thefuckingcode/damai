...
public class MtopBBCAreaInfoRequest extends DMBaseMtopRequest {
    ...
    public String getApiName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-802632541")) {
            return "mtop.damai.wireless.project.getB2B2CAreaInfo";
        }
        return (String) ipChange.ipc$dispatch("-802632541", new Object[]{this});
    }
    ...
    public String getVersion() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1365104182")) {
            return i9.b().a();
        }
        return (String) ipChange.ipc$dispatch("1365104182", new Object[]{this});
    }
