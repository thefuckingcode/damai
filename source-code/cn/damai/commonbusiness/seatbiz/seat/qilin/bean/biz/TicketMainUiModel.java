...
public class TicketMainUiModel implements Serializable {
    ...
    public boolean isTicketPriceModel() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1824806902")) {
            return TextUtils.equals("1", this.moduleType);
        }
        return ((Boolean) ipChange.ipc$dispatch("1824806902", new Object[]{this})).booleanValue();
    }
}
