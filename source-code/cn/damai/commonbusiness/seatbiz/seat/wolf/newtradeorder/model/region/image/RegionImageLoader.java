...
public class RegionImageLoader implements IRegionImageCallback {
    ...
    public static class SVGUrl {
        public final l32 assist;
        public final boolean isRainBowUrl;
        public final String url;

        public SVGUrl(String str, l32 l32, boolean z) {
            this.url = str;
            this.assist = l32;
            this.isRainBowUrl = z;
        }
    ...
    private void addImageLoadListener(SVGUrl sVGUrl, OnRegionImageLoadListener onRegionImageLoadListener) {
        ...
        RegionImageData regionImageData = null;
        String str = sVGUrl.url;
        if (this.mRegionImageResultList.get(str) != null) {
            regionImageData = this.mRegionImageResultList.get(str).get();
        }
    ...
    private String[] buildRegionImageUrl(RegionData regionData) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1883826284")) {
            ...
            boolean isSVGRegion2 = isSVGRegion(regionData);
            this.isSVGRegion = isSVGRegion2;
            if (isSVGRegion2) {
    ...
    private String unEnableHttpsValidation(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "361117148")) {
            return (!TextUtils.isEmpty(str) && AppConfig.g() == AppConfig.EnvMode.test && str.startsWith("https://sseat.damai.test")) ? str.replace("https://sseat.damai.test", "https://sseat.damai.test") : str;
        }
        return (String) ipChange.ipc$dispatch("361117148", new Object[]{this, str});
    }
    ...
    public boolean isOSSRegionImageEnable() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2070140057")) {
            return this.isOSSRegionImageEnable;
        }
        return ((Boolean) ipChange.ipc$dispatch("-2070140057", new Object[]{this})).booleanValue();
    }
