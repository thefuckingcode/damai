...
public abstract class DamaiBaseActivity<T extends cn.damai.common.app.base.a, E extends BaseModel> extends BaseActivity<T, E> implements ResponseErrorPage.ErrorRefreshListener, IBaseActivityProxy {
    ...
    public DamaiBaseMvpFragment getCurFragment() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-628323380")) {
            return this.currentFragment;
        }
        return (DamaiBaseMvpFragment) ipChange.ipc$dispatch("-628323380", new Object[]{this});
    }

    public a.b getDamaiUTKeyBuilder() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1730864878")) {
            return this.mBuilder;
        }
        return (a.b) ipChange.ipc$dispatch("-1730864878", new Object[]{this});
    }

    public ScreenShotBean getDetectBean(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-556941554")) {
            return ScreenShotDetector.k().r(str);
        }
        return (ScreenShotBean) ipChange.ipc$dispatch("-556941554", new Object[]{this, str});
    }
    ...
    /* access modifiers changed from: protected */
    @Override // androidx.activity.ComponentActivity, androidx.core.app.ComponentActivity, androidx.fragment.app.FragmentActivity, cn.damai.common.app.base.BaseActivity
    public void onCreate(@Nullable Bundle bundle) {
        ...
        kn0 kn0 = kn0.fragmentXFixer;
        kn0.b(this, bundle);
        if (getIntent() != null) {
            kn0.b(this, getIntent().getExtras());
        }
    ...
    /* access modifiers changed from: protected */
    @Override // androidx.fragment.app.FragmentActivity, cn.damai.common.app.base.BaseActivity
    public void onPause() {
