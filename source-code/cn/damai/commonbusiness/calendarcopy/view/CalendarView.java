...
public class CalendarView extends ViewGroup {
    ...
    private void rePaintView() {
        ...
        this.mWidth = i;
        int a = (i - l42.a(this.mContext, 18.0f)) / 7;
        this.mDayWidth = a;
        this.mDayHeigth = (((a - 6) * 56) / 45) + l42.a(this.mContext, 16.0f);
        this.mDayHeigth = Math.max(l42.a(this.mContext, 82.0f), this.mDayHeigth);
        ...
        for (int i2 = 0; i2 < this.mDays.size(); i2++) {
            ...
            if (day != null) {
                ...
                View b = d30.a().b(this.mContext, day);
                b.setTag(day);
                b.setOnClickListener(this.mItemClickListener);
                addView(b);
                int i3 = R$id.view_bg;
                b.findViewById(i3).getLayoutParams().width = this.mDayWidth - l42.a(this.mContext, 6.0f);
                b.findViewById(i3).getLayoutParams().height = this.mDayHeigth - l42.a(this.mContext, 16.0f);
                int i4 = R$id.view_long_select;
                b.findViewById(i4).getLayoutParams().width = this.mDayWidth;
                b.findViewById(i4).getLayoutParams().height = this.mDayHeigth - l42.a(this.mContext, 16.0f);
                ...
                if (day.selectType > 0) {
                    ...
                    boolean z = i6 == instance.getActualMaximum(5);
                    if ((z && day.selectType == 4 && i5 == 1) || (i6 == 1 && day.selectType == 4 && i5 == 7)) {
                        ...
                        if ((i7 == 2 && z) || ((i7 == 2 && i5 == 7) || ((i7 == 3 && i5 == 1) || (i7 == 3 && i6 == 1)))) {
                            ...
                            frameLayout.setPadding(l42.a(this.mContext, 3.0f), 0, 0, 0);
                            ...
                            frameLayout.setPadding(0, 0, l42.a(this.mContext, 3.0f), 0);
    ...
    public int getDayWidth() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1478762258")) {
            return this.mDayWidth;
        }
        return ((Integer) ipChange.ipc$dispatch("-1478762258", new Object[]{this})).intValue();
    }

    public int[] getLocation() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-117164556")) {
            return (int[]) ipChange.ipc$dispatch("-117164556", new Object[]{this});
        }
        return new int[]{this.mBubbleRow, this.mBubbleColumn};
    }

    public String getProjectTag() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-7145028")) {
            return this.mProjectTag;
        }
        return (String) ipChange.ipc$dispatch("-7145028", new Object[]{this});
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int a = l42.a(this.mContext, 9.0f);
    ...
    public void setMonth(int i, int i2, List<Day> list, CalendarMonthBean calendarMonthBean, View.OnClickListener onClickListener) {
        ...
        this.mYear = i;
        this.mMonth = i2;
        this.mIsCurrentMonth = we.r(i, i2);
        this.mDays = we.c(i, i2, list, calendarMonthBean);
        this.mStartWeek = we.h(i, i2);
