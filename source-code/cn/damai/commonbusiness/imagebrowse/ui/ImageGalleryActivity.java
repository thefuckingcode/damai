...
public class ImageGalleryActivity extends SimpleBaseActivity {
    ...
    public class ImageAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            ...
            int i2 = this.c;
            roundImageView.setLayoutParams(new RecyclerView.LayoutParams(i2, (int) (((double) i2) * 0.75d)));
    ...
    public class ItemDecoration extends RecyclerView.ItemDecoration {
        ...
        public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
            ...
            if (childAdapterPosition >= this.b) {
                rect.top = s50.a(view.getContext(), 12.0f);
            }
        }
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        this.recyclerView.addItemDecoration(new ItemDecoration(this, s50.a(this, 6.0f), 2));
        this.recyclerView.setAdapter(new ImageAdapter(initExtraData(), this, (DisplayMetrics.getwidthPixels(getResources().getDisplayMetrics()) - s50.a(this, 54.0f)) / 2));
    ...
    public String setTitle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-355709653")) {
            return "全部剧照";
        }
        return (String) ipChange.ipc$dispatch("-355709653", new Object[]{this});
    }
}
