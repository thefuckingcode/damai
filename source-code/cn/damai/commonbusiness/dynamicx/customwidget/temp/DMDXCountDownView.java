...
public class DMDXCountDownView extends LinearLayout {
        ...
        public void handleMessage(Message message) {
            ...
            if (dMDXCountDownView != null && message.what == 101) {
                ...
                if (obj != null) {
                    ...
                    g91.b("DMDXCountDownView", "handleMessage");
                }
    ...
    public DMDXCountDownView(Context context2) {
        this(context2, null);
    }
    ...
    private void countDown() {
        ...
        Thread thread = new Thread(new Runnable() {
            /* class cn.damai.commonbusiness.dynamicx.customwidget.temp.DMDXCountDownView.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-387581550")) {
                    ipChange.ipc$dispatch("-387581550", new Object[]{this});
                    return;
                }
                while (DMDXCountDownView.this.isContinue) {
                    try {
                        ...
                        String[] b = xr.b(DMDXCountDownView.this.timeStamp);
                        Message message = new Message();
                        message.obj = b;
                        message.what = 101;
                        DMDXCountDownView.this.myHandler.sendMessage(message);
                        Thread.sleep(1000);
                        g91.b("DMDXCountDownView", "timeStamp = " + DMDXCountDownView.this.timeStamp);
                    } catch (Exception e) {
                        e.printStackTrace();
                        return;
                    }
    ...
    private int parseColor(String str) {
        ...
        try {
            ...
            g91.b("DMDXCountDownView", e.getMessage());
            return 0;
        }
    }
    ...
    public void dispatchVisibilityChanged(View view, int i) {
        ...
        if (i == 4) {
            ...
            g91.c("DMDXCountDownView", "onVisibilityChanged INVISIBLE");
            pauseCountDown();
            return;
        }
        ...
        sb.append(j);
        g91.c("DMDXCountDownView", sb.toString());
    ...
    public long getCountTime() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-247450930")) {
            return this.originalTime;
        }
        return ((Long) ipChange.ipc$dispatch("-247450930", new Object[]{this})).longValue();
    }
    ...
    public void setCountDownEndListener(CountDownEndListener countDownEndListener2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-564544864")) {
            ipChange.ipc$dispatch("-564544864", new Object[]{this, countDownEndListener2});
            return;
        }
    ...
    public DMDXCountDownView setHourColonTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "444888704")) {
            return setHourColonTvBackgroundColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("444888704", new Object[]{this, str});
    }
    ...
    public DMDXCountDownView setHourColonTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-594828639")) {
            return setHourColonTvTextColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("-594828639", new Object[]{this, str});
    }
    ...
    public DMDXCountDownView setHourTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1596768803")) {
            return setHourTvBackgroundColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("-1596768803", new Object[]{this, str});
    }

    public DMDXCountDownView setHourTvBackgroundColorWithRadius(String str, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-310171524")) {
            return setHourTvBackgroundColorWithRadius(parseColor(str), i);
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("-310171524", new Object[]{this, str, Integer.valueOf(i)});
    }
    ...
    public DMDXCountDownView setHourTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1508275134")) {
            return setHourTvTextColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("1508275134", new Object[]{this, str});
    }
    ...
    public DMDXCountDownView setMinuteColonTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-179609744")) {
            return setMinuteColonTvBackgroundColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("-179609744", new Object[]{this, str});
    }
    ...
    public DMDXCountDownView setMinuteColonTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1831862161")) {
            return setMinuteColonTvTextColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("1831862161", new Object[]{this, str});
    }
    ...
    public DMDXCountDownView setMinuteTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "616201965")) {
            return setMinuteTvBackgroundColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("616201965", new Object[]{this, str});
    }
    ...
    public DMDXCountDownView setMinuteTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1470644018")) {
            return setMinuteTvTextColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("-1470644018", new Object[]{this, str});
    }
    ...
    public DMDXCountDownView setSecondTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1357994867")) {
            return setSecondTvBackgroundColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("-1357994867", new Object[]{this, str});
    }

    public DMDXCountDownView setSecondTvBackgroundColorWidthRadius(String str, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1794182928")) {
            return setSecondTvBackgroundColorWidthRadius(parseColor(str), i);
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("-1794182928", new Object[]{this, str, Integer.valueOf(i)});
    }
    ...
    public DMDXCountDownView setSecondTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-140468626")) {
            return setSecondTvTextColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("-140468626", new Object[]{this, str});
    }
    ...
    public DMDXCountDownView setTimeTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-991882924")) {
            return setTimeTvBackgroundColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("-991882924", new Object[]{this, str});
    }

    public DMDXCountDownView setTimeTvBackgroundColorWidthRadius(String str, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "779709239")) {
            return setTimeTvBackgroundColorWidthRadius(parseColor(str), i);
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("779709239", new Object[]{this, str, Integer.valueOf(i)});
    }
    ...
    public DMDXCountDownView setTimeTvFontName(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            bn0.b(this.hourTv, str);
            bn0.b(this.minuteTv, str);
            bn0.b(this.secondTv, str);
        }
        return this;
    }
    ...
    public DMDXCountDownView setTimeTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1138355317")) {
            return setTimeTvTextColor(parseColor(str));
        }
        return (DMDXCountDownView) ipChange.ipc$dispatch("1138355317", new Object[]{this, str});
    }
    ...
    public DMDXCountDownView(Context context2, @Nullable AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public DMDXCountDownView(Context context2, @Nullable AttributeSet attributeSet, int i) {
