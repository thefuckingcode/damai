...
public class DMUltronSellView extends FrameLayout {
    ...
    public void setItemSellDesc(String str, String str2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "585821957")) {
            ...
            spannableStringBuilder.setSpan(new qw1(ContextCompat.getColor(context, i), ContextCompat.getColor(this.mContext, i), n42.a(this.mContext, 12.0f)), 0, str2.length(), 17);
