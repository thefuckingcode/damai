...
public class HomeCustomTabView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        this.mItemMaxSize = DisplayMetrics.getwidthPixels(v50.b(context)) / 5;
    }
    ...
    private void setViewSize(Bitmap bitmap) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1323940880")) {
            ...
            int a = v50.a(getContext(), (float) (bitmap.getWidth() / 3));
            int a2 = v50.a(getContext(), (float) (bitmap.getHeight() / 3));
