...
public class a {
    ...
    /* compiled from: Taobao */
    public class C0021a implements Comparator<BottomSheetBean.Result> {
        private static transient /* synthetic */ IpChange $ipChange;
        ...
        public int compare(BottomSheetBean.Result result, BottomSheetBean.Result result2) {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "-767855882")) {
                return this.a.indexOf(result.type) - this.a.indexOf(result2.type);
            }
            return ((Integer) ipChange.ipc$dispatch("-767855882", new Object[]{this, result, result2})).intValue();
        }
    }
    ...
    private static void a(List<TabItem> list, List<BottomSheetBean.Result> list2) {
        ...
        Collections.sort(list2, new C0021a(arrayList));
    }
    ...
    public static String b(@Nullable BottomSheetBean bottomSheetBean) {
        ...
        } else if (bottomSheetBean == null || f92.d(bottomSheetBean.content)) {
            return null;
        } else {
    ...
    private static String f(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1521979902")) {
            return TextUtils.isEmpty(str) ? "" : str;
        }
        return (String) ipChange.ipc$dispatch("1521979902", new Object[]{str});
    }
