...
public class BottomSheetBean implements Parcelable {
    ...
    public static class Result implements Parcelable {
        ...
        public class a implements Parcelable.Creator<Result> {
            ...
            public Result createFromParcel(Parcel parcel) {
                ...
                if (!AndroidInstantRuntime.support(ipChange, "-959344821")) {
                    return new Result(parcel);
                }
                return (Result) ipChange.ipc$dispatch("-959344821", new Object[]{this, parcel});
            }

            /* renamed from: b */
            public Result[] newArray(int i) {
                IpChange ipChange = $ipChange;
                if (!AndroidInstantRuntime.support(ipChange, "2092515118")) {
                    return new Result[i];
                }
                return (Result[]) ipChange.ipc$dispatch("2092515118", new Object[]{this, Integer.valueOf(i)});
            }
        }
    ...
    public class a implements Parcelable.Creator<BottomSheetBean> {
        ...
        public BottomSheetBean createFromParcel(Parcel parcel) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "1918746881")) {
                return new BottomSheetBean(parcel);
            }
            return (BottomSheetBean) ipChange.ipc$dispatch("1918746881", new Object[]{this, parcel});
        }

        /* renamed from: b */
        public BottomSheetBean[] newArray(int i) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-101719376")) {
                return new BottomSheetBean[i];
            }
            return (BottomSheetBean[]) ipChange.ipc$dispatch("-101719376", new Object[]{this, Integer.valueOf(i)});
        }
    }
