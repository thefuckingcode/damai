...
public class ShareActivity extends DamaiBaseActivity {
    ...
    private void initExtra() {
        ...
        if (extras == null) {
            toast(bk2.b(this, R$string.damai_sharesina_parameter_error_toast));
            finish();
            return;
        }
        ...
        if (id == R$id.share_sina_btn) {
            ...
            if (yt2.b(this, false)) {
                if (this.shareUtil.checkSharetype()) {
                    ...
                    toast(bk2.b(this, R$string.damai_share_circle_load_toast));
                }
                finish();
            }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.share_title = bk2.a(this, R$array.share_title);
        this.context = this;
        initExtra();
        initView();
    }
