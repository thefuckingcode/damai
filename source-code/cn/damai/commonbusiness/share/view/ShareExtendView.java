...
public class ShareExtendView extends LinearLayout {
    ...
    public TextView getExtendTextView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "495330650")) {
            return this.mExtendViewText;
        }
        return (TextView) ipChange.ipc$dispatch("495330650", new Object[]{this});
    }

    public DMIconFontTextView getExtendViewIcon() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1430308951")) {
            return this.mExtendViewIcon;
        }
        return (DMIconFontTextView) ipChange.ipc$dispatch("-1430308951", new Object[]{this});
    }

    public ImageView getExtendViewImage() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1196756268")) {
            return this.mExtendViewImage;
        }
        return (ImageView) ipChange.ipc$dispatch("-1196756268", new Object[]{this});
    }

    public RelativeLayout getIconFontBackgroundView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1668657543")) {
            return this.mIconFontBackground;
        }
        return (RelativeLayout) ipChange.ipc$dispatch("1668657543", new Object[]{this});
    }

    public LinearLayout getShareItemLayout() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1555544589")) {
            return this;
        }
        return (LinearLayout) ipChange.ipc$dispatch("-1555544589", new Object[]{this});
    }
