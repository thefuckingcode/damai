...
public class RadiusCoverView extends View {
    ...
    private Bitmap drawRect(int i, int i2) {
        ...
        canvas.drawRect(new RectF(0.0f, 0.0f, (float) i3, (float) i3), paint);
        int height = getHeight();
        int i4 = this.leftBottomRadians;
        canvas.drawRect(new RectF(0.0f, (float) (height - i4), (float) i4, (float) getHeight()), paint);
        canvas.drawRect(new RectF((float) (getWidth() - this.rightTopRadians), 0.0f, (float) getWidth(), (float) this.rightTopRadians), paint);
        canvas.drawRect(new RectF((float) (getWidth() - this.rightBottomRadians), (float) (getHeight() - this.rightBottomRadians), (float) getWidth(), (float) getHeight()), paint);
        return createBitmap;
    }
    ...
    private Bitmap drawSector(int i, int i2) {
        ...
        int i3 = this.leftTopRadians;
        canvas.drawArc(new RectF(0.0f, 0.0f, (float) (i3 * 2), (float) (i3 * 2)), 180.0f, 90.0f, true, paint);
        int height = getHeight();
        int i4 = this.leftBottomRadians;
        canvas.drawArc(new RectF(0.0f, (float) (height - (i4 * 2)), (float) (i4 * 2), (float) getHeight()), 90.0f, 90.0f, true, paint);
        canvas.drawArc(new RectF((float) (getWidth() - (this.rightTopRadians * 2)), 0.0f, (float) getWidth(), (float) (this.rightTopRadians * 2)), 270.0f, 90.0f, true, paint);
        canvas.drawArc(new RectF((float) (getWidth() - (this.rightBottomRadians * 2)), (float) (getHeight() - (this.rightBottomRadians * 2)), (float) getWidth(), (float) getHeight()), 0.0f, 90.0f, true, paint);
        return createBitmap;
    }
