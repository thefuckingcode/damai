...
public class NestScrollErrResView extends NestedScrollView {
    ...
    public boolean isShowLoginView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "97471501")) {
            return this.state == 2;
        }
        return ((Boolean) ipChange.ipc$dispatch("97471501", new Object[]{this})).booleanValue();
    }
    ...
    public NestScrollErrResView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.width = m42.a(context, 180.0f);
        this.paddingTop = m42.a(context, 40.0f);
