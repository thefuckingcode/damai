...
public class StatePagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment a() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1486113018")) {
            return this.b;
        }
        return (Fragment) ipChange.ipc$dispatch("-1486113018", new Object[]{this});
    }
    ...
    public Fragment getItem(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "935117348")) {
            return this.a.get(i);
        }
        return (Fragment) ipChange.ipc$dispatch("935117348", new Object[]{this, Integer.valueOf(i)});
    }
