...
public class DMPopLayer extends PopLayer {
        ...
        public boolean execute(String str, String str2, WVCallBackContext wVCallBackContext) {
            ...
            try {
                ...
                if ("getClipboardContent".equals(str)) {
                    ...
                    jSONObject.put("isSupportGif", ms0.a());
                ...
                cr1.c("WVTBPopLayerPlugin.execute.error", th);
                wVCallBackContext.error();
                return false;
            }
        }
    ...
    public DMPopLayer() {
        super(new mq(), new DMConfigAdapter(2, "android_poplayer"), new DMConfigAdapter(1, "android_poplayer_app"), new DMConfigAdapter(3, "android_poplayer_view"), new DMLayerMgrAdapter());
    }
    ...
    public String getActivityInfo(Activity activity) {
        ...
        } else if (activity.getClass().getName().equals(H5MainActivity.class)) {
    ...
    public String onGenarateAdapterVersion() {
        ...
        try {
            ...
            cr1.c("DMPopLayer.setup.adapter_version.error", th);
            return "";
        }
    }
