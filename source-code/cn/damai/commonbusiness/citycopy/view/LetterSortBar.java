...
public class LetterSortBar extends AppCompatTextView {
    ...
    private int dip2px(int i) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "879559741")) {
            return (int) ((((float) i) * this.mDensity) + 0.5f);
        }
        return ((Integer) ipChange.ipc$dispatch("879559741", new Object[]{this, Integer.valueOf(i)})).intValue();
    }

    private int getLettersSize() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "816501251")) {
            return getListSize(this.mLetters);
        }
        return ((Integer) ipChange.ipc$dispatch("816501251", new Object[]{this})).intValue();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        float f2;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "570483232")) {
            ipChange.ipc$dispatch("570483232", new Object[]{this, canvas});
            return;
        }
        onSizeChange();
        int i = 0;
