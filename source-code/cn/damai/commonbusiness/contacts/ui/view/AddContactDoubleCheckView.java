...
public class AddContactDoubleCheckView extends FrameLayout {
    ...
    public void setData(List<a> list) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-249773697")) {
            ...
            String str = "";
            this.mNameTipTv.setText(list.get(0).a == null ? str : list.get(0).a);
            this.mNameDataTv.setText(list.get(0).b == null ? str : list.get(0).b);
            this.mCardTypeTipTv.setText(list.get(1).a == null ? str : list.get(1).a);
            this.mCardTypeDataTv.setText(list.get(1).b == null ? str : list.get(1).b);
            this.mCardNumTipTv.setText(list.get(2).a == null ? str : list.get(2).a);
            this.mCardNumDataTv.setText(list.get(2).b == null ? str : list.get(2).b);
            if (list.size() > 3) {
                this.mRenewalNumberLl.setVisibility(0);
                this.mRenewalNumberTipTv.setText(list.get(3).a == null ? str : list.get(3).a);
                TextView textView = this.mRenewalNumberDataTv;
                if (list.get(3).b != null) {
                    str = list.get(3).b;
                }
