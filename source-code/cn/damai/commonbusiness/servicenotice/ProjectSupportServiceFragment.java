...
public class ProjectSupportServiceFragment extends DamaiBaseMvpFragment {
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1196307950")) {
            return R$layout.layout_service_notice;
        }
        return ((Integer) ipChange.ipc$dispatch("1196307950", new Object[]{this})).intValue();
    }
