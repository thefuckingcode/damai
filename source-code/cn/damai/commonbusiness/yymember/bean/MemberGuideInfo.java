...
public class MemberGuideInfo implements Serializable {
    ...
    public boolean isStatusJustAuthor() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-174029717")) {
            return TextUtils.equals(authorize, getDailyBindMemberStatus());
        }
        return ((Boolean) ipChange.ipc$dispatch("-174029717", new Object[]{this})).booleanValue();
    }

    public boolean isStatusJustBind() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1914576825")) {
            return TextUtils.equals("bind", getDailyBindMemberStatus());
        }
        return ((Boolean) ipChange.ipc$dispatch("1914576825", new Object[]{this})).booleanValue();
    }

    public boolean isStatusNotBind() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-79444352")) {
            return TextUtils.equals(notBind, getDailyBindMemberStatus());
        }
        return ((Boolean) ipChange.ipc$dispatch("-79444352", new Object[]{this})).booleanValue();
    }

    public boolean isValid4DailyBind() {
        GuideInfo guideInfo;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-2097033856")) {
            return ((Boolean) ipChange.ipc$dispatch("-2097033856", new Object[]{this})).booleanValue();
        }
        return (TextUtils.isEmpty(this.tipType) || (guideInfo = this.info) == null || guideInfo.detail == null) ? false : true;
    }
}
