...
public class FaceVerifyFailedActivity extends DamaiBaseActivity {
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1825304133")) {
            return R$layout.realname_faceverify_failed_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("-1825304133", new Object[]{this})).intValue();
    }
