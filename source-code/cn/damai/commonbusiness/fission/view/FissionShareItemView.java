...
public class FissionShareItemView extends LinearLayout {
    ...
    public FissionShareItemView(Context context2) {
        this(context2, null);
    }
    ...
    public FissionShareItemView(Context context2, AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public FissionShareItemView(Context context2, AttributeSet attributeSet, int i) {
        super(context2, attributeSet, i);
        this.context = context2;
        setOrientation(1);
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, R$styleable.fissionAttrs);
