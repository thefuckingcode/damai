...
public class DMRGBUtil {
    ...
    public static int f(Bitmap bitmap) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1107405569")) {
            return e(1.0f, bitmap);
        }
        return ((Integer) ipChange.ipc$dispatch("1107405569", new Object[]{bitmap})).intValue();
    }
    ...
    public static void g(@FloatRange(from = 0.0d, to = 1.0d) final float f, final Bitmap bitmap, @NonNull final String str, final OnFetchColorListener onFetchColorListener) {
        ...
        if (TextUtils.isEmpty(str) || (num = b.get(xf2.f(str))) == null || num.intValue() == 0) {
            ns1.a(new PriorityTask("TASK_FETCH_IMAGE_ALL_PIXEL_AVERAGE_COLOR", null) {
                /* class cn.damai.commonbusiness.util.DMRGBUtil.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // cn.damai.common.util.PriorityTask
                public void doTask() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "564386548")) {
                        ipChange.ipc$dispatch("564386548", new Object[]{this});
                        return;
                    }
                    final int e = DMRGBUtil.e(f, bitmap);
                    if (!TextUtils.isEmpty(str)) {
                        DMRGBUtil.b.put(xf2.f(str), Integer.valueOf(e));
                    }
                    DMRGBUtil.a.post(new Runnable() {
                        /* class cn.damai.commonbusiness.util.DMRGBUtil.AnonymousClass1.AnonymousClass1 */
                        private static transient /* synthetic */ IpChange $ipChange;

                        public void run() {
                            IpChange ipChange = $ipChange;
                            if (AndroidInstantRuntime.support(ipChange, "1038728718")) {
                                ipChange.ipc$dispatch("1038728718", new Object[]{this});
                                return;
                            }
                            onFetchColorListener.onFetchColor(e);
                            g91.b("TASK_FETCH_IMAGE_ALL_PIXEL_AVERAGE_COLOR", "fetch color");
                        }
                    });
                }
            });
        ...
        g91.b("TASK_FETCH_IMAGE_ALL_PIXEL_AVERAGE_COLOR", "cache color");
    }
