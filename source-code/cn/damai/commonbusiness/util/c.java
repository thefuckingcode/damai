...
public abstract class c implements Bitmap12ColorHex.OnHexColorListener {
    ...
    public void onHexColor(String str) {
        ...
        char c = 1;
        if (AndroidInstantRuntime.support(ipChange, "-365989342")) {
            ipChange.ipc$dispatch("-365989342", new Object[]{this, str});
            ...
            switch (c) {
                case 0:
                case 1:
                    i = R$drawable.bg_b_card_blue_3;
                    break;
                case 2:
                case 6:
                    i = R$drawable.bg_b_card_green_3;
                    break;
                case 3:
                case 4:
                case 5:
                case 7:
                    i = R$drawable.bg_b_card_purple_default_3;
                    break;
                case '\b':
                case '\t':
                    i = R$drawable.bg_b_card_red_3;
                    break;
                case '\n':
                case 11:
                    i = R$drawable.bg_b_card_yellow_3;
                    break;
                default:
                    i = R$drawable.bg_b_card_purple_default_3;
                    break;
