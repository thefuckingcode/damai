...
public class CircleAdapter extends RecyclerView.Adapter<CircleCardViewHolder> {
    ...
    public CircleCardViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1963045958")) {
            return new CircleCardViewHolder(viewGroup, this.b);
        }
        return (CircleCardViewHolder) ipChange.ipc$dispatch("-1963045958", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
