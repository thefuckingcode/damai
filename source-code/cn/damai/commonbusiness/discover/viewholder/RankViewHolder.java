...
public class RankViewHolder extends BaseViewHolder<RankBean> implements View.OnClickListener {
    ...
    private DMPosterView c = ((DMPosterView) this.itemView.findViewById(R$id.poster_v2));
    private TextView d = ((TextView) this.itemView.findViewById(R$id.tv_title_v2));
    private TextView e = ((TextView) this.itemView.findViewById(R$id.tv_subtitle_v2));
    private TextView f = ((TextView) this.itemView.findViewById(R$id.tv_see_people_num_v2));
    private TextView g = ((TextView) this.itemView.findViewById(R$id.tv_project_num_v2));
    private TextView h = ((TextView) this.itemView.findViewById(R$id.btn_go_v2));
    private RankBean i;
    private int j;
    ...
    public void a(RankBean rankBean, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1806872091")) {
            ipChange.ipc$dispatch("-1806872091", new Object[]{this, rankBean, Integer.valueOf(i2)});
            ...
            if (rankBean.isRankListType()) {
                ...
                this.c.getLabelView().setCornerRadii((float) m42.a(this.a, 16.0f), (float) m42.a(this.a, 16.0f), (float) m42.a(this.a, 16.0f), (float) m42.a(this.a, 2.0f));
                this.c.getLabelView().setLabelHeight(m42.a(this.a, 32.0f));
                this.c.getLabelView().setLabelWidth(m42.a(this.a, 32.0f));
