...
public class CalendarBean implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "321209051")) {
            ...
            if (!rk1.a(this.dateType, calendarBean.dateType) || !rk1.a(this.startDate, calendarBean.startDate) || !rk1.a(this.endDate, calendarBean.endDate)) {
                return false;
            }
            return true;
        }
    ...
    public int hashCode() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1039119214")) {
            return ((Integer) ipChange.ipc$dispatch("-1039119214", new Object[]{this})).intValue();
        }
        return rk1.b(this.dateType, this.startDate, this.endDate);
    }
