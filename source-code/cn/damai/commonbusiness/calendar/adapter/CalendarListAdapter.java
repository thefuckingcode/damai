...
public class CalendarListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<Day> d;
    private List<CalendarEntity> e = new ArrayList();
    ...
    public void a(CalendarBean calendarBean, List<Day> list) {
        ...
        if (xf2.e(list) > 0) {
            ...
            } else if (!(this.d.get(0) == null || this.d.get(1) == null)) {
                this.d.get(0).selectType = 2;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1775867638")) {
            return new CalendarViewHolder(LayoutInflater.from(this.a));
        }
        return (RecyclerView.ViewHolder) ipChange.ipc$dispatch("-1775867638", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
}
