...
public class CalendarsResolver {
    ...
    public void b(Context context, String str, String str2, long j) {
        ...
        e(context, str, "NULL_FLAG", str2, j, 0, 0);
    }
                ...
                if (query.getCount() > 0) {
                    ...
                    while (!query.isAfterLast()) {
                        ...
                        if (j == query.getLong(query.getColumnIndex("dtstart")) && !TextUtils.isEmpty(str) && str.equals(string)) {
                            if (context.getContentResolver().delete(ContentUris.withAppendedId(Uri.parse("content://com.android.calendar/events"), (long) query.getInt(query.getColumnIndex("_id"))), null, null) == -1) {
