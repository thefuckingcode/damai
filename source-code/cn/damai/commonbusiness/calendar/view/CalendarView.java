...
public class CalendarView extends ViewGroup {
    ...
    private void rePaintView() {
        ...
        for (int i2 = 0; i2 < this.mDays.size(); i2++) {
            ...
            if (day != null) {
                ...
                View b = c30.a().b(this.mContext, day);
                b.setTag(day);
                b.setOnClickListener(this.mItemClickListener);
                addView(b);
                int i3 = R$id.view_bg;
                b.findViewById(i3).getLayoutParams().width = this.mDayWidth - s50.a(this.mContext, 6.0f);
                ...
                if (day.selectType > 0) {
                    ...
                    if ((z && day.selectType == 4 && i5 == 1) || (i6 == 1 && day.selectType == 4 && i5 == 7)) {
                        ...
                        if ((i7 == 2 && z) || ((i7 == 2 && i5 == 7) || ((i7 == 3 && i5 == 1) || (i7 == 3 && i6 == 1)))) {
                            ...
                            frameLayout.setPadding(s50.a(this.mContext, 3.0f), 0, 0, 0);
                            ...
                            frameLayout.setPadding(0, 0, s50.a(this.mContext, 3.0f), 0);
    ...
    public int getDayWidth() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "243813123")) {
            return this.mDayWidth;
        }
        return ((Integer) ipChange.ipc$dispatch("243813123", new Object[]{this})).intValue();
    }

    public int[] getLocation() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1743064703")) {
            return (int[]) ipChange.ipc$dispatch("1743064703", new Object[]{this});
        }
    ...
    public String getProjectTag() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-462363257")) {
            return this.mProjectTag;
        }
        return (String) ipChange.ipc$dispatch("-462363257", new Object[]{this});
    }
    ...
    public void setMonth(int i, int i2, List<Day> list, CalendarMonthBean calendarMonthBean, View.OnClickListener onClickListener) {
        ...
        this.mYear = i;
        this.mMonth = i2;
        this.mIsCurrentMonth = ve.r(i, i2);
        this.mDays = ve.c(i, i2, list, calendarMonthBean);
        this.mStartWeek = ve.h(i, i2);
