...
public class ImageTask extends AsyncTask<String, Void, Bitmap> {
    ...
    private static Bitmap c(Context context, String str) {
        ...
        try {
            return MediaUtils.c().e(str, 1, DisplayMetrics.getwidthPixels(v50.b(context)) / MediaUtils.e, DisplayMetrics.getwidthPixels(v50.b(context)) / MediaUtils.e);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public Bitmap doInBackground(String... strArr) {
        ...
        Bitmap bitmap = null;
        try {
            bitmap = this.b.getContentResolver().loadThumbnail(Uri.parse(strArr[0]), new Size(DisplayMetrics.getwidthPixels(v50.b(this.b)) / MediaUtils.e, DisplayMetrics.getwidthPixels(v50.b(this.b)) / MediaUtils.e), null);
        } catch (IOException e) {
            e.printStackTrace();
        }
        if (bitmap != null) {
            fe.a.put(strArr[0], bitmap);
        }
        return bitmap;
    }
