...
public class ImageAdapter extends RecyclerView.Adapter<e> {
    ...
    public class c implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "451001548")) {
                ...
                ImageAdapter.this.r(this.a);
                ImageAdapter.this.t(this.b, true, this.c, false, this.a);
            } else if (ImageAdapter.this.g == ImageAdapter.this.d.size()) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void t(e eVar, boolean z, int i, boolean z2, Image image) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "2371255")) {
            ...
            g91.c("ImageAdapter", "click选中位置=" + i + " 设置顺序数字=" + image.getShowNum());
        } else {
    ...
    public ArrayList<Image> k() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1239319048")) {
            return this.b;
        }
        return (ArrayList) ipChange.ipc$dispatch("-1239319048", new Object[]{this});
    }

    public ArrayList<Image> l() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2093386958")) {
            return this.d;
        }
        return (ArrayList) ipChange.ipc$dispatch("2093386958", new Object[]{this});
    }
    ...
    public e onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "699947191")) {
            return new e(this.c.inflate(R$layout.adapter_images_item, viewGroup, false));
        }
        return (e) ipChange.ipc$dispatch("699947191", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
