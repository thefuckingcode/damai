...
public class HorizontalProjectViewHolder extends RecyclerView.ViewHolder {
    ...
    public TextView a = ((TextView) this.itemView.findViewById(R$id.uikit_hori_project_title));
    public TextView b = ((TextView) this.itemView.findViewById(R$id.uikit_hori_project_info));
    public TextView c = ((TextView) this.itemView.findViewById(R$id.uikit_hori_project_price));
    public ImageView d = ((ImageView) this.itemView.findViewById(R$id.uikit_hori_project_img));
