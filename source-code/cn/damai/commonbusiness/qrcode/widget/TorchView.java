...
public class TorchView extends LinearLayout implements View.OnClickListener {
    ...
    private void switchTorch() {
        ...
        OnTorchClickListener onTorchClickListener2 = this.onTorchClickListener;
        if (onTorchClickListener2 != null) {
            onTorchClickListener2.onTorchStateSwitch();
        }
    }
    ...
    public void setOnTorchClickListener(OnTorchClickListener onTorchClickListener2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "938022232")) {
            ipChange.ipc$dispatch("938022232", new Object[]{this, onTorchClickListener2});
            return;
        }
        this.onTorchClickListener = onTorchClickListener2;
    }
