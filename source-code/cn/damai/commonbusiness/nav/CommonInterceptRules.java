...
public class CommonInterceptRules implements Serializable {
    ...
    public List<RouterParam> getRules() {
        ...
        routerParam.targetUri = gr.DISCOVER_CIRCLE_THEME_PAGE;
        ...
        routerParam4.targetUri = gr.DISCOVER_CONTENT_DETAIL;
        ...
        routerParam5.targetUri = gr.SCRIPT_SHOP_DETAIL;
        ...
        routerParam6.targetUri = gr.SCRIPT_COUPON_DETAIL;
