    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            if (TextUtils.equals(action, IPassport.ACTION_USER_LOGIN)) {
                ...
                da1.c().k(IPassport.ACTION_TOKEN_REFRESHED, stringExtra);
