    ...
    private void initView() {
        ...
        if (!TextUtils.isEmpty(charSequence)) {
            ...
            if (charSequence.contains("《大麦用户服务协议》")) {
                ...
                spannableString.setSpan(new rp((Activity) this.mContext, 0), indexOf, i, 17);
            }
            if (charSequence.contains("《隐私权政策》")) {
                ...
                spannableString.setSpan(new rp((Activity) this.mContext, 1), indexOf2, i2, 17);
            }
            if (charSequence.contains("《订票服务条款》")) {
                ...
                spannableString.setSpan(new rp((Activity) this.mContext, 2), indexOf3, i3, 17);
            }
