...
public class DamaiGuideFragment extends GuideFragment {
    ...
    public class b implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            DamaiGuideFragment.this.ckProSelect.setChecked(false);
            ru0.f().k("disagree", DamaiGuideFragment.class.getSimpleName(), "1");
    ...
    public class c implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            DamaiGuideFragment.this.ckProSelect.setChecked(true);
            ru0.f().k("agree", DamaiGuideFragment.class.getSimpleName(), "1");
    ...
    public void onActivityCreated(@Nullable Bundle bundle) {
        ...
        ht0.g(getActivity(), (getActivity() == null || getActivity().getWindow() == null) ? this.llUserbg : getActivity().getWindow().getDecorView());
    }
    ...
    public void onClick(View view) {
        ...
        if (id == R$id.login_third_tb_btn) {
            cn.damai.common.user.c.e().x(ru0.f().h("手淘", 1));
            ...
            cn.damai.common.user.c.e().x(ru0.f().h("账号", 5));
            if (this.ckProSelect.isChecked()) {
            ...
            cn.damai.common.user.c.e().x(ru0.f().h("支付宝", 0));
            if (this.ckProSelect.isChecked()) {
            ...
            cn.damai.common.user.c.e().x(ru0.f().h("新浪微博", 2));
            if (this.ckProSelect.isChecked()) {
            ...
            cn.damai.common.user.c.e().x(ru0.f().h(Constants.SOURCE_QQ, 4));
            if (this.ckProSelect.isChecked()) {
            ...
            cn.damai.common.user.c.e().x(ru0.f().h("微信", 3));
            if (this.ckProSelect.isChecked()) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mLoginReceiver = new BroadcastReceiver() {
            /* class cn.damai.login.havana.DamaiGuideFragment.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onReceive(Context context, Intent intent) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "320642476")) {
                    ipChange.ipc$dispatch("320642476", new Object[]{this, context, intent});
        ...
        this.ckProSelect.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            /* class cn.damai.login.havana.DamaiGuideFragment.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "995708926")) {
                    ipChange.ipc$dispatch("995708926", new Object[]{this, compoundButton, Boolean.valueOf(z)});
                } else if (z) {
                    ru0.f().k("agree", DamaiGuideFragment.class.getSimpleName(), "0");
                } else {
                    ru0.f().k("disagree", DamaiGuideFragment.class.getSimpleName(), "0");
                }
            }
        });
        return inflate;
