...
public class b {
    ...
    public a.b b(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "439428500")) {
            return new a.b().i(str);
        }
        return (a.b) ipChange.ipc$dispatch("439428500", new Object[]{this, str});
    }

    public a.b c(String str, String str2, String str3, Boolean bool) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-439180615")) {
            return e(str, str2, str3, new HashMap(), bool);
        }
        return (a.b) ipChange.ipc$dispatch("-439180615", new Object[]{this, str, str2, str3, bool});
    }
