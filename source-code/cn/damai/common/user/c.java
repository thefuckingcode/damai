...
public class c {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-2088221418")) {
            ...
            try {
                if (!map.containsKey("city")) {
                    map.put("city", d20.d());
                } else if (jk1.a(map.get("city"))) {
                    map.put("city", d20.d());
                } else {
                    String str = map.get("city");
                    if (TextUtils.isEmpty(str)) {
                        map.put("city", d20.d());
                    } else if (str.endsWith("市") && str.length() > 1) {
    ...
    public void B(String str, String str2, ArrayList<UTExposureInfo.UTExposureBean> arrayList, int i) {
        ...
        try {
            UTAnalytics.getInstance().getDefaultTracker().send(new UTOriginalCustomHitBuilder(str3, i, c2, null, null, this.b).build());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void C(String str, String str2, String str3, String str4, long j, Map<String, String> map, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1426247301")) {
            ...
            try {
                UTAnalytics.getInstance().getDefaultTracker().send(new UTOriginalCustomHitBuilder(str5, i, c2, null, null, this.b).build());
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void F(View view, String str, String str2, String str3) {
        ...
        a(hashMap);
        try {
            UTAnalytics.getInstance().getDefaultTracker().setExposureTag(view, c2, str4, hashMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void G(View view, String str, String str2, String str3, Map<String, String> map) {
        ...
        a(map);
        try {
            UTAnalytics.getInstance().getDefaultTracker().setExposureTag(view, c2, str4, map);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                if (!TextUtils.isEmpty(str2)) {
                    ...
                    Map<String, String> a2 = l03.c().a(map);
                    l03.c();
                    l03.e(a2, uTControlHitBuilder);
                    UTAnalytics.getInstance().getDefaultTracker().send(uTControlHitBuilder.build());
                    pt2.e(a2);
                    UTAnalytics.getInstance().getDefaultTracker().updateNextPageProperties(pt2.d());
