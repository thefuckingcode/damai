...
public class ConstrainedExecutorService extends AbstractExecutorService {
    ...
    public static ConstrainedExecutorService d(String str, int i, int i2, Executor executor) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-551024187")) {
            return new ConstrainedExecutorService(str, i, executor, new LinkedBlockingQueue(i2));
        }
        return (ConstrainedExecutorService) ipChange.ipc$dispatch("-551024187", new Object[]{str, Integer.valueOf(i), Integer.valueOf(i2), executor});
    }
