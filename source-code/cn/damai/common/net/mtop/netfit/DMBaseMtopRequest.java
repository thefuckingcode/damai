...
public abstract class DMBaseMtopRequest implements IMTOPDataObject {
    ...
    public MtopBusiness build() {
        ...
        Mtop registerTtid = Mtop.instance(Mtop.Id.INNER, xs0.a(), AppConfig.p()).registerTtid(AppConfig.p());
    ...
    public Map<String, String> getHeaderMap() {
        ...
        } else if (!this.takePrivateParams) {
            return m6.e();
        } else {
            return m6.b();
        }
    ...
    public HttpMethod getHttpMethod() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1942348282")) {
            return HttpMethod.GET;
        }
        return (HttpMethod) ipChange.ipc$dispatch("-1942348282", new Object[]{this});
    }
    ...
    public boolean isTakePrivateParams() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2084587301")) {
            return this.takePrivateParams;
        }
        return ((Boolean) ipChange.ipc$dispatch("-2084587301", new Object[]{this})).booleanValue();
    }
