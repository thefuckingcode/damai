...
public class ERROR {
    ...
    public static void broadcastLogoutSuccess(Context context) {
        ...
        intent.setAction(z91.BROADCAST_LOGOUT_SUCCESS);
    ...
    public void setDealLoginErrorListener(DealLoginErrorListener dealLoginErrorListener2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-2003023368")) {
            ipChange.ipc$dispatch("-2003023368", new Object[]{this, dealLoginErrorListener2});
            return;
        }
        this.dealLoginErrorListener = dealLoginErrorListener2;
    }
}
