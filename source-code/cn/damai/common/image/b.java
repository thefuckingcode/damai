...
public class b {
    ...
    public static DMImageStrategyConfig b(String str, int i, int i2) {
        ...
        } else if (!e() || TextUtils.isEmpty(str) || str.contains(".gif")) {
            return null;
        } else {
    ...
    public static String c(String str, DMImageStrategyConfig dMImageStrategyConfig) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1058618550")) {
        ...
        } else if (!e() || TextUtils.isEmpty(str) || str.startsWith("res://") || str.startsWith("file://") || str.startsWith("asset://")) {
            return str;
        } else {
            String b = OrangeConfigCenter.c().b("damai_webp", "blackListHost", "");
            if (!TextUtils.isEmpty(b)) {
                if (b.contains(",")) {
                    CharSequence[] split = b.split(",");
                    if (split == null) {
                        i = 0;
                    } else {
                        i = split.length;
            ...
            if (str.contains(".aliyun-inc.com") || str.contains(".aliyuncs.com")) {
                return h(str, dMImageStrategyConfig);
            }
            return str;
        }
    }
    ...
    public static boolean d(String str) {
        ...
        if (!TextUtils.isEmpty(str) && str.contains(".alicdn.com")) {
            ...
            return !substring.contains(".png_") && !substring.contains(".jpeg_") && !substring.contains(".jpg_") && !substring.contains(".gif");
        }
        return false;
    }
    ...
    public static boolean e() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-2120356299")) {
            return ((Boolean) ipChange.ipc$dispatch("-2120356299", new Object[0])).booleanValue();
        }
        return "1".equals(OrangeConfigCenter.c().b("damai_webp", "openImageOpt", "0"));
    }

    private static boolean f() {
        NetworkInfo activeNetworkInfo;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1235901438")) {
            return ((Boolean) ipChange.ipc$dispatch("-1235901438", new Object[0])).booleanValue();
        }
        if (xs0.a() == null || (activeNetworkInfo = ConnectivityManager.getActiveNetworkInfo((android.net.ConnectivityManager) xs0.a().getSystemService("connectivity"))) == null || activeNetworkInfo.getType() != 1) {
            return false;
        }
        return true;
    }
    ...
    private static String g(String str, DMImageStrategyConfig dMImageStrategyConfig) {
        ...
        if (dMImageStrategyConfig.c && (dMImageCropType = dMImageStrategyConfig.d) != null) {
            if (dMImageCropType.equals(DMImageStrategyConfig.DMImageCropType.cy500)) {
                ...
                str2 = dMImageStrategyConfig.d.equals(DMImageStrategyConfig.DMImageCropType.cy100) ? "cy100i" : str3;
            }
        ...
        if (dMImageStrategyConfig.f) {
            ...
            if (dMImageQuality == null) {
                str3 = f() ? OrangeConfigCenter.c().b("damai_webp", "highNetQ", "q90") : OrangeConfigCenter.c().b("damai_webp", "lowNetQ", "q75");
            } else if (dMImageQuality.equals(DMImageStrategyConfig.DMImageQuality.q90)) {
                str3 = "q90";
        ...
        if (dMImageStrategyConfig.f) {
            ...
            if (dMImageQuality != null) {
                if (dMImageQuality.equals(DMImageStrategyConfig.DMImageQuality.q90)) {
                    ...
                    str2 = dMImageStrategyConfig.j.equals(DMImageStrategyConfig.DMImageQuality.q30) ? "q_30" : "";
                }
            } else if (f()) {
                String b = OrangeConfigCenter.c().b("damai_webp", "highNetQ", "q90");
                str2 = String.format("%s_%s", b.substring(0, 1), b.substring(1));
            } else {
                String b2 = OrangeConfigCenter.c().b("damai_webp", "lowNetQ", "q75");
                str2 = String.format("%s_%s", b2.substring(0, 1), b2.substring(1));
            }
            if (!TextUtils.isEmpty(str2)) {
                sb.append("/quality");
                sb.append(",");
