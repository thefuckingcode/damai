...
public class a implements IImageLoader {
    ...
    /* compiled from: Taobao */
    public class C0011a implements DMImageCreator.DMImageFailListener {
        private static transient /* synthetic */ IpChange $ipChange;
        final /* synthetic */ IImageLoader.IImageFailListener a;

        C0011a(a aVar, IImageLoader.IImageFailListener iImageFailListener) {
    ...
    public DMImageCreator c(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "365683269")) {
            return d(str, null);
        }
        return (DMImageCreator) ipChange.ipc$dispatch("365683269", new Object[]{this, str});
    }
    ...
    public DMImageCreator d(String str, DMImageStrategyConfig dMImageStrategyConfig) {
        ...
        } else if (dMImageStrategyConfig == null) {
    ...
    public DMImageCreator e(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1559250943")) {
            return f(str, -1, -1);
        }
        return (DMImageCreator) ipChange.ipc$dispatch("-1559250943", new Object[]{this, str});
    }

    public DMImageCreator f(String str, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1295852257")) {
            return g(str, b.b(str, i, i2));
        }
        return (DMImageCreator) ipChange.ipc$dispatch("1295852257", new Object[]{this, str, Integer.valueOf(i), Integer.valueOf(i2)});
    }
    ...
    public DMImageCreator g(String str, DMImageStrategyConfig dMImageStrategyConfig) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "674178020")) {
            ...
            return new DMImageCreator().l(this.b.s(b.c(str, dMImageStrategyConfig)));
        }
    }
    ...
    public void load(String str, int i, int i2, int i3, IImageLoader.IImageSuccListener iImageSuccListener, IImageLoader.IImageFailListener iImageFailListener) {
        ...
        f2.n(new b(this, iImageSuccListener)).e(new C0011a(this, iImageFailListener)).f();
    }

    @Override // cn.damai.uikit.image.IImageLoader
    public IImageLoader.ImageTicket loadinto(String str, ImageView imageView) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-940210448")) {
            return e(str).g(imageView);
        }
        return (IImageLoader.ImageTicket) ipChange.ipc$dispatch("-940210448", new Object[]{this, str, imageView});
    }
