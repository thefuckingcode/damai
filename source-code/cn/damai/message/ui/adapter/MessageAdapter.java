...
public class MessageAdapter extends BaseAdapter {
    ...
    public int getCount() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1079993649")) {
            return this.data.size();
        }
        return ((Integer) ipChange.ipc$dispatch("-1079993649", new Object[]{this})).intValue();
    }

    public long getItemId(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1598458")) {
            return (long) i;
        }
        return ((Long) ipChange.ipc$dispatch("-1598458", new Object[]{this, Integer.valueOf(i)})).longValue();
    }
    ...
    public MessageItem getItem(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-374402582")) {
            return this.data.get(i);
        }
        return (MessageItem) ipChange.ipc$dispatch("-374402582", new Object[]{this, Integer.valueOf(i)});
    }
}
