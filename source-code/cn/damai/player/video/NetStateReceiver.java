...
public class NetStateReceiver extends BroadcastReceiver {
    ...
    public static synchronized NetStateReceiver b() {
        synchronized (NetStateReceiver.class) {
            ...
            if (b == null) {
                ...
                xs0.a().registerReceiver(b, new IntentFilter(ConnectivityBroadcastReceiver.CONNECTIVITY_ACTION));
            }
            return b;
        }
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (ConnectivityBroadcastReceiver.CONNECTIVITY_ACTION.equals(intent.getAction()) && xh1.c(context) == NetworkType.NETWORK_MOBILE) {
            a();
        }
    }
}
