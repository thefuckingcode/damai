...
public abstract class DMBaseVideoController extends FrameLayout {
    ...
    public String getSpmB() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "50046469")) {
            return this.spmB;
        }
        return (String) ipChange.ipc$dispatch("50046469", new Object[]{this});
    }

    public String getSpmC() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "261397382")) {
            return this.spmC;
        }
        return (String) ipChange.ipc$dispatch("261397382", new Object[]{this});
    }

    public OnPlayerUTReportListener getUTReportListener() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "790228200")) {
            return this.mUTReportListener;
        }
        return (OnPlayerUTReportListener) ipChange.ipc$dispatch("790228200", new Object[]{this});
    }

    public boolean isAutoReport() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-800712194")) {
            return this.autoReport;
        }
        return ((Boolean) ipChange.ipc$dispatch("-800712194", new Object[]{this})).booleanValue();
    }
