...
public class VolumeChangeObserver {
    ...
    public static class VolumeReceiver extends BroadcastReceiver {
        ...
        private boolean a(Intent intent) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-2072309263")) {
                return ((Boolean) ipChange.ipc$dispatch("-2072309263", new Object[]{this, intent})).booleanValue();
    ...
    public int b() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-331468226")) {
            return this.d.getStreamVolume(3);
        }
        return ((Integer) ipChange.ipc$dispatch("-331468226", new Object[]{this})).intValue();
    }
