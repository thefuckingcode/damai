...
public class DaMaiPushAgent {
    ...
    private static final Map<String, String> c = new HashMap<String, String>() {
        /* class cn.damai.push.DaMaiPushAgent.AnonymousClass1 */
    ...
    public static class a implements IAppReceiver {
        ...
        public Map<String, String> getAllServices() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "-565908154")) {
                return DaMaiPushAgent.c;
            }
            return (Map) ipChange.ipc$dispatch("-565908154", new Object[]{this});
        }

        @Override // com.taobao.accs.IAppReceiver
        public String getService(String str) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-212839109")) {
                return (String) DaMaiPushAgent.c.get(str);
            }
            return (String) ipChange.ipc$dispatch("-212839109", new Object[]{this, str});
        }
        ...
        public void onBindApp(int i) {
            ...
            if (i == 200) {
                ...
                b20.g();
                c.e().A(tk.g().i(DaMaiPushAgent.b, "accs", "1", ""), "trip_yk_accs_sync_login", "push");
                return;
            }
            c.e().A(tk.g().i(DaMaiPushAgent.b, "accs", "2", ""), "trip_yk_accs_sync_login", "push");
        }
    ...
    private static String d(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1768812118")) {
        ...
        return (String) ipChange.ipc$dispatch("-1768812118", new Object[]{Integer.valueOf(i)});
    }

    private static String e(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "983906001")) {
            return i == 0 ? "youku-acs.m.taobao.com" : i == 1 ? "youku-acs.wapa.taobao.com" : i == 2 ? "youku-acs.waptest.taobao.com" : "youku-acs.m.taobao.com";
        }
        return (String) ipChange.ipc$dispatch("983906001", new Object[]{Integer.valueOf(i)});
    }

    private static int f(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1525221734")) {
            return (i == 0 || i == 1 || i != 2) ? 11 : 0;
        }
        return ((Integer) ipChange.ipc$dispatch("1525221734", new Object[]{Integer.valueOf(i)})).intValue();
    }
    ...
    public static void h(Context context) {
        ...
        try {
            ...
            try {
                ...
                ACCSClient.init(xs0.a(), builder.build());
    ...
    public static void i(String str, byte[] bArr) {
        ...
        try {
            ACCSClient.getAccsClient("default").sendData(new ACCSManager.AccsRequest(b20.c(), s2.ACCS_CHANNEL, bArr, str));
        } catch (AccsException e) {
            e.printStackTrace();
        }
    }
