...
public class ErrControlViewInfo implements Serializable {
    ...
    public static ErrControlViewInfo errNetInfo(String str, String str2, String str3, ErrClickListener errClickListener) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1997004783")) {
            return new ErrControlViewInfo(1, str, str2, str3, errClickListener);
        }
        return (ErrControlViewInfo) ipChange.ipc$dispatch("-1997004783", new Object[]{str, str2, str3, errClickListener});
    }

    public static ErrControlViewInfo errResultEmpty(String str, String str2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1289667643")) {
            return new ErrControlViewInfo(3, str, str2, null, null);
        }
        return (ErrControlViewInfo) ipChange.ipc$dispatch("-1289667643", new Object[]{str, str2});
    }
    ...
    public static ErrControlViewInfo errSensitiveWord(String str, String str2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-325401387")) {
            return new ErrControlViewInfo(3, str, str2, null, null);
        }
        return (ErrControlViewInfo) ipChange.ipc$dispatch("-325401387", new Object[]{str, str2});
    }
