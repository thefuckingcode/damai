...
public final class OneProjectModel extends AbsModel<GenericItem<ItemValue>, ProjectItemBean> implements OneProject.Model {
    ...
    public ProjectItemBean getProject() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-385704600")) {
            return (ProjectItemBean) getValue();
        }
        return (ProjectItemBean) ipChange.ipc$dispatch("-385704600", new Object[]{this});
    }
}
