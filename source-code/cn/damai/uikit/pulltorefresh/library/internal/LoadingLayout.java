...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    public LoadingLayout(Context context, PullToRefreshBase.Mode mode, PullToRefreshBase.Orientation orientation, TypedArray typedArray, boolean z) {
        ...
        } else if (a.a[orientation.ordinal()] != 1) {
        ...
        drawable2 = typedArray.hasValue(i7) ? typedArray.getDrawable(i7) : drawable2;
        if (iArr[mode.ordinal()] != 1) {
            ...
            if (typedArray.hasValue(i8)) {
                ...
                if (typedArray.hasValue(i9)) {
                    du2.a("ptrDrawableTop", "ptrDrawableStart");
            ...
            if (typedArray.hasValue(i10)) {
                ...
                if (typedArray.hasValue(i11)) {
                    du2.a("ptrDrawableBottom", "ptrDrawableEnd");
    ...
    public final int getContentSize() {
        ...
        } else if (a.a[this.mScrollDirection.ordinal()] != 1) {
