...
public class WheelScroller {
    ...
    private void n(int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "288340775")) {
            ipChange.ipc$dispatch("288340775", new Object[]{this, Integer.valueOf(i2)});
            return;
        }
        h();
    ...
    public void l(int i2, int i3) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1001176159")) {
            ipChange.ipc$dispatch("-1001176159", new Object[]{this, Integer.valueOf(i2), Integer.valueOf(i3)});
            return;
        }
        this.d.forceFinished(true);
        this.e = 0;
