...
public class EqualLinearView extends LinearLayout {
    ...
    private int mSelectedFontColor = R$color.color_000000;
    ...
    private int mUnSelectedFontColor = R$color.color_999999;
    ...
    private int dip2px(float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "616731558")) {
            return (int) ((f * getContext().getResources().getDisplayMetrics().density) + 0.5f);
        }
        return ((Integer) ipChange.ipc$dispatch("616731558", new Object[]{this, Float.valueOf(f)})).intValue();
    }
    ...
    public void commit() {
        ...
        } else if (!s71.a(this.mTitleList) && this.mTitleList.size() <= 5) {
            removeAllViews();
    ...
    public void selectTitle(int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "310023057")) {
        ...
        } else if (!s71.a(this.mTitleList) && this.mSelectIndex != i && !this.mSrcollStart) {
            ...
            post(new Runnable() {
                /* class cn.damai.uikit.snake.EqualLinearView.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void run() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-740297611")) {
                        ipChange.ipc$dispatch("-740297611", new Object[]{this});
