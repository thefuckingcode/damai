...
public class HorScrollView extends HorizontalScrollView {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (horScrollView.mAutoSelectWhenClick) {
                if (!horScrollView.mLayout.mSrcollStart && HorScrollView.this.mLayout.mSelectIndex != (i = ((ScrollTitleBean) view.getTag()).index)) {
                    HorScrollView.this.selectTitle(i);
                } else {
                    return;
                }
            }
    ...
    private void scrollToIndex(final int i) {
        ...
        this.mLayout.post(new Runnable() {
            /* class cn.damai.uikit.snake.HorScrollView.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void run() {
                ...
                int i;
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1111083562")) {
                    ipChange.ipc$dispatch("-1111083562", new Object[]{this});
                    return;
                }
    ...
    public void commit() {
        ...
        if (this.mLayout.getLayoutParams() != null) {
            this.mLayout.getLayoutParams().height = this.mLayout.dip2px((float) this.mHeight);
        }
    }
    ...
    public HorScrollView setDefaultPadding(int i) {
        ...
        this.mPaddingLeftRight = m42.a(this.mContext, (float) i);
        return this;
    }
