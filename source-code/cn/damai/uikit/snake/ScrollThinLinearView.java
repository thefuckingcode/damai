...
public class ScrollThinLinearView extends ScrollLinearView {
    ...
    public class b implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            ScrollThinLinearView.this.mAnimatedValue = (float) ((Integer) valueAnimator.getAnimatedValue()).intValue();
            ScrollThinLinearView scrollThinLinearView = ScrollThinLinearView.this;
            int i = scrollThinLinearView.mXiaoSize;
            ScrollThinLinearView.this.mTv.setTextSize(1, ((float) i) + ((((float) (scrollThinLinearView.mDaSize - i)) * scrollThinLinearView.mAnimatedValue) / 100.0f));
    ...
    private int selectTitle(int i) {
        ...
        if (textView.getText() != null) {
            ...
            float left = ((float) (textView.getLeft() + dip2px((float) (this.mSpace / 2)))) + ((((float) (((textView.getMeasuredWidth() - dip2px((float) this.mSpace)) * this.mDaSize) / this.mXiaoSize)) - f) / 2.0f);
            this.mStartX = left;
            this.mStopX = left + f;
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        if (this.mIsShowLine) {
            int dip2px = dip2px((float) (this.mHeight / 2)) + dip2px((float) ((this.mDaSize / 2) + 8));
            this.mStartY = dip2px;
            Paint paint = this.mPaint;
            if (paint != null) {
                canvas.drawLine(this.mStartX, (float) dip2px, this.mStopX, (float) dip2px, paint);
            }
        }
    }
    ...
    public void setFontSize(final int i) {
        ...
        postDelayed(new Runnable() {
            /* class cn.damai.uikit.snake.ScrollThinLinearView.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "632641965")) {
                    ipChange.ipc$dispatch("632641965", new Object[]{this});
                    return;
                }
