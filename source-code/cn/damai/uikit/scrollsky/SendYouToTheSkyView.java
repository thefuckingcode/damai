...
public class SendYouToTheSkyView extends View {
    ...
    private int dip2px(float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1913495191")) {
            return (int) ((f * getContext().getResources().getDisplayMetrics().density) + 0.5f);
        }
        return ((Integer) ipChange.ipc$dispatch("-1913495191", new Object[]{this, Float.valueOf(f)})).intValue();
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private float dip2pxForFloat(float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1417114649")) {
            return f * getContext().getResources().getDisplayMetrics().density;
        }
        return ((Float) ipChange.ipc$dispatch("1417114649", new Object[]{this, Float.valueOf(f)})).floatValue();
    }
    ...
    private void initView() {
        ...
        this.mDpHeight = ((float) i) + 5.0f + 25.0f + ((float) i) + 5.0f;
        this.mHeight = (float) dip2px(((float) i) + 5.0f + 25.0f + ((float) i) + 5.0f);
        this.mFixY1 = (float) dip2px((float) (this.mTextSize + 5));
        int i2 = this.mTextSize;
        this.mFixY2 = (float) dip2px((float) (i2 + 5 + 25 + i2));
        int i3 = this.mTextSize;
        this.mFixY3 = (float) dip2px((float) (i3 + 5 + 25 + i3 + 25 + i3));
        float f = sTopAlpaha;
        ...
        this.mBorderPaint1.setStrokeWidth((float) dip2px(1.0f));
        ...
        this.mBorderPaint2.setStrokeWidth((float) dip2px(1.0f));
        ...
        this.mBorderPaint3.setStrokeWidth((float) dip2px(1.0f));
        float dip2px2 = (float) dip2px((float) (this.mTextSize + 25));
        ...
        this.mAnimator.addListener(new Animator.AnimatorListener() {
            /* class cn.damai.uikit.scrollsky.SendYouToTheSkyView.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onAnimationCancel(Animator animator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "2081677153")) {
                    ipChange.ipc$dispatch("2081677153", new Object[]{this, animator});
                }
            }

            public void onAnimationEnd(Animator animator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "430669678")) {
                    ipChange.ipc$dispatch("430669678", new Object[]{this, animator});
                    return;
                }
                SendYouToTheSkyView.this.setNextString();
                SendYouToTheSkyView.this.resetY();
                SendYouToTheSkyView.this.invalidate();
                SendYouToTheSkyView.this.postDelayed(new Runnable() {
                    /* class cn.damai.uikit.scrollsky.SendYouToTheSkyView.AnonymousClass2.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    public void run() {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "649607307")) {
                            ipChange.ipc$dispatch("649607307", new Object[]{this});
                            return;
                        }
            ...
            public void onAnimationRepeat(Animator animator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "100285472")) {
                    ipChange.ipc$dispatch("100285472", new Object[]{this, animator});
                }
            }

            public void onAnimationStart(Animator animator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "112298311")) {
                    ipChange.ipc$dispatch("112298311", new Object[]{this, animator});
                }
            }
        });
    }
    ...
    private boolean isCanLoop() {
        Activity activity;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1373405461")) {
            return ((Boolean) ipChange.ipc$dispatch("-1373405461", new Object[]{this})).booleanValue();
        }
        return this.mIsAttached && uf2.b(this.mList) > 1 && !this.mAnimator.isRunning() && (activity = this.mActivity) != null && !activity.isFinishing();
    }
    ...
    public Bitmap getCirleBitmap(Bitmap bitmap) {
        ...
        int i2 = this.diam;
        canvas.drawCircle((float) (i2 / 2), (float) (i2 / 2), (float) (i2 / 2), paint);
        return createBitmap;
    }
    ...
    public void onAttachedToWindow() {
        ...
        postDelayed(new Runnable() {
            /* class cn.damai.uikit.scrollsky.SendYouToTheSkyView.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-72271562")) {
                    ipChange.ipc$dispatch("-72271562", new Object[]{this});
                    return;
                }
                SendYouToTheSkyView.this.startAnim();
            }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1824501135")) {
            ...
            if (this.mTexts[0].bitmap != null) {
                canvas.drawCircle((float) dip2px(10.0f), (this.mText1Y - ((float) dip2px(13.0f))) + ((float) dip2px(10.0f)), (float) dip2px(9.5f), this.mBorderPaint1);
                canvas.drawBitmap(this.mTexts[0].bitmap, 0.0f, this.mText1Y - ((float) dip2px(13.0f)), this.mPaintBitmap1);
            }
            if (this.mTexts[1].bitmap != null) {
                canvas.drawCircle((float) dip2px(10.0f), (this.mText2Y - ((float) dip2px(13.0f))) + ((float) dip2px(10.0f)), (float) dip2px(9.5f), this.mBorderPaint2);
                canvas.drawBitmap(this.mTexts[1].bitmap, 0.0f, this.mText2Y - ((float) dip2px(13.0f)), this.mPaintBitmap2);
            }
            if (this.mTexts[2].bitmap != null) {
                canvas.drawCircle((float) dip2px(10.0f), (this.mText3Y - ((float) dip2px(13.0f))) + ((float) dip2px(10.0f)), (float) dip2px(9.5f), this.mBorderPaint3);
                canvas.drawBitmap(this.mTexts[2].bitmap, 0.0f, this.mText3Y - ((float) dip2px(13.0f)), this.mPaintBitmap3);
            }
            canvas.drawText(this.mTexts[0].content, (float) dip2px(25.0f), this.mText1Y, this.mPaint1);
            canvas.drawText(this.mTexts[1].content, (float) dip2px(25.0f), this.mText2Y, this.mPaint2);
            canvas.drawText(this.mTexts[2].content, (float) dip2px(25.0f), this.mText3Y, this.mPaint3);
        }
    }
    ...
    public void onWindowVisibilityChanged(int i) {
        ...
        if (i == 0) {
            this.mIsAttached = true;
            postDelayed(new Runnable() {
                /* class cn.damai.uikit.scrollsky.SendYouToTheSkyView.AnonymousClass5 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void run() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-268785067")) {
                        ipChange.ipc$dispatch("-268785067", new Object[]{this});
                        return;
                    }
                    SendYouToTheSkyView.this.startAnim();
                }
