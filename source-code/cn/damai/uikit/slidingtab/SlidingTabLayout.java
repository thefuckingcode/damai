...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void initAttributes(AttributeSet attributeSet) {
        ...
        this.mTabPaddingLeft = (int) TypedValue.applyDimension(1, (float) this.mTabPaddingLeft, displayMetrics);
        this.mTabPaddingRight = (int) TypedValue.applyDimension(1, (float) this.mTabPaddingRight, displayMetrics);
        this.mTabTextSize = (int) TypedValue.applyDimension(1, (float) this.mTabTextSize, displayMetrics);
        this.mTabItemLeftAndRightPadding = (int) TypedValue.applyDimension(1, (float) this.mTabItemLeftAndRightPadding, displayMetrics);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!isInEditMode() && this.mTabCount != 0) {
            ...
            float left = (float) (childAt.getLeft() + getPaddingLeft() + this.mTabPaddingLeft);
            float right = (float) ((childAt.getRight() + getPaddingRight()) - this.mTabPaddingLeft);
            ...
            float f3 = left - ((float) i2);
            float f4 = ((float) i2) + right;
            int i3 = this.mUnderLineWidth;
            if (i3 > 0) {
                f = left + (((right - left) - ((float) i3)) / 2.0f);
                f2 = ((float) i3) + f;
            } else {
                f2 = f4;
                f = f3;
            ...
            LinearGradient linearGradient = new LinearGradient(f, f5, f2, f6, -46418, (int) DEFAULT_TAB_SELECTED_TEXT_COLOR, Shader.TileMode.MIRROR);
            this.mShader = linearGradient;
            this.mRectPaintL.setShader(linearGradient);
            canvas.drawRect(f, f5, f2, f6, this.mRectPaintL);
        }
    }
    ...
    public void setTabItemLeftAndRightPadding(float f) {
        ...
        this.mTabItemLeftAndRightPadding = s50.a(getContext(), f);
    }
    ...
    public void setUnderLineWidth(float f) {
        ...
        this.mUnderLineWidth = s50.a(getContext(), f);
    }
    ...
    public SlidingTabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mTabItemLeftAndRightPadding = s50.a(getContext(), 9.0f);
