...
public class PullToRefreshHeaderView extends FrameLayout implements RefreshTrigger {
    ...
    public static PullToRefreshHeaderView getInstance(Context context) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "2040491031")) {
            return getInstance(context, false);
        }
        return (PullToRefreshHeaderView) ipChange.ipc$dispatch("2040491031", new Object[]{context});
    }
    ...
    private void initStatuBar(Activity activity) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1688200862")) {
            ...
            if (Build.VERSION.SDK_INT < 23) {
                ...
                this.statusHeight = ne2.a(activity);
    ...
    public int getRefreshLayoutHeight() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1833926955")) {
            return getMeasuredHeight();
        }
        return ((Integer) ipChange.ipc$dispatch("1833926955", new Object[]{this})).intValue();
    }

    public int getStatusHeight() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1212090176")) {
            return this.statusHeight;
        }
        return ((Integer) ipChange.ipc$dispatch("1212090176", new Object[]{this})).intValue();
    }
    ...
    public static PullToRefreshHeaderView getInstance(Context context, boolean z) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-82979619")) {
            return getInstance(context, z, R$color.transparent);
        }
        return (PullToRefreshHeaderView) ipChange.ipc$dispatch("-82979619", new Object[]{context, Boolean.valueOf(z)});
    }
    ...
    public PullToRefreshHeaderView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (mRefreshViweHeightUnitDp != 0) {
            frameLayout.setLayoutParams(new LinearLayout.LayoutParams(-1, s50.a(context, (float) mRefreshViweHeightUnitDp)));
        }
    }

    public static PullToRefreshHeaderView getInstance(Context context, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-553960436")) {
            return getInstance(context, false, i);
        }
        return (PullToRefreshHeaderView) ipChange.ipc$dispatch("-553960436", new Object[]{context, Integer.valueOf(i)});
    }

    public static PullToRefreshHeaderView getInstance(Context context, boolean z, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1957041146")) {
            return getInstance(context, 70, z, i);
        }
        return (PullToRefreshHeaderView) ipChange.ipc$dispatch("-1957041146", new Object[]{context, Boolean.valueOf(z), Integer.valueOf(i)});
    }
