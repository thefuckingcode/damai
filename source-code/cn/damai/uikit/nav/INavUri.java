...
public class INavUri implements Serializable {
    ...
    public static Schemed scheme(String str) {
        ...
        return new a(iNavUri);
    }

    public Uri build() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-10019296")) {
            return this.mBuilder.build();
        }
        return (Uri) ipChange.ipc$dispatch("-10019296", new Object[]{this});
    }
