...
public class DMPeopleSeeTagView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        setPadding(0, m42.a(this.mContext, 6.0f), m42.a(this.mContext, 3.0f), 0);
    ...
    public DMPeopleSeeTagView setPeopleNum(int i) {
        ...
        } else if (this.mNumName == null || this.mNumTip == null || i == 0) {
            setVisibility(8);
            return this;
        } else {
            if (i > 0) {
                ...
                if (i >= 10000) {
                    try {
                        String valueOf = String.valueOf(((float) ((int) ((((float) i) / 10000.0f) * 10.0f))) / 10.0f);
