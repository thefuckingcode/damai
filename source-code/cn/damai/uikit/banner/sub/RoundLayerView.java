...
public class RoundLayerView extends View {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        this.mPath.lineTo((float) this.radius, 0.0f);
        this.mPath.quadTo(0.0f, 0.0f, 0.0f, (float) this.radius);
        this.mPath.close();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        try {
            ...
            drawCorner(canvas, this.mPath, (float) getWidth(), 0.0f, 90.0f);
            drawCorner(canvas, this.mPath, (float) getWidth(), (float) getHeight(), 180.0f);
            drawCorner(canvas, this.mPath, 0.0f, (float) getHeight(), 270.0f);
