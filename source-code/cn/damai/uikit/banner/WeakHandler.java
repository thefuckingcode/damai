...
public class WeakHandler {
    ...
    public final boolean a(@NonNull Runnable runnable) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2052660138")) {
            return this.a.post(e(runnable));
        }
        return ((Boolean) ipChange.ipc$dispatch("-2052660138", new Object[]{this, runnable})).booleanValue();
    }

    public final boolean b(Runnable runnable, long j) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "508734166")) {
            return this.a.postDelayed(e(runnable), j);
        }
        return ((Boolean) ipChange.ipc$dispatch("508734166", new Object[]{this, runnable, Long.valueOf(j)})).booleanValue();
    }
