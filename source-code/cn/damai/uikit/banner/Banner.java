...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public class BannerPagerAdapter extends PagerAdapter {
        ...
        public int getCount() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "1387129324")) {
                return Banner.this.imageViews.size();
            }
            return ((Integer) ipChange.ipc$dispatch("1387129324", new Object[]{this})).intValue();
        }
        ...
        public boolean isViewFromObject(View view, Object obj) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "782763096")) {
                return view == obj;
            }
            return ((Boolean) ipChange.ipc$dispatch("782763096", new Object[]{this, view, obj})).booleanValue();
        }
    }
    ...
    private void handleTypedArray(Context context2, AttributeSet attributeSet) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-69538709")) {
            ipChange.ipc$dispatch("-69538709", new Object[]{this, context2, attributeSet});
    ...
    private void initView(Context context2, AttributeSet attributeSet) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "125089325")) {
            ipChange.ipc$dispatch("125089325", new Object[]{this, context2, attributeSet});
            return;
        }
        this.imageViews.clear();
    ...
    public Banner(Context context2, AttributeSet attributeSet, int i) {
        ...
        this.task = new Runnable() {
            /* class cn.damai.uikit.banner.Banner.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;
