...
public class ArcCorverView extends View {
    ...
    private Bitmap drawRect(int i, int i2) {
        ...
        int i3 = this.gravity;
        if (i3 == 0) {
            canvas.drawRect(new RectF(0.0f, 0.0f, (float) getWidth(), (float) getWidth()), paint);
        } else if (i3 == 1) {
            canvas.drawRect(new RectF((float) (getWidth() - getWidth()), 0.0f, (float) getWidth(), (float) getWidth()), paint);
        } else if (i3 == 2) {
            canvas.drawRect(new RectF((float) (getWidth() - getWidth()), (float) (getHeight() - getWidth()), (float) getWidth(), (float) getHeight()), paint);
        } else if (i3 == 3) {
            canvas.drawRect(new RectF(0.0f, (float) (getHeight() - getWidth()), (float) getWidth(), (float) getHeight()), paint);
        }
        return createBitmap;
    }
    ...
    private Bitmap drawSector(int i, int i2) {
        ...
        int i3 = this.gravity;
        if (i3 == 0) {
            canvas.drawArc(new RectF(0.0f, 0.0f, (float) (getWidth() * 2), (float) (getWidth() * 2)), 180.0f, 90.0f, true, paint);
        } else if (i3 == 1) {
            canvas.drawArc(new RectF((float) (getWidth() - (getWidth() * 2)), 0.0f, (float) getWidth(), (float) (getWidth() * 2)), 270.0f, 90.0f, true, paint);
        } else if (i3 == 2) {
            canvas.drawArc(new RectF((float) (getWidth() - (getWidth() * 2)), (float) (getHeight() - (getWidth() * 2)), (float) getWidth(), (float) getHeight()), 0.0f, 90.0f, true, paint);
        } else if (i3 == 3) {
            canvas.drawArc(new RectF(0.0f, (float) (getWidth() - (getWidth() * 2)), (float) (getWidth() * 2), (float) getWidth()), 90.0f, 90.0f, true, paint);
        }
        return createBitmap;
    }
