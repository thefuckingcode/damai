...
public class DMActionButtonBgView extends LinearLayout {
    ...
    public DMActionButtonBgView(Context context2) {
        this(context2, null);
    }
    ...
    private void setDefaultBackground() {
        ...
        rr.d(this.partent, new int[]{Color.parseColor("#FF7F81"), Color.parseColor("#FF2869")}, s50.a(this.context, 25.0f), Color.parseColor("#4bFF2D79"), s50.a(this.context, 2.0f), 0, s50.a(this.context, 2.0f));
    }
    ...
    private void setUnsuedBackground() {
        ...
        rr.d(this.partent, new int[]{Color.parseColor("#66FF7F81"), Color.parseColor("#66FF2D79")}, s50.a(this.context, 25.0f), Color.parseColor("#1AFF2D79"), s50.a(this.context, 2.0f), 0, s50.a(this.context, 2.0f));
    }

    public TextView getEventTv() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1389599360")) {
            return this.submit_btn;
        }
        return (TextView) ipChange.ipc$dispatch("1389599360", new Object[]{this});
    }
    ...
    public DMActionButtonBgView(Context context2, @Nullable AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public DMActionButtonBgView(Context context2, @Nullable AttributeSet attributeSet, int i) {
    ...
    public void update(String str, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "728386672")) {
            ...
            this.submit_btn.setText(str.trim());
            this.submit_btn.setTextSize(1, (float) i);
        }
    }
}
