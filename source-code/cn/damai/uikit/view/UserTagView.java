...
public class UserTagView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        dMLabelView.setLabelHeight(s50.a(context, 16.0f));
        this.tagName.setLabelType(DMLabelType.LABEL_TYPE_CUSTOM);
        this.tagName.setPaddingLeft(s50.a(context, 22.0f));
        this.tagName.setPaddingRight(s50.a(context, 6.0f));
        this.tagName.setCornerRadii((float) s50.a(context, 9.0f), (float) s50.a(context, 8.0f), (float) s50.a(context, 8.0f), (float) s50.a(context, 3.0f));
        ...
        addView(this.tagIcon, new FrameLayout.LayoutParams(s50.a(context, 17.0f), s50.a(context, 16.0f)));
        setVisibility(8);
    }
    ...
    public void setIconSize(Context context, int i, int i2) {
        ...
        this.tagIcon.setLayoutParams(new FrameLayout.LayoutParams(s50.a(context, (float) i), s50.a(context, (float) i2)));
    }
