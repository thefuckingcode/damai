...
public class ExpandFlowLayout<T> extends FrameLayout {
    ...
    public static abstract class a<T> {
        ...
        public T a(int i) {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "11789420")) {
                return this.a.get(i);
            }
            return (T) ipChange.ipc$dispatch("11789420", new Object[]{this, Integer.valueOf(i)});
        }

        public int b() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-1161781903")) {
                return this.a.size();
            }
            return ((Integer) ipChange.ipc$dispatch("-1161781903", new Object[]{this})).intValue();
        }
    ...
    public static class b {
        ...
        public int d() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-1660845177")) {
                return this.a.size();
            }
            return ((Integer) ipChange.ipc$dispatch("-1660845177", new Object[]{this})).intValue();
        }
            ...
            if (aVar != null) {
                if (aVar.b() > 0) {
                    ...
                    for (int i4 = 0; i4 < b2; i4++) {
                        T a2 = this.mAdapter.a(i4);
                        View view = null;
                        if (!this.mRemovedViewStack.empty()) {
                            view = this.mRemovedViewStack.pop();
                        }
                        addView(this.mAdapter.c(this, view, a2, i4));
                    }
                    ...
                    for (int i7 = 0; i7 < childCount; i7++) {
                        ...
                        if (width > i6 && acquireEmptyLine.d() > 0) {
                    ...
                    if (!this.isExpand && size2 >= 2) {
                        ...
                        for (int i8 = 0; i8 < size2; i8++) {
                            b bVar = this.mLineViewsList.get(i8);
                            if (i8 < 2) {
                    ...
                    if (View.MeasureSpec.getMode(i2) == 1073741824) {
                        ...
                        for (int i10 = 0; i10 < size4; i10++) {
                            i3 += this.mLineViewsList.get(i10).b;
                        }
                    }
