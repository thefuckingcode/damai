...
public class DMLRLabelView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        layoutParams.height = s50.a(context, 16.0f);
        layoutParams.setMargins(s50.a(context, 1.0f), 0, 0, 0);
        TextView textView = new TextView(context);
        this.mTagView = textView;
        textView.setGravity(16);
        this.mTagView.setPadding(s50.a(context, 20.0f), 0, s50.a(context, 6.0f), 0);
        ...
        layoutParams2.height = s50.a(context, 16.0f);
        DMLabelView dMLabelView = new DMLabelView(context);
        this.labelView = dMLabelView;
        dMLabelView.setLabelHeight(m42.a(getContext(), 16.0f));
        this.labelView.setPaddingLeft(s50.a(context, 5.0f));
        this.labelView.setPaddingRight(s50.a(context, 5.0f));
    ...
    public DMLabelView getLabelView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1228223237")) {
            return this.labelView;
        }
        return (DMLabelView) ipChange.ipc$dispatch("1228223237", new Object[]{this});
    }
