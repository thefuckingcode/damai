...
public class PrivacySettingActivity extends DamaiBaseActivity {
    ...
    private void initRecommendConfig() {
        ...
        this.mRecommendSwitch.setChecked(d20.K());
        this.mRecSwitchNoLogin.setChecked(d20.K());
    }
    ...
    private void requestQueryPermissionList() {
        ...
        new QueryPrivacyPermissonRequest().request(new DMMtopRequestListener<PrivacyPermissionBean>(PrivacyPermissionBean.class) {
            /* class cn.damai.setting.PrivacySettingActivity.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-2012304494")) {
                    ipChange.ipc$dispatch("-2012304494", new Object[]{this, str, str2});
                    return;
                }
            ...
            public void onSuccess(PrivacyPermissionBean privacyPermissionBean) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1593918700")) {
                    ipChange.ipc$dispatch("-1593918700", new Object[]{this, privacyPermissionBean});
                    return;
                }
    ...
    private void requestSetupPermission() {
        ...
        setupPermissionListRequest.request(new DMMtopRequestListener<SetPrivacyPermissionBean>(SetPrivacyPermissionBean.class) {
            /* class cn.damai.setting.PrivacySettingActivity.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-2020063853")) {
                    ipChange.ipc$dispatch("-2020063853", new Object[]{this, str, str2});
                    return;
                }
            ...
            public void onSuccess(SetPrivacyPermissionBean setPrivacyPermissionBean) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-861250129")) {
                    ipChange.ipc$dispatch("-861250129", new Object[]{this, setPrivacyPermissionBean});
                    return;
                }
    ...
    private void setDnaContent(String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "364043476")) {
            return R$layout.mine_privacy_setting_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("364043476", new Object[]{this})).intValue();
    }
    ...
    public void onClick(View view) {
        ...
        if (id == R$id.mine_title_left_icon_font_tv) {
            ...
            if (!this.isReturnProtocol) {
                ...
                SwitchButton switchButton = this.mDnaSwitch;
            ...
            if (this.isCheckedProtocol) {
                ...
                SwitchButton switchButton2 = this.mDnaSwitch;
            ...
            d20.a0(this.mRecommendSwitch.isChecked());
        } else if (id == R$id.recommend_switch_when_not_login) {
            d20.a0(this.mRecSwitchNoLogin.isChecked());
    ...
    public String setTitle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1609023560")) {
            return "";
        }
        return (String) ipChange.ipc$dispatch("1609023560", new Object[]{this});
    }
    ...
    public void showDnaError(boolean z) {
        ...
        TextView textView = this.mDnaErrorTv;
        if (!z) {
            i = 8;
        }
