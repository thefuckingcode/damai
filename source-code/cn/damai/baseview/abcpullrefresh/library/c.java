...
public class c {
    ...
    static {
        ...
        a(o52.SUPPORTED_VIEW_CLASSES, o52.class);
    }
    ...
    static ViewDelegate b(View view) {
        IpChange ipChange = $ipChange;
    ...
    static <T> T c(Context context, String str) {
        ...
        try {
            ...
            nu2.d("InstanceCreationUtils", "Cannot instantiate class: " + str + e.getMessage());
            return null;
        }
    }
    ...
    private static <T> T d(Context context, Class cls, Class[] clsArr, Object... objArr) {
        ...
        try {
            ...
            nu2.d("InstanceCreationUtils", "Cannot instantiate class: " + cls.getName() + e.getMessage());
            return null;
        }
    }
}
