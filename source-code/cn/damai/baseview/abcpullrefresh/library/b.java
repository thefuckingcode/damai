...
public class b extends yu0 {
    ...
    protected static TypedArray n(Context context, int i, int[] iArr) {
        IpChange ipChange = $ipChange;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v8, resolved type: android.animation.AnimatorSet */
    ...
    public boolean a() {
        ...
        if (z) {
            if (this.b.getAlpha() >= 0.5f) {
                ...
                animatorSet.playTogether(ObjectAnimator.ofFloat(viewGroup, "translationY", 0.0f, (float) (-viewGroup.getHeight())), ObjectAnimator.ofFloat(this.a, "alpha", 1.0f, 0.0f));
    ...
    public void c(float f2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1745649686")) {
            ipChange.ipc$dispatch("-1745649686", new Object[]{this, Float.valueOf(f2)});
            return;
        }
        ...
        if (smoothProgressBar != null) {
            ...
            smoothProgressBar2.setProgress(Math.round(((float) smoothProgressBar2.getMax()) * interpolation));
        }
    }
    ...
    public boolean g() {
        ...
        if (z) {
            ...
            AnimatorSet animatorSet = new AnimatorSet();
            ViewGroup viewGroup = this.b;
            animatorSet.playTogether(ObjectAnimator.ofFloat(viewGroup, "translationY", (float) (-viewGroup.getHeight()), 0.0f), ObjectAnimator.ofFloat(this.a, "alpha", 0.0f, 1.0f));
    ...
    public View l() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1535922123")) {
            return this.a;
        }
        return (View) ipChange.ipc$dispatch("1535922123", new Object[]{this});
    }
