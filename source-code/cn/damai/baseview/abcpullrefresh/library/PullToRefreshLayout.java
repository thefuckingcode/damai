...
public class PullToRefreshLayout extends FrameLayout {
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public String getViewDelegateClassName() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "-670964314")) {
                return this.mViewDelegateClassName;
            }
            return (String) ipChange.ipc$dispatch("-670964314", new Object[]{this});
        }
    }
    ...
    public yu0 getHeaderTransformer() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1995524855")) {
            return (yu0) ipChange.ipc$dispatch("1995524855", new Object[]{this});
        }
        ensureAttacher();
    ...
    public ViewDelegate getViewDelegateFromLayoutParams(View view) {
        ...
        } else if (view == null || !(view.getLayoutParams() instanceof LayoutParams)) {
            return null;
        } else {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        } else if (!isEnabled() || this.mPullToRefreshAttacher == null || getChildCount() <= 0) {
            return false;
        } else {
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1736484973")) {
            return new LayoutParams(getContext(), attributeSet);
        }
        return (FrameLayout.LayoutParams) ipChange.ipc$dispatch("-1736484973", new Object[]{this, attributeSet});
    }
