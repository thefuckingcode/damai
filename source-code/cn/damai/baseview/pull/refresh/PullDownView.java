...
public class PullDownView extends LinearLayout {
    ...
    private final OnHeaderViewStateChangeListener ON_HEADER_VIEW_STATE_CHANGE_LISTENER = new b();
    private final AdapterView.OnItemClickListener ON_ITEM_CLICK_LISTENER = new AdapterView.OnItemClickListener() {
        /* class cn.damai.baseview.pull.refresh.PullDownView.AnonymousClass3 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private final AdapterView.OnItemLongClickListener ON_ITEM_LONG_CLICK_LISTENER = new AdapterView.OnItemLongClickListener() {
        /* class cn.damai.baseview.pull.refresh.PullDownView.AnonymousClass4 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private final AbsListView.OnScrollListener ON_LISTVIEW_SCROLL_LISTENER = new AbsListView.OnScrollListener() {
        /* class cn.damai.baseview.pull.refresh.PullDownView.AnonymousClass1 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private final View.OnTouchListener ON_LISTVIEW_TOUCH_LISTENER = new a();
    private final String TAG = "PullDownView";
    private int mArrowIcon = R$drawable.uikit_pull_to_refresh_logo_0;
    ...
    private OnHeaderViewStateChangeListener mOnHeaderViewStateChangeListener = null;
    private OnObtainMoreListener mOnObtainMoreListener = null;
    private OnPullDownBackListener mOnPullDownBackListener = null;
    private OnRefreshListener mOnRefreshListener = null;
    private OnTouchDownUpListener mOnTouchDownUpListener;
    private OnTouchViewListener mOnTouchViewListener = null;
    private boolean mPullDownEnabled = true;
    private OnPullDownListener mPullDownListener = null;
    private OnItemClickListener mPullDownViewOnItemClickListener = null;
    private OnItemLongClickListener mPullDownViewOnItemLongClickListener = null;
    private EPullStatus mPullStatus = EPullStatus.PULL_NORMAL;
    ...
    public class a implements View.OnTouchListener {
        ...
        private int c(MotionEvent motionEvent) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-1916571437")) {
            ...
            } else if (PullDownView.this.mListView == null) {
                return 0;
            } else {
                ...
                if (Math.abs(motionEvent.getRawY() - this.b) > ((float) PullDownView.this.mTouchSlop)) {
                ...
                int i = -scrollY;
                int rawY2 = (int) (((double) (motionEvent.getRawY() - this.a)) / ((((double) height) / ((double) (height - (i * 2)))) * 1.2d));
                if (i + rawY2 >= 0) {
                    scrollY = rawY2;
                }
        ...
        public boolean a(int i) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "961582003")) {
                return i > PullDownView.this.mTouchSlop;
            }
            return ((Boolean) ipChange.ipc$dispatch("961582003", new Object[]{this, Integer.valueOf(i)})).booleanValue();
        }
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            if (!(!PullDownView.this.mPullDownEnabled || EPullStatus.MORE_REFRESHING == PullDownView.this.mPullStatus || PullDownView.this.mListView.getCount() == 0 || EPullStatus.PULL_REFRESHING == PullDownView.this.mPullStatus)) {
                ...
                if (action == 0) {
                    ...
                    d();
                } else if (action == 2 && c(motionEvent) == 1) {
                    return true;
                }
            }
            return false;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setPullStatus(EPullStatus ePullStatus) {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "973425005")) {
            return super.dispatchTouchEvent(motionEvent);
        }
        return ((Boolean) ipChange.ipc$dispatch("973425005", new Object[]{this, motionEvent})).booleanValue();
    }

    public HeaderView getHeaderView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-111278856")) {
            return this.mHeaderView;
        }
        return (HeaderView) ipChange.ipc$dispatch("-111278856", new Object[]{this});
    }

    public ListView getListView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2143033707")) {
            return this.mListView;
        }
        return (ListView) ipChange.ipc$dispatch("2143033707", new Object[]{this});
    }
