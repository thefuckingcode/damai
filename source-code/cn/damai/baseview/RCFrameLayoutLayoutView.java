...
public class RCFrameLayoutLayoutView extends FrameLayout implements Checkable, RCAttrs {
    ...
    public float getBottomLeftRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "918569964")) {
            return this.mRCHelper.a[4];
        }
        return ((Float) ipChange.ipc$dispatch("918569964", new Object[]{this})).floatValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public float getBottomRightRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "551567415")) {
            return this.mRCHelper.a[6];
        }
        return ((Float) ipChange.ipc$dispatch("551567415", new Object[]{this})).floatValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public int getStrokeColor() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "134957458")) {
            return this.mRCHelper.f;
        }
        return ((Integer) ipChange.ipc$dispatch("134957458", new Object[]{this})).intValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public int getStrokeWidth() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-623342513")) {
            return this.mRCHelper.h;
        }
        return ((Integer) ipChange.ipc$dispatch("-623342513", new Object[]{this})).intValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public float getTopLeftRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2005102900")) {
            return this.mRCHelper.a[0];
        }
        return ((Float) ipChange.ipc$dispatch("-2005102900", new Object[]{this})).floatValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public float getTopRightRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "112021847")) {
            return this.mRCHelper.a[2];
        }
        return ((Float) ipChange.ipc$dispatch("112021847", new Object[]{this})).floatValue();
    }
    ...
    public boolean isChecked() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1175654077")) {
            return this.mRCHelper.l;
        }
        return ((Boolean) ipChange.ipc$dispatch("1175654077", new Object[]{this})).booleanValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public boolean isClipBackground() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "573500272")) {
            return this.mRCHelper.i;
        }
        return ((Boolean) ipChange.ipc$dispatch("573500272", new Object[]{this})).booleanValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public boolean isRoundAsCircle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1166392884")) {
            return this.mRCHelper.d;
        }
        return ((Boolean) ipChange.ipc$dispatch("1166392884", new Object[]{this})).booleanValue();
    }
