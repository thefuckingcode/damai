...
public class HeaderViewListAdapter implements Filterable, WrapperListAdapter {
    ...
    public int getFootersCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-52428729")) {
            return this.mFooterViewInfos.size();
        }
        return ((Integer) ipChange.ipc$dispatch("-52428729", new Object[]{this})).intValue();
    }

    public int getHeadersCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1470645141")) {
            return this.mHeaderViewInfos.size();
        }
        return ((Integer) ipChange.ipc$dispatch("1470645141", new Object[]{this})).intValue();
    }
    ...
    public ListAdapter getWrappedAdapter() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1328430850")) {
            return this.mAdapter;
        }
        return (ListAdapter) ipChange.ipc$dispatch("-1328430850", new Object[]{this});
    }
