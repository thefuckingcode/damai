...
public class RCRelativeLayoutView extends RelativeLayout implements Checkable, RCAttrs {
    ...
    public float getBottomLeftRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1955127457")) {
            return this.mRCHelper.a[4];
        }
        return ((Float) ipChange.ipc$dispatch("1955127457", new Object[]{this})).floatValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public float getBottomRightRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1674888670")) {
            return this.mRCHelper.a[6];
        }
        return ((Float) ipChange.ipc$dispatch("-1674888670", new Object[]{this})).floatValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public int getStrokeColor() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "770101181")) {
            return this.mRCHelper.f;
        }
        return ((Integer) ipChange.ipc$dispatch("770101181", new Object[]{this})).intValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public int getStrokeWidth() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "11801210")) {
            return this.mRCHelper.h;
        }
        return ((Integer) ipChange.ipc$dispatch("11801210", new Object[]{this})).intValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public float getTopLeftRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1517341129")) {
            return this.mRCHelper.a[0];
        }
        return ((Float) ipChange.ipc$dispatch("-1517341129", new Object[]{this})).floatValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public float getTopRightRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1947232436")) {
            return this.mRCHelper.a[2];
        }
        return ((Float) ipChange.ipc$dispatch("-1947232436", new Object[]{this})).floatValue();
    }
    ...
    public boolean isChecked() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2021582414")) {
            return this.mRCHelper.l;
        }
        return ((Boolean) ipChange.ipc$dispatch("-2021582414", new Object[]{this})).booleanValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public boolean isClipBackground() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1061262043")) {
            return this.mRCHelper.i;
        }
        return ((Boolean) ipChange.ipc$dispatch("1061262043", new Object[]{this})).booleanValue();
    }

    @Override // cn.damai.baseview.rclayouthelper.RCAttrs
    public boolean isRoundAsCircle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-618988183")) {
            return this.mRCHelper.d;
        }
        return ((Boolean) ipChange.ipc$dispatch("-618988183", new Object[]{this})).booleanValue();
    }
