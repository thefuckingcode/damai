...
public class FilterReqParamBean implements Serializable {
    ...
    public CategoryRequestNewParams createReqParams() {
        ...
        categoryRequestNewParams.sortType = lk1.j(this.sortType, 10);
        if (f92.g(this.optionParam)) {
            categoryRequestNewParams.optionParam = s41.e(this.optionParam);
        } else {
