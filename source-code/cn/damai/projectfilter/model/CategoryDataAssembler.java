...
public final class CategoryDataAssembler {
    ...
    public final String getBtnText() {
        ...
        if (this.mSelectUsed4RequestList.size() != 0) {
            try {
                str = zc.h(this.mCategoryList, this.mSelectUsed4RequestList);
            } catch (Exception e) {
                e.printStackTrace();
            }
            k21.h(str, "{\n            try {\n    …\"\n            }\n        }");
    ...
    public final OnCategoryUpdateListener getMListener() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-434758245")) {
            return this.mListener;
        }
        return (OnCategoryUpdateListener) ipChange.ipc$dispatch("-434758245", new Object[]{this});
    }

    @NotNull
    public final ArrayList<CategoryLevelOne> getSelect4Request() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "408786505")) {
            return this.mSelectUsed4RequestList;
        }
        return (ArrayList) ipChange.ipc$dispatch("408786505", new Object[]{this});
    }
            ...
            for (CategoryLevelOne categoryLevelOne : list2) {
                ...
                if (categoryLevelOne.select && (list = categoryLevelOne.lineItemList) != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        k21.g(clone, "null cannot be cast to non-null type cn.damai.projectfilter.bean.CategoryLevelTwo");
