...
public class CategoryAdapter extends RecyclerView.Adapter<CVh> {
    ...
    public class CVh extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void a(CategoryBean categoryBean, int i) {
            ...
            this.b.setTextColor(categoryBean.isSelected ? ng0.C_FF2869 : ng0.C_C8C8C8);
    ...
    public CVh onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "510999577")) {
            return new CVh(LayoutInflater.from(this.a).inflate(R$layout.item_filter_one_category_item, viewGroup, false));
        }
        return (CVh) ipChange.ipc$dispatch("510999577", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
