...
public class FastDiffCallback extends DiffUtil.Callback {
    ...
    public boolean areContentsTheSame(int i, int i2) {
        ...
        if (!TextUtils.equals(filterBean.name, filterBean2.name) || !TextUtils.equals(filterBean.value, filterBean2.value) || filterBean.isSelected != filterBean2.isSelected) {
            z = false;
        }
        return z;
    }
    ...
    public boolean areItemsTheSame(int i, int i2) {
        ...
        if (!TextUtils.equals(filterBean.name, filterBean2.name) || !TextUtils.equals(filterBean.value, filterBean2.value)) {
            z = false;
        }
        return z;
    }
