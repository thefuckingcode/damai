...
public class FastFilterAdapter extends RecyclerView.Adapter<FastVh> {
    ...
    public static class FastVh extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void a(FilterBean filterBean, int i) {
            ...
            this.a.setTextColor(filterBean.isSelected ? ng0.C_FF2869 : ng0.C_333333);
    ...
    public FastVh onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1141586118")) {
            return new FastVh(LayoutInflater.from(this.a).inflate(R$layout.item_filter_fast_btn, viewGroup, false), this.b);
        }
        return (FastVh) ipChange.ipc$dispatch("-1141586118", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
