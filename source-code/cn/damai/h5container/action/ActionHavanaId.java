...
public class ActionHavanaId extends DMBridgeAction {
    ...
    public boolean doAction(String str, String str2, WVCallBackContext wVCallBackContext) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(c) && c.length() == 32) {
                wVResult.addData("mixId", yb1.c(userId).substring(8, 24));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String getAction() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1175169566")) {
            return "getHavanaId";
        }
        return (String) ipChange.ipc$dispatch("-1175169566", new Object[]{this});
    }
}
