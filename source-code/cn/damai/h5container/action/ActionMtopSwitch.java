...
public class ActionMtopSwitch extends DMBridgeAction {
    ...
    public boolean doAction(String str, String str2, WVCallBackContext wVCallBackContext) {
        ...
        if (!TextUtils.isEmpty(param)) {
            if ("damai".equals(param)) {
                Mtop.instance(Mtop.Id.INNER, xs0.a(), AppConfig.p()).registerTtid(AppConfig.p());
            } else if ("youku".equals(param)) {
                Mtop.instance(NetConstants.YOUKU_MTOP_INSTANCE_ID, xs0.a(), AppConfig.p()).registerTtid(AppConfig.p());
            }
        }
    ...
    public String getAction() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1843816916")) {
            return "mtopSwtich";
        }
        return (String) ipChange.ipc$dispatch("-1843816916", new Object[]{this});
    }
}
