...
public class ActionDMLoginWithUrl extends DMBridgeAction implements ILoginListener {
    ...
    public boolean doAction(String str, String str2, WVCallBackContext wVCallBackContext) {
        ...
        try {
            if (LoginManager.k().q()) {
                ...
                DMNav.from(this.contextReference).withExtras(bundle).toUri(NavUri.b(gr.t));
            } else {
    ...
    public String getAction() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1611065671")) {
            return "dmLoginWithUrl";
        }
        return (String) ipChange.ipc$dispatch("-1611065671", new Object[]{this});
    }
