...
public class ActionImageViewer extends DMBridgeAction {
    ...
    public boolean doAction(String str, String str2, WVCallBackContext wVCallBackContext) {
        ...
        DMNav.from(this.contextReference).withExtras(bundle).toUri(NavUri.b(da.XFLUSH_NAME).e("gallery"));
    ...
    public String getAction() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1291654003")) {
            return "imageViewer";
        }
        return (String) ipChange.ipc$dispatch("1291654003", new Object[]{this});
    }
}
