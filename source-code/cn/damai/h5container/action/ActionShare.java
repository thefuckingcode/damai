...
public class ActionShare extends DMBridgeAction {
    ...
    private void addCopyLink(LinearLayout linearLayout) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "653457712")) {
            ...
            linearLayout.addView(q92.c(this.contextReference, this.mProducturl));
        }
    }
    ...
    private void mock() {
        ...
        jSONObject.put("type", (Object) by0.ARG_COPY);
    ...
    public boolean doAction(String str, String str2, WVCallBackContext wVCallBackContext) {
        ...
        if (!xf2.j(getParam("plugins")) && (jSONArray = this.jsonObject.getJSONArray("plugins")) != null && jSONArray.size() > 0) {
            for (int i = 0; i < jSONArray.size(); i++) {
                ...
                if (!(jSONObject == null || jSONObject.getString("type") == null)) {
                    ...
                    } else if (by0.ARG_COPY.equals(jSONObject.getString("type"))) {
    ...
    public String getAction() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1792834491")) {
            return "share";
        }
        return (String) ipChange.ipc$dispatch("-1792834491", new Object[]{this});
    }
}
