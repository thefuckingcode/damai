...
public class ActionFissionShare extends DMBridgeAction {
    ...
    private FissionParam getFissionParam() {
        ...
        try {
            return (FissionParam) s41.a(this.jsonObject.toJSONString(), FissionParam.class);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public String getAction() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1376105962")) {
            return "newShare";
        }
        return (String) ipChange.ipc$dispatch("1376105962", new Object[]{this});
    }
}
