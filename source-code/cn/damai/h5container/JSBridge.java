...
public class JSBridge {
    ...
    private Handler mHandler = new Handler() {
        /* class cn.damai.h5container.JSBridge.AnonymousClass3 */
    ...
    private boolean canWxPay(IWXAPI iwxapi) {
        ...
        a.j(context, bk2.b(context, R$string.pay_wx_not_support_toast));
        return false;
    }
    ...
    private void doAliPay(String str, final String str2, String str3) {
        ...
        new Thread(new Runnable() {
            /* class cn.damai.h5container.JSBridge.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "812096524")) {
                    ipChange.ipc$dispatch("812096524", new Object[]{this});
                    return;
                }
    ...
    private void onAlipay(String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    public long getCityId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1174901725")) {
            return xs0.b();
        }
        return ((Long) ipChange.ipc$dispatch("1174901725", new Object[]{this})).longValue();
    }
    ...
    public void openPage(String str) {
        ...
        pp2.b().q((Activity) this.mContext, str);
    }
    ...
    public void setSpecialTitle(final String str) {
        ...
        this.mWebView.post(new Runnable() {
            /* class cn.damai.h5container.JSBridge.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1008610029")) {
                    ipChange.ipc$dispatch("1008610029", new Object[]{this});
