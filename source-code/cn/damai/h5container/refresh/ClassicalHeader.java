...
public class ClassicalHeader extends FrameLayout implements JRefreshHeader {
    ...
    public int dp2px(Context context, float f) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1251319538")) {
            return (int) ((f * context.getResources().getDisplayMetrics().density) + 0.5f);
        }
        return ((Integer) ipChange.ipc$dispatch("1251319538", new Object[]{this, context, Float.valueOf(f)})).intValue();
    }
    ...
    public int maxOffsetHeight() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "426071370")) {
            return getHeight() * 4;
        }
        return ((Integer) ipChange.ipc$dispatch("426071370", new Object[]{this})).intValue();
    }
    ...
    public int refreshHeight() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1395001862")) {
            return getHeight();
        }
        return ((Integer) ipChange.ipc$dispatch("1395001862", new Object[]{this})).intValue();
    }
