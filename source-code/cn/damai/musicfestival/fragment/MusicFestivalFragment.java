...
public class MusicFestivalFragment extends AbsFragmentV2 implements OnCityChangedListener, HomeGetPageListener {
    ...
    public class a implements OnBizListener<Pair<BaseResponse, AtmosphereBean>> {
        ...
        /* compiled from: Taobao */
        public class C0031a implements OnErrClickListener {
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        public void onFail(String str, String str2) {
            ...
            MusicFestivalFragment.this.refreshFinish();
            MusicFestivalFragment.this.showErrorViewV2(str, str2, new C0031a());
        }
    }
    ...
    private void addScrollListener() {
        ...
        this.mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            /* class cn.damai.musicfestival.fragment.MusicFestivalFragment.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "208848957")) {
                    ipChange.ipc$dispatch("208848957", new Object[]{this, recyclerView, Integer.valueOf(i), Integer.valueOf(i2)});
                    return;
                }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateHomeAtmosphere(AtmosphereBean atmosphereBean) {
        String str;
        IpChange ipChange = $ipChange;
    ...
    public int getDistance() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1068222618")) {
            return this.mScrollDistance;
        }
        return ((Integer) ipChange.ipc$dispatch("1068222618", new Object[]{this})).intValue();
    }
