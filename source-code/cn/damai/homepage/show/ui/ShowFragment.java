...
public class ShowFragment extends AbsFragmentV2 implements OnCityChangedListener {
    ...
    public class e {
        ...
        private List<ShowShowItem> a(ShowBean showBean) {
            ...
            if (ShowFragment.this.mShowRequest.cityOption == 0) {
                ...
                if (i == 0) {
                    if (ShowFragment.this.mIsFristProject) {
                        ...
                        if (xf2.e(showBean.nearByCity) > 0) {
                            ...
                            if (xf2.e(showBean.nearByCity) < Integer.parseInt(ShowFragment.this.mShowRequest.pageSize)) {
                ...
                } else if (xf2.e(showBean.currentCity) > 0) {
            ...
            } else if (xf2.e(showBean.nearByCity) > 0) {
                ...
                while (it.hasNext() && (next = it.next()) != null && next.getSections() != null) {
                    for (BaseSection baseSection : next.getSections()) {
                        if (!(baseSection == null || !TextUtils.equals(wj2.CATEGORY_LIST_COMPONENT_ID, baseSection.getComponentId()) || baseSection.getItem() == null)) {
                            List<ShowShowItem> a2 = a((ShowBean) JSON.parseObject(baseSection.getItem().toJSONString(), ShowBean.class));
                            JSONObject jSONObject = new JSONObject();
                            jSONObject.put("result", (Object) a2);
                            jSONObject.put(qa.KEY_DAOJISHI, (Object) ShowFragment.this.mDaojishi);
                            jSONObject.put(qa.KEY_SHOW_DIS, (Object) Boolean.valueOf(ShowFragment.this.mIsShowJuli));
                            jSONObject.put(qa.TRACKKEY_CATEGORY_NAME, (Object) ShowFragment.this.mCategoryName);
                            jSONObject.put("trackB", (Object) ra2.f(ShowFragment.this.mCategoryId));
            ...
            while (it.hasNext() && (next = it.next()) != null && next.getSections() != null) {
                ...
                while (true) {
                    if (it2.hasNext()) {
                        ...
                        if (next2 != null && TextUtils.equals(wj2.CATEGORY_LIST_COMPONENT_ID, next2.getComponentId()) && next2.getItem() != null && (showBean = (ShowBean) JSON.parseObject(next2.getItem().toJSONString(), ShowBean.class)) != null) {
                            if (xf2.e(showBean.currentCity) + xf2.e(showBean.nearByCity) == 0) {
                                return true;
                            }
                            return false;
                        }
    ...
    private ShowRequest getRequest() {
        ...
        this.mShowRequest.currentCityId = d20.c();
        this.mShowRequest.cityId = d20.c();
        this.mShowRequest.comboDamaiCityId = d20.c();
        ShowRequest showRequest = this.mShowRequest;
        showRequest.longitude = d20.o() + "";
        ShowRequest showRequest2 = this.mShowRequest;
        showRequest2.latitude = d20.n() + "";
    ...
    public void initView() {
        ...
        this.mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            /* class cn.damai.homepage.show.ui.ShowFragment.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-664404127")) {
                    ipChange.ipc$dispatch("-664404127", new Object[]{this, recyclerView, Integer.valueOf(i), Integer.valueOf(i2)});
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.mUTBuilder = ra2.h().g(this.mCategoryId);
        initView();
    ...
    public void request(final boolean z, boolean z2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1530864758")) {
            ...
            if (this.mShowRequest.cityOption == 1 && (drObj2 = this.drObj) != null) {
            ...
            tetrisRequest.request(new DMMtopWarningListener<BaseResponse>(BaseResponse.class, tetrisRequest.toJsonString()) {
                /* class cn.damai.homepage.show.ui.ShowFragment.AnonymousClass5 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // cn.damai.tetris.DMMtopWarningListener
                public void onFailWithWarning(String str, String str2) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "456938147")) {
                        ipChange.ipc$dispatch("456938147", new Object[]{this, str, str2});
                        return;
                    }
                ...
                public void onSuccessWithWarning(BaseResponse baseResponse) {
                    ...
                    List<Node> list2;
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-739169733")) {
                        ipChange.ipc$dispatch("-739169733", new Object[]{this, baseResponse});
                        return;
                    }
                    ...
                    if (ShowFragment.this.mIsFristProject) {
                        if (baseResponse.layers == null) {
                            ...
                            if (ShowFragment.this.mShowRequest != null) {
                                sa2.a(JSON.toJSONString(ShowFragment.this.mShowRequest));
                                return;
                            }
                            return;
                        }
