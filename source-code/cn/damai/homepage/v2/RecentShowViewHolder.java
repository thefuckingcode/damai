...
public class RecentShowViewHolder extends BaseViewHolder<RecentShowBean> {
    ...
    ImageView mRankItemImage = ((ImageView) this.itemView.findViewById(R$id.homepage_rank_item_image_normal));
    DMDigitTextView mRankItemPrice = ((DMDigitTextView) this.itemView.findViewById(R$id.homepage_rank_item_price));
    LinearLayout mRankItemPriceLayout = ((LinearLayout) this.itemView.findViewById(R$id.homepage_rank_item_price_layout));
    DMDigitTextView mRankItemPriceUnknown;
    DMCategroyTagView mRankItemTag;
    TextView mRankItemTime = ((TextView) this.itemView.findViewById(R$id.homepage_rank_item_time));
    TextView mRankItemTitle = ((TextView) this.itemView.findViewById(R$id.homepage_rank_item_title));
    ...
    public RecentShowViewHolder(View view) {
        ...
        this.itemView.setLayoutParams(new ViewGroup.LayoutParams(v50.a(this.mContext, 98.0f), -2));
    }
    ...
    public void bindData(@NonNull IItem<ItemValue> iItem) {
        ...
        handleView((RecentShowBean) getValue(), getModuleRank());
    }
    ...
    public void handleView(RecentShowBean recentShowBean, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-187827383")) {
            ...
            if (this.mRankItemImage.getTag() instanceof zq) {
                ((zq) this.mRankItemImage.getTag()).cancel();
            }
            DMImageCreator f = a.b().f(recentShowBean.projectPic, v50.a(this.context, 98.0f), v50.a(this.mContext, 131.0f));
            ...
            if (recentShowBean.isLiveRoom()) {
                ...
                this.mRankItemTag.setVisibility((!TextUtils.isEmpty(recentShowBean.categoryName) || !TextUtils.isEmpty(recentShowBean.discountRate)) ? 0 : 8);
            }
