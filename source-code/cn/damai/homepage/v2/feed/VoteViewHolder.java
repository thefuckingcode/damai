...
public class VoteViewHolder extends BaseViewHolder<VoteInfoBean> {
    ...
    public class a implements VotePanel.VoteActionListener {
        ...
        public void ut4CancelVoteClick(VoteInfoBean voteInfoBean) {
            ...
            gw0.i().f(gw0.g(VoteViewHolder.this.getComponentActions()), "", "", "", "12", voteInfoBean.id, VoteViewHolder.this.getData().getIndex());
        }
        ...
        public void ut4VoteCardExposure(View view, VoteInfoBean voteInfoBean, int i) {
            ...
            gw0.i().k(gw0.g(VoteViewHolder.this.getComponentActions()), view, "", "", "", "12", voteInfoBean.id, VoteViewHolder.this.getData().getIndex());
        }
        ...
        public void ut4VoteClick(VoteInfoBean voteInfoBean, VoteBean voteBean, int i) {
            ...
            gw0.i().m(gw0.g(VoteViewHolder.this.getComponentActions()), "", "", "", "12", voteBean.id, VoteViewHolder.this.getData().getIndex());
        }
    }
    ...
    private VotePanel.VoteActionListener getActionListener(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "51819380")) {
            return new a(context);
        }
        return (VotePanel.VoteActionListener) ipChange.ipc$dispatch("51819380", new Object[]{this, context});
    }
    ...
    public void bindData(@NonNull IItem<ItemValue> iItem) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1602159301")) {
            ...
            VoteInfoBean voteInfoBean = (VoteInfoBean) getValue();
            this.mBean = voteInfoBean;
            this.mRoot.setBackground(voteInfoBean.getVoteBgDrawable());
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                cn.damai.common.image.a.b().f(str, (DisplayMetrics.getwidthPixels(n42.b(xs0.a())) - (n42.a(xs0.a(), 21.0f) * 2)) / 2, a3).g(this.mTopImg);
                i = a2;
            }
