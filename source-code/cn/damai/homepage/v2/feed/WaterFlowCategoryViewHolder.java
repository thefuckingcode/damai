...
public class WaterFlowCategoryViewHolder extends BaseViewHolder<WaterFlowRecommendItem> {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            gw0.i().m(gw0.g(WaterFlowCategoryViewHolder.this.getComponentActions()), "", waterFlowRecommendItem.alg, waterFlowRecommendItem.scm, waterFlowRecommendItem.cardType, "", WaterFlowCategoryViewHolder.this.getData().getIndex());
            ...
            DMNav.from(WaterFlowCategoryViewHolder.this.mContext).withExtras(bundle).toUri(NavUri.b(gr.o));
        }
    }
    ...
    public WaterFlowCategoryViewHolder(View view) {
        ...
        this.itemView.setLayoutParams(new ViewGroup.LayoutParams(-1, ((int) (((double) (((float) ((((DisplayMetrics.getwidthPixels(v50.b(this.mContext)) - v50.a(this.mContext, 30.0f)) / 2) - v50.a(this.mContext, 12.0f)) * 233)) * 1.0f)) / 160.5d)) + v50.a(this.mContext, 20.0f)));
    }
    ...
    public void handleView(WaterFlowRecommendItem waterFlowRecommendItem) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-427866978")) {
            ...
            gw0.i().k(gw0.g(getComponentActions()), this.itemView, "", waterFlowRecommendItem.alg, waterFlowRecommendItem.scm, waterFlowRecommendItem.cardType, "", getData().getIndex());
        }
    }
}
