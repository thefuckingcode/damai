...
public class WaterFlowRankListViewHolder extends BaseViewHolder<WaterFlowRecommendItem> {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            gw0 i = gw0.i();
            String g = gw0.g(WaterFlowRankListViewHolder.this.getComponentActions());
            ...
            if ("5".equals(waterFlowRecommendItem.cardType)) {
                ...
                try {
                    ...
                    g91.b("WaterFlowRankListViewHolder", e.getMessage());
                }
                bundle.putLong(RankListFragment.KEY_RANK_ID, j);
                DMNav.from(WaterFlowRankListViewHolder.this.mContext).withExtras(bundle).toUri(NavUri.b(gr.C));
                return;
            }
    ...
    public void bindData(@NonNull IItem<ItemValue> iItem) {
        ...
        this.imageViewHeight = (int) ((((float) (a2 * 393)) * 1.0f) / 342.0f);
        ...
        this.itemView.setLayoutParams(new FrameLayout.LayoutParams(-1, this.imageViewHeight + v50.a(this.mContext, 9.0f)));
    ...
    public void handleView(WaterFlowRecommendItem waterFlowRecommendItem) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-2049650638")) {
            ...
            if (this.mRankListImage.getTag() instanceof zq) {
                ((zq) this.mRankListImage.getTag()).cancel();
            }
    ...
    public void render(int i) {
        ...
        dt0.b(this.mRankGradient, GradientDrawable.Orientation.TOP_BOTTOM, 0.0f, new int[]{tj.c(1.0f, i), tj.c(0.8f, i), tj.c(0.4f, i), tj.c(0.0f, i), tj.c(0.0f, i)});
    }
}
