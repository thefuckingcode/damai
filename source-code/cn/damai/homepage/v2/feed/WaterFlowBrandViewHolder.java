...
public class WaterFlowBrandViewHolder extends BaseViewHolder<WaterFlowRecommendItem> {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            gw0.i().m(gw0.g(WaterFlowBrandViewHolder.this.getComponentActions()), waterFlowRecommendItem.projectId, waterFlowRecommendItem.alg, waterFlowRecommendItem.scm, waterFlowRecommendItem.cardType, waterFlowRecommendItem.brandId, WaterFlowBrandViewHolder.this.getData().getIndex());
            Bundle bundle = new Bundle();
            bundle.putString("userId", waterFlowRecommendItem.brandId);
            bundle.putString("usertype", "4");
            DMNav.from(WaterFlowBrandViewHolder.this.mContext).withExtras(bundle).toUri(NavUri.b(gr.Y));
        }
    }
    ...
    public class c implements DMImageCreator.DMImageSuccListener {
        ...
        public class a implements DMRGBUtil.OnFetchColorListener {
            ...
            public void onFetchColor(int i) {
                ...
                dt0.a(WaterFlowBrandViewHolder.this.mVenueBgShade, GradientDrawable.Orientation.LEFT_RIGHT, (float) v50.a(WaterFlowBrandViewHolder.this.mContext, 6.0f), i);
            }
        }
        ...
        public void onSuccess(DMImageCreator.e eVar) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-1742695118")) {
                ...
                l01.c(WaterFlowBrandViewHolder.this.mContext, this.a.backgroundPic, eVar.b, new b());
            }
        }
    }
    ...
    public void bindData(@NonNull IItem<ItemValue> iItem) {
        ...
        int i = (int) ((((float) (a2 * UCNetworkDelegate.CHANGE_WEBVIEW_URL)) * 1.0f) / 168.0f);
        this.imageViewHeight = i;
        this.itemView.setLayoutParams(new ViewGroup.LayoutParams(-1, i + v50.a(this.mContext, 12.0f)));
    ...
    public void handleView(WaterFlowRecommendItem waterFlowRecommendItem) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1346834047")) {
            ...
            DMImageCreator f = cn.damai.common.image.a.b().f(waterFlowRecommendItem.pic, v50.a(this.mContext, 50.0f), v50.a(this.mContext, 50.0f));
            ...
            gw0.i().k(gw0.g(getComponentActions()), this.itemView, waterFlowRecommendItem.projectId, waterFlowRecommendItem.alg, waterFlowRecommendItem.scm, waterFlowRecommendItem.cardType, waterFlowRecommendItem.brandId, getData().getIndex());
        }
    }
}
