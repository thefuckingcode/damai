...
public class HomePageExhibitionRequest extends DMBaseMtopRequest implements IHomeFeedReq, Serializable {
    ...
    public String getApiName() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-651394010")) {
            return HOME_API_HOMEPAGE_EXHIBITION_DYNAMIC;
        }
        return (String) ipChange.ipc$dispatch("-651394010", new Object[]{this});
    }
    ...
    public String getVersion() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1516342713")) {
            return this.apiVersion;
        }
        return (String) ipChange.ipc$dispatch("1516342713", new Object[]{this});
    }
