...
public class MainAlertEntity implements Serializable {
    ...
    private boolean textEquals(String str, String str2) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1708964855")) {
            return TextUtils.equals(str, str2);
        }
        return ((Boolean) ipChange.ipc$dispatch("-1708964855", new Object[]{this, str, str2})).booleanValue();
    }
    ...
    public MemberGuideInfo getMemberDailyBindGuideInfo() {
        ...
        } else if (TextUtils.isEmpty(this.memberGuideInfo)) {
            return new MemberGuideInfo();
        } else {
            return (MemberGuideInfo) s41.a(this.memberGuideInfo, MemberGuideInfo.class);
        }
    }
    ...
    public MemberFinishedInfo getMemberFinishedInfo() {
        ...
        } else if (TextUtils.isEmpty(this.memberFinishedInfo)) {
            return new MemberFinishedInfo();
        } else {
            return (MemberFinishedInfo) s41.a(this.memberFinishedInfo, MemberFinishedInfo.class);
        }
    }
    ...
    public boolean isDailyMemberGuide() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1688449902")) {
            return textEquals("5", this.type);
        }
        return ((Boolean) ipChange.ipc$dispatch("1688449902", new Object[]{this})).booleanValue();
    }

    public boolean isFirstMemberGuide() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1681150917")) {
            return textEquals("4", this.type);
        }
        return ((Boolean) ipChange.ipc$dispatch("1681150917", new Object[]{this})).booleanValue();
    }

    public boolean isMemberFinishGuide() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1512570988")) {
            return textEquals("6", this.type);
        }
        return ((Boolean) ipChange.ipc$dispatch("1512570988", new Object[]{this})).booleanValue();
    }

    public boolean isType4Member() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-726030457")) {
            return isFirstMemberGuide() || isDailyMemberGuide() || isMemberFinishGuide();
        }
        return ((Boolean) ipChange.ipc$dispatch("-726030457", new Object[]{this})).booleanValue();
    }
}
