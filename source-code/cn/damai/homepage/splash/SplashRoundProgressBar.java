...
public class SplashRoundProgressBar extends View {
    ...
    public int getCricleColor() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1089572294")) {
            return this.roundColor;
        }
        return ((Integer) ipChange.ipc$dispatch("1089572294", new Object[]{this})).intValue();
    }

    public int getCricleProgressColor() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "449840659")) {
            return this.roundProgressColor;
        }
        return ((Integer) ipChange.ipc$dispatch("449840659", new Object[]{this})).intValue();
    }
    ...
    public float getRoundWidth() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-705624530")) {
            return this.roundWidth;
        }
        return ((Float) ipChange.ipc$dispatch("-705624530", new Object[]{this})).floatValue();
    }

    public int getTextColor() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "580145841")) {
            return this.textColor;
        }
        return ((Integer) ipChange.ipc$dispatch("580145841", new Object[]{this})).intValue();
    }

    public float getTextSize() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1590298808")) {
            return this.textSize;
        }
        return ((Float) ipChange.ipc$dispatch("1590298808", new Object[]{this})).floatValue();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (i2 == 0) {
            ...
            if (i3 != 0) {
                canvas.drawArc(rectF, -90.0f, (float) ((i3 * 360) / this.max), true, this.paint);
            }
        }
    }
