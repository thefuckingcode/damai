...
public class WaterFlowBrandViewHolder extends RecyclerView.ViewHolder {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            DMNav.from(WaterFlowBrandViewHolder.this.a).withExtras(bundle).toUri(NavUri.b(gr.Y));
        }
    }
    ...
    public class c implements DMImageCreator.DMImageSuccListener {
        ...
        public class a implements DMRGBUtil.OnFetchColorListener {
            ...
            public void onFetchColor(int i) {
                ...
                dt0.a(WaterFlowBrandViewHolder.this.d, GradientDrawable.Orientation.LEFT_RIGHT, (float) v50.a(WaterFlowBrandViewHolder.this.a, 6.0f), i);
            }
        }
        ...
        public void onSuccess(DMImageCreator.e eVar) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "226877431")) {
                ...
                l01.c(WaterFlowBrandViewHolder.this.a, this.a.backgroundPic, eVar.b, new b());
            }
        }
    }
    ...
    public WaterFlowBrandViewHolder(String str, Context context) {
        ...
        int a2 = ((DisplayMetrics.getwidthPixels(v50.b(context)) - v50.a(context, 30.0f)) / 2) - v50.a(context, 12.0f);
        this.j = a2;
        this.k = (int) ((((float) (a2 * UCNetworkDelegate.CHANGE_WEBVIEW_URL)) * 1.0f) / 168.0f);
        new FrameLayout.LayoutParams(this.j, this.k);
        this.itemView.setLayoutParams(new ViewGroup.LayoutParams(-1, this.k + v50.a(context, 12.0f)));
    ...
    public void handleView(WaterFlowRecommendItem waterFlowRecommendItem) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1749721958")) {
            ...
            DMImageCreator f2 = cn.damai.common.image.a.b().f(waterFlowRecommendItem.pic, v50.a(this.a, 50.0f), v50.a(this.a, 50.0f));
            int i2 = R$drawable.uikit_user_default_icon_trans_white;
            f2.i(i2).c(i2).g(this.e);
