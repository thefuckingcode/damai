...
public class HomeLottieView extends FrameLayout {
    ...
    public LottieAnimationView getLottieView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1643456165")) {
            return this.lottieView;
        }
        return (LottieAnimationView) ipChange.ipc$dispatch("1643456165", new Object[]{this});
    }
    ...
    public void setBgImage(String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1203604483")) {
            ...
            a.b().c(pr.a(str)).g(this.bgImageView);
        }
    }
    ...
    public void setProgress(int i) {
        ...
        LottieAnimationView lottieAnimationView = this.lottieView;
        if (lottieAnimationView != null) {
            lottieAnimationView.setProgress((float) i);
        }
    }
