...
public class TabPagerAdapter extends FragmentStatePagerAdapter {
    ...
    private HomeCmsFragment g = null;
    ...
    public Fragment a() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1290566560")) {
            return this.b;
        }
        return (Fragment) ipChange.ipc$dispatch("1290566560", new Object[]{this});
    }

    public HomeCmsFragment b() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "717362405")) {
            return this.g;
        }
        return (HomeCmsFragment) ipChange.ipc$dispatch("717362405", new Object[]{this});
    }
    ...
    public Fragment getItem(int i) {
        ...
        if (AppConfig.v()) {
            g91.c("TabPagerExp", "HomeTab can not find match fragment " + s41.e(homeTabBean));
        }
