...
public class NetStateChangeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (ConnectivityBroadcastReceiver.CONNECTIVITY_ACTION.equals(intent.getAction()) && xh1.c(context) == NetworkType.NETWORK_MOBILE && (onNetWorkChangeListener = this.a) != null) {
