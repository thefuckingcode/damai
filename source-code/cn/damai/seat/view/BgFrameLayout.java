...
public class BgFrameLayout extends FrameLayout {
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (i > i5 * 2 && i2 > i5) {
            Path path = new Path();
            this.bgPath = path;
            path.moveTo(0.0f, (float) this.topRadius);
            this.bgPath.quadTo(0.0f, 0.0f, (float) this.topRadius, 0.0f);
            this.bgPath.lineTo((float) (i - this.topRadius), 0.0f);
            float f = (float) i;
            this.bgPath.quadTo(f, 0.0f, f, (float) this.topRadius);
            float f2 = (float) i2;
            ...
            path2.moveTo(0.0f, (float) this.topRadius);
            this.topRadiusPath.quadTo(0.0f, 0.0f, (float) this.topRadius, 0.0f);
            this.topRadiusPath.lineTo((float) (i - this.topRadius), 0.0f);
            this.topRadiusPath.quadTo(f, 0.0f, f, (float) this.topRadius);
        }
    }
    ...
    public BgFrameLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.topRadius = n42.a(context, 12.0f);
