    ...
    public static class DimensWrap implements Serializable {
        ...
        public void setFraction(float f) {
            ...
            if (view != null && view.getLayoutParams() != null) {
                ...
                layoutParams.width = (int) (((float) this.endWidth) + (((float) this.mOffsetWidth) * f));
                layoutParams.height = (int) (((float) this.endHeight) + (((float) this.mOffsetHeight) * f));
                this.target.setLayoutParams(layoutParams);
                View view2 = this.target;
                float f2 = this.endAlpha;
                view2.setAlpha(f2 + ((this.startAlpha - f2) * f));
                s72.f("animator : fraction = " + f + " , startHeight = " + this.startHeight + " , endHeight = " + this.endHeight + " , startAlpha = " + this.startAlpha + " ,endAlpha = " + this.endAlpha);
        ...
        public DimensWrap(View view, int i, int i2, int i3, int i4, int i5, int i6) {
            ...
            this.mOffsetWidth = i - i2;
            this.mOffsetHeight = i3 - i4;
            this.startAlpha = (float) i5;
            this.endAlpha = (float) i6;
        }
    }
}
