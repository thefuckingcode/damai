...
public abstract class SeatVrTipPanel implements View.OnClickListener {
    ...
    public SeatVrTipPanel(Activity activity, View view) {
        if (view != null && activity != null && !activity.isFinishing()) {
            ...
            this.d = ScreenUtil.dip2px(xs0.a(), 124.0f);
            this.e = ScreenUtil.dip2px(xs0.a(), 104.0f);
        }
    }
    ...
    private void i(View view) {
        ...
        try {
            ...
            create.setCornerRadius((float) n42.a(this.a, 6.0f));
    ...
    public void n(SeatNew seatNew, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1778708079")) {
            ...
            int i2 = R$drawable.bg_border_corner_6_solid_f5f5f5;
            c2.i(i2).c(i2).k(new DMRoundedCornersBitmapProcessor(n42.a(this.a, 12.0f), 0)).n(new d(str)).e(new c(this)).f();
            m();
        }
    }
