...
public class SeatDynamic implements Serializable {
    ...
    public IPriceManager getPriceManager() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "324422363")) {
            return new PriceManagerImpl(this.priceList);
        }
        return (IPriceManager) ipChange.ipc$dispatch("324422363", new Object[]{this});
    }
    ...
    public boolean hasPromotion() {
        ...
        PromotionBean promotionBean = this.promotionDetail;
        return promotionBean != null && !f92.d(promotionBean.promotionGroupList);
    }
    ...
    public boolean showPromotion() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-325465179")) {
            return hasPromotion();
        }
        return ((Boolean) ipChange.ipc$dispatch("-325465179", new Object[]{this})).booleanValue();
    }
    ...
    public void updateRegions(List<Region> list) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "74424258")) {
            ...
            for (Region region : list) {
                ...
                sb.append(region.id);
                sb.append("");
                region.state = !f92.d(summaryMap.get(sb.toString())) ? 1 : 0;
            }
        }
    }
}
