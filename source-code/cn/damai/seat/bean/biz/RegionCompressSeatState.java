...
public class RegionCompressSeatState implements SeatStateChild, Serializable {
    ...
    public int getLength() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1330997346")) {
            return getTotalLength();
        }
        return ((Integer) ipChange.ipc$dispatch("1330997346", new Object[]{this})).intValue();
    }

    public String getRegionId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "3377626")) {
            return this.regionId;
        }
        return (String) ipChange.ipc$dispatch("3377626", new Object[]{this});
    }
    ...
    public int getSeatStateByIndex(int i) {
        ...
        } else if (i < 0 || i >= this.totalLength) {
            return o72.SEAT_STATUS_SALE_OUT.shortValue();
        } else {
    ...
    public int getState(SeatNew seatNew) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1730887972")) {
            return getSeatStateByIndex(seatNew.i);
        }
        return ((Integer) ipChange.ipc$dispatch("1730887972", new Object[]{this, seatNew})).intValue();
    }

    public int getTotalLength() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1869436354")) {
            return this.totalLength;
        }
        return ((Integer) ipChange.ipc$dispatch("-1869436354", new Object[]{this})).intValue();
    }
}
