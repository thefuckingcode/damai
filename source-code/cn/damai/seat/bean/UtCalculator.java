...
public class UtCalculator implements Serializable {
    ...
    public static UtCalculator fail(long j, long j2, List<SeatCalcParams> list, String str, String str2) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-22793419")) {
            return new UtCalculator(false, j, j2, list, str, str2);
        }
        return (UtCalculator) ipChange.ipc$dispatch("-22793419", new Object[]{Long.valueOf(j), Long.valueOf(j2), list, str, str2});
    }

    public static UtCalculator success(long j, long j2, List<SeatCalcParams> list) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1236916150")) {
            return new UtCalculator(true, j, j2, list, null, null);
        }
        return (UtCalculator) ipChange.ipc$dispatch("-1236916150", new Object[]{Long.valueOf(j), Long.valueOf(j2), list});
    }
