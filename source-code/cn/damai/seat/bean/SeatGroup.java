...
public class SeatGroup {
    ...
    public final boolean isPackage = false;
    ...
    public String getKanTaiName() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-691427910")) {
            ...
            return null;
        } else if (!f92.d(this.packageList)) {
    ...
    public SeatGroup(@NonNull List<SeatNew> list) {
        ...
        Collections.sort(arrayList, new Comparator<SeatNew>() {
            /* class cn.damai.seat.bean.SeatGroup.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;
