...
public final class SeatPB$SeatData extends GeneratedMessageLite<SeatPB$SeatData, Builder> implements SeatPB$SeatDataOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<SeatPB$SeatData, Builder> implements SeatPB$SeatDataOrBuilder {
        ...
        public SeatPB$FloorSeat getFloorSeat(int i) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "1244008775")) {
                return ((SeatPB$SeatData) this.instance).getFloorSeat(i);
            }
            return (SeatPB$FloorSeat) ipChange.ipc$dispatch("1244008775", new Object[]{this, Integer.valueOf(i)});
        }

        @Override // cn.damai.serialize.pbdecoder.pb.SeatPB$SeatDataOrBuilder
        public int getFloorSeatCount() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-1615825969")) {
                return ((SeatPB$SeatData) this.instance).getFloorSeatCount();
            }
            return ((Integer) ipChange.ipc$dispatch("-1615825969", new Object[]{this})).intValue();
        }

        @Override // cn.damai.serialize.pbdecoder.pb.SeatPB$SeatDataOrBuilder
        public List<SeatPB$FloorSeat> getFloorSeatList() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "1403112614")) {
                return Collections.unmodifiableList(((SeatPB$SeatData) this.instance).getFloorSeatList());
            }
            return (List) ipChange.ipc$dispatch("1403112614", new Object[]{this});
        }
    ...
    private void I(Iterable<? extends SeatPB$FloorSeat> iterable) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void J(int i, SeatPB$FloorSeat.Builder builder) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void K(int i, SeatPB$FloorSeat seatPB$FloorSeat) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void L(SeatPB$FloorSeat.Builder builder) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void M(SeatPB$FloorSeat seatPB$FloorSeat) {
        IpChange ipChange = $ipChange;
    ...
    public static SeatPB$SeatData P(byte[] bArr) throws InvalidProtocolBufferException {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1920713028")) {
            return (SeatPB$SeatData) GeneratedMessageLite.t(e, bArr);
        }
        return (SeatPB$SeatData) ipChange.ipc$dispatch("-1920713028", new Object[]{bArr});
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void R(int i, SeatPB$FloorSeat.Builder builder) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void S(int i, SeatPB$FloorSeat seatPB$FloorSeat) {
        IpChange ipChange = $ipChange;
    ...
    public SeatPB$FloorSeat getFloorSeat(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-349679632")) {
            return this.d.get(i);
        }
        return (SeatPB$FloorSeat) ipChange.ipc$dispatch("-349679632", new Object[]{this, Integer.valueOf(i)});
    }

    @Override // cn.damai.serialize.pbdecoder.pb.SeatPB$SeatDataOrBuilder
    public int getFloorSeatCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-129944954")) {
            return this.d.size();
        }
        return ((Integer) ipChange.ipc$dispatch("-129944954", new Object[]{this})).intValue();
    }

    @Override // cn.damai.serialize.pbdecoder.pb.SeatPB$SeatDataOrBuilder
    public List<SeatPB$FloorSeat> getFloorSeatList() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2065236195")) {
            return this.d;
        }
        return (List) ipChange.ipc$dispatch("-2065236195", new Object[]{this});
    }
