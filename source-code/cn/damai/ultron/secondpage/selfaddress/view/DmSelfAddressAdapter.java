...
public class DmSelfAddressAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class SelfAddressViewHolder extends RecyclerView.ViewHolder {
        ...
        public void a(DmSelfAddressBean dmSelfAddressBean, int i2) {
            boolean z;
            String str;
            IpChange ipChange = $ipChange;
            if (AndroidInstantRuntime.support(ipChange, "820357679")) {
                ipChange.ipc$dispatch("820357679", new Object[]{this, dmSelfAddressBean, Integer.valueOf(i2)});
                return;
            }
            ...
            if (DmSelfAddressAdapter.this.getItemCount() == 1 || i2 == DmSelfAddressAdapter.this.getItemCount() - 1) {
