...
public class DmUltronPickAddressAdapter extends RecyclerView.Adapter<PickupAddressViewHolder> {
    ...
    public PickupAddressViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "770740901")) {
            return new PickupAddressViewHolder(this, LayoutInflater.from(this.b).inflate(R$layout.ultron_pickup_address_item, viewGroup, false));
        }
        return (PickupAddressViewHolder) ipChange.ipc$dispatch("770740901", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2139440002")) {
            return xf2.e(this.a);
        }
        return ((Integer) ipChange.ipc$dispatch("2139440002", new Object[]{this})).intValue();
    }
}
