...
public class OrderDetailPickAddressAdapter extends RecyclerView.Adapter<PickupAddressViewHolder> {
    ...
    public PickupAddressViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-931061609")) {
        ...
        return (PickupAddressViewHolder) ipChange.ipc$dispatch("-931061609", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "680060254")) {
            return xf2.e(this.a);
        }
        return ((Integer) ipChange.ipc$dispatch("680060254", new Object[]{this})).intValue();
    }
}
