...
public class DmUltronPromotionAdapter extends RecyclerView.Adapter<CouponViewHolder> {
    ...
    public class CouponViewHolder extends RecyclerView.ViewHolder {
        ...
        public void a(DmPromotionOptionsBean dmPromotionOptionsBean, int i2) {
            IpChange ipChange = $ipChange;
            if (AndroidInstantRuntime.support(ipChange, "996031427")) {
                ipChange.ipc$dispatch("996031427", new Object[]{this, dmPromotionOptionsBean, Integer.valueOf(i2)});
                return;
            }
            ...
            if (dmPromotionOptionsBean.valid) {
                this.a.setOnClickListener(new a(dmPromotionOptionsBean, i2));
            } else {
            ...
            hashMap.put("item_id", String.valueOf(w90.b(DmUltronPromotionAdapter.this.b)));
            hashMap.put("coupon_id", dmPromotionOptionsBean.selectedId);
            c e2 = c.e();
            View view = this.itemView;
            e2.G(view, "item_" + (i2 - (!dmPromotionOptionsBean.valid ? 1 : 0)), "couponlayer", "confirm", hashMap);
        }
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2018425565")) {
            return xf2.e(this.a);
        }
        return ((Integer) ipChange.ipc$dispatch("2018425565", new Object[]{this})).intValue();
    }

    /* renamed from: h */
    public CouponViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1558057507")) {
            return new CouponViewHolder(LayoutInflater.from(this.b).inflate(R$layout.fragment_sku_ncov_promotion_select, viewGroup, false));
        }
        return (CouponViewHolder) ipChange.ipc$dispatch("-1558057507", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
}
