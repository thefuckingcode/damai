...
public class WXPayEntryActivity extends DamaiBaseActivity implements IWXAPIEventHandler {
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-914434214")) {
            return R$layout.wx_pay_activity;
        }
        return ((Integer) ipChange.ipc$dispatch("-914434214", new Object[]{this})).intValue();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        IWXAPI createWXAPI = WXAPIFactory.createWXAPI(this, z10.a(WXEntryActivity.APP_ID_CRYPT));
    ...
    public void onResp(BaseResp baseResp) {
        ...
        if (baseResp.getType() == 5) {
            ...
            if (i == 0) {
                if (DamaiPayConstants.PAY_SUCCESS_PUSH_OPEN_STAYUS_SHOW.equals(d20.B(DamaiPayConstants.PAY_SUCCESS_PUSH_OPEN_STAYUS)) || PermissionsHelper.a(getApplicationContext())) {
                    ToastUtil.i(bk2.b(this, R$string.data_string_001));
                }
            } else if (i == -4) {
                ToastUtil.i(bk2.b(this, R$string.data_string_002));
            } else if (i == -1) {
                ToastUtil.i(bk2.b(this, R$string.data_string_003));
            } else if (i == -3) {
                ToastUtil.i(bk2.b(this, R$string.data_string_004));
            } else if (i == -5) {
                ToastUtil.i(bk2.b(this, R$string.data_string_005));
            } else if (i == -2) {
                ToastUtil.i(bk2.b(this, R$string.data_string_006));
            }
            if (mFrom == FROM_H5) {
    ...
    public void wxPayFailXFlush(String str, String str2, BaseResp baseResp) {
        ...
        yz2.c("wechatPay", "dmpay", sb2, str, str2);
    }
}
