...
public class TencentUtil {
    ...
    private IUiListener mListener = new IUiListener() {
        /* class cn.damai.wxapi.TencentUtil.AnonymousClass1 */
        ...
        public void onCancel() {
            ...
            TencentUtil.this.mOauthListener.onError(bk2.b(TencentUtil.this.mActivity, R$string.data_string_014));
        }
        ...
        public void onComplete(Object obj) {
            ...
            d20.X(optString + "," + optString2 + "," + optString3);
        ...
        public void onWarning(int i) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "235770670")) {
                ...
                TencentUtil.this.mOauthListener.onError(bk2.b(TencentUtil.this.mActivity, R$string.data_string_012));
    ...
    public Tencent getTencent() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1540529875")) {
            return this.mTencent;
        }
        return (Tencent) ipChange.ipc$dispatch("1540529875", new Object[]{this});
    }
    ...
    public void shareImageToQQ(String str, IUiListener iUiListener) {
        ...
        bundle.putString("appName", bk2.b(this.mActivity, R$string.data_string_013));
