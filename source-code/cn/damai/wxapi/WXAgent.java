...
public class WXAgent {
    ...
    public static final String APP_SECRET = z10.a(APP_SECRET_CRYPT);
    ...
    public static IWXAPI createWxApi() {
        ...
        if (AppConfig.v()) {
            return WXAPIFactory.createWXAPI(xs0.a(), z10.a(APP_ID_DEBUG_CRYPT), false);
        }
        return WXAPIFactory.createWXAPI(xs0.a(), z10.a(APP_ID_CRYPT), false);
    }
