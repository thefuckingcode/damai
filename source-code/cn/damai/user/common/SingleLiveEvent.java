...
public class SingleLiveEvent<T> extends MutableLiveData<T> {
    ...
    public void observe(LifecycleOwner lifecycleOwner, final Observer<? super T> observer) {
        ...
        super.observe(lifecycleOwner, new Observer<T>() {
            /* class cn.damai.user.common.SingleLiveEvent.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.lifecycle.Observer
            public void onChanged(@Nullable T t) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1181396156")) {
                    ipChange.ipc$dispatch("-1181396156", new Object[]{this, t});
