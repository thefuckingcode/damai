...
public class BrandScrollListener extends RecyclerView.OnScrollListener {
    ...
    BrandHeaderInfoBean g = new BrandHeaderInfoBean();
    AbsFragmentV2 h;
    ActivityInfo i;
    AttentionView j;
    long k;
    ...
    public class a implements BrandAttentionFloatLayerView.AttentionLayerCallBack {
        ...
        public void attentionAction() {
            ...
            } else if (BrandScrollListener.this.h.getActivity() != null && (BrandScrollListener.this.h.getActivity() instanceof BrandActivity)) {
    ...
    public BrandScrollListener(AbsFragmentV2 absFragmentV2, ViewGroup viewGroup, ScrollAlphaListener scrollAlphaListener, BrandHeaderInfoBean brandHeaderInfoBean, ActivityInfo activityInfo) {
        v50.a(absFragmentV2.getActivity(), 250.0f);
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1580421809")) {
            ipChange.ipc$dispatch("1580421809", new Object[]{this, recyclerView, Integer.valueOf(i2)});
            return;
        }
    ...
    public void onScrolled(RecyclerView recyclerView, int i2, int i3) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "504998478")) {
            ipChange.ipc$dispatch("504998478", new Object[]{this, recyclerView, Integer.valueOf(i2), Integer.valueOf(i3)});
            return;
        }
        ...
        if (this.g != null) {
            ...
            int i5 = this.a - i3;
            this.a = i5;
            if ((i5 == 0 || i4 == 0) && (scrollAlphaListener2 = this.f) != null) {
                scrollAlphaListener2.onAlphaChanged(0.0f);
            } else if (i5 < 0 && (scrollAlphaListener = this.f) != null) {
