...
public class HorizontalVideoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class VideoHolder extends RecyclerView.ViewHolder {
        ...
        private RoundImageView c = ((RoundImageView) this.itemView.findViewById(R$id.image_video));
        private ImageView d = ((ImageView) this.itemView.findViewById(R$id.icon_video));
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1833263629")) {
            return new VideoHolder(this, LayoutInflater.from(this.a));
        }
        return (RecyclerView.ViewHolder) ipChange.ipc$dispatch("1833263629", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
}
