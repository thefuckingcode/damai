...
public class HorizontalCityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class CityHolder extends RecyclerView.ViewHolder {
        private static transient /* synthetic */ IpChange $ipChange;
        public View a = this.itemView.findViewById(R$id.layout_left);
        private View b = this.itemView.findViewById(R$id.layout_right);
        private View c = this.itemView.findViewById(R$id.layout_bg);
        private TextView d = ((TextView) this.itemView.findViewById(R$id.tv_city));
        private TextView e = ((TextView) this.itemView.findViewById(R$id.tv_time));
        private TextView f = ((TextView) this.itemView.findViewById(R$id.btn_buy));
        private Context g;
        ...
        public void a(TourProjects tourProjects, boolean z, boolean z2) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "1211713607")) {
                ...
                if (tourProjects.status == 2) {
                    while (paint != null && paint.measureText(tourProjects.buttonText) > ((float) v50.a(this.g, 60.0f)) && paint.getTextSize() > ((float) v50.a(this.g, 4.0f))) {
                        paint.setTextSize(paint.getTextSize() - ((float) v50.a(this.g, 1.0f)));
                    }
                } else {
                    paint.setTextSize((float) v50.a(this.g, 13.0f));
                }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "968345873")) {
            return new CityHolder(this, LayoutInflater.from(this.a));
        }
        return (RecyclerView.ViewHolder) ipChange.ipc$dispatch("968345873", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
}
