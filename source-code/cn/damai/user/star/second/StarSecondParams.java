...
public class StarSecondParams extends TetrisParams {
    ...
    public String getPatternName() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "154574045")) {
            return "dm_artist_main_official_content_list";
        }
        return (String) ipChange.ipc$dispatch("154574045", new Object[]{this});
    }
