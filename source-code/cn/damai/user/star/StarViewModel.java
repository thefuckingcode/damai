...
public class StarViewModel extends AndroidViewModel implements Serializable {
    ...
    private final SingleLiveEvent<Object> clickEvent = new SingleLiveEvent<>();
    public int feedsTabIndex = 0;
    public String id;
    ...
    public SingleLiveEvent<Object> getClickEvent() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1528497941")) {
            return this.clickEvent;
        }
        return (SingleLiveEvent) ipChange.ipc$dispatch("-1528497941", new Object[]{this});
    }
    ...
    public MutableLiveData<StarIndexResponse> requestStarInfo(long j) {
        ...
        try {
            starIndexRequest.currentCityId = Long.parseLong(d20.c());
