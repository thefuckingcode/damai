...
public class RepertoireDetailFragment extends DamaiBaseMvpFragment<RepertoireDetailPresenter, RepertoireDetailModel> implements RepertoireDetailContract.View {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            c.e().x(wz1.h().m(RepertoireDetailFragment.this.mRepertoireId, RepertoireDetailFragment.this.mUserType, RepertoireDetailFragment.this.mMySelf, this.a.getProjectId(), this.b));
            Intent intent = new Intent();
            intent.putExtra(IssueConstants.ProjectID, Long.valueOf(this.a.getProjectId()));
            tb2.a(RepertoireDetailFragment.this.getContext(), this.a.schema, intent.getExtras());
        }
    }
    ...
    private void getRepertoireData() {
        ...
        repertoireDetaiRequest.request(new DMMtopRequestListener<RepertoireDetailDataBean>(RepertoireDetailDataBean.class) {
            /* class cn.damai.user.repertoite.ui.RepertoireDetailFragment.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1758086203")) {
                    ipChange.ipc$dispatch("1758086203", new Object[]{this, str, str2});
                    return;
                }
            ...
            public void onSuccess(RepertoireDetailDataBean repertoireDetailDataBean) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-2004826719")) {
                    ipChange.ipc$dispatch("-2004826719", new Object[]{this, repertoireDetailDataBean});
                    return;
                }
    ...
    private void updateSaleProject(RepertoireDetailDataBean repertoireDetailDataBean) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1918379255")) {
            ...
            for (int i = 0; i < repertoireDetailDataBean.getProjectCardInfo().size(); i++) {
                ...
                if (i == 0) {
                    DMImageCreator k = cn.damai.common.image.a.b().c(projectCardInfoBean.getProjectPic()).k(new DMRoundedCornersBitmapProcessor(v50.a(getContext(), 3.0f), 0));
                    ...
                    if (!xf2.j(projectCardInfoBean.getRecReason())) {
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1820702904")) {
            return R$layout.repertoire_detail_fragment;
        }
        return ((Integer) ipChange.ipc$dispatch("1820702904", new Object[]{this})).intValue();
    }
