...
public class VideoAdapter extends RecyclerView.Adapter<VideoHoloder> {
    ...
    public VideoHoloder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        inflate.setLayoutParams(new ViewGroup.LayoutParams(-1, v50.a(this.a.getContext(), 260.0f)));
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "409953840")) {
            return this.b.size();
        }
        return ((Integer) ipChange.ipc$dispatch("409953840", new Object[]{this})).intValue();
    }
}
