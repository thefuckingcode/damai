...
public class FollowViewHolder extends FeedsWraperHolder {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            it2.f(activity, str, js2.DYNAMIC, "dynamic_" + FollowViewHolder.this.itemView.getTag(), true, FollowViewHolder.this.t, hashMap);
        }
    }
    ...
    public void x(FeedMergeDataDO feedMergeDataDO) {
        ...
        if (str2 != null) {
            ...
            if (1 == i || 2 == i) {
                if (this.y.getTag() instanceof zq) {
                    ((zq) this.y.getTag()).cancel();
                }
                ...
                if (this.E != null) {
                    if (!xf2.j(followFeedData.vipLevelIcon)) {
                ...
                DMImageCreator k = cn.damai.common.image.a.b().c(str4).k(new DMRoundedCornersBitmapProcessor(v50.a(this.w, 3.0f), 0));
                int i3 = R$drawable.uikit_default_image_bg_gradient;
                zq g = k.i(i3).c(i3).g(this.y);
                this.y.setVisibility(0);
                cn.damai.uikit.view.DMAvatar dMAvatar = this.z;
                if (dMAvatar != null) {
        ...
        this.C.setOnClickListener(new a(str, i, i2, followFeedData));
    }
}
