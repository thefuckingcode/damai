...
public class InfoViewHolder extends FeedsWraperHolder {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "678677289")) {
                ...
                DMNav.from(InfoViewHolder.this.w).withExtras(bundle).toUri(NavUri.b(gr.ARTISTID_THEME));
            } else {
                Bundle bundle2 = new Bundle();
                bundle2.putString(RepertoireDetailFragment.REPERTOIREID, this.a.circleTargetId);
                bundle2.putBoolean("circle", true);
                DMNav.from(InfoViewHolder.this.w).withExtras(bundle2).toUri(NavUri.b(wz1.REPERTOITE));
            }
        }
    }
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-1504999638")) {
                ...
                Bundle bundle = new Bundle();
                bundle.putString(p21.ISSUE_PARAM_COMMENT_ID, this.a.bizId);
                ...
                it2.e(activity, str, "circle", "circle_" + InfoViewHolder.this.itemView.getTag(), true, null, hashMap);
            }
        }
    }
    ...
    public class c implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            tb2.a(InfoViewHolder.this.w, this.a.schema, bundle);
            HashMap hashMap = new HashMap();
            CommentFeedData commentFeedData = this.a;
            if (commentFeedData != null) {
            ...
            Activity activity = infoViewHolder.w;
            String str = infoViewHolder.q;
            it2.e(activity, str, "circle", "circle_item_" + InfoViewHolder.this.itemView.getTag(), true, null, hashMap);
        }
    }
    ...
    public class d implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (watchFeedData.targetDataType == 1) {
                ...
                DMNav.from(InfoViewHolder.this.w).withExtras(bundle).toUri(NavUri.b(wz1.REPERTOITE));
            }
            HashMap hashMap = new HashMap();
    ...
    private String A(CommentFeedData commentFeedData) {
        ...
        if (!xf2.j(commentFeedData.targetCityName)) {
            arrayList.add(commentFeedData.targetCityName);
        }
        if (!xf2.j(commentFeedData.targetShowTime)) {
            arrayList.add(commentFeedData.targetShowTime);
        }
        if (!xf2.j(commentFeedData.targetPlace)) {
        ...
        if (feedMergeDataDO != null && (list3 = feedMergeDataDO.dynamicData) != null && list3.size() > 0) {
            ...
            if (dynamicFeedData != null) {
                if (dynamicFeedData.imgs != null) {
                    r((ArrayList) dynamicFeedData.imgs, this.w, ((int) up2.d(this.w)) - up2.a(this.w, 42.0f), dynamicFeedData.videoInfo);
                } else {
            ...
            if (commentFeedData != null) {
                if (!xf2.j(commentFeedData.comment)) {
                ...
                if (view.findViewById(i) != null) {
                    if (xf2.j(commentFeedData.targetName)) {
            ...
            if (watchFeedData.imgs != null) {
                r((ArrayList) watchFeedData.imgs, this.w, ((int) up2.d(this.w)) - up2.a(this.w, 42.0f), watchFeedData.videoInfo);
            } else {
            ...
            if (xf2.j(watchFeedData.comment)) {
                this.x.setText("分享图片");
            } else {
            ...
            if (view4.findViewById(i5) != null) {
                if (xf2.j(watchFeedData.targetName)) {
