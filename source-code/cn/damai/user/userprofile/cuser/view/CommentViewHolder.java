...
public class CommentViewHolder extends FeedsWraperHolder {
        ...
        public void onClick(View view) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-1549316300")) {
                ...
                if (CommentViewHolder.this.j() == FeedsAdapter.G) {
                    ...
                    DMNav.from(CommentViewHolder.this.w).withExtras(bundle).toUri(INavUri.page(gr.DISCOVER_CONTENT_DETAIL));
                } else {
                    Bundle bundle2 = new Bundle();
                    bundle2.putString(p21.ISSUE_PARAM_COMMENT_ID, this.a.bizId);
                ...
                it2.f(activity, str, js2.DYNAMIC, "dynamic_" + CommentViewHolder.this.itemView.getTag(), true, CommentViewHolder.this.t, hashMap);
            }
        }
    }
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "561974069")) {
                ...
                tb2.a(CommentViewHolder.this.w, this.c.schema, this.a);
            } else if (this.b.getSubType().intValue() == 22 || this.c.targetDataType == 2) {
                this.a.putString(RepertoireDetailFragment.REPERTOIREID, this.c.targetId);
                DMNav.from(CommentViewHolder.this.w).withExtras(this.a).toUri(NavUri.b(wz1.REPERTOITE));
            }
        }
    }
    ...
    public void x(FeedMergeDataDO feedMergeDataDO) {
        ...
        if ((list2 != null && list2.size() > 0) || ((list = feedMergeDataDO.watchData) != null && list.size() > 0)) {
            ...
            if (this.y != null) {
                if (this.A != null && !xf2.j(watchFeedData.comment)) {
                    this.A.setText(watchFeedData.comment);
                }
                if (this.z != null && !xf2.j(watchFeedData.targetImg)) {
                    DMImageCreator k = cn.damai.common.image.a.b().c(watchFeedData.targetImg).k(new DMRoundedCornersBitmapProcessor(v50.a(this.w, 3.0f), 0));
                ...
                if (watchFeedData instanceof WatchFeedData) {
                    ...
                    if (watchFeedData2.imgs == null && watchFeedData2.videoInfo == null) {
                        ...
                        r((ArrayList) watchFeedData2.imgs, this.w, ((int) up2.d(this.w)) - up2.a(this.w, 42.0f), watchFeedData2.videoInfo);
                    }
                    View view2 = this.D;
                    if (view2 != null) {
