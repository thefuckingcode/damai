...
public class CommonFollowAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private void b(Bundle bundle, String str, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1412282276")) {
            ...
            DMNav.from(this.b).withExtras(bundle).toUri(NavUri.b(gr.ARTISTID_THEME));
        } else if (i == 2) {
            ...
            DMNav.from(this.b).withExtras(bundle).toUri(NavUri.b(wz1.REPERTOITE));
        }
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        new dq(0.0f, 0, (float) v50.a(this.b, 0.5f), this.b.getResources().getColor(R$color.color_6black));
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(v50.a(this.b, 80.0f), -2);
        layoutParams.setMargins(0, 0, v50.a(this.b, 15.0f), 0);
        ...
        ViewGroup.LayoutParams layoutParams3 = new RelativeLayout.LayoutParams(v50.a(this.b, 80.0f), v50.a(this.b, 80.0f));
        relativeLayout.addView(dMAvatar, layoutParams2);
        linearLayout.addView(relativeLayout, layoutParams3);
        TextView textView = new TextView(viewGroup.getContext());
        LinearLayout.LayoutParams layoutParams4 = new LinearLayout.LayoutParams(v50.a(this.b, 80.0f), -2);
        layoutParams4.setMargins(0, v50.a(this.b, 12.0f), 0, 0);
        ...
        LinearLayout.LayoutParams layoutParams5 = new LinearLayout.LayoutParams(v50.a(this.b, 69.0f), v50.a(this.b, 30.0f));
        layoutParams5.setMargins(v50.a(this.b, 5.5f), v50.a(this.b, 12.0f), 0, 0);
    ...
    public void e(int i, String str) {
        ...
        b bVar = new b();
        c.e().x(bVar.e(gt2.USER_HOME_PAGE, "taste", "follow_" + i, hashMap, Boolean.TRUE));
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-855705118")) {
            return this.a.size();
        }
        return ((Integer) ipChange.ipc$dispatch("-855705118", new Object[]{this})).intValue();
    }
}
