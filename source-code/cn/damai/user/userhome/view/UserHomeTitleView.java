...
public class UserHomeTitleView extends LinearLayout {
    ...
    private void initData() {
        ...
        this.twoFollowWidth = m42.a(this.mContext, 65.0f);
        this.followWidth = m42.a(this.mContext, 57.0f);
    }
    ...
    private void initImmersionStyle() {
        ...
        this.mTitleStatusBarHeight = v50.a(this.mContext, 45.0f);
    ...
    public AttentionView getAttentionView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-22241316")) {
            return this.mAttention;
        }
        return (AttentionView) ipChange.ipc$dispatch("-22241316", new Object[]{this});
    }

    public int getTitleHeight() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1591166036")) {
            return this.mTitleStatusBarHeight;
        }
        return ((Integer) ipChange.ipc$dispatch("-1591166036", new Object[]{this})).intValue();
    }
    ...
    public void setBackGroundAlpha(float f) {
        ...
        boolean z2 = f > 0.5f;
        if (!this.isSetAlphaFirstTime && this.isDarkModeNow == z2) {
            z = false;
        } else {
            z = true;
        }
        this.isSetAlphaFirstTime = false;
        this.isDarkModeNow = z2;
        setBackgroundColor(z2 ? Color.argb(Math.round(f * 255.0f), 255, 255, 255) : 0);
        if (z) {
