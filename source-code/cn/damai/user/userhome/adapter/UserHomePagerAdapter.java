...
public class UserHomePagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment a() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "44644210")) {
            return this.b;
        }
        return (Fragment) ipChange.ipc$dispatch("44644210", new Object[]{this});
    }
    ...
    public Object instantiateItem(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1478145484")) {
            return (Fragment) super.instantiateItem(viewGroup, i);
        }
        return ipChange.ipc$dispatch("1478145484", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
