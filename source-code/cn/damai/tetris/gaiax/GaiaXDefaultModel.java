...
public class GaiaXDefaultModel extends AbsModel implements GaiaXModel {
    ...
    public float getDefaultDesireWidth(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "472235302")) {
            return ScreenUtils.INSTANCE.getScreenWidthPx(context);
        }
        return ((Float) ipChange.ipc$dispatch("472235302", new Object[]{this, context})).floatValue();
    }

    @Override // cn.damai.tetris.gaiax.GaiaXModel
    public JSONObject getDesireRawJson() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1852132855")) {
            return this.desireRawJson;
        }
        return (JSONObject) ipChange.ipc$dispatch("1852132855", new Object[]{this});
    }
