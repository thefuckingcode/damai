...
public class TetrisRequest extends DMBaseMtopRequest {
    ...
    public String getApiName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1584829047")) {
            return "mtop.damai.mec.aristotle.get";
        }
        return (String) ipChange.ipc$dispatch("1584829047", new Object[]{this});
    }
    ...
    public String getVersion() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-542401526")) {
            return "1.0";
        }
        return (String) ipChange.ipc$dispatch("-542401526", new Object[]{this});
    }
