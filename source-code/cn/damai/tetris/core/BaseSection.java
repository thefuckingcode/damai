...
public class BaseSection extends BaseNode {
    ...
    public String getComponentId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "309867470")) {
            return this.componentId;
        }
        return (String) ipChange.ipc$dispatch("309867470", new Object[]{this});
    }

    public String getSectionId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-899416458")) {
            return this.sectionId;
        }
        return (String) ipChange.ipc$dispatch("-899416458", new Object[]{this});
    }
