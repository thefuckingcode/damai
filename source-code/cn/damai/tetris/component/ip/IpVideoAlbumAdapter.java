...
public class IpVideoAlbumAdapter extends RecyclerView.Adapter<b> {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (this.a.contentTag == 2) {
                ...
                NavProxy.from(IpVideoAlbumAdapter.this.b).withExtras(bundle).toUri(INavUri.page(gr.DISCOVER_CONTENT_DETAIL));
            }
        ...
        if (videoAlbum != null) {
            ...
            if (videoAlbum.contentTag > 0) {
                ...
                if (i2 == 1) {
                    ...
                    bVar.f.setText(mv2.h(videoAlbum.getVideoInfo().videoTime));
            ...
            if (videoAlbum.baseUserDO != null) {
                ...
                ob.a(bVar.d, videoAlbum.baseUserDO.nickName);
                g(videoAlbum.baseUserDO.userTypeCode, bVar.h);
            }
            ContentInfo contentInfo = videoAlbum.contentInfo;
            if (contentInfo != null) {
                ob.a(bVar.b, contentInfo.title);
            }
            if (i == 0) {
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) bVar.itemView.getLayoutParams();
                marginLayoutParams.setMargins(v50.a(this.b, 21.0f), 0, v50.a(this.b, 12.0f), 0);
                bVar.itemView.setLayoutParams(marginLayoutParams);
            }
            if (!(this.c.getModel() == null || this.c.getModel().getTrackInfo() == null)) {
                this.c.getModel().getTrackInfo().put(za.PRE_CONTENT_ID, (Object) videoAlbum.getId());
                this.c.getModel().getTrackInfo().put(za.PRE_CONTENT_TYPE, (Object) "video");
            }
    ...
    public b onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(v50.a(this.b, 208.0f), -1);
        layoutParams.setMargins(0, 0, v50.a(this.b, 12.0f), 0);
