...
public class IpVideoHeaderView extends AbsView<IpVideoHeaderContract.Presenter> implements IpVideoHeaderContract.View<IpVideoHeaderContract.Presenter> {
    ...
    public class a implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            layoutParams.setMargins(0, -s50.a(IpVideoHeaderView.this.mContext, (1.0f - valueAnimator.getAnimatedFraction()) * 123.0f), 0, 0);
    ...
    public cs getManager() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1807263499")) {
            return this.manager;
        }
        return (cs) ipChange.ipc$dispatch("-1807263499", new Object[]{this});
    }
    ...
    public void toogleAnim(RecyclerView recyclerView) {
        ...
        ObjectAnimator duration = ObjectAnimator.ofFloat(view, "translationY", (float) view.getTop(), (float) (this.coverTop.getTop() - this.coverTop.getHeight())).setDuration(1000L);
