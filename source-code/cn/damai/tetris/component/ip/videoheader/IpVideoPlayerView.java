...
public class IpVideoPlayerView extends FrameLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        this.mMuteBtn.setPadding(v50.a(getContext(), 21.0f), this.mMuteBtn.getPaddingTop(), this.mMuteBtn.getPaddingRight(), this.mMuteBtn.getPaddingBottom());
    }
    ...
    public int getVoice() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2059604060")) {
            return this.mVoice;
        }
        return ((Integer) ipChange.ipc$dispatch("-2059604060", new Object[]{this})).intValue();
    }
    ...
    public void setMuteListener(MuteListener muteListener2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1716871386")) {
            ipChange.ipc$dispatch("1716871386", new Object[]{this, muteListener2});
            return;
        }
        this.muteListener = muteListener2;
    }
    ...
    public void voice() {
        ...
        if (muteListener2 != null) {
            muteListener2.onStateChanged(this.mVoice);
        }
    }
}
