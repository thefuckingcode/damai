...
public class BannerView extends AbsView<BannerContract$Presenter> implements BannerContract$View<BannerContract$Presenter> {
    ...
    private void exposeItemView(View view, BannerBean bannerBean, int i) {
        IpChange ipChange = $ipChange;
        ...
        BannerContract$Presenter bannerContract$Presenter = (BannerContract$Presenter) getPresenter();
        if (bannerContract$Presenter != null) {
            bannerContract$Presenter.exposeItemView(view, bannerBean, i);
        }
    }
    ...
    public void setAdapter() {
        ...
        Activity activity = ((BannerContract$Presenter) getPresenter()).getContext().getActivity();
