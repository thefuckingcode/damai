...
public class BrandIpModel extends AbsModel implements BrandIpContract.Model {
    ...
    public ArrayList<IpBean> getBeanList() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1831610971")) {
            return this.ipBeanList;
        }
        return (ArrayList) ipChange.ipc$dispatch("1831610971", new Object[]{this});
    }

    @Override // cn.damai.tetris.component.brand.BrandIpContract.Model
    public BrandInfoBean getBrandInfo() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-987105692")) {
            return this.brand;
        }
        return (BrandInfoBean) ipChange.ipc$dispatch("-987105692", new Object[]{this});
    }
