...
public class ArtistProMutiRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (parseInt == -1) {
                ...
                DMNav.from(ArtistProMutiRecycleAdapter.this.a).withExtras(bundle).toUri(NavUri.b(gr.ARTISTID_THEME));
            } else if (parseInt == 1) {
                ...
                DMNav.from(ArtistProMutiRecycleAdapter.this.a).withExtras(bundle2).toUri(NavUri.b(gr.b));
            } else if (parseInt == 2) {
                ...
                DMNav.from(ArtistProMutiRecycleAdapter.this.a).withExtras(bundle3).toUri(NavUri.b(gr.DISCOVER_CONTENT_DETAIL));
            }
        }
    }
    ...
    public int getItemViewType(int i) {
        ...
        if (Integer.parseInt(artistContentBean.type) == 2) {
            return 2;
        }
        return 3;
    }
