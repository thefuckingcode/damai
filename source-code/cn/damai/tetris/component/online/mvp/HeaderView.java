...
public class HeaderView extends AbsView<HeaderContract$Presenter> implements HeaderContract$View<HeaderContract$Presenter>, WeakRefCountDownTimer.OnTickListener {
    ...
    private cs mDMVideoPlayerManager;
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-30142364")) {
                ...
                ((HeaderContract$Presenter) HeaderView.this.getPresenter()).btnClick(HeaderView.this.mSchemaUrl);
            }
        }
    }
    ...
    public HeaderView(View view) {
        ...
        this.mDMVideoPlayerManager = cs.d();
        ...
        try {
            ...
            this.mVideoPlayerView.setVideoPlayerSize(com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getwidthPixels(displayMetrics) - n42.a(this.mContext, 42.0f), n42.a(this.mContext, 188.0f));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void setAfterPerfrom(long j, long j2, long j3) {
        ...
        this.mTimeTipTv.getPaint().setShader(new LinearGradient(0.0f, 0.0f, (float) n42.a(this.mContext, 66.0f), 0.0f, Color.parseColor("#A045FF"), Color.parseColor("#5B90FF"), Shader.TileMode.CLAMP));
    ...
    private void setBeforePerfrom(long j, long j2, long j3) {
        ...
        this.mShengyuLayout.setVisibility(8);
        zy2 zy2 = new zy2((j2 - j) - this.intervalTime, 1000, this);
        this.mTimer = zy2;
        zy2.start();
    ...
    private void setPerfroming(long j, long j2, long j3) {
        ...
        this.mTimeTipTv.getPaint().setShader(new LinearGradient(0.0f, 0.0f, (float) n42.a(this.mContext, 66.0f), 0.0f, Color.parseColor("#FF2869"), Color.parseColor("#D963FF"), Shader.TileMode.CLAMP));
        this.mTimeTipTv.invalidate();
        this.mTimeStartTv.setVisibility(8);
        this.mDaojishiLayout.setVisibility(8);
        this.mShengyuLayout.setVisibility(0);
        zy2 zy2 = new zy2((j3 - j) - this.intervalTime, 1000, this);
        this.mTimer = zy2;
        zy2.start();
    ...
    public void setData(ArtistBean artistBean) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "543430144")) {
            ...
            cn.damai.common.image.a.b().h(xs0.a()).e(this.mBean.contentPic).g(this.mBgImageView);
            if (!TextUtils.isEmpty(this.mBean.vid)) {
                if (zh1.b(this.mContext) == NetworkType.NETWORK_WIFI) {
            ...
            if (s71.a(this.mBean.artistList)) {
            ...
            if (artistBean2.startPerformTime > 0 && artistBean2.endPerformTime > 0 && artistBean2.currentTime > 0) {
                ...
                this.intervalTime = elapsedRealtime - fm2.a;
    ...
    public void videoDestory() {
        ...
        cs csVar = this.mDMVideoPlayerManager;
        if (csVar != null) {
            csVar.f();
