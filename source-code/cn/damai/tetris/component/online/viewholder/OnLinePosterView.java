...
public class OnLinePosterView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        gradientDrawable.setCornerRadius((float) s50.a(context, 6.0f));
        gradientDrawable.setStroke(s50.a(context, 0.5f), Color.parseColor("#1A000000"));
        ...
        layoutParams3.rightMargin = s50.a(context, 3.0f);
        layoutParams3.topMargin = s50.a(context, 3.0f);
        ...
        layoutParams4.leftMargin = s50.a(context, 0.0f);
        layoutParams4.bottomMargin = s50.a(context, 0.0f);
        ...
        FrameLayout.LayoutParams layoutParams5 = new FrameLayout.LayoutParams(s50.a(context, 24.0f), s50.a(context, 24.0f));
        layoutParams5.gravity = 17;
        ImageView imageView2 = new ImageView(context);
        this.videoIcon = imageView2;
        imageView2.setImageResource(R$drawable.dm_poster_video_icon);
        this.videoIcon.setVisibility(8);
        addView(this.videoIcon, layoutParams5);
        FrameLayout.LayoutParams layoutParams6 = new FrameLayout.LayoutParams(-2, -2);
        layoutParams6.rightMargin = s50.a(context, 3.0f);
        layoutParams6.topMargin = s50.a(context, 3.0f);
        ...
        layoutParams7.rightMargin = s50.a(context, 3.0f);
        layoutParams7.bottomMargin = s50.a(context, 3.0f);
    ...
    public RoundImageView getImageView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1756586418")) {
            return this.imageView;
        }
        return (RoundImageView) ipChange.ipc$dispatch("1756586418", new Object[]{this});
    }
