...
public class RankProjectParams extends TetrisParams {
    ...
    public String getPatternName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-255008578")) {
            return this.pN;
        }
        return (String) ipChange.ipc$dispatch("-255008578", new Object[]{this});
    }

    @Override // cn.damai.tetris.request.TetrisParams
    public String getVersion() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "456578779")) {
            return this.pV;
        }
        return (String) ipChange.ipc$dispatch("456578779", new Object[]{this});
    }
