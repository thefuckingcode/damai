...
public class RankTypeAdapter extends RecyclerView.Adapter<RTVh> {
    ...
    public class RTVh extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void a(TypeTabBean typeTabBean, int i) {
            ...
            if (z) {
                int c2 = RankTypeAdapter.this.c(i);
    ...
    public int c(int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1106788441")) {
            return ((Integer) ipChange.ipc$dispatch("1106788441", new Object[]{this, Integer.valueOf(i)})).intValue();
        }
        return e[i % 4];
    }
    ...
    public RTVh onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1382499220")) {
            return new RTVh(LayoutInflater.from(this.a).inflate(R$layout.item_tetris_rank_one_sub_filter, viewGroup, false));
        }
        return (RTVh) ipChange.ipc$dispatch("1382499220", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1468646027")) {
            return this.c.size();
        }
        return ((Integer) ipChange.ipc$dispatch("-1468646027", new Object[]{this})).intValue();
    }
}
