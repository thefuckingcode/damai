...
public class BannerImageLoader extends ViewLoader {
    ...
    @Override // cn.damai.uikit.banner.loader.ImageLoaderInterface, cn.damai.uikit.banner.loader.ViewLoader
    public View createImageView(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-116857987")) {
            return LayoutInflater.from(context).inflate(R$layout.live_header_banner_item, (ViewGroup) null);
        }
        return (View) ipChange.ipc$dispatch("-116857987", new Object[]{this, context});
    }
