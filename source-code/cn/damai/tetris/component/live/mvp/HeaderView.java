...
public class HeaderView extends AbsView<HeaderContract$Presenter> implements HeaderContract$View<HeaderContract$Presenter> {
    ...
    private int[] mColors = {Color.parseColor("#00000000"), Color.parseColor("#0a000000"), Color.parseColor("#19000000"), Color.parseColor("#45000000"), Color.parseColor("#70000000"), Color.parseColor("#99000000"), Color.parseColor("#dd000000"), Color.parseColor("#ff000000"), Color.parseColor("#ff000000"), Color.parseColor("#ff000000")};
    ...
    public class a implements OnBannerListener {
        ...
        public void OnBannerClick(int i) {
            ...
            ((HeaderContract$Presenter) HeaderView.this.getPresenter()).headerClick(this.a);
        }
    }
    ...
    private void bannerSetting() {
        ...
        this.mBannerView.setPageMargin(m42.a(this.mContext, 0.0f));
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1318795784")) {
            ...
            if (getPresenter() != null) {
                ...
                if (headerPresenter.mTrackInfo != null) {
                    ...
                    hashMap.put(za.PRE_CONTENT_ID, liveHeaderPicBean.themeId);
                    hashMap.put(za.PRE_CONTENT_TYPE, "theme");
