...
public class BannerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-262340722")) {
            return this.b.get(i).type;
        }
        return ((Integer) ipChange.ipc$dispatch("-262340722", new Object[]{this, Integer.valueOf(i)})).intValue();
    }
        ...
        if (AndroidInstantRuntime.support(ipChange, "586999858")) {
            ...
            if (!(bannerPresenter == null || bannerPresenter.mTrackInfo == null)) {
                ...
                if (liveHeaderCardItemBean.type == 2) {
                    hashMap.put(za.PRE_CONTENT_ID, liveHeaderCardItemBean.id);
