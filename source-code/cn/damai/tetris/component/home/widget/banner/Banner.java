...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public class BannerPagerAdapter extends PagerAdapter {
        ...
        public int getCount() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-1159844604")) {
                return Banner.this.imageViews.size();
            }
            return ((Integer) ipChange.ipc$dispatch("-1159844604", new Object[]{this})).intValue();
        }
        ...
        public boolean isViewFromObject(View view, Object obj) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "29222976")) {
                return view == obj;
            }
            return ((Boolean) ipChange.ipc$dispatch("29222976", new Object[]{this, view, obj})).booleanValue();
        }
    }
    ...
    private void handleTypedArray(Context context2, AttributeSet attributeSet) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1206975405")) {
            ipChange.ipc$dispatch("-1206975405", new Object[]{this, context2, attributeSet});
    ...
    private void initView(Context context2, AttributeSet attributeSet) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1888695829")) {
            ipChange.ipc$dispatch("1888695829", new Object[]{this, context2, attributeSet});
            return;
        }
        this.imageViews.clear();
            ...
            if (list2 == null || list2.size() == list.size()) {
                ...
                for (int i = 0; i <= this.count + 1; i++) {
                    ...
                    if (i == 0) {
                        ...
                        if (list3 != null) {
                            view.setTag(R$id.bannervideo, list3.get(this.count - 1));
                        }
                    } else if (i == this.count + 1) {
                        obj = list.get(0);
                        List<Boolean> list4 = this.videoList;
                        if (list4 != null) {
                            view.setTag(R$id.bannervideo, list4.get(0));
                        }
                    } else {
                        int i2 = i - 1;
                        ...
                        if (list5 != null) {
                            view.setTag(R$id.bannervideo, list5.get(i2));
                        }
                        obj = obj2;
                    }
                    ...
                    if (imageLoaderInterface2 != null) {
                        imageLoaderInterface2.displayImage(this.context, i, obj, view);
                    } else {
    ...
    public void onPageScrollStateChanged(int i) {
        ...
        } else if (currentItem2 == this.count + 1) {
            this.viewPager.setCurrentItem(1, false);
        }
    }
    ...
    public Banner setOnTagListener(OnTagListener onTagListener2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1817657115")) {
            return (Banner) ipChange.ipc$dispatch("-1817657115", new Object[]{this, onTagListener2});
        }
        this.onTagListener = onTagListener2;
        return this;
    }
    ...
    public void startAutoPlay() {
        ...
        this.handler.b(this.task, (long) this.delayTime);
    }
    ...
    public Banner(Context context2, AttributeSet attributeSet, int i) {
        ...
        this.task = new Runnable() {
            /* class cn.damai.tetris.component.home.widget.banner.Banner.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void run() {
                ...
                if (AndroidInstantRuntime.support(ipChange, "36302029")) {
                    ...
                    Banner.this.handler.b(Banner.this.task, (long) Banner.this.delayTime);
                }
            }
        };
