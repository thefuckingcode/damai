...
public class BannerImageView extends AppCompatImageView {
    ...
    private void drawCanvas(Canvas canvas) {
        ...
        if (rectF != null && (paint = this.mBitmapPaint) != null) {
            ...
            if (this.mBorderWidth > 0) {
                ...
                canvas.drawRoundRect(rectF2, (float) i2, (float) i2, this.mBorderPaint);
            }
        }
    }
    ...
    private void setUpShader() {
        ...
        if (drawable != null && (drawableToBitamp = drawableToBitamp(drawable)) != null) {
            ...
            if (!(drawableToBitamp.getWidth() == width && drawableToBitamp.getHeight() == height)) {
                f = Math.max((((float) width) * 1.0f) / ((float) drawableToBitamp.getWidth()), (((float) height) * 1.0f) / ((float) drawableToBitamp.getHeight()));
            }
    ...
    public int dp2px(float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-595187067")) {
            return (int) TypedValue.applyDimension(1, f, getResources().getDisplayMetrics());
        }
        return ((Integer) ipChange.ipc$dispatch("-595187067", new Object[]{this, Float.valueOf(f)})).intValue();
    }
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.mRoundRect = new RectF(0.0f, 0.0f, (float) ((getWidth() - getPaddingLeft()) - getPaddingRight()), (float) ((getHeight() - getPaddingTop()) - getPaddingBottom()));
    }
    ...
    public void setBorder(float f, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-324913743")) {
            ...
            this.mBorderPaint.setStrokeWidth((float) dp2px);
            invalidate();
        }
    }
