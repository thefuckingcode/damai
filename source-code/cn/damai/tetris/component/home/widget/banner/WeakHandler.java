...
public class WeakHandler {
    ...
    public final boolean a(@NonNull Runnable runnable) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1563246226")) {
            return this.a.post(e(runnable));
        }
        return ((Boolean) ipChange.ipc$dispatch("-1563246226", new Object[]{this, runnable})).booleanValue();
    }

    public final boolean b(Runnable runnable, long j) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-625217554")) {
            return this.a.postDelayed(e(runnable), j);
        }
        return ((Boolean) ipChange.ipc$dispatch("-625217554", new Object[]{this, runnable, Long.valueOf(j)})).booleanValue();
    }
    ...
    public final void c(Runnable runnable) {
        ...
        WeakRunnable c2 = this.c.c(runnable);
        if (c2 != null) {
