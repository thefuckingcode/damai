...
public class TabLottieLinearView extends TabLinearView {
    ...
    private PageListener pageListener = new PageListener(this, null);
    ...
    public class f implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            TabLottieLinearView.this.mAnimatedValue = (float) ((Integer) valueAnimator.getAnimatedValue()).intValue();
    ...
    private int selectTitle(int i) {
        ...
        if (this.mPaddingLeftRight > 0) {
            viewGroup = (ViewGroup) getChildAt(i + 1);
        } else {
            viewGroup = (ViewGroup) getChildAt(i);
        }
        if (viewGroup != null) {
            float right = (float) (viewGroup.getRight() - viewGroup.getLeft());
            float f2 = this.mLineWidth;
            float left = ((float) viewGroup.getLeft()) + ((right - f2) / 2.0f);
            this.mStartX = left;
            this.mStopX = left + f2;
        }
    ...
    public void initView() {
        ...
        this.mPaint = paint;
        paint.setStrokeWidth((float) dip2px(4.0f));
        this.mPaint.setStrokeCap(Paint.Cap.ROUND);
        this.mLineWidth = (float) dip2px(18.0f);
        float f2 = this.mStartX;
        int i = this.mStartY;
        this.mPaint.setShader(new LinearGradient(f2, (float) i, this.mStopX, (float) i, Color.parseColor("#FF70B8"), Color.parseColor("#FFBEED"), Shader.TileMode.CLAMP));
    ...
    public void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        if (this.mIsShowLine) {
            this.mStartY = dip2px((float) (this.mHeight / 2)) + dip2px((float) ((this.mDaSize / 2) + 8));
            ...
            if (paint != null) {
                ...
                int i2 = this.mStartY;
                canvas.drawLine(f3, (float) i2, this.mStopX, (float) i2, this.mPaint);
            }
        }
    }
    ...
    public void setFontSize(final int i) {
        ...
        if (this.mPaddingLeftRight > 0) {
            ...
            for (int i5 = 0; i5 < getChildCount(); i5++) {
                ...
                if (i == i5) {
                    ...
                    if (i6 == i7) {
                        textView2.setTextSize(1, (float) i7);
                    }
                    ...
                    textView2.setTextSize(1, (float) this.mXiaoSize);
        ...
        if (textView3 != null) {
            this.mTv = textView3;
            textView3.setTextSize(1, (float) this.mDaSize);
            postDelayed(new Runnable() {
                /* class cn.damai.tetris.component.home.widget.TabLottieLinearView.AnonymousClass6 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void run() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1850792838")) {
                        ipChange.ipc$dispatch("-1850792838", new Object[]{this});
                        return;
                    }
