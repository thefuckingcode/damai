...
public class HomeTabScrollView extends HorizontalScrollView {
    ...
    private void scrollToIndex(final int i) {
        ...
        this.mLayout.post(new Runnable() {
            /* class cn.damai.tetris.component.home.widget.HomeTabScrollView.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void run() {
                ...
                int i;
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-759369996")) {
                    ipChange.ipc$dispatch("-759369996", new Object[]{this});
                    return;
                }
                ...
                HomeTabScrollView.this.smoothScrollTo(i2 - width, 0);
            }
        });
    }
