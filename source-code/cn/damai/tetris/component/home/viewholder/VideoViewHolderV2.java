...
public class VideoViewHolderV2 extends CommonViewHolder {
    ...
    private boolean isPageShowing = true;
    private boolean isSetVideoPlayOptHelper = false;
    private IVideoAdapter mAdapter;
    private Context mContext;
    private int mIndex;
    private TextView mModuleTitle;
    private IVideoAdapter.OnVideoItemClickListener mOnVideoItemClickListener = new a();
    ...
    public class a implements IVideoAdapter.OnVideoItemClickListener {
        ...
        public void onBuyClick(int i, String str, String str2, String str3) {
            ...
            if (xf2.j(str)) {
                DMNav.from(VideoViewHolderV2.this.mContext).withExtras(bundle).toUri(NavUri.b(gr.b));
            } else {
                DMNav.from(VideoViewHolderV2.this.mContext).toUri(str);
            }
            zw0.B().u(VideoViewHolderV2.this.mTrackInfo, str3, i);
        }
        ...
        public void onItemClick(View view, int i, HomePageVideoBean.HomePageVideoItem homePageVideoItem) {
            ...
            if (VideoViewHolderV2.this.mVideoPlayer != null) {
                ...
                zw0.B().O(VideoViewHolderV2.this.mTrackInfo, VideoViewHolderV2.this.mVideoPlayer, videoInfo, VideoViewHolderV2.this.mProjectId);
            }
            tx1.a(VideoViewHolderV2.this.mContext, VideoViewHolderV2.this.mProjectList, view);
            zw0.B().v(VideoViewHolderV2.this.mTrackInfo, homePageVideoItem.projectId, i);
        }
        ...
        public void onItemReClick(int i, String str, String str2, String str3) {
            ...
            zw0.B().i(VideoViewHolderV2.this.mTrackInfo, str3, i);
        }
    }
    ...
    public class c implements VideoListener {
        ...
        public void onMuteClick(VideoInfo videoInfo, boolean z) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-1294266815")) {
                ...
                zw0.B().x(VideoViewHolderV2.this.mTrackInfo, str, !z ? 1 : 0);
            }
        }
        ...
        public void onPlayClick(VideoInfo videoInfo) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "93038990")) {
                ...
                if (VideoViewHolderV2.this.mTrackInfo != null) {
                    zw0.B().w(VideoViewHolderV2.this.mTrackInfo, VideoViewHolderV2.this.mVideoInfo.getVid(), VideoViewHolderV2.this.mProjectId, VideoViewHolderV2.this.mIndex);
                }
            }
        }
        ...
        public void onVideoEnd(ApiPlayer apiPlayer, VideoInfo videoInfo, int i) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "358613952")) {
                ...
                zw0.B().P(VideoViewHolderV2.this.mTrackInfo.trackB, VideoViewHolderV2.this.mTrackInfo.trackC, "playend", VideoViewHolderV2.this.mProjectId, videoInfo, (long) i, apiPlayer.getSessionId());
            }
        }
        ...
        public void onVideoPlay(ApiPlayer apiPlayer, VideoInfo videoInfo, int i) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-480579815")) {
                ...
                zw0.B().Q(VideoViewHolderV2.this.mTrackInfo.trackB, VideoViewHolderV2.this.mTrackInfo.trackC, "playstart", VideoViewHolderV2.this.mProjectId, videoInfo, true, VideoViewHolderV2.this.mVideoPlayer.getSessionId());
            }
        }
    }
    ...
    public void setData(CommonBean commonBean) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-620115131")) {
            ...
            if (e > 0) {
                ...
                zw0.B().O(this.mTrackInfo, this.mVideoPlayer, videoInfo, homePageVideoItem.projectId);
            }
