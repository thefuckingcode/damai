...
public class VideoViewHolder extends CommonViewHolder {
    ...
    private OnPlayerUTReportListener mOnPlayerUTReportListener = new a();
    private IVideoAdapter.OnVideoItemClickListener mOnVideoItemClickListener = new b();
    ...
    public class a implements OnPlayerUTReportListener {
        ...
        public void onMuteBtnClick(String str, int i) {
            ...
            zw0.B().x(VideoViewHolder.this.mTrackInfo, str, i);
        }
        ...
        public void onPauseOrPlayClick(String str, int i) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "1933365720")) {
                ...
                zw0.B().w(VideoViewHolder.this.mTrackInfo, VideoViewHolder.this.mVideoInfo.getVid(), VideoViewHolder.this.mProjectId, VideoViewHolder.this.mIndex);
            }
        }
    ...
    public class b implements IVideoAdapter.OnVideoItemClickListener {
        ...
        public void onBuyClick(int i, String str, String str2, String str3) {
            ...
            if (xf2.j(str)) {
                DMNav.from(VideoViewHolder.this.mContext).withExtras(bundle).toUri(NavUri.b(gr.b));
            } else {
                DMNav.from(VideoViewHolder.this.mContext).toUri(str);
            }
            zw0.B().u(VideoViewHolder.this.mTrackInfo, str3, i);
        }
        ...
        public void onItemClick(View view, int i, HomePageVideoBean.HomePageVideoItem homePageVideoItem) {
            ...
            tx1.a(VideoViewHolder.this.mContext, VideoViewHolder.this.mProjectList, view);
            zw0.B().v(VideoViewHolder.this.mTrackInfo, homePageVideoItem.projectId, i);
        ...
        public void onItemReClick(int i, String str, String str2, String str3) {
            ...
            zw0.B().i(VideoViewHolder.this.mTrackInfo, str3, i);
        }
    }
    ...
    public VideoViewHolder(View view) {
        ...
        dMVideoPlayerHomeController.setBottomPadding(v50.a(this.mContext, 22.0f));
    ...
    public void fixVideoHeight() {
        ...
        layoutParams2.topMargin = c2 - v50.a(this.mContext, 22.0f);
    ...
    public DMVideoPlayer getVideoPlayer() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "358378297")) {
            return this.mVideoPlayer;
        }
        return (DMVideoPlayer) ipChange.ipc$dispatch("358378297", new Object[]{this});
    }
    ...
    public void setData(CommonBean commonBean) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "942689057")) {
            ...
            int e = xf2.e(homePageVideoBean.content);
            for (int i = 0; i < e; i++) {
