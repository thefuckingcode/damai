...
public class RecentShowPagerAdapter extends PagerAdapter {
    ...
    public int getCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "700065662")) {
            return this.b.size();
        }
        return ((Integer) ipChange.ipc$dispatch("700065662", new Object[]{this})).intValue();
    }
    ...
    public boolean isViewFromObject(@NonNull View view, @NonNull Object obj) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1643533306")) {
            return view == obj;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1643533306", new Object[]{this, view, obj})).booleanValue();
    }
}
