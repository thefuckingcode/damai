...
public class RankTopPagerAdapter extends PagerAdapter {
    ...
    public int getCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "175365633")) {
            return this.b.size();
        }
        return ((Integer) ipChange.ipc$dispatch("175365633", new Object[]{this})).intValue();
    }
    ...
    public boolean isViewFromObject(@NonNull View view, @NonNull Object obj) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-53662109")) {
            return view == obj;
        }
        return ((Boolean) ipChange.ipc$dispatch("-53662109", new Object[]{this, view, obj})).booleanValue();
    }
}
