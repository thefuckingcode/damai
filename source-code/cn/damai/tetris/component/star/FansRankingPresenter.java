...
public class FansRankingPresenter extends BasePresenter<FansRankingContract.Model, FansRankingView, BaseSection> implements FansRankingContract.Presenter<FansRankingContract.Model, FansRankingView, BaseSection> {
    ...
    public class a implements FansRankingViewHolder.ITaskHandler {
        ...
        public LifecycleOwner getLifecycleOwner() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-1127242884")) {
                return (LifecycleOwner) ((BasePresenter) FansRankingPresenter.this).mContext.getActivity();
            }
            return (LifecycleOwner) ipChange.ipc$dispatch("-1127242884", new Object[]{this});
        }
    }
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            NavProxy.from(((BasePresenter) FansRankingPresenter.this).mContext.getActivity()).toUri(((FansRankingContract.Model) FansRankingPresenter.this.getModel()).getUrl());
    ...
    public class d implements IImageLoader.IImageSuccListener {
        ...
        public void onSuccess(IImageLoader.b bVar) {
            ...
            if (bitmap != null) {
                ...
                int d = g70.d() - s50.a(((BasePresenter) FansRankingPresenter.this).mContext.getActivity(), 42.0f);
    ...
    public FansRankingPresenter(FansRankingView fansRankingView, String str, w9 w9Var) {
        super(fansRankingView, str, w9Var);
    }
    ...
    private void bindFans(View view, TopFans topFans, int i) {
        ...
        ob.a((TextView) view.findViewById(R$id.ll_fans_ranking_item_name), topFans.nickName);
        ob.a((TextView) view.findViewById(R$id.ll_fans_ranking_item_value), topFans.score);
    ...
    public void init(FansRankingContract.Model model) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "752501921")) {
            ...
            TextView textView = (TextView) ((FansRankingView) getView()).getFansView().findViewById(R$id.tv_project_tip);
            if (textView != null) {
            ...
            new FansRankingViewHolder(((FansRankingView) getView()).getFansView(), new a(), this.mContext.getActivity(), this).q(rankingData);
            if (model.getFansList() != null) {
                LinearLayout linearLayout = (LinearLayout) ((FansRankingView) getView()).getRootView().findViewById(R$id.ll_fans_ranking_parent);
            ...
            if (TextUtils.isEmpty(((FansRankingContract.Model) getModel()).getUrl())) {
                ((FansRankingView) getView()).getFansView().findViewById(R$id.layout_all).setVisibility(4);
            } else {
                ViewGroup fansView = ((FansRankingView) getView()).getFansView();
                int i2 = R$id.layout_all;
                fansView.findViewById(i2).setVisibility(0);
                ((FansRankingView) getView()).getFansView().findViewById(i2).setOnClickListener(new b());
                userTrackExpose(((FansRankingView) getView()).getFansView().findViewById(i2), "rule");
            }
            ViewGroup fansView2 = ((FansRankingView) getView()).getFansView();
            int i3 = R$id.tv_all_click_toall;
            ob.a((TextView) fansView2.findViewById(i3), rankingData.rankingMoreLinkDesc);
            ((FansRankingView) getView()).getFansView().findViewById(R$id.layout_all_click_toall).setOnClickListener(new c(rankingData));
            userTrackExpose(((FansRankingView) getView()).getFansView().findViewById(i3), "more");
            ImageView imageView = (ImageView) ((FansRankingView) getView()).getFansView().findViewById(R$id.fans_banner);
            if (!TextUtils.isEmpty(((FansRankingContract.Model) getModel()).getBannerImg())) {
                imageView.setVisibility(0);
                IImageLoader a2 = cn.damai.uikit.image.a.a();
                String bannerImg = ((FansRankingContract.Model) getModel()).getBannerImg();
                int i4 = R$drawable.uikit_default_image_bg_gradient_v2;
                a2.loadinto(bannerImg, imageView, i4, i4);
                cn.damai.uikit.image.a.a().load(((FansRankingContract.Model) getModel()).getBannerImg(), R$drawable.uikit_default_image_bg_grey, new d(imageView), new e(this));
                return;
            }
