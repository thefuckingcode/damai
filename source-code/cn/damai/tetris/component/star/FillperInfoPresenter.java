...
public class FillperInfoPresenter extends BasePresenter<FillperInfoContract.Model, FillperInfoView, BaseSection> implements FillperInfoContract.Presenter<FillperInfoContract.Model, FillperInfoView, BaseSection> {
    ...
    public FillperInfoPresenter(FillperInfoView fillperInfoView, String str, w9 w9Var) {
        super(fillperInfoView, str, w9Var);
    }
    ...
    public void init(FillperInfoContract.Model model) {
        ...
        ViewGroup fillperView = ((FillperInfoView) getView()).getFillperView();
        ...
        List<FillperItemBean> data = ((FillperInfoContract.Model) getModel()).getData();
        new ArrayList();
        if (xf2.e(data) > 0) {
            ...
            for (int i2 = 0; i2 < convert.size(); i2++) {
                ...
                new hj0(inflate).a(convert.get(i2));
            }
            if (data.size() < 3) {
