...
public class UserVipPanel {
    ...
    public UserVipPanel(final Activity activity, ViewGroup viewGroup, BasePresenter basePresenter) {
        if (activity != null) {
            ...
            this.b = findViewById;
            findViewById.getLayoutParams().height = s50.a(activity, 75.0f);
            ...
            autoTextSwitcher.setFactory(new ViewSwitcher.ViewFactory() {
                /* class cn.damai.tetris.component.star.vipcard.UserVipPanel.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;
    ...
    public boolean c() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1050586450")) {
            return LoginManager.k().q();
        }
        return ((Boolean) ipChange.ipc$dispatch("-1050586450", new Object[]{this})).booleanValue();
    }
    ...
    public void d(ArtistVipBean artistVipBean) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "616019268")) {
            ...
            DMImageCreator c2 = cn.damai.common.image.a.b().c(artistVipBean.bgImage);
            int i2 = R$drawable.bg_vip_switch;
            c2.i(i2).c(i2).g(this.c);
