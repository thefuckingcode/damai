...
public class ContentBaseAdapter extends RecyclerView.Adapter<ContentBaseViewHolder> {
    ...
    private boolean a(int i) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "368563445")) {
            return i + 1 == this.d.size();
        }
        return ((Boolean) ipChange.ipc$dispatch("368563445", new Object[]{this, Integer.valueOf(i)})).booleanValue();
    }
    ...
    private void h(ContentItemBean contentItemBean, int i, View view) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1480624216")) {
            ...
            this.b.userTrackExpose(view, "card_" + i, fn.a(this.b.getModel().getTrackInfo().getArgsMap(), contentItemBean.getContentId(), contentItemBean.getCard()), false);
        }
    }
    ...
    public void onBindViewHolder(ContentBaseViewHolder contentBaseViewHolder, int i) {
        ...
        n91.a("real-uikit", "onBindViewHolder()");
    ...
    public ContentBaseViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "462193132")) {
            return (ContentBaseViewHolder) ipChange.ipc$dispatch("462193132", new Object[]{this, viewGroup, Integer.valueOf(i)});
        }
        return new ContentBaseViewHolder(this.a, LayoutInflater.from(this.a), this.b);
    }
    ...
    public void onViewAttachedToWindow(@NonNull ContentBaseViewHolder contentBaseViewHolder) {
        ...
        n91.a("real-uikit", "attachFromWindow(holder)");
    ...
    public void onViewDetachedFromWindow(@NonNull ContentBaseViewHolder contentBaseViewHolder) {
        ...
        n91.a("real-uikit", "detachFromWindow(holder)");
    ...
    public void onAttachedToRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        n91.a("real-uikit", "attachFromWindow(RecyclerView)");
    }
    ...
    public void onDetachedFromRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        n91.a("real-uikit", "detachFromWindow(RecyclerView)");
    }
}
