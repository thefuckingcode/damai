...
public class ContentVideoPlayerController extends DMBaseVideoController implements View.OnClickListener, IVideoController {
    ...
    private void playOrPause() {
        ...
        if (!(this.mUTReportListener == null || (bsVar = this.mDataHolder) == null || bsVar.e() == null || this.mDataHolder.c() == null)) {
    ...
    public void assembleLayers() {
        ...
        mv2.a(this.mBottomView, this.mContainer);
        mv2.a(this.mErrorView, this.mContainer);
    ...
    public ContentVideoPlayerView getBottomView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2073534701")) {
            return this.mBottomView;
        }
        return (ContentVideoPlayerView) ipChange.ipc$dispatch("2073534701", new Object[]{this});
    }
    ...
    public void onClick(View view) {
        ...
        } else if (view == this && (bsVar = this.mDataHolder) != null && bsVar.e() != null) {
    ...
    public void onPlayerPlaying(Object obj) {
        ...
        if (this.isNewRequest) {
            ...
            ov2.f().g(this.mContext, this.mDataHolder.e().getVid(), "homepage_video", this.mDataHolder.d());
            reset();
        }
        DMVideoPlayerDefaultErrorView dMVideoPlayerDefaultErrorView = this.mErrorView;
        if (dMVideoPlayerDefaultErrorView != null) {
