...
public class ContentVideoPlayerView extends FrameLayout implements View.OnClickListener {
    ...
    public int getVoice() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-507393280")) {
            return this.mVoice;
        }
        return ((Integer) ipChange.ipc$dispatch("-507393280", new Object[]{this})).intValue();
    }
    ...
    public void setMuteListener(MuteListener muteListener2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "2104581458")) {
            ipChange.ipc$dispatch("2104581458", new Object[]{this, muteListener2});
            return;
        }
