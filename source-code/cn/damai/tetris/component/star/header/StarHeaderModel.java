...
public class StarHeaderModel extends AbsModel implements StarHeaderContract.Model<BaseNode> {
    ...
    public StarHeaderData getData() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-245576040")) {
            return this.headerData;
        }
        return (StarHeaderData) ipChange.ipc$dispatch("-245576040", new Object[]{this});
    }

    @Override // cn.damai.tetris.component.star.header.StarHeaderContract.Model
    public int getFragmentType() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1944558456")) {
            return this.innerFragmentType;
        }
        return ((Integer) ipChange.ipc$dispatch("-1944558456", new Object[]{this})).intValue();
    }
