...
public class BaseTabModel extends AbsModel implements BaseTabContract$Model {
    ...
    public List<BaseTabResultItem> getTabLists() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1688080780")) {
            return this.tabLists;
        }
        return (List) ipChange.ipc$dispatch("1688080780", new Object[]{this});
    }

    @Override // cn.damai.tetris.component.common.BaseTabContract$Model
    public JSONObject getTrackInfoAction() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1184663648")) {
            return this.action;
        }
        return (JSONObject) ipChange.ipc$dispatch("1184663648", new Object[]{this});
    }
