...
public class CommonErrorModel extends AbsModel implements CommonErrorContract.Model {
    ...
    public String getCode() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-868688871")) {
            return this.code;
        }
        return (String) ipChange.ipc$dispatch("-868688871", new Object[]{this});
    }

    @Override // cn.damai.tetris.component.common.CommonErrorContract.Model
    public String getMsg() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2081162805")) {
            return this.message;
        }
        return (String) ipChange.ipc$dispatch("-2081162805", new Object[]{this});
    }
