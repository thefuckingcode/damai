...
public class HorizontalProjectAdapter extends RecyclerView.Adapter<HorizontalProjectViewHolder> {
    ...
    public void onBindViewHolder(HorizontalProjectViewHolder horizontalProjectViewHolder, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "664867645")) {
            ...
            horizontalProjectViewHolder.itemView.getLayoutParams().width = s50.a(horizontalProjectViewHolder.itemView.getContext(), 317.0f);
        }
    }
    ...
    public HorizontalProjectViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1307114009")) {
            return new HorizontalProjectViewHolder(LayoutInflater.from(this.a));
        }
        return (HorizontalProjectViewHolder) ipChange.ipc$dispatch("1307114009", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
