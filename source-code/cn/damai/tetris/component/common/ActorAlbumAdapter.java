...
public class ActorAlbumAdapter extends RecyclerView.Adapter<b> {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            DMNav.from(ActorAlbumAdapter.this.b).withExtras(bundle).toUri(NavUri.b(gr.ARTISTID_THEME));
    ...
    public b onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(v50.a(this.b, 80.0f), -1);
