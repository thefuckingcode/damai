...
public class CircleHeadModel extends AbsModel implements CircleHeadContract.Model {
    ...
    public String getBackImage() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-561005935")) {
            return this.theme.backgroundImg;
        }
        return (String) ipChange.ipc$dispatch("-561005935", new Object[]{this});
    }
    ...
    public List<ProjectItemBean> getProjectList() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1653755867")) {
            return this.projectDOS;
        }
        return (List) ipChange.ipc$dispatch("1653755867", new Object[]{this});
    }

    @Override // cn.damai.tetris.component.discover.mvp.CircleHeadContract.Model
    public ThemeRankBean getRank() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1564285620")) {
            return this.activity;
        }
        return (ThemeRankBean) ipChange.ipc$dispatch("1564285620", new Object[]{this});
    }

    @Override // cn.damai.tetris.component.discover.mvp.CircleHeadContract.Model
    public ThemeShareBean getShare() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1318320743")) {
            return this.share;
        }
        return (ThemeShareBean) ipChange.ipc$dispatch("-1318320743", new Object[]{this});
    }
    ...
    public ThemeBean getThemeBean() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2118947772")) {
            return this.theme;
        }
        return (ThemeBean) ipChange.ipc$dispatch("-2118947772", new Object[]{this});
    }
