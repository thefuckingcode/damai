...
public class VideoInfo implements Serializable {
    ...
    public String formatVideoTime() {
        ...
        if (TextUtils.isEmpty(this.videoTime) || (j = lk1.j(this.videoTime, -1)) <= 0) {
            return null;
        }
        int i = (j % 60000) / 1000;
    ...
    public boolean isVideoUnderReviewStatus() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1953736909")) {
            return TextUtils.equals("0", this.status);
        }
        return ((Boolean) ipChange.ipc$dispatch("-1953736909", new Object[]{this})).booleanValue();
    }
}
