...
public class FilterCalendarPanel implements View.OnClickListener {
    ...
    public FilterCalendarPanel(ViewGroup viewGroup, OnCalendarListener onCalendarListener) {
        this.c = viewGroup;
        this.b = (ViewGroup) LayoutInflater.from(xs0.a()).inflate(R$layout.item_tetris_filter_calendar_container, viewGroup, false);
        this.f = new CalendarPopView(xs0.a(), true, true, 80, new a());
