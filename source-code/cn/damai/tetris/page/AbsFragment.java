...
public abstract class AbsFragment<T> extends Fragment implements OnLoadMoreListener, OnRefreshListener, IMessage {
    ...
    protected w9 baseContext = new w9();
    ...
    public class ReqRunnable implements Runnable {
        ...
        public void run() {
            ...
            message.what = 0;
            message.obj = AbsFragment.this.getJsonFromCDN(new a(this.pattern, this.version, this.cityCode));
    ...
    private void initRecycleView(DamaiRootRecyclerView damaiRootRecyclerView) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-886932976")) {
            ...
            damaiRootRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
                /* class cn.damai.tetris.page.AbsFragment.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
                public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1955667614")) {
                        ipChange.ipc$dispatch("-1955667614", new Object[]{this, recyclerView, Integer.valueOf(i), Integer.valueOf(i2)});
            ...
            brVar.b(this.baseContext.a() + 11004, this.commonAction);
            br brVar2 = this.mDMMessage;
            brVar2.b(this.baseContext.a() + 11003, this.commonAction);
            br brVar3 = this.mDMMessage;
            brVar3.b(this.baseContext.a() + 11002, this.commonAction);
            br brVar4 = this.mDMMessage;
            brVar4.b(this.baseContext.a() + 11001, this.commonAction);
        }
    }
    ...
    private void showToTopBtn(@NonNull View view) {
        ...
        this.mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            /* class cn.damai.tetris.page.AbsFragment.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1492390944")) {
                    ipChange.ipc$dispatch("-1492390944", new Object[]{this, recyclerView, Integer.valueOf(i)});
                    return;
                }
            ...
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1210724415")) {
                    ipChange.ipc$dispatch("1210724415", new Object[]{this, recyclerView, Integer.valueOf(i), Integer.valueOf(i2)});
                    return;
                }
    ...
    public void addComponent(BaseResponse baseResponse, BaseLayer baseLayer) {
        ...
        } else if (baseResponse != null && !s71.a(baseResponse.layers) && baseLayer != null) {
    ...
    public void addData(T t) {
        ...
        AbsAdapter absAdapter2 = this.absAdapter;
        if (absAdapter2 != null) {
            absAdapter2.a(t);
    ...
    public abstract AbsAdapter<AbsViewHolder, T> getAdapter(w9 w9Var);

    public w9 getBaseContext() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1762277490")) {
            return this.baseContext;
        }
        return (w9) ipChange.ipc$dispatch("1762277490", new Object[]{this});
    }

    public String getJsonFromCDN(a aVar) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "677717397")) {
            return aVar.c();
        }
        return (String) ipChange.ipc$dispatch("677717397", new Object[]{this, aVar});
    }

    public Map getProperties() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1492115300")) {
            return this.properties;
        }
        return (Map) ipChange.ipc$dispatch("1492115300", new Object[]{this});
    }
    ...
    public boolean isLazyLoaded() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-418164461")) {
            return this.isLazyLoaded;
        }
        return ((Boolean) ipChange.ipc$dispatch("-418164461", new Object[]{this})).booleanValue();
    }
    ...
    public boolean isRecyclerViewOverPage(RecyclerView recyclerView) {
        ...
        if (recyclerView != null) {
            try {
                ...
                if (childAt == null || layoutManager == null || layoutManager.getPosition(childAt) <= 10) {
                    return false;
                }
                return true;
            } catch (Exception e2) {
    ...
    public boolean isViewCreated() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1215739485")) {
            return this.isViewCreated;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1215739485", new Object[]{this})).booleanValue();
    }
    ...
    public void sendMsg(cn.damai.tetris.core.msg.Message message) {
        ...
        br.c(this.baseContext.a(), message);
    }
    ...
    public void setUserVisibleHint(boolean z) {
        ...
        if (this.baseContext == null) {
            w9 w9Var = new w9();
            this.baseContext = w9Var;
            w9Var.setActivity(getActivity());
        }
    ...
    public boolean showToTop() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1019952575")) {
            return this.showToTop;
        }
        return ((Boolean) ipChange.ipc$dispatch("1019952575", new Object[]{this})).booleanValue();
    }
    ...
    public void sendMsg(cn.damai.tetris.core.msg.Message message, int i) {
        ...
        br.c(this.baseContext.a() + i, message);
    }
