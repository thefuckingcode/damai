...
public class CmsDxTemplate implements Serializable {
    ...
    public boolean isValid(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1063102073")) {
            return !TextUtils.isEmpty(str) && this.version > -1;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1063102073", new Object[]{this, str})).booleanValue();
    }
}
