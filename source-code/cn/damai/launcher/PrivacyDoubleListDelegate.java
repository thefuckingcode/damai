...
public final class PrivacyDoubleListDelegate {
    ...
    @NotNull
    private static final Lazy b = b.b(PrivacyDoubleListDelegate$isOpen$2.INSTANCE);
    ...
    public final boolean isOpen() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1746948693")) {
            return ((Boolean) b.getValue()).booleanValue();
        }
        return ((Boolean) ipChange.ipc$dispatch("1746948693", new Object[]{this})).booleanValue();
    }
}
