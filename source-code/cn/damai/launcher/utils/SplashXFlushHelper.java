...
public class SplashXFlushHelper {
    ...
    public static void a(String str, String str2, String str3) {
        ...
        try {
            yz2.a("homepage" + ":jsondata={apiName: " + SPLASH_ADS_CLICK_API_NAME + ", retMsg:" + str + ", schema:" + str3 + ", cityId:" + str2 + "}", "-1008", "开机页广告点击跳转失败");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void b(String str, String str2, String str3, String str4) {
        ...
        try {
            yz2.c(yz2.a, BUSINESS_NAME_MONITORPOINT, "homepage" + ":jsondata={apiName: " + SPLASH_ADS_DOWNLOAD_API_NAME + ", retCode:" + str + ", retMsg:" + str2 + ", pic:" + str4 + ", cityId:" + str3 + "}", "-1007", "开机页广告图片下载失败");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void c(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1529028568")) {
            ipChange.ipc$dispatch("-1529028568", new Object[]{str, str2, str3});
        }
    }
    ...
    public static void d(int i) {
        ...
        try {
            yz2.a("homepage" + ":jsondata={apiName: " + "startLocation" + ", retMsg:" + i + ", tips:" + "retMsg查高德文档" + ", cityId:" + d20.c() + "}", START_LOCATION_FAIL_CODE, START_LOCATION_FAIL_MSG);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void e(String str, String str2, String str3, String str4, String str5) {
        ...
        try {
            yz2.a("homepage" + ":jsondata={apiName: " + str + ", retCode:" + str2 + ", retMsg:" + str3 + ", data:" + str4 + ", cityId:" + str5 + "}", "-1006", "开机页广告接口解析失败");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
