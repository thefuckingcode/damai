...
public class PictureGaiaxProviderImp extends PictureGaiaxProviderAbs {
    ...
    public Dialog PictureCommonDialog(@NonNull Activity activity, String str, String str2, String str3, String str4, DialogInterface.OnClickListener onClickListener, DialogInterface.OnClickListener onClickListener2) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1102985414")) {
            return new DMDialog(activity).v(str).q(str2).n(str4, onClickListener).i(str3, onClickListener2).t(17).o(true);
        }
        return (Dialog) ipChange.ipc$dispatch("-1102985414", new Object[]{this, activity, str, str2, str3, str4, onClickListener, onClickListener2});
    }
}
