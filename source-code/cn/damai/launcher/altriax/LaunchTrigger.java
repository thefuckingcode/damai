...
public class LaunchTrigger {
    ...
    public void a() {
        ...
        Discriminator.installStrategy(new Strategy(this) {
            /* class cn.damai.launcher.altriax.LaunchTrigger.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // me.ele.altriax.launcher.biz.strategy.Strategy
            public boolean identify(@NonNull String str) {
                IpChange ipChange = $ipChange;
                if (!AndroidInstantRuntime.support(ipChange, "-2102679131")) {
                    return true;
                }
                return ((Boolean) ipChange.ipc$dispatch("-2102679131", new Object[]{this, str})).booleanValue();
            }
