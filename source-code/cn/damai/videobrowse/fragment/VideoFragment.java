...
public class VideoFragment extends LazyLoadFragment {
    ...
    public class b implements OnPlayerUTReportListener {
        ...
        public void fullScreenBtnClick(String str) {
            ...
            pv2.g().i("bottom", "fullscreen", false, VideoFragment.this.mProjectId, str, d20.E());
        }
        ...
        public void onMuteBtnClick(String str, int i) {
            ...
            pv2.g().j("bottom", "mute", false, VideoFragment.this.mProjectId, str, d20.E(), String.valueOf(i));
        }
        ...
        public void onPauseOrPlayClick(String str, int i) {
            ...
            pv2.g().j("bottom", "pause_play", false, VideoFragment.this.mProjectId, str, d20.E(), str2);
        }
        ...
        public void onSeekBarClick(String str) {
            ...
            pv2.g().i("bottom", "progress", false, VideoFragment.this.mProjectId, str, d20.E());
        }
        ...
        public void playEnd(String str, int i) {
            ...
            pv2.g().k(VideoFragment.this.mProjectId, d20.E(), "playend", str, VideoFragment.this.mVideoInfo != null ? VideoFragment.this.mVideoInfo.getTitle() : "", String.valueOf(i));
        }
        ...
        public void returnSmallScreen(String str) {
            ...
            pv2.g().i("fullscreen", Constants.Event.RETURN, false, VideoFragment.this.mProjectId, str, d20.E());
        }
    }
    ...
    public int setContentView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1694615205")) {
            return R$layout.video_fragment_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("1694615205", new Object[]{this})).intValue();
    }
