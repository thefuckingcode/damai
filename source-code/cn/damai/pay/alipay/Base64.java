...
public final class Base64 {
    ...
    public static String encode(byte[] bArr) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1565804696")) {
            ...
            while (i < i3) {
                ...
                byte b4 = (byte) (b2 & 15);
                byte b5 = (byte) (b & 3);
                byte b6 = (byte) ((b & as2.MAX_POWER_OF_TWO) == 0 ? b >> 2 : (b >> 2) ^ 192);
                byte b7 = (byte) ((b2 & as2.MAX_POWER_OF_TWO) == 0 ? b2 >> 4 : (b2 >> 4) ^ GlMapUtil.DEVICE_DISPLAY_DPI_MEDIAN);
                int i9 = (b3 & as2.MAX_POWER_OF_TWO) == 0 ? b3 >> 6 : (b3 >> 6) ^ 252;
                int i10 = i5 + 1;
            ...
            if (i2 == 8) {
                byte b8 = bArr[i4];
                byte b9 = (byte) (b8 & 3);
                int i13 = (b8 & as2.MAX_POWER_OF_TWO) == 0 ? b8 >> 2 : (b8 >> 2) ^ 192;
                int i14 = i5 + 1;
                ...
                byte b13 = (byte) (b10 & 3);
                byte b14 = (byte) ((b10 & as2.MAX_POWER_OF_TWO) == 0 ? b10 >> 2 : (b10 >> 2) ^ 192);
                int i16 = (b11 & as2.MAX_POWER_OF_TWO) == 0 ? b11 >> 4 : (b11 >> 4) ^ GlMapUtil.DEVICE_DISPLAY_DPI_MEDIAN;
                int i17 = i5 + 1;
    ...
    private static boolean isData(char c) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "99080654")) {
            return c < 128 && base64Alphabet[c] != -1;
        }
        return ((Boolean) ipChange.ipc$dispatch("99080654", new Object[]{Character.valueOf(c)})).booleanValue();
    }

    private static boolean isPad(char c) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1416826809")) {
            return c == PAD;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1416826809", new Object[]{Character.valueOf(c)})).booleanValue();
    }

    private static boolean isWhiteSpace(char c) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-509655807")) {
            return c == ' ' || c == '\r' || c == '\n' || c == '\t';
        }
        return ((Boolean) ipChange.ipc$dispatch("-509655807", new Object[]{Character.valueOf(c)})).booleanValue();
    }
