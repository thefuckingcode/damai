...
public class MobileSecurePayHelper {
    ...
    private Handler mHandler = new Handler() {
        /* class cn.damai.pay.alipay.MobileSecurePayHelper.AnonymousClass3 */
    ...
    public static PackageInfo getApkInfo(Context context, String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "296642846")) {
            return context.getPackageManager().getPackageArchiveInfo(str, 128);
        }
        return (PackageInfo) ipChange.ipc$dispatch("296642846", new Object[]{context, str});
    }
    ...
    public boolean detectMobile_sp() {
        ...
        if (!isMobile_spExist) {
            ...
            this.mProgress = BaseHelper.showProgress(context, null, bk2.b(context, R$string.data_string_044), false, true);
            new Thread(new Runnable() {
                /* class cn.damai.pay.alipay.MobileSecurePayHelper.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void run() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1046985755")) {
                        ipChange.ipc$dispatch("1046985755", new Object[]{this});
                        return;
                    }
    ...
    public String getMsp(Context context) {
        ...
        } else if (isAppInstalled(context, "com.eg.android.AlipayGphone")) {
    ...
    public boolean isMobile_spExist() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1024326252")) {
            return isAppInstalled(this.mContext, n.a);
        }
        return ((Boolean) ipChange.ipc$dispatch("-1024326252", new Object[]{this})).booleanValue();
    }
    ...
    public void showInstallConfirmDialog(final Context context, final String str) {
        ...
        dMDialog.l(R$string.Ensure, new DialogInterface.OnClickListener() {
            /* class cn.damai.pay.alipay.MobileSecurePayHelper.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(DialogInterface dialogInterface, int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1213452921")) {
                    ipChange.ipc$dispatch("1213452921", new Object[]{this, dialogInterface, Integer.valueOf(i)});
                    return;
                }
