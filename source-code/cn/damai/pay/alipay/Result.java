...
public class Result {
    ...
    public static String getAppUserId(String str) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "884154610")) {
            return getContent(str.replace(jl1.BLOCK_START_STR, "").replace("}", ""), "userid=", null);
        }
        return (String) ipChange.ipc$dispatch("884154610", new Object[]{str});
    }
    ...
    public static String getResult(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1330146612")) {
            return getContent(str.replace(jl1.BLOCK_START_STR, "").replace("}", ""), "memo=", ";result");
        }
        return (String) ipChange.ipc$dispatch("1330146612", new Object[]{str});
    }

    public static String getToken(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1070101156")) {
            return getContent(str.replace(jl1.BLOCK_START_STR, "").replace("}", ""), "token=", "&userid");
        }
        return (String) ipChange.ipc$dispatch("1070101156", new Object[]{str});
    }
}
