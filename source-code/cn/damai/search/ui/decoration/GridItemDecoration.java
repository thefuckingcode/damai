...
public class GridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public static class b {
        ...
        public GridItemDecoration a() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "1347003701")) {
                return new GridItemDecoration(this.b, this.c, this.d);
            }
            return (GridItemDecoration) ipChange.ipc$dispatch("1347003701", new Object[]{this});
        }
