...
public class ArtificialAdapter extends RecyclerView.Adapter<SearchHeadArtificialViewHolder> {
    ...
    public SearchHeadArtificialViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-572602418")) {
            return new SearchHeadArtificialViewHolder(this.b, viewGroup, this.c);
        }
        return (SearchHeadArtificialViewHolder) ipChange.ipc$dispatch("-572602418", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
