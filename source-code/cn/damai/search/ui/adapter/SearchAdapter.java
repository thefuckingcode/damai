...
public class SearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void c(ProjectItemBean projectItemBean, boolean z, View view, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1873924064")) {
            ipChange.ipc$dispatch("-1873924064", new Object[]{this, projectItemBean, Boolean.valueOf(z), view, Integer.valueOf(i2)});
    ...
    public List<SearchDataHolder> getData() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1471982358")) {
            return this.a;
        }
        return (List) ipChange.ipc$dispatch("-1471982358", new Object[]{this});
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1875538118")) {
            return xf2.e(this.a);
        }
        return ((Integer) ipChange.ipc$dispatch("-1875538118", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1843110687")) {
            return this.a.get(i2).mType;
        }
        return ((Integer) ipChange.ipc$dispatch("-1843110687", new Object[]{this, Integer.valueOf(i2)})).intValue();
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-301086337")) {
            ipChange.ipc$dispatch("-301086337", new Object[]{this, viewHolder, Integer.valueOf(i2)});
            ...
            if (i3 == 0) {
                ...
                c(searchDataHolder.mProjectItem, searchDataHolder.isRecommendProject, viewHolder.itemView, i2);
            } else if (i3 == 1) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "686591831")) {
            return (RecyclerView.ViewHolder) ipChange.ipc$dispatch("686591831", new Object[]{this, viewGroup, Integer.valueOf(i2)});
        }
