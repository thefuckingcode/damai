...
public class SearchHeadTourViewHolder extends RecyclerView.ViewHolder {
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (intValue >= 0) {
                c.e().x(c62.C().M(SearchHeadTourViewHolder.this.m));
                ...
                boolean z2 = searchHeadTourViewHolder3.h;
                if (intValue > 6) {
                    z = true;
                }
                searchHeadTourViewHolder3.n(z2, z);
            }
        }
    }
    ...
    public void f(String str, List<SearchTourItem> list) {
        ...
        if (e2 > 0) {
            ...
            this.e.setTag(Integer.valueOf(e2));
            boolean z2 = this.h;
            if (e2 <= 6) {
                z = false;
            }
        ...
        if (AndroidInstantRuntime.support(ipChange, "-726792927")) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(str2)) {
                    spannableStringBuilder.setSpan(new ForegroundColorSpan(ContextCompat.getColor(this.g, R$color.main_color)), i3, str2.length() + i3, 18);
                }
