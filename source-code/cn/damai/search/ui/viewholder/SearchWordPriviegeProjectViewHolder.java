...
public class SearchWordPriviegeProjectViewHolder extends RecyclerView.ViewHolder {
    ...
    public static String a(String str, Long l) {
        ...
        } else if (l != null && l.longValue() != 0 && !TextUtils.isEmpty(str)) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-440712081")) {
            ...
            if (i == 21) {
                if ("0".equals(projectItemBean.categoryName)) {
                    ...
                    str = "1".equals(projectItemBean.categoryName) ? "be_evaluated" : str2;
                }
                c.e().F(this.itemView, str, "top", c62.SEARCH_ITEM_ASSOCIATE);
            }
            if (z) {
                ...
                this.g.setPadding(0, 0, 0, s50.a(this.b, 15.0f));
                ...
                if (z2 && (i == 17 || i == 21)) {
                    ...
                    layoutParams.setMargins(0, 0, 0, s50.a(this.b, 15.0f));
            ...
            if (num == null || num.intValue() != 1) {
                this.f.getLayoutParams().height = s50.a(this.b, 68.0f);
                this.d.setMaxLines(2);
                d(projectItemBean.showTime, projectItemBean.venueName);
            } else {
                this.f.getLayoutParams().height = s50.a(this.b, 48.0f);
            ...
            if (num2 == null || num2.intValue() != 1) {
                ...
                DMImageCreator c3 = a.b().c(projectItemBean.verticalPic);
                int i4 = R$drawable.store_defult_img;
                this.c.setTag(c3.i(i4).c(i4).g(this.c));
            }
