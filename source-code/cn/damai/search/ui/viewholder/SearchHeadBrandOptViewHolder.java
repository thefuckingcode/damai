    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "101281735")) {
                ...
                c.e().x(c62.C().o(SearchHeadBrandOptViewHolder.this.c, "", brandOptimizationDO.id, brandOptimizationDO.type, this.a));
                Bundle bundle = new Bundle();
                bundle.putString(IssueConstants.ProjectID, brandOptimizationDO.id);
                DMNav.from(SearchHeadBrandOptViewHolder.this.b).withExtras(bundle).toUri(gr.a());
            }
        }
    }
