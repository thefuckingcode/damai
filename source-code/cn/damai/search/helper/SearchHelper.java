...
public class SearchHelper {
    ...
    public class a implements Comparator<ArtificialProxy> {
        ...
        public int compare(ArtificialProxy artificialProxy, ArtificialProxy artificialProxy2) {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "-247659605")) {
                return artificialProxy.index() - artificialProxy2.index();
            }
            return ((Integer) ipChange.ipc$dispatch("-247659605", new Object[]{this, artificialProxy, artificialProxy2})).intValue();
        }
    }
    ...
    public static String e(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-314964207")) {
            return context.getSharedPreferences("history", 0).getString("keyhistory", "");
        }
        return (String) ipChange.ipc$dispatch("-314964207", new Object[]{context});
    }
    ...
    public static List<SearchDataHolder> h(SearchResultBeanV2 searchResultBeanV2, String str, String str2, InputState inputState) {
        ...
        } else if (searchResultBeanV2 == null) {
            return null;
        } else {
    ...
    public static int j(SearchResultBeanV2 searchResultBeanV2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-857970743")) {
            ...
            return xf2.e(searchResultBeanV2.contentNoteList);
        }
    }
    ...
    public static int l(boolean z, SearchResultBeanV2 searchResultBeanV2) {
        ...
        int e = xf2.e(searchResultBeanV2.projectInfo);
        return (!z || (searchTourBean = searchResultBeanV2.tour) == null) ? e : e + xf2.e(searchTourBean.items);
    }
    ...
    public static String n(String str) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-556671952")) {
            return (String) ipChange.ipc$dispatch("-556671952", new Object[]{str});
        } else if (str == null) {
            return "";
        } else {
            if (str.equals("2")) {
    ...
    public static int o(SearchTourBean searchTourBean) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1402119793")) {
            ...
            return xf2.e(searchTourBean.items);
        }
    }
    ...
    public static void s(ImageView imageView, String str, int i, int i2) {
        ...
        imageView.setImageDrawable(xs0.a().getResources().getDrawable(R$drawable.uikit_default_image_bg_gradient));
