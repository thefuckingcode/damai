...
public class SearchResultBeanYouKu implements Serializable {
    ...
    public static class ListBean {
        ...
        public String getVideoSupport() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "834658036")) {
                return (TextUtils.isEmpty(this.isVideoSupport) || !this.isVideoSupport.equals("1")) ? "false" : "true";
            }
            return (String) ipChange.ipc$dispatch("834658036", new Object[]{this});
        }
    ...
    public static boolean isResImageTextEnded(SearchResultBeanYouKu searchResultBeanYouKu) {
        ...
        if (!(searchResultBeanYouKu == null || (dataBean = searchResultBeanYouKu.data) == null || f92.d(dataBean.resultList))) {
