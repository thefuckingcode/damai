...
public class SearchHistoryFragment extends DamaiBaseMvpFragment implements SearchInputObserver {
    ...
    public class a implements View.OnClickListener {
        ...
        public class DialogInterface$OnClickListenerC0039a implements DialogInterface.OnClickListener {
            ...
            DialogInterface$OnClickListenerC0039a() {
            }
        ...
        public void onClick(View view) {
            ...
            if (activity != null && !activity.isFinishing()) {
                ...
                dMDialog.v("确认清空搜索历史？");
                dMDialog.i("取消", null);
                dMDialog.n("确定", new DialogInterface$OnClickListenerC0039a());
                dMDialog.show();
            }
        }
    }
            ...
            if (AndroidInstantRuntime.support(ipChange, "-512654820")) {
                ...
                for (int i9 = 0; i9 < childCount; i9++) {
                    ...
                    if (childAt.getTag() instanceof String) {
                        d62.g(childAt, (String) childAt.getTag(), i9);
                    }
                }
            }
        }
    ...
    public class d implements ExpandFlowLayout.ExpandBtnView {
        ...
        public View getExpandBtnView() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "1994727746")) {
                return SearchHistoryFragment.this.mExpandBtnView;
            }
            return (View) ipChange.ipc$dispatch("1994727746", new Object[]{this});
        }
    ...
    public class e extends ExpandFlowLayout.a<String> {
        ...
        public View c(ViewGroup viewGroup, View view, String str, int i) {
            ...
            if (view == null) {
                view = LayoutInflater.from(xs0.a()).inflate(R$layout.item_one_history_word, viewGroup, false);
            }
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1202154546")) {
            return R$layout.fragment_search_rank_word;
        }
        return ((Integer) ipChange.ipc$dispatch("-1202154546", new Object[]{this})).intValue();
    }
    ...
    public void initView() {
        ...
        View inflate = LayoutInflater.from(xs0.a()).inflate(R$layout.item_history_arrow_view, (ViewGroup) null);
