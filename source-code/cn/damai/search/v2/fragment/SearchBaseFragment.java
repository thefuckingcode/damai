...
public abstract class SearchBaseFragment extends BaseFragment implements ISearchTabSwitch, SearchInputObserver, ITab {
    ...
    public class SearchPageLoader extends BasePageLoader {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-1112037426")) {
                ...
                try {
                    if (jSONObject.get("currentTime") instanceof String) {
                        j = Long.parseLong((String) jSONObject.get("currentTime"));
                    } else {
                        j = jSONObject.get("currentTime") instanceof Long ? ((Long) jSONObject.get("currentTime")).longValue() : 0;
                    }
                    if (j > 0) {
                        long elapsedRealtime = SystemClock.elapsedRealtime();
                        if (node.getData() != null) {
                            node.getData().put("nativeDiffTime", (Object) Long.valueOf(j - elapsedRealtime));
                            node.getData().put(ProjectShowBean.SERVER_TIME, (Object) Long.valueOf(j));
                        }
                    }
        ...
        public void handleLoadFailure(IResponse iResponse) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-1226558235")) {
                ...
                try {
                    ...
                    c62.f(iResponse.getRetCode(), iResponse.getRetMessage(), inputInfo == null ? "none" : inputInfo.inputText);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        public void handleLoadFinish(@Nullable IResponse iResponse, boolean z, int i) {
            IpChange ipChange = $ipChange;
            ...
            SearchBaseFragment.this.getPageContext().runOnUIThread(new w52(this, iResponse, i));
            try {
                if (getCallback() != null) {
        ...
        @Override // com.youku.arch.v3.loader.PagingLoader, com.youku.arch.v3.loader.PageLoader, com.youku.arch.v3.loader.AbsLoader, com.alient.onearch.adapter.loader.BasePageLoader
        public void handleLoadSuccess(IResponse iResponse, int i) {
            ...
            if (iResponse.getRawData().contains("contain_sensitive_words")) {
                SearchBaseFragment.this.getPageContext().runOnUIThreadLocked(new v52(this));
            } else {
        ...
        public boolean isInterceptCreateSection(Node node, JSONObject jSONObject) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-1245369103")) {
            ...
            } else if (parseComponentType(jSONObject.getString("componentId")) != 1000) {
                return false;
            } else {
                ...
                if (jSONArray2 != null && !jSONArray2.isEmpty()) {
                    ...
                    if (getComponentItemDisplayLimiter().hasComponentLimitSize(node3.getType())) {
                        ...
                        if (getComponentItemDisplayLimiter().geComponentLimitSize(node3.getType()).intValue() < jSONArray2.size()) {
                            z = true;
                        }
                        node3.setMore(true);
                    } else {
                        parseItems(node3, jSONArray2, jSONArray2.size());
                        node3.setMore(jSONObject2.containsKey(wj2.HAS_NEXT) && "true".equals(jSONObject2.getString(wj2.HAS_NEXT)));
                    }
        ...
        @Override // com.youku.arch.v3.loader.PagingLoader, com.youku.arch.v3.loader.AbsLoader, com.alient.onearch.adapter.loader.BasePageLoader
        ...
        public int parseComponentType(String str) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "163390659")) {
                return ComponentTypeMapper.INSTANCE.convertComponentTypeToInt(str);
            }
            return ((Integer) ipChange.ipc$dispatch("163390659", new Object[]{this, str})).intValue();
        }

        @Override // com.youku.arch.v3.loader.PageLoader, com.alient.onearch.adapter.loader.BasePageLoader
        @NonNull
    ...
    public class SearchRequestBuilder implements RequestBuilder {
        ...
        public IRequest build(Map<String, ?> map) {
            ...
            hashMap2.put("comboDamaiCityId", d20.c());
            ...
            Map<String, String> c = a20.b().c(API_NAME, hashMap);
            Map<String, String> e = m6.e();
            if (d20.t()) {
                e.put("EagleEye-UserData", "scm_project=" + d20.s());
            }
            ...
            if ((obj2 instanceof Boolean) && ((Boolean) obj2).booleanValue()) {
                ...
                g91.c("CDNDownGrade", "cdn url: " + str);
    ...
    public RequestBuilder createRequestBuilder(@Nullable Map<String, ?> map) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1763281376")) {
            return new SearchRequestBuilder();
        }
        return (RequestBuilder) ipChange.ipc$dispatch("-1763281376", new Object[]{this, map});
    }
    ...
    public String getConfigPath() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1559750313")) {
            return "://trade/raw/search_component_config";
        }
        return (String) ipChange.ipc$dispatch("1559750313", new Object[]{this});
    }

    /* access modifiers changed from: protected */
    public abstract String getEmptyPageDesSuffix();

    /* access modifiers changed from: protected */
    @Override // com.youku.arch.v3.page.GenericFragment
    public String getPageName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-889593828")) {
            return "search";
        }
        return (String) ipChange.ipc$dispatch("-889593828", new Object[]{this});
    }
    ...
    /* access modifiers changed from: protected */
    public abstract String getRequestPatternVersion();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle bundle) {
        ...
        getRecyclerView().setPadding(0, v50.a(getActivity(), 9.0f), 0, 0);
    }
