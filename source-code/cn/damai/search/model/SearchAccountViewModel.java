...
public class SearchAccountViewModel extends AndroidViewModel implements Serializable {
    ...
    private SearchAccountRepository mRepository = new SearchAccountRepository();
    ...
    public MutableLiveData<Integer> getPageIndex() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "98959515")) {
            return this.mPageIndex;
        }
        return (MutableLiveData) ipChange.ipc$dispatch("98959515", new Object[]{this});
    }
