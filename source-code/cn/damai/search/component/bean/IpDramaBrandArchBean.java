...
public class IpDramaBrandArchBean implements Serializable {
    ...
    public String getIpBrandType() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1169119257")) {
            return (String) ipChange.ipc$dispatch("1169119257", new Object[]{this});
    ...
    public int getTagImageResourceRid() {
        IpChange ipChange = $ipChange;
        char c = 0;
        if (AndroidInstantRuntime.support(ipChange, "-775144106")) {
            return ((Integer) ipChange.ipc$dispatch("-775144106", new Object[]{this})).intValue();
        } else if (TextUtils.equals("11", this.type)) {
            return R$drawable.icon_ip_brand;
        } else {
            ...
            switch (c) {
                case 0:
                    return R$drawable.icon_ip_sport;
                case 1:
                    return R$drawable.icon_ip_leisure;
                case 2:
                    return R$drawable.icon_ip_drama_venue;
                case 3:
                    return R$drawable.icon_ip_exhibition;
                case 4:
                    return R$drawable.icon_ip_activity;
                case 5:
                    return R$drawable.icon_ip_music;
                case 6:
                    return R$drawable.music_festival_icon;
                default:
                    return -1;
            }
        }
    ...
    public boolean isShowVTag() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "755589796")) {
            return !TextUtils.isEmpty(this.vaccount) && !"0".equals(this.vaccount);
        }
        return ((Boolean) ipChange.ipc$dispatch("755589796", new Object[]{this})).booleanValue();
    }
}
