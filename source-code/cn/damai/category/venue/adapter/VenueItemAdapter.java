...
public class VenueItemAdapter extends RecyclerView.Adapter<VenueItemViewHolder> {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            DMNav.from(VenueItemAdapter.this.a).withExtras(bundle).toUri(NavUri.b(gr.ARTISTID_THEME));
    ...
    public void onBindViewHolder(final VenueItemViewHolder venueItemViewHolder, int i) {
        ...
        venueItemViewHolder.c.post(new Runnable() {
            /* class cn.damai.category.venue.adapter.VenueItemAdapter.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1362574106")) {
                    ipChange.ipc$dispatch("1362574106", new Object[]{this});
    ...
    public VenueItemViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "507575739")) {
            return new VenueItemViewHolder(this, LayoutInflater.from(viewGroup.getContext()).inflate(R$layout.category_venue_item, viewGroup, false));
        }
        return (VenueItemViewHolder) ipChange.ipc$dispatch("507575739", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "475479813")) {
            return xf2.e(this.b);
        }
        return ((Integer) ipChange.ipc$dispatch("475479813", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public long getItemId(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-814521399")) {
            return (long) i;
        }
        return ((Long) ipChange.ipc$dispatch("-814521399", new Object[]{this, Integer.valueOf(i)})).longValue();
    }
