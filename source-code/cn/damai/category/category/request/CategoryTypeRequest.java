...
public class CategoryTypeRequest extends DMBaseMtopRequest {
    ...
    public String getApiName() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1955353058")) {
            return "mtop.damai.wireless.search.performance.category.get";
        }
        return (String) ipChange.ipc$dispatch("-1955353058", new Object[]{this});
    }
    ...
    public String getVersion() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "212383665")) {
            return "1.1";
        }
        return (String) ipChange.ipc$dispatch("212383665", new Object[]{this});
    }
}
