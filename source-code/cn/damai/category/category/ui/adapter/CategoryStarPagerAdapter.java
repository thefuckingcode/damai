...
public class CategoryStarPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int i) {
        ...
        if (i == 0) {
            ...
            StarListBean starListBean = this.a;
            if (starListBean == null || u71.a(starListBean.artistList) || (i2 = i - 2) < 0 || i2 >= this.a.artistList.size()) {
                return null;
            }
    ...
    public Object instantiateItem(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "494037354")) {
            return (Fragment) super.instantiateItem(viewGroup, i);
        }
        return ipChange.ipc$dispatch("494037354", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
