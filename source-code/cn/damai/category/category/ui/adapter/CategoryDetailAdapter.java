...
public class CategoryDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "81708394")) {
            return xf2.e(this.c);
        }
        return ((Integer) ipChange.ipc$dispatch("81708394", new Object[]{this})).intValue();
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1115901319")) {
            return new CategoryDetailHolder(LayoutInflater.from(this.a));
        }
        return (RecyclerView.ViewHolder) ipChange.ipc$dispatch("1115901319", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
}
