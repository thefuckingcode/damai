...
public class ShowFragment extends AbsFragmentV2 {
    ...
    public class c {
        ...
        private List<ProjectItem> a(CategoryNewProjectBean categoryNewProjectBean) {
            ...
            if (ShowFragment.this.mCategoryRequest.cityOption == 0) {
                ...
                if (i == 0) {
                    if (ShowFragment.this.mIsFristProject) {
                        ...
                        if (xf2.e(categoryNewProjectBean.nearByCity) > 0) {
                            ...
                            if (xf2.e(categoryNewProjectBean.nearByCity) < Integer.parseInt(ShowFragment.this.mCategoryRequest.pageSize)) {
                ...
                } else if (xf2.e(categoryNewProjectBean.currentCity) > 0) {
            ...
            } else if (xf2.e(categoryNewProjectBean.nearByCity) > 0) {
            ...
            if (!(baseResponse == null || (arrayList = baseResponse.layers) == null)) {
                ...
                while (it.hasNext() && (next = it.next()) != null && next.getSections() != null) {
                    for (BaseSection baseSection : next.getSections()) {
                        if (!(baseSection == null || !TextUtils.equals(wj2.CATEGORY_LIST_COMPONENT_ID, baseSection.getComponentId()) || baseSection.getItem() == null)) {
                            List<ProjectItem> a2 = a((CategoryNewProjectBean) JSON.parseObject(baseSection.getItem().toJSONString(), CategoryNewProjectBean.class));
                            JSONObject jSONObject = new JSONObject();
                            jSONObject.put("result", (Object) a2);
                            jSONObject.put(qa.KEY_DAOJISHI, (Object) ShowFragment.this.mData.daojishi);
                            jSONObject.put(qa.KEY_SHOW_DIS, (Object) Boolean.valueOf(ShowFragment.this.mData.isShowJuli));
                            jSONObject.put(qa.TRACKKEY_CATEGORY_NAME, (Object) ShowFragment.this.mCategoryName);
                            jSONObject.put("trackB", (Object) ig.g(ShowFragment.this.mCategoryId));
                            jSONObject.put(qa.TRACKKEY_CITY, (Object) d20.d());
    ...
    private boolean checkEmpty(BaseResponse baseResponse) {
        ArrayList<BaseLayer> arrayList;
        BaseLayer next;
            ...
            while (it.hasNext() && (next = it.next()) != null && next.getSections() != null) {
                ...
                while (true) {
                    if (it2.hasNext()) {
                        ...
                        if (next2 != null && TextUtils.equals(wj2.CATEGORY_LIST_COMPONENT_ID, next2.getComponentId()) && next2.getItem() != null && (categoryNewProjectBean = (CategoryNewProjectBean) JSON.parseObject(next2.getItem().toJSONString(), CategoryNewProjectBean.class)) != null) {
                            if (xf2.e(categoryNewProjectBean.currentCity) + xf2.e(categoryNewProjectBean.nearByCity) == 0) {
                                return true;
                            }
                            return false;
                        }
            ...
            for (BaseLayer baseLayer : baseResponse.layers) {
                ...
                if (sections != null) {
                    for (BaseSection baseSection : sections) {
                        if (baseSection != null && wj2.CATEGORY_LIST_COMPONENT_ID.equals(baseSection.getComponentId())) {
                            drObj2.targetLayerId = baseLayer.getLayerId();
                            drObj2.targetSectionId = baseSection.getSectionId();
                        }
                    }
                }
            }
    ...
    public void initView() {
        ...
        this.mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            /* class cn.damai.category.category.ui.ShowFragment.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1890018798")) {
                    ipChange.ipc$dispatch("-1890018798", new Object[]{this, recyclerView, Integer.valueOf(i), Integer.valueOf(i2)});
    ...
    public void request(final boolean z, boolean z2, boolean z3) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-915991941")) {
            ...
            if (this.mCategoryRequest.cityOption == 1 && (drObj2 = this.drObj) != null) {
            ...
            tetrisRequest.request(new DMMtopWarningListener<BaseResponse>(BaseResponse.class, tetrisRequest.toJsonString()) {
                /* class cn.damai.category.category.ui.ShowFragment.AnonymousClass3 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // cn.damai.tetris.DMMtopWarningListener
                public void onFailWithWarning(String str, String str2) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-2033719916")) {
                        ipChange.ipc$dispatch("-2033719916", new Object[]{this, str, str2});
                        return;
                    }
                ...
                public void onSuccessWithWarning(BaseResponse baseResponse) {
                    ...
                    List<Node> list2;
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1667721686")) {
                        ipChange.ipc$dispatch("-1667721686", new Object[]{this, baseResponse});
                        return;
                    }
                    ShowFragment.this.mIsRequesting = false;
                    ...
                    if (ShowFragment.this.mIsFristProject) {
                        if (baseResponse.layers == null) {
                            ...
                            if (ShowFragment.this.mCategoryRequest != null) {
                                kg.b(JSON.toJSONString(ShowFragment.this.mCategoryRequest));
                                return;
                            }
                            return;
                        }
