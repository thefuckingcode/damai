...
public class BannerImageLoader extends ViewLoader {
    ...
    public View createImageView(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1977890494")) {
            return LayoutInflater.from(context).inflate(R$layout.category_video_item, (ViewGroup) null);
        }
        return (View) ipChange.ipc$dispatch("-1977890494", new Object[]{this, context});
    }
