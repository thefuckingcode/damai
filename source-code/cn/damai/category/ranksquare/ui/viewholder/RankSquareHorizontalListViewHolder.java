...
public class RankSquareHorizontalListViewHolder extends BaseViewHolderV2<RankSquareListInfoBean> implements View.OnClickListener {
    ...
    private TextView c = ((TextView) this.itemView.findViewById(R$id.square_title));
    private TextView d = ((TextView) this.itemView.findViewById(R$id.square_sub_title));
    private Context e;
    private OnItemClickListener<RankSquareListInfoBean> f;
    private FlowLayout g = ((FlowLayout) this.itemView.findViewById(R$id.square_items));
    private RelativeLayout h = ((RelativeLayout) this.itemView.findViewById(R$id.square_header));
    private HeaderPicListViewHolder i = ((HeaderPicListViewHolder) this.itemView.findViewById(R$id.square_piclist_view));
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-1330468565")) {
                ...
                DMNav.from(RankSquareHorizontalListViewHolder.this.e).withExtras(bundle).toUri(NavUri.b(gr.DISCOVER_THEME));
                c.e().x(cx1.f().r(this.a.itemList.get(this.b).id, this.b));
            } else if (Integer.parseInt(this.a.type) == 5) {
                c.e().x(cx1.f().p(this.a.itemList.get(this.b).id, this.b));
                Bundle bundle2 = new Bundle();
                bundle2.putString(RepertoireDetailFragment.REPERTOIREID, this.a.itemList.get(this.b).id);
                DMNav.from(RankSquareHorizontalListViewHolder.this.e).withExtras(bundle2).toUri(NavUri.b(wz1.REPERTOITE));
            }
        }
    }
    ...
    /* renamed from: e */
    public void c(RankSquareListInfoBean rankSquareListInfoBean, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "34227002")) {
            ipChange.ipc$dispatch("34227002", new Object[]{this, rankSquareListInfoBean, Integer.valueOf(i2)});
            ...
            for (int i3 = 0; i3 < rankSquareListInfoBean.itemList.size(); i3++) {
                ...
                inflate.setOnClickListener(new b(rankSquareListInfoBean, i3));
                ...
                if (Integer.parseInt(rankSquareListInfoBean.type) == 6) {
                    ...
                    textView.setText(if2.b(this.e, R$drawable.squre_title_icon, rankSquareListInfoBean.itemList.get(i3).name));
                    StringBuffer stringBuffer = new StringBuffer();
                    stringBuffer.append("<font color=\"#FF993A\">" + rankSquareListInfoBean.itemList.get(i3).contentCount + "</font>人参与");
                    stringBuffer.append(" | ");
                    stringBuffer.append("<font color=\"#FF993A\">" + rankSquareListInfoBean.itemList.get(i3).ipvuv + "</font>人围观");
                    ...
                    onLinePosterView2.setImageUrlForWebp(rankSquareListInfoBean.itemList.get(i3).headPic, 0, 0);
                } else if (Integer.parseInt(rankSquareListInfoBean.type) == 5) {
                    linearLayout.setVisibility(0);
                    dMDigitTextView.setVisibility(8);
                    textView.setText(rankSquareListInfoBean.itemList.get(i3).name);
                    onLinePosterView2.setVisibility(8);
                    onLinePosterView.setVisibility(0);
                    onLinePosterView.setImageUrlForWebp(rankSquareListInfoBean.itemList.get(i3).headPic, 0, 0);
                }
