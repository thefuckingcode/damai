...
public class GirlShowListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1523573574")) {
            return xf2.e(this.c);
        }
        return ((Integer) ipChange.ipc$dispatch("1523573574", new Object[]{this})).intValue();
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "92931427")) {
            return (RecyclerView.ViewHolder) ipChange.ipc$dispatch("92931427", new Object[]{this, viewGroup, Integer.valueOf(i)});
        }
