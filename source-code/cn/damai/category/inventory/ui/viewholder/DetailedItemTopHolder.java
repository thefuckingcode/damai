...
public class DetailedItemTopHolder extends RecyclerView.ViewHolder {
    ...
    private void h(ItemBean itemBean, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "927668852")) {
            ipChange.ipc$dispatch("927668852", new Object[]{this, itemBean, Integer.valueOf(i2)});
        } else if (itemBean != null) {
            itemBean.index = i2;
            this.e.setTag(itemBean);
            cn.damai.common.image.a.b().f(itemBean.verticalPic, n42.a(this.a, 111.0f), n42.a(this.a, 148.0f)).c(R$drawable.uikit_default_image_bg_gradient).g(this.k);
    ...
    public void g(ItemBean itemBean) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1508739742")) {
            ...
            c.e().x(w60.g().i(this.u, itemBean.id, this.v, itemBean.index));
