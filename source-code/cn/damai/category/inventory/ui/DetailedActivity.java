...
public class DetailedActivity extends SimpleBaseActivity {
    ...
    Observer<DetailedFollowResponse> followChangeObserver = new Observer<DetailedFollowResponse>() {
        /* class cn.damai.category.inventory.ui.DetailedActivity.AnonymousClass3 */
        private static transient /* synthetic */ IpChange $ipChange;
        ...
        public void onClick(View view) {
            ...
            if (id == R$id.btn_left || id == R$id.error_btn_left) {
                ...
                if (view.getTag() != null) {
                    ...
                    cn.damai.common.user.c.e().x(w60.g().h(DetailedActivity.this.mDetailTitle, DetailedActivity.this.mDetailId, booleanValue));
                    if (!LoginManager.k().q()) {
                ...
                cn.damai.common.user.c.e().x(w60.g().j(DetailedActivity.this.mDetailTitle, DetailedActivity.this.mDetailId));
    ...
    private void defaultTopBackground() {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private int getTitleBgColor(int i) {
        IpChange ipChange = $ipChange;
        ...
        return setAlphaColor(((float) i) / 255.0f, i2);
    }
    ...
    private void initStateBar(View view, boolean z) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            if (view != null) {
                this.mStatusBarHeight = ne2.a(this);
        ...
        this.topShapeHeight = n42.a(this, 81.0f);
        this.imageShapeHeight = this.mStatusBarHeight + n42.a(this, 126.0f);
        if (z) {
            int a2 = this.mStatusBarHeight + n42.a(this.mContext, 44.0f);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void openShare(DetailedBean detailedBean) {
        IpChange ipChange = $ipChange;
    ...
    private void requestData(boolean z) {
        ...
        cancelCountDown();
        this.mViewModel.getDetailedListData().observe(this, new Observer<DetailedBeanResponse>() {
            /* class cn.damai.category.inventory.ui.DetailedActivity.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onChanged(@Nullable DetailedBeanResponse detailedBeanResponse) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1388495343")) {
                    ipChange.ipc$dispatch("-1388495343", new Object[]{this, detailedBeanResponse});
                    return;
                }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void returnDetailedData(DetailedBean detailedBean) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-495808345")) {
            ipChange.ipc$dispatch("-495808345", new Object[]{this, detailedBean});
        } else if (detailedBean != null) {
            int e2 = xf2.e(detailedBean.topItems);
            int e3 = xf2.e(detailedBean.items);
            if (e2 > 0 || e3 > 0) {
    ...
    public static int setAlphaColor(@FloatRange(from = 0.0d, to = 1.0d) float f2, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1960050357")) {
            return ((Integer) ipChange.ipc$dispatch("-1960050357", new Object[]{Float.valueOf(f2), Integer.valueOf(i)})).intValue();
        }
        return Color.argb(Math.round(f2 * 255.0f), (16711680 & i) >> 16, (65280 & i) >> 8, i & 255);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setTopImageBackground(int[] iArr) {
        IpChange ipChange = $ipChange;
    ...
    private void startTime() {
        ...
        if (this.mTimeCountDown == null) {
            this.mTimeCountDown = new a(3000, 3000);
        }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateFansData(boolean z) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateShareLayout(String str, DetailedBean detailedBean) {
        IpChange ipChange = $ipChange;
    ...
    private void visCollectTip() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1377719701")) {
            ...
            layoutParams.topMargin = this.mTitleMinHeight - n42.a(this.mContext, 8.0f);
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1619214380")) {
            return R$layout.inventory_activity;
        }
        return ((Integer) ipChange.ipc$dispatch("-1619214380", new Object[]{this})).intValue();
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        setDamaiUTKeyBuilder(w60.g().f(this.mDetailId));
        requestData(true);
    }
