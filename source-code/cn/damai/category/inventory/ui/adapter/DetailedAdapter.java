...
public class DetailedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1785241967")) {
            return xf2.e(this.b);
        }
        return ((Integer) ipChange.ipc$dispatch("1785241967", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "459885718")) {
            return this.b.get(i).mType;
        }
        return ((Integer) ipChange.ipc$dispatch("459885718", new Object[]{this, Integer.valueOf(i)})).intValue();
    }
