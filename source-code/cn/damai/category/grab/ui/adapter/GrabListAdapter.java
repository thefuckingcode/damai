...
public class GrabListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1526426847")) {
            return xf2.e(this.c);
        }
        return ((Integer) ipChange.ipc$dispatch("-1526426847", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-563014328")) {
            return this.c.get(i).groupType;
        }
        return ((Integer) ipChange.ipc$dispatch("-563014328", new Object[]{this, Integer.valueOf(i)})).intValue();
    }
