...
public class CalendarView extends ViewGroup {
    ...
    private void rePaintView() {
        ...
        for (int i2 = 0; i2 < this.mDays.size(); i2++) {
            ...
            if (day != null) {
                ...
                View b = f30.a().b(this.mContext, day);
                b.setTag(day);
    ...
    public int getDayWidth() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-147582808")) {
            return this.mDayWidth;
        }
        return ((Integer) ipChange.ipc$dispatch("-147582808", new Object[]{this})).intValue();
    }

    public int[] getLocation() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1800274566")) {
            return (int[]) ipChange.ipc$dispatch("-1800274566", new Object[]{this});
        }
    ...
    public String getProjectTag() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "53226434")) {
            return this.mProjectTag;
        }
        return (String) ipChange.ipc$dispatch("53226434", new Object[]{this});
    }
    ...
    public void setMonth(int i, int i2, List<Day> list, CalendarMonthBean calendarMonthBean, View.OnClickListener onClickListener) {
        ...
        this.mYear = i;
        this.mMonth = i2;
        this.mIsCurrentMonth = ze.r(i, i2);
        this.mDays = ze.d(i, i2, list, calendarMonthBean);
        this.mStartWeek = ze.h(i, i2);
