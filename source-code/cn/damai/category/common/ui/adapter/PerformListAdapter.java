...
public class PerformListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "261994111")) {
            return xf2.e(this.c);
        }
        return ((Integer) ipChange.ipc$dispatch("261994111", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1189960102")) {
            return this.c.get(i).type;
        }
        return ((Integer) ipChange.ipc$dispatch("1189960102", new Object[]{this, Integer.valueOf(i)})).intValue();
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-525921510")) {
            ...
            if (i2 == 1) {
                ...
                projectItemViewHolder.v(this.b);
                ...
                rankItemBean.type = 1;
                if (!u71.a(categoryItemRankBean.verticalPicList) && categoryItemRankBean.verticalPicList.get(0) != null) {
