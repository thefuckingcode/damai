...
public class DiscountTicketActivity extends DamaiBaseActivity {
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1684940190")) {
            return R$layout.activity_discount_container;
        }
        return ((Integer) ipChange.ipc$dispatch("-1684940190", new Object[]{this})).intValue();
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (i == 6) {
            setDamaiUTKeyBuilder(kt2.i());
            c.e().K(this);
        } else if (i == 7) {
            setDamaiUTKeyBuilder(kt2.o());
        }
    }
