...
public class HorizontalCategoryAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private static transient /* synthetic */ IpChange $ipChange;
        private TextView a = ((TextView) this.itemView.findViewById(R$id.tv_category));
        private TextView b = ((TextView) this.itemView.findViewById(R$id.tv_num));
        private View c = this.itemView.findViewById(R$id.view_left);
        private View d = this.itemView.findViewById(R$id.view_right);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-833751337")) {
            return new ViewHolder();
        }
        return (ViewHolder) ipChange.ipc$dispatch("-833751337", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
    ...
    public void g(CategoryPerformBean categoryPerformBean) {
        ...
        } else if (categoryPerformBean != null && xf2.e(categoryPerformBean.statistics) > 0) {
            this.d = "0";
