...
public class OrderListBean implements Parcelable {
    ...
    public static final Parcelable.Creator<OrderListBean> CREATOR = new Parcelable.Creator<OrderListBean>() {
        /* class cn.damai.trade.newtradeorder.ui.orderlist.bean.OrderListBean.AnonymousClass1 */
        private static transient /* synthetic */ IpChange $ipChange;

        @Override // android.os.Parcelable.Creator
        public OrderListBean createFromParcel(Parcel parcel) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-208745909")) {
                return new OrderListBean(parcel);
            }
            return (OrderListBean) ipChange.ipc$dispatch("-208745909", new Object[]{this, parcel});
        }

        @Override // android.os.Parcelable.Creator
        public OrderListBean[] newArray(int i) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-1446788338")) {
                return new OrderListBean[i];
            }
            return (OrderListBean[]) ipChange.ipc$dispatch("-1446788338", new Object[]{this, Integer.valueOf(i)});
        }
    };
    ...
    public boolean isHNOrder() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "10863947")) {
            return this.orderType == 3;
        }
        return ((Boolean) ipChange.ipc$dispatch("10863947", new Object[]{this})).booleanValue();
    }
