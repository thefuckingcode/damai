...
public class WantSeeAvatarLayout2 extends ViewGroup {
    ...
    private void refresh() {
        ...
        removeAllViews();
        int i = 0;
        while (i < this.mAllUris.size() && i < 5) {
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-464479234")) {
            return new ViewGroup.MarginLayoutParams(getContext(), attributeSet);
        }
        return (ViewGroup.LayoutParams) ipChange.ipc$dispatch("-464479234", new Object[]{this, attributeSet});
    }
    ...
    public void append(String str, WantSeeAvatarListListener wantSeeAvatarListListener) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "422507522")) {
            ...
            c2.i(i).c(i).k(new cq()).g(imageView);
            addView(imageView);
