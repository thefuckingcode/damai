...
public class TicketGuideNoticeViewHolder extends RecyclerView.ViewHolder {
    ...
    private View a = this.itemView.findViewById(R$id.top_line);
    private TextView b = ((TextView) this.itemView.findViewById(R$id.tv_notice_title));
    private TextView c = ((TextView) this.itemView.findViewById(R$id.tv_notice_desc));
    private ImageView d = ((ImageView) this.itemView.findViewById(R$id.iv_notice_image));
    private DashedLine e = ((DashedLine) this.itemView.findViewById(R$id.bottom_line));
    private int f;
    private Context g;
    ...
    public class b implements DMImageCreator.DMImageSuccListener {
        ...
        public class a implements View.OnClickListener {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(b.this.a.imageUrl)) {
                    ...
                    DMNav.from(TicketGuideNoticeViewHolder.this.g).withExtras(bundle).toUri(gr.e());
                }
            }
        }
        ...
        public void onSuccess(DMImageCreator.e eVar) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "592657269")) {
                ...
                ticketGuideNoticeViewHolder.f(ticketGuideNoticeViewHolder.d, TicketGuideNoticeViewHolder.this.f, (int) ((((float) (drawable.getIntrinsicHeight() * TicketGuideNoticeViewHolder.this.f)) * 1.0f) / ((float) eVar.a.getIntrinsicWidth())));
    ...
    public void e(ProjectTickGuideNoticeBean projectTickGuideNoticeBean, boolean z, boolean z2, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "961410178")) {
            ...
            DMImageCreator g2 = cn.damai.common.image.a.b().g(projectTickGuideNoticeBean.imageUrl, b2);
            int i = R$drawable.uikit_default_image_bg_grey;
            g2.i(i).c(i).n(new b(projectTickGuideNoticeBean, str)).e(new a()).f();
        }
    }
}
