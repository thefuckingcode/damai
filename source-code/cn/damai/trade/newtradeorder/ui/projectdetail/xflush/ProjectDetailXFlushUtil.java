...
public class ProjectDetailXFlushUtil {
    ...
    private static String c(String str, String str2, String str3, String str4, String str5) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-610037385")) {
            return a.a().b(wk.PROJECT_DETAIL_PAGE).i().a(str3).j().e(str).j().f(str2).g(str4).j().h(str5).d().c();
        }
        return (String) ipChange.ipc$dispatch("-610037385", new Object[]{str, str2, str3, str4, str5});
    }
    ...
    private static String f(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1029256575")) {
            return wt1.c(str) ? "候鸟 " : "非候鸟 ";
        }
        return (String) ipChange.ipc$dispatch("1029256575", new Object[]{str});
    }

    private static boolean g(String str) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1135788231")) {
            return ((Boolean) ipChange.ipc$dispatch("-1135788231", new Object[]{str})).booleanValue();
        } else if ("MAPIE98015".equals(str) || oz0.FAIL_SYS_TRAFFIC_LIMIT.equals(str) || "ANDROID_SYS_NETWORK_ERROR".equals(str) || "FAIL_SYS_SERVICE_ERROR".equals(str)) {
            return true;
        } else {
            return false;
        }
    ...
    public static void h(String str, String str2, String str3, String str4, String str5) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-265847557")) {
            ipChange.ipc$dispatch("-265847557", new Object[]{str, str2, str3, str4, str5});
            return;
        }
        ...
        dr.INSTANCE.a().a(str).c(str3).d(str4).e(hashMap).g("商品详情页").j(ta.PROJECT_PAGE).f(false).b();
    }
    ...
    public static void i(String str, String str2, String str3) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-251486142")) {
            ...
            yz2.a(b(str2, str3, "mtop.damai.mxm.user.accesstoken.get", str), "-3200", "获取小蜜token错误");
        }
    }
    ...
    public static void j(String str, String str2, String str3) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1836894333")) {
            ...
            yz2.a(b(str2, str3, "mtop.damai.wireless.comment.module.get", str), "-3300", "讨论区接口加载失败");
        }
    }
    ...
    public static void k(String str, String str2, String str3) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1496832084")) {
            ...
            yz2.a(b(str2, str3, "mtop.damai.wireless.comment.module.get", str), "-3310", "评价接口加载失败");
        }
    }
    ...
    public static void l(String str, String str2, String str3) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "782436728")) {
            ...
            yz2.a(b(str2, str3, ApiConstant.API_NAME_RELATION_UPDATE, str), "-3210", "关注项目错误");
        }
    }
    ...
    public static void m(String str, String str2, String str3, String str4, String str5) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1313468451")) {
            ...
            yz2.a(c(str3, str4, str, str2, str5), "-3000", e(str2));
        }
    }
    ...
    public static void n(String str, String str2, String str3) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-178652161")) {
            ...
            yz2.a(d(str, str2, str3), "-3001", "项目海报图加载失败");
        }
    }
    ...
    public static void o(String str, String str2, String str3, String str4, String str5) {
        ...
        yz2.a(a(str, str2, str3, str4, str5), "-3002", "详情页业务错误");
    }
