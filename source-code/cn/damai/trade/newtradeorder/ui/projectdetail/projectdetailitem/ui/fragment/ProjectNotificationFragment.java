...
public class ProjectNotificationFragment extends DamaiBaseMvpFragment {
    ...
    private void openZoomImageActivity() {
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1465055351")) {
            return R$layout.project_item_pop_notification_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("-1465055351", new Object[]{this})).intValue();
    }
