...
public class ProjectTourAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "2052874236")) {
            return xf2.e(this.b);
        }
        return ((Integer) ipChange.ipc$dispatch("2052874236", new Object[]{this})).intValue();
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1740302467")) {
            ...
            ln2.r().i2(viewHolder.itemView, this.c, i);
        }
    }
