...
public class AutoFitTextView extends TextView implements AutoFitHelper.OnTextSizeChangeListener {
    ...
    public AutoFitHelper getAutofitHelper() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1599717144")) {
            return this.mHelper;
        }
        return (AutoFitHelper) ipChange.ipc$dispatch("1599717144", new Object[]{this});
    }

    public float getMaxTextSize() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1107692849")) {
            return this.mHelper.j();
        }
        return ((Float) ipChange.ipc$dispatch("-1107692849", new Object[]{this})).floatValue();
    }

    public float getMinTextSize() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-450776799")) {
            return this.mHelper.k();
        }
        return ((Float) ipChange.ipc$dispatch("-450776799", new Object[]{this})).floatValue();
    }

    public float getPrecision() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1929113123")) {
            return this.mHelper.l();
        }
        return ((Float) ipChange.ipc$dispatch("1929113123", new Object[]{this})).floatValue();
    }
