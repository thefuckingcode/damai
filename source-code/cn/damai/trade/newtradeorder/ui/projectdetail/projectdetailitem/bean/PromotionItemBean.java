...
public class PromotionItemBean implements Serializable {
    ...
    private void addTags(ViewGroup viewGroup, FlowLayout flowLayout) {
        ...
        for (MarketTagBean marketTagBean : this.contentList) {
            if (isVip()) {
                ...
                ((ViewGroup.MarginLayoutParams) layoutParams).height = v50.a(viewGroup.getContext(), 15.0f);
            }
            layoutParams.setMarginEnd(v50.a(viewGroup.getContext(), 3.0f));
            layoutParams.setMargins(0, 0, 0, v50.a(viewGroup.getContext(), 2.5f));
        }
    }
    ...
    private TextView getColorTextTag(MarketTagBean marketTagBean, Context context) {
        ...
        textView.setPadding(v50.a(context, 2.0f), 0, v50.a(context, 2.0f), 0);
    ...
    private TextView getTextTag(String str, Context context) {
        ...
        textView.setLineSpacing((float) v50.a(context, 4.0f), 1.0f);
        return textView;
    }
    ...
    public boolean hasCoupon() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-314662325")) {
            return isVip() || BQCScanEngine.COUPON_ENGINE.equalsIgnoreCase(this.type);
        }
        return ((Boolean) ipChange.ipc$dispatch("-314662325", new Object[]{this})).booleanValue();
    }

    public boolean isVip() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1599431880")) {
            return "vip".equalsIgnoreCase(this.type);
        }
        return ((Boolean) ipChange.ipc$dispatch("-1599431880", new Object[]{this})).booleanValue();
    }

    public boolean isWednesdayDiscount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1583284574")) {
            return "WED_HALF_PRICE".equals(this.type);
        }
        return ((Boolean) ipChange.ipc$dispatch("1583284574", new Object[]{this})).booleanValue();
    }
}
