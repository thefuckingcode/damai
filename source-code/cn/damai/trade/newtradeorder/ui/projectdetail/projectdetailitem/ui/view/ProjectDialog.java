...
public class ProjectDialog extends Dialog implements Runnable {
    ...
    private void enableClickConfirm() {
        IpChange ipChange = $ipChange;
    ...
    public boolean isScrollBottom() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1113814326")) {
            return this.isScorllBottom;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1113814326", new Object[]{this})).booleanValue();
    }
    ...
    public void run() {
        ...
        if (textView != null) {
            ...
            if (i >= 0) {
                this.mCountTime = i - 1;
                this.mCountDownHandler.postDelayed(this, 1000);
                return;
            }
