...
public class AutoFitLayout extends FrameLayout {
    ...
    public AutoFitHelper getAutofitHelper(TextView textView) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2063596290")) {
            return this.mHelpers.get(textView);
        }
        return (AutoFitHelper) ipChange.ipc$dispatch("2063596290", new Object[]{this, textView});
    }

    public AutoFitHelper getAutofitHelper(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2030961921")) {
            return this.mHelpers.get(getChildAt(i));
        }
        return (AutoFitHelper) ipChange.ipc$dispatch("2030961921", new Object[]{this, Integer.valueOf(i)});
    }
