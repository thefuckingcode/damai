...
public class ProjectNoticePromptViewHolder extends RecyclerView.ViewHolder {
    ...
    private void c() {
        ...
        this.itemView.setOnClickListener(new du1(this));
    }
    ...
    public void b(ProjectDataHolder projectDataHolder) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-250088802")) {
            ...
            if (!isTicketNoteEndPos) {
                ...
                view2.setPadding(view2.getPaddingLeft(), this.itemView.getPaddingTop(), this.itemView.getPaddingRight(), v50.a(this.a, 15.0f));
            }
            String str = "";
            if (ticketNote != null) {
            ...
            if (ticketNote2rd != null) {
                ...
                this.d.setText(!TextUtils.isEmpty(ticketNote2rd.getTitle()) ? ticketNote2rd.getTitle() : str);
                TextView textView3 = this.e;
                if (!TextUtils.isEmpty(ticketNote2rd.getContent())) {
                    str = ticketNote2rd.getContent();
                }
