...
public class DiscoverItemHolder extends RecyclerView.ViewHolder {
    ...
    private ImageView c = ((ImageView) this.itemView.findViewById(R$id.image_pic));
    private ImageView d = ((ImageView) this.itemView.findViewById(R$id.image_video));
    private TextView e = ((TextView) this.itemView.findViewById(R$id.tv_title));
    private ImageView f = ((ImageView) this.itemView.findViewById(R$id.image_head));
    private TextView g = ((TextView) this.itemView.findViewById(R$id.tv_desc));
    private View h = this.itemView.findViewById(R$id.image_head_layout);
