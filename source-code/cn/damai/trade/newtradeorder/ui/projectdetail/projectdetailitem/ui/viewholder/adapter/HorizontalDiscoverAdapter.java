...
public class HorizontalDiscoverAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "834326935")) {
            ...
            ln2.r().j(viewHolder.itemView, this.d, inFieldCommentsBean, i);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1759007295")) {
            return new DiscoverItemHolder(LayoutInflater.from(this.a));
        }
        return (RecyclerView.ViewHolder) ipChange.ipc$dispatch("1759007295", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
}
