...
public class ProjectBrandSingleViewHolder extends RecyclerView.ViewHolder {
    ...
    private Context a;
    private RelativeLayout b = ((RelativeLayout) this.itemView.findViewById(R$id.rl_project_detail_brand_area));
    ...
    private ArrayList<BaseLayer> b(BrandAndArtists brandAndArtists) {
        ...
        if (brandAndArtists != null) {
            ...
            jSONObject2.put("usercode", (Object) d20.i());
            baseSection.setTrackInfoBeta(jSONObject2);
            baseSection.getTrackInfo().trackB = ta.PROJECT_PAGE;
    ...
    public void a(ProjectDataHolder projectDataHolder, vv2 vv2) {
        BrandAndArtists brandAndArtists;
        LinearLayout c;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1816810366")) {
            ipChange.ipc$dispatch("1816810366", new Object[]{this, projectDataHolder, vv2});
        } else if (projectDataHolder != null && (brandAndArtists = projectDataHolder.brandOrArtists) != null && vv2 != null && (c = vv2.c(b(brandAndArtists), (ViewGroup) this.itemView)) != null) {
