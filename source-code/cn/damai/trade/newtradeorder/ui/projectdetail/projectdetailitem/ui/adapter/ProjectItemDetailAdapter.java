...
public class ProjectItemDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProjectItemDetailAdapter(ProjectDetailActivity projectDetailActivity, long j2) {
    ...
    public List<ProjectDataHolder> b() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1696995461")) {
            return this.a;
        }
        return (List) ipChange.ipc$dispatch("-1696995461", new Object[]{this});
    }
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1485313872")) {
            return xf2.e(this.a);
        }
        return ((Integer) ipChange.ipc$dispatch("1485313872", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1596516855")) {
            return this.a.get(i2).getModuleType();
        }
        return ((Integer) ipChange.ipc$dispatch("1596516855", new Object[]{this, Integer.valueOf(i2)})).intValue();
    }
    ...
    public void m(vv2 vv2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1209096537")) {
            ipChange.ipc$dispatch("-1209096537", new Object[]{this, vv2});
            return;
        }
        this.c = vv2;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-757482583")) {
            ipChange.ipc$dispatch("-757482583", new Object[]{this, viewHolder, Integer.valueOf(i2)});
            return;
        }
        ProjectDataHolder projectDataHolder = this.a.get(i2);
            ...
            if (moduleType == 0) {
                ...
                switch (moduleType) {
                    ...
                    case 4:
                        ...
                        return;
                    case 5:
                        ((ProjectRecommendViewHolder) viewHolder).D(projectDataHolder);
                        return;
                    case 6:
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1824292973")) {
            return (RecyclerView.ViewHolder) ipChange.ipc$dispatch("1824292973", new Object[]{this, viewGroup, Integer.valueOf(i2)});
        }
        switch (i2) {
            case 0:
