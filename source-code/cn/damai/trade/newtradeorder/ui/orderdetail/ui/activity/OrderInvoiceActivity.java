...
public class OrderInvoiceActivity extends DamaiBaseActivity<OrderInvoicePresenter, OrderInvoiceContract.Model> implements OrderInvoiceContract.View {
    ...
    private l21 mInvoiceHeaderViewHolder;
    ...
    private void showInvoiceContent(List<InvoiceTitleInfo> list, List<AddressBean> list2, List<InvoicesTrans> list3, String str) {
        ...
        l21 l21 = new l21(this, this.mInvoiceTitleLayout, this.mInflater);
        this.mInvoiceHeaderViewHolder = l21;
        l21.e(list);
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2126366406")) {
            return R$layout.activity_order_invoice;
        }
        return ((Integer) ipChange.ipc$dispatch("-2126366406", new Object[]{this})).intValue();
    }
    ...
    public void requestInvoiceSubmit() {
        ...
        l21 l21 = this.mInvoiceHeaderViewHolder;
        if (l21 == null) {
            resetSubmitBtn();
            return;
        }
        ...
        if (d != 1) {
            ...
            if (xf2.j(this.mInvoiceTitleStr) || xf2.j(this.mInvoiceTaxNumStr)) {
                ToastUtil.i("请输入发票信息");
                resetSubmitBtn();
                return;
            }
        ...
        if (k.equals("2")) {
            ...
            if (xf2.j(this.mInvoiceUserName)) {
                ToastUtil.i("请输入取票人姓名");
                resetSubmitBtn();
                return;
            } else if (xf2.j(this.mInvoicePhone)) {
                ToastUtil.i("请输入手机");
                resetSubmitBtn();
                return;
            } else {
            ...
            if (!(invoiceAddBean == null || xf2.e(invoiceAddBean.pay) <= 0 || (invoicePayInfo = this.mInvoiceBean.pay.get(0)) == null)) {
    ...
    public void returnInvoiceInfo(InvoiceAddInfo invoiceAddInfo) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1875819383")) {
            ...
            int e = xf2.e(invoiceAddBean.trans);
            if (xf2.e(this.mInvoiceBean.invoice) == 0 || e == 0) {
                returnInvoiceInfoError(this.mErrorCode, invoiceAddInfo.error);
                return;
            }
            int i = 0;
    ...
    public void returnInvoiceInfoError(String str, String str2) {
        ...
        an1.d(OrderDetailConstantsApi.API_ZL_ORDER_INVOICE_INFO, str, str2, "projectId:" + this.mProjectId + ",orderId:" + this.mOrderId + ",fromWhere:发票渲染接口失败");
    }
    ...
    public void returnSubmitInvoiceError(String str, String str2) {
        ...
        ToastUtil.i(str2);
        an1.d(OrderDetailConstantsApi.API_ZL_ORDER_INVOICE_SUBMIT, str, str2, "projectId:" + this.mProjectId + ",orderId:" + this.mOrderId + ",fromWhere:发票提交信息接口失败");
    }
    ...
    public void returnSubmitInvoiceInfo(InvoiceSubmitResult invoiceSubmitResult) {
        ...
        if (invoiceSubmitResult.os) {
            ...
            if (!this.mSelectDeliveryType.equals("1")) {
                setResult(-1);
                finish();
            } else if (xf2.j(invoiceSubmitResult.payParm)) {
    ...
    public String setTitle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1932365266")) {
            return "大麦订单";
        }
        return (String) ipChange.ipc$dispatch("-1932365266", new Object[]{this});
    }
