...
public class OrderDetailProgressViewHolder extends RecyclerView.ViewHolder {
    ...
    private View a = this.itemView.findViewById(R$id.oval);
    private DMIconFontTextView b = ((DMIconFontTextView) this.itemView.findViewById(R$id.icon_oval));
    private View c = this.itemView.findViewById(R$id.line);
    private LinearLayout d = ((LinearLayout) this.itemView.findViewById(R$id.ll_progress_container));
    private TextView e = ((TextView) this.itemView.findViewById(R$id.tv_nodeName));
    private LinearLayout f = ((LinearLayout) this.itemView.findViewById(R$id.ll_progress));
    private Context g;
    ...
    public void a(OrderDetailProgressBean orderDetailProgressBean, boolean z) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-123298735")) {
            ...
            int e2 = xf2.e(orderDetailProgressBean.orderProgressItems);
            if (e2 > 0 || !TextUtils.isEmpty(orderDetailProgressBean.nodeName)) {
