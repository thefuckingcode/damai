...
public class OrderDetailTicketViewHolder extends RecyclerView.ViewHolder {
    ...
    private FlowLayout a = ((FlowLayout) this.itemView.findViewById(R$id.fl_ticket_service));
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (tag != null) {
                br.c(mm1.NOTIFY_JUMP_TICKET_SERVICE, tag);
            }
        }
    }
    ...
    private View a(OrderDetailTicketServiceTitle orderDetailTicketServiceTitle) {
        ...
        } else if (orderDetailTicketServiceTitle == null) {
            return null;
        } else {
