...
public class OrderInvoiceDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-393946042")) {
            return xf2.e(this.b);
        }
        return ((Integer) ipChange.ipc$dispatch("-393946042", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1756251117")) {
            return this.b.get(i).type;
        }
        return ((Integer) ipChange.ipc$dispatch("1756251117", new Object[]{this, Integer.valueOf(i)})).intValue();
    }
