...
public class HnOrderInvoiceTitleTypeFragment extends DamaiBaseMvpFragment {
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1385024871")) {
            return R$layout.fragment_hn_invoice_title;
        }
        return ((Integer) ipChange.ipc$dispatch("-1385024871", new Object[]{this})).intValue();
    }
