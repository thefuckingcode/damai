...
public class OrderDetailMecItemInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<OrderDetailMecItemInfo> CREATOR = new Parcelable.Creator<OrderDetailMecItemInfo>() {
        /* class cn.damai.trade.newtradeorder.ui.orderdetail.bean.OrderDetailMecItemInfo.AnonymousClass1 */
        private static transient /* synthetic */ IpChange $ipChange;

        @Override // android.os.Parcelable.Creator
        public OrderDetailMecItemInfo createFromParcel(Parcel parcel) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "569696939")) {
                return new OrderDetailMecItemInfo(parcel);
            }
            return (OrderDetailMecItemInfo) ipChange.ipc$dispatch("569696939", new Object[]{this, parcel});
        }

        @Override // android.os.Parcelable.Creator
        public OrderDetailMecItemInfo[] newArray(int i) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "872934736")) {
                return new OrderDetailMecItemInfo[i];
            }
            return (OrderDetailMecItemInfo[]) ipChange.ipc$dispatch("872934736", new Object[]{this, Integer.valueOf(i)});
        }
    };
    ...
    public boolean isChangeTime() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "481836678")) {
            return this.oldShowDateTime != 0;
        }
        return ((Boolean) ipChange.ipc$dispatch("481836678", new Object[]{this})).booleanValue();
    }

    public boolean isTimeValid() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-712127520")) {
            return this.showDateTime != 0;
        }
        return ((Boolean) ipChange.ipc$dispatch("-712127520", new Object[]{this})).booleanValue();
    }
