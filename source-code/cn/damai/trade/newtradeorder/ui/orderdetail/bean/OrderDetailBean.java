...
public class OrderDetailBean implements Parcelable {
    ...
    public static final Parcelable.Creator<OrderDetailBean> CREATOR = new Parcelable.Creator<OrderDetailBean>() {
        /* class cn.damai.trade.newtradeorder.ui.orderdetail.bean.OrderDetailBean.AnonymousClass1 */
        private static transient /* synthetic */ IpChange $ipChange;

        @Override // android.os.Parcelable.Creator
        public OrderDetailBean createFromParcel(Parcel parcel) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "416542795")) {
                return new OrderDetailBean(parcel);
            }
            return (OrderDetailBean) ipChange.ipc$dispatch("416542795", new Object[]{this, parcel});
        }

        @Override // android.os.Parcelable.Creator
        public OrderDetailBean[] newArray(int i) {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-792037170")) {
                return new OrderDetailBean[i];
            }
            return (OrderDetailBean[]) ipChange.ipc$dispatch("-792037170", new Object[]{this, Integer.valueOf(i)});
        }
    };
    ...
    public boolean isHouNiaoOrder() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1791687656")) {
            return this.orderSource == 3;
        }
        return ((Boolean) ipChange.ipc$dispatch("1791687656", new Object[]{this})).booleanValue();
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeByte(this.isSupportInvoice ? (byte) 1 : 0);
