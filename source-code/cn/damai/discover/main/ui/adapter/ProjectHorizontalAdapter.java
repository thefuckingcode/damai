    ...
    public class PVh extends BaseViewHolder<ProjectItemBean> implements View.OnClickListener {
        ...
        public void a(ProjectItemBean projectItemBean, int i2) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-1565358128")) {
                ipChange.ipc$dispatch("-1565358128", new Object[]{this, projectItemBean, Integer.valueOf(i2)});
                return;
            }
            ...
            DMImageCreator f2 = a.b().f(projectItemBean.verticalPic, ProjectHorizontalAdapter.this.e, ProjectHorizontalAdapter.this.f);
