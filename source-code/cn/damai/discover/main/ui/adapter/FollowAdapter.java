...
public class FollowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "403488568")) {
            return xf2.e(this.d);
        }
        return ((Integer) ipChange.ipc$dispatch("403488568", new Object[]{this})).intValue();
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "2112946881")) {
            ...
            f81.m(peopleItemHolder.itemView, i, followRecommendBean.userInfo.id);
        }
    }
