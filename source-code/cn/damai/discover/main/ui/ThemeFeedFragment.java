...
public class ThemeFeedFragment extends Fragment implements UpLoadMorePanel.LoadMoreEventListener {
    ...
    public class a extends v3 {
        ...
        public void utNoteClick(NoteBean noteBean, int i) {
            ...
            za.j(ThemeFeedFragment.this.mUt.z(i, noteBean.baseUserDO.havanaIdStr, ThemeFeedFragment.this.mIndex, noteBean.id));
        }
    }
    ...
    private void initView() {
        ...
        this.mItemViewPadding = n42.a(this.mActivity, 6.0f);
        this.mWaterfallRev.setLayoutManager(new StaggeredGridLayoutManager(2, 1));
        this.mWaterfallRev.addItemDecoration(new RecyclerView.ItemDecoration() {
            /* class cn.damai.discover.main.ui.ThemeFeedFragment.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.recyclerview.widget.RecyclerView.ItemDecoration
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-15679834")) {
                    ipChange.ipc$dispatch("-15679834", new Object[]{this, rect, view, recyclerView, state});
                    return;
                }
        ...
        TopicAdapter topicAdapter = new TopicAdapter(themeActivity, this.mIndex, new t3(themeActivity, new a()));
    ...
    public void setUt(kk2 kk2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "2125113945")) {
            ipChange.ipc$dispatch("2125113945", new Object[]{this, kk2});
            return;
        }
        this.mUt = kk2;
    }
