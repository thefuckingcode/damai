...
public class WantToSeeFragment extends Fragment implements OnLoadMoreListener {
    ...
    private void initView() {
        ...
        this.mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            /* class cn.damai.discover.main.ui.WantToSeeFragment.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.viewpager.widget.ViewPager.OnPageChangeListener
            public void onPageScrollStateChanged(int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "12992879")) {
                    ipChange.ipc$dispatch("12992879", new Object[]{this, Integer.valueOf(i)});
                }
            }
            ...
            public void onPageScrolled(int i, float f, int i2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1364153074")) {
                    ipChange.ipc$dispatch("-1364153074", new Object[]{this, Integer.valueOf(i), Float.valueOf(f), Integer.valueOf(i2)});
                }
            }
            ...
            public void onPageSelected(int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-801812614")) {
                    ipChange.ipc$dispatch("-801812614", new Object[]{this, Integer.valueOf(i)});
                    return;
                }
