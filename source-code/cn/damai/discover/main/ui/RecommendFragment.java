...
public class RecommendFragment extends AbsFragmentV2 implements PtrChildHandler, OnActivityResultListener {
    ...
    private qv1 mHandler = new c(this);
    ...
    public class a implements OnBizListener<PageData<BaseResponse>> {
        ...
        /* compiled from: Taobao */
        public class C0022a implements OnErrClickListener {
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        public void onBizSuccess(PageData<BaseResponse> pageData) {
            ...
            RecommendFragment.this.hideErrView();
            RecommendFragment.this.setData((BaseResponse) pageData.data);
            if (pageData.hasMore) {
        ...
        public void onBizFail(String str, String str2) {
            ...
            RecommendFragment.this.showErrView(str, str2, new C0022a());
        }
    }
    ...
    public class d implements OnBizListener<BaseResponse> {
        ...
        public void onBizSuccess(BaseResponse baseResponse) {
            ...
            this.a.onRefreshSuccess(u80.e(baseResponse));
    ...
    private void loadPage(@Nullable OnBizListener<BaseResponse> onBizListener) {
        IpChange ipChange = $ipChange;
    ...
    private void setUpWaterFallView() {
        ...
        this.mTopPadding = n42.a(this.mActivity, 10.0f);
        this.mRecyclerView.addItemDecoration(new RecyclerView.ItemDecoration() {
            /* class cn.damai.discover.main.ui.RecommendFragment.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.recyclerview.widget.RecyclerView.ItemDecoration
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1440859611")) {
                    ipChange.ipc$dispatch("1440859611", new Object[]{this, rect, view, recyclerView, state});
                    return;
                }
        ...
        this.mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            /* class cn.damai.discover.main.ui.RecommendFragment.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-994529285")) {
                    ipChange.ipc$dispatch("-994529285", new Object[]{this, recyclerView, Integer.valueOf(i), Integer.valueOf(i2)});
                } else if (RecommendFragment.this.mOverPageListener != null) {
                    RecommendFragment.this.mOverPageListener.onOverPage(u80.h(recyclerView));
                }
            }
        });
    }
    ...
    public boolean checkCanDoRefresh(PtrFrameLayout ptrFrameLayout, View view, View view2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "489478953")) {
            return this.isViewCreated && isAdded() && this.mHandler.checkCanDoRefresh(ptrFrameLayout, this.mRecyclerView, view2);
        }
        return ((Boolean) ipChange.ipc$dispatch("489478953", new Object[]{this, ptrFrameLayout, view, view2})).booleanValue();
    }
