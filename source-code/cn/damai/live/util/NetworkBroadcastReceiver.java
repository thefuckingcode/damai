...
public class NetworkBroadcastReceiver extends BroadcastReceiver {
    ...
    private boolean a() {
        ...
        if (this.c) {
            ...
            if (SystemClock.elapsedRealtime() - this.d < DanmakuFactory.DEFAULT_DANMAKU_DURATION_V) {
                g91.b("NetworkBroadcastReceiver", "短时间内首次回调,认为无效");
                return true;
            }
        }
        return false;
    ...
    public void b() {
        ...
        g91.b("NetworkBroadcastReceiver", "registerNetworkChangeBroadcast");
        try {
    ...
    public void d() {
        ...
        g91.b("NetworkBroadcastReceiver", "unRegisterNetworkChangeBroadcast");
        try {
