...
public class DMWXShareModule extends WXModule implements Destroyable {
    ...
    private FissionParam getFissionParam(JSONObject jSONObject) {
        ...
        try {
            return (FissionParam) s41.a(jSONObject.toJSONString(), FissionParam.class);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    private String getParam(JSONObject jSONObject, String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1821554721")) {
            return (jSONObject == null || jSONObject.get(str) == null) ? "" : jSONObject.get(str).toString();
        }
        return (String) ipChange.ipc$dispatch("-1821554721", new Object[]{this, jSONObject, str});
    }
    ...
    public void share(JSONObject jSONObject, JSCallback jSCallback) {
        ...
        if (!xf2.j(getParam(jSONObject, "plugins")) && (jSONArray = jSONObject.getJSONArray("plugins")) != null && jSONArray.size() > 0) {
