...
public class TickletFaceUnbindDialogView extends LinearLayout {
    ...
    public TickletFaceUnbindDialogView(Context context2) {
        this(context2, null);
    }
    ...
    public TickletFaceUnbindDialogView(Context context2, AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public TickletFaceUnbindDialogView(Context context2, AttributeSet attributeSet, int i) {
