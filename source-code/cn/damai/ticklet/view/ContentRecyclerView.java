...
public class ContentRecyclerView extends RecyclerView {
    ...
    public ContentRecyclerView(Context context) {
        super(context);
        CompositeScrollListener compositeScrollListener2 = new CompositeScrollListener(this, null);
        this.compositeScrollListener = compositeScrollListener2;
        super.addOnScrollListener(compositeScrollListener2);
