...
public class TickletSouvenirClassicsView extends RelativeLayout {
    ...
    public class a implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            ...
            if (TickletSouvenirClassicsView.this.souvenir_divider.getBottom() != 0 && TickletSouvenirClassicsView.this.HoleCardView.getBottom() != 0) {
                TickletSouvenirClassicsView.this.HoleCardView.setScallopPositionPercent((float) ((((double) TickletSouvenirClassicsView.this.souvenir_divider.getBottom()) * 100.0d) / ((double) TickletSouvenirClassicsView.this.HoleCardView.getBottom())));
            }
        }
    }
    ...
    public TickletSouvenirClassicsView(Context context2) {
        this(context2, null);
    }
    ...
    private int[] getColor(int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1071650138")) {
            return (int[]) ipChange.ipc$dispatch("-1071650138", new Object[]{this, Integer.valueOf(i)});
        }
        return new int[]{i, lw2.f().d(0.6f, i), lw2.f().d(0.4f, i), lw2.f().d(0.8f, i), i, i};
    }
    ...
    public void setPriceShow(String str, int i, boolean z) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1006301257")) {
            ...
            if (z) {
                ...
                this.souvenir_ticklet_total_price.setPadding(0, v50.a(this.context, 4.0f), 0, 0);
            }
            this.souvenir_ticklet_total_price.setTextSize(1, (float) i);
    ...
    public void setUserInfo(String str, boolean z, boolean z2, String str2) {
        ...
        if (z) {
            ...
            this.cb_user_name.setPadding(0, v50.a(this.context, 4.0f), 0, 0);
        } else {
    ...
    public void update(TicketSouvenirBean ticketSouvenirBean, int i, int i2, int i3) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1806543127")) {
            ...
            lw2.E(this.souvenir_share_no, ticketSouvenirBean.shareNo);
            this.souvenir_ticklet_total_price.setVisibility(0);
            ...
            lw2.E(this.souvenir_seat_no, ticketSouvenirBean.allSeatText);
            int i4 = i / 2;
            ...
            lw2.E(this.souvenir_time, ticketSouvenirBean.beginTimeStr);
            lw2.E(this.souvenir_address, ticketSouvenirBean.venueName);
            lw2.E(this.souvenir_project_name, ticketSouvenirBean.projectName);
            lw2.E(this.souvenir_damai_congratulation, ticketSouvenirBean.text);
            ...
            if ("1".equals(ticketSouvenirBean.vip)) {
                this.cb_user_icon.setAvatarCrownVisibility(0);
                this.cb_user_icon.setAvatarBorderVisibility(0);
                lw2.r(this.cb_vip_icon, ticketSouvenirBean.vipLevelIcon);
            } else {
                this.cb_vip_icon.setVisibility(8);
                this.cb_user_icon.setAvatarCrownVisibility(8);
                this.cb_user_icon.setAvatarBorderVisibility(8);
    ...
    public TickletSouvenirClassicsView(Context context2, AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public TickletSouvenirClassicsView(Context context2, AttributeSet attributeSet, int i) {
