...
public class TickletTransferShareItemView extends RelativeLayout {
    ...
    public TickletTransferShareItemView(Context context2) {
        this(context2, null);
    }
    ...
    public void update(boolean z, String str, String str2, String str3, View.OnClickListener onClickListener) {
        ...
        lw2.E(this.ticklet_tip_text, str3);
    ...
    public TickletTransferShareItemView(Context context2, @Nullable AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public TickletTransferShareItemView(Context context2, @Nullable AttributeSet attributeSet, int i) {
