...
public class TickletTransferConfirmDialogView extends LinearLayout {
    ...
    private void setParam() {
        ...
        if (this.tvTip.getText().length() > 420) {
            layoutParams = new LinearLayout.LayoutParams(-1, DisplayMetrics.getheightPixels(v50.b(this.mContent)) - v50.a(this.mContent, 120.0f));
        } else {
