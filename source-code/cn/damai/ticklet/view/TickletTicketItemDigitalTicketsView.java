...
public class TickletTicketItemDigitalTicketsView extends LinearLayout implements View.OnClickListener {
    ...
    public TickletTicketItemDigitalTicketsView(Context context2) {
        this(context2, null);
    }
    ...
    private void startAnimation(View view) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1361507940")) {
            ...
            if (this.frontAnim == null) {
                float width = ((float) this.views[0].getWidth()) / 2.0f;
                float height = ((float) this.views[0].getHeight()) / 2.0f;
                ...
                rotate3dAnimation.setDuration((long) ANIM_DURATION);
                ...
                rotate3dAnimation2.setDuration((long) ANIM_DURATION);
    ...
    private void upTranslateView(int i) {
        IpChange ipChange = $ipChange;
    ...
    public TextView getTipTv() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "244056509")) {
            return this.ticketAreaLayout.getTipTv();
        }
        return (TextView) ipChange.ipc$dispatch("244056509", new Object[]{this});
    }
    ...
    public void onClick(View view) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1710133855")) {
            ...
            if (tickletTicketCallback != null && (i2 = this.mPosition) > 0) {
                tickletTicketCallback.viewPageSlide(i2 - 1);
            ...
            if (tickletTicketCallback2 != null && this.mTotal - 1 > (i = this.mPosition)) {
            ...
            e.x(instance.e(sl2.TICKLET_DETAIL_PAGE, "nft", "reverse_" + this.mPosition, hashMap, Boolean.FALSE));
            startAnimation(view);
        }
    }
    ...
    public void setShowType(int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-819987582")) {
            ...
            if (i != 0 || !this.mTicketTable.isNftTicket()) {
                lw2.F(this.ticketAreaLayout);
                lw2.w(this.nftAreaLayout);
            } else {
                lw2.F(this.nftAreaLayout);
                lw2.w(this.ticketAreaLayout);
            }
            this.index = i;
            SHOW_TYPE = i;
            upTranslateView(i);
    ...
    public void update(UserTicketTable userTicketTable, TickletExtraInfo tickletExtraInfo, TicketDeatilResult ticketDeatilResult, int i, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-217128434")) {
            ...
            if (this.mTicketTable.isNftTicket()) {
                ...
                lw2.F(this.translateLayout);
            } else {
                lw2.F(this.ticketAreaLayout);
                lw2.w(this.nftAreaLayout);
                lw2.w(this.translateLayout);
            }
    ...
    public TickletTicketItemDigitalTicketsView(Context context2, AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public TickletTicketItemDigitalTicketsView(Context context2, AttributeSet attributeSet, int i) {
