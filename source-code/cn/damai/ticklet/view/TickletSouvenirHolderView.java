...
public class TickletSouvenirHolderView extends RelativeLayout {
    ...
    public TickletSouvenirHolderView(Context context2) {
        this(context2, null);
    }
    ...
    public TickletSouvenirHolderView(Context context2, AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public TickletSouvenirHolderView(Context context2, AttributeSet attributeSet, int i) {
