...
public class TickletWebDialog extends RelativeLayout implements ResponseErrorPage.ErrorRefreshListener {
    ...
    public class TickletWebDialogWebViewClient extends WVUCWebViewClient {
        ...
        public void onPageFinished(WebView webView, String str) {
            ...
            new Handler().postDelayed(new Runnable() {
                /* class cn.damai.ticklet.view.TickletWebDialog.TickletWebDialogWebViewClient.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void run() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-851202305")) {
                        ipChange.ipc$dispatch("-851202305", new Object[]{this});
                        return;
                    }
    ...
    private void setParam() {
        ...
        setLayoutParams(new RelativeLayout.LayoutParams(-1, DisplayMetrics.getheightPixels(v50.b(this.ctx)) - v50.a(this.ctx, 120.0f)));
    }
