...
public class TickletSouvenIrCustomView extends LinearLayout {
    ...
    public TickletSouvenIrCustomView(Context context2) {
        this(context2, null);
    }
    ...
    public boolean isCheck() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-247279122")) {
            return this.isCheck;
        }
        return ((Boolean) ipChange.ipc$dispatch("-247279122", new Object[]{this})).booleanValue();
    }
    ...
    public TickletSouvenIrCustomView(Context context2, @Nullable AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public TickletSouvenIrCustomView(Context context2, @Nullable AttributeSet attributeSet, int i) {
