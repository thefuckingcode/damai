...
public class TickletTicketHeadView extends RelativeLayout implements View.OnClickListener {
    ...
    public TickletTicketHeadView(Context context2) {
        this(context2, null);
    }
    ...
    public String getViewType() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1949191303")) {
            return this.viewType;
        }
        return (String) ipChange.ipc$dispatch("-1949191303", new Object[]{this});
    }
    ...
    public void update(UserTicketTable userTicketTable, int i, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1162939080")) {
            ...
            if (userTicketTable.isCouponTicket()) {
                lw2.f();
                lw2.v(this.tv_ticket_unit);
            } else {
                lw2.f();
                lw2.F(this.tv_ticket_unit);
            }
            if (!gl2.TICKLET_TICKET_VIEW_FLOAT_LAYER.equals(getViewType()) && this.ll_forget_card != null) {
    ...
    public TickletTicketHeadView(Context context2, AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public TickletTicketHeadView(Context context2, AttributeSet attributeSet, int i) {
