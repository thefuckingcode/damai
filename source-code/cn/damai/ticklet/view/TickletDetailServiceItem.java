...
public class TickletDetailServiceItem extends RelativeLayout {
    ...
    public TickletDetailServiceItem(Context context2) {
        this(context2, null);
    }
    ...
    public void update(String str, int i, View.OnClickListener onClickListener) {
        ...
        lw2.E(this.ticklet_detail_service_item_title, str);
        if (i != 0) {
    ...
    public TickletDetailServiceItem(Context context2, @Nullable AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public TickletDetailServiceItem(Context context2, @Nullable AttributeSet attributeSet, int i) {
