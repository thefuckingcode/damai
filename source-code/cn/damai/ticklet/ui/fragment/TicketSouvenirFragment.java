...
public class TicketSouvenirFragment extends DamaiBaseMvpFragment {
    ...
    private void addLiveDataObserver() {
        ...
        this.mViewModel.mSouvenirLiveData.observe(this, new Observer<TicketSouvenirDetail>() {
            /* class cn.damai.ticklet.ui.fragment.TicketSouvenirFragment.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onChanged(@Nullable TicketSouvenirDetail ticketSouvenirDetail) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-381017856")) {
                    ipChange.ipc$dispatch("-381017856", new Object[]{this, ticketSouvenirDetail});
                    return;
                }
        ...
        this.mViewModel.mNetLiveData.observe(this, new Observer<String>() {
            /* class cn.damai.ticklet.ui.fragment.TicketSouvenirFragment.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onChanged(@Nullable String str) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "178316537")) {
                    ipChange.ipc$dispatch("178316537", new Object[]{this, str});
                    return;
                }
                TicketSouvenirFragment.this.stopProgressDialog();
                TicketSouvenirFragment.this.mErrorView.setVisibility(0);
    ...
    private TicketSouvenirViewModel obtainViewModel() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "925249562")) {
            return (TicketSouvenirViewModel) ViewModelProviders.of(this, new ViewModelProvider.Factory() {
                /* class cn.damai.ticklet.ui.fragment.TicketSouvenirFragment.AnonymousClass3 */
                private static transient /* synthetic */ IpChange $ipChange;
                ...
                public <T extends ViewModel> T create(@NonNull Class<T> cls) {
                    IpChange ipChange = $ipChange;
                    if (!AndroidInstantRuntime.support(ipChange, "-530653606")) {
                        return new TicketSouvenirViewModel(TicketSouvenirFragment.this.mParams);
                    }
                    return (T) ((ViewModel) ipChange.ipc$dispatch("-530653606", new Object[]{this, cls}));
                }
            }).get(TicketSouvenirViewModel.class);
        }
        return (TicketSouvenirViewModel) ipChange.ipc$dispatch("925249562", new Object[]{this});
    }
    ...
    private void reportUT(String str, String str2, boolean z) {
        ...
        c.e().x(sl2.j().c(sl2.TICKLET_SOUVENIR, str, str2, Boolean.valueOf(z)));
    }
    ...
    private void updateUI(TicketSouvenirDetail ticketSouvenirDetail) {
        IpChange ipChange = $ipChange;
    ...
    public void closeTicketFragmentPopLayer() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1221124482")) {
            ...
            k42.b(activity, k42.a(activity));
            new Handler().postDelayed(new Runnable() {
                /* class cn.damai.ticklet.ui.fragment.TicketSouvenirFragment.AnonymousClass6 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void run() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "627008053")) {
                        ipChange.ipc$dispatch("627008053", new Object[]{this});
                        return;
                    }
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-476312233")) {
            return R$layout.fragment_ticket_souvenir;
        }
        return ((Integer) ipChange.ipc$dispatch("-476312233", new Object[]{this})).intValue();
    }
    ...
    public void showTicketFragmentPopLayer(@NonNull TicketDeatilResult ticketDeatilResult) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-751889061")) {
            ...
            TickletDialogShowFragment instance = TickletDialogShowFragment.getInstance(ticketDeatilResult.getPerformId(), null, ticketDeatilResult, TickletDialogShowFragment.SHOW_TICKLET_FROM_SOUVENIR);
            this.mTicketShowFragment = instance;
            instance.setOnClickCloseListener(new b());
