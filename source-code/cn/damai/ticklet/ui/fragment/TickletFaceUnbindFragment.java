...
public class TickletFaceUnbindFragment extends DamaiBaseMvpFragment {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (!(TickletFaceUnbindFragment.this.mTicketTable == null || TickletFaceUnbindFragment.this.mTicketDetailResult == null)) {
                cn.damai.common.user.c.e().x(sl2.j().D(TickletFaceUnbindFragment.this.mTicketDetailResult.getProjectId(), TickletFaceUnbindFragment.this.mTicketTable.performId, TickletFaceUnbindFragment.this.mTicketTable.voucherUniqueKey));
            }
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (activity != null && (activity instanceof TickletFaceSettingActivity) && TickletFaceUnbindFragment.this.mTicketTable != null && TickletFaceUnbindFragment.this.mTicketDetailResult != null) {
                cn.damai.common.user.c.e().x(sl2.j().L(TickletFaceUnbindFragment.this.mTicketDetailResult.getProjectId(), TickletFaceUnbindFragment.this.mTicketTable.performId, TickletFaceUnbindFragment.this.mTicketTable.voucherUniqueKey));
    ...
    public class c implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "1070009417")) {
                ...
                cn.damai.common.user.c.e().x(sl2.j().F(TickletFaceUnbindFragment.this.mTicketDetailResult.getProjectId(), TickletFaceUnbindFragment.this.mTicketTable.performId, TickletFaceUnbindFragment.this.mTicketTable.voucherUniqueKey));
            }
        }
    }
    ...
    public class d implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (!(TickletFaceUnbindFragment.this.mTicketTable == null || TickletFaceUnbindFragment.this.mTicketDetailResult == null)) {
                cn.damai.common.user.c.e().x(sl2.j().E(TickletFaceUnbindFragment.this.mTicketDetailResult.getProjectId(), TickletFaceUnbindFragment.this.mTicketTable.performId, TickletFaceUnbindFragment.this.mTicketTable.voucherUniqueKey));
            }
    ...
    private void executeFaceUnbindRequest() {
        ...
        g91.b(TAG, "executeFaceUnbindRequest()");
        if (!TextUtils.isEmpty(this.mTicketId)) {
            if (LoginManager.k().q()) {
                ...
                tickletFaceUnbindRequest.loginKey = d20.q();
                tickletFaceUnbindRequest.request(new DMMtopRequestListener<TickletFaceUnbindResult>(TickletFaceUnbindResult.class) {
                    /* class cn.damai.ticklet.ui.fragment.TickletFaceUnbindFragment.AnonymousClass5 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
                    public void onFail(String str, String str2) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "1259324366")) {
                            ipChange.ipc$dispatch("1259324366", new Object[]{this, str, str2});
                            return;
                        }
                    ...
                    public void onSuccess(TickletFaceUnbindResult tickletFaceUnbindResult) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-1336336265")) {
                            ipChange.ipc$dispatch("-1336336265", new Object[]{this, tickletFaceUnbindResult});
                            return;
                        }
                        TickletFaceUnbindFragment.this.stopProgressDialog();
    ...
    private void faceUnbindFailure(TickletFaceUnbindResult tickletFaceUnbindResult) {
        ...
        if (list != null && list.size() > 0 && (userFaceUnbindInfo = list.get(0)) != null) {
            ...
            unbindErrorXFlushMonitor(vl2.TICKLET_PERFORM_DETAIL_NETWORK_ERROR_MSG_FACE_UNBIND_FAIL, tickletFaceUnbindResult.userFaceUnbindingInfoList.get(0).opResultMsg, this.mTicketId);
        }
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void faceUnbindResultProcess(TickletFaceUnbindResult tickletFaceUnbindResult) {
        IpChange ipChange = $ipChange;
        ...
        } else if (!"1".equals(tickletFaceUnbindResult.allSuccess)) {
    ...
    private void renderErrorXFlushMonitor(String str, String str2) {
        ...
        vl2.d(vl2.f(vl2.TICKLET_PERFORM_DETAIL_RENDER_UNBIND_FAIL_MSG, "", "", str, "voucherUniqueKey:" + str2), vl2.TICKLET_PERFORM_DETAIL_RENDER_ERROR_CODE, "", "票夹场次详情渲染失败");
    }
    ...
    private void setSeatInfo(String str, String str2) {
        ...
        if (!TextUtils.isEmpty(str2)) {
            ...
            lw2.y(str, textView, "#111111", "#999999");
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void showTicketFaceUnbindDialog() {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void unbindErrorXFlushMonitor(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-439717080")) {
            ipChange.ipc$dispatch("-439717080", new Object[]{this, str, str2, str3});
            return;
        }
        vl2.d(vl2.f(vl2.TICKLET_PERFORM_DETAIL_NETWORK_ERROR_MSG_FACE_UNBIND, "mtop.damai.wireless.ticklet2.perform.detail.get", str, str2, "voucherUniqueKey:" + str3), vl2.TICKLET_PERFORM_DETAIL_NETWORK_ERROR_CODE, str, vl2.TICKLET_PERFORM_DETAIL_NETWORK_ERROR_MSG);
    }
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-191527287")) {
            return R$layout.ticklet_fragment_face_unbind;
        }
        return ((Integer) ipChange.ipc$dispatch("-191527287", new Object[]{this})).intValue();
    }
