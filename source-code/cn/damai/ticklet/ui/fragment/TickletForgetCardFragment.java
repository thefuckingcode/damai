...
public class TickletForgetCardFragment extends DamaiBaseMvpFragment {
    ...
    private void initData() {
        ...
        if (!TextUtils.isEmpty(this.name) || !TextUtils.isEmpty(this.cardNum)) {
            ...
            lw2.E(this.tvName, this.name);
            lw2.E(this.tvCardNum, this.cardNum);
        ...
        int e = v50.e(getContext(), (float) com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getheightPixels(displayMetrics)) + ErrorCode.ERROR_MD5_UPDATE;
        ...
        if (this.forgetCardResult.forgotCardInfos.size() > 2) {
            layoutParams.height = v50.a(getContext(), e > 345 ? 345.0f : (float) e);
            this.irc.setLayoutParams(layoutParams);
        } else if (this.forgetCardResult.forgotCardInfos.size() == 2) {
            layoutParams.height = v50.a(getContext(), e > 290 ? 290.0f : (float) e);
            this.irc.setLayoutParams(layoutParams);
        } else {
            layoutParams.height = v50.a(getContext(), e > 185 ? 185.0f : (float) e);
            this.irc.setLayoutParams(layoutParams);
        }
    ...
    public int getLayoutResource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-804877889")) {
            return R$layout.ticklet_ticket_forget_card_view;
        }
        return ((Integer) ipChange.ipc$dispatch("-804877889", new Object[]{this})).intValue();
    }
    ...
    public void notifyData(UserTicketTable userTicketTable) {
        ...
        if (tickletForgetCardResult != null && (arrayList = tickletForgetCardResult.forgotCardInfos) != null && arrayList.size() > 0 && userTicketTable != null && !yf2.c(userTicketTable.voucherUniqueKey)) {
    ...
    public void onClick(View view) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1859252129")) {
            ...
            lw2.f().k(getContext(), this.performId, this.forgetCardResult.ecertTipsInfo);
            closeForget();
        }
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        setDamaiUTKeyBuilder(sl2.j().k(sl2.TICKLET_FORGET_CARD));
    }
