...
public class TransferAllowAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        if (tickletTransferManagerListExtra != null) {
            ...
            lw2.E(viewHolder.e, tickletTransferManagerListExtra.fullSeatInfo);
            ...
            lw2.E(viewHolder.b, str);
            lw2.E(viewHolder.c, str2);
            lw2.E(viewHolder.f, tickletTransferManagerListExtra.productSystemVoucherIdWithPre);
            if (i != this.a.size() - 1) {
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-949770654")) {
            return this.a.size();
        }
        return ((Integer) ipChange.ipc$dispatch("-949770654", new Object[]{this})).intValue();
    }
