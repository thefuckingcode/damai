...
public class TickletTransferRunningAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        if (tickletTransferManagerListExtra != null) {
            ...
            if (!TextUtils.isEmpty(tickletTransferManagerListExtra.realCountDown)) {
                ...
                textView.setText("剩余时间 " + b30.c(tickletTransferManagerListExtra.realCountDown));
            } else if (!TextUtils.isEmpty(tickletTransferManagerListExtra.transferValidityTime)) {
                viewHolder.c.setVisibility(0);
                TextView textView2 = viewHolder.c;
                textView2.setText("剩余时间 " + b30.c(String.valueOf(Long.parseLong(tickletTransferManagerListExtra.transferValidityTime) - b30.a())));
            } else {
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1623375084")) {
            return this.a.size();
        }
        return ((Integer) ipChange.ipc$dispatch("-1623375084", new Object[]{this})).intValue();
    }
