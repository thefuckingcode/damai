...
public class TickletAttendanceActivity extends TickletBaseActivity implements DamaiConstants, TickletDetailConfirmAcceptUtil.TickletTransferConfirmAcceptCallBack, TickletAttendanceAdapter.OnSelectIdTypeChanged {
    ...
    private void reportContactListXFlushError(String str, String str2) {
        ...
        vl2.d(vl2.f(vl2.TICKLET_CONTACT_INTERFACE_LIST_API, "mtop.damai.wireless.user.customerlist.get", str, str2, ""), vl2.TICKLET_CONTACT_INTERFACE_ERROR_CODE, str, vl2.TICKLET_CONTACT_INTERFACE_ERROR_MSG);
    }
    ...
    private void requestContactsList() {
        ...
        tickletGetContactListRequest.loginkey = d20.q();
        tickletGetContactListRequest.request(new DMMtopRequestListener<TickletContractResponse>(TickletContractResponse.class) {
            /* class cn.damai.ticklet.ui.activity.TickletAttendanceActivity.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-873376418")) {
                    ipChange.ipc$dispatch("-873376418", new Object[]{this, str, str2});
                    return;
                }
            ...
            public void onSuccess(TickletContractResponse tickletContractResponse) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1002733372")) {
                    ipChange.ipc$dispatch("-1002733372", new Object[]{this, tickletContractResponse});
                    return;
                }
                TickletAttendanceActivity.this.stopProgressDialog();
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1083336312")) {
            return R$layout.ticklet_attendance_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("-1083336312", new Object[]{this})).intValue();
    }
    ...
    public void onClick(View view) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1810541739")) {
            ...
            DMNav.from(this.mContext).forResult(ORDER_ADD_CONTACTS).withExtras(bundle).toUri(NavUri.b(gr.z));
        } else if (view.getId() == R$id.ticklet_attendance_confirm) {
            c.e().x(b.getInstance().e(sl2.TICKLET_TRANSFER_TABLE_PAGE, "bottom", "submitbtn", null, Boolean.FALSE));
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (getIntent() != null) {
            ...
            setDamaiUTKeyBuilder(sl2.j().k(sl2.TICKLET_TRANSFER_TABLE_PAGE));
            return;
        }
        finish();
    }
    ...
    public void returnContactsList(TickletContractResponse tickletContractResponse) {
        ...
        for (int i = 0; i < tickletContractResponse.getResult().size(); i++) {
            try {
                ...
                g91.b("TickletAttendance", e.getMessage());
            }
        }
