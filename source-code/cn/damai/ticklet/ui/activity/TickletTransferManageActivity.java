...
public class TickletTransferManageActivity extends TickletBaseActivity implements DamaiConstants, View.OnClickListener, TickletTransferCallback, PullToRefreshBase.OnRefreshListener<DMScrollerView> {
    ...
    private final nn2 mDividerDataHolder = new nn2(3);
    ...
    private nn2 transferAllows = new nn2(0);
    private TickletTransferDataResult transferDataResult;
    private ArrayList<nn2> transferDatas = new ArrayList<>();
    private nn2 transferLimit = new nn2(5);
    private TextView transferOneTicket;
    private nn2 transferOuts = new nn2(1);
    private nn2 transferRunnings = new nn2(2);
    private nn2 transferTips = new nn2(4);
                ...
                try {
                    ...
                    for (int i = 0; i < this.runningTransfers.size(); i++) {
                        if (!TextUtils.isEmpty(this.runningTransfers.get(i).transferValidityTime)) {
                            long parseLong = Long.parseLong(this.runningTransfers.get(i).transferValidityTime) - b30.a();
                            if (parseLong >= 1000) {
    ...
    public class c implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            cn.damai.common.user.c.e().x(sl2.j().O("bottom", "canceltransferbtn", TickletTransferManageActivity.this.performId, TickletTransferManageActivity.this.acceptPerson, false));
            dialogInterface.dismiss();
        }
    }
    ...
    public class d implements ProtocolDialog.OnConfirmListener {
        ...
        public void onConfirmClick(boolean z, DialogInterface dialogInterface) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "287291874")) {
                ...
                cn.damai.common.user.c.e().x(sl2.j().O("bottom", "submittransferbtn", TickletTransferManageActivity.this.performId, TickletTransferManageActivity.this.acceptPerson, false));
    ...
    public class f implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            ...
            if (TickletTransferManageActivity.this.visibleWindowDisplayHeight > rect.bottom) {
                ...
                g91.b("TestCostomUIActivity", "输入框show");
                return;
            }
            ...
            g91.b("TestCostomUIActivity", "输入框hide");
        }
    }
    ...
    public class i implements TickletTransferShareCallback {
        ...
        public void alipay() {
            ...
            sl2 j = sl2.j();
            e.x(j.P("bottom", "transfer_item_" + String.valueOf(1), TickletTransferManageActivity.this.performId, "支付宝", false));
        }
        ...
        public void damaiPhone() {
            ...
            cn.damai.common.user.c e = cn.damai.common.user.c.e();
            sl2 j = sl2.j();
            e.x(j.P("bottom", "transfer_item_" + String.valueOf(2), TickletTransferManageActivity.this.performId, "手机", false));
        }
        ...
        public void weChat() {
            ...
            cn.damai.common.user.c e = cn.damai.common.user.c.e();
            sl2 j = sl2.j();
            e.x(j.P("bottom", "transfer_item_" + String.valueOf(0), TickletTransferManageActivity.this.performId, "微信", false));
        }
    }
    ...
    private void cancelTransfer(String str) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1577158746")) {
            ...
            tickletTransferManagerCancelRequest.request(new DMMtopRequestListener<TickletTransferCancelData>(TickletTransferCancelData.class) {
                /* class cn.damai.ticklet.ui.activity.TickletTransferManageActivity.AnonymousClass4 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
                public void onFail(String str, String str2) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-877888920")) {
                        ipChange.ipc$dispatch("-877888920", new Object[]{this, str, str2});
                        return;
                    }
                    TickletTransferManageActivity.this.returnSponsorCancelFailResult(str, str2);
                    rl2.c(2, str, str2, TickletTransferManageActivity.this.performId);
                }

                public void onSuccess(TickletTransferCancelData tickletTransferCancelData) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-329556878")) {
                        ipChange.ipc$dispatch("-329556878", new Object[]{this, tickletTransferCancelData});
                        return;
                    }
    ...
    private void confirmTransfer(String str) {
        ...
        if (xf2.e(checkedTransferInfo) > 0 && checkedTransferInfo.get(0) != null) {
        ...
        if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str)) {
            ...
            tickletTransferManagerSponsorRequest.request(new DMMtopRequestListener<TickletTransferConfirmData>(TickletTransferConfirmData.class) {
                /* class cn.damai.ticklet.ui.activity.TickletTransferManageActivity.AnonymousClass5 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
                public void onFail(String str, String str2) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-885648279")) {
                        ipChange.ipc$dispatch("-885648279", new Object[]{this, str, str2});
                        return;
                    }
                    TickletTransferManageActivity.this.returnSponsorCancelFailResult(str, str2);
                    rl2.c(3, str, str2, TickletTransferManageActivity.this.performId);
                }

                public void onSuccess(TickletTransferConfirmData tickletTransferConfirmData) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1551551377")) {
                        ipChange.ipc$dispatch("-1551551377", new Object[]{this, tickletTransferConfirmData});
                        return;
                    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private ArrayList<TickletTransferManagerListExtra> getCheckedTransferInfo() {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private boolean isCheckTransferEnabled() {
        ...
        if (arrayList == null || arrayList.size() <= 0 || (tickletTransferDataResult = this.transferDataResult) == null || !"1".equals(tickletTransferDataResult.transferState)) {
            return false;
        }
        return true;
    }
    ...
    private boolean isNeedRefreshCode(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "530894863")) {
            return "FAIL_BIZ_FAIL_BIZ_TRANS_ERROR_NOT_SUPPORT_DONATION".equals(str) || "FAIL_BIZ_FAIL_BIZ_TRANS_ERROR_NO_TRANSFERRABLE_TICK".equals(str) || "FAIL_BIZ_FAIL_BIZ_TRANS_ERROR_ACCEPT_NO_DONATION".equals(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("530894863", new Object[]{this, str})).booleanValue();
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void phoneConfirmButtonState() {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void phoneTransferInput() {
        IpChange ipChange = $ipChange;
    ...
    private void refreshViewByDataChange() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1176763224")) {
            ...
            if ("0".equals(this.transferDataResult.transferState) && this.mCurrentPageIndex > 0) {
                new f4(this).i(getResources().getString(R$string.ticklet_transfer_stop_tip_title)).c(false).e(getResources().getString(R$string.ticklet_transfer_stop_tip_text)).h(getResources().getString(R$string.ticklet_know), null).j();
            }
        } else {
            showLimitPage();
        }
    ...
    private void requestDetailData(boolean z, boolean z2) {
        ...
        tickletTransferManagerListRequest.request(new DMMtopRequestListener<TickletTransferDataResult>(TickletTransferDataResult.class) {
            /* class cn.damai.ticklet.ui.activity.TickletTransferManageActivity.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-870129561")) {
                    ipChange.ipc$dispatch("-870129561", new Object[]{this, str, str2});
                    return;
                }
                ...
                rl2.c(1, str, str2, TickletTransferManageActivity.this.performId);
            }

            public void onSuccess(TickletTransferDataResult tickletTransferDataResult) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "564754030")) {
                    ipChange.ipc$dispatch("564754030", new Object[]{this, tickletTransferDataResult});
                    return;
                }
                TickletTransferManageActivity.this.stopProgressDialog();
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void returnSponsorCancelFailResult(String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void returnSponsorTransferTicketResult() {
        IpChange ipChange = $ipChange;
    ...
    private void showTransferConfirmDialog() {
        ...
        tickletTransferConfirmDialogView.setData(getCheckedTransferInfo().size(), this.acceptPerson, str);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void thirdTransferConirm() {
        IpChange ipChange = $ipChange;
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            tickletTransferManagerSponsorRequest.request(new DMMtopRequestListener<TickletTransferThirdConfirmData>(TickletTransferThirdConfirmData.class) {
                /* class cn.damai.ticklet.ui.activity.TickletTransferManageActivity.AnonymousClass6 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
                public void onFail(String str, String str2) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-893407638")) {
                        ipChange.ipc$dispatch("-893407638", new Object[]{this, str, str2});
                        return;
                    }
                    TickletTransferManageActivity.this.returnSponsorCancelFailResult(str, str2);
                    rl2.c(3, str, str2, TickletTransferManageActivity.this.performId);
                ...
                public void onSuccess(TickletTransferThirdConfirmData tickletTransferThirdConfirmData) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1935255883")) {
                        ipChange.ipc$dispatch("-1935255883", new Object[]{this, tickletTransferThirdConfirmData});
                        return;
                    }
                    TickletTransferManageActivity.this.stopProgressDialog();
                    if (!tickletTransferThirdConfirmData.optResult) {
                        ...
                        rl2.c(7, "", sb.toString(), TickletTransferManageActivity.this.performId);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void thirdTransferShare(TickletTransferThirdConfirmData tickletTransferThirdConfirmData) {
        IpChange ipChange = $ipChange;
    ...
    private void transferPhoneImp() {
        ...
        String trim = this.etTransferPhone.getText().toString().trim();
        cn.damai.common.user.c.e().x(sl2.j().O("bottom", "submittransfer", this.performId, trim, false));
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void transferTypeDeal(boolean z, String str) {
        IpChange ipChange = $ipChange;
        ...
        } else if ("2".equals(this.transferType) && yt2.a(this, false)) {
            showTickletTransferDialog();
    ...
    public void callCancelTransfer(String str, int i2, String str2) {
        ...
        sl2 j = sl2.j();
        e2.x(j.O("list", "canceltransfer_" + String.valueOf(i2), this.performId, str2, false));
        DMDialog dMDialog = new DMDialog(this);
    ...
    public void chooseUpdateView(int i2) {
        ...
        cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_TRANSFER_MANAGER_PAGE, "to_transfer", "select_ticket", hashMap, Boolean.FALSE));
        this.adapterManage.a();
        confirmButtonState();
    }
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "946039201")) {
            return R$layout.ticklet_sponsor_transfer_manager_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("946039201", new Object[]{this})).intValue();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (!TextUtils.isEmpty(this.performId)) {
            onRefresh();
            setDamaiUTKeyBuilder(sl2.j().k(sl2.TICKLET_TRANSFER_MANAGER_PAGE));
        }
    }
    ...
    public void returnTransferData(TickletTransferDataResult tickletTransferDataResult) {
        ...
        if (!(tickletTransferDataResult == null || !tickletTransferDataResult.isNotEmptyList())) {
            if (!TextUtils.isEmpty(tickletTransferDataResult.serverTimestamp)) {
                b30.d(Long.parseLong(tickletTransferDataResult.serverTimestamp));
            }
            if (this.mCurrentPageIndex == 0) {
            ...
            if (arrayList != null && arrayList.size() > 0 && "1".equals(tickletTransferDataResult.transferState)) {
                ...
                Thread thread2 = new Thread(this.timeThread);
                this.thread = thread2;
                thread2.start();
            }
    ...
    public String setTitle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "23552597")) {
            return "";
        }
        return (String) ipChange.ipc$dispatch("23552597", new Object[]{this});
    }

    public ArrayList<nn2> ticketSeatCombine(TickletTransferDataResult tickletTransferDataResult, boolean z) {
        IpChange ipChange = $ipChange;
        ...
        if (z) {
            ...
            this.transferTips = new nn2(4);
            this.transferAllows = new nn2(0);
            this.transferOuts = new nn2(1);
            this.transferRunnings = new nn2(2);
        }
