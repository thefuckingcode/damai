...
public class TicketDetailAcceptTransferActivity extends TickletBaseActivity implements TickletDetailConfirmAcceptUtil.TickletTransferConfirmAcceptCallBack, TickletTransferDetailWaitAcceptAdapter.TickletTransferWaitCallback, OnLoadMoreListener, OnRefreshListener {
    ...
    public class a implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_TRANSFER_CONDIRM_PAGE, "center", "cancel_receiver", this.a, Boolean.FALSE));
    ...
    public class b implements ProtocolDialog.OnConfirmListener {
        ...
        public void onConfirmClick(boolean z, DialogInterface dialogInterface) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "930015175")) {
                ...
                dialogInterface.dismiss();
                cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_TRANSFER_CONDIRM_PAGE, "center", "confim_receiver_btn", this.a, Boolean.FALSE));
                TicketDetailAcceptTransferActivity.this.checkLiveBind();
            } else {
                ToastUtil.a().j(xs0.a(), "请您认真阅读转送规则及《订票服务条款》，接受后可开始使用我们的服务");
            }
        }
    }
    ...
    public class c implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_TRANSFER_CONDIRM_PAGE, "center", "transfermanager_notice", this.a, Boolean.TRUE));
            lw2.f().n(TicketDetailAcceptTransferActivity.this, gl2.DAMAI_PROTOCOL_TIPS_URL);
        }
    }
    ...
    public class d implements YouKuTrustListener {
        ...
        public void trustYouKuFail(String str, String str2) {
            ...
            ToastUtil.i(str2);
            yz2.a(yz2.i("", "", str, str2, ""), su0.LOGIN_YOUKU_BRIDGE_FAILED_CODE, "票夹待接收业务： 优酷h5桥自动登录失败");
        }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void confirmAcceptOnclick() {
        ...
        } else if (xf2.e(getRealNameNum(this.confirmAcceptData)) > 0) {
    ...
    private void requestDetailData(boolean z) {
        ...
        new TickletTransferWaitingAcceptListRequest().request(new DMMtopRequestListener<TicketPerformTransferAcceptResult>(TicketPerformTransferAcceptResult.class) {
            /* class cn.damai.ticklet.ui.activity.TicketDetailAcceptTransferActivity.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // cn.damai.common.net.mtop.netfit.DMMtopRequestListener
            public void onFail(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-912818095")) {
                    ipChange.ipc$dispatch("-912818095", new Object[]{this, str, str2});
                    return;
                }
                TicketDetailAcceptTransferActivity.this.stopProgressDialog();
            ...
            public void onSuccess(TicketPerformTransferAcceptResult ticketPerformTransferAcceptResult) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "522464195")) {
                    ipChange.ipc$dispatch("522464195", new Object[]{this, ticketPerformTransferAcceptResult});
                    return;
                }
                TicketDetailAcceptTransferActivity.this.stopProgressDialog();
    ...
    public void acceptConfirm(TicketPerformTransferAcceptResult.TicketPerformTransferData ticketPerformTransferData) {
        ...
        cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_TRANSFER_CONDIRM_PAGE, "center", "confimbtn", hashMap, Boolean.FALSE));
        ...
        String str = "";
        if (tips == null) {
            rl2.c(5, "android_native_alarm", "待接收用户协议服务端返回为null", str);
        } else {
            str = tips.getText();
        }
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1428506571")) {
            return R$layout.ticklet_transfer_detail_wait_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("-1428506571", new Object[]{this})).intValue();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (getIntent() != null) {
            ...
            if ("android.intent.action.VIEW".equals(getIntent().getAction()) && (data = getIntent().getData()) != null) {
                ...
                if (!yf2.c(queryParameter)) {
                    try {
                        AcceptTransferH5Params acceptTransferH5Params = (AcceptTransferH5Params) s41.a(queryParameter, AcceptTransferH5Params.class);
        ...
        setDamaiUTKeyBuilder(sl2.j().k(sl2.TICKLET_TRANSFER_CONDIRM_PAGE));
        if (!LoginManager.k().q()) {
            gotoLogin();
        } else {
            requestDetailData(true);
