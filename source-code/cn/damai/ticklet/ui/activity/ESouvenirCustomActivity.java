...
public class ESouvenirCustomActivity extends DamaiBaseActivity implements ILoginListener {
    ...
    public class a implements MyScrollView.ScrollYListener {
        ...
        public void onScroll(View view, int i) {
            ...
            ESouvenirCustomActivity.this.updateTitleAlpha(((float) i) / ((float) v50.a(ESouvenirCustomActivity.this.mContext, 48.0f)));
        }
    }
    ...
    public static int setAlphaComponent(float f, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1873978087")) {
            return ((Integer) ipChange.ipc$dispatch("1873978087", new Object[]{Float.valueOf(f), Integer.valueOf(i)})).intValue();
        }
    ...
    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-952689078")) {
            return R$layout.ticklet_e_custom_souvenir_layout;
        }
        return ((Integer) ipChange.ipc$dispatch("-952689078", new Object[]{this})).intValue();
    }
    ...
    public void onBackPresss() {
        ...
        c.e().z(sl2.j().o(sl2.TICKLET_DEFINE_SOUNENIR_TICKET, this.performId, "bottom"));
        finish();
    }
    ...
    public void onClick(View view) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-537736279")) {
            ...
            if (view.getId() == R$id.icon_generate_image) {
                ...
                hashMap.put("price", this.ticklet_sou_price.isCheck() ? str2 : "0");
                ...
                hashMap2.put("usercode", String.valueOf(d20.E()));
                c.e().x(b.getInstance().e(sl2.TICKLET_DEFINE_SOUNENIR_TICKET, "bottom", "share", hashMap2, Boolean.TRUE));
                createPic(view, this);
                ...
                tickletSouvenirClassicsView.setUserInfo(ticketSouvenirBean.nickname, false, str2.equals(ticketSouvenirBean.vip), this.infoBean.pfVipMemberLevel);
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        setDamaiUTKeyBuilder(sl2.j().b(sl2.TICKLET_DEFINE_SOUNENIR_TICKET));
        if (getIntent() != null) {
            ...
            this.height = getIntent().getIntExtra("height", v50.a(this, 469.0f));
            this.heightImage = getIntent().getIntExtra("heightImage", v50.a(this, 347.0f));
            this.width = getIntent().getIntExtra("width", v50.a(this, 260.0f));
