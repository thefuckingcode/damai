...
public class TickletDetailSceneVenueItemHolder extends RecyclerView.ViewHolder {
    ...
    private void c(String str, String str2, String str3, int i) {
        ...
        if (((TicketDeatilActivity) context) != null) {
            ...
            if (i2 == 0) {
                cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_DETAIL_PAGE, "venue_info", "mass_transit", sl2.j().s(projectId, performId), Boolean.TRUE));
            } else if (i2 == 1) {
                cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_DETAIL_PAGE, "venue_info", "parking_lots", sl2.j().s(projectId, performId), Boolean.TRUE));
            } else if (i2 == 2) {
                cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_DETAIL_PAGE, "venue_info", "smallfoods", sl2.j().s(projectId, performId), Boolean.TRUE));
            } else if (i2 == 3) {
                cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_DETAIL_PAGE, "venue_info", "wc", sl2.j().s(projectId, performId), Boolean.TRUE));
            } else if (i2 != 4) {
                if (i2 != 5) {
                    if (i2 == 100) {
                        cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_DETAIL_PAGE, "venue_info", "venue_map_btn", sl2.j().s(projectId, performId), Boolean.TRUE));
                    }
                }
                cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_DETAIL_PAGE, "venue_info", "mall", sl2.j().s(projectId, performId), Boolean.TRUE));
            } else {
                cn.damai.common.user.c.e().x(cn.damai.common.user.b.getInstance().e(sl2.TICKLET_DETAIL_PAGE, "venue_info", "quickshop", sl2.j().s(projectId, performId), Boolean.TRUE));
            }
            if (i2 == 100) {
                i2 = 0;
            }
            ...
            if (!"1".equals(ticketExtMapBean.pdfVoucher)) {
                ...
                if (this.f.getChildCount() == 0 || this.g.getChildCount() == 0) {
                    ...
                    for (int i = 0; i < this.d.size(); i++) {
                        TickletDetailServiceItem b2 = b(this.d.get(i).getName(), this.d.get(i).iconFontId, this.d.get(i).type, ticketExtMapBean.lat, ticketExtMapBean.lng, ticketExtMapBean.title);
                        if (i < this.d.size() / 2) {
                            this.f.addView(b2);
                        } else {
                            this.g.addView(b2);
                    ...
                    for (int i2 = 0; i2 < this.d.size(); i2++) {
                        if (i2 < this.d.size() / 2) {
                            ...
                            view = this.g.getChildAt(i2 % (this.d.size() / 2));
                        }
                        if (view != null) {
                            f((TickletDetailServiceItem) view, this.d.get(i2).getName(), this.d.get(i2).iconFontId, this.d.get(i2).type, ticketExtMapBean.lat, ticketExtMapBean.lng, ticketExtMapBean.title);
                        }
                    }
                }
