...
public class TicketServiceFacility implements Serializable {
    ...
    private boolean textEq(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1588837269")) {
            return !TextUtils.isEmpty(this.name) && this.name.contentEquals(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("-1588837269", new Object[]{this, str})).booleanValue();
    }

    public String getIcon() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "715363515")) {
            return this.icon;
        }
        return (String) ipChange.ipc$dispatch("715363515", new Object[]{this});
    }

    public String getLink() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "796999100")) {
            return this.link;
        }
        return (String) ipChange.ipc$dispatch("796999100", new Object[]{this});
    }

    public String getName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "64755149")) {
            return this.name;
        }
        return (String) ipChange.ipc$dispatch("64755149", new Object[]{this});
    }

    public boolean hasUrl() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1364789413")) {
            return !TextUtils.isEmpty(this.link);
        }
        return ((Boolean) ipChange.ipc$dispatch("1364789413", new Object[]{this})).booleanValue();
    }

    public boolean isParking() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-759329750")) {
            return textEq(PARKING);
        }
        return ((Boolean) ipChange.ipc$dispatch("-759329750", new Object[]{this})).booleanValue();
    }

    public boolean isPublicTransit() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1995357368")) {
            return textEq(PUBLIC_TRANSIT);
        }
        return ((Boolean) ipChange.ipc$dispatch("1995357368", new Object[]{this})).booleanValue();
    }
