...
public class TickletDetailCompViewBean implements Serializable {
    ...
    public boolean isNoAllowGoto() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1837136688")) {
            return ((Boolean) ipChange.ipc$dispatch("-1837136688", new Object[]{this})).booleanValue();
        }
        if ("0".equals(this.type) || (("1".equals(this.type) && TextUtils.isEmpty(this.url)) || ((bizData2 = this.bizData) != null && "1".equals(bizData2.pdfVoucher)))) {
            return true;
        }
        return false;
    }
