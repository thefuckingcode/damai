...
public class ComponentFragment extends AbsFragmentV2 {
    ...
    private void load(final boolean z) {
        ...
        TetrisParams tetrisParams = null;
        OnCompFragmentListener onCompFragmentListener = this.mLifeListener;
        if (onCompFragmentListener != null) {
            tetrisParams = onCompFragmentListener.obtainPreferParams();
        }
        if (tetrisParams == null) {
            tetrisParams = new CmsCommonParams();
        }
        TetrisRequest tetrisRequest = new TetrisRequest(tetrisParams);
        ...
        tetrisRequest.request(new DMMtopWarningListener<BaseResponse>(BaseResponse.class, tetrisRequest.toJsonString()) {
            /* class cn.damai.livehouse.ComponentFragment.AnonymousClass1 */
            ...
            public void onFailWithWarning(String str, String str2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-544800596")) {
                    ipChange.ipc$dispatch("-544800596", new Object[]{this, str, str2});
                    return;
                }
                if (z) {
            ...
            public void onSuccessWithWarning(BaseResponse baseResponse) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1003573266")) {
                    ipChange.ipc$dispatch("1003573266", new Object[]{this, baseResponse});
                    return;
                }
                if (z) {
                    ComponentFragment.this.stopProgressDialog();
