...
public class PraiseView extends FrameLayout implements PraiseRequest.PraiseRequestCallBack {
    ...
    public int COMMENT_TYPE_COMMENT_DETAIL = 3;
    public int COMMENT_TYPE_COMMENT_LIST = 2;
    public int COMMENT_TYPE_EVALUATE_LIST = 4;
    public int COMMENT_TYPE_PROJECT = 0;
    public int COMMENT_TYPE_REPERTOIRE = 1;
    public int COMMENT_TYPE_VEVALUATE_LIST = 5;
    private String DEFAULT_PRAISE_ICON;
    private int DEFAULT_PRAISE_ICON_AND_TEXT_MARGIN = 3;
    private int DEFAULT_PRAISE_ICON_TEXT_COLOR;
    private int DEFAULT_PRAISE_ICON_TEXT_PRAISED_COLOR;
    private int DEFAULT_PRAISE_ICON_TEXT_SIZE = 16;
    private String DEFAULT_PRAISE_NUMBER = "点赞";
    private int DEFAULT_PRAISE_NUMBER_TEXT_COLOR;
    private int DEFAULT_PRAISE_NUMBER_TEXT_PRAISED_COLOR;
    private int DEFAULT_PRAISE_NUMBER_TEXT_SIZE = 12;
    ...
    private View.OnClickListener onPraiseLayoutClickListener = new a();
    ...
    private void initView() {
        ...
        textView.setTextSize(1, (float) this.DEFAULT_PRAISE_NUMBER_TEXT_SIZE);
    ...
    private void requestPraise() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1345570390")) {
            ...
            this.praiseRequest.a(z, getCommentId());
        }
    }
    ...
    private void setValue(CommentPraiseInfoBean commentPraiseInfoBean, int i, String str) {
        ...
        setPraiseNumber(i > 0 ? hk.a(i) : this.DEFAULT_PRAISE_NUMBER);
    ...
    private void updateItemData() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "828972399")) {
            ...
            if (praiseInfo.isHasPraised()) {
                ...
                praiseInfo.setPraiseCount(i > 0 ? hk.a(i - 1) : this.DEFAULT_PRAISE_NUMBER);
                return;
            }
            praiseInfo.setHasPraised(true);
            praiseInfo.setPraiseCount(hk.a(i + 1));
        }
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updatePraiseView(String str) {
        CommentPraiseInfoBean praiseInfo;
        IpChange ipChange = $ipChange;
        int i = 0;
    ...
    public DMIconFontTextView getPraiseIconView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-773308482")) {
            return new DMIconFontTextView(getContext());
        }
        return (DMIconFontTextView) ipChange.ipc$dispatch("-773308482", new Object[]{this});
    }
    ...
    public TextView getPraiseNumberView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1176591433")) {
            return this.praiseNumber;
        }
        return (TextView) ipChange.ipc$dispatch("1176591433", new Object[]{this});
    }

    public boolean isShowAnim() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1944680321")) {
            return this.showAnim;
        }
        return ((Boolean) ipChange.ipc$dispatch("1944680321", new Object[]{this})).booleanValue();
    }
