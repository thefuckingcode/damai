...
public class SoftInputUtils {
    ...
    public class a implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            ...
            if (this.a != i2) {
                ...
                this.c.onSoftKeyBoardChange(i2, !z);
            }
            this.a = height;
        }
    }
    ...
    public static boolean b(Activity activity, MotionEvent motionEvent) {
        ...
        int i = iArr[0];
        int i2 = iArr[1];
        return motionEvent.getX() <= ((float) i) || motionEvent.getX() >= ((float) DisplayMetrics.getwidthPixels(v50.b(activity))) || motionEvent.getY() <= ((float) i2) || motionEvent.getY() >= ((float) (currentFocus.getHeight() + i2));
    }
