...
public class DefaultProgressEvent implements Parcelable, NetworkEvent$ProgressEvent {
    public static final Parcelable.Creator<DefaultProgressEvent> CREATOR = new Parcelable.Creator<DefaultProgressEvent>() {
        /* class anetwork.channel.aidl.DefaultProgressEvent.AnonymousClass1 */
    ...
    public String toString() {
        return "DefaultProgressEvent [index=" + this.index + ", size=" + this.size + ", total=" + this.total + jl1.ARRAY_END_STR;
    }
