...
public class a {
    ...
    public static Cache.Entry b(Map<String, List<String>> map) {
        ...
        String d = ry0.d(map, "Cache-Control");
        boolean z = true;
        int i = 0;
        if (d != null) {
        ...
        String d2 = ry0.d(map, HttpHeaderConstant.DATE);
        long c = d2 != null ? c(d2) : 0;
        String d3 = ry0.d(map, "Expires");
        long c2 = d3 != null ? c(d3) : 0;
        String d4 = ry0.d(map, "Last-Modified");
        long c3 = d4 != null ? c(d4) : 0;
        String d5 = ry0.d(map, "ETag");
        if (z) {
