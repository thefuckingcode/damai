...
public final class Functions {
    ...
    public static final class NotificationOnComplete<T> implements Action {
        final Consumer<? super vj1<T>> onNotification;

        NotificationOnComplete(Consumer<? super vj1<T>> consumer) {
            this.onNotification = consumer;
        }

        @Override // io.reactivex.functions.Action
        public void run() throws Exception {
            this.onNotification.accept(vj1.a());
        }
    }
    ...
    public static final class NotificationOnError<T> implements Consumer<Throwable> {
        ...
        NotificationOnError(Consumer<? super vj1<T>> consumer) {
            this.onNotification = consumer;
        }

        public void accept(Throwable th) throws Exception {
            this.onNotification.accept(vj1.b(th));
        }
    }
    ...
    public static final class NotificationOnNext<T> implements Consumer<T> {
        ...
        NotificationOnNext(Consumer<? super vj1<T>> consumer) {
            this.onNotification = consumer;
        }

        @Override // io.reactivex.functions.Consumer
        public void accept(T t) throws Exception {
            this.onNotification.accept(vj1.c(t));
        }
    }
    ...
    /* access modifiers changed from: package-private */
    /* compiled from: Taobao */
    public static final class TimestampFunction<T> implements Function<T, em2<T>> {
        ...
        @Override // io.reactivex.functions.Function
        public em2<T> apply(T t) throws Exception {
            return new em2<>(t, this.scheduler.now(this.unit), this.unit);
        }
    }
    ...
    public static <T> Action notificationOnComplete(Consumer<? super vj1<T>> consumer) {
        return new NotificationOnComplete(consumer);
    }

    public static <T> Consumer<Throwable> notificationOnError(Consumer<? super vj1<T>> consumer) {
        return new NotificationOnError(consumer);
    }

    public static <T> Consumer<T> notificationOnNext(Consumer<? super vj1<T>> consumer) {
    ...
    public static <T> Function<T, em2<T>> timestampWith(TimeUnit timeUnit, Scheduler scheduler) {
