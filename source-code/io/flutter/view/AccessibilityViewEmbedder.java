...
public class AccessibilityViewEmbedder {
    ...
    public static class ReflectionAccessors {
        ...
        @Nullable
        private Long getChildId(@NonNull AccessibilityNodeInfo accessibilityNodeInfo, int i) {
        ...
        /* access modifiers changed from: public */
        @Nullable
        private Long getParentNodeId(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        /* access modifiers changed from: public */
        @Nullable
        private Long getRecordSourceNodeId(@NonNull AccessibilityRecord accessibilityRecord) {
        ...
        /* access modifiers changed from: public */
        @Nullable
        private Long getSourceNodeId(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        private ReflectionAccessors() {
            ...
            if (Build.VERSION.SDK_INT <= 26) {
                ...
                try {
                    ...
                    method3 = Class.forName("android.util.LongArray").getMethod(gl1.TYPE_OPEN_URL_METHOD_GET, Integer.TYPE);
                    method4 = null;
