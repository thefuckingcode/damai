...
public class U4WPKAdapter extends HashMap<String, String> implements ValueCallback<U4StatLine>, U4Line.Clearable {
    ...
    private static final ValueCallback<Pair<Message, Message>> sConfigChangeCallback = new ValueCallback<Pair<Message, Message>>() {
        /* class io.flutter.wpkbridge.U4WPKAdapter.AnonymousClass2 */
    ...
    private static final ValueCallback<Pair<Message, Message>> sInternalCallback = new ValueCallback<Pair<Message, Message>>() {
        /* class io.flutter.wpkbridge.U4WPKAdapter.AnonymousClass1 */
    ...
    public static long goodTimeMillis() {
        if (sClientTimeMillis == -1) {
            ...
            long optLong = configs.optLong(WPKFactory.CONF_SERVER_TIME, -1);
            if (optLong != -1) {
                long optLong2 = configs.optLong(WPKFactory.CONF_CLIENT_TIME, -1);
                if (optLong2 != -1) {
