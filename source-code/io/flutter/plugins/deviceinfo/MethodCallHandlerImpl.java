...
public class MethodCallHandlerImpl implements MethodChannel.MethodCallHandler {
    ...
    MethodCallHandlerImpl(ContentResolver contentResolver2, PackageManager packageManager2) {
            ...
            if (!str.startsWith("generic") && !str.startsWith("unknown")) {
                ...
                if (!str2.contains("goldfish") && !str2.contains("ranchu")) {
                    ...
                    if (!model.contains("google_sdk") && !model.contains("Emulator") && !model.contains("Android SDK built for x86") && !Build.getMANUFACTURER().contains("Genymotion")) {
                        ...
                        return product.contains("sdk_google") || product.contains("google_sdk") || product.contains(a.C0103a.a) || product.contains("sdk_x86") || product.contains("vbox86p") || product.contains("emulator") || product.contains("simulator");
                    }
                }
            }
        }
