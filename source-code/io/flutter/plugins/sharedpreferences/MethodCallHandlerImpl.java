...
public class MethodCallHandlerImpl implements MethodChannel.MethodCallHandler {
    ...
    private void commitAsync(final SharedPreferences.Editor editor, final MethodChannel.Result result) {
        this.executor.execute(new Runnable() {
            /* class io.flutter.plugins.sharedpreferences.MethodCallHandlerImpl.AnonymousClass1 */

            public void run() {
                final boolean commit = editor.commit();
                MethodCallHandlerImpl.this.handler.post(new Runnable() {
                    /* class io.flutter.plugins.sharedpreferences.MethodCallHandlerImpl.AnonymousClass1.AnonymousClass1 */
