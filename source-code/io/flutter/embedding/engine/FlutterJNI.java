...
public class FlutterJNI {
    ...
    private static void asyncWaitForVsyncEx(final long j) {
        initVSyncThread();
        sVSyncHandler.post(new Runnable() {
            /* class io.flutter.embedding.engine.FlutterJNI.AnonymousClass2 */
    ...
    public static Bitmap decodeImage(@NonNull ByteBuffer byteBuffer, long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            try {
                return ImageDecoder.decodeBitmap(ImageDecoder.createSource(byteBuffer), new hm0(j));
            } catch (IOException e) {
    ...
    public static void decodeImageUsingExtendImageDecoder(@NonNull ByteBuffer byteBuffer, int i, String str, int i2, int i3, int i4, int i5, long j, long j2) {
        ...
        if (findExtendImageDecoder == null) {
            i6 = i2;
        } else {
            i6 = findExtendImageDecoder.fallbackWidth();
        }
        if (findExtendImageDecoder == null) {
            i7 = i3;
        } else {
            i7 = findExtendImageDecoder.fallbackHeight();
        }
        if (findExtendImageDecoder == null) {
            i8 = i4;
        } else {
            i8 = findExtendImageDecoder.fallbackColorType();
        }
        if (findExtendImageDecoder == null) {
            i9 = i5;
        } else {
            i9 = findExtendImageDecoder.fallbackAlphaType();
        }
        if (findExtendImageDecoder == null) {
            bitmap = null;
        } else {
            bitmap = findExtendImageDecoder.fallbackBitmap();
        }
        if (findExtendImageDecoder == null) {
            z = false;
        } else {
            z = findExtendImageDecoder.fallbackCanRecycle();
        }
        if (findExtendImageDecoder == null) {
            z2 = false;
        } else {
            z2 = findExtendImageDecoder.fallbackCanCache();
        }
        FlutterEngine.ExtendImageDecoderResponser extendImageDecoderResponser = new FlutterEngine.ExtendImageDecoderResponser(j, j2, i6, i7, i8, i9, bitmap, z, z2);
        boolean z3 = true;
        boolean z4 = findExtendImageDecoder != null && findExtendImageDecoder.supportSync() && (findExtendImageDecoder.preferSync() || !findExtendImageDecoder.preferAsync());
        boolean z5 = findExtendImageDecoder != null && findExtendImageDecoder.supportAsync() && !z4;
        if (j2 != 0) {
            z3 = false;
        }
        if (z5) {
            ...
            extendImageDecoderResponser.fallbackIfNeeded(0);
        } else {
            extendImageDecoderResponser.fallbackIfNeeded(0);
        }
    }
        ...
        synchronized (FlutterJNI.class) {
            if (sVSyncThread == null) {
                ...
                handler.post(new Runnable() {
                    /* class io.flutter.embedding.engine.FlutterJNI.AnonymousClass1 */
    ...
    public void handlePlatformMessage(@NonNull String str, ByteBuffer byteBuffer, int i) {
        PlatformMessageHandler platformMessageHandler2 = this.platformMessageHandler;
        if (platformMessageHandler2 != null) {
            platformMessageHandler2.handleMessageFromDart(str, byteBuffer, i);
        }
    }
    ...
    /* access modifiers changed from: package-private */
    @UiThread
    public void onPlatformViewDisplayedUpdated(int i, float f, int i2, int i3, int i4, int i5) {
        ensureRunningOnMainThread();
    ...
    public void onPresentSurface(long j) {
        ensureRunningOnMainThread();
        PresentSurfaceCallback presentSurfaceCallback2 = this.presentSurfaceCallback;
        if (presentSurfaceCallback2 != null) {
            presentSurfaceCallback2.onPresentSurface(j);
        }
    }
    ...
    public void onPresentSurfaceCompleted(long j) {
        ...
        PresentSurfaceCallback presentSurfaceCallback2 = this.presentSurfaceCallback;
        if (presentSurfaceCallback2 != null) {
            presentSurfaceCallback2.onPresentSurfaceCompleted(j);
        }
    }
    ...
    public void requestDartDeferredLibrary(int i) {
        ...
        if (deferredComponentManager2 != null) {
            deferredComponentManager2.installDeferredComponent(i, null);
        } else {
    ...
    @UiThread
    public void setPresentSurfaceCallback(@Nullable PresentSurfaceCallback presentSurfaceCallback2) {
        ensureRunningOnMainThread();
        this.presentSurfaceCallback = presentSurfaceCallback2;
    }
