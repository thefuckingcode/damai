...
public class SystemProperties {
    ...
    static {
        try {
            ...
            methodGet = cls.getMethod(gl1.TYPE_OPEN_URL_METHOD_GET, String.class);
            methodGetDef = systemPropertiesHelperClass.getMethod(gl1.TYPE_OPEN_URL_METHOD_GET, String.class, String.class);
