...
public class FlutterFPS {
    ...
    public static boolean calculate() {
        ...
        sOverallFps = (((double) sFrames) * 1000.0d) / ((double) j2);
        sOverallTime = 0;
        sFrames = 0;
        if (ENABLE_LOG) {
    ...
    public static void draw(Canvas canvas, View view, boolean z) {
        if (ENABLE) {
            ...
            int i2 = width - 2;
            int i3 = (sEngineVersion != null ? 30 : 0) + 30;
            if (sCommitHash != null) {
                i = 30;
            }
            int i4 = i3 + i;
            ...
            if (z) {
                ...
                canvas.translate((float) scrollX, (float) ((scrollY + height) - i4));
            }
            canvas.drawRect((float) (width - 250), 0.0f, (float) width, (float) i4, sFpsBgPaint);
            float f = (float) i2;
