...
public class InstantPatcher {
    ...
    private InstantPatcher(String str, Context context2) {
        this.context = context2;
        this.packageName = str;
        FileManager.context = context2;
    }
    ...
    public static InstantPatcher create(Context context2) {
        if (sInstantPatcher == null) {
            sInstantPatcher = new InstantPatcher(context2.getPackageName(), context2);
        }
    ...
    @RequiresApi(api = 3)
    private void handlePatch(FileState fileState, PatchResult patchResult) {
                ...
                if (file != null) {
                    if (file.exists()) {
                        AnonymousClass1 r2 = new Runnable() {
                            /* class com.android.alibaba.ip.server.InstantPatcher.AnonymousClass1 */
                        ...
                        if (i == 0) {
                            ThreadUtils.asyncExcute(r2);
                            return;
                        } else if (i == 1) {
                            ThreadUtils.syncExcute(r2);
                            return;
                        } else {
                            return;
                        }
        ...
        try {
            if (p6.a != null) {
                ...
                while (true) {
                    ...
                    if (p6.a.equals(next.processName)) {
                        if (next.pid == myPid) {
