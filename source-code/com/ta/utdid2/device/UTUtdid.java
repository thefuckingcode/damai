...
public class UTUtdid {
    ...
    private PersistentConfiguration mPersistentConfiguration = null;
    ...
    static boolean isValidUtdid(String str) {
    ...
    private String readUtdid() {
        ...
        if (isValidUtdid(utdidFromSp)) {
            ...
            startSyncThread(new SyncUtdidRunnable() {
                /* class com.ta.utdid2.device.UTUtdid.AnonymousClass3 */
        ...
        if (isValidUtdid(utdidFromMySp)) {
            ...
            startSyncThread(new SyncUtdidRunnable() {
                /* class com.ta.utdid2.device.UTUtdid.AnonymousClass4 */
        ...
        if (isValidUtdid(readUtdidDir)) {
            ...
            startSyncThread(new SyncUtdidRunnable() {
                /* class com.ta.utdid2.device.UTUtdid.AnonymousClass5 */
        ...
        if (isValidUtdid(readUtdidFromEcdid)) {
            ...
            startSyncThread(new SyncUtdidRunnable() {
                /* class com.ta.utdid2.device.UTUtdid.AnonymousClass6 */
    ...
    static void startSyncThread(final SyncUtdidRunnable syncUtdidRunnable) {
        new Thread("UtdidSyncThread") {
            /* class com.ta.utdid2.device.UTUtdid.AnonymousClass7 */
    ...
    private void writeNewUtdidAsync(final String str) {
        if (isValidUtdid(str)) {
            ...
            startSyncThread(new SyncUtdidRunnable() {
                /* class com.ta.utdid2.device.UTUtdid.AnonymousClass1 */
    ...
    private void writeSpFromSettingsAsync(final String str) {
        if (isValidUtdid(str)) {
            startSyncThread(new SyncUtdidRunnable() {
                /* class com.ta.utdid2.device.UTUtdid.AnonymousClass2 */
