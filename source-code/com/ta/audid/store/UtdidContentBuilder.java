...
public class UtdidContentBuilder {
    ...
    public static String buildUDID(String str) {
        ...
        return StringUtils.getStringWithoutBlank(String.format(BODY, AudidConfigListener.KEY, Variables.getInstance().getCurrentTimeMillisString(), buildAudidDataJsonString(str, UtdidKeyFile.readAudidFile(), "", context.getPackageName())));
    }
}
