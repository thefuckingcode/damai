...
public class ZCache {
    ...
    private static final ExecutorService taskQueue = new ThreadPoolExecutor(0, Integer.MAX_VALUE, 3, TimeUnit.SECONDS, new SynchronousQueue(), new ThreadFactory() {
        /* class com.taobao.zcache.ZCache.AnonymousClass3 */
    ...
    private static void registerOrangeListener() {
        try {
            OrangeConfig.getInstance().registerListener(new String[]{ConfigGroupName}, new OConfigListener() {
                /* class com.taobao.zcache.ZCache.AnonymousClass2 */
    ...
    public static void setup(Context context2, String str, String str2) {
        ...
        if (core == null) {
            ...
            new Thread("ZCache.InstallPreload") {
                /* class com.taobao.zcache.ZCache.AnonymousClass1 */
        ...
        if (resourceResponseCallback != null) {
            ...
            if (core == null) {
                ...
                taskQueue.execute(new Runnable() {
                    /* class com.taobao.zcache.ZCache.AnonymousClass4 */

                    public void run() {
                        ZCacheCoreProxy.core().getResource(resourceRequest, resourceResponseCallback);
                    }
                });
            } else {
