...
public class ZCacheCoreWrapper implements IZCacheCore {
    ...
    public ZCacheCoreWrapper(Context context) {
        ...
        NetworkUtils.setListener(new NetworkUtils.NetworkListener() {
            /* class com.taobao.zcache.core.ZCacheCoreWrapper.AnonymousClass1 */
    ...
    private void sendRequest(DownloadRequest downloadRequest, final long j) {
        this.downloadFactory.sendRequest(downloadRequest, new DownloadFinishedCallback() {
            /* class com.taobao.zcache.core.ZCacheCoreWrapper.AnonymousClass2 */
    ...
    private native boolean setProxyNative(ZCacheCoreWrapper zCacheCoreWrapper, AssetManager assetManager2);
    ...
    private boolean subscribePushMessage(String str, final long j) {
        ...
        pushService.subscribePushMessage(str, new PushMessageCallback() {
            /* class com.taobao.zcache.core.ZCacheCoreWrapper.AnonymousClass3 */
    ...
    public void setDownloadFactory(DownloadFactory downloadFactory2) {
        if (downloadFactory2 == null) {
