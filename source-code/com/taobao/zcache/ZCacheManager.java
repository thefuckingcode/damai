...
public class ZCacheManager {
    ...
    public void getAppPath(String str, final IZCacheCore.AppInfoCallback appInfoCallback) {
        ...
        if (core != null) {
            core.loadAppReader(str, new IZCacheCore.AppReaderInfoCallback() {
                /* class com.taobao.zcache.ZCacheManager.AnonymousClass1 */

                @Override // com.taobao.zcache.core.IZCacheCore.AppReaderInfoCallback
                public void finish(AppInfo appInfo, Error error) {
                    IZCacheCore.AppInfoCallback appInfoCallback = appInfoCallback;
                    if (appInfoCallback != null) {
                        appInfoCallback.onReceive(appInfo, new Error(error));
                    }
                }
            });
        }
    ...
    public void updatePack(String str, String str2, int i, final IZCacheCore.UpdateCallback updateCallback) {
        ZCache.updatePack(new PackRequest(str, str2), new PackUpdateFinishedCallback() {
            /* class com.taobao.zcache.ZCacheManager.AnonymousClass2 */

            @Override // com.taobao.zcache.PackUpdateFinishedCallback
            public void finish(String str, Error error) {
                IZCacheCore.UpdateCallback updateCallback = updateCallback;
                if (updateCallback != null) {
                    updateCallback.finish(str, new Error(error));
                }
            }
        });
    }
