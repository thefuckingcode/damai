...
public class SDKJSBridgeService extends WVApiPlugin {
    ...
    public class a extends AsyncTask<Object, Void, RpcResponse<LoginReturnData>> {
        ...
        public void onPostExecute(RpcResponse<LoginReturnData> rpcResponse) {
            String str;
            T t;
            if (rpcResponse == null || (t = rpcResponse.returnValue) == null || rpcResponse.code != 3000) {
                int i = -1;
                if (rpcResponse != null) {
                    i = rpcResponse.code;
                ...
                if (wVCallBackContext != null) {
                    SDKJSBridgeService.this.failCallback(wVCallBackContext, str, String.valueOf(i));
                    return;
                }
                return;
            }
            LoginDataHelper.processLoginReturnData(true, (LoginReturnData) t, "");
