...
public class SessionManager implements ISession {
    ...
    private void clearChildProcessCookies() {
        new Thread("clear-cookie-data") {
            /* class com.taobao.login4android.session.SessionManager.AnonymousClass2 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void sendCustomTrack(String str, String str2, Map<String, String> map) {
        try {
    ...
    public void appendEventTrace(String str) {
        if (!TextUtils.isEmpty(str)) {
            ...
            if (length > 512) {
                try {
                    if (str2.contains(jl1.BLOCK_START_STR) && str2.contains("}")) {
                        int indexOf = str2.indexOf(jl1.BLOCK_START_STR);
    ...
    public long getHavanaSsoTokenExpiredTime() {
        ...
        if (this.mHavanaSsoTokenExpiredTime <= 0 && (sharedPreferences = this.storage) != null) {
            this.mHavanaSsoTokenExpiredTime = sharedPreferences.getLong(SessionConstants.HAVANA_SSO_TOKEN_EXPIRE, 0);
        }
    ...
    public long getLoginTime() {
        ...
        if (this.mLoginTime == 0 && (sharedPreferences = this.storage) != null) {
            this.mLoginTime = sharedPreferences.getLong(SessionConstants.LOGIN_TIME, 0);
        }
    ...
    public long getSessionExpiredTime() {
        ...
        if (this.mSessionExpiredTime <= 0 && (sharedPreferences = this.storage) != null) {
            this.mSessionExpiredTime = sharedPreferences.getLong(SessionConstants.SESSION_EXPIRED_TIME, 0);
        }
    ...
    /* JADX WARNING: Can't wrap try/catch for region: R(12:0|(13:2|(1:6)|7|(1:9)|10|11|12|(1:14)|17|(1:19)|20|(1:22)(1:23)|24)|25|(1:27)|28|29|30|31|32|(1:36)|37|41) */
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0209, code lost:
        r0 = move-exception;
     */
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:31:0x017b */
    @Override // com.taobao.login4android.session.ISession
    ...
    public boolean recoverCookie() {
        ...
        LoginTLogAdapter.e(TAG, "recoverCookie size:" + list.size());
        if (SessionConstants.IS_CHECK_COOKIE_VALID && LoginSwitch.getSwitch("new_validate_cookie", "true")) {
            LoginTLogAdapter.e(TAG, "new_validate_cookie");
            if (checkSessionValid()) {
                ...
                while (true) {
                    ...
                    if (next != null && !TextUtils.isEmpty(next.domain) && TextUtils.equals(next.domain.trim(), ".taobao.com") && !TextUtils.isEmpty(next.name)) {
                        if (TextUtils.equals(next.name.trim(), "unb") || TextUtils.equals(next.name.trim(), "munb")) {
                            LoginTLogAdapter.i(TAG, "unb:" + next.value + ", unb = " + getUserId());
                            if (!TextUtils.isEmpty(next.value) && !TextUtils.equals(next.value, getUserId())) {
                                break;
                            }
                        }
                    }
                ...
                for (LoginCookie loginCookie2 : arrayList) {
                    if (loginCookie2 != null) {
                        ...
                        for (String str2 : ssoDomainList) {
                            ...
                            LoginTLogAdapter.i(TAG, "add cookies to domain:" + str2 + ", cookie = " + loginCookie3);
    ...
    private SessionManager(Context context) {
        if (context != null) {
            ...
            new Thread("login-session-init") {
                /* class com.taobao.login4android.session.SessionManager.AnonymousClass1 */
                ...
                public void run() {
                    ...
                    BroadcastReceiver unused3 = SessionManager.receiver = new BroadcastReceiver() {
                        /* class com.taobao.login4android.session.SessionManager.AnonymousClass1.AnonymousClass1 */
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            if (intent != null && TextUtils.equals(intent.getAction(), SessionManager.CLEAR_SESSION_ACTION)) {
                                LoginTLogAdapter.e(SessionManager.TAG, "receive CLEAR_SESSION_ACTION in currentProcessName:" + curProcessName + " sendProcessName:" + str);
                                if (!TextUtils.equals(curProcessName, str)) {
                                    ...
                                    new Thread("init-session-data") {
                                        /* class com.taobao.login4android.session.SessionManager.AnonymousClass1.AnonymousClass1.AnonymousClass1 */
                                ...
                                LoginTLogAdapter.e(SessionManager.TAG, "receive CLEAR_SESSION_COOKIES_ACTION in currentProcessName:" + curProcessName + " sendProcessName:" + str);
                                if (!TextUtils.equals(curProcessName, str)) {
                                    ...
                                    } else if (!LoginSwitch.getSwitch("ingoreChannelProcess", "true")) {
                                        SessionManager.this.clearChildProcessCookies();
                                    }
                                }
                            }
