    ...
    public GetThirdCookiesResponseData getAlipayCookies() {
        ...
        if (instance.checkSessionValid()) {
            try {
                ...
                return (GetThirdCookiesResponseData) ((RpcService) ServiceFactory.getService(RpcService.class)).post(rpcRequest, GetThirdCookiesResponseData.class, instance.getUserId());
