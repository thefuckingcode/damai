    ...
    private RpcResponse<LoginReturnData> autoLogin(String str, String str2, int i, String str3, boolean z, String str4) {
        ...
        if (rpcResponse == null || !"SUCCESS".equals(rpcResponse.actionType)) {
            ...
            try {
                ...
                UserTrackAdapter.sendUT(UTConstant.PageName.UT_PAGE_EXTEND, "autoLogin_failure", String.valueOf(i2), properties2);
            } catch (Exception e3) {
                e3.printStackTrace();
            }
            ...
            UserTrackAdapter.sendUT(UTConstant.PageName.UT_PAGE_EXTEND, "autoLogin_success", properties3);
        }
        return rpcResponse;
    }
}
