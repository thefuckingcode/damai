        ...
        synchronized (DefaultLoginImpl.class) {
            if (this.receiver == null) {
                AnonymousClass1 r1 = new BroadcastReceiver() {
                    /* class com.taobao.tao.remotebusiness.login.DefaultLoginImpl.AnonymousClass1 */
                ...
                this.receiver = r1;
                invokeMethod(this.registerReceiverMethod, mContext, r1);
            }
        }
    }
            ...
            try {
                ...
                try {
                    ...
                    MtopSDKThreadPoolExecutorFactory.submit(new Runnable() {
                        /* class com.taobao.tao.remotebusiness.login.DefaultLoginImpl.AnonymousClass2 */
                        ...
                        public void run() {
                            try {
                                if (DefaultLoginImpl.isRegistered.compareAndSet(false, true)) {
                                    ...
                                    IUploadStats iUploadStats = iUploadStats;
                                    if (iUploadStats != null) {
                                        iUploadStats.onRegister(DefaultLoginImpl.STATS_MODULE_MTOPRB, DefaultLoginImpl.STATS_MONITOR_POINT_SESSION_INVALID, hashSet, null, false);
                                    }
                                    if (TBSdkLog.isLogEnable(TBSdkLog.LogEnable.ErrorEnable)) {
                                ...
                                if (iUploadStats2 != null) {
                                    iUploadStats2.onCommit(DefaultLoginImpl.STATS_MODULE_MTOPRB, DefaultLoginImpl.STATS_MONITOR_POINT_SESSION_INVALID, hashMap, null);
                                }
                            } catch (Exception e) {
                                TBSdkLog.e(DefaultLoginImpl.TAG, "upload  SessionInvalid Stats error.", e);
                            }
                        }
                    });
                    threadLocal.remove();
