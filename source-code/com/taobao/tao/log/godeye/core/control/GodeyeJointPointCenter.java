    ...
    private static class GodeyeStartJointPointCallbackWithDelayStop extends IGodeyeJointPointCenter.GodeyeJointPointCallback {
        ...
        public void doCallback() {
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                /* class com.taobao.tao.log.godeye.core.control.GodeyeJointPointCenter.GodeyeStartJointPointCallbackWithDelayStop.AnonymousClass1 */
            ...
            if (this.mDelayStopMilliSeconds > 0) {
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    /* class com.taobao.tao.log.godeye.core.control.GodeyeJointPointCenter.GodeyeStartJointPointCallbackWithDelayStop.AnonymousClass2 */
