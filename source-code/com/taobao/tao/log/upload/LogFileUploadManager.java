...
public class LogFileUploadManager {
    ...
    private boolean filePathUpload(String str, UploadReason uploadReason, List<String> list, String str2, String str3, String str4, Map<String, String> map, FileUploadListener fileUploadListener) {
        if ("exception".equalsIgnoreCase(str3) || TextUtils.isEmpty(str2)) {
            String str5 = TAG;
            Log.w(str5, "unSupport type :" + str2 + " " + str3);
            TLogMonitor tLogMonitor = TLogInitializer.getInstance().gettLogMonitor();
            String str6 = TLogStage.MSG_LOG_UPLOAD;
            String str7 = TAG;
            tLogMonitor.stageError(str6, str7, "unSupport type :" + str2 + " " + str3 + this.uploadId + " isForceUpload:" + this.isForceUpload);
        ...
        String str9 = TAG;
        tLogMonitor2.stageInfo(str8, str9, "文件上传：触发主动上传文件，" + str3);
    ...
    private void uploadFailed(String str, String str2, String str3, String str4, String str5) {
        StringBuilder sb = new StringBuilder();
        sb.append("文件上传：文件上传失败,uploadId=");
    ...
    private void uploadFile(boolean z) {
        TLogThreadPool.getInstance().executeUpload(new y81(this, z));
    }
            ...
            if (this.mFiles.size() != 0) {
                ...
                if (this.logUploader != null) {
                    ...
                    if (this.logUploader.getUploadInfo().type.equals(TLogConstant.TOKEN_TYPE_OSS)) {
                        ...
                        this.logUploader.startUpload(uploaderParam, str5, new TLogUploadListener(str5, uploaderParam.fileContentType, str2, str));
                    }
                    str2 = str4;
                    str = str3;
                    TLogInitializer.getInstance().gettLogMonitor().stageInfo(TLogStage.MSG_LOG_UPLOAD, TAG, "文件上传：校验通过，调用上传通道,uploadId=" + this.uploadId);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void uploadSuccess(String str, String str2, String str3, String str4, String str5) {
        String str6 = this.uploadId;
        if (str6 == null) {
            str6 = "-";
        }
