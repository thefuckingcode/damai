    ...
    public static List<String> getFilePath(String str, Integer num) {
        ...
        if (file.exists()) {
            ...
            for (int i = 0; i < listFiles.length; i++) {
                ...
                if (!TextUtils.isEmpty(name) && !name.endsWith("mmap2") && !name.equals(lf1.CACHE_MMAP)) {
                    if (name.equals(str)) {
    ...
    public static Map<String, LogLevel> makeModule(String str) {
        ...
        if (split != null) {
            ...
            for (String str2 : split) {
                String[] split2 = str2.split(o70.DINAMIC_PREFIX_AT);
    ...
    public static List<String> getFilePath(String str, int i, String[] strArr) {
        ...
        if (file.exists()) {
            ...
            for (int i2 = 0; i2 < listFiles.length; i2++) {
                ...
                if (!TextUtils.isEmpty(name) && !name.endsWith("mmap2") && !name.endsWith(lf1.CACHE_MMAP)) {
                    if (name.equals(str)) {
