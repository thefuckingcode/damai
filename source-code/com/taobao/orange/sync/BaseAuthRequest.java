...
public abstract class BaseAuthRequest<T> extends BaseRequest<T> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:49:0x010a A[RETURN] */
        ...
        try {
            ...
            if (iNetConnection instanceof HurlNetConnection) {
                ...
                try {
                    ...
                    int responseCode2 = iNetConnection.getResponseCode();
                    ...
                    if (OLog.isPrintLog(3)) {
                        OLog.w(TAG, "syncRequest fail", th3, "host", this.mHost);
                    }
