...
public class OrangeMonitor {
    ...
    public static void commitBootPerformanceInfo(OrangeMonitorData orangeMonitorData) {
        if (mAppMonitorValid) {
            ...
            String str = "1";
            create.setValue("bootType", orangeMonitorData.performance.bootType ? str : "0");
    ...
    public static void commitFileStatMonitor(String str, boolean z, boolean z2, int i, double d) {
        ...
        if (mAppMonitorValid) {
            ...
            String str3 = "1";
            create.setValue("success", z ? str3 : "0");
            if (z2) {
                str2 = str3;
            } else {
                str2 = "0";
            ...
            create.setValue("processIsolated", str3);
    ...
    public static void commitConfigMonitor(String str, String str2, String str3, String str4, String str5) {
        if (mAppMonitorValid) {
            ...
            String str6 = "1";
            create.setValue("enableChangeVersion", ((Integer) SPUtil.getFromSharePreference(GlobalOrange.context, "enableChangeVersion", 0)).intValue() > 0 ? str6 : "0");
            create.setValue("process", AndroidUtil.currentProcess);
            if (!GlobalOrange.processIsolated) {
                str6 = "0";
            }
