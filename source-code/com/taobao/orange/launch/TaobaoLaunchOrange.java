    ...
    public void init(Application application, HashMap<String, Object> hashMap) {
        ...
        try {
            ...
            try {
                ...
                str = "21646297";
                str2 = str3;
                OrangeConfig.getInstance().init(application, new OConfig.Builder().setAppKey(str).setAppVersion(str2).setEnv(envMode).setServerType(OConstant.SERVER.TAOBAO.ordinal()).setIndexUpdateMode(OConstant.UPDMODE.O_XMD.ordinal()).setReportAck(false).setStatUsedConfig(true).setTime(-1).build());
            }
        } catch (Throwable th3) {
            th = th3;
            OLog.e(TAG, UCCore.LEGACY_EVENT_INIT, th, new Object[0]);
