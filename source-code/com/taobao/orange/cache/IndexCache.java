...
public class IndexCache {
    ...
    private List<String> diffCache(IndexDO indexDO) {
        ...
        OThreadFactory.executeDisk(new Runnable() {
            /* class com.taobao.orange.cache.IndexCache.AnonymousClass2 */
    ...
    public List<String> cache(IndexDO indexDO) {
        ...
        updateOrangeHeader();
        OThreadFactory.executeDisk(new Runnable() {
            /* class com.taobao.orange.cache.IndexCache.AnonymousClass1 */
    ...
    public String getCdnUrl() {
        ...
        return GlobalOrange.schema + ke1.SCHEME_SLASH + this.mIndex.cdn;
    }
