...
public class WXSDKManager {
    ...
    public static int w(String str) {
        WXSDKInstance y2 = v().y(str);
        if (y2 == null) {
            return FeatureFactory.PRIORITY_ABOVE_NORMAL;
        }
        return y2.getInstanceViewPortWidth();
    }
    ...
    @Deprecated
    public void b(String str, String str2, Map<String, Object> map, boolean z2) {
        this.b.callback(str, str2, map, z2);
    }

    /* access modifiers changed from: package-private */
    public void c(WXSDKInstance wXSDKInstance, s42 s42, Map<String, Object> map, String str) {
        this.c.registerInstance(wXSDKInstance);
        this.b.createInstance(wXSDKInstance.getInstanceId(), s42, map, str);
