...
public class WXSDKInstance implements View.OnLayoutChangeListener, IWXActivityStateListener {
    ...
    private c mHttpListener;
    private ImageNetworkHandler mImageNetworkHandler;
    private final String mInstanceId;
    private List<l11> mInstanceOnFireEventInterceptorList;
    ...
    private void checkWhiteScreen() {
        if (!this.isDestroy && oz2.b() && oz2.f(this)) {
    ...
    private String filterUrlByEaglePlugin(String str) {
        Pair<String, WXEaglePlugin> a2 = b.b().a(str);
        if (a2 == null) {
            return null;
        }
        ...
        this.mRenderStrategy = b.e(pluginName);
        return str2;
    }
    ...
    private void onInterceptInstanceEvent(String str, String str2, String str3, Map<String, Object> map, Map<String, Object> map2) {
        List<l11> list = this.mInstanceOnFireEventInterceptorList;
        if (list != null) {
            for (l11 l11 : list) {
                l11.onInterceptFireEvent(str, str2, str3, map, map2);
            }
        }
    }
    ...
    private void renderByUrlInternal(String str, String str2, Map<String, Object> map, String str3, WXRenderStrategy wXRenderStrategy) {
        ...
        if (parse == null || !TextUtils.equals(parse.getScheme(), "file")) {
            ...
            wXRequest.paramMap.put("user-agent", jx2.a(this.mContext, WXEnvironment.getConfig()));
            wXRequest.paramMap.put("isBundleRequest", "true");
            c cVar = new c(this, wrapPageName, map, str3, wXRenderStrategy, System.currentTimeMillis());
        ...
        render(wrapPageName, loadFileOrAsset, map, str3, wXRenderStrategy);
    }
    ...
    private void renderInternal(String str, String str2, Map<String, Object> map, String str3, WXRenderStrategy wXRenderStrategy) {
        if (!this.mRendered && !TextUtils.isEmpty(str2)) {
            renderInternal(str, new s42(str2), map, str3, wXRenderStrategy);
        }
    }
        ...
        if (this.mFixMultiThreadBug) {
            if (this.mPageDirty) {
                WXBridgeManager.getInstance().post(new Runnable() {
                    /* class com.taobao.weex.WXSDKInstance.AnonymousClass12 */
            ...
            WXBridgeManager.getInstance().post(new Runnable() {
                /* class com.taobao.weex.WXSDKInstance.AnonymousClass13 */
    ...
    public void addInstanceOnFireEventInterceptor(l11 l11) {
        if (l11 != null && !getInstanceOnFireEventInterceptorList().contains(l11)) {
            getInstanceOnFireEventInterceptorList().add(l11);
        }
    }
    ...
    public synchronized void destroy() {
        if (!isDestroy()) {
            WXBridgeManager.getInstance().post(new Runnable() {
                /* class com.taobao.weex.WXSDKInstance.AnonymousClass8 */
            ...
            WXBridgeManager.getInstance().post(new Runnable() {
                /* class com.taobao.weex.WXSDKInstance.AnonymousClass9 */
            ...
            WXBridgeManager.getInstance().postDelay(new Runnable() {
                /* class com.taobao.weex.WXSDKInstance.AnonymousClass10 */
    ...
    public List<l11> getInstanceOnFireEventInterceptorList() {
    ...
    public void onJSException(final String str, final String str2, final String str3) {
        ...
        if (this.mRenderListener != null && this.mContext != null) {
            ...
            runOnUiThread(new Runnable() {
                /* class com.taobao.weex.WXSDKInstance.AnonymousClass6 */
    ...
    public void onOldFsRenderTimeLogic() {
        if (!this.mEnd) {
            ...
            if (!(this.mStatisticsListener == null || this.mContext == null)) {
                runOnUiThread(new Runnable() {
                    /* class com.taobao.weex.WXSDKInstance.AnonymousClass7 */
    ...
    public void onRenderError(final String str, final String str2) {
        ...
        if (this.mRenderListener != null && this.mContext != null) {
            ...
            runOnUiThread(new Runnable() {
                /* class com.taobao.weex.WXSDKInstance.AnonymousClass5 */
    ...
    public void onRenderSuccess(int i, int i2) {
        ...
        wXPerformance.totalTime = (double) currentTimeMillis;
        if (((double) wXPerformance.screenRenderTime) < 0.001d) {
    ...
    public void preInit(String str, String str2, Map<String, Object> map, String str3, WXRenderStrategy wXRenderStrategy) {
        ...
        this.mApmForInstance.z = false;
        WXSDKManager.v().c(this, new s42(str2), map, str3);
    }
    ...
    public void registerReactorJSContext(final long j) {
        if (isUsingReactorPage()) {
            if (WXBridgeManager.getInstance().getJSLooper() == Looper.myLooper()) {
                this.mReactorPage = rx2.b().a(j, getInstanceId());
            } else {
                WXBridgeManager.getInstance().post(new Runnable() {
                    /* class com.taobao.weex.WXSDKInstance.AnonymousClass14 */

                    public void run() {
                        WXSDKInstance.this.mReactorPage = rx2.b().a(j, WXSDKInstance.this.getInstanceId());
                    }
                });
            }
        }
    ...
    public void setMaxDeepLayer(int i) {
        ...
        this.mApmForInstance.D(WXInstanceApm.KEY_PAGE_STATS_MAX_DEEP_VIEW, (double) i);
    }

    public void setMaxDomDeep(int i) {
        this.mApmForInstance.D(WXInstanceApm.KEY_PAGE_STATS_MAX_DEEP_DOM, (double) i);
        WXPerformance wXPerformance = this.mWXPerformance;
    ...
    public void setPreRenderMode(final boolean z) {
        WXSDKManager.v().G().postOnUiThread(new Runnable() {
            /* class com.taobao.weex.WXSDKInstance.AnonymousClass4 */
    ...
    public void setSize(int i, int i2) {
        if (i > 0) {
            if (((i2 > 0) && (!this.isDestroy)) && this.mRendered && this.mRenderContainer != null) {
                ...
                if (i3 > 0) {
                    double d = 100.0d;
                    double d2 = (((double) i2) / ((double) i3)) * 100.0d;
                    if (d2 <= 100.0d) {
                        d = d2;
                    }
                    getApmForInstance().g(WXInstanceApm.KEY_PAGE_STATS_BODY_RATIO, d);
                }
                ...
                if (layoutParams != null) {
                    ...
                    if (this.mRootComp != null) {
                        ...
                        WXBridgeManager.getInstance().post(new Runnable() {
                            /* class com.taobao.weex.WXSDKInstance.AnonymousClass11 */
    ...
    public void setWXAbstractRenderContainer(WXAbstractRenderContainer wXAbstractRenderContainer) {
        ...
        if (wXAbstractRenderContainer == null || wXAbstractRenderContainer.getLayoutParams() == null || this.mRenderContainer.getLayoutParams().width != -2) {
            WXBridgeManager.getInstance().post(new Runnable() {
                /* class com.taobao.weex.WXSDKInstance.AnonymousClass2 */
            ...
            WXBridgeManager.getInstance().post(new Runnable() {
                /* class com.taobao.weex.WXSDKInstance.AnonymousClass1 */
    ...
    private void renderInternal(String str, s42 s42, Map<String, Object> map, String str2, WXRenderStrategy wXRenderStrategy) {
        if (!this.mRendered && s42 != null && !s42.c()) {
            ...
            if (sx2.b()) {
                sx2.a c2 = sx2.c("executeBundleJS", this.mInstanceId, -1);
            ...
            if (!WXEnvironment.sDynamicMode || TextUtils.isEmpty(WXEnvironment.sDynamicUrl) || map.get("dynamicMode") != null) {
                new TimeCalculator(this);
                this.mWXPerformance.JSTemplateSize = (double) (((float) s42.d()) / 1024.0f);
                ...
                if (isPreInitMode()) {
                    ...
                    WXBridgeManager.getInstance().loadJsBundleInPreInitMode(getInstanceId(), s42.b());
                } else {
                    WXSDKManager.v().c(this, s42, map, str2);
                }
                createLogDetail.taskEnd();
                this.mRendered = true;
                ...
                if (F != null && F.shouldReboot()) {
                    WXSDKManager.v().N(new Runnable() {
                        /* class com.taobao.weex.WXSDKInstance.AnonymousClass3 */
            ...
            map.put("dynamicMode", "true");
            renderByUrl(str, WXEnvironment.sDynamicUrl, map, str2, wXRenderStrategy);
        }
    }

    public void render(String str, String str2, Map<String, Object> map, String str3, WXRenderStrategy wXRenderStrategy) {
        render(str, new s42(str2), map, str3, wXRenderStrategy);
    }
    ...
    public void render(String str, s42 s42, Map<String, Object> map, String str2, WXRenderStrategy wXRenderStrategy) {
        this.mWXPerformance.beforeInstanceRender(this.mInstanceId);
        if (!WXEnvironment.isApkDebugable() || !"default".equals(str)) {
            renderInternal(str, s42, map, str2, wXRenderStrategy);
    ...
    public void render(String str, byte[] bArr, Map<String, Object> map, String str2) {
        render(str, new s42(bArr), map, str2, WXRenderStrategy.DATA_RENDER_BINARY);
    }
