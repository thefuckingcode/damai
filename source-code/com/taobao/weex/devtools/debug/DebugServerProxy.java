...
public class DebugServerProxy {
    ...
    public void start() {
        synchronized (DebugServerProxy.class) {
            ...
            WXDebugBridge instance = WXDebugBridge.getInstance();
            this.mWXBridge = instance;
            instance.setSession(this.mWebSocketClient);
            ...
            this.mWebSocketClient.connect(this.mRemoteUrl, new SocketClient.Callback() {
                /* class com.taobao.weex.devtools.debug.DebugServerProxy.AnonymousClass1 */
                    ...
                    synchronized (DebugServerProxy.class) {
                        if (DebugServerProxy.this.mWebSocketClient != null && DebugServerProxy.this.mWebSocketClient.isOpen()) {
                            ...
                            WXSDKManager.v().N(new Runnable() {
                                /* class com.taobao.weex.devtools.debug.DebugServerProxy.AnonymousClass1.AnonymousClass1 */
