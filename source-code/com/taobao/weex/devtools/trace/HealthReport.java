...
public class HealthReport {
    ...
    public void writeToConsole() {
        Log.d(TAG, "health report(" + this.bundleUrl + jl1.BRACKET_END_STR);
        ...
        if (list != null && !list.isEmpty()) {
            ...
            for (EmbedDesc embedDesc : this.embedDescList) {
                Log.d(TAG, "[health report] embedDesc: (src:" + embedDesc.src + ",layer:" + embedDesc.actualMaxLayer + jl1.BRACKET_END_STR);
            }
        }
        ...
        if (map2 != null) {
            for (Map.Entry<String, String> entry : map2.entrySet()) {
                Log.d(TAG, "[health report] " + entry.getKey() + ":" + entry.getValue() + jl1.BRACKET_END_STR);
            }
        }
    }
