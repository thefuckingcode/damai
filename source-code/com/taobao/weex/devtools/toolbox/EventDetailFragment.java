...
public class EventDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        for (int i3 = 0; i3 < this.rootEvent.m.size(); i3++) {
            sx2.a valueAt = this.rootEvent.m.valueAt(i3);
            if (!"DomExecute".equals(valueAt.a) && !"UIExecute".equals(valueAt.a)) {
                ...
                int screenWidth = (int) ((((double) (j - aVar.e)) / aVar.l) * ((double) (WXViewUtils.getScreenWidth(getContext()) - WXViewUtils.dip2px(8.0f))));
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) eventView.indicator.getLayoutParams();
                marginLayoutParams.width = ((int) ((valueAt.l / this.rootEvent.l) * ((double) WXViewUtils.getScreenWidth(getContext())))) + WXViewUtils.dip2px(2.0f);
        ...
        if (str != null) {
            try {
                if (str.startsWith(jl1.BLOCK_START_STR)) {
                    JSONObject jSONObject = new JSONObject(this.rootEvent.n);
                    this.rootEvent.n = jSONObject.toString(2);
                } else if (this.rootEvent.n.startsWith(jl1.ARRAY_START_STR)) {
