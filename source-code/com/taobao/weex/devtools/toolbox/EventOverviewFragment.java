...
public class EventOverviewFragment extends Fragment {
    ...
    private class PerfListAdapter extends RecyclerView.Adapter<ItemHolder> {
        private sx2.a rootEvent;

        public PerfListAdapter(sx2.a aVar) {
            this.rootEvent = aVar;
        }
        ...
        public void onBindViewHolder(final ItemHolder itemHolder, int i) {
            final sx2.a valueAt = this.rootEvent.m.valueAt(i);
            itemHolder.itemView.setOnClickListener(new View.OnClickListener() {
                /* class com.taobao.weex.devtools.toolbox.EventOverviewFragment.PerfListAdapter.AnonymousClass1 */
            ...
            itemHolder.itemView.post(new Runnable() {
                /* class com.taobao.weex.devtools.toolbox.EventOverviewFragment.PerfListAdapter.AnonymousClass2 */

                public void run() {
                    ViewGroup.MarginLayoutParams marginLayoutParams = marginLayoutParams;
                    marginLayoutParams.width = (int) ((valueAt.l / PerfListAdapter.this.rootEvent.l) * ((double) itemHolder.getItemWidth()));
                    marginLayoutParams.leftMargin = (int) ((((double) (valueAt.e - PerfListAdapter.this.rootEvent.e)) / PerfListAdapter.this.rootEvent.l) * ((double) itemHolder.getItemWidth()));
            ...
            if (valueAt.g != null) {
                ...
                if (wXComponent != null) {
                    ...
                    textView2.setText(jl1.L + componentType + "/>");
