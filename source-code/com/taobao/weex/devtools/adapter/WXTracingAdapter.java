...
public class WXTracingAdapter implements ITracingAdapter {
    private volatile SparseArray<sx2.a> traceEvents = new SparseArray<>();

    public WXTracingAdapter() {
        WXSDKManager.v().Q(new WXSDKManager.InstanceLifeCycleCallbacks() {
            /* class com.taobao.weex.devtools.adapter.WXTracingAdapter.AnonymousClass1 */
    ...
    private void collectNativeTracingData(sx2.a aVar, JSONArray jSONArray) {
        if (aVar.m != null) {
            for (int i = 0; i < aVar.m.size(); i++) {
                sx2.a valueAt = aVar.m.valueAt(i);
                if (!valueAt.p) {
    ...
    private void enableMonitor(final String str) {
        ...
        if (y != null) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                /* class com.taobao.weex.devtools.adapter.WXTracingAdapter.AnonymousClass2 */
    ...
    private JSONObject parseToJSONObject(sx2.a aVar) {
    ...
    private void sendSummaryInfo(String str) {
    ...
    private void sendTracingData(final String str) {
        ...
        WXDebugBridge.getInstance().post(new Runnable() {
            /* class com.taobao.weex.devtools.adapter.WXTracingAdapter.AnonymousClass3 */
    ...
    public sx2.a getTraceEventByInstanceId(int i) {
        return this.traceEvents.get(i);
    }

    @Override // com.taobao.weex.adapter.ITracingAdapter
    public void submitTracingEvent(sx2.a aVar) {
        int parseInt = Integer.parseInt(aVar.f);
        if (parseInt == -1) {
            WXLogUtils.e("Wrong instance id: " + parseInt);
        }
        sx2.a aVar2 = this.traceEvents.get(parseInt);
        if (aVar2 == null) {
            aVar2 = new sx2.a();
            aVar2.d = parseInt;
            aVar2.e = aVar.e;
        ...
        if ("renderFinish".equals(aVar.a)) {
            aVar2.l = aVar.l;
            SparseArray<sx2.a> sparseArray = aVar2.m;
            if (sparseArray != null) {
                aVar.l = 0.0d;
        ...
        if (i == -1) {
            ...
            } else if (ExifInterface.LONGITUDE_EAST.equals(aVar.c)) {
                sx2.a aVar3 = aVar2.m.get(aVar.d);
                if (aVar3 == null) {
                    WXLogUtils.w("WXTracingAdapter", "begin event not found: " + aVar.a + o70.DINAMIC_PREFIX_AT + aVar.d);
                    return;
                }
                aVar3.l = (double) (aVar.e - aVar3.e);
                aVar3.c = "X";
            }
        } else {
            sx2.a aVar4 = aVar2.m.get(i);
            if (aVar4 != null) {
                if (aVar4.m == null) {
