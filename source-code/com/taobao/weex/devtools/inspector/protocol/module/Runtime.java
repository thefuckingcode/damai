...
public class Runtime implements ChromeDevtoolsDomain {
    ...
    public Runtime() {
        this(new RuntimeReplFactory() {
            /* class com.taobao.weex.devtools.inspector.protocol.module.Runtime.AnonymousClass1 */

            @Override // com.taobao.weex.devtools.inspector.console.RuntimeReplFactory
            public RuntimeRepl newInstance() {
                return new RuntimeRepl() {
                    /* class com.taobao.weex.devtools.inspector.protocol.module.Runtime.AnonymousClass1.AnonymousClass1 */
        ...
        synchronized (Runtime.class) {
            ...
            if (session == null) {
                ...
                jsonRpcPeer.registerDisconnectReceiver(new DisconnectReceiver() {
                    /* class com.taobao.weex.devtools.inspector.protocol.module.Runtime.AnonymousClass2 */
