...
public class CSS implements ChromeDevtoolsDomain {
    ...
    private void mockStyleProperty(List<CSSComputedStyleProperty> list, HashMap<String, String> hashMap) {
    ...
    public JsonRpcResult getComputedStyleForNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        this.mDocument.postAndWait(new Runnable() {
            /* class com.taobao.weex.devtools.inspector.protocol.module.CSS.AnonymousClass1 */
            ...
            public void run() {
                ...
                CSS.this.mDocument.getElementStyles(elementForNodeId, new StyleAccumulator() {
                    /* class com.taobao.weex.devtools.inspector.protocol.module.CSS.AnonymousClass1.AnonymousClass1 */
    ...
    public JsonRpcResult getMatchedStylesForNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        this.mDocument.postAndWait(new Runnable() {
            /* class com.taobao.weex.devtools.inspector.protocol.module.CSS.AnonymousClass2 */
            ...
            public void run() {
                ...
                CSS.this.mDocument.getElementStyles(elementForNodeId, new StyleAccumulator() {
                    /* class com.taobao.weex.devtools.inspector.protocol.module.CSS.AnonymousClass2.AnonymousClass1 */
