...
public class Input implements ChromeDevtoolsDomain {
    ...
    private void down(int i, int i2) {
        ...
        if (tryGetTopActivity != null) {
            ...
            final MotionEvent obtain = MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 0, ((float) i) / ScreencastDispatcher.getsBitmapScale(), (((float) i2) / ScreencastDispatcher.getsBitmapScale()) + ((float) getStatusBarHeight(tryGetTopActivity)), 0);
            tryGetTopActivity.runOnUiThread(new Runnable() {
                /* class com.taobao.weex.devtools.inspector.protocol.module.Input.AnonymousClass2 */
    ...
    private void move(int i, int i2) {
        ...
        if (tryGetTopActivity != null) {
            ...
            tryGetTopActivity.runOnUiThread(new Runnable() {
                /* class com.taobao.weex.devtools.inspector.protocol.module.Input.AnonymousClass1 */
    ...
    private void up(int i, int i2) {
        ...
        if (tryGetTopActivity != null) {
            ...
            tryGetTopActivity.runOnUiThread(new Runnable() {
                /* class com.taobao.weex.devtools.inspector.protocol.module.Input.AnonymousClass3 */
