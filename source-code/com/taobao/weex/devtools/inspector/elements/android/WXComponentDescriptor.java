...
public class WXComponentDescriptor extends AbstractChainedDescriptor<WXComponent> implements HighlightableDescriptor {
    ...
    private static boolean filter(String str) {
        ...
        if (lowerCase.contains(Constants.Name.PADDING) || lowerCase.contains(Constants.Name.MARGIN) || lowerCase.contains("width") || lowerCase.contains("height") || lowerCase.contains("left") || lowerCase.contains("right") || lowerCase.contains("top") || lowerCase.contains("bottom")) {
            return false;
        }
        return true;
    }
    ...
    public /* bridge */ /* synthetic */ void onGetChildren(WXComponent wXComponent, Accumulator accumulator) {
        onGetChildren(wXComponent, (Accumulator<Object>) accumulator);
    }
