...
public class WXStateRecord {
    ...
    public static class a implements Comparable<a> {
        ...
        public String toString() {
            return jl1.ARRAY_START + this.b + ',' + this.a + ',' + this.c + "]->";
        }
    }
    ...
    public Map<String, String> e() {
        ...
        if (J != null && "true".equalsIgnoreCase(J.getConfig(kx2.WXAPM_CONFIG_GROUP, "dumpIpcPageInfo", "true"))) {
    ...
    private WXStateRecord() {
        this.h = -1;
        this.i = new Runnable() {
            /* class com.taobao.weex.performance.WXStateRecord.AnonymousClass1 */
            ...
            public void run() {
                ...
                WXStateRecord.this.h = WXUtils.getFixUnixTime();
                WXBridgeManager.getInstance().postDelay(WXStateRecord.this.i, 500);
            }
        };
