...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    public static class Ring {
        ...
        public void draw(Canvas canvas, Rect rect) {
            ...
            if (this.mAlpha < 255) {
                ...
                canvas.drawCircle(rect.exactCenterX(), rect.exactCenterY(), (float) (com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.width(rect) / 2), this.mCirclePaint);
            }
        }
    ...
    public MaterialProgressDrawable(Context context, View view) {
        ...
        AnonymousClass3 r2 = new Drawable.Callback() {
            /* class com.taobao.weex.ui.view.refresh.circlebar.MaterialProgressDrawable.AnonymousClass3 */
    ...
    private void setupAnimators() {
        ...
        AnonymousClass1 r1 = new Animation() {
            /* class com.taobao.weex.ui.view.refresh.circlebar.MaterialProgressDrawable.AnonymousClass1 */
        ...
        r1.setAnimationListener(new Animation.AnimationListener() {
            /* class com.taobao.weex.ui.view.refresh.circlebar.MaterialProgressDrawable.AnonymousClass2 */
