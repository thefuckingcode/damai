...
public class WXSDKEngine implements Serializable {
    ...
    private static void doInitInternal(final Application application, final a aVar) {
        ...
        WXBridgeManager.getInstance().postWithName(new Runnable() {
            /* class com.taobao.weex.WXSDKEngine.AnonymousClass1 */
    ...
    public static void initialize(Application application, a aVar) {
        synchronized (mLock) {
            if (!mIsInit) {
                long currentTimeMillis = System.currentTimeMillis();
    ...
    private static void register() {
        ...
        try {
            ...
            registerModule(lf1.RESOURCE_STREAM, WXStreamModule.class);
    ...
    public static void reload(final Context context, String str, boolean z) {
        ...
        WXSDKManager.v().N(new Runnable() {
            /* class com.taobao.weex.WXSDKEngine.AnonymousClass2 */
