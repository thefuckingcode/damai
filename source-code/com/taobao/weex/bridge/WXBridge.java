...
public class WXBridge implements IWXBridge {
    ...
    public Object callNativeModule(String str, String str2, String str3, byte[] bArr, byte[] bArr2) {
        ...
        try {
            ...
            if (y2 != null) {
                ...
                y2.getApmForInstance().C(WXInstanceApm.KEY_PAGE_STATS_FS_CALL_NATIVE_TIME, (double) (WXUtils.getFixUnixTime() - fixUnixTime));
            }
            ...
            } else if (callNativeModule.getClass() == WXJSObject.class) {
    ...
    public void reportNativeInitStatus(String str, String str2) {
        ...
        for (WXErrorCode wXErrorCode2 : values) {
    ...
    public void resetWXBridge(boolean z) {
        nativeResetWXBridge(this, getClass().getName().replace('.', v00.DIR));
    }
