...
public class c extends RewindableStream {
    ...
    private int a(byte[] bArr, int i, int i2) throws IOException {
        ...
        if (bArr2 == null || i3 > bArr2.length) {
            byte[] g2 = a.f().g(Math.min(i3 + min, this.b));
            byte[] bArr3 = this.e;
            if (bArr3 != null) {
                System.arraycopy(bArr3, 0, g2, 0, this.c);
                a.f().h(this.e);
            }
            this.e = g2;
        }
        ...
        while (true) {
            ...
            if (read >= 0) {
                ...
                this.g = true;
                kg0.a(Pexode.TAG, "bufferAndWriteTo() read stream end -1 now", new Object[0]);
                break;
            }
        }
        return i4;
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        if (!this.f) {
            ...
            if (i3 > 0 && this.c < this.b && (a2 = a(bArr, (i + i2) - i3, i3)) >= 0) {
                i3 -= a2;
                i4 = i4 < 0 ? a2 : i4 + a2;
            }
        } else {
        ...
        if (this.g || i3 <= 0 || (b2 = b(bArr, (i + i2) - i3, i3)) < 0) {
            return i4;
        }
        return i4 < 0 ? b2 : i4 + b2;
    }
