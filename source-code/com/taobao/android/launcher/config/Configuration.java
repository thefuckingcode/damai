...
public class Configuration {
    ...
    public static class Builder {
        ...
        public Builder(TaskFactory<String, Void> taskFactory, TaskProvider<String, Void> taskProvider, Generator<String> generator2) {
    ...
    private Configuration(TaskFactory<String, Void> taskFactory, TaskProvider<String, Void> taskProvider, Generator<String> generator2, String str, TaskDeffer<String, Void> taskDeffer) {
        this.provider = taskProvider;
        this.generator = generator2;
        this.factory = taskFactory;
        this.optimizedSwitch = str;
