...
public class MainScheduler extends LaunchScheduler implements DAGExecutor.Interceptor, OnDemandReceiver, Runnable {
    private static final boolean DAG_CREATE_SYSTRACE = (Log.isLoggable("systrace", 2) && Build.VERSION.SDK_INT >= 18);
    ...
    private final Runnable idleTaskHandler = new IdleTaskHandler(this);
    ...
    private void onBootFinishedInternal(final boolean z) {
        ...
        schedule(createStage, 200, TimeUnit.MILLISECONDS, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass14 */
    ...
    private void scheduleDebugStage() {
        ...
        schedule(createStage, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass1 */
    ...
    public void onAppAttach(Context context) {
        ...
        schedule(createStage, 1, TimeUnit.MILLISECONDS, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass2 */
    ...
    public void onAppCreated(Context context) {
        ...
        schedule(createStage, SchedulePolicy.DEFERRABLE, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass7 */
    ...
    public void onAppMain(Context context) {
        ...
        schedule(createStage, schedulePolicy, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass4 */
        ...
        schedule(createStage2, schedulePolicy, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass5 */
        ...
        schedule(createStage3, schedulePolicy, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass6 */
    ...
    public void onAppSecurityGuard(Context context) {
        ...
        schedule(createStage, 1, TimeUnit.MILLISECONDS, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass3 */
    ...
    public void onBackground(Activity activity) {
        ...
        scheduleDemand(createDemandStage, 200, TimeUnit.MILLISECONDS, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass13 */
    ...
    public void onColdLogin() {
        ...
        schedule(createStage, 200, TimeUnit.MILLISECONDS, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass15 */
    ...
    public void onFirstActivityCreated(Activity activity) {
        ...
        schedule(createStage, SchedulePolicy.DEFERRABLE, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass8 */
    ...
    public void onForeground(Activity activity) {
        ...
        scheduleDemand(createDemandStage, 200, TimeUnit.MILLISECONDS, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass12 */
    ...
    public void onLogin() {
        ...
        scheduleDemand(createDemandStage, 200, TimeUnit.MILLISECONDS, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass16 */
    ...
    public void onLogout() {
        ...
        scheduleDemand(createDemandStage, 200, TimeUnit.MILLISECONDS, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass17 */
    ...
    public void onSchemaWaked(Activity activity) {
        ...
        schedule(createStage, SchedulePolicy.DEFERRABLE, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass9 */
    ...
    public void onSchemaWebWaked() {
        ...
        schedule(createStage, SchedulePolicy.DEFERRABLE, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass11 */
    ...
    public void onSchemaWaked() {
        ...
        this.generator.genMainSchemaWaked(DAGTaskChain.from(createStage));
        schedule(createStage, SchedulePolicy.DEFERRABLE, new StageRunnable<String, Void>() {
            /* class com.taobao.android.launcher.schedulers.MainScheduler.AnonymousClass10 */
