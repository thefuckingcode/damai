...
public class TaoTrace {
        ...
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            if ((j2 <= 0 || j <= j2) && isSwitchOn()) {
                LazyExecutor.Startup.EXECUTOR.submit(new Runnable() {
                    /* class com.taobao.android.launcher.statistics.TaoTrace.AnonymousClass2 */
    ...
    public static void end(final String str, final String str2) {
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            ...
            if (isSwitchOn()) {
                LazyExecutor.Startup.EXECUTOR.submit(new Runnable() {
                    /* class com.taobao.android.launcher.statistics.TaoTrace.AnonymousClass1 */
    ...
    public static void start(String str, String str2) {
        duration(str, str2, System.currentTimeMillis(), 0);
    }
}
