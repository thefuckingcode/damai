...
public class Constants {
    ...
    public static final String STAGE_MAIN_APP_FRONT = "m-front";
    public static final String STAGE_MAIN_APP_LAUNCH = "m-launch";
    public static final String STAGE_MAIN_APP_ONCREATE = "m-a-c";
    public static final String STAGE_MAIN_APP_ONCREATE_END = "m-a-c-e";
    public static final String STAGE_MAIN_APP_SECURITY_GUARD = "m-security-guard";
    ...
    public static final String STAGE_MAIN_IDLE_2s = "m-idle-2s";
    ...
    public static final String STAGE_MAIN_SCHEMA_WEB_WAKE = "m-s-w-w";
