...
public class TBSsoLogin {
    ...
    public static class a extends AsyncTask<Object, Void, DefaultLoginResponseData> {
        ...
        public DefaultLoginResponseData doInBackground(Object... objArr) {
            try {
                ...
                long j = this.a.getLong(SSOIPCConstants.IPC_MASTER_T, 0);
        ...
        public void onPostExecute(DefaultLoginResponseData defaultLoginResponseData) {
            ...
            if (defaultLoginResponseData != null) {
                try {
                    if (defaultLoginResponseData.returnValue != null && defaultLoginResponseData.code == 3000) {
                        Properties properties = new Properties();
                        properties.setProperty("monitor", "T");
                        properties.setProperty("site", DataProviderFactory.getDataProvider().getSite() + "");
                        UserTrackAdapter.sendUT(str2, UTConstant.CustomEvent.UT_SINGLE_LOGIN_SUCCESS, "", LoginType.LocalLoginType.SSO_LOGIN, properties);
                        Properties properties2 = new Properties();
            ...
            if (defaultLoginResponseData != null && "H5".equals(defaultLoginResponseData.actionType) && defaultLoginResponseData.returnValue != null) {
                ...
                LoginResultHelper.gotoH5PlaceHolder(this.c, defaultLoginResponseData.returnValue, loginParam3);
                ...
                if (TBSsoLogin.a != null) {
                    ...
                    UserTrackAdapter.sendUT(str2, UTConstant.CustomEvent.UT_SINGLE_LOGIN_FAILURE, defaultLoginResponseData.code + "", LoginType.LocalLoginType.SSO_LOGIN, properties4);
                    TBSsoLogin.a = null;
                }
    ...
    public static class b extends AsyncTask<Object, Void, RpcResponse<LoginReturnData>> {
        ...
        public void onPostExecute(RpcResponse<LoginReturnData> rpcResponse) {
            if (rpcResponse == null) {
                ...
                if ("SUCCESS".equals(rpcResponse.actionType) && t != null) {
                    ...
                    LoginResultHelper.gotoH5PlaceHolder(this.c, t, loginParam);
                } else {
                    LongLifeCycleUserTrack.sendUT(LongLifeCycleUserTrack.getResultScene() + "_FAILURE");
                    String string = DataProviderFactory.getApplicationContext().getString(R.string.aliuser_network_error);
    ...
    public static void h(int i, final String str) {
        MainThreadExecutor.execute(new Runnable() {
            /* class com.taobao.android.TBSsoLogin.AnonymousClass3 */
    ...
    public static void j(RpcResponse<LoginReturnData> rpcResponse) {
        ...
        UserTrackAdapter.sendUT(str, UTConstant.CustomEvent.UT_SINGLE_LOGIN_FAILURE, valueOf, LoginType.LocalLoginType.SSO_LOGIN, properties);
        Properties properties2 = new Properties();
        if (a != null) {
