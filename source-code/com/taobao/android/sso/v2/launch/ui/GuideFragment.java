...
public class GuideFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void initViews(View view) {
        ...
        this.mLoginReceiver = new BroadcastReceiver() {
            /* class com.taobao.android.sso.v2.launch.ui.GuideFragment.AnonymousClass1 */
    ...
    public void onCheckLogin(final int i) {
        ...
        rrotocolFragment.setNagetive(new View.OnClickListener() {
            /* class com.taobao.android.sso.v2.launch.ui.GuideFragment.AnonymousClass2 */
        ...
        rrotocolFragment.setPositive(new View.OnClickListener() {
            /* class com.taobao.android.sso.v2.launch.ui.GuideFragment.AnonymousClass3 */
