...
public class SsoLogin {
    ...
    public static ISsoRemoteParam getSsoRemoteParam() {
        return new ISsoRemoteParam() {
            /* class com.taobao.android.sso.v2.launch.SsoLogin.AnonymousClass1 */
        ...
        if (isAlipayAuthCallBack(intent)) {
            try {
                AlipayAuthManager.getInstance().getAlipayAuth().handleIntent(intent, new IAlipayAuthEventHandler() {
                    /* class com.taobao.android.sso.v2.launch.SsoLogin.AnonymousClass2 */
    ...
    public static boolean isSupportTBSsoV2(Context context) {
        return isSchemeSupport(context, th2.ACTION_CUSTOM, "tbopen://m.taobao.com/sso?");
    }
