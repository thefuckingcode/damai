...
public class AlipayAuthManager {
    ...
    private void initAlipayApi() {
        try {
            this.mAlipayAuthApi = AlipayAuthAPIFactory.createAlipayAuthApi(DataProviderFactory.getApplicationContext(), new IAlipayAuthMonitor(this) {
                /* class com.taobao.android.sso.v2.launch.alipay.AlipayAuthManager.AnonymousClass1 */
