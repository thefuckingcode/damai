...
public final class ExecutionResult<T, R> {
    ...
    public static <T, R> ExecutionResult<T, R> failed(T t, R r, String str) {
        return new ExecutionResult<>(t, r, 0, str, ExecutionSummary.create(-1, -1));
    }
    ...
    public String toString() {
        return "ExecutionResult [id=" + ((Object) this.id) + ", result=" + ((Object) this.result) + ", status=" + this.status + ", message=" + this.message + jl1.ARRAY_END_STR;
    }
