...
public class h extends b {
    LruCache<String, a> d = new LruCache<>(this.a.i());
    ...
    public DXWidgetNode i(DXRuntimeContext dXRuntimeContext, View view) {
        ...
        try {
            ...
            if (view != null) {
                view.setTag(kz.a, dXWidgetNode);
            }
            return dXWidgetNode;
        } catch (Exception e2) {
            DXAppMonitor.q(this.b, dXRuntimeContext.getDxTemplateItem(), "Render", "Render_Get_Expand_Tree_Crash", e.GET_EXPAND_TREE_CRASH, vx.a(e2));
            return null;
        }
    }
