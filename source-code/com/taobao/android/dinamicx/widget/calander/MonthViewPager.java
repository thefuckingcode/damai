...
public final class MonthViewPager extends ViewPager {
        ...
        public void onPageSelected(int i) {
            ...
            if (MonthViewPager.this.mDelegate.y() == 0) {
                if (!e.isCurrentMonth()) {
                    ...
                    MonthViewPager.this.mDelegate.L = a.m(e, MonthViewPager.this.mDelegate);
                }
                MonthViewPager.this.mDelegate.M = MonthViewPager.this.mDelegate.L;
            } else if (e.isSameMonth(MonthViewPager.this.mDelegate.L)) {
                MonthViewPager.this.mDelegate.M = MonthViewPager.this.mDelegate.L;
            }
            ...
            if (baseMonthView != null) {
                ...
                if (MonthViewPager.this.mDelegate.J != null) {
                    MonthViewPager.this.mDelegate.J.onMonthUIRangeChange(MonthViewPager.this.mDelegate.L, a.f(e.getYear(), e.getMonth()), MonthViewPager.this.mDelegate.x(e.getYear(), e.getMonth()));
                }
            }
    ...
    public final class b extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup viewGroup, int i) {
            ...
            if (i == MonthViewPager.this.getCurrentItem() && MonthViewPager.this.mDelegate.J != null) {
                MonthViewPager.this.mDelegate.J.onMonthUIRangeChange(MonthViewPager.this.mDelegate.L, a.f(v, v2), MonthViewPager.this.mDelegate.x(v, v2));
            }
    ...
    private void updateMonthViewHeight(int i, int i2) {
        ...
        this.mCurrentViewHeight = a.k(i, i2, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
        if (i2 == 1) {
            this.mPreViewHeight = a.k(i - 1, 12, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
            this.mNextViewHeight = a.k(i, 2, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
            return;
        }
        this.mPreViewHeight = a.k(i, i2 - 1, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
        if (i2 == 12) {
            this.mNextViewHeight = a.k(i + 1, 1, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
        } else {
            this.mNextViewHeight = a.k(i, i2 + 1, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
        }
    }
    ...
    public final void updateItemHeight() {
        ...
        this.mCurrentViewHeight = a.k(year, month, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
        if (month == 1) {
            this.mPreViewHeight = a.k(year - 1, 12, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
            this.mNextViewHeight = a.k(year, 2, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
        } else {
            this.mPreViewHeight = a.k(year, month - 1, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
            if (month == 12) {
                this.mNextViewHeight = a.k(year + 1, 1, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
            } else {
                this.mNextViewHeight = a.k(year, month + 1, this.mDelegate.d(), this.mDelegate.E(), this.mDelegate.w());
            }
        }
        ViewGroup.LayoutParams layoutParams = getLayoutParams();
        layoutParams.height = this.mCurrentViewHeight;
