                ...
                if (this.b != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (findViewByPosition != null) {
                            int i = (this.d.get(Integer.valueOf(intValue)).longValue() > 0 ? 1 : (this.d.get(Integer.valueOf(intValue)).longValue() == 0 ? 0 : -1));
                            if (i == 0 && yf0.b(findViewByPosition, this.c.visiblePercent())) {
                                this.d.put(Integer.valueOf(intValue), Long.valueOf(System.currentTimeMillis()));
                            } else if (i > 0 && yf0.a(findViewByPosition, 0.1f)) {
                                d(intValue, this.a);
                            }
                        }
                    }
            ...
            if (!(recyclerView == null || recyclerView.getLayoutManager() == null)) {
                if (this.b != null) {
                    for (Map.Entry<Integer, Long> entry : this.d.entrySet()) {
                        if (yf0.b(this.a.getLayoutManager().findViewByPosition(entry.getKey().intValue()), this.c.visiblePercent())) {
