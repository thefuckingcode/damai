...
public class DXTemplateWidgetNode extends DXLinearLayoutWidgetNode {
    ...
    private JSONObject processSlotInfo(DXWidgetNode dXWidgetNode) {
        ...
        if (queryRootWidgetNode != null) {
            ...
            if (dXWidgetNode2 instanceof DXTemplateWidgetNode) {
                ...
                String name2 = getDXRuntimeContext().getDxTemplateItem().getName();
                JSONObject jSONObject2 = jSONObject.getJSONObject(name2);
                if (jSONObject2 == null) {
                    wz.b("对应的父节点 " + name2 + "找不到slot信息");
                    return null;
                }
                JSONObject jSONObject3 = jSONObject2.getJSONObject(this.slotId);
                if (jSONObject3 == null) {
                    wz.b("对应的slotId " + this.slotId + " 找不到slot信息");
                }
                ry.a("找到slot信息" + JSON.toJSONString(jSONObject3));
                return jSONObject3;
            }
        }
        ry.c("坑位 " + this.slotId + " 发生错误 找不到slot信息");
        return null;
    }
    ...
    private JSONObject processSlotInfoOld(DXWidgetNode dXWidgetNode) {
        ...
        JSONObject slotInfoJObj2 = queryRootWidgetNode.getSlotInfoJObj();
        if (slotInfoJObj2 != null) {
            return slotInfoJObj2.getJSONObject(getDXRuntimeContext().getDxTemplateItem().getName()).getJSONObject(this.slotId);
        }
    ...
    public void bindRuntimeContext(DXRuntimeContext dXRuntimeContext, boolean z) {
        ...
        if (dXRuntimeContext != null) {
            ...
            if (dXRuntimeContext2 != dXRuntimeContext) {
                Map<String, ey> env = dXRuntimeContext2.getEnv();
            ...
            if (childAt == null || childAt.getDXRuntimeContext() == null) {
                ry.g(ry.TAG, "template deepCopyChildNode child or child runtimeContext is null!!!");
                return;
            }
    ...
    public DXWidgetNode deepClone(DXRuntimeContext dXRuntimeContext) {
        ...
        if (!(dXRuntimeContext.getDxTemplateItem() == null || dXRuntimeContext.getDxTemplateItem().packageInfo == null)) {
            ...
            ry.s("DXTemplateWidgetNode deepClone 写packageinfo信息");
        }
        ...
        try {
            ...
            if (getChildrenCount() <= 0) {
                ...
                if (dXRemoteChildTemplateManager != null) {
                    ...
                    if (h == null) {
                        wz.b("dxRemoteChildTemplateManager.getTemplateManger(getDXRuntimeContext()) == null");
                    }
                    ...
                    if (dXRemoteChildTemplateManager.i(g, dXTemplateItem)) {
                        ...
                        wz.b("同步获取模版失败" + dXTemplateItem.getIdentifier());
                        return;
                    }
                    if (g != null) {
    ...
    public void onSetListAttribute(long j, JSONArray jSONArray) {
        if (j == DXTEMPLATE__SLOTINFOLIST) {
            ...
            this.slotInfoJObj = n00.b(jSONArray);
            return;
        }
    ...
    public void processContainsSlotIdTemplate() {
        if (this.hasProcessContainsSlotIdTemplate && DinamicXEngine.x()) {
            ry.c("hasProcessContainsSlotIdTemplate: " + getTemplateInfo());
        }
        JSONObject processSlotInfo = processSlotInfo(this);
        if (processSlotInfo != null) {
            this.name = n00.a(getDXRuntimeContext(), "name", processSlotInfo);
            this.version = n00.a(getDXRuntimeContext(), "version", processSlotInfo);
            this.url = n00.a(getDXRuntimeContext(), "url", processSlotInfo);
