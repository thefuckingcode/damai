...
public class DXVideoController<VideoData, Video> implements IDXVideoController<VideoData, Video> {
    ...
    private void d(@NonNull final VideoData videodata, @NonNull final String str) {
        a().post(new Runnable() {
            /* class com.taobao.android.dinamicx.videoc.core.impl.DXVideoController.AnonymousClass3 */

            /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.taobao.android.dinamicx.videoc.core.impl.DXVideoController */
    ...
    private void e() {
        a().post(new Runnable() {
            /* class com.taobao.android.dinamicx.videoc.core.impl.DXVideoController.AnonymousClass1 */
    ...
    private void f(@NonNull final String str) {
        a().post(new Runnable() {
            /* class com.taobao.android.dinamicx.videoc.core.impl.DXVideoController.AnonymousClass2 */
    ...
    private void g(@NonNull final VideoData videodata, @NonNull final String str) {
        a().post(new Runnable() {
            /* class com.taobao.android.dinamicx.videoc.core.impl.DXVideoController.AnonymousClass4 */
    ...
    private void h(@NonNull final Video video, @NonNull final String str) {
        a().post(new Runnable() {
            /* class com.taobao.android.dinamicx.videoc.core.impl.DXVideoController.AnonymousClass5 */
    ...
    private void i(@NonNull final Video video, @NonNull final String str) {
        a().post(new Runnable() {
            /* class com.taobao.android.dinamicx.videoc.core.impl.DXVideoController.AnonymousClass6 */
    ...
    public void playNextVideo(@NonNull Video video, @NonNull String str) {
        try {
            ...
            if (b2 != null) {
                this.c.notifyVideoPlay(this, b2, str);
            }
        } catch (Throwable th) {
            vx.b(th);
        }
