...
public interface IDXVideoControlCenter {
    ...
    void makeVideoControl(@NonNull RecyclerView recyclerView, @NonNull DXVideoControlConfig<xv2> dXVideoControlConfig);

    void makeVideoControl(@NonNull RecyclerView recyclerView, @NonNull DXVideoControlConfig<xv2> dXVideoControlConfig, @NonNull String str);
