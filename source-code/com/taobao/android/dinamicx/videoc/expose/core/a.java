...
public abstract class a<ExposeKey, ExposeData> implements IExposureEngine<ExposeKey, ExposeData> {
    ...
    /* compiled from: Taobao */
    public static abstract class AbstractC0207a<ExposeKey, ExposeData, CacheDataType> {
        ...
        public AbstractC0207a(@NonNull IExposureZone.Builder<ExposeKey, ExposeData> builder, @Nullable IExposureCenter<ExposeKey, ExposeData, CacheDataType> iExposureCenter) {
            this.a = builder;
        ...
        public IExposureEngine<ExposeKey, ExposeData> a() {
            IExposureZone<ExposeKey, ExposeData> iExposureZone;
            if (this.d == null) {
                this.d = new r40();
            }
            for (Pair<IExposure<ExposeKey, ExposeData>, String> pair : this.b) {
                ...
                if (obj != null) {
                    iExposureZone = this.a.build((IExposure) pair.first, (String) obj);
                } else {
                    iExposureZone = this.a.build((IExposure) pair.first);
                }
                this.d.registerExposureZone(iExposureZone);
            }
            IExposureZoneRunner<ExposeKey, ExposeData> iExposureZoneRunner = this.d;
            if (iExposureZoneRunner == null) {
                iExposureZoneRunner = new r40<>();
            }
        ...
        @NonNull
        public abstract IExposureEngine<ExposeKey, ExposeData> b(@NonNull IExposureZoneRunner<ExposeKey, ExposeData> iExposureZoneRunner, @NonNull Collection<IExposureZone<ExposeKey, ExposeData>> collection);

        public AbstractC0207a<ExposeKey, ExposeData, CacheDataType> c(@NonNull IExposure<ExposeKey, ExposeData> iExposure, @Nullable String str) {
            this.b.add(new Pair<>(iExposure, str));
            return this;
        }

        public AbstractC0207a<ExposeKey, ExposeData, CacheDataType> d(@NonNull ExposureLifecycle<ExposeKey, ExposeData> exposureLifecycle, long j, @Nullable String str) {
