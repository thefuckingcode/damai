...
public class a implements RichTextNode {
    ...
    /* compiled from: Taobao */
    public class C0208a implements ClickSpanDelegate {
        C0208a() {
        }
    ...
    private List<Object> p() {
        ...
        if (i2 >= 0 || this.b <= 0) {
            if (i2 == 0) {
                this.a = (int) Math.round(this.c * ((double) this.b));
            }
            if (this.b == 0) {
                this.b = (int) Math.round(((double) this.a) / this.c);
            }
        ...
        if (this.f != null) {
            this.k.setClickDelegate(new C0208a());
        }
        if (this.g != null) {
