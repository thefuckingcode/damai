...
public class DXBindingXViewUpdateManager implements INativeViewUpdater {
    ...
    public void update(@NonNull final View view, @NonNull String str, @NonNull final Object obj, @NonNull PlatformManager.IDeviceResolutionTranslator iDeviceResolutionTranslator, @NonNull Map<String, Object> map) {
        if (DinamicXEngine.x()) {
            ry.n("开始更新" + str + " 属性，需要更新到的值为 " + obj + " 更新前的值为 " + a(str, view) + " 其对应的view为 " + view);
        }
        if (!TextUtils.isEmpty(str) && view != null) {
            str.hashCode();
            if (str.equals("height")) {
                AnonymousClass2 r1 = new Runnable() {
                    /* class com.taobao.android.dinamicx.bindingx.DXBindingXViewUpdateManager.AnonymousClass2 */
                ...
                AnonymousClass1 r12 = new Runnable() {
                    /* class com.taobao.android.dinamicx.bindingx.DXBindingXViewUpdateManager.AnonymousClass1 */
        ...
        if (DinamicXEngine.x()) {
            ry.n("更新完成" + str + " 属性，需要更新到的值为 " + obj + " 更新后的值为 " + a(str, view) + " 其对应的view为 " + view);
        }
    }
}
