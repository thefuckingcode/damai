            ...
            if (!list2.isEmpty()) {
                for (NavPreprocessor navPreprocessor2 : list2) {
                    ...
                    if (navPreprocessor2 instanceof RedirectNavPreprocessor) {
                        z2 = ((RedirectNavPreprocessor) navPreprocessor2).beforeNavTo(this, this.mIntent);
                    } else {
                        z2 = navPreprocessor2.beforeNavTo(this.mIntent);
                    }
            ...
            while (true) {
                try {
                    ...
                    if (this.mDisallowLoopback) {
                        Context context = this.mContext;
                        if ((context instanceof Activity) && componentName != null && componentName.equals(((Activity) context).getComponentName())) {
