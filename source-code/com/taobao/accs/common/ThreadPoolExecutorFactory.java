        ...
        if (acceptThreadPoolExecutor == null) {
            synchronized (ThreadPoolExecutorFactory.class) {
                if (acceptThreadPoolExecutor == null) {
                    ...
                    acceptThreadPoolExecutor.setKeepAliveTime(3, TimeUnit.SECONDS);
        ...
        if (scheduleThreadPoolExecutor == null) {
            synchronized (ThreadPoolExecutorFactory.class) {
                if (scheduleThreadPoolExecutor == null) {
                    ...
                    scheduleThreadPoolExecutor.setKeepAliveTime(10, TimeUnit.SECONDS);
        ...
        if (sendThreadPoolExecutor == null) {
            synchronized (ThreadPoolExecutorFactory.class) {
                if (sendThreadPoolExecutor == null) {
                    ...
                    sendThreadPoolExecutor.setKeepAliveTime(10, TimeUnit.SECONDS);
