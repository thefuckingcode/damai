...
public abstract class BaseConnection {
    ...
    protected LinkedHashMap<Integer, Message> mAckMessage = new LinkedHashMap<Integer, Message>() {
        /* class com.taobao.accs.net.BaseConnection.AnonymousClass1 */
    ...
    public void initAwcn(Context context) {
        try {
            ...
            c.z(context, new a.C0000a().c(this.mAppkey).b(this.mConfig.getAppSecret()).d(this.mConfig.getAuthCode()).e(env).f(this.mConfig.getAppKey()).a());
    ...
    public void send(Message message, boolean z) {
        if (message.isAck || UtilityImpl.isNetworkConnected(this.mContext)) {
            long flowCtrlDelay = message.getType() != 2 ? this.mMessageHandler.mFlowControl.getFlowCtrlDelay(message.serviceId, message.bizId) : 0;
            if (flowCtrlDelay == -1) {
    ...
    public void setPingTimeOut() {
        if (this.mPingTimeoutRunnable == null) {
            this.mPingTimeoutRunnable = new Runnable() {
                /* class com.taobao.accs.net.BaseConnection.AnonymousClass3 */
    ...
    public void setTimeOut(final String str, final boolean z, long j) {
        ThreadPoolExecutorFactory.getScheduledExecutor().schedule(new Runnable() {
            /* class com.taobao.accs.net.BaseConnection.AnonymousClass2 */
    ...
    public void startChannelService() {
        try {
            ThreadPoolExecutorFactory.schedule(new Runnable() {
                /* class com.taobao.accs.net.BaseConnection.AnonymousClass4 */
