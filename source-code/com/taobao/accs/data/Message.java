...
public class Message implements Serializable {
    ...
    public static Message buildBindApp(String str, String str2, Context context, Intent intent) {
        ...
        try {
            ...
            message = buildBindApp(context, str2, intent.getStringExtra("appKey"), intent.getStringExtra("app_sercet"), stringExtra, intent.getStringExtra("ttid"), intent.getStringExtra("appVersion"));
            setControlHost(str, message);
            return message;
        } catch (Exception e) {
    ...
    public static Message buildEventMessage(int i, long j, String str, String str2, Context context) {
        return buildSendData(str, str2, "", context, context.getPackageName(), new ACCSManager.AccsRequest("", Constants.TARGET_SERVICE_EVENT_COLLECT, ze0.a(context, i, j), ""));
    }
    ...
    public static Message buildMassMessage(String str, String str2, String str3, String str4, String str5, Context context) {
        return buildSendData(str4, str5, "", context, context.getPackageName(), new ACCSManager.AccsRequest("", Constants.TARGET_SERVICE_MASS, nb1.a(context, str, str3, str2), ""));
    }
    ...
    public static Message buildRequest(Context context, String str, String str2, String str3, String str4, String str5, ACCSManager.AccsRequest accsRequest, boolean z) {
        ...
        if (z2) {
            NetPerformanceMonitor netPerformanceMonitor2 = new NetPerformanceMonitor();
            message.netPerformanceMonitor = netPerformanceMonitor2;
            netPerformanceMonitor2.setDataId(accsRequest.dataId);
    ...
    public byte[] build(Context context, int i, Boolean bool) {
        ...
        boolean z = true;
        int length = this.targetLength + 3 + 1 + this.sourceLength + 1 + bArr.length;
        ...
        try {
            ...
            if (ALog.isPrintLog(level)) {
                String tag2 = getTag();
                ALog.d(tag2, "\tversion:2 compress:" + ((int) this.compress), new Object[0]);
            }
            if (i == 0) {
                messageStreamBuilder.writeByte(as2.MAX_POWER_OF_TWO);
                if (ALog.isPrintLog(level)) {
            ...
            if (ALog.isPrintLog(level)) {
                String tag3 = getTag();
                ALog.d(tag3, "\ttotalLength:" + ((int) this.totalLength), new Object[0]);
            }
            messageStreamBuilder.writeShort(this.dataLength);
            if (ALog.isPrintLog(level)) {
                String tag4 = getTag();
                ALog.d(tag4, "\tdataLength:" + ((int) this.dataLength), new Object[0]);
            }
            ...
            if (ALog.isPrintLog(level)) {
                String tag6 = getTag();
                ALog.d(tag6, "\ttargetLength:" + ((int) this.targetLength), new Object[0]);
            }
            ...
            if (ALog.isPrintLog(level)) {
                String tag8 = getTag();
                ALog.d(tag8, "\tsourceLength:" + ((int) this.sourceLength), new Object[0]);
            }
            ...
            if (ALog.isPrintLog(level)) {
                String tag12 = getTag();
                ALog.d(tag12, "\textHeader len:" + ((int) extHeaderLen), new Object[0]);
            }
            ...
            if (map != null) {
                for (Integer num : map.keySet()) {
                    ...
                    if (!TextUtils.isEmpty(str4)) {
                        ...
                        if (ALog.isPrintLog(ALog.Level.D)) {
                            String tag13 = getTag();
                            ALog.d(tag13, "\textHeader key:" + intValue + " value:" + str4, new Object[0]);
                        }
                    }
                }
            }
            ...
            if (bArr4 != null) {
                messageStreamBuilder.write(bArr4);
            }
            if (ALog.isPrintLog(ALog.Level.D)) {
                String tag14 = getTag();
