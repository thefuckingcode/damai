...
public class MessageV2 extends Message {
    ...
    public static MessageV2 buildBindApp(String str, String str2, Context context, Intent intent) {
        ...
        String str3 = "1";
        String str4 = "true".equals(AdapterUtilityImpl.isNotificationEnabled(context)) ? str3 : "0";
        ...
        if (!"true".equals(String.valueOf(AdapterUtilityImpl.checkFloatPermission(context)))) {
            str3 = "0";
        }
        messageV2.floatingEnable = str3;
        return messageV2;
    }
    ...
    public void buildData() throws JSONException, UnsupportedEncodingException {
        ...
        if (num != null && num.intValue() != 100 && this.command.intValue() != 102) {
            ...
            String regId2 = OrangeAdapter.getRegId(context);
            if (TextUtils.isEmpty(regId2)) {
                this.regId = null;
                this.version = "1";
                ALog.e(TAG, "regid null, degrade to V1", new Object[0]);
            } else {
                ALog.i(TAG, "set again", "regId", this.regId, "id", regId2);
                this.regId = regId2;
            }
