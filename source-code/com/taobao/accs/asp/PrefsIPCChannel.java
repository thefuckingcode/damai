...
public class PrefsIPCChannel implements IPrefsChannel {
    ...
    static class Client {
        ...
        static void commitToDisk(ModifiedRecord modifiedRecord) {
        ...
        static void registerDataListener(@NonNull String str, @NonNull OnDataUpdateListener onDataUpdateListener) {
    ...
    @Keep
    static PrefsIPCChannel getInstance() {
