...
public class TrafficsMonitor {
    ...
    private Map<String, String> bidMap = new HashMap<String, String>() {
        /* class com.taobao.accs.ut.monitor.TrafficsMonitor.AnonymousClass1 */
            ...
            try {
                for (TrafficInfo trafficInfo : traffics) {
                    if (trafficInfo != null) {
                        ...
                        w6.b().commitStat(statTrafficMonitor);
                    }
                }
            ...
            for (String str2 : this.trafficMap.keySet()) {
                for (TrafficInfo trafficInfo : this.trafficMap.get(str2)) {
                    if (trafficInfo != null) {
                        ...
                        instance.onTraffics(str3, str4, this.bidMap.get(str4), trafficInfo.isBackground, trafficInfo.trafficSize, str);
                    }
                }
            }
