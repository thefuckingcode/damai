...
public class OrangeAdapter {
    ...
    public static long getBackInterval(Context context) {
        long j;
        try {
            j = (long) APreferencesManager.getSharedPreferences(context, Constants.SP_FILE_NAME, 0).getInt("back_interval", SmartHeartbeatImpl.BACKGROUND_INTERVAL);
        } catch (Throwable th) {
    ...
    public static void getConfigForAccs() {
        ...
        hashMap.put("global_channel_enable", Boolean.valueOf(getConfig("accs", "global_channel_enable", str)));
        ...
        hashMap.put("regid_enable", Boolean.valueOf(getConfig("accs", "regid_enable", str2)));
    ...
    public static long getConnectTimeout(Context context) {
        ...
        return (long) ConnectTimeout.intValue();
    }

    public static String getConnectionServiceType(Context context) {
        String str = "0";
        try {
            str = APreferencesManager.getSharedPreferences(context, Constants.SP_FILE_NAME, 0).getString("connection_service_type", str);
        } catch (Throwable th) {
    ...
    public static long getForeInterval(Context context) {
        long j;
        try {
            j = (long) APreferencesManager.getSharedPreferences(context, Constants.SP_FILE_NAME, 0).getInt("fore_interval", SmartHeartbeatImpl.FOREGROUND_INTERVAL);
        } catch (Throwable th) {
    ...
    static long getLastActiveTime(Context context) {
        if (lastActiveTime == null) {
            try {
                lastActiveTime = Long.valueOf(APreferencesManager.getSharedPreferences(context, Constants.SP_FILE_NAME, 0).getLong(Constants.SP_KEY_LAST_LAUNCH_TIME, 0));
            } catch (Throwable th) {
    ...
    public static List<String> getUpRetryServiceIds(Context context) {
        ...
        String str = "";
        try {
            str = APreferencesManager.getSharedPreferences(context, Constants.SP_FILE_NAME, 0).getString("up_retry_ids", str);
    ...
    static void saveLastActiveTime(Context context, long j) {
        try {
