...
public class NoTraceTriggerHelper {
    ...
    static BroadcastReceiver eventReceiver = new BroadcastReceiver() {
        /* class com.taobao.accs.utl.NoTraceTriggerHelper.AnonymousClass1 */
        private volatile long lastEventSendTime;

        public void onReceive(final Context context, final Intent intent) {
            ThreadPoolExecutorFactory.getScheduledExecutor().execute(new Runnable() {
                /* class com.taobao.accs.utl.NoTraceTriggerHelper.AnonymousClass1.AnonymousClass1 */
                                ...
                                for (int i5 = 0; i5 < length; i5++) {
                                    if (iArr[i5] == i) {
                                        ...
                                        if (connection == null) {
                                            ...
                                            return;
                                        } else if (System.currentTimeMillis() - AnonymousClass1.this.lastEventSendTime >= ((long) i3)) {
                                            ...
                                            ThreadPoolExecutorFactory.getScheduledExecutor().schedule(new Runnable() {
                                                /* class com.taobao.accs.utl.NoTraceTriggerHelper.AnonymousClass1.AnonymousClass1.AnonymousClass1 */

                                                public void run() {
                                                    ALog.i(NoTraceTriggerHelper.TAG, "send event request", "in channel process");
                                                    connection.sendMessage(buildEventMessage, true);
                                                }
                                            }, (long) NoTraceTriggerHelper.random.nextInt(i2), TimeUnit.MILLISECONDS);
                                            return;
                                        } else {
                                            return;
                                        }
    ...
    static void startTriggerProcess(final Context context, final Bundle bundle, boolean z) {
        if (z) {
            ThreadPoolExecutorFactory.getScheduledExecutor().execute(new Runnable() {
                /* class com.taobao.accs.utl.NoTraceTriggerHelper.AnonymousClass3 */
                                ...
                                if (i7 == 1 && i == 1) {
                                    ...
                                    if (UtilityImpl.isSameDay(currentTimeMillis, System.currentTimeMillis())) {
                                        ...
                                        if (i9 < i8) {
                                            str3 = str8;
                                            ThreadPoolExecutorFactory.getScheduledExecutor().schedule(new Runnable() {
                                                /* class com.taobao.accs.utl.NoTraceTriggerHelper.AnonymousClass2 */

                                                public void run() {
                                                    NoTraceTriggerHelper.startTriggerProcess(context, bundle, false);
                                                }
                                            }, (long) random.nextInt(jSONObject.getInt(Constants.KEY_DELAY_CEILING)), TimeUnit.SECONDS);
                                    ...
                                    if (i7 == 2 && i == 8) {
                                        ...
                                        if (System.currentTimeMillis() < j) {
                                            ...
                                            scheduledFuture = ThreadPoolExecutorFactory.getScheduledExecutor().scheduleAtFixedRate(cycleTriggerRunnable, 0, (long) i14, TimeUnit.MINUTES);
                                        }
                                    } else {
                                        i6++;
                                        str8 = str3;
