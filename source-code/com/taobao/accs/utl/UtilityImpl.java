...
public class UtilityImpl {
    ...
    public static synchronized String createRegId() {
        ...
        synchronized (UtilityImpl.class) {
            ...
            sb2.append(leftPadding(Base62Utils.encode(((long) random.nextInt(Integer.MAX_VALUE)) + MIN), true, 14));
    ...
    public static boolean getAgooServiceEnabled(Context context) {
        ...
        PackageManager packageManager = context.getPackageManager();
        try {
            if (componentName.getPackageName().equals(jl1.AND_NOT)) {
    ...
    public static String getAppsign(Context context, String str, String str2, String str3, String str4, int i) {
        ...
        try {
            if (!isSecurityOff(str4)) {
                ...
                return rt0.b(bytes, str6.getBytes());
            } else {
    ...
    public static String getCreateRegIdAppSign(Context context, String str, String str2, String str3, String str4, int i) {
        ...
        try {
            if (!isSecurityOff(str4)) {
                ...
                byte[] bytes = str2.getBytes();
                signRequest = rt0.b(bytes, ("1&" + str + "&" + str3 + "&" + i).getBytes());
            } else {
    ...
    public static String getEmuiVersion() {
        ...
        try {
            ...
            String str = (String) cls.getDeclaredMethod(gl1.TYPE_OPEN_URL_METHOD_GET, clsArr).invoke(cls, objArr);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:?, code lost:
        ...
        com.taobao.accs.utl.UtilityImpl.isDual = r6;
        r6 = r6.booleanValue();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0067, code lost:
        com.taobao.accs.utl.ALog.e(com.taobao.accs.utl.UtilityImpl.TAG, "isDualApp: " + com.taobao.accs.utl.UtilityImpl.isDual, new java.lang.Object[0]);
     */
        ...
        try {
            synchronized (mLock) {
                try {
                    ...
                    str = !APreferencesManager.getSharedPreferences(context, str, 0).getString("notification_state", isNotificationEnabled).equals(isNotificationEnabled) ? 1 : 0;
                } catch (Throwable th2) {
                    th = th2;
                    z2 = str;
                    throw th;
        ...
        try {
            synchronized (mLock) {
                try {
                    ...
                    str = !APreferencesManager.getSharedPreferences(context, str, 0).getString("utdid", deviceId).equals(deviceId) ? 1 : 0;
                } catch (Throwable th2) {
                    th = th2;
                    z2 = str;
                    throw th;
