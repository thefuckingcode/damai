...
public class TLogConfigSwitchReceiver {
    ...
    public static void init(final Context context) {
        OrangeConfig.getInstance().registerListener(new String[]{REMOTE_DEBUGER_ANDROID, "tlog_switch"}, new OrangeConfigListener() {
            /* class com.taobao.tlog.remote.TLogConfigSwitchReceiver.AnonymousClass1 */
