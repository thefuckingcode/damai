...
public class TLogDiagnose extends WVApiPlugin {
    ...
    private void uploadLogFile(String str, WVCallBackContext wVCallBackContext) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(optString)) {
                if (!TextUtils.isEmpty(optString2)) {
                    ...
                    TLogEventHelper.setUploadDiagnoseListener(this.sessionID, new ii2(this, wVCallBackContext));
