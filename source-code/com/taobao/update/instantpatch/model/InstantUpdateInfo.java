...
public class InstantUpdateInfo implements Serializable {
    ...
    public static InstantUpdateInfo create(JSONObject jSONObject) {
        ...
        if (jSONObject.containsKey("httpsUrl")) {
            ...
            instantUpdateInfo.httpsUrl = str;
        } else {
            instantUpdateInfo.patchUrl = str;
            instantUpdateInfo.httpsUrl = str;
        }
        instantUpdateInfo.size = jSONObject.containsKey("size") ? jSONObject.getString("size") : str;
        instantUpdateInfo.priority = jSONObject.containsKey("priority") ? jSONObject.getString("priority") : "0";
        instantUpdateInfo.baseVersion = jSONObject.containsKey(HiAnalyticsConstant.HaKey.BI_KEY_BASE_VERSION) ? jSONObject.getString(HiAnalyticsConstant.HaKey.BI_KEY_BASE_VERSION) : str;
        instantUpdateInfo.type = jSONObject.containsKey("type") ? jSONObject.getString("type") : str;
        instantUpdateInfo.patchVersion = jSONObject.containsKey("patchVersion") ? jSONObject.getString("patchVersion") : str;
        if (jSONObject.containsKey("md5")) {
            str = jSONObject.getString("md5");
        }
        instantUpdateInfo.md5 = str;
        return instantUpdateInfo;
    }
