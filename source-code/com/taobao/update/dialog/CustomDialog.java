...
public class CustomDialog extends Dialog {
    ...
    public static class b {
        ...
        /* compiled from: Taobao */
        class View$OnClickListenerC0230b implements View.OnClickListener {
            final /* synthetic */ CustomDialog a;

            View$OnClickListenerC0230b(CustomDialog customDialog) {
                this.a = customDialog;
            }
        ...
        public CustomDialog create() {
            ...
            inflate.findViewById(R$id.close_btn).setOnClickListener(new View$OnClickListenerC0230b(customDialog));
            if (this.d != null) {
