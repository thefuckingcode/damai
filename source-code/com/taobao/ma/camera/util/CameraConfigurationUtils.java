...
public final class CameraConfigurationUtils {
    ...
    public static Point findBestPictureSizeValue(Camera.Parameters parameters, int i) {
        ...
        Collections.sort(arrayList, new Comparator<Camera.Size>() {
            /* class com.taobao.ma.camera.util.CameraConfigurationUtils.AnonymousClass1 */
    ...
    public static Point findBestPreviewSizeValue(Camera.Parameters parameters, Point point) {
        ...
        Collections.sort(arrayList, new Comparator<Camera.Size>() {
            /* class com.taobao.ma.camera.util.CameraConfigurationUtils.AnonymousClass2 */
        ...
        while (it.hasNext()) {
            ...
            if (i3 < MIN_PREVIEW_PIXELS || i3 > MAX_PREVIEW_PIXELS) {
                ...
                str = str2;
                double abs = Math.abs((((double) i4) / ((double) i5)) - xVar);
                if (abs < d) {
