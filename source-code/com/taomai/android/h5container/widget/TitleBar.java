...
public class TitleBar extends LinearLayout implements View.OnClickListener {
    ...
    public class a {
        ...
        public void j(int i) {
            ((TextView) this.a.findViewById(R$id.titlebar_button)).setTextSize((float) i);
        }
    ...
    private void onTitleClick() {
        if (this.firstClick) {
            ...
            postDelayed(new Runnable() {
                /* class com.taomai.android.h5container.widget.TitleBar.AnonymousClass1 */
    ...
    public void setTitleTextSize(int i) {
        this.titleTv.setTextSize((float) i);
    }
