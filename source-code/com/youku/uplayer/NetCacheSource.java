...
public class NetCacheSource {
    ...
    private class EventHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i != 3001) {
                ...
                } else if (NetCacheSource.this.mOnPreLoadDoneListener != null) {
    ...
    private void initPlayerNative() {
        ...
        try {
            if (!"mounted".equals(Environment.getExternalStorageState()) || a.a.getExternalCacheDir() == null) {
                ...
                j = (long) (((((double) g.a()) * 0.04d) / 1024.0d) / 1024.0d);
                str = "size:" + j;
            }
            Log.d(TAG, str);
        } catch (Exception e) {
        ...
        try {
            native_preload_init(getInitPath(), j, getPath(), 50);
    ...
    private static void preLoadCallbackFromNative(int i, int i2, int i3, Object obj) {
        if (c.d) {
            c.a(TAG, "preLoadCallbackFromNative() called with: what = [" + i + "], arg1 = [" + i2 + "], arg2 = [" + i3 + "], obj = [" + obj + jl1.ARRAY_END_STR);
        }
    ...
    public void cacheUrlForFeeds(String str) {
        addPreloadTask(str, (long) this.preLoadCachesize);
    }
