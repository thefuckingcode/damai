...
public class EGLUtil {
    ...
    public static boolean InitEGL() {
        ...
        if (egl10 == null) {
            ...
            if (EGL10.EGL_NO_DISPLAY == eglGetDisplay) {
                ...
                int[] iArr = {12352, EGL_OPENGL_ES2_BIT, 12339, 4, 12344};
                EGLConfig[] eGLConfigArr = new EGLConfig[1];
                if (!mEGL.eglChooseConfig(mEGLDisplay, iArr, eGLConfigArr, 1, new int[1])) {
                    return false;
                }
                ...
                if (surfaceHolder == null || !surfaceHolder.getSurface().isValid()) {
                    ...
                    if (eGLSurface == eGLSurface2) {
                        ...
                        int[] iArr2 = new int[1];
                        int[] iArr3 = new int[1];
                        if (!mEGL.eglQuerySurface(mEGLDisplay, eGLSurface2, 12375, iArr2) || !mEGL.eglQuerySurface(mEGLDisplay, mEGLSurface, 12374, iArr3)) {
                            str = TAG;
    ...
    public static String getClassPath() {
        return EGLUtil.class.getName().replace('.', v00.DIR);
    }
