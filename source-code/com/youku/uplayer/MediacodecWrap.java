...
public class MediacodecWrap {
    ...
    public int flush() {
        String str;
        CodecState codecState2;
        Log.d("MediacodecWrap", "flush()");
        MediaCodec mediaCodec = this.codec;
        if (mediaCodec == null || (codecState2 = this.codecState) == CodecState.Uninitialized || codecState2 == CodecState.Released) {
