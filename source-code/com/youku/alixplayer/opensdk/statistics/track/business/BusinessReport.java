...
public class BusinessReport {
    ...
    public BusinessReport(Context context, String str) {
        AnonymousClass1 r0 = new ConcurrentHashMap<String, String>() {
            /* class com.youku.alixplayer.opensdk.statistics.track.business.BusinessReport.AnonymousClass1 */
