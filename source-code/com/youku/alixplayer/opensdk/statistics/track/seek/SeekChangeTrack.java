...
public class SeekChangeTrack {
    ...
    public void onSeekComplete() {
        if (this.mCommit != null) {
            ...
            double d = (double) (currentTimeMillis - this.mStartTime);
            oneChangeCommit.changeTotalTimeFromPlayer = d;
            oneChangeCommit.timeConsume = d;
            oneChangeCommit.isSuccess = "1";
            oneChangeCommit.currentPosition = (double) this.mPlayerContainer.getPlayer().getCurrentPosition(Aliplayer.PositionType.NORMAL);
