...
public class ImpairmentCommit extends BaseTrack implements Track.OnExtrasBuildCallback {
    ...
    private double mConsumedSizeSEnd = -1.0d;
    private double mConsumedSizeStart = -1.0d;
    private double mDownLoadSizeEnd = -1.0d;
    private double mDownLoadSizeStart = -1.0d;
    ...
    public ImpairmentCommit(Track track, double d) {
        super(track);
        this.mTrack = track;
        this.mStartTime = (double) System.currentTimeMillis();
        this.mPosition = d;
    ...
    public void commit(YoukuVideoInfo youkuVideoInfo, double d, String str, int i, int i2, Object obj) {
        if (youkuVideoInfo != null) {
            ...
            String str2 = "1";
            dimensions.put("isAuto", TrackUtil.isAuto(playVideoInfo) ? str2 : "0");
            ...
            dimensions.put(TableField.IS_VIP, str2);
            ...
            measures.put("durationAfterSeek", Double.valueOf(getCost((double) System.currentTimeMillis(), (double) this.mTrack.getSeekChangeTrack().getEndTime())));
            measures.put("durationAfterTune", Double.valueOf(getCost((double) System.currentTimeMillis(), (double) this.mTrack.getQualityChangeTrack().getEndTime())));
