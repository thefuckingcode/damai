...
public class UtProxy {
    ...
    public static void utInit(Application application, final String str) {
        if (sIsUseUt) {
            UTAnalytics.getInstance().setAppApplicationInstance(application, new IUTApplication() {
                /* class com.youku.alixplayer.opensdk.statistics.proxy.UtProxy.AnonymousClass2 */
    ...
    public void commit(String str, String str2, Map<String, String> map, Map<String, Double> map2) {
        if (sIsUseAppMonitor) {
            ...
            map.put("page", str);
            map.put(oj2.TAG_MONITOR_POINT, str2);
    ...
    public void init(String str, String str2, String str3, String str4, String str5, UtEventSender utEventSender) {
        ...
        if (utEventSender != null) {
            UtHelperProxy.getInstance().init(str, str2, str3, str4, str5, new UtHelperProxy.UtEventSender() {
                /* class com.youku.alixplayer.opensdk.statistics.proxy.UtProxy.AnonymousClass1 */
    ...
    public void register(String str, String str2, Set<String> set, Set<String> set2) {
        if (sIsUseAppMonitor) {
            ...
            set2.add("ccode");
            set2.add("page");
            set2.add(oj2.TAG_MONITOR_POINT);
