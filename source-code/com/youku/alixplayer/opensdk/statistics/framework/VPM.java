...
public class VPM {
    ...
    private Map<MSGTABLEID, Table> mTables = new HashMap<MSGTABLEID, Table>() {
        /* class com.youku.alixplayer.opensdk.statistics.framework.VPM.AnonymousClass1 */
