...
public class HeartBeatReporter extends BaseTrack {
    ...
    long reportInterval = DateUtils.MILLIS_PER_MINUTE;
    ...
    public void sendHeartBeat(Track track) {
        this.isVip = "1.".equals(this.mPlayer.getPlayerConfig().getDynamicProperties().call(TableField.IS_VIP));
        String str = "1";
        this.isLogin = str.equals(this.mPlayer.getPlayerConfig().getDynamicProperties().call("isLogin"));
