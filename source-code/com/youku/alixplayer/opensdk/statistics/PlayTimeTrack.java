...
public class PlayTimeTrack implements IPlayTimeTrack {
    ...
    private Map<String, Double> mFastPlayTimes = new ConcurrentHashMap<String, Double>() {
        /* class com.youku.alixplayer.opensdk.statistics.PlayTimeTrack.AnonymousClass1 */
    ...
    private Map<String, Double> mPlayerCoreTimes = new ConcurrentHashMap<String, Double>() {
        /* class com.youku.alixplayer.opensdk.statistics.PlayTimeTrack.AnonymousClass3 */
    ...
    private Map<String, Long> mPlayerCoreTimestamp = new ConcurrentHashMap<String, Long>() {
        /* class com.youku.alixplayer.opensdk.statistics.PlayTimeTrack.AnonymousClass2 */
    };
    ...
    private double cut(String str, String str2) {
        ...
        return (double) (l.longValue() - l2.longValue());
    }
