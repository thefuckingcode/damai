...
public class LiveMediaSource extends BaseLiveVideoStream {
    ...
    @Override // com.youku.alixplayer.BaseMediaSource, com.youku.alixplayer.opensdk.BaseLiveVideoStream, com.youku.alixplayer.IMediaSource
    public void preparePlaylist() {
        ...
        if (buildPlaylistByLiveInfo != null) {
            ...
            if (list == null || list.isEmpty()) {
                ...
                new RealInterceptionWrapper(2, this.mPlayList, this.mInterceptors, new Interceptor() {
                    /* class com.youku.alixplayer.opensdk.live.LiveMediaSource.AnonymousClass1 */
