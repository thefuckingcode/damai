...
public class LiveVideoInfo extends YoukuVideoInfo {
    ...
    public String isMcu() {
        LivePlayControl livePlayControl = this.mLivePlayControl;
        return (livePlayControl == null || !"mic".equals(livePlayControl.streamMode) || !PushConstants.URI_PACKAGE_NAME.equals(this.mLivePlayControl.micMode) || this.mLivePlayControl.mcu != 1) ? "0" : "1";
    }
