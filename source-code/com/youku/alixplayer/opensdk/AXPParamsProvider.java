...
public class AXPParamsProvider {
    ...
    private static class PerfMonitor {
        ...
        public PerfMonitor putStepMeasure(String str) {
            ...
            this.measureValueSet.setValue(str, (double) (this.timestampStepBegin - System.currentTimeMillis()));
            return this;
        }
        ...
        public PerfMonitor putTotalMeasure(String str) {
            ...
            this.measureValueSet.setValue(str, (double) (this.timestampTotalBegin - System.currentTimeMillis()));
            return this;
        }
