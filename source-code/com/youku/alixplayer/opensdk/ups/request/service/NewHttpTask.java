    ...
    private boolean connectAPI(RequestData requestData) {
        ...
        try {
            ...
            if (isCallSuccess) {
                ...
                connectStat4.response_code = YKErrorConstants.converRespondCode(i, ykErrorCode);
                Logger.e(str, "http fail " + this.connectStat.response_code);
            } else {
                ConnectStat connectStat7 = this.connectStat;
                connectStat7.response_code = YKErrorConstants.converRespondCode(connectStat7.response_code, ykErrorCode);
