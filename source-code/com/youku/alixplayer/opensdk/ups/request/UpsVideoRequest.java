...
public class UpsVideoRequest implements IVideoRequest {
    ...
    private void checkResult(PlayVideoInfo playVideoInfo, VideoInfo videoInfo, ConnectStat connectStat, IVideoRequest.Callback callback) {
        if (!this.mIsCancel) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void reportError(final IVideoRequest.Callback callback, final VideoRequestError videoRequestError) {
        this.mHandler.post(new Runnable() {
            /* class com.youku.alixplayer.opensdk.ups.request.UpsVideoRequest.AnonymousClass3 */

            public void run() {
                IVideoRequest.Callback callback = callback;
                if (callback != null) {
    ...
    private void reportSuccess(final VideoInfo videoInfo, final Map<String, String> map, final IVideoRequest.Callback callback) {
        this.mHandler.post(new Runnable() {
            /* class com.youku.alixplayer.opensdk.ups.request.UpsVideoRequest.AnonymousClass2 */
    ...
    public void request(final PlayVideoInfo playVideoInfo, Map<String, String> map) {
        ...
        playVideoInfo2.point = str;
        playVideoInfo2.audiolang = str;
        playVideoInfo2.media_type = getMediaType();
        if (!this.mPlayerConfig.isSupportH265()) {
            str = "0";
        }
        playVideoInfo2.h265 = str;
        ...
        try {
            if (this.mPlayerConfig.getDrmConfig() != null) {
                ...
                playVideoInfo2.encryptR_client = PlayerUtil.urlEncoder(str2);
                playVideoInfo2.key_index = generateEncryptRClient.keyIndex;
                Logger.d("DrmManager", "R1:" + this.mDrmR1);
                Logger.d("DrmManager", "staticSafeEncrypt:" + str2);
        ...
        if (TextUtils.isEmpty(string) || TextUtils.isEmpty(string2)) {
            this.mRequest = new UpsInfoRequest(this.mContext, networkTask, this.mPlayerConfig.isExternal());
        } else {
            this.mRequest = new UpsInfoRequest(this.mContext, networkTask, this.mPlayerConfig.isExternal(), string, string2);
        }
        this.mRequest.request(playVideoInfo2, map, null, createNetworkParam, new IUpsInfoRequest.IUpsInfoRequestCallback() {
            /* class com.youku.alixplayer.opensdk.ups.request.UpsVideoRequest.AnonymousClass1 */
