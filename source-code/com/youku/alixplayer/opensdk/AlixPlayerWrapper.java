...
public class AlixPlayerWrapper extends AlixPlayer implements IPlayerWrapper {
    ...
    @Override // com.youku.alixplayer.IAlixPlayer, com.youku.alixplayer.opensdk.IPlayer, com.youku.alixplayer.AlixPlayer
    public long getDuration() {
        IVideoStream iVideoStream = this.mVideoStream;
        return Math.max((iVideoStream == null || iVideoStream.getCurrentBitStream() == null) ? 0 : (long) this.mVideoStream.getCurrentBitStream().getLength(), super.getDuration());
    }
    ...
    @Override // com.youku.alixplayer.IAlixPlayer, com.youku.alixplayer.AlixPlayer
    ...
    @Override // com.youku.alixplayer.IAlixPlayer, com.youku.alixplayer.AlixPlayer, com.youku.alixplayer.opensdk.IPlayerWrapper
    public void reset() {
    ...
    public void seekTo(int i, int i2) {
        if (this.mPlayerTrack != null) {
            ...
            bundle.putDouble("position", (double) i);
