...
public class SystemPlayerQueue {
    ...
    public SystemPlayerQueue() {
        AnonymousClass1 r0 = new SystemInstancePool.Instantiater<AndroidPlayer>() {
            /* class com.youku.alixplayer.instances.System.SystemPlayerQueue.AnonymousClass1 */
        ...
        this.mInstantiater = r0;
        this.mInstancePool = new SystemInstancePool<>(r0, 0);
    }
