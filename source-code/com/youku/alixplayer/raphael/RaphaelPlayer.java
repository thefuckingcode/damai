...
public class RaphaelPlayer extends Aliplayer {
    ...
    private RaphaelPlayerEngine.OnInfoListener mOnInfoListener = new RaphaelPlayerEngine.OnInfoListener() {
        /* class com.youku.alixplayer.raphael.RaphaelPlayer.AnonymousClass1 */
        ...
        public void onInfo(int i, int i2, int i3, Object obj) {
            ...
            try {
                if (RaphaelPlayer.this.playerEventListener != null) {
                    RaphaelPlayer.this.playerEventListener.onNotify(RaphaelPlayer.this.identity, i5, i4, i3, obj);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public RaphaelPlayer(Context context) {
        ...
        this.identity = new IdentityExt(-1);
    }
