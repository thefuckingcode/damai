...
public class AdPlugin extends YKEventListener implements Interceptor, IAdAction {
    ...
    private void initAdEventListener() {
        this.mPlayerAdManager.setOnAdEventListener(new OnAdEventListener() {
            /* class com.youku.youkuplayer.plugin.ad.AdPlugin.AnonymousClass1 */
    ...
    @Override // com.youku.youkuplayer.IAdEventListener, com.youku.youkuplayer.YKEventListener
    ...
    public void onRealVideoStart() {
        ...
        runOnUiThread(new Runnable() {
            /* class com.youku.youkuplayer.plugin.ad.AdPlugin.AnonymousClass2 */
