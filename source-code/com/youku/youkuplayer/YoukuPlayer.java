...
public class YoukuPlayer implements OnResizerListener, IYoukuPlayer {
    ...
    private PlayerEventListener mPlayerEventListener = new PlayerEventListener() {
        /* class com.youku.youkuplayer.YoukuPlayer.AnonymousClass3 */
    ...
    private void initPlayer() {
        ...
        if (!this.mPlayerConfig.isDisableAd()) {
            ...
            this.mAdPlugin.setCallback(new PlayerCallBack() {
                /* class com.youku.youkuplayer.YoukuPlayer.AnonymousClass1 */
    ...
    private void initUT(Application application, PlayerConfig playerConfig) {
        ...
        UTAnalytics.getInstance().setAppApplicationInstance(application, new IUTApplication() {
            /* class com.youku.youkuplayer.YoukuPlayer.AnonymousClass2 */
    ...
    private void initVideoInfo(PlayInfoResult playInfoResult) {
    ...
    public long getCurrentPosition() {
        return (long) ((int) this.mPlayerService.getCurrentPosition());
    }
