...
public class ColorUtil {
    ...
    public static int getColorWithAlpha(float f, int i) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "424015660")) {
            return (Math.min(255, Math.max(0, (int) (f * 255.0f))) << 24) + (i & 16777215);
        }
        return ((Integer) ipChange.ipc$dispatch("424015660", new Object[]{Float.valueOf(f), Integer.valueOf(i)})).intValue();
    }
    ...
    public static int parseColor(String str, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1375166003")) {
            ...
            String substring = str.substring(str.indexOf(jl1.BRACKET_START_STR) + 1, str.indexOf(jl1.BRACKET_END_STR));
