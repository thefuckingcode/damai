...
public class ShapeBuilder {
    ...
    public ShapeBuilder gradient(int i, int i2, int i3) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1010618233")) {
            return gradientInit(GradientDrawable.Orientation.TOP_BOTTOM, i, i2, i3);
        }
        return (ShapeBuilder) ipChange.ipc$dispatch("-1010618233", new Object[]{this, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)});
    }
    ...
    public ShapeBuilder gradient(GradientDrawable.Orientation orientation, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "513377010")) {
            return (ShapeBuilder) ipChange.ipc$dispatch("513377010", new Object[]{this, orientation, Integer.valueOf(i), Integer.valueOf(i2)});
        }
        return gradientInit(orientation, i, i2);
    }
    ...
    public ShapeBuilder radius(float f, float f2, float f3, float f4) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "198218940")) {
            return roundRadius(f, f2, f3, f4);
        }
        return (ShapeBuilder) ipChange.ipc$dispatch("198218940", new Object[]{this, Float.valueOf(f), Float.valueOf(f2), Float.valueOf(f3), Float.valueOf(f4)});
    }
    ...
    public ShapeBuilder stroke(int i, int i2, int i3, int i4) {
        ...
        this.drawable.setStroke(i, i2, (float) i3, (float) i4);
        AttrContainer attrContainer = this.container;
        if (attrContainer != null) {
            attrContainer.strokeWidth = i;
            attrContainer.stokeColor = i2;
    ...
    public ShapeBuilder gradient(GradientDrawable.Orientation orientation, int i, int i2, int i3) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1780510159")) {
            return gradientInit(orientation, i, i2, i3);
        }
        return (ShapeBuilder) ipChange.ipc$dispatch("1780510159", new Object[]{this, orientation, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)});
    }
}
