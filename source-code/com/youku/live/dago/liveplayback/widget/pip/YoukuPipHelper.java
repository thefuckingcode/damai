...
public class YoukuPipHelper {
    ...
    private BroadcastReceiver mPiPBroadcastReceiver = new BroadcastReceiver() {
        /* class com.youku.live.dago.liveplayback.widget.pip.YoukuPipHelper.AnonymousClass2 */
    ...
    public State getState() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1825906778")) {
            return this.mState;
        }
        return (State) ipChange.ipc$dispatch("1825906778", new Object[]{this});
    }

    public boolean isInPictureInPictureMode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1267589598")) {
            return this.mIsInPictureInPictureMode;
        }
        return ((Boolean) ipChange.ipc$dispatch("1267589598", new Object[]{this})).booleanValue();
    }
        ...
        if (this.mApplicationContext != null && this.mPlayerContainer != null) {
            if (z) {
                ...
                AnonymousClass1 r5 = new BroadcastReceiver() {
                    /* class com.youku.live.dago.liveplayback.widget.pip.YoukuPipHelper.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    public void onReceive(Context context, Intent intent) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "541289555")) {
                            ipChange.ipc$dispatch("541289555", new Object[]{this, context, intent});
                            return;
                        }
                ...
                this.mReceiver = r5;
                this.mApplicationContext.registerReceiver(r5, new IntentFilter(ACTION_MEDIA_CONTROL));
                return;
            }
