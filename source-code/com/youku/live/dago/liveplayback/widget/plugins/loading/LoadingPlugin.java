...
public class LoadingPlugin extends AbsPlugin implements Interceptor {
    ...
    private OnInfoListener mOnInfoListener = new OnInfoListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.loading.LoadingPlugin.AnonymousClass3 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private OnStateChangeListener mOnStateChangeListener = new OnStateChangeListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.loading.LoadingPlugin.AnonymousClass2 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private OnVideoStreamListener mOnVideoStreamListener = new OnVideoStreamListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.loading.LoadingPlugin.AnonymousClass1 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private Runnable mRetryRunnable = new Runnable() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.loading.LoadingPlugin.AnonymousClass4 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    public void intercept(Chain<Object> chain) {
        ...
        if (chain.getAction() == 3) {
            ...
            if (needRetry(message) && (i = this.mSumDelayMillis) < 300000) {
                ...
                this.mHandler.postDelayed(this.mRetryRunnable, (long) this.mDelayMillis);
                this.mRetryCount++;
                return;
            }
        }
