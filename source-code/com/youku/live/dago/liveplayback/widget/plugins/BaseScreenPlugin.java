...
public abstract class BaseScreenPlugin extends AbsPlugin {
    ...
    private Runnable hideControlRunnable = new Runnable() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.BaseScreenPlugin.AnonymousClass2 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    public void bindData(List<Map<String, Object>> list) {
        ...
        Collections.sort(list, new Comparator<Map<String, Object>>() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.BaseScreenPlugin.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public int compare(Map<String, Object> map, Map<String, Object> map2) {
                IpChange ipChange = $ipChange;
                if (!AndroidInstantRuntime.support(ipChange, "-141725383")) {
                    return ((Integer) map.get("p")).intValue() - ((Integer) map2.get("p")).intValue();
                }
                return ((Integer) ipChange.ipc$dispatch("-141725383", new Object[]{this, map, map2})).intValue();
            }
        });
    ...
    public boolean canShow() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-904145777")) {
            return this.mPlayerContext.getMode() != 1;
        }
        return ((Boolean) ipChange.ipc$dispatch("-904145777", new Object[]{this})).booleanValue();
    }
    ...
    public void hideControlDelay() {
        ...
        this.mHandler.postDelayed(this.hideControlRunnable, 6000);
    }
