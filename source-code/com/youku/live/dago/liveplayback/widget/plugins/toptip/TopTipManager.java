...
public class TopTipManager {
    ...
    public static boolean canShowWhenControlBarVisible(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-879754436")) {
            return 1001 == i;
        }
        return ((Boolean) ipChange.ipc$dispatch("-879754436", new Object[]{Integer.valueOf(i)})).booleanValue();
    }
    ...
    public static TopTipConfigManager.RemoteTopTipInfo getRemoteTopTipConfig(int i, Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1931460839")) {
            return TopTipConfigManager.getRemoteTopTipInfo(i, context);
        }
        return (TopTipConfigManager.RemoteTopTipInfo) ipChange.ipc$dispatch("1931460839", new Object[]{Integer.valueOf(i), context});
    }
    ...
    public static boolean isValidLevel(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2067282777")) {
            return i >= 0 || i <= 1000;
        }
        return ((Boolean) ipChange.ipc$dispatch("2067282777", new Object[]{Integer.valueOf(i)})).booleanValue();
    }
    ...
    public static void registerTipLevel(String str, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1468846587")) {
            ...
            sLevelMap.put(str, Integer.valueOf(i));
        }
    }
}
