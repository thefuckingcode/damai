...
public class TopTipConfigManager {
    ...
    public static class RemoteTopTipInfo {
        ...
        public boolean isCustomStyle() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "876858534")) {
                return "3".equals(this.styleType);
            }
            return ((Boolean) ipChange.ipc$dispatch("876858534", new Object[]{this})).booleanValue();
        }

        public boolean isVipStyle() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "182622360")) {
                return "2".equals(this.styleType);
            }
            return ((Boolean) ipChange.ipc$dispatch("182622360", new Object[]{this})).booleanValue();
        }
