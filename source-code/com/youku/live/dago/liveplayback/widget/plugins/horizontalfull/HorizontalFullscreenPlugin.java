...
public class HorizontalFullscreenPlugin extends BaseScreenPlugin implements HorizontalFullControlContact.Presenter {
    ...
    private OnDataSourceListener mOnDataSourceListener = new OnDataSourceListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullscreenPlugin.AnonymousClass6 */
    ...
    public HorizontalFullscreenPlugin(AlixPlayerContext alixPlayerContext, PluginConfig pluginConfig, ViewGroup viewGroup) {
        ...
        alixPlayerContext.getPlayerContainer().addVideoStreamListener(new OnVideoStreamListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullscreenPlugin.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onDataReady(final YoukuVideoInfo youkuVideoInfo) {
                ...
                ((BaseScreenPlugin) HorizontalFullscreenPlugin.this).mHandler.post(new Runnable() {
                    /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullscreenPlugin.AnonymousClass1.AnonymousClass2 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    public void run() {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-957131514")) {
                            ipChange.ipc$dispatch("-957131514", new Object[]{this});
                            return;
                        }
            ...
            public void onNewRequest(PlayVideoInfo playVideoInfo) {
                ...
                ((BaseScreenPlugin) HorizontalFullscreenPlugin.this).mHandler.post(new Runnable() {
                    /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullscreenPlugin.AnonymousClass1.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    public void run() {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-760618009")) {
                            ipChange.ipc$dispatch("-760618009", new Object[]{this});
        ...
        this.mPlayerContainer.addPositionChangeListener(new OnCurrentPositionChangeListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullscreenPlugin.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onCurrentPostionChange(final int i) {
                ...
                ((BaseScreenPlugin) HorizontalFullscreenPlugin.this).mHandler.post(new Runnable() {
                    /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullscreenPlugin.AnonymousClass2.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    public void run() {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-631535290")) {
                            ipChange.ipc$dispatch("-631535290", new Object[]{this});
                        } else if (HorizontalFullscreenPlugin.this.mView.isShow()) {
        ...
        this.mPlayer.addOnPlayerStateListener(new OnStateChangeListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullscreenPlugin.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        this.mPlayer.addOnInfoListener(new OnInfoListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullscreenPlugin.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onInfo(int i, final int i2, int i3, Object obj) {
                ...
                if (AndroidInstantRuntime.support(ipChange, "-1957189058")) {
                    ...
                    ((BaseScreenPlugin) HorizontalFullscreenPlugin.this).mHandler.post(new Runnable() {
                        /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullscreenPlugin.AnonymousClass4.AnonymousClass1 */
                        private static transient /* synthetic */ IpChange $ipChange;

                        public void run() {
                            IpChange ipChange = $ipChange;
                            if (AndroidInstantRuntime.support(ipChange, "-373369852")) {
                                ipChange.ipc$dispatch("-373369852", new Object[]{this});
                                return;
                            }
    ...
    private void initShow() {
        ...
        this.mHandler.post(new Runnable() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullscreenPlugin.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "337702352")) {
                    ipChange.ipc$dispatch("337702352", new Object[]{this});
    ...
    public int getMode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-25569242")) {
            return getPlayerContext().getMode();
        }
        return ((Integer) ipChange.ipc$dispatch("-25569242", new Object[]{this})).intValue();
    }
    ...
    public BaseView getView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "830576706")) {
            return this.mView;
        }
        return (BaseView) ipChange.ipc$dispatch("830576706", new Object[]{this});
    }
