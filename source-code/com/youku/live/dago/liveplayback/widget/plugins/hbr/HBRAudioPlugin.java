...
public class HBRAudioPlugin extends AbsPlugin {
    ...
    private OnChangeVideoListener mOnChangeVideoListener = new OnChangeVideoListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.hbr.HBRAudioPlugin.AnonymousClass3 */
    ...
    private OnNotifyListener mOnNotifyListener = new OnNotifyListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.hbr.HBRAudioPlugin.AnonymousClass4 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private OnStateChangeListener mOnStateChangeListener = new OnStateChangeListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.hbr.HBRAudioPlugin.AnonymousClass2 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private OnVideoStreamListener mOnVideoStreamListener = new OnVideoStreamListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.hbr.HBRAudioPlugin.AnonymousClass1 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private boolean isSupportAudioHbr(YoukuVideoInfo youkuVideoInfo) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "204471405")) {
        ...
        } else if (youkuVideoInfo == null || youkuVideoInfo.getLivePlayControl() == null || youkuVideoInfo.getLivePlayControl().playerWidget == null) {
            return false;
        } else {
            ...
            boolean isSupportAudioHbr = PostProcessingConfigManager2.isSupportAudioHbr(str, "8", youkuVideoInfo.getLivePlayControl().playerWidget);
            if (!z2 || !isSupportAudioHbr) {
                z = false;
            }
            return z;
        }
    ...
    private void onAudioHbrClick(boolean z) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onChangeVideoFinish() {
        IpChange ipChange = $ipChange;
            ...
            if (!z) {
                ...
                if (!HbrUtil.isVideoHbr(this.mYoukuVideoInfo, liveQuality) && z2) {
                    this.mHandler.post(new Runnable() {
                        /* class com.youku.live.dago.liveplayback.widget.plugins.hbr.HBRAudioPlugin.AnonymousClass5 */
                        private static transient /* synthetic */ IpChange $ipChange;

                        public void run() {
                            IpChange ipChange = $ipChange;
                            if (AndroidInstantRuntime.support(ipChange, "-254423836")) {
                                ipChange.ipc$dispatch("-254423836", new Object[]{this});
                                return;
                            }
