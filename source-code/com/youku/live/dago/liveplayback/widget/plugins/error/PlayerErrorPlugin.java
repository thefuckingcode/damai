...
public class PlayerErrorPlugin extends BaseErrorPlugin {
    ...
    private OnPlayerErrorListener mOnPlayerErrorListener = new OnPlayerErrorListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.error.PlayerErrorPlugin.AnonymousClass1 */
    ...
    private OnStateChangeListener mPlayerStateChangeListener = new OnStateChangeListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.error.PlayerErrorPlugin.AnonymousClass2 */
        private static transient /* synthetic */ IpChange $ipChange;
