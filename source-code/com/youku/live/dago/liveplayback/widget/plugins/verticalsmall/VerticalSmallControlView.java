...
public class VerticalSmallControlView extends LazyInflatedView implements VerticalSmallControlContract.View {
    ...
    private float mAnimationY = 0.0f;
    ...
    private void initView(View view) {
        ...
        circleImageView.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.verticalsmall.VerticalSmallControlView.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "626952626")) {
                    ipChange.ipc$dispatch("626952626", new Object[]{this, view});
                    return;
                }
        ...
        this.mSeekBar.setTrackPadding((float) dimension);
        int i = dimension * 2;
        this.mSeekBar.setPadding(0, i, 0, i);
        this.mSeekBar.setOnSeekBarChangeListener(new PlayerSeekBar.OnSeekBarChangeListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.verticalsmall.VerticalSmallControlView.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onBackClicked(long j, long j2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "692550471")) {
                    ipChange.ipc$dispatch("692550471", new Object[]{this, Long.valueOf(j), Long.valueOf(j2)});
                    return;
                }
            ...
            public void onProgressChanged(PlayerSeekBar playerSeekBar, long j, boolean z) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1764900369")) {
                    ipChange.ipc$dispatch("1764900369", new Object[]{this, playerSeekBar, Long.valueOf(j), Boolean.valueOf(z)});
                } else if (z) {
            ...
            public void onStartTrackingTouch(PlayerSeekBar playerSeekBar) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-415765954")) {
                    ipChange.ipc$dispatch("-415765954", new Object[]{this, playerSeekBar});
                }
            }
            ...
            public void onStopTrackingTouch(PlayerSeekBar playerSeekBar, long j, boolean z, boolean z2, long j2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1590618814")) {
                    ipChange.ipc$dispatch("-1590618814", new Object[]{this, playerSeekBar, Long.valueOf(j), Boolean.valueOf(z), Boolean.valueOf(z2), Long.valueOf(j2)});
                    return;
                }
                VerticalSmallControlView.this.isSeeking = false;
                if (z) {
            ...
            public void onTrackingPressDown(PlayerSeekBar playerSeekBar) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-498309734")) {
                    ipChange.ipc$dispatch("-498309734", new Object[]{this, playerSeekBar});
                    return;
                }
    ...
    public void addView(List<WeexWidget> list) {
        ...
        for (WeexWidget weexWidget : list) {
            ...
            if ("unlimitScreen".equals(key)) {
                ...
                this.mPickButton.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
                    /* class com.youku.live.dago.liveplayback.widget.plugins.verticalsmall.VerticalSmallControlView.AnonymousClass8 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-120583514")) {
                            ipChange.ipc$dispatch("-120583514", new Object[]{this, view, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6), Integer.valueOf(i7), Integer.valueOf(i8)});
                        } else if (!(i == i5 && i2 == i6 && i3 == i7 && i4 == i8) && !VerticalSmallControlView.this.mPresenter.getPlayerContext().isLandScreen() && view == VerticalSmallControlView.this.mPickButton) {
    ...
    public long getLiveTime() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-726576258")) {
            return this.mLiveTime;
        }
        return ((Long) ipChange.ipc$dispatch("-726576258", new Object[]{this})).longValue();
    }
    ...
    public void onInflate(View view) {
        ...
        findViewById.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.verticalsmall.VerticalSmallControlView.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1411951185")) {
                    ipChange.ipc$dispatch("-1411951185", new Object[]{this, view});
                    return;
                }
        ...
        circleImageView.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.verticalsmall.VerticalSmallControlView.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "699339184")) {
                    ipChange.ipc$dispatch("699339184", new Object[]{this, view});
                    return;
                }
        ...
        this.bottomContainer.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.verticalsmall.VerticalSmallControlView.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-673521333")) {
                    ipChange.ipc$dispatch("-673521333", new Object[]{this, view, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6), Integer.valueOf(i7), Integer.valueOf(i8)});
                } else if ((i != i5 || i2 != i6 || i3 != i7 || i4 != i8) && view.getParent() != null && !VerticalSmallControlView.this.mPresenter.getPlayerContext().isLandScreen()) {
                    VerticalSmallControlView.this.mAnimationY = (float) (((View) view.getParent()).getHeight() - view.getHeight());
                    VerticalSmallControlView.this.showTips();
                }
            }
        });
    ...
    public void updateProgress(int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "2063326472")) {
            ...
            this.mLeftText.setText(Utils.getFormathourTime((long) i));
        }
    }
        ...
        if (AndroidInstantRuntime.support(ipChange, "591799045")) {
            ...
            if (this.mPresenter.getPlayerContext().isDlnaMode()) {
                ...
                if (z) {
                    ...
                    PluginAnimationUtils.pluginBottomHide(this.bottomContainer, new PluginAnimationUtils.AnimationActionListener() {
                        /* class com.youku.live.dago.liveplayback.widget.plugins.verticalsmall.VerticalSmallControlView.AnonymousClass7 */
                        private static transient /* synthetic */ IpChange $ipChange;

                        @Override // com.youku.live.dago.liveplayback.widget.plugins.PluginAnimationUtils.AnimationActionListener
                        public void onAnimationEnd() {
                            IpChange ipChange = $ipChange;
                            if (AndroidInstantRuntime.support(ipChange, "1003091022")) {
                                ipChange.ipc$dispatch("1003091022", new Object[]{this});
                                return;
                            }
    ...
    public void show(boolean z) {
        ...
        if (playerContext.isLandVideo() && !playerContext.isLandScreen() && !isShow()) {
            ...
            if (this.mAnimationY > 0.0f && z) {
                ...
                PluginAnimationUtils.pluginBottomShow(this.bottomContainer, new PluginAnimationUtils.AnimationActionListener() {
                    /* class com.youku.live.dago.liveplayback.widget.plugins.verticalsmall.VerticalSmallControlView.AnonymousClass6 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    @Override // com.youku.live.dago.liveplayback.widget.plugins.PluginAnimationUtils.AnimationActionListener
                    public void onAnimationEnd() {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "791740109")) {
                            ipChange.ipc$dispatch("791740109", new Object[]{this});
                            return;
                        }
                        VerticalSmallControlView.this.showTips();
                    }
