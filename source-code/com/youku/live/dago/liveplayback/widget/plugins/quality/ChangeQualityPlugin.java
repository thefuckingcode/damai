...
public class ChangeQualityPlugin extends AbsPlugin implements ChangeQualityContract.Presenter {
    ...
    public List<Quality> mDefinitions = new ArrayList();
    private IPlayerContainer mPlayer;
    private OnVideoStreamListener mPlayerListener = new OnVideoStreamListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.quality.ChangeQualityPlugin.AnonymousClass1 */
    ...
    public ChangeQualityPlugin(AlixPlayerContext alixPlayerContext, PluginConfig pluginConfig, ViewGroup viewGroup) {
        ...
        this.mPlayerContext.getPlayerContainer().getPlayer().addOnPlayerStateListener(new OnStateChangeListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.quality.ChangeQualityPlugin.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        this.mPlayerContext.getPlayerContainer().addChangeVideoListener(new OnChangeVideoListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.quality.ChangeQualityPlugin.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;
    ...
    private void closeHbrTip() {
        ...
        Utils.showVipTopTips(this.mPlayerContext, TopTipManager.TipName.CHANGE_QUALITY_TIP_PLUGIN, Html.fromHtml("<font color=#F7C3A7>" + "正在关闭VIP专属的帧享视听体验" + "</font>"), 53, -1, 10000, true, null, new TopTipInfo.DismissCallback() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.quality.ChangeQualityPlugin.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.dago.liveplayback.widget.plugins.toptip.TopTipInfo.DismissCallback
            public void onDismiss() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "81953900")) {
                    ipChange.ipc$dispatch("81953900", new Object[]{this});
                    return;
                }
    ...
    private void initData(YoukuVideoInfo youkuVideoInfo) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void showChangeFinishTips(Quality quality) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1962706495")) {
            ipChange.ipc$dispatch("1962706495", new Object[]{this, quality});
            return;
        }
        Utils.showTopTips(this.mPlayerContext, TopTipManager.TipName.CHANGE_QUALITY_TIP_PLUGIN, Html.fromHtml("已为您切换到" + "<font color=#0D9BFF>" + quality.name + "</font>"), -1, -1, 3000, true, null, new TopTipInfo.DismissCallback() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.quality.ChangeQualityPlugin.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.dago.liveplayback.widget.plugins.toptip.TopTipInfo.DismissCallback
            public void onDismiss() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "592488077")) {
                    ipChange.ipc$dispatch("592488077", new Object[]{this});
                    return;
                }
                ChangeQualityPlugin.this.sendQualityTipChangeEvent();
            }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void showChangingTips(Quality quality) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "2000161269")) {
            ipChange.ipc$dispatch("2000161269", new Object[]{this, quality});
            return;
        }
        Utils.showTopTips(this.mPlayerContext, TopTipManager.TipName.CHANGE_QUALITY_TIP_PLUGIN, Html.fromHtml("正在切换到" + "<font color=#0D9BFF>" + quality.name + "</font>" + "，请稍候..."), -1, -1, 3000, true, null, new TopTipInfo.DismissCallback() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.quality.ChangeQualityPlugin.AnonymousClass6 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.dago.liveplayback.widget.plugins.toptip.TopTipInfo.DismissCallback
            public void onDismiss() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-428580277")) {
                    ipChange.ipc$dispatch("-428580277", new Object[]{this});
                    return;
                }
                ChangeQualityPlugin.this.sendQualityTipChangeEvent();
            }
    ...
    public List<String> getBitStreamListSize() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2127664901")) {
            return new ArrayList();
        }
        return (List) ipChange.ipc$dispatch("-2127664901", new Object[]{this});
    }
