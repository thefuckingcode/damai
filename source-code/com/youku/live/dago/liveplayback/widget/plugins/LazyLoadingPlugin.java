...
public class LazyLoadingPlugin implements IPlugin {
    ...
    private Class[] mArgClasses = null;
                ...
                if (this.mInnerPlugin == null) {
                    try {
                        ...
                        if (objArr == null || objArr.length <= 0) {
                            this.mInnerPlugin = (IPlugin) this.mInnerPluginClass.newInstance();
                        } else {
                            this.mInnerPlugin = (IPlugin) this.mInnerPluginClass.getConstructor(this.mArgClasses).newInstance(this.mArguments);
                        }
