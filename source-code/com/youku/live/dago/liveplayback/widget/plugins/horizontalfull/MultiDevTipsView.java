...
public class MultiDevTipsView extends PopupWindow implements View.OnClickListener {
    ...
    private Runnable mCloseRunnable = new Runnable() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.MultiDevTipsView.AnonymousClass1 */
    ...
    private boolean canShow(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "916515700")) {
            return !context.getSharedPreferences("alix_live_tip", 0).getBoolean("is_multi_tip_closed", false);
        }
        return ((Boolean) ipChange.ipc$dispatch("916515700", new Object[]{this, context})).booleanValue();
    }
    ...
    private static int dip2px(Context context, float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1759271615")) {
            return (int) TypedValue.applyDimension(1, f, context.getResources().getDisplayMetrics());
        }
        return ((Integer) ipChange.ipc$dispatch("-1759271615", new Object[]{context, Float.valueOf(f)})).intValue();
    }
    ...
    public void show(View view, String str) {
        ...
        if (checkWindowTokenAvailable()) {
            ...
            this.mHandler.postDelayed(this.mCloseRunnable, 3000);
        }
    }
}
