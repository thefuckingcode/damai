...
public class DlnaPlugin extends AbsPlugin implements OnInflateListener, DlnaContract.Presenter {
    ...
    private int mChangeDevReason = -1;
    private UiApiDef.IControlPanelListener mControlPanelListener = new UiApiDef.IControlPanelListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass10 */
    ...
    private Runnable mDelayShowControl = new Runnable() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass8 */
    ...
    private Runnable mDevicePairRunnable = new Runnable() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass5 */
        private static transient /* synthetic */ IpChange $ipChange;
        ...
        public void run() {
            ...
            if (scanClient != null) {
                ...
                if (DlnaPlugin.this.mTryCount <= SupportApiBu.api().orange().multiscreen().ott_scan_timeout) {
                    LegoApp.handler().postDelayed(DlnaPlugin.this.mDevicePairRunnable, 1000);
                } else {
    ...
    private DlnaPublic.IDlnaDevsListenerEx mDlnaDevListener = new DlnaPublic.IDlnaDevsListenerEx() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass15 */
    ...
    private Boolean mIsDlna = Boolean.FALSE;
    boolean mNeedSetSpeed = false;
    private boolean mNeedUpdate = true;
    private ScanPairDeviceInfo mOttScanDeviceInfo;
    private IPlayer mPlayer;
    private DlnaPlugin mPlugin = this;
    private Client mPushClient = null;
    private DlnaDlg.QualityListener mQualityListener = new DlnaDlg.QualityListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass11 */
        private static transient /* synthetic */ IpChange $ipChange;

        @Override // com.youku.live.dago.liveplayback.widget.plugins.dlna.view.DlnaDlg.QualityListener
        public String onGetCurQuality() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-1468923856")) {
                return DlnaPlugin.this.getCurQuality();
            }
            return (String) ipChange.ipc$dispatch("-1468923856", new Object[]{this});
        }

        @Override // com.youku.live.dago.liveplayback.widget.plugins.dlna.view.DlnaDlg.QualityListener
        public List<DlnaQualityInfo> onGetQualities() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-1361805495")) {
                return DlnaPlugin.this.getDefinitionList();
            }
            return (List) ipChange.ipc$dispatch("-1361805495", new Object[]{this});
        }
    ...
    Double mSpeed = Double.valueOf(1.0d);
    ...
    public DlnaPlugin(AlixPlayerContext alixPlayerContext, PluginConfig pluginConfig, ViewGroup viewGroup) {
        ...
        player.addOnPlayerStateListener(new OnStateChangeListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        alixPlayerContext.getPlayerContainer().addVideoStreamListener(new OnVideoStreamListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        alixPlayerContext.addDataSourceListener(new OnDataSourceListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;
    ...
    private void changeQualitySelected(Activity activity, DlnaQualityInfo dlnaQualityInfo) {
        DlnaPublic.DlnaProjReq dlnaProjReq;
        List devs;
        ...
        if (DlnaApiBu.api().proj().stat() != DlnaPublic.DlnaProjStat.IDLE) {
            dlnaProjReq = DlnaApiBu.api().proj().req();
        } else {
            dlnaProjReq = DlnaApiBu.api().proj().preReq();
        }
        if (dlnaProjReq != null && dlnaProjReq.mDev != null && dlnaProjReq.mDev.getIp() != null && (devs = DlnaApiBu.api().devs().devs()) != null) {
            Client client = null;
            ...
            while (true) {
                ...
                if (client2.getIp() != null && client2.getIp().equalsIgnoreCase(dlnaProjReq.mDev.getIp()) && client2.getManufacturer().equalsIgnoreCase("www.yunos.com_cibn")) {
                    client = client2;
                    break;
                }
            }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void commitOttScanResult(ScanPairDeviceInfo scanPairDeviceInfo) {
    ...
    private void dlnaUpsRequest(PlayVideoInfo playVideoInfo) {
        ...
        if (client != null) {
            ...
            LegoApp.handler().post(new Runnable() {
                /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass14 */
                private static transient /* synthetic */ IpChange $ipChange;
            ...
            if ((obj instanceof Bundle) && (string = (bundle = (Bundle) obj).getString("source")) != null && string.equalsIgnoreCase("ott_scan")) {
                ...
                if (StrUtil.isValidStr(string2)) {
                    ...
                    if (scanPairDeviceInfo != null) {
                        ...
                        LegoApp.handler().postDelayed(this.mDevicePairRunnable, 1000);
                    }
                }
            }
        }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private Client getScanClient(ScanPairDeviceInfo scanPairDeviceInfo) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void handlePreProj(String str, Event event) {
        ...
        if (this.mPlayerContext.isDlnaMode()) {
            dlnaPreProjInfo = DlnaPreProjHandler.createPreProjInfo((Client) null, str, DlnaPublic.DlnaProjScene.DEVPICKER, UiAppDef.DevpickerScene.CHANGE_DEV);
        } else if (parseBoolean) {
            dlnaPreProjInfo = DlnaPreProjHandler.createPreProjInfo((Client) null, str, DlnaPublic.DlnaProjScene.DEVPICKER_AD, UiAppDef.DevpickerScene.DLNA_BTN_AD);
        } else {
            dlnaPreProjInfo = DlnaPreProjHandler.createPreProjInfo((Client) null, str, DlnaPublic.DlnaProjScene.DEVPICKER, UiAppDef.DevpickerScene.DLNA_BTN);
        }
        if (parseBoolean || (obj = event.data) == null) {
            if (dlnaPreProjInfo.mDevpickeScene == UiAppDef.DevpickerScene.CHANGE_DEV) {
                dlnaPreProjInfo.mUseLastDevIfAvailable = false;
            } else {
                dlnaPreProjInfo.mUseLastDevIfAvailable = true;
            }
        } else if (((Boolean) obj).booleanValue()) {
            dlnaPreProjInfo.mUseLastDevIfAvailable = false;
        } else if (dlnaPreProjInfo.mDevpickeScene == UiAppDef.DevpickerScene.CHANGE_DEV) {
            dlnaPreProjInfo.mUseLastDevIfAvailable = false;
        } else {
            dlnaPreProjInfo.mUseLastDevIfAvailable = true;
        }
        DlnaPreProjHandler dlnaPreProjHandler = new DlnaPreProjHandler(this, dlnaPreProjInfo);
    ...
    private void initWithFetchDeviceInfoAndCheckShowPanel() {
        ...
        long configLong = OptConfigUtils.getConfigLong("delayInitDlnaSdk", 0);
        AnonymousClass4 r1 = new Runnable() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        if (!isOpenOpt || configLong <= 0) {
            ...
            LegoApp.handler().postDelayed(r1, configLong);
        }
    }
    ...
    private void onRealVideoStart() {
        LegoApp.handler().post(new Runnable() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass7 */
            private static transient /* synthetic */ IpChange $ipChange;
    ...
    private void showFullDlnaControl(DlnaPublic.DlnaProjScene dlnaProjScene) {
        if (!isShowFullScreenControl(dlnaProjScene)) {
            ...
            LegoApp.handler().postDelayed(new Runnable() {
                /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass9 */
                private static transient /* synthetic */ IpChange $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void startOttScanProj(Client client, String str) {
    ...
    public void handleDrm(Client client) {
        if (YkMultiscreenEntry.isInited()) {
            LegoApp.handler().post(new Runnable() {
                /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass12 */
                private static transient /* synthetic */ IpChange $ipChange;
    ...
    public void handleNoCopyRight() {
        if (YkMultiscreenEntry.isInited()) {
            LegoApp.handler().post(new Runnable() {
                /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass13 */
                private static transient /* synthetic */ IpChange $ipChange;
    ...
    public void onShowDlnaPanel(DlnaPublic.DlnaProjScene dlnaProjScene) {
        ...
        LegoApp.handler().postDelayed(this.mDelayShowControl, 500);
    ...
    public void showDeviceListInfo(final Event event) {
        ...
        if (this.mYoukuVideoInfo != null) {
            if (!checkCopyrightForbidden()) {
                ...
                this.mDlnaOpreater.liveRequestForCopyright(this.mPlayerContext.getPlayerContainer().getPlayVideoInfo().getLiveId(), new IVideoRequest.Callback<BypassPlayInfo, LivePlayControl>() {
                    /* class com.youku.live.dago.liveplayback.widget.plugins.dlna.DlnaPlugin.AnonymousClass6 */
                    private static transient /* synthetic */ IpChange $ipChange;
    ...
    public void startProj(Client client, DlnaPreProjHandler dlnaPreProjHandler) {
        if (this.mDlnaOpreater != null) {
            if (dlnaPreProjHandler.getPreProjInfo().liveQuality == -1) {
                ...
                while (true) {
                    if (it.hasNext()) {
                        if (it.next().quality == this.mPlayer.getVideoStream().getCurAlixVideoItem().getLiveQuality()) {
