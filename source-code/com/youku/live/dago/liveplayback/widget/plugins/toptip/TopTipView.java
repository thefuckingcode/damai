...
public class TopTipView extends LazyInflatedView implements TopTipContract.View {
    ...
    private boolean mEnableTipBg = true;
    private int mOffset;
    ...
    private View.OnTouchListener onSpanTextViewTouchListener = new View.OnTouchListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.toptip.TopTipView.AnonymousClass1 */
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1555587568")) {
            ...
            if (i == 4) {
                ...
                if (topTipInfo.textSize > 0) {
                    px2sp = Utils.px2sp(getContext(), (float) topTipInfo.textSize);
                }
