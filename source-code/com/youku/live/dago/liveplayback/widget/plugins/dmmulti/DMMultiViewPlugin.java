...
public class DMMultiViewPlugin extends AbsPlugin {
    ...
    private MultiGridViewClickListener multiGridViewClickListener = new MultiGridViewClickListener() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.dmmulti.DMMultiViewPlugin.AnonymousClass2 */
    ...
    public DMMultiViewPlugin(AlixPlayerContext alixPlayerContext, PluginConfig pluginConfig, ViewGroup viewGroup) {
        ...
        AnonymousClass3 r4 = new OnVideoStreamListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.dmmulti.DMMultiViewPlugin.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        this.mVideoStreamListenre = r4;
        this.mActivityLifeCycleListener = new ActivityLifeCycleListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.dmmulti.DMMultiViewPlugin.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        this.mOnNotifyListener = new OnNotifyListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.dmmulti.DMMultiViewPlugin.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        playerContainer.addVideoStreamListener(r4);
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private String getMcuSceneId(List<Stream> list) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onMultiMode(boolean z) {
        IpChange ipChange = $ipChange;
    ...
    private void request(String str) {
        ...
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.liveplayback.widget.plugins.dmmulti.DMMultiViewPlugin.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;
                ...
                public void onFinish(INetResponse iNetResponse) {
                    ...
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-2029823018")) {
                        ipChange.ipc$dispatch("-2029823018", new Object[]{this, iNetResponse});
                        return;
                    }
    ...
    public boolean isFullScreen() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1456907096")) {
            return ((Boolean) ipChange.ipc$dispatch("1456907096", new Object[]{this})).booleanValue();
