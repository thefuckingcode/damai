...
public class QualityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public int getItemViewType(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "883790326")) {
            return super.getItemViewType(i);
        }
        return ((Integer) ipChange.ipc$dispatch("883790326", new Object[]{this, Integer.valueOf(i)})).intValue();
    }

    public int getSelection() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-670749441")) {
            return this.mSelection;
        }
        return ((Integer) ipChange.ipc$dispatch("-670749441", new Object[]{this})).intValue();
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1107181366")) {
            ...
            if (list != null && i < list.size()) {
                ...
                TextPaint paint = myViewHolder.item_txt.getPaint();
