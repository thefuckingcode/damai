...
public class PickTipsView extends PopupWindow implements View.OnClickListener {
    ...
    private Runnable mCloseRunnable = new Runnable() {
        /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.PickTipsView.AnonymousClass1 */
    ...
    private boolean canShow(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1544700985")) {
            return !context.getSharedPreferences("alix_live_tip", 0).getBoolean("is_pick_tip_closed", false);
        }
        return ((Boolean) ipChange.ipc$dispatch("1544700985", new Object[]{this, context})).booleanValue();
    }
    ...
    private static int dip2px(Context context, float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1131086330")) {
            return (int) TypedValue.applyDimension(1, f, context.getResources().getDisplayMetrics());
        }
        return ((Integer) ipChange.ipc$dispatch("-1131086330", new Object[]{context, Float.valueOf(f)})).intValue();
    }
