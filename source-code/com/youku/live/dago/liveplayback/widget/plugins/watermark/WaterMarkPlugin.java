...
public class WaterMarkPlugin implements OnCurrentPositionChangeListener, OnStateChangeListener, OnVideoStreamListener {
    ...
    private WaterMarkContainer mWaterMarkContainer = new WaterMarkContainer(this.mContext);
    ...
    public WaterMarkContainer getWaterMarkContainer() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-489572043")) {
            return this.mWaterMarkContainer;
        }
        return (WaterMarkContainer) ipChange.ipc$dispatch("-489572043", new Object[]{this});
    }
