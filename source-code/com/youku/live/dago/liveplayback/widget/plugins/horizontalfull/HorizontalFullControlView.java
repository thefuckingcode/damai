...
public class HorizontalFullControlView extends LazyInflatedView implements View.OnClickListener, HorizontalFullControlContact.View {
    ...
    private void initView(View view) {
        ...
        circleImageView.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullControlView.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1919383561")) {
                    ipChange.ipc$dispatch("-1919383561", new Object[]{this, view});
                    return;
                }
        ...
        this.mSeekBar.setOnSeekBarChangeListener(new PlayerSeekBar.OnSeekBarChangeListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullControlView.AnonymousClass6 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onBackClicked(long j, long j2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "264091170")) {
                    ipChange.ipc$dispatch("264091170", new Object[]{this, Long.valueOf(j), Long.valueOf(j2)});
                    return;
                }
            ...
            public void onProgressChanged(PlayerSeekBar playerSeekBar, long j, boolean z) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-2086395668")) {
                    ipChange.ipc$dispatch("-2086395668", new Object[]{this, playerSeekBar, Long.valueOf(j), Boolean.valueOf(z)});
                } else if (z) {
            ...
            public void onStartTrackingTouch(PlayerSeekBar playerSeekBar) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "453141187")) {
                    ipChange.ipc$dispatch("453141187", new Object[]{this, playerSeekBar});
                }
            }
            ...
            public void onStopTrackingTouch(PlayerSeekBar playerSeekBar, long j, boolean z, boolean z2, long j2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1745874275")) {
                    ipChange.ipc$dispatch("-1745874275", new Object[]{this, playerSeekBar, Long.valueOf(j), Boolean.valueOf(z), Boolean.valueOf(z2), Long.valueOf(j2)});
                    return;
                }
                HorizontalFullControlView.this.isSeeking = false;
                if (z) {
            ...
            public void onTrackingPressDown(PlayerSeekBar playerSeekBar) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-54638475")) {
                    ipChange.ipc$dispatch("-54638475", new Object[]{this, playerSeekBar});
                    return;
                }
    ...
    public long getLiveTime() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "304459962")) {
            return this.mLiveTime;
        }
        return ((Long) ipChange.ipc$dispatch("304459962", new Object[]{this})).longValue();
    }
    ...
    public void onInflate(View view) {
        ...
        findViewById.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullControlView.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1774610445")) {
                    ipChange.ipc$dispatch("-1774610445", new Object[]{this, view});
                    return;
                }
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullControlView.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "336679924")) {
                    ipChange.ipc$dispatch("336679924", new Object[]{this, view});
                    return;
                }
                HorizontalFullControlView.this.mPresenter.showQuality(view);
            }
        });
        ...
        view.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullControlView.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "590040711")) {
                    ipChange.ipc$dispatch("590040711", new Object[]{this, view, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6), Integer.valueOf(i7), Integer.valueOf(i8)});
        ...
        this.fullBottomContainer.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
            /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullControlView.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1559621734")) {
                    ipChange.ipc$dispatch("1559621734", new Object[]{this, view, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6), Integer.valueOf(i7), Integer.valueOf(i8)});
                } else if ((i != i5 || i2 != i6 || i3 != i7 || i4 != i8) && view.getParent() != null && HorizontalFullControlView.this.mPresenter.getPlayerContext().isLandScreen()) {
                    HorizontalFullControlView.this.mAnimationY = (float) (((View) view.getParent()).getHeight() - view.getHeight());
                }
            }
        });
    }
    ...
    public void showDisplayButton(boolean z) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-303889898")) {
            ...
            View view = this.playerDisplayBtn;
            if (!z) {
                i = 8;
            }
    ...
    public void hide(boolean z) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "833101121")) {
            ...
            if (z) {
                ...
                PluginAnimationUtils.pluginBottomHide(this.fullBottomContainer, new PluginAnimationUtils.AnimationActionListener() {
                    /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullControlView.AnonymousClass8 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    @Override // com.youku.live.dago.liveplayback.widget.plugins.PluginAnimationUtils.AnimationActionListener
                    public void onAnimationEnd() {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "1820553747")) {
                            ipChange.ipc$dispatch("1820553747", new Object[]{this});
                            return;
                        }
    ...
    public void show(boolean z) {
        ...
        if (playerContext.isLandVideo() && playerContext.isLandScreen() && !isShow()) {
            ...
            if (this.mAnimationY > 0.0f && z) {
                PluginAnimationUtils.pluginTopShow(this.topContainer, new PluginAnimationUtils.AnimationActionListener() {
                    /* class com.youku.live.dago.liveplayback.widget.plugins.horizontalfull.HorizontalFullControlView.AnonymousClass7 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    @Override // com.youku.live.dago.liveplayback.widget.plugins.PluginAnimationUtils.AnimationActionListener
                    public void onAnimationEnd() {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "1609202834")) {
                            ipChange.ipc$dispatch("1609202834", new Object[]{this});
