...
public class PostProcessingConfigManager2 {
    ...
    public static PPConfigItem getPPConfigItemByConfigId(String str, String str2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1104138278")) {
            ...
            try {
                hashMap = (HashMap) JSON.parseObject(ConfigFetcher.getInstance().getConfig(str, "app_post_processing_config_list", ""), new TypeReference<HashMap<String, PPConfigItem>>() {
                    /* class com.youku.live.dago.liveplayback.widget.plugins.postprocessing.PostProcessingConfigManager2.AnonymousClass1 */
                }, new Feature[0]);
            } catch (Exception unused) {
                hashMap = null;
            }
    ...
    public static PPConfigItem getPPConfigItemByTypeId(String str, String str2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-710459794")) {
            return getPPConfigItemByConfigId(str, getPPConfigId(str, str2));
        }
        return (PPConfigItem) ipChange.ipc$dispatch("-710459794", new Object[]{str, str2});
    }
    ...
    public static boolean isPPMasterEnable(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "479707301")) {
            return "1".equals(ConfigFetcher.getInstance().getConfig(str, "app_post_processing_in_auto", "0"));
        }
        return ((Boolean) ipChange.ipc$dispatch("479707301", new Object[]{str})).booleanValue();
    }
    ...
    public static boolean isPostProcessingEnable(Context context, String str) {
        ...
        if (!"1".equals(ConfigFetcher.getInstance().getConfig(str, "app_post_processing_enable", "0")) || !PostProcessingSwitch.isOn(context, ConfigFetcher.getInstance().getConfig(str, "app_post_processing_switch", null))) {
            z = false;
        }
        if (Logger.DEBUG) {
            String str2 = TAG;
    ...
    public static boolean isSupportAudioHbr(String str, String str2, PlayerWidget playerWidget) {
        ...
        if (playControlPostProcessMode == 1) {
            String str3 = ConfigConstants.CONFIG_TYPE_NAMESPACE_MAP.get(str2);
            return !TextUtils.isEmpty(str3) && !TextUtils.isEmpty(getCurrentPPTypeId(str)) && getPPFilterType(str3) != 0;
        }
    ...
    public static String getPPMode(String str, String str2, String str3) {
        ...
        String currentPPTypeId = getCurrentPPTypeId(str);
        if (!TextUtils.isEmpty(currentPPTypeId) && isPostProcessingEnable(null, str4)) {
            return getPPMode(getPPConfigItemByTypeId(str4, currentPPTypeId), getPPConfigItemByLiveControl(str4, str2, currentPPTypeId));
        }
        return "0";
    }
    ...
    public static PPConfigItem getPPConfigItemByLiveControl(String str, String str2, String str3) {
        ...
        try {
            ...
            if (Logger.DEBUG) {
                String str4 = TAG;
                Logger.d(str4, "get ups config " + parseObject + " namespace = " + str + jl1.BRACKET_START_STR + pPFilterType + jl1.BRACKET_END_STR);
            }
