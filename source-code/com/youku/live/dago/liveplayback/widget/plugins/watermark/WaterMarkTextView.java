...
public class WaterMarkTextView extends AppCompatTextView implements IWaterMarkView {
    ...
    public WaterMarkTextView(Context context, WaterMark waterMark, WaterMark.DisplayDTOS displayDTOS) {
        ...
        float f = (float) (((double) waterMark.textSize) / 1.5d);
    ...
    private String getAlphaString(float f) {
        ...
        if (f == 0.6f) {
            str = p21.ISSUE_PARAM_COMMENT_TYPE_SCRIPT;
        }
        if (f == 0.7f) {
            str = "4D";
        }
    ...
    public WaterMark.DisplayDTOS getDisplayDTOS() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1744069134")) {
            return this.mDisplayDTOS;
        }
        return (WaterMark.DisplayDTOS) ipChange.ipc$dispatch("1744069134", new Object[]{this});
    }

    @Override // com.youku.live.dago.liveplayback.widget.plugins.watermark.IWaterMarkView
    public WaterMark getWaterMark() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-256700494")) {
            return this.mWaterMark;
        }
        return (WaterMark) ipChange.ipc$dispatch("-256700494", new Object[]{this});
    }
