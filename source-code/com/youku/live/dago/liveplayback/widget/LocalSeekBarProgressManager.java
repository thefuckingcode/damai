...
public class LocalSeekBarProgressManager {
    ...
    private Runnable mRunnable = new Runnable() {
        /* class com.youku.live.dago.liveplayback.widget.LocalSeekBarProgressManager.AnonymousClass1 */
        ...
        public void run() {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-1332510557")) {
                ...
                LocalSeekBarProgressManager.this.mHandler.postDelayed(this, 1000);
            }
        }
    };
    ...
    public long getNowTime() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1939227914")) {
            return this.mNowTime;
        }
        return ((Long) ipChange.ipc$dispatch("-1939227914", new Object[]{this})).longValue();
    }
