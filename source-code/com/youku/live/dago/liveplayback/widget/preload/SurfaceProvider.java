    ...
    public Surface getSurface() {
        ...
        if (surface == null || !surface.isValid()) {
            ...
            newInstance.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
                /* class com.youku.live.dago.liveplayback.widget.preload.SurfaceProvider.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void onImageAvailable(ImageReader imageReader) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1768612329")) {
                        ipChange.ipc$dispatch("-1768612329", new Object[]{this, imageReader});
