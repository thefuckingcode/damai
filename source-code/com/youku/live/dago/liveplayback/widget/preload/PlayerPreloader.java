...
public class PlayerPreloader implements IPlayerPreloader {
    ...
    public IPlayerContainer findPreloadPlayer(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "972319184")) {
            return this.mPlayerContaners.get(str);
        }
        return (IPlayerContainer) ipChange.ipc$dispatch("972319184", new Object[]{this, str});
    }
        ...
        if (!TextUtils.isEmpty(str)) {
            if (TextUtils.isEmpty(str2)) {
                ...
                if (newPlayInfoModel == null || newPlayInfoModel.playInfo == null) {
                    play(str, i, i2, z);
                } else if (TextUtils.isEmpty(newPlayInfoModel.templateId) || !"13".equals(newPlayInfoModel.templateId)) {
