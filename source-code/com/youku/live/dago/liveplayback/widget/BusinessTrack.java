...
public class BusinessTrack {
    ...
    private Map<String, String> mBaseArgs = new ConcurrentHashMap<String, String>() {
        /* class com.youku.live.dago.liveplayback.widget.BusinessTrack.AnonymousClass1 */
    ...
    public boolean containsKey(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "368656142")) {
            return this.mBaseArgs.containsKey(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("368656142", new Object[]{this, str})).booleanValue();
    }
    ...
    public boolean reportPlayEnd() {
        ...
        } else if (!this.mVVBeginReported || this.mVVEndReported) {
            return false;
        } else {
