...
public class PromptLayout extends RelativeLayout {
    ...
    private int dip2px(int i) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1887440018")) {
            return ContextUtils.dip2px(getContext(), i);
        }
        return ((Integer) ipChange.ipc$dispatch("-1887440018", new Object[]{this, Integer.valueOf(i)})).intValue();
    }
    ...
    private void initView() {
        ...
        this.mPromptTv = (TextView) findViewById(R.id.f1067tv);
    ...
    private void setPrompt(String str, final String str2) {
        ...
        if (button2 != null) {
            button2.setOnClickListener(new View.OnClickListener() {
                /* class com.youku.live.dago.liveplayback.widget.view.PromptLayout.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void onClick(View view) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "943613493")) {
                        ipChange.ipc$dispatch("943613493", new Object[]{this, view});
