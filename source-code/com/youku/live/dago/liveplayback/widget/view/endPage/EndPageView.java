...
public class EndPageView extends LinearLayout {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void jumpToRecommendPage(int i) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void jumpToShortVideoPage(int i) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setCompletedData(EndPageModel endPageModel) {
        IpChange ipChange = $ipChange;
        ...
        this.mActorAvatar.setImageUrl(endPageModel.avatar, new PhenixOptions().bitmapProcessors(new gp()));
    ...
    public EndPageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mClickListener = new View.OnClickListener() {
            /* class com.youku.live.dago.liveplayback.widget.view.endPage.EndPageView.AnonymousClass1 */
        ...
        this.mListener = new EndPageDataMapper.GetEndPageDataListener() {
            /* class com.youku.live.dago.liveplayback.widget.view.endPage.EndPageView.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        this.mAttentionListener = new EndPageDataMapper.GetAttentionStateListener() {
            /* class com.youku.live.dago.liveplayback.widget.view.endPage.EndPageView.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;
