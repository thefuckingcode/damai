...
public class UTManager {
    ...
    public static void playHeart(String str, String str2, String str3, String str4, Map<String, String> map) {
        ...
        UTAnalytics.getInstance().getDefaultTracker().send(new UTOriginalCustomHitBuilder(str5, 12030, str, str2, str4, hashMap).build());
    ...
    public static void playStart(String str, String str2, Map<String, String> map) {
        ...
        UTAnalytics.getInstance().getDefaultTracker().send(new UTOriginalCustomHitBuilder(str3, 12002, str, str2, null, hashMap).build());
    ...
    public static void playStop(String str, String str2, String str3, Map<String, String> map) {
        ...
        UTAnalytics.getInstance().getDefaultTracker().send(new UTOriginalCustomHitBuilder(str4, 12003, str, str2, diffTimeMillis, hashMap).build());
