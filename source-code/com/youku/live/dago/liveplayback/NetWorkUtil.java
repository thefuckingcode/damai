...
public class NetWorkUtil {
    ...
    public static boolean isWifiConnected(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1354556580")) {
            return ((android.net.ConnectivityManager) context.getSystemService("connectivity")).getNetworkInfo(1).isConnected();
        }
        return ((Boolean) ipChange.ipc$dispatch("1354556580", new Object[]{context})).booleanValue();
    }
}
