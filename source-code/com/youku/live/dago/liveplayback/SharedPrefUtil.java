...
public class SharedPrefUtil {
    ...
    public boolean containKey(String str) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-529375817")) {
            return this.mSp.contains(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("-529375817", new Object[]{this, str})).booleanValue();
    }

    public boolean getBoolean(String str, boolean z) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1012319052")) {
            return this.mSp.getBoolean(str, z);
        }
        return ((Boolean) ipChange.ipc$dispatch("1012319052", new Object[]{this, str, Boolean.valueOf(z)})).booleanValue();
    }

    public int getInt(String str, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-439779983")) {
            return this.mSp.getInt(str, i);
        }
        return ((Integer) ipChange.ipc$dispatch("-439779983", new Object[]{this, str, Integer.valueOf(i)})).intValue();
    }

    public long getLong(String str, long j) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1175211638")) {
            return this.mSp.getLong(str, j);
        }
        return ((Long) ipChange.ipc$dispatch("-1175211638", new Object[]{this, str, Long.valueOf(j)})).longValue();
    }

    public String getString(String str, String str2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1946387523")) {
            return this.mSp.getString(str, str2);
        }
        return (String) ipChange.ipc$dispatch("-1946387523", new Object[]{this, str, str2});
    }
