...
public class ConfigUtils {
    ...
    public static boolean enableAsyncPlayer() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-543110051")) {
            return ((Boolean) ipChange.ipc$dispatch("-543110051", new Object[0])).booleanValue();
        }
        return "1".equals(ConfigFetcher.getInstance().getConfig("laifeng_config", "enable_async_player", "1"));
    }

    public static boolean enableAsyncStopAndRelease() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1247207220")) {
            return ((Boolean) ipChange.ipc$dispatch("-1247207220", new Object[0])).booleanValue();
        }
        return "1".equals(ConfigFetcher.getInstance().getConfig("laifeng_config", "enable_async_stopandrelease", "1"));
    }
    ...
    public static boolean enableBackgroundPlay(int i) {
        ...
        if (i == 3) {
            str = ConfigFetcher.getInstance().getConfig("laifeng_config", "enable_laifeng_background_play", "1");
        } else {
            str = ConfigFetcher.getInstance().getConfig("laifeng_config", "enable_other_background_play", "1");
        }
        return "1".equals(str);
    }
    ...
    public static boolean enableFastPlay() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "10359016")) {
            return ((Boolean) ipChange.ipc$dispatch("10359016", new Object[0])).booleanValue();
        }
        return "1".equals(ConfigFetcher.getInstance().getConfig("laifeng_config", "enable_fast_play", "1"));
    }
    ...
    public static boolean enableNoSurfacePlay() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-213678918")) {
            return ((Boolean) ipChange.ipc$dispatch("-213678918", new Object[0])).booleanValue();
        }
    ...
    public static boolean enablePickMode() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-281798476")) {
            return ((Boolean) ipChange.ipc$dispatch("-281798476", new Object[0])).booleanValue();
        }
        return "1".equals(ConfigFetcher.getInstance().getConfig("laifeng_config", "enable_pick_mode", "0"));
    }

    public static boolean enablePickModeRotate() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1172930841")) {
            return ((Boolean) ipChange.ipc$dispatch("1172930841", new Object[0])).booleanValue();
        }
    ...
    public static int getPickSEICountLimit() {
        ...
        try {
            return Integer.parseInt(ConfigFetcher.getInstance().getConfig("laifeng_config", "pick_sei_count_limit", ERROR.MTOP_XFLUSH_SUCCESS_CODE));
    ...
    public static boolean supportLiveHbr() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "941042078")) {
            return ((Boolean) ipChange.ipc$dispatch("941042078", new Object[0])).booleanValue();
        }
        return "1".equals(ConfigFetcher.getInstance().getConfig("z_real_config", "live_z_real_enable", "0"));
    }
}
