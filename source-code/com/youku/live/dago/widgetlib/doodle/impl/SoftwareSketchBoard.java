...
public class SoftwareSketchBoard extends View implements SketchBoard {
    ...
    public int getBoardHeight() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1514947114")) {
            return getMeasuredHeight();
        }
        return ((Integer) ipChange.ipc$dispatch("1514947114", new Object[]{this})).intValue();
    }

    @Override // com.youku.live.dago.widgetlib.doodle.SketchBoard
    public int getBoardWidth() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-870587015")) {
            return getMeasuredWidth();
        }
        return ((Integer) ipChange.ipc$dispatch("-870587015", new Object[]{this})).intValue();
    }
