...
public class LaifengSplashScheduler implements SplashScheduler<String, String> {
    ...
    private Map<Integer, SplashScheduler.IconItem> mIconMaps;
    private List<SplashScheduler.OnSplashUpdateListener> mOnSplashUpdateListeners;
    ...
    public LaifengSplashScheduler(Context context) {
        ...
        this.mOnSplashUpdateListeners = new ArrayList();
        ...
        this.mSketchBoard.setOnDrawListener(new SketchBoard.OnDrawListener() {
            /* class com.youku.live.dago.widgetlib.doodle.impl.LaifengSplashScheduler.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onDraw(int i, int i2, int i3, int i4) {
                ...
                if (LaifengSplashScheduler.this.mEnableTouch) {
                    for (SplashScheduler.OnSplashUpdateListener onSplashUpdateListener : LaifengSplashScheduler.this.mOnSplashUpdateListeners) {
                        onSplashUpdateListener.onSplashUpdate((float) i2, (float) i3, i, i4);
                    }
                }
            }
        });
        this.mRobotPainter.setOnPaintListener(new RobotPainter.OnPaintListener() {
            /* class com.youku.live.dago.widgetlib.doodle.impl.LaifengSplashScheduler.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        this.mHumanPainter.setOnTouchListener(new View.OnTouchListener() {
            /* class com.youku.live.dago.widgetlib.doodle.impl.LaifengSplashScheduler.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == 1 && LaifengSplashScheduler.this.mDrawCount >= LaifengSplashScheduler.this.mDrawLimit) {
                    ...
                    Toast.makeText(context, "做多送" + LaifengSplashScheduler.this.mDrawLimit + "个涂鸦礼物", 1).show();
                }
                return false;
            }
        });
    ...
    public View getContentView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1854182745")) {
            return this.mHumanPainter;
        }
        return (View) ipChange.ipc$dispatch("1854182745", new Object[]{this});
    }
    ...
    public SplashScheduler.IconItem getIconItem(int i) {
        ...
        } else if (this.mIconMaps.containsKey(Integer.valueOf(i))) {
    ...
    public SketchBoard getSketchBoard() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1558849757")) {
            return this.mSketchBoard;
        }
        return (SketchBoard) ipChange.ipc$dispatch("1558849757", new Object[]{this});
    }

    @Override // com.youku.live.dago.widgetlib.doodle.SplashScheduler
    public boolean isTouchEnabled() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2131886743")) {
            return this.mEnableTouch;
        }
        return ((Boolean) ipChange.ipc$dispatch("2131886743", new Object[]{this})).booleanValue();
    }
