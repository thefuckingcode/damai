...
public class ILRoom extends AbsILRoom {
    ...
    public void sendMessage(Map<String, Object> map, final ResultCallback resultCallback) {
        ...
        this.chatRoom.sendMessage(map, new ChatRoom.SendMsgCallback() {
            /* class com.youku.live.dago.widgetlib.ailproom.ILRoom.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.dago.widgetlib.ailpchat.ChatRoom.SendMsgCallback
            public void onSendFail(int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-433247935")) {
                    ipChange.ipc$dispatch("-433247935", new Object[]{this, Integer.valueOf(i)});
                    return;
                }
                resultCallback.onFailure();
            }
            ...
            public void onSendSuccess(int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1288642972")) {
                    ipChange.ipc$dispatch("1288642972", new Object[]{this, Integer.valueOf(i)});
                    return;
                }
