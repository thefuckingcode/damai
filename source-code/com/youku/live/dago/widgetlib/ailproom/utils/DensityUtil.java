...
public class DensityUtil {
    ...
    public static int dip2px(Context context, float f) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1999185214")) {
            return (int) TypedValue.applyDimension(1, f, context.getResources().getDisplayMetrics());
        }
        return ((Integer) ipChange.ipc$dispatch("1999185214", new Object[]{context, Float.valueOf(f)})).intValue();
    }
    ...
    public static int px2dip(Context context, float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1704508076")) {
            return (int) ((f / context.getResources().getDisplayMetrics().density) + 0.5f);
        }
        return ((Integer) ipChange.ipc$dispatch("1704508076", new Object[]{context, Float.valueOf(f)})).intValue();
    }

    public static int sp2px(Context context, float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-541501098")) {
            return (int) ((f * context.getResources().getDisplayMetrics().scaledDensity) + 0.5f);
        }
        return ((Integer) ipChange.ipc$dispatch("-541501098", new Object[]{context, Float.valueOf(f)})).intValue();
    }

    public static int getWindowHeight(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1021722400")) {
            return ((WindowManager) context.getSystemService(v.ATTACH_MODE_WINDOW)).getDefaultDisplay().getHeight();
        }
        return ((Integer) ipChange.ipc$dispatch("1021722400", new Object[]{context})).intValue();
    }

    public static int getWindowWidth(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1334495161")) {
            return ((WindowManager) context.getSystemService(v.ATTACH_MODE_WINDOW)).getDefaultDisplay().getWidth();
        }
        return ((Integer) ipChange.ipc$dispatch("1334495161", new Object[]{context})).intValue();
    }
}
