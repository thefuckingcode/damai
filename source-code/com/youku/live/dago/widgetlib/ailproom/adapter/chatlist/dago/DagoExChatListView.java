...
public class DagoExChatListView extends FrameLayout implements View.OnClickListener, IDagoChatListView {
    ...
    private Runnable newMessageTipsRunnable = new Runnable() {
        /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DagoExChatListView.AnonymousClass2 */
    ...
    public DagoExChatListView(@NonNull Context context, OnCellClickListener onCellClickListener2) {
        super(context);
    ...
    private void initView(Context context) {
        ...
        this.mChatRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DagoExChatListView.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "2136987690")) {
                    ipChange.ipc$dispatch("2136987690", new Object[]{this, recyclerView, Integer.valueOf(i)});
                    return;
                }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateNewMsgLayoutStatus() {
        IpChange ipChange = $ipChange;
    ...
    public void setOnCellClickListener(OnCellClickListener onCellClickListener2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1578099723")) {
            ipChange.ipc$dispatch("1578099723", new Object[]{this, onCellClickListener2});
            return;
        }
        DagoExChatListAdapter dagoExChatListAdapter = this.mAdapter;
        if (dagoExChatListAdapter != null) {
            this.onCellClickListener = onCellClickListener2;
            dagoExChatListAdapter.setOnCellClickListener(onCellClickListener2);
        }
    }
