...
public class GingerScroller extends ScrollerProxy {
    ...
    public int getCurrX() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "292185741")) {
            return this.mScroller.getCurrX();
        }
        return ((Integer) ipChange.ipc$dispatch("292185741", new Object[]{this})).intValue();
    }

    @Override // com.youku.live.dago.widgetlib.ailproom.adapter.upload.crop.scrollerproxy.ScrollerProxy
    public int getCurrY() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "292215532")) {
            return this.mScroller.getCurrY();
        }
        return ((Integer) ipChange.ipc$dispatch("292215532", new Object[]{this})).intValue();
    }

    @Override // com.youku.live.dago.widgetlib.ailproom.adapter.upload.crop.scrollerproxy.ScrollerProxy
    public boolean isFinished() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-908666670")) {
            return this.mScroller.isFinished();
        }
        return ((Boolean) ipChange.ipc$dispatch("-908666670", new Object[]{this})).booleanValue();
    }
}
