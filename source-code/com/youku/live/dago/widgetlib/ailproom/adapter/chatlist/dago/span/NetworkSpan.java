...
public class NetworkSpan extends ReplacementSpan {
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        if (bitmapDrawable != null && (bitmap = bitmapDrawable.getBitmap()) != null && !bitmap.isRecycled()) {
            ...
            if (this.tintFlag) {
                ...
                canvas.drawRect((float) this.drawable.getBounds().left, (float) i3, (float) this.drawable.getBounds().right, (float) i5, paint2);
            }
    ...
    public BitmapDrawable getDrawable() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-690612011")) {
            return this.drawable;
        }
        return (BitmapDrawable) ipChange.ipc$dispatch("-690612011", new Object[]{this});
    }
