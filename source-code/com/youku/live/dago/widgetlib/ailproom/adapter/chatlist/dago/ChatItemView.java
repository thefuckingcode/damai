...
public class ChatItemView extends LinearLayout {
    ...
    final SpannableStringBuilder mBuilder = new SpannableStringBuilder();
    private DrawCellItemUtils.DeleteTextSpanCallBack mCallBack = new DrawCellItemUtils.DeleteTextSpanCallBack() {
        /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.ChatItemView.AnonymousClass1 */
    ...
    public void drawCell(DagoCell dagoCell, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1225223447")) {
            ...
            this.mContextTextView.setTextSize((float) this.mFontSize);
            ...
            gradientDrawable.setCornerRadius((float) UIUtil.dip2px(13));
