...
public class DagoChatListAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public DagoChatListAdapter(OnCellClickListener onCellClickListener2) {
    ...
    public long getItemId(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "706197642")) {
            return (long) i;
        }
        return ((Long) ipChange.ipc$dispatch("706197642", new Object[]{this, Integer.valueOf(i)})).longValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "262876973")) {
            return this.mLiveCommentItem.get(i).getCellType();
        }
        return ((Integer) ipChange.ipc$dispatch("262876973", new Object[]{this, Integer.valueOf(i)})).intValue();
    }

    /* access modifiers changed from: protected */
    public int getMaxChatListLength() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "388374434")) {
            return MAX_CHAT_LIST_LENGTH;
        }
        return ((Integer) ipChange.ipc$dispatch("388374434", new Object[]{this})).intValue();
    }
    ...
    public void setOnCellClickListener(OnCellClickListener onCellClickListener2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-546259004")) {
            ipChange.ipc$dispatch("-546259004", new Object[]{this, onCellClickListener2});
            return;
        }
        this.onCellClickListener = onCellClickListener2;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1179219753")) {
            return new ViewHolder(new ChatItemView(viewGroup.getContext()));
        }
        return (ViewHolder) ipChange.ipc$dispatch("-1179219753", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
