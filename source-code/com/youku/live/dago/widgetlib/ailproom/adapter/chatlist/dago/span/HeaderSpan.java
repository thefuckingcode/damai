...
public class HeaderSpan extends ReplacementSpan {
    ...
    public void draw(@NonNull Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, @NonNull Paint paint) {
        ...
        int i6 = (int) f;
        int i7 = srcSize;
        bitmapDrawable2.setBounds(i6, i3, (int) (((float) i7) + f), i3 + i7);
        ...
        if (bitmapDrawable3 != null && bitmapDrawable3.getBitmap() != null && !this.mIconDrawable.getBitmap().isRecycled()) {
            this.mIconDrawable.setBounds(i6, i3, (int) (f + ((float) i7)), i7 + i3);
    ...
    public int getSize(@NonNull Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1317733252")) {
            return srcSize;
        }
        return ((Integer) ipChange.ipc$dispatch("1317733252", new Object[]{this, paint, charSequence, Integer.valueOf(i), Integer.valueOf(i2), fontMetricsInt})).intValue();
    }

    public BitmapDrawable getSrcDrawable() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1985608854")) {
            return this.mSrcDrawable;
        }
        return (BitmapDrawable) ipChange.ipc$dispatch("1985608854", new Object[]{this});
    }
