...
public class PagerExpressionNormal extends PagerExpression {
    ...
    public void init(int i, int i2, IExpressionSelectListener iExpressionSelectListener) {
        ...
        this.mGridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatinput.expression.widget.PagerExpressionNormal.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // android.widget.AdapterView.OnItemClickListener
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-445913651")) {
                    ipChange.ipc$dispatch("-445913651", new Object[]{this, adapterView, view, Integer.valueOf(i), Long.valueOf(j)});
                    return;
                }
                Map<String, Object> map = PagerExpressionNormal.this.listItems.get(i);
