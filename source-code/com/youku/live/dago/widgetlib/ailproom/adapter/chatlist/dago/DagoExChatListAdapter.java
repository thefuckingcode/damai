...
public class DagoExChatListAdapter extends RecyclerView.Adapter<DagoChatListAdapter.ViewHolder> {
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper()) {
        /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DagoExChatListAdapter.AnonymousClass1 */
    ...
    public static class RenderRunnable implements Runnable {
        ...
        public void run() {
            while (DagoExChatListAdapter.isRunning) {
                try {
                    DagoExChatListAdapter dagoExChatListAdapter = this.mAdapterRef.get();
                    if (dagoExChatListAdapter != null) {
                        dagoExChatListAdapter.renderMessage();
                        Thread.sleep((long) DagoExChatListAdapter.mDuratuon);
                    } else {
                        return;
                    }
    ...
    public DagoExChatListAdapter(OnCellClickListener onCellClickListener2) {
        ((ILog) Dsl.getService(ILog.class)).i(TAG, "DagoExChatListAdapter init " + onCellClickListener2);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateMsgLast(DagoCell dagoCell) {
        IpChange ipChange = $ipChange;
    ...
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2120317779")) {
            return this.mDisplayMessageList.size();
        }
        return ((Integer) ipChange.ipc$dispatch("2120317779", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public long getItemId(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1478730857")) {
            return (long) i;
        }
        return ((Long) ipChange.ipc$dispatch("-1478730857", new Object[]{this, Integer.valueOf(i)})).longValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1910150266")) {
            return this.mDisplayMessageList.get(i).getCellType();
        }
        return ((Integer) ipChange.ipc$dispatch("1910150266", new Object[]{this, Integer.valueOf(i)})).intValue();
    }

    public int getNewMessageCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "813837639")) {
            return this.mNewMessageList.size();
        }
        return ((Integer) ipChange.ipc$dispatch("813837639", new Object[]{this})).intValue();
    }
    ...
    public void setOnCellClickListener(OnCellClickListener onCellClickListener2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1800444399")) {
            ipChange.ipc$dispatch("-1800444399", new Object[]{this, onCellClickListener2});
            return;
        }
        this.onCellClickListener = onCellClickListener2;
    }
    ...
    public void onBindViewHolder(DagoChatListAdapter.ViewHolder viewHolder, int i) {
        ...
        try {
            ...
            if (viewHolder != null && dagoCell != null) {
    ...
    public DagoChatListAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "480663786")) {
            return new DagoChatListAdapter.ViewHolder(new ChatItemView(viewGroup.getContext()));
        }
        return (DagoChatListAdapter.ViewHolder) ipChange.ipc$dispatch("480663786", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
}
