...
public class ExpressionPanel extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        ImageView imageView2 = this.mExpressionIndicatorThird;
    ...
    public void initExpressionView(Context context, IExpressionSelectListener iExpressionSelectListener) {
        ...
        this.mExpresstionViewpager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatinput.expression.ExpressionPanel.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.viewpager.widget.ViewPager.OnPageChangeListener
            public void onPageScrollStateChanged(int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1215780262")) {
                    ipChange.ipc$dispatch("1215780262", new Object[]{this, Integer.valueOf(i)});
                }
            }
            ...
            public void onPageScrolled(int i, float f, int i2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1041819717")) {
                    ipChange.ipc$dispatch("1041819717", new Object[]{this, Integer.valueOf(i), Float.valueOf(f), Integer.valueOf(i2)});
                }
            }
            ...
            public void onPageSelected(int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-401544079")) {
                    ipChange.ipc$dispatch("-401544079", new Object[]{this, Integer.valueOf(i)});
                } else if (i == 0) {
