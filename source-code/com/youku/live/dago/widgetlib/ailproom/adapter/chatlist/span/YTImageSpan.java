...
public class YTImageSpan extends ImageSpan implements YTBaseSpan {
    ...
    public YTImageSpan(Drawable drawable, ImageBean imageBean2, TextView textView2) {
        super(drawable, imageBean2.alignment.intValue());
        this.mDrawable = drawable;
        this.imageBean = imageBean2;
        this.textView = textView2;
        this.w = (int) (imageBean2.width + 0.5f);
        this.h = (int) (imageBean2.height + 0.5f);
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        if (i7 == 1) {
            ...
            if (i7 != 4) {
                ...
                f2 = (float) ((((i5 - i6) - com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(bounds)) / 2) + i6);
                canvas.save();
    ...
    public YTBaseSpan fetch(Context context) {
        ...
        DagoImageLoader.getInstance().load(context, this.imageBean.src, new ImageLoadListener() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.span.YTImageSpan.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.dago.widgetlib.ailpbaselib.image.ImageLoadListener
            public void onFail() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "649325860")) {
                    ipChange.ipc$dispatch("649325860", new Object[]{this});
                }
            }
            ...
            public void onSuccess(BitmapDrawable bitmapDrawable) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "244187290")) {
                    ipChange.ipc$dispatch("244187290", new Object[]{this, bitmapDrawable});
                    return;
                }
