...
public class RadiusSpan extends ReplacementSpan {
    ...
    public void draw(@NonNull Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, @NonNull Paint paint) {
        ...
        float descent = ((float) this.height) - (paint.descent() - paint.ascent());
        float f2 = (float) i4;
        RectF rectF = new RectF(f, (paint.ascent() + f2) - descent, ((float) this.mSize) + f, paint.descent() + f2);
        int i6 = this.mRadius;
        canvas.drawRoundRect(rectF, (float) i6, (float) i6, paint);
        paint.setColor(this.mTextColor);
        canvas.drawText(charSequence, i, i2, f + ((float) this.mRadius), f2 - (descent / 2.0f), paint);
    }
    ...
    public int getSize(@NonNull Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        ...
        int measureText = (int) (paint.measureText(charSequence, i, i2) + ((float) (this.mRadius * 2)));
