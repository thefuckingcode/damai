...
public class DeviceUtils {
    ...
    public static String getAvailableExternalMemorySize() {
        ...
        return Formatter.formatFileSize(getAppContext(), ((long) statFs.getAvailableBlocks()) * ((long) statFs.getBlockSize()));
    }
    ...
    public static float getProcessMemeryInfo() {
        ...
        return ((float) activityManager.getProcessMemoryInfo(new int[]{Process.myPid()})[0].getTotalPrivateDirty()) / 1024.0f;
    }
    ...
    public static String getTotalExternalMemorySize() {
        ...
        StatFs statFs = new StatFs(Environment.getExternalStorageDirectory().getAbsolutePath());
        return Formatter.formatFileSize(getAppContext(), ((long) statFs.getBlockCount()) * ((long) statFs.getBlockSize()));
    }
