...
public abstract class BaseChatListRecyclerViewAdapter<T, H extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<H> {
    ...
    public List<T> getLiveCommentItem() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1118003888")) {
            return this.mLiveCommentItem;
        }
        return (List) ipChange.ipc$dispatch("-1118003888", new Object[]{this});
    }

    /* access modifiers changed from: protected */
    public int getMaxChatCacheLength() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1612661132")) {
            return MAX_CHAT_CACHE_LENGTH;
        }
        return ((Integer) ipChange.ipc$dispatch("-1612661132", new Object[]{this})).intValue();
    }

    /* access modifiers changed from: protected */
    public int getMaxChatListLength() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1716760624")) {
            return MAX_CHAT_LIST_LENGTH;
        }
        return ((Integer) ipChange.ipc$dispatch("1716760624", new Object[]{this})).intValue();
    }
