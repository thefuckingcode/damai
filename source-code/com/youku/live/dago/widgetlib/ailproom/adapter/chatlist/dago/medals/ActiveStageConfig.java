...
public class ActiveStageConfig {
    ...
    public String getActiveStage(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1061991247")) {
            return this.mActiveStageMap.get(Integer.valueOf(i));
        }
        return (String) ipChange.ipc$dispatch("1061991247", new Object[]{this, Integer.valueOf(i)});
    }
        ...
        try {
            ...
            if (optJSONObject.optInt("cd", -1) == 0) {
                ...
                for (int i = 0; i < optJSONArray.length(); i++) {
                    ...
                    this.mActiveStageMap.put(Integer.valueOf(optInt), optJSONArray.optJSONObject(i).optString("sgn"));
                }
            }
    ...
    public void updateActiveStage(String str) {
        ...
        try {
            ...
            if (optJSONObject.optInt("cd", -1) == 0) {
                ...
                this.mActiveStageMap.put(Integer.valueOf(optInt), optJSONObject.optString("sgn"));
            }
        } catch (JSONException e) {
            e.printStackTrace();
        }
