...
public class MedalsConfig {
    ...
    public int[] getAllMedalSize(long j) {
        ...
        return new int[]{medal.width, medal.height};
    }
    ...
    public void updateAllMedals() {
        ...
        if (this.mAllMasterMap.isEmpty()) {
            ((IThreadPool) Dsl.getService(IThreadPool.class)).excute(new PriorityRunnable() {
                /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.medals.MedalsConfig.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void run() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-771965636")) {
                        ipChange.ipc$dispatch("-771965636", new Object[]{this});
                        return;
                    }
