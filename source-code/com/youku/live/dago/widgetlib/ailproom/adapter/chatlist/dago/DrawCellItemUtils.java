...
public class DrawCellItemUtils {
    ...
    public static void alarmCommitBigImage(String str) {
        ...
        hashMap.put("url", str);
        AppMonitor.Alarm.commitFail("YoukuLiveAlarm", "DagoChatList", new JSONObject(hashMap).toString(), su0.LOGIN_ALIPAY_FAILED_CODE, str);
    }
    ...
    public static void alarmCommitLoadImageError(String str) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("url", str);
        AppMonitor.Alarm.commitFail("YoukuLiveAlarm", "DagoChatList", new JSONObject(hashMap).toString(), su0.LOGIN_TAOBAO_FAILED_CODE, str);
    }
    ...
    public static CharSequence drawButtonCellItem(final ButtonCellItem buttonCellItem, final OnCellClickListener onCellClickListener, final DeleteTextSpanCallBack deleteTextSpanCallBack) {
        ...
        spannableString.setSpan(new DagoClickableSpan(Color.parseColor(buttonCellItem.color)) {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DrawCellItemUtils.AnonymousClass10 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.span.DagoClickableSpan
            public void onClick(@NonNull View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1104582615")) {
                    ipChange.ipc$dispatch("-1104582615", new Object[]{this, view});
                    return;
                }
                ((ILog) Dsl.getService(ILog.class)).i(DrawCellItemUtils.TAG, "ButtonCellItem: onClick");
                OnCellClickListener onCellClickListener = onCellClickListener;
                ...
                if (buttonCellItem.hiddenAfterClick) {
                    ...
                    DeleteTextSpanCallBack deleteTextSpanCallBack = deleteTextSpanCallBack;
    ...
    private static SpannableString drawCustomMedal(TextView textView, BitmapDrawable bitmapDrawable, final String str, String str2) {
        ...
        DagoImageLoader.getInstance().load(getContext(), str, new ImageLoadListener() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DrawCellItemUtils.AnonymousClass9 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.dago.widgetlib.ailpbaselib.image.ImageLoadListener
            public void onFail() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-623836299")) {
                    ipChange.ipc$dispatch("-623836299", new Object[]{this});
                }
            }
            ...
            public void onSuccess(BitmapDrawable bitmapDrawable) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-628065815")) {
                    ipChange.ipc$dispatch("-628065815", new Object[]{this, bitmapDrawable});
                } else if (bitmapDrawable == null || bitmapDrawable.getBitmap() == null) {
                    DrawCellItemUtils.alarmCommitLoadImageError(str);
                } else {
                    medalSpan.setDrawable(bitmapDrawable);
    ...
    public static CharSequence drawFaceCellItem(final FaceCellItem faceCellItem) {
        ...
        if (faceCellItem != null) {
            ...
            final AnonymousClass4 r9 = new ImageLoadListener() {
                /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DrawCellItemUtils.AnonymousClass4 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dago.widgetlib.ailpbaselib.image.ImageLoadListener
                public void onFail() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "843178736")) {
                        ipChange.ipc$dispatch("843178736", new Object[]{this});
                    }
                }
                ...
                public void onSuccess(BitmapDrawable bitmapDrawable) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "435095118")) {
                        ipChange.ipc$dispatch("435095118", new Object[]{this, bitmapDrawable});
                    } else if (bitmapDrawable == null || bitmapDrawable.getBitmap() == null) {
                        DrawCellItemUtils.alarmCommitLoadImageError(faceCellItem.icon);
                    } else {
            ...
            DagoImageLoader.getInstance().loadCircle(getContext(), urlWithOriginUrl, new ImageLoadListener() {
                /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DrawCellItemUtils.AnonymousClass5 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dago.widgetlib.ailpbaselib.image.ImageLoadListener
                public void onFail() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "549775729")) {
                        ipChange.ipc$dispatch("549775729", new Object[]{this});
                    }
                }
                ...
                public void onSuccess(BitmapDrawable bitmapDrawable) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1495523987")) {
                        ipChange.ipc$dispatch("-1495523987", new Object[]{this, bitmapDrawable});
                    } else if (bitmapDrawable == null || bitmapDrawable.getBitmap() == null) {
                        ...
                        if (!TextUtils.isEmpty(faceCellItem.icon)) {
                            DagoImageLoader.getInstance().load(DrawCellItemUtils.getContext(), faceCellItem.icon, r9);
                        }
                    }
                }
            });
    ...
    public static CharSequence drawGiftCellItem(GiftCellItem giftCellItem) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1482747768")) {
            return drawGiftCellItem(null, giftCellItem);
        }
        return (CharSequence) ipChange.ipc$dispatch("-1482747768", new Object[]{giftCellItem});
    }

    public static CharSequence drawImageCellItem(ImageCellItem imageCellItem, OnCellClickListener onCellClickListener) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "364000928")) {
            return drawImageCellItem(null, imageCellItem, onCellClickListener);
        }
        return (CharSequence) ipChange.ipc$dispatch("364000928", new Object[]{imageCellItem, onCellClickListener});
    }
    ...
    private static SpannableString drawImageMedal(TextView textView, BitmapDrawable bitmapDrawable, final String str) {
        ...
        DagoImageLoader.getInstance().load(getContext(), str, new ImageLoadListener() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DrawCellItemUtils.AnonymousClass7 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.dago.widgetlib.ailpbaselib.image.ImageLoadListener
            public void onFail() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-37030285")) {
                    ipChange.ipc$dispatch("-37030285", new Object[]{this});
                }
            }
            ...
            public void onSuccess(BitmapDrawable bitmapDrawable) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1061794901")) {
                    ipChange.ipc$dispatch("-1061794901", new Object[]{this, bitmapDrawable});
                } else if (bitmapDrawable == null || bitmapDrawable.getBitmap() == null) {
                    DrawCellItemUtils.alarmCommitLoadImageError(str);
                } else {
                    centerImageSpan.setDrawable(bitmapDrawable);
                    TextView textView = (TextView) weakReference.get();
                    if (textView != null) {
                        textView.invalidate();
                    }
    ...
    public static CharSequence drawMedalCellItem(MedalCellItem medalCellItem) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "654165788")) {
            return drawMedalCellItem(null, medalCellItem, null);
        }
        return (CharSequence) ipChange.ipc$dispatch("654165788", new Object[]{medalCellItem});
    }
    ...
    public static CharSequence drawTextCellItem(final TextCellItem textCellItem, final OnCellClickListener onCellClickListener) {
        ...
        if (textCellItem.clickData != null) {
            emojiConvertText.setSpan(new DagoClickableSpan(Color.parseColor(textCellItem.color)) {
                /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DrawCellItemUtils.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.span.DagoClickableSpan
                public void onClick(@NonNull View view) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-631232613")) {
                        ipChange.ipc$dispatch("-631232613", new Object[]{this, view});
                        return;
                    }
                    OnCellClickListener onCellClickListener = onCellClickListener;
                    if (onCellClickListener != null) {
    ...
    private static SpannableString drawTrueLoveMedal(TextView textView, BitmapDrawable bitmapDrawable, final String str, String str2) {
        ...
        spannableString.setSpan(centerImageSpan, 0, 7, 17);
        DagoImageLoader.getInstance().load(getContext(), str, new ImageLoadListener() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DrawCellItemUtils.AnonymousClass8 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.dago.widgetlib.ailpbaselib.image.ImageLoadListener
            public void onFail() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-330433292")) {
                    ipChange.ipc$dispatch("-330433292", new Object[]{this});
                }
            }
            ...
            public void onSuccess(BitmapDrawable bitmapDrawable) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1302553290")) {
                    ipChange.ipc$dispatch("1302553290", new Object[]{this, bitmapDrawable});
                } else if (bitmapDrawable == null || bitmapDrawable.getBitmap() == null) {
                    DrawCellItemUtils.alarmCommitLoadImageError(str);
                } else {
                    centerImageSpan.setDrawable(bitmapDrawable);
    ...
    public static boolean isBigImage(Bitmap bitmap) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "109511866")) {
            return getBitmapSize(bitmap) > 102400;
        }
        return ((Boolean) ipChange.ipc$dispatch("109511866", new Object[]{bitmap})).booleanValue();
    }
    ...
    public static CharSequence drawGiftCellItem(TextView textView, GiftCellItem giftCellItem) {
        ...
        spannableStringBuilder.append((CharSequence) spannableString);
        DagoImageLoader.getInstance().load(getContext(), str, new ImageLoadListener() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DrawCellItemUtils.AnonymousClass6 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.dago.widgetlib.ailpbaselib.image.ImageLoadListener
            public void onFail() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "256372722")) {
                    ipChange.ipc$dispatch("256372722", new Object[]{this});
                }
            }
            ...
            public void onSuccess(BitmapDrawable bitmapDrawable) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "868824204")) {
                    ipChange.ipc$dispatch("868824204", new Object[]{this, bitmapDrawable});
                } else if (bitmapDrawable == null || bitmapDrawable.getBitmap() == null) {
                    DrawCellItemUtils.alarmCommitLoadImageError(str);
                } else {
                    centerImageSpan.setDrawable(bitmapDrawable);
    ...
    public static CharSequence drawImageCellItem(TextView textView, final ImageCellItem imageCellItem, final OnCellClickListener onCellClickListener) {
        ...
        if (imageCellItem != null) {
            ...
            if (imageCellItem.clickData != null) {
                spannableString.setSpan(new DagoClickableSpan(Color.parseColor("#FFFFFF")) {
                    /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DrawCellItemUtils.AnonymousClass2 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    @Override // com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.span.DagoClickableSpan
                    public void onClick(@NonNull View view) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "1480057756")) {
                            ipChange.ipc$dispatch("1480057756", new Object[]{this, view});
                            return;
                        }
                        OnCellClickListener onCellClickListener = onCellClickListener;
                        if (onCellClickListener != null) {
                            onCellClickListener.onClick(imageCellItem.clickData);
                        }
                    }
                }, 0, 7, 17);
            }
            ...
            DagoImageLoader.getInstance().load(getContext(), urlWithOriginUrl, new ImageLoadListener() {
                /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.DrawCellItemUtils.AnonymousClass3 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dago.widgetlib.ailpbaselib.image.ImageLoadListener
                public void onFail() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1136581743")) {
                        ipChange.ipc$dispatch("1136581743", new Object[]{this});
                    }
                }
                ...
                public void onSuccess(BitmapDrawable bitmapDrawable) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1929253073")) {
                        ipChange.ipc$dispatch("-1929253073", new Object[]{this, bitmapDrawable});
                    } else if (bitmapDrawable == null || bitmapDrawable.getBitmap() == null) {
                        DrawCellItemUtils.alarmCommitLoadImageError(urlWithOriginUrl);
                    } else {
                        if (DrawCellItemUtils.isBigImage(bitmapDrawable.getBitmap())) {
                        ...
                        centerImageSpan.setDrawable(DrawCellItemUtils.getOptimizedBitmapDrawable(bitmapDrawable, BitmapFactory.decodeResource(UIUtil.getResources(), 17170432)));
                        TextView textView = (TextView) weakReference.get();
                        if (textView != null) {
                            textView.invalidate();
                        }
    ...
    public static CharSequence drawMedalCellItem(TextView textView, MedalCellItem medalCellItem, String str) {
        ...
        if (allMedalType == 7 || allMedalType == 8 || allMedalType == 9) {
            spannableString = drawCustomMedal(textView, bitmapDrawable, allMedalUrl, getActiveText(allMedalType));
        } else if (allMedalType != 11) {
            spannableString = drawImageMedal(textView, bitmapDrawable, allMedalUrl);
        } else {
            spannableString = drawTrueLoveMedal(textView, bitmapDrawable, allMedalUrl, str);
        }
