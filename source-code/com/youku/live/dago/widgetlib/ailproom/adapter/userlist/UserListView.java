...
public class UserListView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1317406509")) {
            ...
            this.mUserCountText.setOnClickListener(new View.OnClickListener() {
                /* class com.youku.live.dago.widgetlib.ailproom.adapter.userlist.UserListView.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void onClick(View view) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1173862280")) {
                        ipChange.ipc$dispatch("1173862280", new Object[]{this, view});
                        return;
                    }
    ...
    public void clear() {
        ...
        if (textView != null) {
            ...
            this.mUserCountText.setText(Util.formatNumber((long) this.mUserCount));
        }
        UserListAdapter userListAdapter = this.mAdapter;
        if (userListAdapter != null) {
            userListAdapter.clearUserList();
    ...
    public void reqUserList(String str) {
        ...
        AnonymousClass2 r0 = new AILPMtopListener() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.userlist.UserListView.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.taobao.tao.remotebusiness.IRemoteListener
            public void onError(int i, MtopResponse mtopResponse, Object obj) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1937455781")) {
                    ipChange.ipc$dispatch("-1937455781", new Object[]{this, Integer.valueOf(i), mtopResponse, obj});
                    return;
                }
            ...
            public void onSuccess(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-411517892")) {
                    ipChange.ipc$dispatch("-411517892", new Object[]{this, Integer.valueOf(i), mtopResponse, baseOutDo, obj});
                    return;
                }
                try {
                    if ("SUCCESS".equals(mtopResponse.getRetCode())) {
                        ...
                        if (UserListView.this.mUserCountText != null) {
                            ...
                            UserListView.this.mUserCountText.setText(Util.formatNumber((long) UserListView.this.mUserCount));
                        }
            ...
            public void onSystemError(int i, MtopResponse mtopResponse, Object obj) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1954210196")) {
                    ipChange.ipc$dispatch("-1954210196", new Object[]{this, Integer.valueOf(i), mtopResponse, obj});
                    return;
                }
        ...
        NetworkProxy.request(MTOP_API_ROOM_USER_LIST_URL, "1.0", hashMap, true, r0);
    }
    ...
    public void setOnItemClickListener(final IClickCallback iClickCallback) {
        ...
        if (iClickCallback == null) {
            ...
            this.mUserCountText.setOnClickListener(new View.OnClickListener() {
                /* class com.youku.live.dago.widgetlib.ailproom.adapter.userlist.UserListView.AnonymousClass3 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void onClick(View view) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1101475722")) {
                        ipChange.ipc$dispatch("1101475722", new Object[]{this, view});
                        return;
                    }
                    IClickCallback iClickCallback = iClickCallback;
                    if (iClickCallback != null) {
                        iClickCallback.onItemClick(null);
                    }
                }
    ...
    public void updateAttributes(String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "2113211348")) {
        ...
        } else if (qm.SDK_TYPE.equals(str)) {
            ...
            if (textView != null) {
                ...
                textView2.setText("在线用户" + Util.formatNumber((long) this.mUserCount));
            }
        } else {
