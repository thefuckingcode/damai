...
public class DagoInputBoxDialog extends Dialog implements DialogInterface.OnKeyListener, TextWatcher, View.OnClickListener, View.OnFocusChangeListener, CompoundButton.OnCheckedChangeListener, TextView.OnEditorActionListener, IDagoInputBox {
    ...
    private int[] btnBg = new int[2];
    private boolean isShowEmoji = false;
    private boolean isShowSwitch = false;
    private boolean isShowYell = false;
    ...
    private IExpressionSelectListener mExpressionListener = new IExpressionSelectListener() {
        /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatinput.DagoInputBoxDialog.AnonymousClass6 */
    ...
    private boolean isExceedLimit(String str) {
        ...
        if (i != 0 && i - ((int) Math.round(DagoInputBoxUtils.getLengthCH(str))) <= 0) {
            return true;
        }
        return false;
    }
    ...
    private void parseOptions(Map<String, Object> map) {
        ...
        this.btnBg[0] = Color.parseColor(str2);
        this.btnBg[1] = Color.parseColor(str);
    }
    ...
    private void setSendBtnBackground(int[] iArr) {
        ...
        gradientDrawable.setCornerRadius((float) UIUtil.dip2px(24));
    ...
    private void showExpressionPanel() {
        ...
        UIUtil.postDelayed(new Runnable() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatinput.DagoInputBoxDialog.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1846736729")) {
                    ipChange.ipc$dispatch("-1846736729", new Object[]{this});
                    return;
                }
    ...
    public boolean canClose() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1015202397")) {
            return System.currentTimeMillis() - this.mCurrentTimeMillis > 500;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1015202397", new Object[]{this})).booleanValue();
    }
    ...
    public void dismiss() {
        ...
        hideKeyboardPanel();
        super.dismiss();
        OnInputDialogShowListener onInputDialogShowListener2 = this.onInputDialogShowListener;
        if (onInputDialogShowListener2 != null) {
            onInputDialogShowListener2.dialogShow(false);
        }
    }
    ...
    public boolean isShowExpressionPanel() {
        ...
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "502252386")) {
            return ((Boolean) ipChange.ipc$dispatch("502252386", new Object[]{this})).booleanValue();
        }
        return isShowPanelContainer() && (expressionPanel = this.mExpressionPanel) != null && expressionPanel.getVisibility() == 0;
    }
    ...
    public boolean isWeexCallClose() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1715521400")) {
            return this.weexCallClose;
        }
        return ((Boolean) ipChange.ipc$dispatch("1715521400", new Object[]{this})).booleanValue();
    }
    ...
    public void onClick(View view) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-999885800")) {
            ...
            if (onInputBoxListener2 != null) {
                onInputBoxListener2.onChangeExpressionPanel(!isShowExpressionPanel());
            }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setOnDismissListener(new DialogInterface.OnDismissListener() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatinput.DagoInputBoxDialog.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onDismiss(DialogInterface dialogInterface) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "54260091")) {
                    ipChange.ipc$dispatch("54260091", new Object[]{this, dialogInterface});
    ...
    public void setBarrageRes(String str, String str2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1236933579")) {
            ...
            DagoImageLoader.getInstance().load(getContext(), str2, new ImageLoadListener() {
                /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatinput.DagoInputBoxDialog.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dago.widgetlib.ailpbaselib.image.ImageLoadListener
                public void onFail() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1346288760")) {
                        ipChange.ipc$dispatch("1346288760", new Object[]{this});
                    }
                }
                ...
                public void onSuccess(BitmapDrawable bitmapDrawable) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1677855174")) {
                        ipChange.ipc$dispatch("1677855174", new Object[]{this, bitmapDrawable});
                        return;
                    }
            ...
            DagoImageLoader.getInstance().load(getContext(), str, new ImageLoadListener() {
                /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatinput.DagoInputBoxDialog.AnonymousClass3 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dago.widgetlib.ailpbaselib.image.ImageLoadListener
                public void onFail() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1052885753")) {
                        ipChange.ipc$dispatch("1052885753", new Object[]{this});
                    }
                }
                ...
                public void onSuccess(BitmapDrawable bitmapDrawable) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-252763931")) {
                        ipChange.ipc$dispatch("-252763931", new Object[]{this, bitmapDrawable});
                        return;
                    }
                    stateListDrawable.addState(new int[]{-16842912}, bitmapDrawable);
                    if (DagoInputBoxDialog.this.mBarrageSwitch != null) {
    ...
    @Override // com.youku.live.dago.widgetlib.ailproom.adapter.chatinput.IDagoInputBox
    public void setOnInputBoxListener(OnInputBoxListener onInputBoxListener2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "353168708")) {
            ipChange.ipc$dispatch("353168708", new Object[]{this, onInputBoxListener2});
            return;
        }
        this.onInputBoxListener = onInputBoxListener2;
    }

    public void setOnInputDialogShowListener(OnInputDialogShowListener onInputDialogShowListener2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "16326290")) {
            ipChange.ipc$dispatch("16326290", new Object[]{this, onInputDialogShowListener2});
            return;
        }
        this.onInputDialogShowListener = onInputDialogShowListener2;
    }
    ...
    public void show() {
        ...
        super.show();
        UIUtil.postDelayed(new Runnable() {
            /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatinput.DagoInputBoxDialog.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1650223224")) {
                    ipChange.ipc$dispatch("-1650223224", new Object[]{this});
        ...
        OnInputDialogShowListener onInputDialogShowListener2 = this.onInputDialogShowListener;
        if (onInputDialogShowListener2 != null) {
            onInputDialogShowListener2.dialogShow(true);
        }
    }
    ...
    public boolean useBarrage() {
        CheckBox checkBox;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1726990030")) {
            return ((Boolean) ipChange.ipc$dispatch("-1726990030", new Object[]{this})).booleanValue();
        }
        return this.isShowSwitch && (checkBox = this.mBarrageSwitch) != null && checkBox.isChecked();
    }
}
