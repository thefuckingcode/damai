...
public class DagoChatListTest implements View.OnClickListener {
    ...
    private Runnable runnable = new Runnable() {
        /* class com.youku.live.dago.widgetlib.ailproom.adapter.chatlist.dago.test.DagoChatListTest.AnonymousClass1 */
    ...
    private String getText() {
        ...
        return "{\"cell\":" + strArr[(int) (((double) 2) * Math.random())] + ",\"bgColor\":26000000" + ",\"borderColor\":26000000" + ",\"borderWidth\":0" + "}";
    }
    ...
    private static String getText2(String str) {
        ...
        return "[{\"level\":20,\"type\":\"lfUserLevel\"},{\"color\":\"FFFFFFFF\",\"emoji\":false,\"text\":\" \",\"type\":\"text\"},{\"id\":\"483\",\"type\":\"medal\"},{\"color\":\"FFFFFFFF\",\"emoji\":false,\"text\":\" \",\"type\":\"text\"},{\"bold\":true,\"clickData\":\"{\\\"userId\\\":1558848224}\",\"color\":\"FFFFB700\",\"emoji\":false,\"text\":\"奋斗的饼干\",\"type\":\"text\"},{\"color\":\"FFFFFFFF\",\"emoji\":false,\"text\":\" \",\"type\":\"text\"},{\"bold\":true,\"color\":\"FFFFF6DE\",\"emoji\":false,\"text\":\"赠送了\",\"type\":\"text\"},{\"color\":\"FFFFFFFF\",\"emoji\":false,\"text\":\" \",\"type\":\"text\"},{\"bold\":true,\"color\":\"FFFFB700\",\"emoji\":false,\"text\":\"星星\",\"type\":\"text\"},{\"color\":\"FF999900\",\"emoji\":false,\"text\":\"count: " + str + "\",\"type\":\"text\"}" + jl1.ARRAY_END_STR;
    }
    ...
    private static String getText5(String str) {
        ...
        return (String) ipChange.ipc$dispatch("1752427289", new Object[]{str});
    }
