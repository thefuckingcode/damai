...
public abstract class TagAdapter<T> {
    ...
    public T getItem(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "712858509")) {
            return this.mTagDatas.get(i);
        }
        return (T) ipChange.ipc$dispatch("712858509", new Object[]{this, Integer.valueOf(i)});
    }
    ...
    public HashSet<Integer> getPreCheckedList() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-926172852")) {
            return this.mCheckedPosList;
        }
        return (HashSet) ipChange.ipc$dispatch("-926172852", new Object[]{this});
    }
