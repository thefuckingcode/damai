...
public class ViewFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
        ...
        if (this.mTagAdapter != null) {
            for (final int i = 0; i < this.mTagAdapter.getCount(); i++) {
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    /* class com.youku.live.dago.widgetlib.ailproom.view.flowview.ViewFlowLayout.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    public void onClick(View view) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-399647575")) {
                            ipChange.ipc$dispatch("-399647575", new Object[]{this, view});
    ...
    public int dip2px(Context context, float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1919293465")) {
            return (int) ((f * context.getResources().getDisplayMetrics().density) + 0.5f);
        }
        return ((Integer) ipChange.ipc$dispatch("-1919293465", new Object[]{this, context, Float.valueOf(f)})).intValue();
    }

    public TagAdapter getAdapter() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1756505821")) {
            return this.mTagAdapter;
        }
        return (TagAdapter) ipChange.ipc$dispatch("1756505821", new Object[]{this});
    }
