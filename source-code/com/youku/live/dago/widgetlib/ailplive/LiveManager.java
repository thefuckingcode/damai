...
public class LiveManager {
    ...
    public static class Builder {
        ...
        public Builder chatRoom(ChatRoom chatRoom) {
            if (chatRoom == null) {
                ...
                if (!(liveManager2 == null || liveManager2.uniqueKey == null)) {
                ...
                if (liveManager3 != null) {
                    chatRoom.addMessageDelegate(liveManager3.mIMDelegate);
    ...
    private LiveManager() {
        ...
        this.mExt = "";
        this.mIMDelegate = new MessageListener(Arrays.asList(names)) {
            /* class com.youku.live.dago.widgetlib.ailplive.LiveManager.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            /* access modifiers changed from: protected */
            @Override // com.youku.live.dago.widgetlib.ailpchat.MessageDelegate, com.youku.live.dago.widgetlib.ailpchat.MessageListener
