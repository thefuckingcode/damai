...
public class ReportSocketIO {
            ...
            while (networkInterfaces.hasMoreElements()) {
                ...
                while (true) {
                    ...
                    if (!(nextElement instanceof Inet6Address)) {
                        if (!LivePlayerController.CLIENT_IP.equals(nextElement.getHostAddress())) {
    ...
    private void connect(URI uri) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-35537602")) {
            ...
            AnonymousClass1 r0 = new WebSocketClient(uri, new Draft_6455(), null, 3000) {
                /* class com.youku.live.dago.widgetlib.ailpbaselib.net.ReportSocketIO.AnonymousClass1 */
