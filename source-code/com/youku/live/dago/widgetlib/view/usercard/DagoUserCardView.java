...
public class DagoUserCardView extends FrameLayout implements View.OnClickListener {
    ...
    private boolean isShowLiveManageBtn = false;
    ...
    private Handler mHandler = new Handler() {
        /* class com.youku.live.dago.widgetlib.view.usercard.DagoUserCardView.AnonymousClass1 */
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 257) {
                ...
                obtain.what = 257;
                DagoUserCardView.this.mHandler.sendMessageDelayed(obtain, 5);
            } else if (i == 258) {
    ...
    private UserVideoAdapter.ItemClickListener mItemClickLister = new UserVideoAdapter.ItemClickListener() {
        /* class com.youku.live.dago.widgetlib.view.usercard.DagoUserCardView.AnonymousClass2 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private Orientation orientation = Orientation.ORIENTATION_PORTAIT;
    ...
    private void init() {
        ...
        if (WidgetSDKEngine.getOrientation() == Orientation.ORIENTATION_LANDSCAPE && Build.VERSION.SDK_INT >= 21) {
            this.mLayoutWrapper.setOutlineProvider(new ViewOutlineProvider() {
                /* class com.youku.live.dago.widgetlib.view.usercard.DagoUserCardView.AnonymousClass3 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void getOutline(View view, Outline outline) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1943244653")) {
                        ipChange.ipc$dispatch("-1943244653", new Object[]{this, view, outline});
                        return;
                    }
                    outline.setRoundRect(0, 0, view.getWidth(), view.getHeight(), (float) DensityUtil.dip2px(AppContextUtils.getApp(), 15.0f));
                }
            });
        ...
        this.mRvVideo.addOnScrollListener(new RecyclerView.OnScrollListener() {
            /* class com.youku.live.dago.widgetlib.view.usercard.DagoUserCardView.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-75888710")) {
                    ipChange.ipc$dispatch("-75888710", new Object[]{this, recyclerView, Integer.valueOf(i)});
                    return;
                }
            ...
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "2116450085")) {
                    ipChange.ipc$dispatch("2116450085", new Object[]{this, recyclerView, Integer.valueOf(i), Integer.valueOf(i2)});
                    return;
                }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void showOrHideChatRedPoint(boolean z) {
        IpChange ipChange = $ipChange;
        int i = 0;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateAttentionButton(boolean z) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1263077790")) {
            ...
            if (userCardInfo == null || userCardInfo.localType != 0) {
                ShapeBuilder.create().radius((float) UIUtil.dip2px(getContext(), 17)).solid(Color.parseColor("#EAEAEA")).build(this.mTvAttention);
                ShapeBuilder.create().radius((float) UIUtil.dip2px(getContext(), 17)).solid(Color.parseColor("#EAEAEA")).build(this.mBtnAttentionSmall);
                return;
            }
            ShapeBuilder.create().radius((float) UIUtil.dip2px(getContext(), 17)).gradient(45, Color.parseColor("#37E8FF"), Color.parseColor("#80C6FF"), Color.parseColor("#F586FF")).build(this.mTvAttention);
            ShapeBuilder.create().radius((float) UIUtil.dip2px(getContext(), 17)).gradient(45, Color.parseColor("#37E8FF"), Color.parseColor("#80C6FF"), Color.parseColor("#F586FF")).build(this.mBtnAttentionSmall);
        }
    }
    ...
    private void updateHeaderUI() {
        ...
        if (i <= dip2px) {
            ...
            float f2 = (float) ((((double) (i - dip2px)) * 1.0d) / ((double) i2));
            if (f2 >= 1.0f) {
                f2 = 1.0f;
            }
        ...
        double d = (double) (180 - i);
        int i3 = (int) (((42.0d * d) / 180.0d) + 52.0d);
        int i4 = (int) (((40.0d * d) / 180.0d) + 66.0d);
        float f3 = (float) (d / 180.0d);
        int dip2px2 = DensityUtil.dip2px(AppContextUtils.getApp(), (float) ((int) (((d * 4.0d) / 180.0d) + 2.0d)));
        ...
        ((RelativeLayout.LayoutParams) this.mLayoutName.getLayoutParams()).setMargins(DensityUtil.dip2px(AppContextUtils.getApp(), (float) i4), DensityUtil.dip2px(AppContextUtils.getApp(), 12.0f), 0, 0);
    ...
    private void updatePrivateChatRedPoint() {
        ...
        if (iImChannel != null && (userCardInfo = this.mUserCardInfo) != null) {
            iImChannel.checkRedPointWithSomeOne(String.valueOf(userCardInfo.ytid), new RedPointCallBack() {
                /* class com.youku.live.dago.widgetlib.view.usercard.DagoUserCardView.AnonymousClass5 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.im.RedPointCallBack
                public void onRedPointStateChanged(boolean z) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1927033815")) {
                        ipChange.ipc$dispatch("1927033815", new Object[]{this, Boolean.valueOf(z)});
                        return;
                    }
    ...
    public void attentionActor(Map<String, String> map) {
        ...
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.view.usercard.DagoUserCardView.AnonymousClass6 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1517892835")) {
                        ipChange.ipc$dispatch("-1517892835", new Object[]{this, iNetResponse});
                        return;
                    }
                    if (iNetResponse != null) {
                        try {
                            if ("SUCCESS".equals(iNetResponse.getRetCode())) {
                                ...
                                DagoUserCardView.this.post(new Runnable() {
                                    /* class com.youku.live.dago.widgetlib.view.usercard.DagoUserCardView.AnonymousClass6.AnonymousClass1 */
                                    private static transient /* synthetic */ IpChange $ipChange;

                                    public void run() {
                                        IpChange ipChange = $ipChange;
                                        if (AndroidInstantRuntime.support(ipChange, "-1728717037")) {
                                            ipChange.ipc$dispatch("-1728717037", new Object[]{this});
                                            return;
                                        }
    ...
    public boolean isSlideToBottom(RecyclerView recyclerView) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-376983381")) {
            return recyclerView != null && recyclerView.computeVerticalScrollExtent() + recyclerView.computeVerticalScrollOffset() >= recyclerView.computeVerticalScrollRange();
        }
        return ((Boolean) ipChange.ipc$dispatch("-376983381", new Object[]{this, recyclerView})).booleanValue();
    }
    ...
    public void onClick(View view) {
                ...
                if (j >= 0) {
                    ...
                    if (i == 0) {
                        ...
                        if (onUserCardListener2 != null) {
                            onUserCardListener2.onHomeClicked(j);
                        }
                    } else if (i == 1) {
        ...
        } else if (id == R.id.layout_dago_user_card_btn_attention || id == R.id.layout_dago_user_card_btn_attention_small) {
        ...
        } else if (id == R.id.layout_dago_user_card_btn_private_chat) {
                ...
                if (j2 >= 0) {
                    ...
                    if (i3 == 0) {
                        ...
                        if (onUserCardListener4 != null) {
                            onUserCardListener4.onPrivateChatClicked(j2, userCardInfo4.isFollower);
                        }
                    } else if (i3 == 1) {
