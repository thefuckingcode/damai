...
public class UserCardApi {
    ...
    public void requestUserInfo(long j) {
        ...
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.view.usercard.UserCardApi.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1036193466")) {
                        ipChange.ipc$dispatch("-1036193466", new Object[]{this, iNetResponse});
                    } else if (iNetResponse != null && iNetResponse.isSuccess() && UserCardApi.this.mListener != null) {
                        UserCardApi.this.mListener.onUserInfo(((UserCardInfoResponse) ((IDeserialize) Dsl.getService(IDeserialize.class)).deserialize(iNetResponse.getSource(), UserCardInfoResponse.class)).data);
                    }
                }
            });
        }
    ...
    public void requestUserInfoAndVideos(String str, int i, int i2) {
        ...
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.view.usercard.UserCardApi.AnonymousClass3 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-995518716")) {
                        ipChange.ipc$dispatch("-995518716", new Object[]{this, iNetResponse});
                    } else if (iNetResponse != null && iNetResponse.isSuccess()) {
                        T t = ((UserCardTabInfoResponse) ((IDeserialize) Dsl.getService(IDeserialize.class)).deserialize(iNetResponse.getSource(), UserCardTabInfoResponse.class)).data;
                        if (UserCardApi.this.mListener != null) {
                            UserCardApi.this.mListener.onUserTab(t);
                        }
                    } else if (UserCardApi.this.mListener != null) {
    ...
    public void requestUserVideos(long j, int i, int i2) {
        ...
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.view.usercard.UserCardApi.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1015856091")) {
                        ipChange.ipc$dispatch("-1015856091", new Object[]{this, iNetResponse});
                    } else if (iNetResponse != null && iNetResponse.isSuccess()) {
                        T t = ((UserCardVideoListResponse) ((IDeserialize) Dsl.getService(IDeserialize.class)).deserialize(iNetResponse.getSource(), UserCardVideoListResponse.class)).data;
                        if (UserCardApi.this.mListener != null) {
                            UserCardApi.this.mListener.onUserVideos(t);
                        }
                    }
                }
            });
