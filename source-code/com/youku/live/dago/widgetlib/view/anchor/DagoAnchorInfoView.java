...
public class DagoAnchorInfoView extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.view.anchor.DagoAnchorInfoView.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "365558873")) {
                    ipChange.ipc$dispatch("365558873", new Object[]{this, view});
        ...
        this.mAttentionBtn.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.view.anchor.DagoAnchorInfoView.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1818118054")) {
                    ipChange.ipc$dispatch("-1818118054", new Object[]{this, view});
                } else if (DagoAnchorInfoView.this.mCallback != null) {
    ...
    public void reset() {
        ...
        this.mAnchorImageView.setImageUrl("", new PhenixOptions().bitmapProcessors(new gp()));
    ...
    public void setBtnBg(List<String> list) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-889039891")) {
            ...
            if (i != 0 || i2 != 0) {
                int i3 = i == 0 ? i2 : i;
                setBtnBackground(ThemeUtils.getGradientDrawable(i3, i2 == 0 ? i3 : i2, GradientDrawable.Orientation.LEFT_RIGHT, 0, 0, (float) DensityUtil.dip2px(getContext(), 15.0f)));
            }
        }
    }
    ...
    public void updateAnchorAvatar(String str) {
        ...
        this.mAnchorImageView.setImageUrl(str, new PhenixOptions().bitmapProcessors(new gp()));
    }
