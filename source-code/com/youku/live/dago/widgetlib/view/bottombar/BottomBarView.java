...
public class BottomBarView extends LinearLayout {
    ...
    private void updateChildView() {
        ...
        Collections.sort(this.mChilds, new Comparator<BaseBottomBarBtn>() {
            /* class com.youku.live.dago.widgetlib.view.bottombar.BottomBarView.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public int compare(BaseBottomBarBtn baseBottomBarBtn, BaseBottomBarBtn baseBottomBarBtn2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "719722865")) {
                    return ((Integer) ipChange.ipc$dispatch("719722865", new Object[]{this, baseBottomBarBtn, baseBottomBarBtn2})).intValue();
                } else if (baseBottomBarBtn.getType() > baseBottomBarBtn2.getType()) {
                    return 1;
                } else {
