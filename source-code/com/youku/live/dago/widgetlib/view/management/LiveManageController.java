...
public class LiveManageController {
    ...
    public static boolean isActor(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-148405995")) {
            return (i & 4) == 4;
        }
        return ((Boolean) ipChange.ipc$dispatch("-148405995", new Object[]{Integer.valueOf(i)})).booleanValue();
    }

    public static boolean isHasRightBanSpeak(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-195416503")) {
            return (i & 1) == 1;
        }
        return ((Boolean) ipChange.ipc$dispatch("-195416503", new Object[]{Integer.valueOf(i)})).booleanValue();
    }

    public static boolean isHasRightKickout(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1483265434")) {
            return (i & 2) == 2;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1483265434", new Object[]{Integer.valueOf(i)})).booleanValue();
    }

    public static boolean isHasRightManager(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1130465205")) {
            return (i & 4) == 4;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1130465205", new Object[]{Integer.valueOf(i)})).booleanValue();
    }

    public static boolean isManager(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-637917363")) {
            return (i & 32) == 32;
        }
        return ((Boolean) ipChange.ipc$dispatch("-637917363", new Object[]{Integer.valueOf(i)})).booleanValue();
    }
    ...
    public void requestManagerCancel() {
        ...
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.view.management.LiveManageController.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1693121889")) {
                        ipChange.ipc$dispatch("1693121889", new Object[]{this, iNetResponse});
    ...
    public void requestManagerSet() {
        ...
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.view.management.LiveManageController.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1672784514")) {
                        ipChange.ipc$dispatch("1672784514", new Object[]{this, iNetResponse});
                    } else if (iNetResponse.isSuccess()) {
                        try {
                            JSONObject jSONObject = new JSONObject(new JSONObject(new JSONObject(iNetResponse.getSource()).toString()).getString("data"));
                            String string = jSONObject.getString("msg");
    ...
    public void requestUserBanSpeak(int i) {
        ...
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.view.management.LiveManageController.AnonymousClass5 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1754134014")) {
                        ipChange.ipc$dispatch("1754134014", new Object[]{this, iNetResponse});
                    } else if (iNetResponse.isSuccess()) {
                        try {
                ...
                /* class com.youku.live.dago.widgetlib.view.management.LiveManageController.AnonymousClass6 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetError
                public void onError(String str) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1381366292")) {
                        ipChange.ipc$dispatch("-1381366292", new Object[]{this, str});
                        return;
                    }
    ...
    public void requestUserKickout(int i) {
        ...
        ((ILog) Dsl.getService(ILog.class)).i(TAG, "requestUserKickout [roomId: " + this.mRoomId + ", targetUserId: " + this.mTargetUserId + jl1.ARRAY_END_STR);
        INetRequest createRequestWithMTop = iNetClient.createRequestWithMTop(MTOP_LIVE_USER_KICKOUT, "1.0", hashMap, false, false);
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.view.management.LiveManageController.AnonymousClass3 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1713459264")) {
                        ipChange.ipc$dispatch("1713459264", new Object[]{this, iNetResponse});
                    } else if (iNetResponse.isSuccess()) {
                        try {
                            JSONObject jSONObject = new JSONObject(new JSONObject(new JSONObject(iNetResponse.getSource()).toString()).getString("data"));
                            String string = jSONObject.getString("msg");
    ...
    public void requestUserUnBanSpeak() {
        ...
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.view.management.LiveManageController.AnonymousClass7 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1794808764")) {
                        ipChange.ipc$dispatch("1794808764", new Object[]{this, iNetResponse});
                    } else if (iNetResponse.isSuccess()) {
                        try {
                            String string = new JSONObject(new JSONObject(new JSONObject(iNetResponse.getSource()).toString()).getString("data")).getString("result");
                            if (TextUtils.isEmpty(string)) {
                ...
                /* class com.youku.live.dago.widgetlib.view.management.LiveManageController.AnonymousClass8 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetError
                public void onError(String str) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1106606678")) {
                        ipChange.ipc$dispatch("-1106606678", new Object[]{this, str});
                        return;
                    }
                    ToastUtil.showCenter(AppContextUtils.getApp(), str);
                }
    ...
    public void requestUserUnKickout() {
        ...
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.view.management.LiveManageController.AnonymousClass4 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1733796639")) {
                        ipChange.ipc$dispatch("1733796639", new Object[]{this, iNetResponse});
                    } else if (iNetResponse.isSuccess()) {
                        try {
                            JSONObject jSONObject = new JSONObject(new JSONObject(new JSONObject(iNetResponse.getSource()).toString()).getString("data"));
                            String string = jSONObject.getString("msg");
