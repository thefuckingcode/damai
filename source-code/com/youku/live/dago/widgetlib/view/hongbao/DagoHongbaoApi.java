    ...
    public void getHongbaoRequest(String str) {
        ...
        if (createRequestWithMTop != null) {
            createRequestWithMTop.async(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.view.hongbao.DagoHongbaoApi.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-373634621")) {
                        ipChange.ipc$dispatch("-373634621", new Object[]{this, iNetResponse});
                        ...
                        DagoHongbaoApi.this.mCallback.onGetHongbaoResult(((HongbaoResultInfoResponse) ((IDeserialize) Dsl.getService(IDeserialize.class)).deserialize(iNetResponse.getSource(), HongbaoResultInfoResponse.class)).data);
                    }
                }
            });
        }
