...
public class DagoVipHongbaoView extends FrameLayout implements IHongbaoCountdownView, IDestroyable, IAppearStateChangedListener {
    ...
    private void initChildrenView(View view) {
        ...
        setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.view.hongbao.DagoVipHongbaoView.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1430441688")) {
                    ipChange.ipc$dispatch("1430441688", new Object[]{this, view});
