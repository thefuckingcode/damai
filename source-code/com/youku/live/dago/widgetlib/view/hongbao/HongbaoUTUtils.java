...
public class HongbaoUTUtils {
    ...
    private static String getDirection() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1676854422")) {
            return (String) ipChange.ipc$dispatch("-1676854422", new Object[0]);
        }
        if (WidgetSDKEngine.getOrientation() == Orientation.ORIENTATION_LANDSCAPE) {
            return "fplayer";
        }
        return VIDEO_LANDSCAPE ? "vhplayer" : "vplayer";
    }
