...
public class LFAnchorGuardButton extends FrameLayout implements IDestroyable, IAppearStateChangedListener {
    ...
    private void initView(Context context) {
        ...
        if (this.supportAsyncInflater) {
            new AsyncLayoutInflater(getContext()).inflate(R.layout.dago_lf_guard_btn_layout, this, new AsyncLayoutInflater.OnInflateFinishedListener() {
                /* class com.youku.live.dago.widgetlib.view.guard.LFAnchorGuardButton.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // androidx.asynclayoutinflater.view.AsyncLayoutInflater.OnInflateFinishedListener
                public void onInflateFinished(View view, int i, ViewGroup viewGroup) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1308956481")) {
                        ipChange.ipc$dispatch("1308956481", new Object[]{this, view, Integer.valueOf(i), viewGroup});
                        return;
                    }
                    ...
                    LFAnchorGuardButton.this.mTextShouhu.setOnClickListener(new View.OnClickListener() {
                        /* class com.youku.live.dago.widgetlib.view.guard.LFAnchorGuardButton.AnonymousClass1.AnonymousClass1 */
                        private static transient /* synthetic */ IpChange $ipChange;

                        public void onClick(View view) {
                            IpChange ipChange = $ipChange;
                            if (AndroidInstantRuntime.support(ipChange, "-461982819")) {
                                ipChange.ipc$dispatch("-461982819", new Object[]{this, view});
        ...
        this.mTextShouhu.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.view.guard.LFAnchorGuardButton.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1627274385")) {
                    ipChange.ipc$dispatch("1627274385", new Object[]{this, view});
                } else if (LFAnchorGuardButton.this.isFullScreen) {
                    LFAnchorGuardButton.this.showNoClickToast();
                } else if (!((ILogin) Dsl.getService(ILogin.class)).isLogined()) {
                    ((ILogin) Dsl.getService(ILogin.class)).login();
    ...
    private void playAnim(URL url) {
        ...
        if (sVGAAnimationView != null && url != null) {
            ...
            new SVGAParser(getContext()).k(url, new SVGAParser.ParseCompletion() {
                /* class com.youku.live.dago.widgetlib.view.guard.LFAnchorGuardButton.AnonymousClass4 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.opensource.svgaplayer.SVGAParser.ParseCompletion
                public void onComplete(@NonNull SVGAVideoEntity sVGAVideoEntity) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "175400171")) {
                        ipChange.ipc$dispatch("175400171", new Object[]{this, sVGAVideoEntity});
                        return;
                    }
                ...
                public void onError() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "532464991")) {
                        ipChange.ipc$dispatch("532464991", new Object[]{this});
                        return;
                    }
                    LFAnchorGuardButton.this.animationView.setVisibility(8);
                }
            });
            this.animationView.setCallback(new SVGACallback() {
                /* class com.youku.live.dago.widgetlib.view.guard.LFAnchorGuardButton.AnonymousClass5 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.opensource.svgaplayer.SVGACallback
                public void onFinished() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-2071071342")) {
                        ipChange.ipc$dispatch("-2071071342", new Object[]{this});
                        return;
                    }
                    LFAnchorGuardButton.this.animationView.setVisibility(8);
                ...
                public void onPause() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-95515568")) {
                        ipChange.ipc$dispatch("-95515568", new Object[]{this});
                    }
                }
                ...
                public void onRepeat() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-149441655")) {
                        ipChange.ipc$dispatch("-149441655", new Object[]{this});
                    }
                }
                ...
                public void onStep(int i, double d) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1798842387")) {
                        ipChange.ipc$dispatch("1798842387", new Object[]{this, Integer.valueOf(i), Double.valueOf(d)});
                    }
                }
            });
        }
    ...
    public String getPageName() {
        ...
        } else if (SdkChannel.isYouku(AppContextUtils.getApp())) {
    ...
    public void onPurchaseGuardianUpdate(String str) {
        ...
        try {
            ...
            if (parseArray == null || parseArray.isEmpty()) {
                UIUtil.setGone((View) this.mShouhuAvatar, true);
                UIUtil.setGone((View) this.mShouhuNull, false);
                return;
            }
            ...
            if (!TextUtils.isEmpty(str2)) {
                ...
                UIUtil.setGone((View) this.mShouhuNull, true);
                UIUtil.setGone((View) this.mShouhuAvatar, false);
            } else {
                UIUtil.setGone((View) this.mShouhuAvatar, true);
                UIUtil.setGone((View) this.mShouhuNull, false);
            }
    ...
    public LFAnchorGuardButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mHandler = new Handler(Looper.getMainLooper()) {
            /* class com.youku.live.dago.widgetlib.view.guard.LFAnchorGuardButton.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;
