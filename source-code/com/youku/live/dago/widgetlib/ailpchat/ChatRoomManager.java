...
public class ChatRoomManager {
    ...
    public static boolean hasChatRoom(String str, String str2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1764586840")) {
            return mChatRoomManager.containsKey(str) && mChatRoomManager.get(str) != null && mChatRoomManager.get(str).containsKey(str2);
        }
        return ((Boolean) ipChange.ipc$dispatch("-1764586840", new Object[]{str, str2})).booleanValue();
    }

    public static boolean hasLiveId(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "457578634")) {
            return mChatRoomManager.containsKey(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("457578634", new Object[]{str})).booleanValue();
    }
