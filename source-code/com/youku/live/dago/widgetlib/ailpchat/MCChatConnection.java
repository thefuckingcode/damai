...
public class MCChatConnection implements IChatConnection {
    ...
    public boolean connect(ICallback iCallback) {
        ...
        if (mCChannel != null) {
            mCChannel.open(new IMCChannelEventCallback() {
                /* class com.youku.live.dago.widgetlib.ailpchat.MCChatConnection.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;
                ...
                public void onEvent(MCChannelEvent mCChannelEvent, String str, Map<String, Object> map) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "642116708")) {
                        ipChange.ipc$dispatch("642116708", new Object[]{this, mCChannelEvent, str, map});
                        return;
                    }
                    String str2 = MCChatConnection.this.TAG;
                    ((ILog) Dsl.getService(ILog.class)).d(str2, "Connection event callback, message:" + str);
                    if (mCChannelEvent == MCChannelEvent.OPEN_SUCCESS) {
                        ...
                        ((ILog) Dsl.getService(ILog.class)).d(MCChatConnection.this.TAG, str);
                    }
                }
            }, new IMCDispatchMsgCallback() {
                /* class com.youku.live.dago.widgetlib.ailpchat.MCChatConnection.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.messagechannel.callback.IMCDispatchMsgCallback
                public void onDispatch(MCMessage mCMessage) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-793879812")) {
                        ipChange.ipc$dispatch("-793879812", new Object[]{this, mCMessage});
                        ...
                        if (MCChatConnection.this.mListener != null) {
                            ...
                            String str = MCChatConnection.this.TAG;
                            ((ILog) Dsl.getService(ILog.class)).v(str, "Dispatch message:" + chatMessage.toString());
                        }
                        ...
                        if (MCChatConnection.this.mWeexListeners != null) {
                            for (IChatConnection.WeexMessageListener weexMessageListener : MCChatConnection.this.mWeexListeners) {
                                if (weexMessageListener != null) {
                                    ...
                                    String str2 = MCChatConnection.this.TAG;
                                    ((ILog) Dsl.getService(ILog.class)).v(str2, "Dispatch weex message:" + hashMap.toString());
