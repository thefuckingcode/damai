...
public class YKLNetSysAdapter implements YKLNetProtocol {
    ...
    private String getNetworkEvent() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1887932991")) {
            return (String) ipChange.ipc$dispatch("-1887932991", new Object[]{this});
        } else if (NetworkUtils.hasInternet()) {
            return !NetworkUtils.isWifi() ? WX_NET_CELL : WX_NET_WIFI;
        } else {
            return WX_NET_UNKNOWN;
        }
    }
    ...
    private void initNetWorkReceiver() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1999987916")) {
            ...
            this.mNetworkReceiver = new BroadcastReceiver() {
                /* class com.youku.live.dago.widgetlib.wedome.adapter.net.YKLNetSysAdapter.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void onReceive(Context context, Intent intent) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1245273013")) {
                        ipChange.ipc$dispatch("1245273013", new Object[]{this, context, intent});
