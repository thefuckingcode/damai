...
public abstract class CommonAdapter<T> extends BaseAdapter {
    ...
    public boolean contains(T t) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "972809809")) {
            return this.mDatas.contains(t);
        }
        return ((Boolean) ipChange.ipc$dispatch("972809809", new Object[]{this, t})).booleanValue();
    }
    ...
    public int getCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1930009898")) {
            return this.mDatas.size();
        }
        return ((Integer) ipChange.ipc$dispatch("1930009898", new Object[]{this})).intValue();
    }

    public List<T> getData() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-146469171")) {
            return this.mDatas;
        }
        return (List) ipChange.ipc$dispatch("-146469171", new Object[]{this});
    }
    ...
    public long getItemId(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2098820001")) {
            return (long) i;
        }
        return ((Long) ipChange.ipc$dispatch("2098820001", new Object[]{this, Integer.valueOf(i)})).longValue();
    }
