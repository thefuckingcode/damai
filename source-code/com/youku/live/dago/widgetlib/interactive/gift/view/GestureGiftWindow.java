...
public class GestureGiftWindow extends FrameLayout {
    ...
    public class Coord {
        ...
        Coord(GiftInfoBean giftInfoBean2, int i, float f, float f2) {
            this.giftInfoBean = giftInfoBean2;
            this.iconIdentity = i;
            this.x = f;
            this.y = f2;
        }
    ...
    private boolean checkCost() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "549294068")) {
            return this.mTotalCost < this.mCoins;
        }
        return ((Boolean) ipChange.ipc$dispatch("549294068", new Object[]{this})).booleanValue();
    }
    ...
    private void init() {
        ...
        tp1.o().s(i42.p("dago_pgc_ykl_gesture_movement_indicator")).y(this.mGestureIndicator);
        ...
        this.mGiftList.addOnScrollListener(new RecyclerView.OnScrollListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GestureGiftWindow.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1494021423")) {
                    ipChange.ipc$dispatch("1494021423", new Object[]{this, recyclerView, Integer.valueOf(i)});
                    return;
                }
                super.onScrollStateChanged(recyclerView, i);
                if (i == 0) {
                    GestureGiftWindow.this.mPagerIndicator.select(recyclerView.getChildAdapterPosition(recyclerView.findChildViewUnder((float) (recyclerView.getWidth() / 2), (float) (recyclerView.getHeight() / 2))));
                }
            }
        });
        ...
        this.mSplashScheduler.addOnSplashUpdateListener(new SplashScheduler.OnSplashUpdateListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GestureGiftWindow.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.dago.widgetlib.doodle.SplashScheduler.OnSplashUpdateListener
            public void onPaintingEnd() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1249846881")) {
                    ipChange.ipc$dispatch("-1249846881", new Object[]{this});
                }
            }
            ...
            public void onPaintingStart() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1132230520")) {
                    ipChange.ipc$dispatch("1132230520", new Object[]{this});
                }
            }
            ...
            public void onSplashUpdate(float f, float f2, int i, int i2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1745191708")) {
                    ipChange.ipc$dispatch("-1745191708", new Object[]{this, Float.valueOf(f), Float.valueOf(f2), Integer.valueOf(i), Integer.valueOf(i2)});
                    return;
                }
        ...
        SplashItemParser<String, String> instance = LaifengSplashItemParser.getInstance();
        this.mItemParser = instance;
        this.mSplashScheduler.setParser(instance);
        ...
        this.mClearButton.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GestureGiftWindow.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-875350171")) {
                    ipChange.ipc$dispatch("-875350171", new Object[]{this, view});
                    return;
                }
        ...
        this.mCloseButton.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GestureGiftWindow.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1235940198")) {
                    ipChange.ipc$dispatch("1235940198", new Object[]{this, view});
        ...
        this.mRechargeButton.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GestureGiftWindow.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-947736729")) {
                    ipChange.ipc$dispatch("-947736729", new Object[]{this, view});
                } else if (GestureGiftWindow.this.mOnLifecycleListener != null) {
                    GestureGiftWindow.this.mOnLifecycleListener.onRechargeTriggered();
                }
            }
        });
        this.mSendGiftButton.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GestureGiftWindow.AnonymousClass6 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1163553640")) {
                    ipChange.ipc$dispatch("1163553640", new Object[]{this, view});
                } else if (GestureGiftWindow.this.mSendGiftButton.isEnabled() && GestureGiftWindow.this.mOnLifecycleListener != null) {
                    GestureGiftWindow.this.mOnLifecycleListener.onGiftSent(GestureGiftWindow.this.mSplashScheduler.getSketchBoard().getBoardWidth(), GestureGiftWindow.this.mSplashScheduler.getSketchBoard().getBoardHeight(), GestureGiftWindow.this.mDrewGifts, 100, GestureGiftWindow.this.mTargetInfoBeans);
                }
            }
        });
        updateAppearance();
