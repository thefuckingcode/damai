...
public class MultiTargetListAdapter extends RecyclerView.Adapter {
    ...
    private String getUserRoles(int i) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1060137437")) {
            return i == 4 ? "房主" : i == 256 ? "主持" : "";
        }
        return (String) ipChange.ipc$dispatch("-1060137437", new Object[]{this, Integer.valueOf(i)});
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1578727247")) {
            return this.mDataList.size();
        }
        return ((Integer) ipChange.ipc$dispatch("1578727247", new Object[]{this})).intValue();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2096902774")) {
            return i;
        }
        return ((Integer) ipChange.ipc$dispatch("2096902774", new Object[]{this, Integer.valueOf(i)})).intValue();
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        if (giftTargetInfoBean.isChecked) {
            ...
            avaterViewHolder.mSeat.setBackground(ThemeUtils.getDrawable(this.bgRingColor, 0, 0, (float) (this.basePx * 7)));
        } else {
        ...
        avaterViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.multitarget.MultiTargetListAdapter.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1773898336")) {
                    ipChange.ipc$dispatch("-1773898336", new Object[]{this, view});
