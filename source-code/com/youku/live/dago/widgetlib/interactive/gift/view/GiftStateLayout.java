...
public class GiftStateLayout extends RelativeLayout {
    ...
    private String formatNumber(long j) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1589734141")) {
            ...
            if (j < 100000) {
                ...
                double doubleValue = new BigDecimal(((double) j) / 10000.0d).setScale(2, 1).doubleValue();
                return doubleValue + "万";
            } else {
                double doubleValue2 = new BigDecimal(((double) j) / 1.0E8d).setScale(2, 1).doubleValue();
    ...
    private void initGiftLayout() {
        ...
        this.mNumShowLayout.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GiftStateLayout.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1170318329")) {
                    ipChange.ipc$dispatch("-1170318329", new Object[]{this, view});
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GiftStateLayout.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "940972040")) {
                    ipChange.ipc$dispatch("940972040", new Object[]{this, view});
                } else if (GiftStateLayout.this.listener != null) {
        ...
        textView2.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GiftStateLayout.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1242704887")) {
                    ipChange.ipc$dispatch("-1242704887", new Object[]{this, view});
                } else if (GiftStateLayout.this.listener != null) {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GiftStateLayout.AnonymousClass6 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "868585482")) {
                    ipChange.ipc$dispatch("868585482", new Object[]{this, view});
                } else if (GiftStateLayout.this.listener != null) {
    ...
    private void initPropLayout() {
        ...
        this.mSendPropBtn.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GiftStateLayout.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1097931771")) {
                    ipChange.ipc$dispatch("-1097931771", new Object[]{this, view});
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.GiftStateLayout.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1013358598")) {
                    ipChange.ipc$dispatch("1013358598", new Object[]{this, view});
                    return;
                }
    ...
    public long getCoins() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1836620719")) {
            return this.mCoins;
        }
        return ((Long) ipChange.ipc$dispatch("1836620719", new Object[]{this})).longValue();
    }

    public View getSendBtn() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "582809291")) {
            return this.mSendBtn;
        }
        return (View) ipChange.ipc$dispatch("582809291", new Object[]{this});
    }
    ...
    public void setSendBtnVisible(boolean z) {
        ...
        LinearLayout linearLayout = this.mSendBtnLayout;
        if (!z) {
            i = 8;
        }
