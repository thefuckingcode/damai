...
public class LotteryGiftOtherPersonViewController {
    ...
    private Animator getHolderAnimation(View view) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1376048072")) {
            return ObjectAnimator.ofFloat(view, "Alpha", 1.0f, 1.0f);
        }
        return (Animator) ipChange.ipc$dispatch("-1376048072", new Object[]{this, view});
    }
    ...
    public void addSmallLotteryView(Context context, ViewGroup viewGroup, int i, int i2) {
        ...
        if (i == 500 && (viewGroup instanceof RelativeLayout)) {
            ...
            holderAnimation.setDuration(3000);
            holderAnimation.addListener(new AnimatorListenerAdapter() {
                /* class com.youku.live.dago.widgetlib.interactive.gift.lottery.LotteryGiftOtherPersonViewController.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void onAnimationEnd(Animator animator) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1314162957")) {
                        ipChange.ipc$dispatch("1314162957", new Object[]{this, animator});
                        return;
                    }
