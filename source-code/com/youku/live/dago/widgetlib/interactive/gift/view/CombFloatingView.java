...
public class CombFloatingView extends RelativeLayout {
    ...
    private void setDismissStyleType() {
        ...
        this.mDismissScaleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.CombFloatingView.AnonymousClass7 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1034988269")) {
                    ipChange.ipc$dispatch("1034988269", new Object[]{this, valueAnimator});
                    return;
                }
        ...
        this.mDismissScaleAnimator.addListener(new AnimatorListenerAdapter() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.CombFloatingView.AnonymousClass8 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onAnimationEnd(Animator animator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1113025565")) {
                    ipChange.ipc$dispatch("1113025565", new Object[]{this, animator});
                    return;
                }
    ...
    private void setNumScaleType() {
        ...
        this.mNumScaleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.CombFloatingView.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-856387606")) {
                    ipChange.ipc$dispatch("-856387606", new Object[]{this, valueAnimator});
                    return;
                }
                CombFloatingView.this.mCombNumView.setScaleX(((Float) valueAnimator.getAnimatedValue()).floatValue());
                CombFloatingView.this.mCombNumView.setScaleY(((Float) valueAnimator.getAnimatedValue()).floatValue());
    ...
    private void setStateChangeType() {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.CombFloatingView.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-225928981")) {
                    ipChange.ipc$dispatch("-225928981", new Object[]{this, valueAnimator});
                    return;
                }
                CombFloatingView.this.mCombEffectView.setScaleX(((Float) valueAnimator.getAnimatedValue()).floatValue());
                CombFloatingView.this.mCombEffectView.setScaleY(((Float) valueAnimator.getAnimatedValue()).floatValue());
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.CombFloatingView.AnonymousClass6 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onAnimationEnd(Animator animator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1128544283")) {
                    ipChange.ipc$dispatch("1128544283", new Object[]{this, animator});
                    return;
                }
                super.onAnimationEnd(animator);
    ...
    private void setTextScaleType() {
        ...
        objectAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.CombFloatingView.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-2117304856")) {
                    ipChange.ipc$dispatch("-2117304856", new Object[]{this, valueAnimator});
                    return;
                }
                CombFloatingView.this.mCombEffectView.setScaleX(((Float) valueAnimator.getAnimatedValue()).floatValue());
                CombFloatingView.this.mCombEffectView.setScaleY(((Float) valueAnimator.getAnimatedValue()).floatValue());
        ...
        this.mTextScaleAnimator.addListener(new AnimatorListenerAdapter() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.CombFloatingView.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onAnimationEnd(Animator animator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1151822360")) {
                    ipChange.ipc$dispatch("1151822360", new Object[]{this, animator});
                    return;
                }
                super.onAnimationEnd(animator);
                ...
                CombFloatingView.this.weakHandler.sendEmptyMessageDelayed(17, 4500);
            }
        });
    }
    ...
    public void setDataForText(int i) {
        ...
        if (this.isMaxSendNum) {
            tp1.o().s("https://img.alicdn.com/tfs/TB1xxa6JbH1gK0jSZFwXXc7aXXa-344-168.png").y(this.mCombShineView);
    ...
    public CombFloatingView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.weakHandler = new Handler() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.CombFloatingView.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;
