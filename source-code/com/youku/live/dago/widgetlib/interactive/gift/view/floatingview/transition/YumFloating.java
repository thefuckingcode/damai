...
public class YumFloating implements ITransition, Rebound {
    ...
    public View getTargetView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1538315837")) {
            return this.mTargetViewWeakReference.get();
        }
        return (View) ipChange.ipc$dispatch("-1538315837", new Object[]{this});
    }
