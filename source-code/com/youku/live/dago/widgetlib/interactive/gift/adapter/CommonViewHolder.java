...
public class CommonViewHolder {
    ...
    public View getConvertView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-273412894")) {
            return this.mConvertView;
        }
        return (View) ipChange.ipc$dispatch("-273412894", new Object[]{this});
    }

    public int getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1625211104")) {
            return this.mLayoutId;
        }
        return ((Integer) ipChange.ipc$dispatch("-1625211104", new Object[]{this})).intValue();
    }

    public <T extends View> T getView(int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-193867144")) {
            return (T) ((View) ipChange.ipc$dispatch("-193867144", new Object[]{this, Integer.valueOf(i)}));
        }
