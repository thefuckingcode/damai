...
public class GiftKeyBoardAdapter extends MultiItemCommonAdapter<KeyBoardBean> {
    ...
    public GiftKeyBoardAdapter(Context context, List<KeyBoardBean> list) {
        super(context, list, new MultiItemTypeSupport<KeyBoardBean>() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.adapter.GiftKeyBoardAdapter.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;
