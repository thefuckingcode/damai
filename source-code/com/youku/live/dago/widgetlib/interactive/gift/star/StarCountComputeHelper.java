...
public class StarCountComputeHelper implements Handler.Callback, SYTimerListener, SYTimerTask.SYTimerStepListener {
    ...
    private IMSendUpStreamRequest.ICallback mSendStarCallback = new IMSendUpStreamRequest.ICallback() {
        /* class com.youku.live.dago.widgetlib.interactive.gift.star.StarCountComputeHelper.AnonymousClass2 */
        private static transient /* synthetic */ IpChange $ipChange;
        ...
        public void onSuccess(int i) {
            ...
            StarCountComputeHelper.this.mStarModel.starAvail = (long) i;
    ...
    private Runnable mSendStarRunnable = new Runnable() {
        /* class com.youku.live.dago.widgetlib.interactive.gift.star.StarCountComputeHelper.AnonymousClass1 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    public void activateCounter(StarModelNew starModelNew) {
        ...
        if (this.mStarModel.leftSeconds <= 0) {
            ...
            SYTimer.getInstance().addNotify(this, this.mStarModel.leftSeconds * 1000, this, 1000);
        }
    }
    ...
    public boolean handleMessage(Message message) {
        ...
        if (this.mStarGetMax - this.mStarGet > 0) {
            ...
            if (starModelNew2.starAvail - starModelNew2.starExt >= starModelNew2.starTotalMax) {
                ...
                this.mStarCycleRunning = true;
                SYTimer.getInstance().addNotify(this, this.mStarModel.starGap * 1000, new SYTimerTask.SYTimerStepListener() {
                    /* class com.youku.live.dago.widgetlib.interactive.gift.star.StarCountComputeHelper.AnonymousClass3 */
                    private static transient /* synthetic */ IpChange $ipChange;
                    ...
                    public void onStepError(long j, long j2) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-1987731507")) {
                            ipChange.ipc$dispatch("-1987731507", new Object[]{this, Long.valueOf(j), Long.valueOf(j2)});
                        }
                    }
                    ...
                    public void onStepNotify(long j, long j2) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-852673812")) {
                            ipChange.ipc$dispatch("-852673812", new Object[]{this, Long.valueOf(j), Long.valueOf(j2)});
    ...
    public boolean hasLeftStar() {
        ...
        if (starModelNew != null && starModelNew.starAvail > 0) {
            return true;
        }
        return false;
    }
