...
public class SendGiftWindow extends FrameLayout implements ParticleSendGiftButton.OnSendListener {
    ...
    private final int DISPLAY_GIFT_BOARD = 0;
    private final int DISPLAY_NUM_KEY_BOARD = 1;
    private final String YKPACKAGE = AXPParamsProvider.ClientType.YOUKU;
    private long allCombNum;
    private long allSendNum;
    private String args = "";
    List<GiftCategoryBean> categoryGiftBeanArrayList = new ArrayList();
    private boolean closeAll;
    private String combRatio;
    private boolean hasPack = false;
    private boolean hasPackTip = false;
    private boolean isClosing = false;
    private int isNewComb = 1;
    private boolean isOldSend;
    private boolean isShowCombo = false;
    private boolean isShowProp = false;
    private FrameLayout mBlankView;
    private GiftNumKeyBoardView.ClickSureListener mClickSureListener = new GiftNumKeyBoardView.ClickSureListener() {
        /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass12 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private ArrayList<GiftBaseView> mGiftBaseViews = new ArrayList<>();
    ...
    private String mLastSelectedGid = null;
    private String mLastSelectedPid = null;
    ...
    private GiftNumSelectView.OnGiftNumClickListener mOnGiftNumClickListener = new GiftNumSelectView.OnGiftNumClickListener() {
        /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass11 */
        private static transient /* synthetic */ IpChange $ipChange;
        ...
        public void onSelectedNum(int i) {
            ...
            SendGiftWindow.this.mSelectedNum = (long) i;
            SendGiftWindow.this.mGiftStateLayout.setSelNum(SendGiftWindow.this.mSelectedNum);
        }
    ...
    private GiftStateLayout.OnGiftStateClickListener mOnGiftStateClickListener = new GiftStateLayout.OnGiftStateClickListener() {
        /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass9 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private GiftStateLayout.OnPropClickListener mPropClickListener = new GiftStateLayout.OnPropClickListener() {
        /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass10 */
        private static transient /* synthetic */ IpChange $ipChange;
        ...
        public void onSendPropClick(int i) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "228754862")) {
                ...
                SendGiftWindow.this.mGiftBoardCallback.onSendProp((long) i, SendGiftWindow.this.mPropPagerView.getSeletedProp(), SendGiftWindow.this.mMultiTargetLayout.getTargetInfos());
            }
        }
    ...
    private PropShowView.PropListener mPropListener = new PropShowView.PropListener() {
        /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass5 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private GiftInfoBean mSelectedGiftInfoBean = null;
    private long mSelectedNum = 1;
    ...
    private MultiTargetListView.EventListener mTargetLayoutListner = new MultiTargetListView.EventListener() {
        /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass4 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private int numBottom = -1;
    private int roomType;
    private ArrayList<Integer> selPositions = new ArrayList<>();
    private int y;
    ...
    private void calculateSendNum(int i) {
        ...
        if (0 != j) {
            this.combRatio = new DecimalFormat("#0.00").format(((double) this.allCombNum) / ((double) this.allSendNum));
        }
    }
    ...
    private ParticleSystem createBomShot(int i, int i2, int i3, int i4) {
        ...
        ParticleSystem particleSystem = new ParticleSystem(this, 2, UIUtil.zoomImage(i, UIUtil.dip2px(i2), UIUtil.dip2px(i3)), (long) i4);
        ...
        particleSystem.setFadeOut(getRandomAlpha(), 400, new AccelerateInterpolator());
        return particleSystem;
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void displaySimulationKeyBord() {
        IpChange ipChange = $ipChange;
    ...
    private float getRandomAlpha() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1100473079")) {
            return (new Random().nextFloat() * 0.4f) + 0.4f;
        }
        return ((Float) ipChange.ipc$dispatch("-1100473079", new Object[]{this})).floatValue();
    }
    ...
    private void initView(Context context) {
        ...
        findViewById.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "309939228")) {
                    ipChange.ipc$dispatch("309939228", new Object[]{this, view});
                    return;
                }
        ...
        this.mRefreshBtn.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1873737699")) {
                    ipChange.ipc$dispatch("-1873737699", new Object[]{this, view});
                } else if (SendGiftWindow.this.mGiftBoardCallback != null) {
        ...
        tp1.o().s(i42.p("dago_pgc_ykl_gesture_enter_indicator")).y(this.mGestureIndicator);
        this.mBlankView.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                int i = 0;
                if (AndroidInstantRuntime.support(ipChange, "237552670")) {
                    ipChange.ipc$dispatch("237552670", new Object[]{this, view});
    ...
    private void setWaveViewStyle() {
        ...
        if (combWaveView != null) {
            ...
            this.mCombWaveView.setInitialRadius((float) UIUtil.dip2px(37));
            this.mCombWaveView.setMaxRadius((float) UIUtil.dip2px(54));
            this.mCombWaveView.setInterpolator(new AccelerateInterpolator(1.0f));
            this.mCombWaveView.setPaintWidth((float) UIUtil.dip2px(3));
            this.mCombWaveView.setDuration(450);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void showDmDialog(String str) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1084976038")) {
            ipChange.ipc$dispatch("-1084976038", new Object[]{this, str});
            return;
        }
        new DMDialog(this.mContext).n("打开优酷", new DialogInterface.OnClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass14 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(DialogInterface dialogInterface, int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1238971613")) {
                    ipChange.ipc$dispatch("-1238971613", new Object[]{this, dialogInterface, Integer.valueOf(i)});
                    return;
                }
            ...
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass13 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(DialogInterface dialogInterface, int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "2086414660")) {
                    ipChange.ipc$dispatch("2086414660", new Object[]{this, dialogInterface, Integer.valueOf(i)});
                    return;
                }
                dialogInterface.dismiss();
            }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void showGiftNumListView(boolean z) {
        ...
        if (this.mSelectedGiftInfoBean != null) {
            ...
            if (!z || this.mGiftNumSelectView.getVisibility() != 0) {
                ...
                giftNumSelectView.setVisibility(i);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void switchDisplayBoard(int i) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void switchSendButtonState(boolean z) {
        IpChange ipChange = $ipChange;
    ...
    public boolean canSendGift() {
        ...
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-632740504")) {
            return ((Boolean) ipChange.ipc$dispatch("-632740504", new Object[]{this})).booleanValue();
        }
        if (this.mSelectedGiftInfoBean == null || (giftStateLayout = this.mGiftStateLayout) == null) {
            return true;
        }
        return ParseUtils.parse2Long(this.mSelectedGiftInfoBean.coins) * this.mGiftStateLayout.getTvNum() > giftStateLayout.getCoins();
    }
    ...
    public boolean checkCost() {
        ...
        if (this.mSelectedGiftInfoBean == null || (giftStateLayout = this.mGiftStateLayout) == null) {
            ...
            return true;
        } else if (ParseUtils.parse2Long(this.mSelectedGiftInfoBean.coins) * this.mGiftStateLayout.getTvNum() > giftStateLayout.getCoins()) {
            showDialogCharge();
            this.mSendGiftButton.setSendVisibility(false);
            return true;
        } else {
                        ...
                        if (this.isOldSend) {
                            ...
                            if (getHandler() != null) {
                                getHandler().postDelayed(new Runnable() {
                                    /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass15 */
                                    private static transient /* synthetic */ IpChange $ipChange;

                                    public void run() {
                                        IpChange ipChange = $ipChange;
                                        if (AndroidInstantRuntime.support(ipChange, "-533526909")) {
                                            ipChange.ipc$dispatch("-533526909", new Object[]{this});
                                            return;
                                        }
    ...
    public void refreshGiftInfo() {
        ...
        for (int i = 0; i < this.categoryGiftBeanArrayList.size(); i++) {
            if (this.categoryGiftBeanArrayList.get(i) != null) {
                ...
                yKLGiftPageView.setItemClickInterface(new GiftBaseView.OnItemClickInterface<GiftInfoBean>() {
                    /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass6 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    @Override // com.youku.live.dago.widgetlib.interactive.gift.view.pageview.GiftBaseView.OnItemClickInterface
                    public void onChildPageChangeListener(int i, List<GiftInfoBean> list) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-1545528790")) {
                            ipChange.ipc$dispatch("-1545528790", new Object[]{this, Integer.valueOf(i), list});
                            return;
                        }
                        GiftUTUtils.giftBoardPageChange(SendGiftWindow.this.mCurrentGroupId, SendGiftWindow.this.mCurrentTitle, i, list);
                    }

                    @Override // com.youku.live.dago.widgetlib.interactive.gift.view.pageview.GiftBaseView.OnItemClickInterface
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, int i2, long j, CommonAdapter<GiftInfoBean> commonAdapter) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "630189840")) {
                            ipChange.ipc$dispatch("630189840", new Object[]{this, adapterView, view, Integer.valueOf(i), Integer.valueOf(i2), Long.valueOf(j), commonAdapter});
                            return;
                        }
                        ...
                        if (data != null && data.size() > 0) {
                            if (commonAdapter.getData().get(i2).checkGiftTag(GiftInfoBean.GiftTag.GRAFFITI)) {
                        ...
                        while (it.hasNext()) {
                            ...
                            Iterator<CommonAdapter<T>> it2 = hashMap.keySet().iterator();
                            while (it2.hasNext()) {
                                GiftShowAdapter giftShowAdapter = (GiftShowAdapter) it2.next();
                        ...
                        GiftInfoBean item = commonAdapter.getItem(i2);
                        if (item == null || !TextUtils.equals(SendGiftWindow.this.mLastSelectedGid, item.id)) {
                            ...
                            if (SendGiftWindow.this.mSelectedGiftInfoBean != null) {
                                SendGiftWindow.this.mSelectedNum = 1;
                                SendGiftWindow.this.mGiftStateLayout.setSelNum(SendGiftWindow.this.mSelectedNum);
                                if (SendGiftWindow.this.getHandler() != null && !SendGiftWindow.this.mSelectedGiftInfoBean.checkGiftTag(GiftInfoBean.GiftTag.GRAFFITI)) {
                                    SendGiftWindow.this.getHandler().post(new Runnable() {
                                        /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass6.AnonymousClass1 */
                                        private static transient /* synthetic */ IpChange $ipChange;

                                        public void run() {
                                            IpChange ipChange = $ipChange;
                                            if (AndroidInstantRuntime.support(ipChange, "1359064194")) {
                                                ipChange.ipc$dispatch("1359064194", new Object[]{this});
                            ...
                            GiftUTUtils.giftBoardItemClick(SendGiftWindow.this.mCurrentGroupId, SendGiftWindow.this.mCurrentTitle, str, i + "", i2 + "", SendGiftWindow.this.mSelectedGiftInfoBean);
                            if (SendGiftWindow.this.mSelectedGiftInfoBean != null) {
        ...
        this.mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass7 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // androidx.viewpager.widget.ViewPager.OnPageChangeListener
            public void onPageScrollStateChanged(int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1773382384")) {
                    ipChange.ipc$dispatch("1773382384", new Object[]{this, Integer.valueOf(i)});
                }
            }
            ...
            public void onPageScrolled(int i, float f, int i2) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "2134648719")) {
                    ipChange.ipc$dispatch("2134648719", new Object[]{this, Integer.valueOf(i), Float.valueOf(f), Integer.valueOf(i2)});
                }
            }
            ...
            public void onPageSelected(int i) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1454339643")) {
                    ipChange.ipc$dispatch("1454339643", new Object[]{this, Integer.valueOf(i)});
                } else if (GiftDataManager.getInstance().getGiftCategoryList().size() > i) {
                    GiftDataManager.getInstance().getGiftCategoryList().get(i);
                    if (SendGiftWindow.this.mGiftBaseViews != null && SendGiftWindow.this.mGiftBaseViews.size() > 0 && i < SendGiftWindow.this.mGiftBaseViews.size()) {
                        GiftUTUtils.giftBoardPageChange(SendGiftWindow.this.mCurrentGroupId, SendGiftWindow.this.mCurrentTitle, i, ((GiftBaseView) SendGiftWindow.this.mGiftBaseViews.get(i)).getCurrentChildPageData());
                    }
                }
            }
        });
        this.mYKLPagerTabIndicator.setOnItemTabClickListener(new DynamicPagerIndicator.OnItemTabClickListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.SendGiftWindow.AnonymousClass8 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onItemTabClick(int i) {
                ...
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-469348426")) {
                    ipChange.ipc$dispatch("-469348426", new Object[]{this, Integer.valueOf(i)});
                    return;
                }
                if (SendGiftWindow.this.isShowProp) {
                    SendGiftWindow.this.switchPropPannel(false);
                }
                SendGiftWindow.this.mCurrentTabPosition = i;
                if (SendGiftWindow.this.mGiftBaseViews != null && SendGiftWindow.this.mGiftBaseViews.size() > 0 && i < SendGiftWindow.this.mGiftBaseViews.size() && (currentChildPageData = ((GiftBaseView) SendGiftWindow.this.mGiftBaseViews.get(i)).getCurrentChildPageData()) != null) {
                    for (GiftInfoBean giftInfoBean : currentChildPageData) {
                        if (giftInfoBean.isChecked && giftInfoBean.checkGiftTag(GiftInfoBean.GiftTag.GRAFFITI)) {
                            SendGiftWindow.this.setIndicatorVisibility(0);
                        }
                    }
                }
                if (GiftDataManager.getInstance().getGiftCategoryList().size() > i && (giftCategoryBean = GiftDataManager.getInstance().getGiftCategoryList().get(i)) != null) {
                    SendGiftWindow.this.mCurrentGroupId = giftCategoryBean.groupId;
                    SendGiftWindow.this.mCurrentTitle = giftCategoryBean.name;
                    GiftUTUtils.giftBoardTabClick(SendGiftWindow.this.mCurrentGroupId, SendGiftWindow.this.mCurrentTitle, i, giftCategoryBean.giftInfos);
                }
            }
        });
    ...
    public void updateTheme(GiftTheme giftTheme) {
        ...
        this.mRefreshBtn.setBackground(ThemeUtils.getGradientDrawable(giftTheme.btnGiantStartColor, giftTheme.btnGiantEndColor, GradientDrawable.Orientation.LEFT_RIGHT, 0, 0, (float) (dip2px * 15)));
        this.mPackIndicator.setImageDrawable(ThemeUtils.getDrawable(giftTheme.themeColor, 0, 0, (float) (dip2px * 4)));
