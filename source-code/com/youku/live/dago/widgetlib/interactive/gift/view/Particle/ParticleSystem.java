...
public class ParticleSystem {
    ...
    private void activateParticle(long j) {
        ...
        remove.configure(this.mTimeToLive, (float) getFromRange(this.mEmitterXMin, this.mEmitterXMax), (float) getFromRange(this.mEmitterYMin, this.mEmitterYMax));
    ...
    private boolean hasGravity(int i, int i2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "240581482")) {
            return (i & i2) == i2;
        }
        return ((Boolean) ipChange.ipc$dispatch("240581482", new Object[]{this, Integer.valueOf(i), Integer.valueOf(i2)})).booleanValue();
    }
    ...
    private void onUpdate(long j) {
        ...
        while (true) {
            ...
            if (((j2 <= 0 || j >= j2) && j2 != -1) || this.mParticles.isEmpty() || ((float) this.mActivatedParticles) >= this.mParticlesPerMillisecond * ((float) j)) {
            } else {
                activateParticle(j);
            }
        }
    ...
    private void startAnimator(Interpolator interpolator, long j) {
        ...
        this.mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.Particle.ParticleSystem.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1335005665")) {
                    ipChange.ipc$dispatch("-1335005665", new Object[]{this, valueAnimator});
                    return;
                }
                ParticleSystem.this.onUpdate((long) ((Integer) valueAnimator.getAnimatedValue()).intValue());
            }
        });
        this.mAnimator.addListener(new Animator.AnimatorListener() {
            /* class com.youku.live.dago.widgetlib.interactive.gift.view.Particle.ParticleSystem.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onAnimationCancel(Animator animator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1979808288")) {
                    ipChange.ipc$dispatch("-1979808288", new Object[]{this, animator});
                    return;
                }
            ...
            public void onAnimationEnd(Animator animator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1499758257")) {
                    ipChange.ipc$dispatch("-1499758257", new Object[]{this, animator});
                    return;
                }
                ParticleSystem.this.cleanupAnimation();
            }
            ...
            public void onAnimationRepeat(Animator animator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "333767327")) {
                    ipChange.ipc$dispatch("333767327", new Object[]{this, animator});
                }
            }

            public void onAnimationStart(Animator animator) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "396924648")) {
                    ipChange.ipc$dispatch("396924648", new Object[]{this, animator});
                }
            }
        });
    ...
    public float dpToPx(float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1572086235")) {
            return f * this.mDpToPxScale;
        }
        return ((Float) ipChange.ipc$dispatch("-1572086235", new Object[]{this, Float.valueOf(f)})).floatValue();
    }
    ...
    public void oneShot(View view, int i, Interpolator interpolator) {
        ...
        while (i2 < i && i2 < this.mMaxParticles) {
            activateParticle(0);
            i2++;
        }
        ParticleField particleField = new ParticleField(this.mParentView.getContext());
    ...
    public ParticleSystem setFadeOut(long j) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1108122226")) {
            return setFadeOut(j, new LinearInterpolator());
        }
        return (ParticleSystem) ipChange.ipc$dispatch("-1108122226", new Object[]{this, Long.valueOf(j)});
    }
