...
public class AnimationsContainer {
    ...
    public FramesSequenceAnimation createProgressDialogAnim(ImageView imageView) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1649906825")) {
            return new FramesSequenceAnimation(imageView, this.resArray, this.FPS);
        }
        return (FramesSequenceAnimation) ipChange.ipc$dispatch("-1649906825", new Object[]{this, imageView});
    }
    ...
    public FramesSequenceAnimation createProgressDialogAnim(ImageView imageView, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2072764695")) {
            return new FramesSequenceAnimation(imageView, getData(i), i2);
        }
        return (FramesSequenceAnimation) ipChange.ipc$dispatch("2072764695", new Object[]{this, imageView, Integer.valueOf(i), Integer.valueOf(i2)});
    }
}
