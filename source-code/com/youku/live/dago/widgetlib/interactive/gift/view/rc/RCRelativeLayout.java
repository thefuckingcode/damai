...
public class RCRelativeLayout extends RelativeLayout implements Checkable, RCAttrs {
    ...
    public float getBottomLeftRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-734221057")) {
            return this.mRCHelper.radii[4];
        }
        return ((Float) ipChange.ipc$dispatch("-734221057", new Object[]{this})).floatValue();
    }

    @Override // com.youku.live.dago.widgetlib.interactive.gift.view.rc.RCAttrs
    public float getBottomRightRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "854653316")) {
            return this.mRCHelper.radii[6];
        }
        return ((Float) ipChange.ipc$dispatch("854653316", new Object[]{this})).floatValue();
    }

    @Override // com.youku.live.dago.widgetlib.interactive.gift.view.rc.RCAttrs
    public int getStrokeColor() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1103085409")) {
            return this.mRCHelper.mStrokeColor;
        }
        return ((Integer) ipChange.ipc$dispatch("-1103085409", new Object[]{this})).intValue();
    }

    @Override // com.youku.live.dago.widgetlib.interactive.gift.view.rc.RCAttrs
    public int getStrokeWidth() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1861385380")) {
            return this.mRCHelper.mStrokeWidth;
        }
        return ((Integer) ipChange.ipc$dispatch("-1861385380", new Object[]{this})).intValue();
    }

    @Override // com.youku.live.dago.widgetlib.interactive.gift.view.rc.RCAttrs
    public float getTopLeftRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2058357095")) {
            return this.mRCHelper.radii[0];
        }
        return ((Float) ipChange.ipc$dispatch("-2058357095", new Object[]{this})).floatValue();
    }

    @Override // com.youku.live.dago.widgetlib.interactive.gift.view.rc.RCAttrs
    public float getTopRightRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1538858198")) {
            return this.mRCHelper.radii[2];
        }
        return ((Float) ipChange.ipc$dispatch("-1538858198", new Object[]{this})).floatValue();
    }
    ...
    public boolean isChecked() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1016669072")) {
            return this.mRCHelper.mChecked;
        }
        return ((Boolean) ipChange.ipc$dispatch("1016669072", new Object[]{this})).booleanValue();
    }

    @Override // com.youku.live.dago.widgetlib.interactive.gift.view.rc.RCAttrs
    public boolean isClipBackground() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "520246077")) {
            return this.mRCHelper.mClipBackground;
        }
        return ((Boolean) ipChange.ipc$dispatch("520246077", new Object[]{this})).booleanValue();
    }

    @Override // com.youku.live.dago.widgetlib.interactive.gift.view.rc.RCAttrs
    public boolean isRoundAsCircle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1441769671")) {
            return this.mRCHelper.mRoundAsCircle;
        }
        return ((Boolean) ipChange.ipc$dispatch("1441769671", new Object[]{this})).booleanValue();
    }
