...
public class GestureGiftItemPagerAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void update(@NonNull final GestureGiftWindow gestureGiftWindow, final GiftInfoBean giftInfoBean) {
            if (giftInfoBean != null) {
                ...
                this.containerView.setOnClickListener(new View.OnClickListener() {
                    /* class com.youku.live.dago.widgetlib.interactive.gift.adapter.GestureGiftItemPagerAdapter.GiftItemViewHolder.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    public void onClick(View view) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-1390410652")) {
                            ipChange.ipc$dispatch("-1390410652", new Object[]{this, view});
                            return;
                        }
            ...
            this.containerView.setOnClickListener(new View.OnClickListener() {
                /* class com.youku.live.dago.widgetlib.interactive.gift.adapter.GestureGiftItemPagerAdapter.GiftItemViewHolder.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void onClick(View view) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "720879717")) {
                        ipChange.ipc$dispatch("720879717", new Object[]{this, view});
                    }
                }
            });
        }
    ...
    public int calculateRealPosition(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1968953949")) {
            return (int) (((float) i) / ((float) this.mRowCount));
        }
        return ((Integer) ipChange.ipc$dispatch("1968953949", new Object[]{this, Integer.valueOf(i)})).intValue();
    }
    ...
    public int getItemCount() {
        ...
        float size = ((float) this.mGiftInfoBeans.size()) / ((float) this.mRowCount);
        int i = (int) size;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1156994889")) {
            return new ViewHolder(this.mSelectionManager, LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.dago_pgc_ykl_item_gesture_board, (ViewGroup) null, false), this.mRowCount);
        }
        return (ViewHolder) ipChange.ipc$dispatch("-1156994889", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
}
