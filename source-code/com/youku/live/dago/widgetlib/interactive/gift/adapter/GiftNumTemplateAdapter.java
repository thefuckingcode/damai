...
public class GiftNumTemplateAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        if (list != null && list.size() >= i) {
            ...
            if (giftNumBean != null) {
                ...
                viewHolder.clickView.setOnClickListener(new View.OnClickListener() {
                    /* class com.youku.live.dago.widgetlib.interactive.gift.adapter.GiftNumTemplateAdapter.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    public void onClick(View view) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "605714755")) {
                            ipChange.ipc$dispatch("605714755", new Object[]{this, view});
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1441111155")) {
            return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.dago_pgc_ykl_gift_num_item, (ViewGroup) null));
        }
        return (ViewHolder) ipChange.ipc$dispatch("-1441111155", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
