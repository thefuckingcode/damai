...
public class GiftInfoBean extends BaseInfoBean {
    ...
    public enum GiftTag {
        ...
        private GiftTag(String str) {
            this.tagString = str;
        }

        public static GiftTag toGiftTag(String str) {
            GiftTag[] values = values();
    ...
    public boolean checkGiftTag(GiftTag giftTag) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1146202912")) {
            return ((Boolean) ipChange.ipc$dispatch("1146202912", new Object[]{this, giftTag})).booleanValue();
        }
        return (giftTag.getBit() & this.mGiftTags) > 0;
    }
