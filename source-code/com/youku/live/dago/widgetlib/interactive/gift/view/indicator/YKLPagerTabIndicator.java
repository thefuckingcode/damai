...
public class YKLPagerTabIndicator extends DynamicPagerIndicator {
    ...
    public BasePagerTabView createTabView(Context context, PagerAdapter pagerAdapter, int i) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1650725957")) {
            return new YKLPagerTabView(context);
        }
        return (BasePagerTabView) ipChange.ipc$dispatch("-1650725957", new Object[]{this, context, pagerAdapter, Integer.valueOf(i)});
    }
