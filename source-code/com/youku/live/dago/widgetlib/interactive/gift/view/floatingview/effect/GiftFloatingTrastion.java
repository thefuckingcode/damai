    ...
    public void applyFloating(final YumFloating yumFloating) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1083015307")) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                /* class com.youku.live.dago.widgetlib.interactive.gift.view.floatingview.effect.GiftFloatingTrastion.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1980556913")) {
                        ipChange.ipc$dispatch("-1980556913", new Object[]{this, valueAnimator});
                        return;
                    }
            ...
            ofFloat.addListener(new AnimatorListenerAdapter() {
                /* class com.youku.live.dago.widgetlib.interactive.gift.view.floatingview.effect.GiftFloatingTrastion.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void onAnimationEnd(Animator animator) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1249615039")) {
                        ipChange.ipc$dispatch("1249615039", new Object[]{this, animator});
                        return;
                    }
            ...
            ofFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                /* class com.youku.live.dago.widgetlib.interactive.gift.view.floatingview.effect.GiftFloatingTrastion.AnonymousClass3 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-719639663")) {
                        ipChange.ipc$dispatch("-719639663", new Object[]{this, valueAnimator});
                        return;
                    }
