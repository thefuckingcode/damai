...
public class TargetListAdapter extends RecyclerView.Adapter<TargetItemHolder> implements View.OnClickListener {
    ...
    public List<GiftTargetInfoBean> getData() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "676384489")) {
            return this.mData;
        }
        return (List) ipChange.ipc$dispatch("676384489", new Object[]{this});
    }
    ...
    public GiftTargetInfoBean getSelectedItem() {
        ...
        List<GiftTargetInfoBean> list = this.mData;
        if (list == null || list.size() <= (i = this.mSelectedPosition)) {
            return null;
        }
    ...
    public TargetItemHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2042615560")) {
            return new TargetItemHolder(LayoutInflater.from(this.mContext).inflate(R.layout.dago_pgc_ykl_target_item, viewGroup, false));
        }
        return (TargetItemHolder) ipChange.ipc$dispatch("-2042615560", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
