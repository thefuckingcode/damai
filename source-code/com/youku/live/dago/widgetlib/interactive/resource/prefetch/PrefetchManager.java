...
public class PrefetchManager {
    ...
    private static boolean hasContent(Config config, ResourceEntity resourceEntity) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1644997156")) {
            return ((Boolean) ipChange.ipc$dispatch("-1644997156", new Object[]{config, resourceEntity})).booleanValue();
        } else if (!hasContent(resourceEntity) || config == null || config.getConfigItems() == null || config.getConfigItems().size() != resourceEntity.resourceList.size()) {
            return false;
        } else {
            return true;
        }
    ...
    private static boolean hasContent(ResourceEntity resourceEntity) {
        ...
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-815695748")) {
            return ((Boolean) ipChange.ipc$dispatch("-815695748", new Object[]{resourceEntity})).booleanValue();
        }
        return (resourceEntity == null || (list = resourceEntity.resourceList) == null || list.size() <= 0) ? false : true;
    }
    ...
    public static Config getResourceConfig(String str) {
        ...
        } else if (getInstance().mConfigFetchers == null || getInstance().mConfigFetchers.get(str) == null) {
            return null;
        } else {
