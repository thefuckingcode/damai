...
public class Config {
    ...
    public List<ResourceEntity.Resource> getConfigItems() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "67957931")) {
            return this.mConfigItemList;
        }
        return (List) ipChange.ipc$dispatch("67957931", new Object[]{this});
    }

    public String getNamespace() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "913285121")) {
            return this.mNamespace;
        }
        return (String) ipChange.ipc$dispatch("913285121", new Object[]{this});
    }
