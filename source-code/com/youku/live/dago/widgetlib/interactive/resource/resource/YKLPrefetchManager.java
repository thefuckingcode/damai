...
public class YKLPrefetchManager {
    ...
    public ResourceEntity.Resource getResourceConfig(String str, String str2) {
        ...
        } else if (getInstance().mConfigFetchers.get(str) == null || getInstance().mConfigFetchers.get(str).onFetchingStart() == null) {
            return null;
        } else {
    ...
    public boolean hasContent(String str, Config config, ResourceEntity resourceEntity) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "482135431")) {
            ...
            if (!hasContent(resourceEntity) || config == null || config.getConfigItems() == null || config.getConfigItems().size() > resourceEntity.resourceList.size()) {
                return false;
            }
            return true;
        }
    ...
    public Config getResourceConfig(String str) {
        ...
        } else if (getInstance().mConfigFetchers.get(str) != null) {
    ...
    public boolean hasContent(ResourceEntity resourceEntity) {
        ...
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1829292835")) {
            return ((Boolean) ipChange.ipc$dispatch("-1829292835", new Object[]{this, resourceEntity})).booleanValue();
        }
    ...
    public void loadResources(String str, String str2, OnResourcesGetListener onResourcesGetListener) {
        ...
        if (!hasContent(str2, config, findCache)) {
            ...
            } else if (ResourceOrangeUtils.isDownLoadResource()) {
