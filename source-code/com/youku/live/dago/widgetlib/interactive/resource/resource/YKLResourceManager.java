...
public class YKLResourceManager {
    ...
    private void init(final String str) {
        ...
        if (this.mHasInited) {
            ...
            YKLPrefetchManager.getInstance().registerConfigFetcher(str, new ConfigFetcher() {
                /* class com.youku.live.dago.widgetlib.interactive.resource.resource.YKLResourceManager.AnonymousClass1 */
                ...
                public Config onFetchingStart() {
                    IpChange ipChange = $ipChange;
                    if (!AndroidInstantRuntime.support(ipChange, "-385023420")) {
                        return YKLResourceManager.this.getConfig(str);
                    }
                    return (Config) ipChange.ipc$dispatch("-385023420", new Object[]{this});
                }
            });
        }
    }
    ...
    private void loadResource(String str, String str2) {
        ...
        YKLPrefetchManager.getInstance().loadResources(str, str2, new OnResourcesGetListener() {
            /* class com.youku.live.dago.widgetlib.interactive.resource.resource.YKLResourceManager.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onBatchResoucesFinish(ResourceEntity resourceEntity) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "438704867")) {
                    ipChange.ipc$dispatch("438704867", new Object[]{this, resourceEntity});
                }
            }
            ...
            public void onResourceGet(ResourceEntity resourceEntity) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1235946541")) {
                    ipChange.ipc$dispatch("-1235946541", new Object[]{this, resourceEntity});
                }
            }
        });
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private ResourceEntity.Resource parseResource(JSONObject jSONObject) {
        IpChange ipChange = $ipChange;
    ...
    private void reloadResouce(final String str) {
        ...
        if (resourceConfig == null || resourceConfig.uri == null) {
            ...
            HttpUtils.getResourceById(ContextUtil.getApplicationContext(), this.mAppId, str, new MtopCallback.MtopFinishListener() {
                /* class com.youku.live.dago.widgetlib.interactive.resource.resource.YKLResourceManager.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // mtopsdk.mtop.common.MtopCallback.MtopFinishListener
                public void onFinished(MtopFinishEvent mtopFinishEvent, Object obj) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "633144939")) {
                        ipChange.ipc$dispatch("633144939", new Object[]{this, mtopFinishEvent, obj});
                        return;
                    }
