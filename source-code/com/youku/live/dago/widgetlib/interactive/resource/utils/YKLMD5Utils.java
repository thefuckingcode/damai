...
public class YKLMD5Utils {
    ...
    private static final char[] DIGITS_UPPER = {YKUpsConvert.CHAR_ZERO, '1', '2', '3', '4', '5', '6', '7', '8', YKUpsConvert.CHAR_NINE, YKUpsConvert.CHAR_A, 'B', 'C', u91.LEVEL_D, u91.LEVEL_E, YKUpsConvert.CHAR_F};

    public static char[] encodeHex(byte[] bArr) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-436770933")) {
            return encodeHex(bArr, true);
        }
        return (char[]) ipChange.ipc$dispatch("-436770933", new Object[]{bArr});
    }
