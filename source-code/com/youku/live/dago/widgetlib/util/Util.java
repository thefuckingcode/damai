...
public class Util {
    ...
    private static final ArrayList<String> userpics = new ArrayList<String>() {
        /* class com.youku.live.dago.widgetlib.util.Util.AnonymousClass1 */
    ...
    public static int Dp2Px(Context context, float f) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-863587676")) {
            return (int) ((f * context.getResources().getDisplayMetrics().density) + 0.5f);
        }
        return ((Integer) ipChange.ipc$dispatch("-863587676", new Object[]{context, Float.valueOf(f)})).intValue();
    }
    ...
    public static String[] FormatLeftTime2(long j) {
        ...
        int i = (int) (j / ((long) 86400));
        long j2 = j - ((long) (86400 * i));
        int i2 = ((int) j2) / ACache.TIME_HOUR;
        long j3 = j2 - ((long) (i2 * ACache.TIME_HOUR));
        int i3 = ((int) j3) / 60;
        return new String[]{String.valueOf(i), String.valueOf(i2), String.valueOf(i3), String.valueOf((int) (j3 - ((long) (i3 * 60))))};
    }
    ...
    public static String FormatLeftTimeToString(long j) {
        ...
        long j3 = j2 - ((long) (i * ACache.TIME_HOUR));
        int i2 = ((int) j3) / 60;
        return String.format(i >= 100 ? "%d:%02d:%02d" : "%02d:%02d:%02d", Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(Math.round((float) (j3 - ((long) (i2 * 60))))));
    }
    ...
    public static String[] FormatLeftTimeToStrings(long j) {
        ...
        long j3 = j2 - ((long) (i2 * ACache.TIME_HOUR));
        int i3 = ((int) j3) / 60;
        return new String[]{String.format(TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i)), String.format(TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i2)), String.format(TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i3)), String.format(TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf((int) (j3 - ((long) (i3 * 60)))))};
    }
    ...
    public static String FormatMinmsTimeToString(long j) {
        ...
        long j2 = j - ((long) 0);
        int i = ((int) j2) / 60;
        return String.format("%02d:%02d", Integer.valueOf(i), Integer.valueOf((int) (j2 - ((long) (i * 60)))));
    }
    ...
    public static Date ParserDate(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "794746327")) {
            return new Date(((long) Integer.parseInt(str)) * 1000);
        }
        return (Date) ipChange.ipc$dispatch("794746327", new Object[]{str});
    }
    ...
    public static String formatNumber(String str) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1586458605")) {
            return (String) ipChange.ipc$dispatch("-1586458605", new Object[]{str});
        }
    ...
    public static String getLiveId(Context context) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-125847422")) {
            return (String) ipChange.ipc$dispatch("-125847422", new Object[]{context});
        } else if (context != null) {
            return context.getSharedPreferences(LiveVideosharePreferences, 0).getString("carouselLiveId", "");
        } else {
            return "";
        }
    }
    ...
    public static int isTodayOrTomorrow(long j) {
        ...
        if (instance2.get(1) == instance.get(1)) {
            int i = instance2.get(6) - instance.get(6);
            if (i == 0) {
                return 1;
            }
            if (i == 1) {
    ...
    public static Date ParserDate(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1744901398")) {
            return new Date(((long) i) * 1000);
        }
        return (Date) ipChange.ipc$dispatch("-1744901398", new Object[]{Integer.valueOf(i)});
    }
    ...
    public static String formatNumber(long j) {
        ...
        if (j < 10000) {
            ...
            String format = decimalFormat.format(((double) j) / 10000.0d);
            return format + "万";
        } else {
            String format2 = decimalFormat.format(((double) j) / 1.0E8d);
            return format2 + "亿";
        }
    }
}
