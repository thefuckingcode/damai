...
public class YKLDownloadModule extends WXModule {
    ...
    private YKLDownloadProtocol getAdapter() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "762704169")) {
            return (YKLDownloadProtocol) YKLAdapterFactory.getInstance().createInterface(YKLDownloadModule.class);
        }
        return (YKLDownloadProtocol) ipChange.ipc$dispatch("762704169", new Object[]{this});
    }
    ...
    public void checkList(Object obj, final JSCallback jSCallback) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "835628785")) {
            ...
            this.adapter.download(this.adapter.checkResourceList(cast2List), new IDownloadCallback() {
                /* class com.youku.live.dago.widgetlib.module.YKLDownloadModule.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dago.widgetlib.wedome.adapter.download.IDownloadCallback
                public void onFailure(int i, String str, String str2) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-566930354")) {
                        ipChange.ipc$dispatch("-566930354", new Object[]{this, Integer.valueOf(i), str, str2});
                ...
                public void onSuccess(int i, String str, String str2) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1019000263")) {
                        ipChange.ipc$dispatch("1019000263", new Object[]{this, Integer.valueOf(i), str, str2});
                    } else if (jSCallback != null) {
                        HashMap hashMap = new HashMap();
                        hashMap.put("code", Integer.valueOf(i));
                        hashMap.put("msg", str2);
