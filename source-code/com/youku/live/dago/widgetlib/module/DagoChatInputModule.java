...
public class DagoChatInputModule extends WXModule implements IDataHandler {
    ...
    private DagoInputBoxDialog.OnInputDialogShowListener inputDialogShowListener = new DagoInputBoxDialog.OnInputDialogShowListener() {
        /* class com.youku.live.dago.widgetlib.module.DagoChatInputModule.AnonymousClass2 */
    ...
    private void asyncPutDataAdrKeyboardHeight(int i) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setResult(JSCallback jSCallback, String str, String str2, boolean z) {
        IpChange ipChange = $ipChange;
    ...
    public void onDataChanged(String str, Object obj, Object obj2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "2006422061")) {
            ...
            if (((Integer) map.get("isShow")).intValue() == 1) {
                z = true;
            }
            ...
            if (z || (iDagoInputBox = this.mDagoInputBox) == null || iDagoInputBox.isShowExpressionPanel() || !this.mDagoInputBox.canClose()) {
                int screenHeight = (int) (((float) UIUtil.getScreenHeight(AppContextUtils.getApp())) * 0.8f);
                ...
                if (iDagoInputBox2 != null) {
                    iDagoInputBox2.updatePanelContainerHeight(DagoInputBoxUtils.getKeyboardHeight());
                    return;
                }
                return;
            }
            ...
            if (!(iDagoInputBox3 == null || this.mCallback == null)) {
                if (TextUtils.isEmpty(iDagoInputBox3.getInputText())) {
                    str2 = "";
                } else {
                    str2 = this.mDagoInputBox.getInputText().toString();
                }
                setResult(this.mCallback, "cancel", str2, this.mDagoInputBox.useBarrage());
            }
    ...
    public void open(Map<String, Object> map, final JSCallback jSCallback) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1800257395")) {
            ...
            try {
                ...
                this.mDagoInputBox.setOnInputBoxListener(new OnInputBoxListener() {
                    /* class com.youku.live.dago.widgetlib.module.DagoChatInputModule.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;
                    ...
                    public void onChangeExpressionPanel(boolean z) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "1246104104")) {
                            ipChange.ipc$dispatch("1246104104", new Object[]{this, Boolean.valueOf(z)});
                        } else if (z) {
                    ...
                    public void onDismiss() {
                        String str;
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-1660390754")) {
                            ipChange.ipc$dispatch("-1660390754", new Object[]{this});
                            return;
                        }
                        if (DagoChatInputModule.this.mDagoInputBox != null) {
                            if (TextUtils.isEmpty(DagoChatInputModule.this.mDagoInputBox.getInputText())) {
                                str = "";
                            } else {
                                str = DagoChatInputModule.this.mDagoInputBox.getInputText().toString();
                            }
                            DagoChatInputModule dagoChatInputModule = DagoChatInputModule.this;
                            dagoChatInputModule.setResult(jSCallback, "cancel", str, dagoChatInputModule.mDagoInputBox.useBarrage());
                        }
                    ...
                    public void onSendMessage(String str) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-1007068749")) {
                            ipChange.ipc$dispatch("-1007068749", new Object[]{this, str});
