...
public class DagoPrivateChatModule extends WXModule implements Destroyable, IDataHandler {
    ...
    public void open(Map<String, Object> map, JSCallback jSCallback) {
        ...
        IEngineInstance widgetEngineInstance = WeexHelper.getWidgetEngineInstance(this);
        String str2 = "";
        String valueOf = (map == null || map.size() <= 0 || !map.containsKey("id")) ? str2 : String.valueOf(map.get("id"));
        if (widgetEngineInstance != null) {
            ...
            if (options != null) {
                String string = options.getString("pagename", str2);
                str = options.getString("spm-cnt", str2);
                str2 = string;
            } else {
                str = str2;
            }
