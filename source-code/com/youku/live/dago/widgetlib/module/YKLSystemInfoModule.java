...
public class YKLSystemInfoModule extends WXModule implements Destroyable, IDataHandler {
    ...
    private int getDeviceScore() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1324210443")) {
            return ((IDynamicConfig) Dsl.getService(IDynamicConfig.class)).getInt("device", IDynamicConfig.KEY_DEVICE_SCORE, -1);
        }
        return ((Integer) ipChange.ipc$dispatch("1324210443", new Object[]{this})).intValue();
    }
    ...
    public void getDeviceLevel(JSCallback jSCallback) {
        ...
        if (deviceScore < 85) {
            i = deviceScore >= 60 ? 2 : deviceScore >= 0 ? 3 : 0;
        }
