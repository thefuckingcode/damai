...
public class YKLGiftBoardComponent extends ProxyWXComponent<View> {
    ...
    private boolean showTargetDetails = false;
    private Map<String, Object> spm;
    private String starCoins = "0";
    private GiftTheme theme = null;
    private String uCoins = "0";
                            ...
                            for (int i2 = 0; i2 < jSONArray.size(); i2++) {
                                ...
                                if (jSONObject2 != null) {
                                    ...
                                    if (parseObject != null) {
                                        ...
                                        for (GiftInfoBean.GiftTag giftTag : values) {
    ...
    private void closeCallback(Map<String, Object> map) {
        IpChange ipChange = $ipChange;
    ...
    private GiftPropBean fetchPropJson(JSONObject jSONObject) {
        ...
        if (jSONObject.containsKey("propType")) {
            i = jSONObject.getInteger("propType").intValue();
        }
        giftPropBean.propType = i;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private String generateTargetInfo(List<GiftTargetInfoBean> list) {
        IpChange ipChange = $ipChange;
    ...
    private YKLGiftBoardProtocol getAdapter(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1525987565")) {
            return (YKLGiftBoardProtocol) YKLAdapterFactory.getInstance().createInterface(YKLGiftBoardComponent.class, context);
        }
        return (YKLGiftBoardProtocol) ipChange.ipc$dispatch("1525987565", new Object[]{this, context});
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private Map<String, Object> getArgs(GiftPropBean giftPropBean) {
        IpChange ipChange = $ipChange;
    ...
    private void initAttrs() {
        ...
        if (!(getBasicComponentData() == null || getBasicComponentData().getAttrs() == null)) {
            ...
            if ("true".equals((String) getBasicComponentData().getAttrs().get("multipleTargets")) || getBasicComponentData().getAttrs().get("multipleTargets") == null) {
                z = true;
            }
            this.hasMultipleTargets = z;
        ...
        if (yKLGiftBoardProtocol != null) {
            ...
            this.mYKLGiftBoardProtocol.setCallback(new IGiftBoardCallback() {
                /* class com.youku.live.dago.widgetlib.component.YKLGiftBoardComponent.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dago.widgetlib.interactive.gift.callback.IGiftBoardCallback
                public void clickLink(String str) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1535522718")) {
                        ipChange.ipc$dispatch("-1535522718", new Object[]{this, str});
                    }
                }
                ...
                public void close(Map<String, Object> map) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1069139901")) {
                        ipChange.ipc$dispatch("-1069139901", new Object[]{this, map});
                        return;
                    }
                ...
                public void morePropBtnClick() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "814642764")) {
                        ipChange.ipc$dispatch("814642764", new Object[]{this});
                ...
                public void onDoMission(GiftPropBean giftPropBean) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-589255954")) {
                        ipChange.ipc$dispatch("-589255954", new Object[]{this, giftPropBean});
                ...
                public void onGestureBoardAppear() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1384007519")) {
                        ipChange.ipc$dispatch("1384007519", new Object[]{this});
                        return;
                    }
                ...
                public void onGestureBoardDisappear() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "2104585971")) {
                        ipChange.ipc$dispatch("2104585971", new Object[]{this});
                        return;
                    }
                ...
                public void onRecharge() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1866746198")) {
                        ipChange.ipc$dispatch("-1866746198", new Object[]{this});
                        return;
                    }
                ...
                public void onSendGestureGift(int i, int i2, List<GestureGiftWindow.Coord> list, long j, List<GiftTargetInfoBean> list2) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1019474980")) {
                        ipChange.ipc$dispatch("-1019474980", new Object[]{this, Integer.valueOf(i), Integer.valueOf(i2), list, Long.valueOf(j), list2});
                        return;
                    }
                    HashMap hashMap = new HashMap();
                    ...
                    jSONObject2.put("canvas", (Object) (((float) i) + jl1.MUL + ((float) i2)));
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        ...
                        sb.append(coord.y);
                        sb.append(",");
                        sb.append(coord.giftInfoBean.id);
                    }
                    jSONObject2.put("points", (Object) sb.toString());
                ...
                public void onSendGift(long j, GiftInfoBean giftInfoBean, List<GiftTargetInfoBean> list) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1052301543")) {
                        ipChange.ipc$dispatch("1052301543", new Object[]{this, Long.valueOf(j), giftInfoBean, list});
                ...
                public void onSendProp(long j, GiftPropBean giftPropBean, List<GiftTargetInfoBean> list) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1558120581")) {
                        ipChange.ipc$dispatch("1558120581", new Object[]{this, Long.valueOf(j), giftPropBean, list});
                        return;
                    }
                ...
                public void openExchangeBroad() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "294367333")) {
                        ipChange.ipc$dispatch("294367333", new Object[]{this});
                        return;
                    }
                ...
                public void openUserCard(String str) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-54874027")) {
                        ipChange.ipc$dispatch("-54874027", new Object[]{this, str});
                        return;
                    }
                ...
                public void refresh(boolean z) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-126483275")) {
                        ipChange.ipc$dispatch("-126483275", new Object[]{this, Boolean.valueOf(z)});
                    } else if (z) {
                ...
                public void switchToProp(boolean z) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1794210134")) {
                        ipChange.ipc$dispatch("1794210134", new Object[]{this, Boolean.valueOf(z)});
                    } else if (z) {
                        YKLGiftBoardComponent.this.packTabCallback();
                    }
                }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void openExchangeBroadCallBack() {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void openUserCardCallback(Map<String, Object> map) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void packTipCallback(Map<String, Object> map) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void sendGiftCallback(Map<String, Object> map) {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void sendPropCallback(Map<String, Object> map) {
        IpChange ipChange = $ipChange;
    ...
    public void setGiftList(Object obj) {
        ...
        if (ConfigManager.q.equals(lh2.a("debug.laifeng.gift.test_gift_list")) && (obj == null || obj.equals("[]"))) {
            obj = TEST_GIFT_LIST;
        }
        if (obj != null) {
    ...
    private YKLGiftBoardProtocol getAdapter(Context context, String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-693087177")) {
            return (YKLGiftBoardProtocol) YKLAdapterFactory.getInstance().createInterface(YKLGiftBoardComponent.class, context, str, false);
        }
        return (YKLGiftBoardProtocol) ipChange.ipc$dispatch("-693087177", new Object[]{this, context, str});
    }
