...
public class DagoUserCardDialog extends Dialog {
    ...
    private boolean isLinkLiving = false;
    private volatile boolean isVideosRequesting = false;
    private String mAnchorId = "";
    private Handler mHandler = new Handler(Looper.getMainLooper()) {
        /* class com.youku.live.dago.widgetlib.component.DagoUserCardDialog.AnonymousClass1 */
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 257) {
                ...
                if (DataUtils.getLongNumberFromString(DagoUserCardDialog.this.mTargetUserId) <= 0) {
                    ...
                    DagoUserCardView dagoUserCardView = DagoUserCardDialog.this.mUserCardView;
                    UserCardTabInfo userCardTabInfo = DagoUserCardDialog.this.mUserCardTabInfo;
                    if (DagoUserCardDialog.this.mUserCardTabInfo.userCardVO == null || DagoUserCardDialog.this.mUserCardTabInfo.userCardVO.ytid <= 0) {
                        z = false;
                    }
                    dagoUserCardView.updateUserCardInfo(userCardTabInfo, z);
                }
    ...
    private UserCardApi.UserCardInfoListener userCardInfoListener = new UserCardApi.UserCardInfoListener() {
        /* class com.youku.live.dago.widgetlib.component.DagoUserCardDialog.AnonymousClass2 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private DagoUserCardView.OnUserCardListener userCardListener = new DagoUserCardView.OnUserCardListener() {
        /* class com.youku.live.dago.widgetlib.component.DagoUserCardDialog.AnonymousClass3 */
        private static transient /* synthetic */ IpChange $ipChange;
        ...
        @Override // com.youku.live.dago.widgetlib.view.usercard.DagoUserCardView.OnUserCardListener
        public void onPrivateChatClicked(long j, boolean z) {
            IpChange ipChange = $ipChange;
            if (AndroidInstantRuntime.support(ipChange, "832114476")) {
                ipChange.ipc$dispatch("832114476", new Object[]{this, Long.valueOf(j), Boolean.valueOf(z)});
                return;
            }
    ...
    private boolean isShowLiveManageBtn(LiveUserInfoData.InfoData infoData) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "124290581")) {
        ...
        } else if (infoData == null || this.mOperateUserId == null) {
            return false;
        } else {
            ...
            if (this.mIsActor || this.mOperateUserId.equals(this.mTargetUserId) || (!LiveManageController.isManager(infoData.operateUserRoles) && !LiveManageController.isActor(infoData.operateUserRoles))) {
                return false;
            }
            return true;
        }
    ...
    private void requestUserStatus() {
        ...
        if (liveManageController != null) {
            ...
            this.mLiveManageController.requestUserStatus(new INetCallback() {
                /* class com.youku.live.dago.widgetlib.component.DagoUserCardDialog.AnonymousClass4 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.network.INetCallback
                public void onFinish(INetResponse iNetResponse) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "991261908")) {
                        ipChange.ipc$dispatch("991261908", new Object[]{this, iNetResponse});
                        ...
                        try {
                            ...
                            if (liveUserInfoDataResponse != null && liveUserInfoDataResponse.data != null && DagoUserCardDialog.this.mUserCardView != null) {
                                DagoUserCardDialog dagoUserCardDialog = DagoUserCardDialog.this;
                                dagoUserCardDialog.mLiveUserInfoData = liveUserInfoDataResponse.data.data;
