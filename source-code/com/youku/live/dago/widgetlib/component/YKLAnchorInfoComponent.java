...
public class YKLAnchorInfoComponent extends ProxyWXComponent<View> {
    ...
    public void onHostViewInitialized(View view) {
        ...
        if (dagoAnchorInfoView != null) {
            ...
            this.mAnchorInfoView.setAnchorCallback(new DagoAnchorInfoView.AnchorCallback() {
                /* class com.youku.live.dago.widgetlib.component.YKLAnchorInfoComponent.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dago.widgetlib.view.anchor.DagoAnchorInfoView.AnchorCallback
                public void onAttentionClick() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1207265644")) {
                        ipChange.ipc$dispatch("-1207265644", new Object[]{this});
                        return;
                    }
                ...
                public void onAvatarClick() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1293254557")) {
                        ipChange.ipc$dispatch("1293254557", new Object[]{this});
                        return;
                    }
