...
public class DagoChatListComponent extends ProxyWXComponent<View> implements OnCellClickListener, IDataHandler {
    ...
    private void parseWXAttr(WXAttr wXAttr) {
        ...
        String str = null;
        String str2 = wXAttr.containsKey("limit") ? (String) wXAttr.get("limit") : null;
        String str3 = wXAttr.containsKey("newMsgTipTextColor") ? (String) wXAttr.get("newMsgTipTextColor") : null;
        String str4 = wXAttr.containsKey("newMsgTipBgColor") ? (String) wXAttr.get("newMsgTipBgColor") : null;
        String str5 = wXAttr.containsKey("newMsgTipBorderColor") ? (String) wXAttr.get("newMsgTipBorderColor") : null;
        String str6 = wXAttr.containsKey("topMaskHeightScale") ? (String) wXAttr.get("topMaskHeightScale") : null;
        if (wXAttr.containsKey("topMaskStartAlpha")) {
            str = (String) wXAttr.get("topMaskStartAlpha");
        }
        int i = 14;
        ...
        if (iDagoChatListView != null) {
            iDagoChatListView.setLimitSize(str2);
            this.mChatListView.setFontSize(i);
            this.mChatListView.setNewMsgTipStyle(str3, str4, str5, str6, str);
        }
    }
