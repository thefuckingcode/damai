...
public class DagoYoukuVipHongbaoComponent extends ProxyWXComponent<View> implements IDataHandler {
    ...
    private void initAttrs(final Context context) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-830976154")) {
            ...
            this.mDagoHongbaoView.setIListener(new DagoVipHongbaoView.IListener() {
                /* class com.youku.live.dago.widgetlib.component.DagoYoukuVipHongbaoComponent.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dago.widgetlib.view.hongbao.DagoVipHongbaoView.IListener
                public void onClick() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-245952162")) {
                        ipChange.ipc$dispatch("-245952162", new Object[]{this});
                        return;
                    }
            ...
            this.mHongbaoHelper.setCallback(new DagoVipHongbaoHelper.ICallback() {
                /* class com.youku.live.dago.widgetlib.component.DagoYoukuVipHongbaoComponent.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;
                ...
                public void onAttentionChange(boolean z) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-137448099")) {
                        ipChange.ipc$dispatch("-137448099", new Object[]{this, Boolean.valueOf(z)});
                ...
                public void onHongbaoFinish() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1067339490")) {
                        ipChange.ipc$dispatch("1067339490", new Object[]{this});
                        return;
                    }
