...
public class AILPLikeViewComponent extends ProxyWXComponent<View> implements IDataHandler {
    ...
    private AILPLikeViewProtocol getAdapter(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1710300541")) {
            return (AILPLikeViewProtocol) AILPAdapterFactory.getInstance().createInterface(AILPLikeViewComponent.class, context);
        }
        return (AILPLikeViewProtocol) ipChange.ipc$dispatch("-1710300541", new Object[]{this, context});
    }
