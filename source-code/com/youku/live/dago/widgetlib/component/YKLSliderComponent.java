...
public class YKLSliderComponent extends ViewPager {
    ...
    public androidx.viewpager.widget.ViewPager getViewPapar() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1514402788")) {
            return (androidx.viewpager.widget.ViewPager) getRealView();
        }
        return (androidx.viewpager.widget.ViewPager) ipChange.ipc$dispatch("1514402788", new Object[]{this});
    }
