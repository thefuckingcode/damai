...
public class DagoPlayerInteract extends WXModule implements View.OnClickListener, Destroyable {
    ...
    private int createElementsByType(Context context, IDagoLivePlaybackInjectorInterface iDagoLivePlaybackInjectorInterface, String str, boolean z, int i, List<PlayerInteract.Controller> list, View.OnClickListener onClickListener) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1871657987")) {
            ...
            if (injectedViewsMap.containsKey(str)) {
                map = injectedViewsMap.get(str);
            }
            if (map == null) {
                map = new HashMap<>();
    ...
    private IDagoLivePlaybackInjectorInterface getInjector() {
        ...
        IDagoLivePlaybackInjectorInterface iDagoLivePlaybackInjectorInterface2 = null;
        ...
        if (widgetEngineInstance != null) {
            ...
            if (findWidgetById instanceof IDagoLivePlaybackInjectorInterface) {
                iDagoLivePlaybackInjectorInterface2 = (IDagoLivePlaybackInjectorInterface) findWidgetById;
            }
            if (iDagoLivePlaybackInjectorInterface2 == null && (findWidgetsByName = widgetEngineInstance.findWidgetsByName(AlixLivePlayback.WIDGET_NAME)) != null) {
                ...
                while (true) {
                    ...
                    if (next instanceof IDagoLivePlaybackInjectorInterface) {
                        iDagoLivePlaybackInjectorInterface2 = (IDagoLivePlaybackInjectorInterface) next;
                        break;
                    }
                }
            }
        }
        this.mInjector = iDagoLivePlaybackInjectorInterface2;
        return iDagoLivePlaybackInjectorInterface2;
    }
                            ...
                            if (dagoAnchorInfoView.getLayoutParams() != null) {
                                if (dagoAnchorInfoView.getContext() != null) {
                                    if (!content6.showFollowBtn) {
                                        i2 = UnitUtil.dp2px(dagoAnchorInfoView.getContext(), 112);
                                    } else {
                                        i2 = UnitUtil.dp2px(dagoAnchorInfoView.getContext(), UNIT_ANCHOR_INFO_WIDTH);
                                    }
                                    int i3 = (int) (((float) i2) + 0.5f);
                                    ((ILog) Dsl.getService(ILog.class)).i("liulei-anchor", "refresh 1111   " + i3);
                                    dagoAnchorInfoView.getLayoutParams().width = i3;
                                ...
                                if (!content6.showFollowBtn) {
                                    i = UnitUtil.dp2px(dagoAnchorInfoView.getContext(), 112);
                                } else {
                                    i = UnitUtil.dp2px(dagoAnchorInfoView.getContext(), UNIT_ANCHOR_INFO_WIDTH);
                                }
                                int i4 = (int) (((float) i) + 0.5f);
                                ((ILog) Dsl.getService(ILog.class)).i("liulei-anchor", "refresh 2222 = " + i4);
                                ViewGroup.LayoutParams layoutParams2 = controller.layoutParams;
                                if (layoutParams2 != null) {
                                    layoutParams2.width = i4;
                                }
                                dagoAnchorInfoView.setLayoutParams(new LinearLayout.LayoutParams(i4, (int) (((float) UnitUtil.dp2px(dagoAnchorInfoView.getContext(), 36)) + 0.5f)));
                            }
    ...
    private boolean setInjectedViews(String str, String str2, View view) {
        ...
        } else if (str == null || str2 == null || view == null) {
            return false;
        } else {
            Map<String, Map<String, View>> injectedViewsMap = getInjectedViewsMap();
            Map<String, View> map = null;
    ...
    public void addSeiEvent(final JSCallback jSCallback) {
        ...
        if (injector != null) {
            injector.injectorSetSeiEventListener(new IDagoLivePlaybackInjectorInterface.IResultListener() {
                /* class com.youku.live.dago.module.DagoPlayerInteract.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.widgets.IDagoLivePlaybackInjectorInterface.IResultListener
                public void onResult(Map<String, Object> map) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1869975378")) {
                        ipChange.ipc$dispatch("1869975378", new Object[]{this, map});
                        return;
                    }
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:7:0x0029 */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v9, types: [android.widget.RelativeLayout, com.youku.live.dago.widgetlib.view.anchor.DagoAnchorInfoView] */
    ...
    /* JADX WARN: Type inference failed for: r0v28, types: [android.widget.RelativeLayout, com.youku.live.dago.view.dagocustomelement.PopImageLayout] */
    ...
    public View createElementByType(Context context, String str, PlayerInteract.Controller controller, View.OnClickListener onClickListener) {
        ...
        if (!(str == null || controller == null)) {
            if (ELEMENT_CUSTOM_IMAGE.equals(str)) {
                controller.layoutParams = new LinearLayout.LayoutParams((int) (((float) UnitUtil.dp2px(context, controller.current.width)) + 0.5f), (int) (((float) UnitUtil.dp2px(context, controller.current.height)) + 0.5f));
                ...
                if (ELEMENT_POP_IMAGE.equals(str)) {
                    int i2 = controller.current.width;
                    if (i2 <= 0) {
                        i2 = 32;
                    }
                    int dp2px = (int) (((float) UnitUtil.dp2px(context, i2)) + 0.5f);
                    int i3 = controller.current.height;
                    if (i3 > 0) {
                        i = i3;
                    }
                    controller.layoutParams = new LinearLayout.LayoutParams(dp2px, (int) (((float) UnitUtil.dp2px(context, i)) + 0.5f));
                    ...
                    controller.layoutParams = new LinearLayout.LayoutParams((int) (((float) UnitUtil.dp2px(context, 32)) + 0.5f), (int) (((float) UnitUtil.dp2px(context, 32)) + 0.5f));
                    ?? imageView2 = new ImageView(context);
                    imageView2.setTag(R.id.dago_interact_controller, controller);
                    imageView2.setOnClickListener(onClickListener);
                    userListView = imageView2;
                } else if ("text".equals(str)) {
                    controller.layoutParams = new LinearLayout.LayoutParams(-2, (int) (((float) UnitUtil.dp2px(context, 28)) + 0.5f));
                    ...
                    controller.layoutParams = new LinearLayout.LayoutParams((int) (((float) UnitUtil.dp2px(context, UNIT_ANCHOR_INFO_WIDTH)) + 0.5f), (int) (((float) UnitUtil.dp2px(context, 36)) + 0.5f));
                    ...
                    dagoAnchorInfoView.setAnchorCallback(new DagoAnchorInfoView.AnchorCallback() {
                        /* class com.youku.live.dago.module.DagoPlayerInteract.AnonymousClass3 */
                        private static transient /* synthetic */ IpChange $ipChange;

                        @Override // com.youku.live.dago.widgetlib.view.anchor.DagoAnchorInfoView.AnchorCallback
                        public void onAttentionClick() {
                            IpChange ipChange = $ipChange;
                            if (AndroidInstantRuntime.support(ipChange, "-1767921657")) {
                                ipChange.ipc$dispatch("-1767921657", new Object[]{this});
                                return;
                            }
                            DagoAnchorInfoView dagoAnchorInfoView = dagoAnchorInfoView;
                            if (dagoAnchorInfoView != null) {
                                ...
                                if (tag instanceof PlayerInteract.Controller) {
                                    ...
                                    PlayerInteract.Ret ret = new PlayerInteract.Ret();
                                    ret.action = controller.current.onAction.clickFollowBtn;
                                    ret.key = controller.key;
                                    ret.state = controller.state;
                        ...
                        public void onAvatarClick() {
                            IpChange ipChange = $ipChange;
                            if (AndroidInstantRuntime.support(ipChange, "1810373386")) {
                                ipChange.ipc$dispatch("1810373386", new Object[]{this});
                                return;
                            }
                            DagoAnchorInfoView dagoAnchorInfoView = dagoAnchorInfoView;
                            if (dagoAnchorInfoView != null) {
                    ...
                    controller.layoutParams = new LinearLayout.LayoutParams(0, (int) (((float) UnitUtil.dp2px(context, 36)) + 0.5f), 1.0f);
                    userListView2.setOnItemClickListener(new UserListView.IClickCallback() {
                        /* class com.youku.live.dago.module.DagoPlayerInteract.AnonymousClass4 */
                        private static transient /* synthetic */ IpChange $ipChange;
                        ...
                        public void onItemClick(UserListBean userListBean) {
                            IpChange ipChange = $ipChange;
                            if (AndroidInstantRuntime.support(ipChange, "-332142382")) {
                                ipChange.ipc$dispatch("-332142382", new Object[]{this, userListBean});
                            } else if (userListBean == null || TextUtils.isEmpty(userListBean.u)) {
                                UserListView userListView = userListView2;
                                ...
                                UserListView userListView2 = userListView2;
                                if (userListView2 != null) {
                                    ...
                                    if (tag2 instanceof PlayerInteract.Controller) {
                                        PlayerInteract.Controller controller2 = (PlayerInteract.Controller) tag2;
                                        PlayerInteract.Ret ret2 = new PlayerInteract.Ret();
                                        ret2.key = controller2.key;
                                        ret2.state = controller2.state;
                                        HashMap hashMap = new HashMap();
    ...
    public void initModule() {
        ...
        IDagoLivePlaybackInjectorInterface injector = getInjector();
        if (injector != null) {
            AnonymousClass1 r1 = new IDagoLivePlaybackInjectorInterface.IResultListener() {
                /* class com.youku.live.dago.module.DagoPlayerInteract.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.dsl.widgets.IDagoLivePlaybackInjectorInterface.IResultListener
                public void onResult(Map<String, Object> map) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1858659251")) {
                        ipChange.ipc$dispatch("1858659251", new Object[]{this, map});
                        return;
                    }
