...
public class MCSession {
    ...
    class ConnectionLaunchTask implements Runnable {
        ...
        public ConnectionLaunchTask(IMCConnection iMCConnection, CountDownLatch countDownLatch2) {
            this.mcConnection = iMCConnection;
            this.countDownLatch = countDownLatch2;
        }

        public void run() {
            this.mcConnection.launch(new IMCConnectionEventCallback() {
                /* class com.youku.live.messagechannel.session.MCSession.ConnectionLaunchTask.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;
    ...
    public class ConnectionShutdownTask implements Runnable {
        ...
        public ConnectionShutdownTask(IMCConnection iMCConnection, CountDownLatch countDownLatch2) {
            this.mcConnection = iMCConnection;
            this.countDownLatch = countDownLatch2;
        }
        ...
        public void run() {
            ...
            this.mcConnection.shutdown(new IMCConnectionEventCallback() {
                /* class com.youku.live.messagechannel.session.MCSession.ConnectionShutdownTask.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.messagechannel.callback.IMCConnectionEventCallback
                public void onEvent(MCConnectionEvent mCConnectionEvent, String str, Map<String, Object> map) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1048659161")) {
                        ipChange.ipc$dispatch("1048659161", new Object[]{this, mCConnectionEvent, str, map});
                        return;
                    }
    ...
    public MCSession(Context context2, long j, String str, List<IMCConnection> list, IMCSessionEventCallback iMCSessionEventCallback) {
        OrangeConfig instance = OrangeConfig.getInstance();
        OrangeConfKey.KeyInfo keyInfo = OrangeConfKey.closeHeartBeat;
        this.closeHeartBeatSwitch = instance.getConfig(OrangeConfKey.Group.android_youku_messagechannel, keyInfo.name, keyInfo.def);
        OrangeConfig instance2 = OrangeConfig.getInstance();
        OrangeConfKey.KeyInfo keyInfo2 = OrangeConfKey.connectionsLaunchTimeout;
        this.connectionsLaunchTimeout = instance2.getConfig(OrangeConfKey.Group.android_youku_messagechannel, keyInfo2.name, keyInfo2.def);
        this.context = context2;
        this.appId = j;
        this.channelId = str;
        this.connections = list;
        this.sessionEventCallback = iMCSessionEventCallback;
        this.heartbeat = new MCHeartbeat(context2, j, str);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void compensateCloseSession(SessionStatus sessionStatus2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "864465035")) {
            ipChange.ipc$dispatch("864465035", new Object[]{this, sessionStatus2});
        } else if (SessionStatus.CLOSING == sessionStatus2) {
    ...
    private void forceCloseSession() {
        ...
        MCThreadPool.sessionOperator.execute(new Runnable() {
            /* class com.youku.live.messagechannel.session.MCSession.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-919977295")) {
                    ipChange.ipc$dispatch("-919977295", new Object[]{this});
                    return;
                }
    ...
    public void closeSession() {
        ...
        SessionStatus sessionStatus2 = getSessionStatus();
        setSessionStatus(SessionStatus.CLOSING);
        if (SessionStatus.OPEN == sessionStatus2) {
            forceCloseSession();
            return;
        }
        MyLog.w(this.TAG, "Session skip close because status is ", sessionStatus2.name(), appIdAndChannelString());
    }

    public SessionStatus getSessionStatus() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1558997812")) {
            return this.sessionStatus;
        }
        return (SessionStatus) ipChange.ipc$dispatch("1558997812", new Object[]{this});
    }
    ...
    public void openSession() {
        ...
        this.selfCheckFuture = scheduledThreadPoolExecutor.scheduleWithFixedDelay(new SelfCheck(), 30, 30, TimeUnit.SECONDS);
        ...
        MCThreadPool.sessionOperator.execute(new Runnable() {
            /* class com.youku.live.messagechannel.session.MCSession.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-723463790")) {
                    ipChange.ipc$dispatch("-723463790", new Object[]{this});
                    return;
                }
                int size = MCSession.this.connections.size();
                CountDownLatch countDownLatch = new CountDownLatch(size);
                ...
                try {
                    countDownLatch.await((long) i2, TimeUnit.SECONDS);
    ...
    public void setSessionStatus(SessionStatus sessionStatus2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "638387676")) {
            ipChange.ipc$dispatch("638387676", new Object[]{this, sessionStatus2});
        } else if (this.sessionStatus != sessionStatus2) {
