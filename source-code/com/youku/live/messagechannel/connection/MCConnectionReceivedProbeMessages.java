...
public class MCConnectionReceivedProbeMessages {
    ...
    public static MCMessage getLastedProbe(long j, String str, MCConnectionFlag mCConnectionFlag) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1559780804")) {
            return activeConnectionsProbeMsg.get(genProbeKey(j, str, mCConnectionFlag));
        }
        return (MCMessage) ipChange.ipc$dispatch("-1559780804", new Object[]{Long.valueOf(j), str, mCConnectionFlag});
    }
