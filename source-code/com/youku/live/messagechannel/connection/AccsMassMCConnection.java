...
public class AccsMassMCConnection extends AbstractMCConnection {
    ...
    private String subscribeRequestId = "1234";
            ...
            if (!(connectInfo == null || TextUtils.isEmpty(connectInfo.host) || connectInfo.host.indexOf(AccsMassMCConnection.this.accsYoukuConnectHost) <= -1)) {
                for (AccsMassMCConnection accsMassMCConnection : AccsMassMCConnection.activeConnections.values()) {
                    if (accsMassMCConnection != null && !accsMassMCConnection.connectByMyself) {
                        ...
                        } else if (accsMassMCConnection.getConnectionState() == MCConnectionState.BROKEN) {
    ...
    public AccsMassMCConnection(Context context, long j, String str, String str2, boolean z) {
        ...
        this.closeSupplySubscribe = instance.getConfig(OrangeConfKey.Group.android_youku_messagechannel, keyInfo.name, keyInfo.def);
        OrangeConfig instance2 = OrangeConfig.getInstance();
        OrangeConfKey.KeyInfo keyInfo2 = OrangeConfKey.accsYoukuConnectHost;
        this.accsYoukuConnectHost = instance2.getConfig(OrangeConfKey.Group.android_youku_messagechannel, keyInfo2.name, keyInfo2.def);
        this.lastSupplySubscribeTime = 0;
        this.topic = str2;
    ...
    private void startDataListen() {
        ...
        GlobalClientInfo.getInstance(this.context).registerListener(serviceId, (AccsAbstractDataListener) new AccsAbstractDataListener() {
            /* class com.youku.live.messagechannel.connection.AccsMassMCConnection.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.taobao.accs.base.AccsDataListener
            public void onBind(String str, int i, TaoBaseService.ExtraInfo extraInfo) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1001468881")) {
                    ipChange.ipc$dispatch("1001468881", new Object[]{this, str, Integer.valueOf(i), extraInfo});
                }
            }
            ...
            public void onData(String str, String str2, String str3, byte[] bArr, TaoBaseService.ExtraInfo extraInfo) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-544952960")) {
                    ipChange.ipc$dispatch("-544952960", new Object[]{this, str, str2, str3, bArr, extraInfo});
            ...
            public void onResponse(String str, String str2, int i, byte[] bArr, TaoBaseService.ExtraInfo extraInfo) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-637589328")) {
                    ipChange.ipc$dispatch("-637589328", new Object[]{this, str, str2, Integer.valueOf(i), bArr, extraInfo});
                }
            }
            ...
            public void onSendData(String str, String str2, int i, TaoBaseService.ExtraInfo extraInfo) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1537291174")) {
                    ipChange.ipc$dispatch("1537291174", new Object[]{this, str, str2, Integer.valueOf(i), extraInfo});
                }
            }
            ...
            public void onUnbind(String str, int i, TaoBaseService.ExtraInfo extraInfo) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-2078444264")) {
                    ipChange.ipc$dispatch("-2078444264", new Object[]{this, str, Integer.valueOf(i), extraInfo});
                }
            }
        });
    }
    ...
    private void subscribeMsgFromServer() {
        IpChange ipChange = $ipChange;
        ...
        HttpUtils.massSubscribe(this.context, String.valueOf(this.appId), this.channelId, this.topic, this.subscribeRequestId, new MtopCallback.MtopFinishListener() {
            /* class com.youku.live.messagechannel.connection.AccsMassMCConnection.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // mtopsdk.mtop.common.MtopCallback.MtopFinishListener
            public void onFinished(MtopFinishEvent mtopFinishEvent, Object obj) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "936369751")) {
                    ipChange.ipc$dispatch("936369751", new Object[]{this, mtopFinishEvent, obj});
                    return;
                }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void supplySubscribeMsgFromServer() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-230988047")) {
            ...
            if (currentTimeMillis - this.lastSupplySubscribeTime > 3000) {
                ...
                HttpUtils.massSupplySubscribe(this.context, String.valueOf(this.appId), this.channelId, this.topic, new MtopCallback.MtopFinishListener() {
                    /* class com.youku.live.messagechannel.connection.AccsMassMCConnection.AnonymousClass3 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    @Override // mtopsdk.mtop.common.MtopCallback.MtopFinishListener
                    public void onFinished(MtopFinishEvent mtopFinishEvent, Object obj) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-1172663498")) {
                            ipChange.ipc$dispatch("-1172663498", new Object[]{this, mtopFinishEvent, obj});
                            return;
                        }
                        MtopResponse mtopResponse = mtopFinishEvent.mtopResponse;
    ...
    private void unsubscribeMsgFromServer() {
        ...
        HttpUtils.massUnsubscribe(this.context, String.valueOf(this.appId), this.channelId, this.topic, new MtopCallback.MtopFinishListener() {
            /* class com.youku.live.messagechannel.connection.AccsMassMCConnection.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // mtopsdk.mtop.common.MtopCallback.MtopFinishListener
            public void onFinished(MtopFinishEvent mtopFinishEvent, Object obj) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1013270549")) {
                    ipChange.ipc$dispatch("1013270549", new Object[]{this, mtopFinishEvent, obj});
                    return;
                }
                MtopResponse mtopResponse = mtopFinishEvent.mtopResponse;
    ...
    public void customLaunch(IMCConnectionEventCallback iMCConnectionEventCallback) {
        ...
        } else if (!AccsH5Connector.getInstance().isSubscribe(serviceId)) {
            AccsH5Connector.getInstance().subscribe(serviceId, new ConnectorListener() {
                /* class com.youku.live.messagechannel.connection.AccsMassMCConnection.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.messagechannel.connection.Connector.ConnectorListener
                public void onClosed() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1553098982")) {
                        ipChange.ipc$dispatch("1553098982", new Object[]{this});
                        return;
                    }
                    for (AccsMassMCConnection accsMassMCConnection : AccsMassMCConnection.activeConnections.values()) {
                        if (accsMassMCConnection != null && accsMassMCConnection.connectByMyself) {
                ...
                public void onError(String str) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1240966202")) {
                        ipChange.ipc$dispatch("1240966202", new Object[]{this, str});
                        return;
                    }
                ...
                public void onMessage(String str, String str2, byte[] bArr) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1199501460")) {
                        ipChange.ipc$dispatch("-1199501460", new Object[]{this, str, str2, bArr});
                    } else if (!AccsMassMCConnection.serviceId.equals(str)) {
                ...
                public void onOpen() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1310293368")) {
                        ipChange.ipc$dispatch("-1310293368", new Object[]{this});
                        return;
                    }
                    for (AccsMassMCConnection accsMassMCConnection : AccsMassMCConnection.activeConnections.values()) {
                        if (accsMassMCConnection != null && accsMassMCConnection.connectByMyself) {
    ...
    public MCConnectionFlag getConnectionFlag() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "513835114")) {
            return MCConnectionFlag.ACCS_MASS;
        }
        return (MCConnectionFlag) ipChange.ipc$dispatch("513835114", new Object[]{this});
    }
