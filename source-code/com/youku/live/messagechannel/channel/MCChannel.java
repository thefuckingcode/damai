...
public class MCChannel {
    ...
    public MCChannel(@NonNull Context context2, @NonNull long j, @NonNull String str) {
    ...
    @NonNull
    private String appIdAndChannelString() {
    ...
    private String appMonitorArg(boolean z, boolean z2, String str) {
        ...
        if (z) {
            j2 = this.openStartTime;
            j = this.localOpenStartTime;
        } else {
            j2 = this.closeStartTime;
            j = this.localCloseStartTime;
        }
        ...
        mCConnectionReportWrap.startTime = j2;
        mCConnectionReportWrap.localStartTime = j;
        mCConnectionReportWrap.endTime = ServerTimeEstimater.estimateServerTimestamp();
        mCConnectionReportWrap.takeTime = System.currentTimeMillis() - j;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private String appMonitorCloseArg(boolean z, String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "803095621")) {
            return appMonitorArg(false, z, str);
        }
        return (String) ipChange.ipc$dispatch("803095621", new Object[]{this, Boolean.valueOf(z), str});
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private String appMonitorOpenArg(boolean z, String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "642595199")) {
            return appMonitorArg(true, z, str);
        }
        return (String) ipChange.ipc$dispatch("642595199", new Object[]{this, Boolean.valueOf(z), str});
    }
    ...
    private void initSession() {
        ...
        if (pMInfo != null && pMInfo.bizCode > 0 && !TextUtils.isEmpty(pMInfo.topic)) {
            ...
            if (!pMInfo2.isBanConnect) {
                ...
                arrayList.add(new PMMCConnection(context2, j, str, pMInfo3.bizCode, pMInfo3.topic, pMInfo3.msgFetchMode));
        ...
        if (cDNInfo != null && !TextUtils.isEmpty(cDNInfo.url)) {
            ...
            arrayList.add(new CDNMCConnection(context3, j2, str2, cDNInfo2.pullInterval, cDNInfo2.url));
        ...
        if (mASSInfo != null && !TextUtils.isEmpty(mASSInfo.topic)) {
            ...
            arrayList.add(new AccsMassMCConnection(context4, j3, str3, mASSInfo2.topic, mASSInfo2.connectByMyself));
        ...
        if (!arrayList.isEmpty()) {
            ...
            MCSession mCSession = new MCSession(this.context, this.appId, this.channelId, arrayList, new IMCSessionEventCallback() {
                /* class com.youku.live.messagechannel.channel.MCChannel.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                /* JADX DEBUG: Multi-variable search result rejected for r1v18, resolved type: com.youku.live.messagechannel.callback.IMCChannelEventCallback */
                /* JADX DEBUG: Multi-variable search result rejected for r1v30, resolved type: com.youku.live.messagechannel.callback.IMCChannelEventCallback */
                /* JADX WARN: Multi-variable type inference failed */
                /* JADX WARN: Type inference failed for: r3v9, types: [com.youku.live.messagechannel.callback.IMCChannelEventCallback, java.util.Map] */
                /* JADX WARN: Type inference failed for: r3v20 */
                /* JADX WARN: Type inference failed for: r3v21 */
                /* JADX WARN: Type inference failed for: r2v7, types: [com.youku.live.messagechannel.callback.IMCChannelEventCallback, java.util.Map] */
                ...
                public void onEvent(MCSessionEvent mCSessionEvent, String str) {
                    ...
                    ?? r2;
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1191962531")) {
                        ipChange.ipc$dispatch("1191962531", new Object[]{this, mCSessionEvent, str});
                        ...
                        if (MCChannel.this.eventCallback != null) {
                            MCChannel.this.eventCallback.onEvent(MCChannelEvent.CLOSE_SUCCESS, str, r3);
    ...
    private void initSessionAfterGetChannelInfo() {
        ...
        HttpUtils.getChannelInfo(this.context, String.valueOf(this.appId), this.channelId, new MtopCallback.MtopFinishListener() {
            /* class com.youku.live.messagechannel.channel.MCChannel.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onFinished(MtopFinishEvent mtopFinishEvent, Object obj) {
                IpChange ipChange = $ipChange;
                boolean z = false;
                if (AndroidInstantRuntime.support(ipChange, "1128534913")) {
                    ipChange.ipc$dispatch("1128534913", new Object[]{this, mtopFinishEvent, obj});
                    return;
                }
                HashMap hashMap = new HashMap(8);
                hashMap.put(ALBiometricsKeys.KEY_APP_ID, String.valueOf(MCChannel.this.appId));
                    ...
                    if (dataJsonObject != null) {
                        ...
                        if (valueOf.longValue() == MCChannel.this.appId && MCChannel.this.channelId.equals(optString) && valueOf2 != null && optJSONObject != null) {
                            ...
                            if (optJSONObject2 != null) {
                                ...
                                JSONObject optJSONObject3 = optJSONObject2.optJSONObject("banSub4Native");
                                MCChannel.this.mcChannelInfo.PMInfo.isBanConnect = optJSONObject3.optBoolean("ban");
                            }
                            JSONObject optJSONObject4 = optJSONObject.optJSONObject(ConnType.PK_CDN);
                            if (optJSONObject4 != null) {
                                MCChannel.this.mcChannelInfo.CDNInfo.url = optJSONObject4.optString("url");
                                MCChannel.this.mcChannelInfo.CDNInfo.pullInterval = optJSONObject4.optInt(Constants.Name.INTERVAL);
                            }
                            JSONObject optJSONObject5 = optJSONObject.optJSONObject("accsMass");
                            if (optJSONObject5 != null) {
                                MCChannel.this.mcChannelInfo.MASSInfo.topic = optJSONObject5.optString("topic");
                                if (!optJSONObject5.isNull("connectByMyself")) {
                                    z = optJSONObject5.optBoolean("connectByMyself");
                                }
                                MCChannel.this.mcChannelInfo.MASSInfo.connectByMyself = z;
                            }
                            hashMap.put("isSuccess", "true");
    ...
    public long getAppId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "981541832")) {
            return this.appId;
        }
        return ((Long) ipChange.ipc$dispatch("981541832", new Object[]{this})).longValue();
    }

    public String getChannelId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1608284626")) {
            return this.channelId;
        }
        return (String) ipChange.ipc$dispatch("-1608284626", new Object[]{this});
    }
    ...
    public MCChannel(@NonNull Context context2, @NonNull MCChannelInfo mCChannelInfo) {
        this.context = context2;
