...
public class HttpUtils {
    ...
    private static Map<String, String> buildRequestHeader(String str, Map<String, String> map) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1378504102")) {
            return new HashMap();
        }
        return (Map) ipChange.ipc$dispatch("-1378504102", new Object[]{str, map});
    }
    ...
    public static void pullCDNMsg(Context context, String str, Callback callback) {
        ...
        if (pullCDNMsgClient == null) {
            ...
            pullCDNMsgClient = c.d(3000, timeUnit).k(3000, timeUnit).b();
        }
