...
public class MCHeartbeat {
    ...
    public class HeartbeatWork implements Runnable {
        ...
        public void run() {
            ...
            if (z) {
                ...
                str = MCHeartbeat.this.heartbeatInfo.heartbeatToken;
            }
            final long currentTimeMillis = System.currentTimeMillis();
            if (z || !MCHeartbeat.this.paused) {
                HttpUtils.heartbeat(MCHeartbeat.this.context, String.valueOf(MCHeartbeat.this.appId), MCHeartbeat.this.channelId, String.valueOf(z), str, String.valueOf(MCHeartbeat.getDeviceOnlineTimeInChannel(MCHeartbeat.this.appId, MCHeartbeat.this.channelId)), new MtopCallback.MtopFinishListener() {
                    /* class com.youku.live.messagechannel.heartbeat.MCHeartbeat.HeartbeatWork.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    /* JADX WARNING: Removed duplicated region for block: B:38:0x01cc  */
                                    ...
                                    if (!z) {
                                        ...
                                        if (z) {
                                            ...
                                            if (MCHeartbeat.this.heartbeatInfo.hbInterval > 0) {
                                                ...
                                                mCHeartbeat.heartbeatFuture = mCHeartbeat.heartbeatExecutor.scheduleWithFixedDelay(new HeartbeatWork(), (long) MCHeartbeat.this.heartbeatInfo.hbInterval, (long) MCHeartbeat.this.heartbeatInfo.hbInterval, TimeUnit.SECONDS);
    ...
    public MCHeartbeat(Context context2, long j, String str) {
        OrangeConfig instance = OrangeConfig.getInstance();
        OrangeConfKey.KeyInfo keyInfo = OrangeConfKey.heartBeatInterval;
        this.heartBeatInterval = instance.getConfig(OrangeConfKey.Group.android_youku_messagechannel, keyInfo.name, keyInfo.def);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void initHeartbeatInfo() {
        IpChange ipChange = $ipChange;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void utRecordHeartbeat(boolean z) {
        IpChange ipChange = $ipChange;
    ...
    public boolean isHeartbeating() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-6145152")) {
            return this.heartbeatFuture != null;
        }
        return ((Boolean) ipChange.ipc$dispatch("-6145152", new Object[]{this})).booleanValue();
    }

    public boolean isPaused() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2094958712")) {
            return this.paused;
        }
        return ((Boolean) ipChange.ipc$dispatch("2094958712", new Object[]{this})).booleanValue();
    }
    ...
    public void stop(IMCHeartbeatEventCallback iMCHeartbeatEventCallback) {
        ...
        if (this.heartbeatInfo != null) {
            ...
            HttpUtils.offline(context2, valueOf, str, this.heartbeatInfo.heartbeatToken, String.valueOf(getDeviceOnlineTimeInChannel(this.appId, str)), new MtopCallback.MtopFinishListener() {
                /* class com.youku.live.messagechannel.heartbeat.MCHeartbeat.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // mtopsdk.mtop.common.MtopCallback.MtopFinishListener
                public void onFinished(MtopFinishEvent mtopFinishEvent, Object obj) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1922401264")) {
                        ipChange.ipc$dispatch("1922401264", new Object[]{this, mtopFinishEvent, obj});
                        return;
                    }
                    MtopResponse mtopResponse = mtopFinishEvent.mtopResponse;
