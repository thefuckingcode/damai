...
public class MCMarkMessageReportTask {
    ...
    public class ReportWork implements Runnable {
        ...
        public void run() {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-13125025")) {
                ...
                if (currentTimeMillis - MCMarkMessageReportTask.this.lastReportTime < ((long) ((Integer.valueOf(MCMarkMessageReportTask.this.appMonitorHeartBeatInterval).intValue() - 2) * 1000))) {
                ...
                mCMarkMessageReportWrap.onFrontFirstReport = i2;
                mCMarkMessageReportWrap.onBackground = i;
    ...
    public MCMarkMessageReportTask(long j, String str) {
        ...
        this.closeAppMonitorHeartBeatReport = instance.getConfig(OrangeConfKey.Group.android_youku_messagechannel, keyInfo.name, keyInfo.def);
    ...
    public boolean isPaused() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1185987833")) {
            return this.paused;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1185987833", new Object[]{this})).booleanValue();
    }
    ...
    public void start() {
        ...
        try {
            ...
            this.markMessageReportFuture = scheduledThreadPoolExecutor.scheduleAtFixedRate(new ReportWork(), 0, (long) Integer.valueOf(this.appMonitorHeartBeatInterval).intValue(), TimeUnit.SECONDS);
        } catch (Exception e) {
