...
public class IDagoLivePlaybackManangerImp implements IDagoLivePlaybackManangerInterface {
    ...
    public String getCkeyInfoForRoomSwitchList(Context context, Map<String, String> map) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1584196870")) {
            return AXPParamsProvider.getMaldivesCKey(context);
        }
        return (String) ipChange.ipc$dispatch("1584196870", new Object[]{this, context, map});
    }
