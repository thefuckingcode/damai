...
public class ShareInfo implements IShareInfo {
    ...
    public ShareMode mode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "31236070")) {
            return this.mMode;
        }
        return (ShareMode) ipChange.ipc$dispatch("31236070", new Object[]{this});
    }
    ...
    public ShareTarget target() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-208397530")) {
            return this.mTarget;
        }
        return (ShareTarget) ipChange.ipc$dispatch("-208397530", new Object[]{this});
    }
