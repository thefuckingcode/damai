...
public class IDynamicConfigImp implements IDynamicConfig {
    ...
    private String getDeviceScore() {
        ...
        if (i == -1 && (applicationContext = xs0.a().getApplicationContext()) != null) {
    ...
    private String getStringInternal(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-982483615")) {
            return (!"device".equalsIgnoreCase(str) || !IDynamicConfig.KEY_DEVICE_SCORE.equalsIgnoreCase(str2)) ? str3 : getDeviceScore();
        }
        return (String) ipChange.ipc$dispatch("-982483615", new Object[]{this, str, str2, str3});
    }
