...
public class IPreloaderManangerImp implements IPreloaderMananger {
    ...
    public boolean createPlayerPreloader() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2085972488")) {
            return PlayerPreloader.getInstance() != null;
        }
        return ((Boolean) ipChange.ipc$dispatch("2085972488", new Object[]{this})).booleanValue();
    }
    ...
    public IPreloader removePreloader(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "699985727")) {
            return getPreloaderMananger().remove(str);
        }
        return (IPreloader) ipChange.ipc$dispatch("699985727", new Object[]{this, str});
    }
}
