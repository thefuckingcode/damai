...
public class BackgroundCacheStuffer extends YKLTextCacheStuffer {
    ...
    private void realDrawText(BaseDanmaku baseDanmaku, String str, Canvas canvas, float f, IDanmakuData iDanmakuData, Paint paint) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "747242856")) {
            ...
            float textBaseLine = getTextBaseLine(paint, (float) iDanmakuData.getPaddingTop(), baseDanmaku.paintHeight - ((float) iDanmakuData.getPaddingBottom()));
            if (str != null) {
                canvas.drawText(str, f + ((float) iDanmakuData.getPaddingLeft()), textBaseLine, paint);
                return;
            }
            CharSequence charSequence = baseDanmaku.text;
            if (charSequence != null) {
                canvas.drawText(charSequence.toString(), f + ((float) iDanmakuData.getPaddingLeft()), textBaseLine, paint);
            }
        }
    }
    ...
    @Override // com.youku.live.dsl.danmaku.youku.SimpleTextCacheStuffer, com.youku.live.dsl.danmaku.youku.YKLTextCacheStuffer
    ...
    @Override // com.youku.danmaku.engine.danmaku.model.android.stuffer.BaseCacheStuffer, com.youku.live.dsl.danmaku.youku.SimpleTextCacheStuffer, com.youku.live.dsl.danmaku.youku.YKLTextCacheStuffer
    public void measure(BaseDanmaku baseDanmaku, TextPaint textPaint, boolean z, AndroidDisplayer.DisplayConfig displayConfig) {
        ...
        if (iDanmakuData != null) {
            baseDanmaku.paintWidth += (float) (iDanmakuData.getPaddingLeft() + iDanmakuData.getPaddingRight());
            baseDanmaku.paintHeight += (float) (iDanmakuData.getPaddingBottom() + iDanmakuData.getPaddingTop());
        }
    }
}
