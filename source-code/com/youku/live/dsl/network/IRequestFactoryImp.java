...
public class IRequestFactoryImp implements IRequestFactory {
    ...
    public IRequest createRequestWithMtop(String str, String str2, Map<String, String> map, boolean z, boolean z2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-344265640")) {
            return new IMtopRequestImp(str, str2, map, z, z2);
        }
        return (IRequest) ipChange.ipc$dispatch("-344265640", new Object[]{this, str, str2, map, Boolean.valueOf(z), Boolean.valueOf(z2)});
    }
}
