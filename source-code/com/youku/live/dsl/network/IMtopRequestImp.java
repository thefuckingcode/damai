...
public class IMtopRequestImp implements IRequest, MtopCallback.MtopFinishListener {
    ...
    public IMtopRequestImp(String str, String str2, Map<String, String> map, boolean z, boolean z2) {
        ...
        Map<String, String> c = a20.b().c(str, map);
        this.params = c;
        this.post = z;
        this.needLogin = z2;
        MtopRequest mtopRequest2 = new MtopRequest();
        this.request = mtopRequest2;
        ...
        MtopBuilder addListener = Mtop.instance(NetConstants.YOUKU_MTOP_INSTANCE_ID, xs0.a(), AppConfig.p()).registerTtid(AppConfig.p()).build(this.request, AppConfig.p()).reqMethod(z ? MethodEnum.POST : MethodEnum.GET).addListener(this);
    ...
    private boolean isMainSheduler() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2079752490")) {
            return getSheduler().equals(IRequest.Scheduler.MAIN_SCHEDULER);
        }
        return ((Boolean) ipChange.ipc$dispatch("2079752490", new Object[]{this})).booleanValue();
    }
    ...
    private void processMtopResponse(MtopResponse mtopResponse) {
        ...
        if (iRequestCallback != null) {
            ...
            AnonymousClass1 r5 = new Runnable() {
                /* class com.youku.live.dsl.network.IMtopRequestImp.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void run() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "712691889")) {
                        ipChange.ipc$dispatch("712691889", new Object[]{this});
                        return;
                    }
