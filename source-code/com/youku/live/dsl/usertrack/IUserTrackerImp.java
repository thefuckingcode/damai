...
public class IUserTrackerImp implements IUserTracker {
    ...
    public Map<String, String> getLastClickParams() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1771571968")) {
            return pt2.d();
        }
        return (Map) ipChange.ipc$dispatch("1771571968", new Object[]{this});
    }
    ...
    public void pageDisAppear(Object obj) {
        ...
        try {
            Map<String, String> b = pt2.b(UTAnalytics.getInstance().getDefaultTracker().getPageProperties(obj));
            ...
            g91.a("pageDisAppear->" + b.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
        c.e().t(obj);
