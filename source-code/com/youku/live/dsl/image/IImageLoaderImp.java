...
public class IImageLoaderImp implements IImageLoader {
    ...
    public IImageLoader circle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1855733486")) {
            return this;
        }
        return (IImageLoader) ipChange.ipc$dispatch("1855733486", new Object[]{this});
    }
    ...
    public IImageLoader into(ImageView imageView) {
        ...
        tp1.o().s(this.mImageUrl).y(imageView);
        return this;
    }
    ...
    public IImageLoader round(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "219744709")) {
            return this;
        }
        return (IImageLoader) ipChange.ipc$dispatch("219744709", new Object[]{this, Integer.valueOf(i)});
    }
}
