...
public class LiveActivityLifecycleCallbackWrapper implements Application.ActivityLifecycleCallbacks {
    ...
    public static class InnerRunnable implements Runnable {
        ...
        WeakReference<LiveActivityLifecycleCallbackWrapper> weakReferenceLifecycle = null;
        ...
        public void run() {
            WeakReference<LiveActivityLifecycleCallbackWrapper> weakReference2;
            ...
            if (weakReference3 != null && weakReference3.get() != null && (weakReference2 = this.weakReferenceLifecycle) != null && weakReference2.get() != null) {
    ...
    public Activity getH5Activity() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-340769668")) {
            return this.mH5Activity;
        }
        return (Activity) ipChange.ipc$dispatch("-340769668", new Object[]{this});
    }
    ...
    public void onActivityPaused(Activity activity) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1344901474")) {
                ...
                if (activity.toString().equals(this.mOldCreateActivity)) {
                    ...
                    if (activity.getIntent() != null && activity.getIntent().getDataString() != null) {
                        ...
                        if (dataString != null && dataString.contains("bizfrom") && this.mHandler == null) {
                            ...
                            handler.postDelayed(this.mRunnable, 6000);
                        }
            ...
            } else if ((activity instanceof LiveActivity) && ((LiveActivity) activity).getPipType() == 3) {
    ...
    public void onActivityResumed(Activity activity) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1646228889")) {
            ...
            } else if ((activity instanceof LiveActivity) && !((LiveActivity) activity).isInPipMode() && (activity2 = this.mH5Activity) != null && !activity2.isFinishing()) {
