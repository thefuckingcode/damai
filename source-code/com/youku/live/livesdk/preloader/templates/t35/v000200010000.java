...
public class v000200010000 implements ITemplate {
    ...
    public String getLandscapeLayout() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1351397415")) {
            return landscapeLayout;
        }
        return (String) ipChange.ipc$dispatch("-1351397415", new Object[]{this});
    }
    ...
    public String getPortraitLayout() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2114167303")) {
            return portraitLayout;
        }
        return (String) ipChange.ipc$dispatch("2114167303", new Object[]{this});
    }
