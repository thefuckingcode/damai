...
public class v000200010000 implements ITemplate {
    ...
    public String getLandscapeLayout() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "916199300")) {
            return landscapeLayout;
        }
        return (String) ipChange.ipc$dispatch("916199300", new Object[]{this});
    }
    ...
    public String getPortraitLayout() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2048768252")) {
            return portraitLayout;
        }
        return (String) ipChange.ipc$dispatch("2048768252", new Object[]{this});
    }
