...
public class TemplateCacheMananger {
    ...
    public String getLayout(String str, String str2, boolean z) {
        ...
        if (iTemplate == null) {
            try {
                ...
                String string = ((IRemoteConfig) Dsl.getService(IRemoteConfig.class)).getString("YKLiveRoom_ABTest", sb.toString(), null);
    ...
    public TemplateCacheMananger updateTemplate(String str, String str2, String str3, String str4) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1427112607")) {
            return updateTemplate(str, str2, str3, str4, null, null);
        }
        return (TemplateCacheMananger) ipChange.ipc$dispatch("1427112607", new Object[]{this, str, str2, str3, str4});
    }
    ...
    public TemplateCacheMananger updateTemplate(String str, String str2, String str3, String str4, TemplateModel templateModel, TemplateModel templateModel2) {
        ...
        } else if (!"1".equals(((IRemoteConfig) Dsl.getService(IRemoteConfig.class)).getString("YKLiveRoom_ABTest", "LayoutCachesUpdate", "1"))) {
            return this;
        } else {
            Map<String, Map<String, ITemplate>> caches = getCaches();
