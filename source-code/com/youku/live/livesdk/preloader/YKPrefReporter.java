    ...
    public static class OnePlay {
        ...
        public void report() {
            ...
            if (YKPrefReporter.mIsFirstLoad) {
                ...
                value.setValue(YKPrefReporter.DATA_KEY_IS_FIRST_LOAD, str);
            }
            ...
            MeasureValueSet value2 = MeasureValueSet.create().setValue(YKPrefReporter.DATA_TIME_PRELOADER, (double) f);
            value2.setValue(YKPrefReporter.DATA_TIME_REQUESTFULLINFO, (double) f2);
            value2.setValue(YKPrefReporter.DATA_TIME_RENDER_WITH_LIVE_FULLINFO, (double) f3);
            value2.setValue(YKPrefReporter.DATA_TIME_LIVEACTIVITY_ONCREATE, (double) f4);
            value2.setValue(YKPrefReporter.DATA_TIME_PLAYEA_FIRST_FRAME, (double) f5);
            value2.setValue(YKPrefReporter.DATA_TIME_PLAYER_FIRST_ADFRAME_TIME, (double) f6);
            value2.setValue(YKPrefReporter.DATA_TIME_ONCREATE_INIT_HOST_VIEW, (double) f7);
            value2.setValue(YKPrefReporter.DATA_TIME_INIT_HOSTVIEW, (double) f8);
            value2.setValue(YKPrefReporter.DATA_TIME_INIT_WITHDATA, (double) f9);
