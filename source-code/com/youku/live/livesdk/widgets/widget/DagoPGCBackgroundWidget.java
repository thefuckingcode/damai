...
public class DagoPGCBackgroundWidget extends BaseWidget implements IDataHandler {
    ...
    private void setBottomDecorate(LiveFullInfoData liveFullInfoData) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-998529979")) {
            ...
            tp1.o().s(liveFullInfoData.theme.phoneBottomBackgroundUrl).Q(new IPhenixListener<ug2>() {
                /* class com.youku.live.livesdk.widgets.widget.DagoPGCBackgroundWidget.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public boolean onHappen(ug2 ug2) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1450326579")) {
                        return ((Boolean) ipChange.ipc$dispatch("1450326579", new Object[]{this, ug2})).booleanValue();
                    }
                    BitmapDrawable f = ug2.f();
                    if (f != null) {
                        int intrinsicWidth = f.getIntrinsicWidth();
                        int intrinsicHeight = f.getIntrinsicHeight();
                        ImageView imageView = DagoPGCBackgroundWidget.this.mBottomDecorateView;
                        if (imageView != null) {
    ...
    private void setPlayerDecorate(final LiveFullInfoData liveFullInfoData) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "598256123")) {
            ...
            tp1.o().s(liveFullInfoData.theme.phoneBackgroundUrl).Q(new IPhenixListener<ug2>() {
                /* class com.youku.live.livesdk.widgets.widget.DagoPGCBackgroundWidget.AnonymousClass2 */
                private static transient /* synthetic */ IpChange $ipChange;

                public boolean onHappen(ug2 ug2) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "283630260")) {
                        return ((Boolean) ipChange.ipc$dispatch("283630260", new Object[]{this, ug2})).booleanValue();
                    }
                    BitmapDrawable f = ug2.f();
                    if (f != null) {
                        int intrinsicWidth = f.getIntrinsicWidth();
                        int intrinsicHeight = f.getIntrinsicHeight();
                        ImageView imageView = DagoPGCBackgroundWidget.this.mPlayerDecorateView;
                        if (imageView != null) {
                            if (intrinsicWidth > 0 && intrinsicHeight > 0) {
                                try {
                                    int[] iArr = iArr;
                            ...
                            tp1.o().s(liveFullInfoData.theme.phoneBackgroundUrl).y(imageView);
                        }
                    }
                    return false;
                }
