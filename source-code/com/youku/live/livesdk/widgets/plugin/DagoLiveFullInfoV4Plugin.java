...
public class DagoLiveFullInfoV4Plugin extends BasePlugin implements DagoChannelPlugin.Receiver, IDataHandler, IActivityBackPressedListener {
    ...
    private Runnable asyncSignalSetFirstFrameImpFalse = new Runnable() {
        /* class com.youku.live.livesdk.widgets.plugin.DagoLiveFullInfoV4Plugin.AnonymousClass3 */
    ...
    private Runnable asyncSignalSetFirstFrameImpTrue = new Runnable() {
        /* class com.youku.live.livesdk.widgets.plugin.DagoLiveFullInfoV4Plugin.AnonymousClass2 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private Runnable asyncTimeoutForFirstFrame = new Runnable() {
        /* class com.youku.live.livesdk.widgets.plugin.DagoLiveFullInfoV4Plugin.AnonymousClass1 */
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private void createInterceptDialog(String str, String str2, String str3, final String str4) {
        ...
        interceptDialog.setOnButtonClickListener(new InterceptDialog.OnButtonClickListener() {
            /* class com.youku.live.livesdk.widgets.plugin.DagoLiveFullInfoV4Plugin.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onCloseButtonClick(boolean z) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "523802401")) {
                    ipChange.ipc$dispatch("523802401", new Object[]{this, Boolean.valueOf(z)});
                } else {
            ...
            public void onLeftButtonClick() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-1672451350")) {
                    ipChange.ipc$dispatch("-1672451350", new Object[]{this});
                    return;
                }
            ...
            public void onRightButtonClick() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-707677385")) {
                    ipChange.ipc$dispatch("-707677385", new Object[]{this});
                    return;
                }
        ...
        this.mInterceptDialog.setOnShowListener(new DialogInterface.OnShowListener() {
            /* class com.youku.live.livesdk.widgets.plugin.DagoLiveFullInfoV4Plugin.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onShow(DialogInterface dialogInterface) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1424774513")) {
                    ipChange.ipc$dispatch("1424774513", new Object[]{this, dialogInterface});
                    return;
                }
    ...
    private int getTimeoutOfFirstFrame() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1517114316")) {
            return ((IRemoteConfig) Dsl.getService(IRemoteConfig.class)).getInt("YKLiveRoom_ABTest", "signalFirstFrameTimeout", 2000);
        }
        return ((Integer) ipChange.ipc$dispatch("-1517114316", new Object[]{this})).intValue();
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void signalSetFirstFrameImp(boolean z) {
        IpChange ipChange = $ipChange;
