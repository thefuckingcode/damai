        ...
        if (AndroidInstantRuntime.support(ipChange, "1118866280")) {
            ...
            if (createRequestWithMTop != null) {
                createRequestWithMTop.async(new INetCallback() {
                    /* class com.youku.live.livesdk.widgets.plugin.DagoLiveFullInfoV3Plugin.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    @Override // com.youku.live.dsl.network.INetCallback
                    public void onFinish(INetResponse iNetResponse) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "1788989232")) {
                            ipChange.ipc$dispatch("1788989232", new Object[]{this, iNetResponse});
                        } else if (iNetResponse != null) {
                            String source = iNetResponse.getSource();
                            JSONObject dataDataWithJson = MtopDataHelper.getDataDataWithJson(source, LiveFullInfo.class);
                            DagoLiveFullInfoV3Plugin.this.getEngineInstance().asyncPutData("mtop.youku.live.com.livefullinfo", (LiveFullInfoData) MtopDataHelper.getDataDataWithModel(source, LiveFullInfo.class), dataDataWithJson);
                        }
                    }
                });
            }
