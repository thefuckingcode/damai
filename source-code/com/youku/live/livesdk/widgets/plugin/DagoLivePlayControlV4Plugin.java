        ...
        if (str2 == null || str == null || !str2.equals(str)) {
            ...
            if (createRequestWithMTop != null) {
                ...
                createRequestWithMTop.async(new INetCallback() {
                    /* class com.youku.live.livesdk.widgets.plugin.DagoLivePlayControlV4Plugin.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    @Override // com.youku.live.dsl.network.INetCallback
                    public void onFinish(INetResponse iNetResponse) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "-655207275")) {
                            ipChange.ipc$dispatch("-655207275", new Object[]{this, iNetResponse});
                            ...
                            DagoLivePlayControlV4Plugin.this.getEngineInstance().asyncPutData("mtop.youku.live.com.livefullinfo", (LiveFullInfoData) MtopDataHelper.getDataDataWithModel(source, LiveFullInfoV4.class), dataDataWithJson);
