...
public class InterceptDialogHelper {
    ...
    public boolean containsLiveId(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-192189274")) {
            return !TextUtils.isEmpty(this.showIds) && this.showIds.contains(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("-192189274", new Object[]{this, str})).booleanValue();
    }

    public String getDirection() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2070481835")) {
            return WidgetSDKEngine.getOrientation() == Orientation.ORIENTATION_LANDSCAPE ? "fplayer" : "vplayer";
        }
        return (String) ipChange.ipc$dispatch("2070481835", new Object[]{this});
    }
