...
public class PagableViewPagerProvider implements PagableViewProvider<SwitchItemModel, LiveContentView> {
    ...
    public <Params, RetValue> RetValue callActiveView(Caller<LiveContentView, Params, RetValue> caller, Params params, RetValue retvalue) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1443219310")) {
            return (RetValue) ipChange.ipc$dispatch("-1443219310", new Object[]{this, caller, params, retvalue});
        }
        return caller.onCall(this.pagableAdapter.getContentViewByIndex(this.viewPager.getCurrentItem()), params);
    }

    @Override // com.youku.live.livesdk.widgets.container.interfaces.PagableViewProvider
    public View getContentView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2114255464")) {
            return this.mContentView;
        }
        return (View) ipChange.ipc$dispatch("-2114255464", new Object[]{this});
    }
