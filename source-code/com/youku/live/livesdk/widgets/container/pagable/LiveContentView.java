...
public class LiveContentView extends FrameLayout implements IDataHandler, IEngineRenderListener, Runnable {
    ...
    private boolean abtestOpenLayoutPreParseRender() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "412369889")) {
            return OptConfigUtils.isOpenOpt() && OptConfigUtils.getConfig("openLayoutPreParseRender", true);
        }
        return ((Boolean) ipChange.ipc$dispatch("412369889", new Object[]{this})).booleanValue();
    }
    ...
    private LoadingRetryView getErrorRetryView(String str) {
        ...
        if (loadingRetryView == null) {
            ...
            loadingRetryView2.setRetryButtonListener(new View.OnClickListener() {
                /* class com.youku.live.livesdk.widgets.container.pagable.LiveContentView.AnonymousClass8 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void onClick(View view) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-2067793457")) {
                        ipChange.ipc$dispatch("-2067793457", new Object[]{this, view});
                        return;
                    }
                    LoadingRetryView loadingRetryView = LiveContentView.this.mErrorRetryView;
                    if (loadingRetryView != null) {
        ...
        loadingRetryView.setRetryButtonListener(new View.OnClickListener() {
            /* class com.youku.live.livesdk.widgets.container.pagable.LiveContentView.AnonymousClass9 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "43496912")) {
                    ipChange.ipc$dispatch("43496912", new Object[]{this, view});
                    return;
                }
                LoadingRetryView loadingRetryView = LiveContentView.this.mErrorRetryView;
                if (loadingRetryView != null) {
    ...
    private YoukuLivePerformance getYoukuLivePerformance() {
        IpChange ipChange = $ipChange;
    ...
    private void performancePlayerPkMcu(Object obj) {
        ...
        if (num != null) {
            ...
            String str = this.livePerformanceId;
            if (str != null) {
                YoukuLivePerformance perfBySessionId = YoukuLivePerformanceManager.getInstance().getPerfBySessionId(str);
                boolean z2 = (intValue & 1) == 1;
                if ((intValue & 2) == 2) {
                    z = true;
                }
                perfBySessionId.setPkType(z2, z);
            }
        }
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void renderLiveFullInfoRetry(String str) {
        IpChange ipChange = $ipChange;
    ...
    private boolean renderWidgetInstance(String str, String str2, TemplateModel templateModel, String str3, String str4, Map<String, Object> map, String str5, Map<String, Object> map2) {
        ...
        if (!TextUtils.isEmpty(str2)) {
            ...
            String str7 = "0";
            String str8 = obj3 instanceof String ? (String) obj3 : str7;
            Object obj4 = map.get("isColdStart");
            String str9 = obj4 instanceof String ? (String) obj4 : str7;
            Object obj5 = map.get("matchLayoutCache");
            if (obj5 instanceof String) {
                str7 = (String) obj5;
            }
            getInstance().getPerfMonitor().perfConfig("roomId", str).perfConfig("spmUrl", str6).perfConfig("firstRoom", str8).perfConfig("isColdStart", str9).perfConfig("matchLayoutCache", str7).perfCommitSuccess();
            z2 = true;
        } else {
            z = false;
        }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void renderWithLiveFullInfo(String str, LiveFullInfoData liveFullInfoData, JSONObject jSONObject) {
        IpChange ipChange = $ipChange;
    ...
    private void updatePvWithLiveFullInfoImp(LiveFullInfoData liveFullInfoData, Map<String, Object> map) {
        ...
        performanceLiveStatus(String.valueOf(i));
        String str2 = liveFullInfoData.name;
        String str3 = "";
        String str4 = liveFullInfoData.screenId != null ? str3 + liveFullInfoData.screenId : str3;
        if (liveFullInfoData.liveId != null) {
            str3 = str3 + liveFullInfoData.liveId;
        }
        utParams.put("type", str);
        utParams.put("liveRoomType", "native");
        utParams.put("screenid", str4);
        utParams.put("page", str2);
        utParams.put("page_type", "1");
        utParams.put("liveid", str3);
        utParams.put("liveId", str3);
        utParams.put("roomid", str3);
        utParams.put("roomId", str3);
        utParams.put("id", str3);
        if (this.isAppear) {
            Context context = getContext();
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateWithLiveFullInfo(final String str, final LiveFullInfoData liveFullInfoData, final JSONObject jSONObject) {
        IpChange ipChange = $ipChange;
        ...
        if (liveFullInfoData == null || jSONObject == null) {
            getInstance().runOnMainThread(new Runnable() {
                /* class com.youku.live.livesdk.widgets.container.pagable.LiveContentView.AnonymousClass6 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void run() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1720206467")) {
                        ipChange.ipc$dispatch("1720206467", new Object[]{this});
                        return;
                    }
        ...
        getInstance().runOnMainThread(new Runnable() {
            /* class com.youku.live.livesdk.widgets.container.pagable.LiveContentView.AnonymousClass7 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1523692962")) {
                    ipChange.ipc$dispatch("1523692962", new Object[]{this});
                    return;
                }
    ...
    public int PxToDp(int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "483096411")) {
            return ((Integer) ipChange.ipc$dispatch("483096411", new Object[]{this, Integer.valueOf(i)})).intValue();
        }
    ...
    public Map<String, String> getParams() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1344207879")) {
            return getRenderParams();
        }
        return (Map) ipChange.ipc$dispatch("-1344207879", new Object[]{this});
    }
    ...
    public boolean isUnimitRotateScreen() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1973576885")) {
            return this.isUnlimitRotateScreen;
        }
        return ((Boolean) ipChange.ipc$dispatch("1973576885", new Object[]{this})).booleanValue();
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (baseSlideLayout != null) {
                baseSlideLayout.handleSlideEvent(motionEvent);
            }
        } else if (action == 2 && this.mMoveState == RoomMoveState.IDLE) {
            BaseSlideLayout baseSlideLayout2 = this.mSlideLayout;
            if (baseSlideLayout2 == null || baseSlideLayout2.isShow()) {
    ...
    public void onRenderSuccess(WidgetInstance widgetInstance) {
        ...
        if (findWidgetById instanceof IDagoLivePlaybackInjectorInterface) {
            ...
            iDagoLivePlaybackInjectorInterface.injectorSetRotateEventListener(new IDagoLivePlaybackInjectorInterface.IResultListener() {
                /* class com.youku.live.livesdk.widgets.container.pagable.LiveContentView.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;
                ...
                public void onResult(Map<String, Object> map) {
                    ...
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1365707306")) {
                        ipChange.ipc$dispatch("1365707306", new Object[]{this, map});
                    } else if (map != null) {
                        try {
                            if (map.containsKey("key") && map.get("key") != null) {
                                if ("DAGOStartOrotateAction".equals(map.get("key"))) {
                                    ...
                                    if (map.containsKey(Constants.ACTION_PARAMS_SCREENMODE) && map.get(Constants.ACTION_PARAMS_SCREENMODE) != null) {
                                        try {
                                            if (LiveContentView.this.mWidgetEngineContext == null) {
                                                return;
                                            }
                                            if (LiveContentView.this.mWidgetEngineContext.getCurrentActivity() != null) {
                                                int intValue = ((Integer) map.get(Constants.ACTION_PARAMS_SCREENMODE)).intValue();
                                                if (intValue != 1) {
                                                    if (intValue != 2) {
                                                        if (intValue == 3) {
                                                            if (LiveContentView.this.mWidgetEngineContext.getCurrentActivity().getRequestedOrientation() != 8) {
                                    ...
                                    if (LiveContentView.this.getHandler() != null) {
                                        LiveContentView.this.getHandler().removeCallbacks(LiveContentView.this.mShowWidgetRunnable);
                                        LiveContentView.this.getHandler().postDelayed(LiveContentView.this.mShowWidgetRunnable, 300);
                                        return;
                                    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x002d, code lost:
        if (r0 != 4) goto L_0x0108;
     */
    public boolean onTouchEvent(MotionEvent motionEvent) {
        Uri data;
        BaseSlideLayout baseSlideLayout;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "2079063625")) {
            return ((Boolean) ipChange.ipc$dispatch("2079063625", new Object[]{this, motionEvent})).booleanValue();
        }
        int action = motionEvent.getAction();
        if (action == 0) {
            return true;
        ...
        if (action != 1) {
            if (action == 2) {
                if (this.mMoveState == RoomMoveState.IDLE) {
                    BaseSlideLayout baseSlideLayout2 = this.mSlideLayout;
                    if (baseSlideLayout2 == null || baseSlideLayout2.isShow()) {
                        float x = motionEvent.getX();
                        float y = motionEvent.getY();
                ...
                if (this.mMoveState != RoomMoveState.RIGHT && !this.mIsLandscape && (baseSlideLayout = this.mSlideLayout) != null && baseSlideLayout.handleSlideEvent(motionEvent)) {
                    return true;
                }
            } else if (action != 3) {
            }
        ...
        BaseSlideLayout baseSlideLayout3 = this.mSlideLayout;
        if (baseSlideLayout3 != null && this.mMoveState == RoomMoveState.IDLE) {
            baseSlideLayout3.handleFullScreenPraise(motionEvent);
        }
        if (this.mMoveState != RoomMoveState.RIGHT) {
            BaseSlideLayout baseSlideLayout4 = this.mSlideLayout;
            if (baseSlideLayout4 != null && !this.mIsLandscape) {
                baseSlideLayout4.handleSlideEvent(motionEvent);
            }
        } else if (this.mIsLandscape) {
            return false;
        } else {
            float x2 = motionEvent.getX() - this.mTouchDownX;
            if (x2 > 0.0f && x2 / ((float) getWidth()) > 0.25f && (getContext() instanceof Activity) && (data = ((Activity) getContext()).getIntent().getData()) != null) {
                String uri = data.toString();
                if (!TextUtils.isEmpty(uri)) {
                    if (SchemaConstants.isYoukuLiveSchema(uri)) {
                        getInstance().asyncPutData("slidingRoom", 0);
                    } else if (SchemaConstants.isLaifengSchema(uri)) {
    ...
    public void updateWithRoomInfo(int i, SwitchItemModel switchItemModel) {
        ...
        if (!switchItemModel.roomId.equals(this.mRoomId)) {
            ...
            if (liveQuickPlayModel2 == null || (obj = liveQuickPlayModel2.newPlayInfo) == null) {
                obj = null;
            }
            renderParamsAsMap.put("dagoLiveIdPlayerModel", obj);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setWidgetVisibility(boolean z, boolean z2) {
        IpChange ipChange = $ipChange;
    ...
    public LiveContentView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mShowWidgetRunnable = new Runnable() {
            /* class com.youku.live.livesdk.widgets.container.pagable.LiveContentView.AnonymousClass2 */
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        this.mHideWidgetRunnable = new Runnable() {
            /* class com.youku.live.livesdk.widgets.container.pagable.LiveContentView.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;
    ...
    private void onRoomChange(final String str, String str2) {
        ...
        if (str2 == null || (data = (instance = Preloader.getInstance()).getData(str2)) == null) {
            onRoomChange(str);
        } else if (data.isFinish()) {
            updateWithLiveFullInfo(str, (LiveFullInfoData) data.getModel(), data.getJson());
        } else {
            instance.addTaskCallback(str2, new Preloader.IResult() {
                /* class com.youku.live.livesdk.widgets.container.pagable.LiveContentView.AnonymousClass4 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.livesdk.preloader.Preloader.IResult
                public void onResult(Preloader.IData iData) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-1469910767")) {
                        ipChange.ipc$dispatch("-1469910767", new Object[]{this, iData});
                        return;
                    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void onRoomChange(final String str) {
        IpChange ipChange = $ipChange;
        ...
        WidgetSDKEngine.getInstance().getRenderMananger().postOnWorkerThread(new Runnable() {
            /* class com.youku.live.livesdk.widgets.container.pagable.LiveContentView.AnonymousClass5 */
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void run() {
                ...
                Map<String, String> build = MapUtils.build(MapUtils.build(MapUtils.build(new HashMap(), "liveId", str), "sdkVersion", ObjectUtils.asString(LiveContentView.this.getInstance().getOptions().getString(SDKConstants.SDK_DEBUG_FULL_INFO_SDK_VERSION, SDKConstants.SDK_VERSION_NUMBER), SDKConstants.SDK_VERSION_NUMBER)), "app", "Android");
                ...
                IPerfMonitor iPerfMonitor2 = LiveContentView.this.mPagePerfMonitor;
                if (iPerfMonitor2 != null) {
                    iPerfMonitor2.point("LiveFullInfoCost", Thread.currentThread().getName() + "::LiveContentView onRoomChange:" + LiveContentView.this + ",mLiveId：" + str + ", 1 before reqLiveFullInfo;" + "4.0");
                }
                if (createRequestWithMTop != null) {
                    createRequestWithMTop.async(new INetCallback() {
                        /* class com.youku.live.livesdk.widgets.container.pagable.LiveContentView.AnonymousClass5.AnonymousClass1 */
                        private static transient /* synthetic */ IpChange $ipChange;

                        @Override // com.youku.live.dsl.network.INetCallback
                        public void onFinish(INetResponse iNetResponse) {
                            IpChange ipChange = $ipChange;
                            if (AndroidInstantRuntime.support(ipChange, "195321172")) {
                                ipChange.ipc$dispatch("195321172", new Object[]{this, iNetResponse});
                                return;
                            }
                            ...
                            if (iNetResponse != null) {
                                IPerfMonitor iPerfMonitor = LiveContentView.this.mPagePerfMonitor;
                                if (iPerfMonitor != null) {
                                    iPerfMonitor.point("LiveFullInfoCost", Thread.currentThread().getName() + "::LiveContentView onRoomChange:" + LiveContentView.this + ",mLiveId：" + str + ", 2 after reqLiveFullInfo;" + "4.0");
                                }
                                ...
                                IPerfMonitor iPerfMonitor2 = LiveContentView.this.mPagePerfMonitor;
                                if (iPerfMonitor2 != null) {
                                    iPerfMonitor2.point("LiveFullInfoCost", Thread.currentThread().getName() + "::LiveContentView onRoomChange parse:" + LiveContentView.this + ",mLiveId：" + str + ", 3 after reqLiveFullInfo;" + "4.0");
                                }
                                JSONObject dataDataWithJson = MtopDataHelper.getDataDataWithJson(source, LiveFullInfoV4.class);
                                AnonymousClass5 r4 = AnonymousClass5.this;
                                LiveContentView.this.updateWithLiveFullInfo(str, liveFullInfoData, dataDataWithJson);
                                if (LiveContentView.this.getYoukuLivePerformance() != null) {
                                ...
                                if (iPerfMonitor3 != null) {
                                    iPerfMonitor3.point("LiveFullInfoCost", Thread.currentThread().getName() + "::LiveContentView onRoomChange parse:" + LiveContentView.this + ",mLiveId：" + str + ", 4 after reqLiveFullInfo;" + "4.0");
                                    return;
                                }
                                return;
                            }
                            ...
                            LiveContentView.this.getInstance().runOnMainThread(new Runnable() {
                                /* class com.youku.live.livesdk.widgets.container.pagable.LiveContentView.AnonymousClass5.AnonymousClass1.AnonymousClass1 */
                                private static transient /* synthetic */ IpChange $ipChange;

                                public void run() {
                                    IpChange ipChange = $ipChange;
                                    if (AndroidInstantRuntime.support(ipChange, "1674864586")) {
                                        ipChange.ipc$dispatch("1674864586", new Object[]{this});
                                        return;
                                    }
