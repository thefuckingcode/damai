...
public class PagableConfigure {
    ...
    public enum PreloadMode {
        ...
        private PreloadMode(String str) {
            this.value = str;
        }
    ...
    public PreloadMode getCurrentModeForLayout() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-139215197")) {
            return this.mCurrentLayoutMode;
        }
        return (PreloadMode) ipChange.ipc$dispatch("-139215197", new Object[]{this});
    }

    public PreloadMode getCurrentModeForWidget() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "376309449")) {
            return this.mCurrentWidgetMode;
        }
        return (PreloadMode) ipChange.ipc$dispatch("376309449", new Object[]{this});
    }
