...
public class PagableAdapter<DataType, ContentViewType extends View> extends RecyclerView.Adapter<PagableViewHolder<DataType>> implements IDestroyable {
    ...
    public long getItemId(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1285482954")) {
            return (long) i;
        }
        return ((Long) ipChange.ipc$dispatch("1285482954", new Object[]{this, Integer.valueOf(i)})).longValue();
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v1, resolved type: com.youku.live.livesdk.widgets.container.interfaces.PagableViewProvider$OnPagingLifecycleListener<DataType, ContentViewType extends android.view.View> */
    ...
    public PagableViewHolder<DataType> onCreateViewHolder(ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-390471062")) {
            return new PagableViewHolder<>(this.mPagingContentCreator.createPageItem());
        }
        return (PagableViewHolder) ipChange.ipc$dispatch("-390471062", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }

    /* JADX DEBUG: Multi-variable search result rejected for r7v0, resolved type: com.youku.live.livesdk.widgets.container.pagable.PagableAdapter<DataType, ContentViewType extends android.view.View> */
    /* JADX DEBUG: Multi-variable search result rejected for r2v4, resolved type: com.youku.live.livesdk.widgets.container.interfaces.PagableViewProvider$OnPagingLifecycleListener<DataType, ContentViewType extends android.view.View> */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v3, resolved type: com.youku.live.livesdk.widgets.container.interfaces.PagableViewProvider$OnPagingLifecycleListener<DataType, ContentViewType extends android.view.View> */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v1, resolved type: com.youku.live.livesdk.widgets.container.interfaces.PagableViewProvider$OnPagingLifecycleListener<DataType, ContentViewType extends android.view.View> */
    /* JADX DEBUG: Multi-variable search result rejected for r2v2, resolved type: com.youku.live.livesdk.widgets.container.interfaces.PagableViewProvider$OnPagingLifecycleListener<DataType, ContentViewType extends android.view.View> */
    /* JADX DEBUG: Multi-variable search result rejected for r0v7, resolved type: com.youku.live.livesdk.widgets.container.interfaces.PagableViewProvider$PagingContentCreator<ContentViewType extends android.view.View> */
    /* JADX WARN: Multi-variable type inference failed */
