...
public class KeyboardHeightProvider extends PopupWindow {
    ...
    public KeyboardHeightProvider(Activity activity2) {
        super(activity2);
        this.activity = activity2;
        View inflate = ((LayoutInflater) activity2.getSystemService("layout_inflater")).inflate(R.layout.dago_container_popupwindow, (ViewGroup) null, false);
        this.popupView = inflate;
        setContentView(inflate);
        setSoftInputMode(21);
        setInputMethodMode(1);
        this.parentView = activity2.findViewById(16908290);
        setWidth(0);
        setHeight(-1);
    ...
    private int getScreenOrientation() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-612433833")) {
            return this.activity.getResources().getConfiguration().orientation;
        }
        return ((Integer) ipChange.ipc$dispatch("-612433833", new Object[]{this})).intValue();
    }
