...
public class LiveStatusBarUtil {
    ...
    private static View createStatusBarView(Activity activity, @ColorInt int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1222255401")) {
            return createStatusBarView(activity, i, 0);
        }
        return (View) ipChange.ipc$dispatch("1222255401", new Object[]{activity, Integer.valueOf(i)});
    }
    ...
    public static int getStatusBarHeight(Context context) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1107332809")) {
            return ((Integer) ipChange.ipc$dispatch("-1107332809", new Object[]{context})).intValue();
        }
                ...
                if (i3 < 21) {
                    ...
                    if (z) {
                        ...
                        coordinatorLayout.post(new Runnable() {
                            /* class com.youku.live.livesdk.wkit.utils.LiveStatusBarUtil.AnonymousClass1 */
                            private static transient /* synthetic */ IpChange $ipChange;

                            public void run() {
                                IpChange ipChange = $ipChange;
                                if (AndroidInstantRuntime.support(ipChange, "907153052")) {
                                    ipChange.ipc$dispatch("907153052", new Object[]{this});
                                    return;
                                }
