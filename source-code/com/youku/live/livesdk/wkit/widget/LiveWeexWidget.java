...
public class LiveWeexWidget extends BaseWidget implements IWXRenderListener, ICall, IDataHandler, IActivityBackPressedListener, IActivityConfigurationOrientationChangedListener, IActivityLifecycleStateChangedListener {
    ...
    private Runnable asyncRenderActionRunnable = new Runnable() {
        /* class com.youku.live.livesdk.wkit.widget.LiveWeexWidget.AnonymousClass7 */
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void renderImpl(final String str, final Map<String, Object> map, final String str2) {
        IpChange ipChange = $ipChange;
        ...
        if (!WXSoInstallMgrSdk.isCPUSupport()) {
            ...
            if (i < 0 || i >= getMaxCheckInitializedCount()) {
                ...
                getEngineInstance().delayRunOnMainThread(new Runnable() {
                    /* class com.youku.live.livesdk.wkit.widget.LiveWeexWidget.AnonymousClass2 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    public void run() {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "391167672")) {
                            ipChange.ipc$dispatch("391167672", new Object[]{this});
                            return;
                        }
    ...
    private void showKickoutDialog(String str) {
        ...
        dialogConfig.onOkBtnClickListener = new DagoLiveDialog.OnDialogButtonClickListener() {
            /* class com.youku.live.livesdk.wkit.widget.LiveWeexWidget.AnonymousClass3 */
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // com.youku.live.livesdk.wkit.dialog.DagoLiveDialog.OnDialogButtonClickListener
            public void onClick(View view) {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-544663559")) {
                    ipChange.ipc$dispatch("-544663559", new Object[]{this, view});
                    return;
                }
        ...
        dagoLiveDialog.setOnKeyListener(new DialogInterface.OnKeyListener() {
            /* class com.youku.live.livesdk.wkit.widget.LiveWeexWidget.AnonymousClass4 */
            private static transient /* synthetic */ IpChange $ipChange;

            public boolean onKey(DialogInterface dialogInterface, int i, KeyEvent keyEvent) {
                IpChange ipChange = $ipChange;
                if (!AndroidInstantRuntime.support(ipChange, "-89256574")) {
                    return true;
                }
                return ((Boolean) ipChange.ipc$dispatch("-89256574", new Object[]{this, dialogInterface, Integer.valueOf(i), keyEvent})).booleanValue();
            }
        });
        FrameLayout frameLayout = this.mRootView;
        if (frameLayout != null) {
            frameLayout.postDelayed(new Runnable() {
                /* class com.youku.live.livesdk.wkit.widget.LiveWeexWidget.AnonymousClass5 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void run() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-198372843")) {
                        ipChange.ipc$dispatch("-198372843", new Object[]{this});
                        return;
                    }
                    Activity activity = activity;
                    if (activity != null && !activity.isFinishing()) {
    ...
    public void destroy() {
        ...
        WidgetSDKEngine.getInstance().getRenderMananger().postOnUiThread(new Runnable() {
            /* class com.youku.live.livesdk.wkit.widget.LiveWeexWidget.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "587681177")) {
                    ipChange.ipc$dispatch("587681177", new Object[]{this});
                    return;
                }
                WeexWidgetView weexWidgetView = weexWidgetView;
                if (weexWidgetView != null) {
    ...
    public View getRealView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1327370566")) {
            return this.mRealView;
        }
        return (View) ipChange.ipc$dispatch("-1327370566", new Object[]{this});
    }
    ...
    public void onActivityConfigurationChanged(Configuration configuration) {
        ...
        getEngineInstance().runOnMainThread(new Runnable() {
            /* class com.youku.live.livesdk.wkit.widget.LiveWeexWidget.AnonymousClass6 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-394886348")) {
                    ipChange.ipc$dispatch("-394886348", new Object[]{this});
                    return;
                }
    ...
    public void onActivityConfigurationOrientationChanged(final int i) {
        ...
        getEngineInstance().runOnMainThread(new Runnable() {
            /* class com.youku.live.livesdk.wkit.widget.LiveWeexWidget.AnonymousClass8 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "-787913358")) {
                    ipChange.ipc$dispatch("-787913358", new Object[]{this});
                    return;
                }
                LiveWeexWidget.this.setWeexScreenType(i);
            }
    ...
    public void onDataChanged(String str, Object obj, Object obj2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1477186616")) {
            ...
            if (obj != null && (obj instanceof Boolean) && (weexWidgetView = this.mRealView) != null) {
                ...
                weexWidgetView.setVisibility(i);
            }
