...
public class BaseSlideWidget extends BaseWidget implements IDataHandler, IActivityConfigurationOrientationChangedListener {
    ...
    public void didMount() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-942391306")) {
            ...
            this.frameLayout.setStatusListener(new BaseSlideLayout.StatusListener() {
                /* class com.youku.live.livesdk.wkit.widget.slide.BaseSlideWidget.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.youku.live.livesdk.wkit.widget.slide.BaseSlideLayout.StatusListener
                public void onHideContent() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1774963285")) {
                        ipChange.ipc$dispatch("1774963285", new Object[]{this});
                        return;
                    }
                ...
                public void onShowContent() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "-58254768")) {
                        ipChange.ipc$dispatch("-58254768", new Object[]{this});
                        return;
                    }
                ...
                public void onTouchClick(int i, int i2, int i3) {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1179014958")) {
                        ipChange.ipc$dispatch("1179014958", new Object[]{this, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)});
                        return;
                    }
    ...
    public LiveWeexWidget findLiveWeexWidget(String str, String str2) {
        ...
        LiveWeexWidget liveWeexWidget = null;
        IEngineInstance engineInstance = getEngineInstance();
        if (engineInstance == null) {
            return null;
        }
        IWidget findWidgetById = engineInstance.findWidgetById(str);
        if (findWidgetById instanceof LiveWeexWidget) {
            liveWeexWidget = (LiveWeexWidget) findWidgetById;
        }
