...
public class SystemBarTintManager {
    ...
    public static class SystemBarConfig {
        ...
        private float getSmallestWidthDp(Activity activity) {
            ...
            return Math.min(((float) com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getwidthPixels(displayMetrics)) / f, ((float) com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getheightPixels(displayMetrics)) / f);
        }
        ...
        private SystemBarConfig(Activity activity, boolean z, boolean z2) {
            ...
            this.mHasNavigationBar = navigationBarHeight > 0 ? true : z3;
    ...
    public SystemBarConfig getConfig() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2070211624")) {
            return this.mConfig;
        }
        return (SystemBarConfig) ipChange.ipc$dispatch("2070211624", new Object[]{this});
    }

    public boolean isNavBarTintEnabled() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1008534009")) {
            return this.mNavBarTintEnabled;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1008534009", new Object[]{this})).booleanValue();
    }

    public boolean isStatusBarTintEnabled() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-83249008")) {
            return this.mStatusBarTintEnabled;
        }
        return ((Boolean) ipChange.ipc$dispatch("-83249008", new Object[]{this})).booleanValue();
    }
