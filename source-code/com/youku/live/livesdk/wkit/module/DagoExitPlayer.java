...
public class DagoExitPlayer extends WXModule implements Destroyable, ILiveActivityActions, IDataHandler {
    ...
    public boolean isEnterPipMode() {
        ...
        if (!isCIBN() && this.isSupportPip && this.isPipSwitchOpen && this.isPipSwitchEnableLayout && ConfigUtil.isPipSwitchOpen() && !isLandscape()) {
            return true;
        }
        return false;
    }
    ...
    public boolean isInPipMode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "734866367")) {
            return this.isInPip;
        }
        return ((Boolean) ipChange.ipc$dispatch("734866367", new Object[]{this})).booleanValue();
    }
