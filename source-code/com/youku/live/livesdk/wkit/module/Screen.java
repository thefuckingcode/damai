    ...
    private void setOrientation(String str) {
        ...
        if (activity != null) {
            if ("portrait".equalsIgnoreCase(str) || "portraitUpsideDown".equalsIgnoreCase(str)) {
                ...
                setFullScreen(new HashMap<String, String>() {
                    /* class com.youku.live.livesdk.wkit.module.Screen.AnonymousClass1 */
                ...
                setFullScreen(new HashMap<String, String>() {
                    /* class com.youku.live.livesdk.wkit.module.Screen.AnonymousClass2 */
