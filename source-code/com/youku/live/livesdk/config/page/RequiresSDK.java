...
public class RequiresSDK {
    ...
    public boolean requireAilpSDK() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-3268903")) {
            return this.requireAilpSDK;
        }
        return ((Boolean) ipChange.ipc$dispatch("-3268903", new Object[]{this})).booleanValue();
    }

    public boolean requireDagoSDK() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-29696366")) {
            return this.requireDagoSDK;
        }
        return ((Boolean) ipChange.ipc$dispatch("-29696366", new Object[]{this})).booleanValue();
    }

    public boolean requireLaifengSDK() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1748652899")) {
            return this.requireLaifengSDK;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1748652899", new Object[]{this})).booleanValue();
    }
    ...
    public RequiresSDK setDagoSDK(boolean z) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1312383603")) {
            return this;
        }
        return (RequiresSDK) ipChange.ipc$dispatch("1312383603", new Object[]{this, Boolean.valueOf(z)});
    }
