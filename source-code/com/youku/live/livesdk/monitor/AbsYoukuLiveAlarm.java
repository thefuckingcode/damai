...
public class AbsYoukuLiveAlarm {
    ...
    private void buildArgs() {
        ...
        Map<String, String> argsMap2 = getArgsMap();
        if (argsMap2 != null) {
            for (Map.Entry<String, String> entry : argsMap2.entrySet()) {
                if (!z) {
                    sb.append(",");
                } else {
                    z = false;
    ...
    private String getErrorCode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2035700095")) {
            return stringEmptyChecker(this.errorCode, "");
        }
        return (String) ipChange.ipc$dispatch("-2035700095", new Object[]{this});
    }

    private String getErrorMessage() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1752920169")) {
            return stringEmptyChecker(this.errorMessage, "");
        }
        return (String) ipChange.ipc$dispatch("1752920169", new Object[]{this});
    }

    private String getModuleName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-951682463")) {
            return this.moduleName;
        }
        return (String) ipChange.ipc$dispatch("-951682463", new Object[]{this});
    }

    private String getPointName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-43947097")) {
            return this.pointName;
        }
        return (String) ipChange.ipc$dispatch("-43947097", new Object[]{this});
    }

    private static String stringEmptyChecker(String str, String str2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1922361561")) {
            return TextUtils.isEmpty(str) ? str2 : str;
        }
        return (String) ipChange.ipc$dispatch("-1922361561", new Object[]{str, str2});
    }
    ...
    public AbsYoukuLiveAlarm commitFailure() {
        ...
        try {
            ...
            Log.e(moduleName2, "Failure: " + getPointName() + "; " + getErrorCode() + "; " + getErrorMessage() + "; " + getArgs());
        } catch (Throwable th) {
            th.printStackTrace();
        }
        return this;
    ...
    public AbsYoukuLiveAlarm commitSuccess() {
        ...
        try {
            ...
            String moduleName2 = getModuleName();
            Log.e(moduleName2, "Success: " + getPointName() + "; " + getArgs());
        } catch (Throwable th) {
            th.printStackTrace();
        }
        return this;
