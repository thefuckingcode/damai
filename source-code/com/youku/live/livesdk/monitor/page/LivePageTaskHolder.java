...
public class LivePageTaskHolder {
    ...
    public boolean addPageNormalTask(Activity activity, Runnable runnable, String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-19638992")) {
            return addPageNormalTask(activity, runnable, str, 2);
        }
        return ((Boolean) ipChange.ipc$dispatch("-19638992", new Object[]{this, activity, runnable, str})).booleanValue();
    }
