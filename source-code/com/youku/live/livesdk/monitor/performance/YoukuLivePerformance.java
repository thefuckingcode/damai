...
public class YoukuLivePerformance extends AbsPerformance {
    ...
    private boolean hasFullInfoMtopEnd = false;
    private boolean hasFullInfoStart = false;
    private boolean hasLiveCoreFirstFrame = false;
    private boolean hasLiveCoreInfo = false;
    private boolean hasLiveFirstFrame = false;
    private boolean hasLiveStart = false;
    private boolean hasPkType = false;
    ...
    public YoukuLivePerformance setAudioHearSound(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_AUDIO_HEAR_SOUND, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setAudioJoinChannel(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_AUDIO_JOIN_CHANNEL, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setAudioRoomType() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-693634363")) {
            return setRoomType("2");
        }
        return (YoukuLivePerformance) ipChange.ipc$dispatch("-693634363", new Object[]{this});
    }
    ...
    public YoukuLivePerformance setAudioStart(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_AUDIO_START, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setChannelEnd(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_CHANNEL_END, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setChannelStart(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_CHANNEL_START, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setFullInfoMtopEnd() {
        ...
        } else if (this.hasFullInfoMtopEnd) {
            return this;
        } else {
    ...
    public YoukuLivePerformance setLiveCoreFirstFrame(long j) {
        ...
        if (!this.hasLiveCoreFirstFrame) {
            ...
            setMeasure(YoukuLivePerformanceConstants.MES_LIVE_CORE_FIRST_FRAME, (double) j);
        }
        return this;
    }
    ...
    public YoukuLivePerformance setLiveFirstFrame(long j) {
        ...
        if (!this.hasLiveFirstFrame) {
            ...
            setMeasure(YoukuLivePerformanceConstants.MES_LIVE_FIRST_FRAME, (double) j);
        }
        return this;
    }
    ...
    public YoukuLivePerformance setLiveStart(long j) {
        ...
        if (!this.hasLiveStart) {
            ...
            setMeasure(YoukuLivePerformanceConstants.MES_LIVE_START, (double) j);
        }
        return this;
    }
    ...
    public YoukuLivePerformance setLiveStatusLive() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-598988076")) {
            return setLiveStatus("1");
        }
        return (YoukuLivePerformance) ipChange.ipc$dispatch("-598988076", new Object[]{this});
    }

    public YoukuLivePerformance setLiveStatusPreview() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-522007386")) {
            return setLiveStatus("0");
        }
        return (YoukuLivePerformance) ipChange.ipc$dispatch("-522007386", new Object[]{this});
    }

    public YoukuLivePerformance setLiveStatusReplay() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1826112441")) {
            return setLiveStatus("2");
        }
        return (YoukuLivePerformance) ipChange.ipc$dispatch("1826112441", new Object[]{this});
    }

    public YoukuLivePerformance setLiveStatusUnknown() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "174796004")) {
            return setLiveStatus("0");
        }
        return (YoukuLivePerformance) ipChange.ipc$dispatch("174796004", new Object[]{this});
    }
    ...
    public YoukuLivePerformance setNavigateEnd(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_NAVIGATE_END, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setNavigateStart(long j) {
        ...
        if (!hasMeasure(YoukuLivePerformanceConstants.MES_NAVIGATE_START)) {
            setMeasure(YoukuLivePerformanceConstants.MES_NAVIGATE_START, (double) j);
        }
        return this;
    }
    ...
    public YoukuLivePerformance setOtherRoomType() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "434077515")) {
            return setRoomType("0");
        }
        return (YoukuLivePerformance) ipChange.ipc$dispatch("434077515", new Object[]{this});
    }
    ...
    public YoukuLivePerformance setPageEnd(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_PAGE_END, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setPageStart(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_PAGE_START, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setPlayControlEnd(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_PLAY_CONTROL_END, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setPlayControlStart(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_PLAY_CONTROL_START, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setTemplateEnd(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_TEMPLATE_END, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setTemplateStart(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_TEMPLATE_START, (double) j);
        return this;
    }

    public YoukuLivePerformance setVideoRoomType() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1300578048")) {
            return setRoomType("1");
        }
        return (YoukuLivePerformance) ipChange.ipc$dispatch("-1300578048", new Object[]{this});
    }
    ...
    public YoukuLivePerformance setWeexEnd(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_WEEX_END, (double) j);
        return this;
    }
    ...
    public YoukuLivePerformance setWeexStart(long j) {
        ...
        setMeasure(YoukuLivePerformanceConstants.MES_WEEX_START, (double) j);
        return this;
    }
}
