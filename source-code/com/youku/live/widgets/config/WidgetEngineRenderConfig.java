...
public class WidgetEngineRenderConfig {
    ...
    public boolean isAppearLevelPlugin(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1367715569")) {
            return getRenderModel().isAppearRenderPlugin(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("-1367715569", new Object[]{this, str})).booleanValue();
    }

    public boolean isAppearLevelWidget(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1900849822")) {
            return getRenderModel().isAppearRenderWidget(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("1900849822", new Object[]{this, str})).booleanValue();
    }
}
