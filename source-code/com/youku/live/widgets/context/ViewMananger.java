...
public class ViewMananger implements IDestroyable, IViewMananger {
    ...
    private Queue<Object> getElements(String str) {
        ...
        Map<String, Queue<Object>> cache2 = getCache();
        Queue<Object> queue = cache2.get(str);
        if (queue != null) {
            return queue;
        }
        synchronized (this) {
            if (cache2.get(str) == null) {
                cache2.put(str, new LinkedList());
            }
        }
    ...
    public void destroy() {
        ...
        Map<String, Queue<Object>> cache2 = getCache();
        if (cache2 != null) {
            for (Map.Entry<String, Queue<Object>> entry : cache2.entrySet()) {
