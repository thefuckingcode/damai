...
public class PerfMonitorImp implements ILog, IPerfMonitor {
    ...
    private PerfMonitorImp(String str, String str2) {
        ...
        this.disableTLogDebug = (!OptConfigUtils.isOpenOpt() || !OptConfigUtils.getConfig("disableTLogDebug", true)) ? false : z;
    ...
    private ILog getLogger() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-236777518")) {
            return this;
        }
        return (ILog) ipChange.ipc$dispatch("-236777518", new Object[]{this});
    }
    ...
    public void e(String str, String str2) {
        ...
        Throwable th = null;
        if (this.forceContainerThrowable) {
            th = new Throwable();
        }
    ...
    public int getDeviceScore() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-435194647")) {
            return this.deviceScore;
        }
        return ((Integer) ipChange.ipc$dispatch("-435194647", new Object[]{this})).intValue();
    }
    ...
    public IPerfMonitor perfCommitFailure() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-580743255")) {
            return this;
        }
        return (IPerfMonitor) ipChange.ipc$dispatch("-580743255", new Object[]{this});
    }
    ...
    public IPerfMonitor perfPointBegin(String str) {
        ...
        } else if (this.timestampBegin == 0 || getPointsDisabled().containsKey(str)) {
            return this;
        } else {
    ...
    public IPerfMonitor point(String str, String str2) {
        ...
        if (!this.disableTLogDebug) {
            ...
            logger2.i(str3, this.inst + "::" + str + "::" + timestamp + "::" + str2);
        }
        return this;
    }
    ...
    public IPerfMonitor pointError(String str, String str2) {
        ...
        ILog logger2 = getLogger();
        String str3 = this.tag;
        logger2.e(str3, this.inst + "::" + str + "::" + timestamp + "::" + str2);
        return this;
    }
    ...
    public IPerfMonitor pointWarn(String str, String str2) {
        ...
        ILog logger2 = getLogger();
        String str3 = this.tag;
        logger2.w(str3, this.inst + "::" + str + "::" + timestamp + "::" + str2);
        return this;
    }
