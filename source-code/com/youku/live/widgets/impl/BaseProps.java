...
public class BaseProps implements IProps {
    ...
    private Object getProp(String str) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "568005907")) {
            return getProps().get(str);
        }
        return ipChange.ipc$dispatch("568005907", new Object[]{this, str});
    }
    ...
    public boolean containsKey(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1579263484")) {
            return getProps().containsKey(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("1579263484", new Object[]{this, str})).booleanValue();
    }

    @Override // com.youku.live.widgets.protocol.IMap
    public Object get(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "562667088")) {
            return getProp(str);
        }
        return ipChange.ipc$dispatch("562667088", new Object[]{this, str});
    }
    ...
    public Map<String, Object> toMap() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1581562146")) {
            return new HashMap(getProps());
        }
        return (Map) ipChange.ipc$dispatch("1581562146", new Object[]{this});
    }
