...
public class BaseStyles implements IStyles {
    ...
    private Object getStyle(String str) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1021456059")) {
            return getStyles().get(str);
        }
        return ipChange.ipc$dispatch("1021456059", new Object[]{this, str});
    }
    ...
    public boolean containsKey(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1355075344")) {
            return getStyles().containsKey(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("-1355075344", new Object[]{this, str})).booleanValue();
    }

    @Override // com.youku.live.widgets.protocol.IMap
    public Object get(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1770726876")) {
            return getStyle(str);
        }
        return ipChange.ipc$dispatch("1770726876", new Object[]{this, str});
    }
