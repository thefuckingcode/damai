...
public abstract class BaseWidget implements IWidget {
    ...
    public boolean addChild(IWidget iWidget) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1892141201")) {
            return getChildren().add(iWidget);
        }
        return ((Boolean) ipChange.ipc$dispatch("1892141201", new Object[]{this, iWidget})).booleanValue();
    }
    ...
    public ActivityLifecycleState getActivityLifecycleState() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1742458560")) {
            return getEngineInstance().getActivityLifecycleState();
        }
        return (ActivityLifecycleState) ipChange.ipc$dispatch("1742458560", new Object[]{this});
    }
    ...
    public AppearState getAppearState() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2137667788")) {
            return this.mAppearState;
        }
        return (AppearState) ipChange.ipc$dispatch("-2137667788", new Object[]{this});
    }
    ...
    public IEngineInstance getEngineInstance() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1199897900")) {
            return this.mEngineInstance;
        }
        return (IEngineInstance) ipChange.ipc$dispatch("1199897900", new Object[]{this});
    }

    @Override // com.youku.live.widgets.protocol.IWidget
    public View getHostView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1995485057")) {
            return this.mHostView;
        }
        return (View) ipChange.ipc$dispatch("-1995485057", new Object[]{this});
    }

    public CSSLayout.LayoutParams getLandscapeLayoutParams() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-229916157")) {
            return this.mLandscapeLayoutParams;
        }
        return (CSSLayout.LayoutParams) ipChange.ipc$dispatch("-229916157", new Object[]{this});
    }

    @Override // com.youku.live.widgets.protocol2.lifecycle.IWidgetViewInitInterface
    ...
    public IWidget getParent() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-649305876")) {
            return this.mParent;
        }
        return (IWidget) ipChange.ipc$dispatch("-649305876", new Object[]{this});
    }

    public CSSLayout.LayoutParams getPortraitLayoutParams() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "71170093")) {
            return this.mPortraitLayoutParams;
        }
        return (CSSLayout.LayoutParams) ipChange.ipc$dispatch("71170093", new Object[]{this});
    }

    @Override // com.youku.live.widgets.protocol.IWidget
    public IProps getProps() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-848604026")) {
            return this.mWidgetProps;
        }
        return (IProps) ipChange.ipc$dispatch("-848604026", new Object[]{this});
    }

    @Override // com.youku.live.widgets.protocol.IWidget
    public View getRealView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1484378807")) {
            return this.mHostView;
        }
        return (View) ipChange.ipc$dispatch("-1484378807", new Object[]{this});
    }
    ...
    public boolean isAppearLevel() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1394389505")) {
            return this.mIsAppearLevel;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1394389505", new Object[]{this})).booleanValue();
    }
