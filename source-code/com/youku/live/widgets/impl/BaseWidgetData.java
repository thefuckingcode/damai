...
public class BaseWidgetData implements IWidgetData {
    ...
    public IProps getOptions() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1306271850")) {
            return this.mOptions;
        }
        return (IProps) ipChange.ipc$dispatch("1306271850", new Object[]{this});
    }

    @Override // com.youku.live.widgets.protocol.IWidgetData
    public IProps getProps() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-113831044")) {
            return this.mProps;
        }
        return (IProps) ipChange.ipc$dispatch("-113831044", new Object[]{this});
    }
