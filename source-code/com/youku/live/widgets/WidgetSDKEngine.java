...
public class WidgetSDKEngine {
    ...
    public static void initWithParams(Map<String, String> map) {
        ...
        registerWidget(gl1.TYPE_OPEN_URL_WEEX, WeexWidget.class);
        try {
    ...
    public RenderMananger getRenderMananger() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1669107067")) {
            return this.mRenderManager;
        }
        return (RenderMananger) ipChange.ipc$dispatch("-1669107067", new Object[]{this});
    }
