...
public class CDNHelper implements ICDNInterface {
    ...
    public String blurUrl(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1874681084")) {
            return blurUrl(str, 15, 15);
        }
        return (String) ipChange.ipc$dispatch("-1874681084", new Object[]{this, str});
    }
    ...
    public String blurWithSize(String str, int i, int i2, int i3, int i4) {
        ...
        } else if (TextUtils.isEmpty(str) || i < 0 || i2 < 0 || i > 50 || i2 > 50 || !isOSSDomain(new UriCDNInfo(str).host)) {
            return str;
        } else {
    ...
    public String decideUrl(String str, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1974886077")) {
            return decideUrl(str, i, i2, false);
        }
        return (String) ipChange.ipc$dispatch("-1974886077", new Object[]{this, str, Integer.valueOf(i), Integer.valueOf(i2)});
    }
    ...
    public String blurUrl(String str, int i, int i2) {
        ...
        } else if (TextUtils.isEmpty(str) || i < 0 || i2 < 0 || i > 50 || i2 > 50) {
            return str;
        } else {
    ...
    public String decideUrl(String str, int i, int i2, boolean z) {
        ...
        } else if (TextUtils.isEmpty(str) || i <= 0 || i2 <= 0 || str.endsWith(".gif") || str.endsWith(".webp")) {
            return str;
        } else {
            UriCDNInfo uriCDNInfo = new UriCDNInfo(str);
            StringBuilder sb = new StringBuilder(str);
