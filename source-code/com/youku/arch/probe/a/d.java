...
public class d {
                ...
                while (rawQuery2.moveToNext()) {
                    ...
                    if (d > 0.0d) {
                        ...
                        if (i7 >= 3 && i > 0) {
                            ...
                            cursor = rawQuery;
                            if (((double) i7) / Double.valueOf((double) i).doubleValue() >= 0.5d) {
    ...
    public String a(String str) {
        ...
        if (this.b != null) {
            ...
            if (i2 > 0) {
                ...
                Collections.sort(a2);
                String a3 = b.a(a2, 10.0d);
                String a4 = b.a(a2, 50.0d);
                String a5 = b.a(a2, 90.0d);
                sb2.append(a3);
                sb2.append("/");
                sb2.append(a4);
                sb2.append("/");
    ...
    public boolean e() {
        ...
        if (this.b != null) {
            ...
            sQLiteDatabase.execSQL("delete from speed_history_table where id <((select max(id) from speed_history_table) - " + a.s + jl1.BRACKET_END_STR);
