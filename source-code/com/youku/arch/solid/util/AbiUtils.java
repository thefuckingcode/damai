...
public class AbiUtils {
    ...
    public static AbiType getCpuArchValueFromApk() {
        ...
        if (!supportedAbis.contains(cpuAbi)) {
            return (!supportedAbis.contains("arm64-v8a") && supportedAbis.contains("armeabi-v7a")) ? AbiType.ABI_32 : abiType;
        }
        if (!cpuAbi.startsWith("arm64") && cpuAbi.startsWith("arm")) {
            return AbiType.ABI_32;
        }
        return abiType;
    }
    ...
    public static boolean isLibraryPath64ForVivo() {
        ...
        if (release.equals("5.1.1") || release.equals(a90.VER_CODE_OLD)) {
    ...
    public static boolean isSpecial32Device() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1630631672")) {
            return ((Boolean) ipChange.ipc$dispatch("-1630631672", new Object[0])).booleanValue();
        }
        return !isLibraryPath64ForVivo() || isXiaomiX86();
    }
