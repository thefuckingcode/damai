...
import com.edge.pcdn.IDownloadListener;
...
public class PcdnDownloaderImpl implements IDownloader {
    ...
    public class PcdnDownloadItemWrapper {
        ...
        public boolean isValid() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "-320454048")) {
                return (this.pcdnRet <= 0 || this.item == null || this.listener == null || this.remainingCount == null || this.hasError == null) ? false : true;
            }
            return ((Boolean) ipChange.ipc$dispatch("-320454048", new Object[]{this})).booleanValue();
        }
    ...
    /* compiled from: Taobao */
    public class SolidPcdnListener implements IDownloadListener {
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    public void init() {
        ...
        if (this.downloader.init(PCDN_INIT_ID, "utdid=" + UTDevice.getUtdid(Solid.getInstance().getApplication())) == 0) {
            z = true;
        }
        this.hasPcdnInit = z;
        reportPcdnInit();
