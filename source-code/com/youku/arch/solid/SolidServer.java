...
public final class SolidServer {
    ...
    public static Status checkLibStatus(Context context, String str) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-2017751331")) {
            return checkLibStatus(context, str, Solid.getInstance().getElapseSinceLaunch());
        }
        return (Status) ipChange.ipc$dispatch("-2017751331", new Object[]{context, str});
    }
    ...
    private static Status checkSoStatusWithFile(Context context, String str) {
        ...
        } else if (new File(context.getApplicationInfo().nativeLibraryDir, str).exists()) {
            return Status.DOWNLOADED;
        } else {
    ...
    private static void registerOnSoGroupStatusChangeListener(SolidRequest solidRequest, final OnSoGroupStatusChangeListener onSoGroupStatusChangeListener) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "468033113")) {
            ...
            Solid.getInstance().executeTask(new Runnable() {
                /* class com.youku.arch.solid.SolidServer.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                public void run() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1834975416")) {
                        ipChange.ipc$dispatch("1834975416", new Object[]{this});
                        return;
                    }
            ...
            if (soGroupWithName == null) {
                ...
                Solid.getInstance().executeTask(new Runnable() {
                    /* class com.youku.arch.solid.SolidServer.AnonymousClass2 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    public void run() {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "1638461911")) {
                            ipChange.ipc$dispatch("1638461911", new Object[]{this});
                            return;
                        }
                        onSoGroupStatusChangeListener.onResponse(solidResponse2);
                    }
                });
