...
public class f {
    ...
    public static void a(d dVar) {
        ...
        create2.setValue("resCode", (double) dVar.a);
        create2.setValue("bandwidth_ori", (double) dVar.b);
        create2.setValue("bandwidth_new", (double) dVar.c);
        AppMonitor.Stat.commit("vpm", "ntk_interfere", create, create2);
        a.a(a, JSON.toJSONString(dVar));
    }
}
