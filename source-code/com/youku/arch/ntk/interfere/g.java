...
public class g {
    ...
    /* synthetic */ g(NtkNetworkDetector$1 ntkNetworkDetector$1) {
        this();
    }
    ...
    private a a(String str, String[] strArr, int i, int i2) {
        ...
        j[] jVarArr = gVar.b;
        if (jVarArr.length > 0) {
            com.youku.arch.ntk.a.d[] dVarArr = jVarArr[0].a;
            i3 = 0;
        ...
        return new a(i5, i4, i3, str2, i2, arrayList);
    }
