    ...
    private void gatherBasicInfo(Messenger.Message message) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1532652356")) {
            ...
            if (userInfo != null) {
                ...
                if (VipUserService.getInstance().getUserInfo().memberId != null) {
                    str = VipUserService.getInstance().getUserInfo().memberId;
                } else {
                    str = "";
                }
                content4.viptype = str;
                Content content5 = message.data.content;
                if (VipUserService.getInstance().getUserInfo().uName != null) {
                    str2 = VipUserService.getInstance().getUserInfo().uName;
                } else {
                    str2 = "";
                }
                content5.userNick = str2;
            }
            ...
            Content content6 = message.data.content;
            content6.chipset = Build.BOARD;
            content6.deviceType = com.alibaba.wireless.security.aopsdk.replace.android.os.Build.getMODEL();
            content6.osVer = Build.VERSION.getRELEASE();
            int netType = getNetType(this.mContext);
            Content content7 = message.data.content;
            content7.network = "" + netType;
            if (netType == 1000) {
            ...
            Content content8 = this.mMessage.data.content;
            content8.actionId = "";
            content8.actionShow = "";
            content8.actionNum = "";
            content8.networkQuality = SmartEvaluator.getInstance().getNetQuality().toString();
            Content content9 = this.mMessage.data.content;
            content9.deviceNetScore = "" + SmartEvaluator.getInstance().getDeviceNetQualityScore(this.mContext);
        }
    }
    ...
    private void gatherSigInfo(Messenger.Message message) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1579673671")) {
            ...
            if (!data.content.eventInfos.isEmpty()) {
                ...
                String str3 = hashMap.get("showid");
                Content content2 = message.data.content;
                if (TextUtils.isEmpty(str3)) {
                    str3 = str2;
                }
                content2.actionShow = str3;
                String str4 = hashMap.get("hbid");
                Content content3 = message.data.content;
                if (!TextUtils.isEmpty(str4)) {
                    str2 = str4;
                }
                content3.actionNum = str2;
            }
