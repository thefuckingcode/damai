...
public class ApasConfigCenter {
    ...
    public boolean containsNamespace(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-457715081")) {
            return !TextUtils.isEmpty(str) && Apas.getInstance().getNamespace(str) != null;
        }
        return ((Boolean) ipChange.ipc$dispatch("-457715081", new Object[]{this, str})).booleanValue();
    }

    public String getConfig(String str, String str2, String str3) {
        String stringValue;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1658412363")) {
            return (String) ipChange.ipc$dispatch("-1658412363", new Object[]{this, str, str2, str3});
        }
        return (TextUtils.isEmpty(str2) || TextUtils.isEmpty(str) || Apas.getInstance().getNamespace(str) == null || Apas.getInstance().getNamespace(str).getConfig(0) == null || (stringValue = Apas.getInstance().getNamespace(str).getConfig(0).getStringValue(str2)) == null || "null".equals(stringValue)) ? str3 : stringValue;
    }
