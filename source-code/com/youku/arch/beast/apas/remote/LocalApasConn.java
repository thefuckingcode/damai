...
public class LocalApasConn implements IApasConn {
    ...
    public boolean containsNamespace(String str) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-898231553")) {
            return ApasConfigCenter.getInstance().containsNamespace(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("-898231553", new Object[]{this, str})).booleanValue();
    }

    @Override // com.youku.arch.beast.apas.remote.IApasConn
    public String getConfig(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1595121453")) {
            return ApasConfigCenter.getInstance().getConfig(str, str2, str3);
        }
        return (String) ipChange.ipc$dispatch("1595121453", new Object[]{this, str, str2, str3});
    }

    @Override // com.youku.arch.beast.apas.remote.IApasConn
    public Map getConfigs(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "719979105")) {
            return ApasConfigCenter.getInstance().getConfigs(str);
        }
        return (Map) ipChange.ipc$dispatch("719979105", new Object[]{this, str});
    }
