...
public class Apas {
    ...
    private boolean mApsEnabled = true;
    ...
    private boolean mUseExtraInfo = false;
    ...
    private Apas() {
        ...
        OrangeConfig.getInstance().registerListener(new String[]{"aps_config"}, new OConfigListener() {
            /* class com.youku.arch.beast.apas.Apas.AnonymousClass1 */
            ...
            public void onConfigUpdate(String str, Map<String, String> map) {
                ...
                String config = OrangeConfig.getInstance().getConfig("aps_config", "aps_enable", "1");
                Apas.this.mApsEnabled = "1".equals(config);
                Logger.d("apas", "aps_enable:" + Apas.this.mApsEnabled);
                String config2 = OrangeConfig.getInstance().getConfig("aps_config", "aps_use_extra_info", "0");
                Apas.this.mUseExtraInfo = "1".equals(config2);
    ...
    public boolean apsEnabled() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-604721578")) {
            return this.mApsEnabled;
        }
        return ((Boolean) ipChange.ipc$dispatch("-604721578", new Object[]{this})).booleanValue();
    }
    ...
    public String getClientIp() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-874160243")) {
            return this.mClientIp;
        }
        return (String) ipChange.ipc$dispatch("-874160243", new Object[]{this});
    }
    ...
    public boolean hasSentInitialRequest() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1753285890")) {
            return this.mSendInitialRequest;
        }
        return ((Boolean) ipChange.ipc$dispatch("1753285890", new Object[]{this})).booleanValue();
    }
    ...
    public boolean isLocalMode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-142836197")) {
            return this.mLocalMode;
        }
        return ((Boolean) ipChange.ipc$dispatch("-142836197", new Object[]{this})).booleanValue();
    }
