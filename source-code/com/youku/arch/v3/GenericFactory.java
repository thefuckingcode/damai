...
public class GenericFactory<PRODUCT, CONFIG> {
    ...
    public final ICreator<PRODUCT, CONFIG> getDefaultCreator() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1196521057")) {
            return this.defaultCreator;
        }
        return (ICreator) ipChange.ipc$dispatch("1196521057", new Object[]{this});
    }
    ...
    public /* synthetic */ GenericFactory(ICreator iCreator, int i, m40 m40) {
