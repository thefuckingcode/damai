...
public final class PageStateManager implements ILoadingViewListener {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bf\u0018\u00002\u00020\u0001J&\u0010\b\u001a\u00020\u00072\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\b\u0010\u0004\u001a\u0004\u0018\u00010\u00022\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005H&¨\u0006\t"}, d2 = {"Lcom/youku/arch/v3/page/state/PageStateManager$OnStateChangeListener;", "", "Lcom/youku/arch/v3/page/state/State;", "oldState", "newState", "", "message", "Ltb/ur2;", "onStateChanged", "konearch_release"}, k = 1, mv = {1, 5, 1})
    /* compiled from: Taobao */
    ...
    public PageStateManager(@Nullable Context context) {
        StateView stateView2 = new StateView(context, null, 0, 6, null);
        this.stateView = stateView2;
        stateView2.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
    }
    ...
    public final State getCurrentState() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "480594562")) {
            ...
            State currentState2 = stateView2 == null ? null : stateView2.getCurrentState();
    ...
    public final OnStateChangeListener getOnStateChangeListener() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1779678020")) {
            return this.onStateChangeListener;
        }
        return (OnStateChangeListener) ipChange.ipc$dispatch("-1779678020", new Object[]{this});
    }

    public final boolean isStateViewEnable() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "989367366")) {
            return this.isStateViewEnable;
        }
        return ((Boolean) ipChange.ipc$dispatch("989367366", new Object[]{this})).booleanValue();
    }
    ...
    public final void setOnConfigStateViewListener(@Nullable OnConfigStateViewListener onConfigStateViewListener) {
        ...
        } else if (this.isStateViewEnable && (stateView2 = this.stateView) != null) {
            stateView2.setOnConfigStateViewListener(onConfigStateViewListener);
        }
    }

    public final void setOnStateChangeListener(@Nullable OnStateChangeListener onStateChangeListener2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1512326382")) {
            ipChange.ipc$dispatch("1512326382", new Object[]{this, onStateChangeListener2});
            return;
        }
    ...
    public final void setStateProperty(@NotNull State state, @Nullable IStateView iStateView) {
        ...
        k21.i(state, "state");
        if (this.isStateViewEnable && (stateView2 = this.stateView) != null) {
            stateView2.setStateProperty(state, iStateView);
        }
    }
    ...
    public final void setState(@NotNull State state, @Nullable String str) {
        ...
        if (onStateChangeListener2 != null) {
            onStateChangeListener2.onStateChanged(this.currentState, state, str);
        }
    ...
    public final void setStateProperty(@NotNull State state, int i) {
        ...
        k21.i(state, "state");
        if (this.isStateViewEnable && (stateView2 = this.stateView) != null) {
            stateView2.setStateProperty(state, i);
        }
    }
    ...
    public final void setStateProperty(@NotNull State state, @Nullable OnCreateStateViewListener onCreateStateViewListener) {
        ...
        StateView stateView2 = this.stateView;
        if (stateView2 != null) {
            stateView2.setStateProperty(state, onCreateStateViewListener);
        }
    }
}
