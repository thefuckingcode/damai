...
public final class StateView extends FrameLayout {
    ...
    public static final class StateProperty {
        ...
        public final OnCreateStateViewListener getCreateStateViewListener() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "245636323")) {
                return this.createStateViewListener;
            }
            return (OnCreateStateViewListener) ipChange.ipc$dispatch("245636323", new Object[]{this});
        }

        public final int getLayoutId() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "641873094")) {
                return this.layoutId;
            }
            return ((Integer) ipChange.ipc$dispatch("641873094", new Object[]{this})).intValue();
        }

        @Nullable
        public final IStateView getView() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-1115214330")) {
                return this.view;
            }
            return (IStateView) ipChange.ipc$dispatch("-1115214330", new Object[]{this});
        }
    ...
    public /* synthetic */ StateView(Context context, AttributeSet attributeSet, int i, int i2, m40 m40) {
    ...
    public final State getCurrentState() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1906762467")) {
            return this.currentState;
        }
        return (State) ipChange.ipc$dispatch("1906762467", new Object[]{this});
    }
    ...
    public final void setOnConfigStateViewListener(@Nullable OnConfigStateViewListener onConfigStateViewListener2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-190562838")) {
            ipChange.ipc$dispatch("-190562838", new Object[]{this, onConfigStateViewListener2});
            return;
        }
        this.onConfigStateViewListener = onConfigStateViewListener2;
    }
    ...
    public final void setState(@NotNull State state) {
        ...
        if (stateProperty != null) {
            ...
            OnConfigStateViewListener onConfigStateViewListener2 = this.onConfigStateViewListener;
            if (onConfigStateViewListener2 != null) {
                onConfigStateViewListener2.onConfigStateView(view == null ? null : view.getContentView(), state);
            }
        }
    ...
    public final void setStateProperty(@NotNull State state, @Nullable IStateView iStateView) {
        ...
        if (stateProperty.getView() != iStateView) {
            if (iStateView == null || (contentView = iStateView.getContentView()) == null) {
                viewParent = null;
            } else {
            ...
            if (viewGroup != null) {
                IStateView view2 = stateProperty.getView();
                viewGroup.removeView(view2 == null ? null : view2.getContentView());
            }
            stateProperty.setView(iStateView);
        }
        if (iStateView != null) {
            view = iStateView.getContentView();
        }
        if (view != null) {
