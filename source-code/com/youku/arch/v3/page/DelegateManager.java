...
public final class DelegateManager {
    ...
    public DelegateManager(@NotNull String str, @NotNull Context context2) {
        k21.i(str, "pageName");
    ...
    public final DelegateConfigure getDelegateConfigure() {
        ...
        if (this.delegateConfigure == null) {
            ...
            this.delegateConfigure = (DelegateConfigure) configParser.parse(context2, Uri.parse("android.resource://" + ((Object) this.context.getPackageName()) + "/raw/" + this.pageName + "_delegate_config"), DelegateConfigure.class);
        }
