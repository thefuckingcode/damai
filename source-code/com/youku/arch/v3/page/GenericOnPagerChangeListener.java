...
public final class GenericOnPagerChangeListener implements ViewPager.OnPageChangeListener {
    ...
    public GenericOnPagerChangeListener(@Nullable ActivityInterceptor activityInterceptor2) {
        this.activityInterceptor = activityInterceptor2;
    }
    ...
    public void onPageScrollStateChanged(int i) {
        ...
        if (activityInterceptor2 != null) {
            activityInterceptor2.onPageScrollStateChanged(i);
        }
    }
    ...
    public void onPageScrolled(int i, float f, int i2) {
        ...
        ActivityInterceptor activityInterceptor2 = this.activityInterceptor;
        if (activityInterceptor2 != null) {
            activityInterceptor2.onPageScrolled(i, f, i2);
        }
    }
    ...
    public void onPageSelected(int i) {
        ...
        ActivityInterceptor activityInterceptor2 = this.activityInterceptor;
        if (activityInterceptor2 != null) {
            activityInterceptor2.onPageSelected(i);
        }
    }
}
