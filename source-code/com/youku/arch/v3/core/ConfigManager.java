...
public final class ConfigManager implements Serializable {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u000e\u0010\u000fJ\u001e\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u000e\u0010\u0005\u001a\n\u0012\u0002\b\u0003\u0012\u0002\b\u00030\u0004J\u000e\u0010\b\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u0002R'\u0010\n\u001a\u0010\u0012\f\u0012\n\u0012\u0002\b\u0003\u0012\u0002\b\u00030\u00040\t8\u0006@\u0006¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\r¨\u0006\u0010"}, d2 = {"Lcom/youku/arch/v3/core/ConfigManager$CreatorConfig;", "Ljava/io/Serializable;", "", "type", "Lcom/youku/arch/v3/ICreator;", "creator", "Ltb/ur2;", "addCreator", "removeCreator", "Landroid/util/SparseArray;", "creators", "Landroid/util/SparseArray;", "getCreators", "()Landroid/util/SparseArray;", "<init>", "()V", "konearch_release"}, k = 1, mv = {1, 5, 1})
    /* compiled from: Taobao */
    public static final class CreatorConfig implements Serializable {
        ...
        public final SparseArray<ICreator<?, ?>> getCreators() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-1532176013")) {
                return this.creators;
            }
            return (SparseArray) ipChange.ipc$dispatch("-1532176013", new Object[]{this});
        }
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u000e\u0010\u000fJ\u001e\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u000e\u0010\u0005\u001a\n\u0012\u0002\b\u0003\u0012\u0002\b\u00030\u0004J\u000e\u0010\b\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u0002R'\u0010\n\u001a\u0010\u0012\f\u0012\n\u0012\u0002\b\u0003\u0012\u0002\b\u00030\u00040\t8\u0006@\u0006¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\r¨\u0006\u0010"}, d2 = {"Lcom/youku/arch/v3/core/ConfigManager$ParserConfig;", "Ljava/io/Serializable;", "", "type", "Lcom/youku/arch/v3/core/parser/IParser;", "parser", "Ltb/ur2;", "addParser", "removeParser", "Landroid/util/SparseArray;", "parsers", "Landroid/util/SparseArray;", "getParsers", "()Landroid/util/SparseArray;", "<init>", "()V", "konearch_release"}, k = 1, mv = {1, 5, 1})
    /* compiled from: Taobao */
    public static final class ParserConfig implements Serializable {
        ...
        public final SparseArray<IParser<?, ?>> getParsers() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-939810467")) {
                return this.parsers;
            }
            return (SparseArray) ipChange.ipc$dispatch("-939810467", new Object[]{this});
        }
    ...
    public final IPresenterCreator<?, ?, ?> getPresenterCreator() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1469565244")) {
            return this.presenterCreator;
        }
        return (IPresenterCreator) ipChange.ipc$dispatch("-1469565244", new Object[]{this});
    }

    @Nullable
    public final IViewCreator getViewCreator() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "936630574")) {
            return this.viewCreator;
        }
        return (IViewCreator) ipChange.ipc$dispatch("936630574", new Object[]{this});
    }

    @Nullable
    public final IViewDataBinder getViewDataBinder() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-30939622")) {
            return this.viewDataBinder;
        }
        return (IViewDataBinder) ipChange.ipc$dispatch("-30939622", new Object[]{this});
    }
