...
public final class GenericComponent$clearItems$1 extends Lambda implements Function0<ur2> {
    private static transient /* synthetic */ IpChange $ipChange;
    final /* synthetic */ GenericComponent<VALUE> this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GenericComponent$clearItems$1(GenericComponent<VALUE> genericComponent) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1421182298")) {
            ipChange.ipc$dispatch("-1421182298", new Object[]{this});
            return;
        }
