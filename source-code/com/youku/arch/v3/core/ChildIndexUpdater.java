...
public final class ChildIndexUpdater<T extends Addressable> implements OnChildAttachStateChangeListener {
    ...
    public final boolean getChanged() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-390685365")) {
            return this.changed;
        }
        return ((Boolean) ipChange.ipc$dispatch("-390685365", new Object[]{this})).booleanValue();
    }

    public final boolean hasChanged() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "596532111")) {
            return this.changed;
        }
        return ((Boolean) ipChange.ipc$dispatch("596532111", new Object[]{this})).booleanValue();
    }
        ...
        if (AndroidInstantRuntime.support(ipChange, "268483159")) {
            ...
            if (!z) {
                ...
                if (size >= 0) {
                    ...
                    while (true) {
                        int i2 = i + 1;
                        ((Addressable) list.get(i)).setIndex(i);
                        if (i2 > size) {
                            break;
                        }
                        i = i2;
