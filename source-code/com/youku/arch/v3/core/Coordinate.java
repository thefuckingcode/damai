...
public final class Coordinate {
    ...
    public final int getComponentIndex() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1532623194")) {
            return this.componentIndex;
        }
        return ((Integer) ipChange.ipc$dispatch("1532623194", new Object[]{this})).intValue();
    }

    public final int getItemIndex() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "133436738")) {
            return this.itemIndex;
        }
        return ((Integer) ipChange.ipc$dispatch("133436738", new Object[]{this})).intValue();
    }

    public final int getModuleIndex() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1375259995")) {
            return this.moduleIndex;
        }
        return ((Integer) ipChange.ipc$dispatch("1375259995", new Object[]{this})).intValue();
    }

    public int hashCode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1747405872")) {
            return (((this.moduleIndex * 31) + this.componentIndex) * 31) + this.itemIndex;
        }
        return ((Integer) ipChange.ipc$dispatch("1747405872", new Object[]{this})).intValue();
    }

    public final boolean isComponentCoordinate() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-651541269")) {
            return this.isComponentCoordinate;
        }
        return ((Boolean) ipChange.ipc$dispatch("-651541269", new Object[]{this})).booleanValue();
    }

    public final boolean isContainerCoordinate() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1512543257")) {
            return this.isContainerCoordinate;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1512543257", new Object[]{this})).booleanValue();
    }

    public final boolean isItemCoordinate() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1186976153")) {
            return this.isItemCoordinate;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1186976153", new Object[]{this})).booleanValue();
    }

    public final boolean isModuleCoordinate() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "844755310")) {
            return this.isModuleCoordinate;
        }
        return ((Boolean) ipChange.ipc$dispatch("844755310", new Object[]{this})).booleanValue();
    }
    ...
    public String toString() {
        ...
        return "pos@[" + this.moduleIndex + AVFSCacheConstants.COMMA_SEP + this.componentIndex + AVFSCacheConstants.COMMA_SEP + this.itemIndex + jl1.ARRAY_END;
    }
