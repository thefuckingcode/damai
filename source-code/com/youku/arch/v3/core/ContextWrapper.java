...
public class ContextWrapper implements IContext {
    ...
    public final IContext getBase() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "639957703")) {
            return this.base;
        }
        return (IContext) ipChange.ipc$dispatch("639957703", new Object[]{this});
    }
    ...
    public IContext getBaseContext() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "53879300")) {
            return this.base;
        }
        return (IContext) ipChange.ipc$dispatch("53879300", new Object[]{this});
    }
