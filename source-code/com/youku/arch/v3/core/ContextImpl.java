...
public final class ContextImpl implements IContext {
    ...
    public Activity getActivity() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-367770556")) {
            return this.activity;
        }
        return (Activity) ipChange.ipc$dispatch("-367770556", new Object[]{this});
    }
    ...
    public ActivityValue getActivityValue() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1412810449")) {
            return this.activityValue;
        }
        return (ActivityValue) ipChange.ipc$dispatch("1412810449", new Object[]{this});
    }
    ...
    public Application getApplication() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "340437846")) {
            return this.application;
        }
        return (Application) ipChange.ipc$dispatch("340437846", new Object[]{this});
    }
    ...
    public Bundle getBundle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-966938475")) {
            return this.bundle;
        }
        return (Bundle) ipChange.ipc$dispatch("-966938475", new Object[]{this});
    }
    ...
    public ComponentCreatorManager getComponentCreatorManager() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1022090660")) {
            return this.componentCreatorManager;
        }
        return (ComponentCreatorManager) ipChange.ipc$dispatch("-1022090660", new Object[]{this});
    }
    ...
    public ConcurrentMap<String, Object> getConcurrentMap() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "216063974")) {
            return this.concurrentMap;
        }
        return (ConcurrentMap) ipChange.ipc$dispatch("216063974", new Object[]{this});
    }
    ...
    public ConfigManager getConfigManager() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-73648399")) {
            return this.configManager;
        }
        return (ConfigManager) ipChange.ipc$dispatch("-73648399", new Object[]{this});
    }
    ...
    public EventBus getEventBus() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-794664603")) {
            return this.eventBus;
        }
        return (EventBus) ipChange.ipc$dispatch("-794664603", new Object[]{this});
    }
    ...
    public String getPageName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1635252377")) {
            return this.pageName;
        }
        return (String) ipChange.ipc$dispatch("-1635252377", new Object[]{this});
    }
    ...
    public StyleManager getStyleManager() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1943722745")) {
            return this.styleManager;
        }
        return (StyleManager) ipChange.ipc$dispatch("-1943722745", new Object[]{this});
    }
    ...
    public void release() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1361627102")) {
            ...
            sb.append((Object) (eventBus2 == null ? null : eventBus2.getChannelId()));
            sb.append("] released");
    ...
    public void setActivity(@Nullable Activity activity2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-956308054")) {
            ipChange.ipc$dispatch("-956308054", new Object[]{this, activity2});
            return;
        }
    ...
    public void setActivityValue(@Nullable ActivityValue activityValue2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "890571281")) {
            ipChange.ipc$dispatch("890571281", new Object[]{this, activityValue2});
            return;
        }
    ...
    public void setApplication(@Nullable Application application2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "410099116")) {
            ipChange.ipc$dispatch("410099116", new Object[]{this, application2});
            return;
        }
    ...
    public void setBundle(@Nullable Bundle bundle2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-388239825")) {
            ipChange.ipc$dispatch("-388239825", new Object[]{this, bundle2});
            return;
        }
        this.bundle = bundle2;
    }
    ...
    public void setComponentCreatorManager(@Nullable ComponentCreatorManager componentCreatorManager2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "552252686")) {
            ipChange.ipc$dispatch("552252686", new Object[]{this, componentCreatorManager2});
            return;
        }
    ...
    public void setConcurrentMap(@Nullable ConcurrentMap<String, Object> concurrentMap2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1250112320")) {
            ipChange.ipc$dispatch("1250112320", new Object[]{this, concurrentMap2});
            return;
        }
    ...
    public void setConfigManager(@Nullable ConfigManager configManager2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1611111745")) {
            ipChange.ipc$dispatch("-1611111745", new Object[]{this, configManager2});
            return;
        }
    ...
    public void setEventBus(@Nullable EventBus eventBus2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1492104893")) {
            ipChange.ipc$dispatch("1492104893", new Object[]{this, eventBus2});
            return;
        }
    ...
    public void setStyleManager(@Nullable StyleManager styleManager2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1247808307")) {
            ipChange.ipc$dispatch("1247808307", new Object[]{this, styleManager2});
            return;
        }
