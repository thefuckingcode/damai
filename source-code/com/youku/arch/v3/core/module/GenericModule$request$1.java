...
public final class GenericModule$request$1 extends Lambda implements Function0<ur2> {
    private static transient /* synthetic */ IpChange $ipChange;
    final /* synthetic */ Callback $callback;
    final /* synthetic */ IRequest $request;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GenericModule$request$1(IRequest iRequest, Callback callback) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1000057024")) {
            ipChange.ipc$dispatch("1000057024", new Object[]{this});
            return;
        }
