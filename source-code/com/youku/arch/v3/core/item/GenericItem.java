...
public class GenericItem<VALUE extends ItemValue> implements IItem<VALUE> {
    ...
    public int getChildCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1976937286")) {
            return this.childCount;
        }
        return ((Integer) ipChange.ipc$dispatch("1976937286", new Object[]{this})).intValue();
    }
    ...
    public IContainer<ModelValue> getContainer() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-375408003")) {
            return getComponent().getContainer();
        }
        return (IContainer) ipChange.ipc$dispatch("-375408003", new Object[]{this});
    }
    ...
    public Coordinate getCoordinate() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1457914148")) {
            return new Coordinate(getModule().getIndex(), getComponent().getIndex(), getIndex());
        }
        return (Coordinate) ipChange.ipc$dispatch("1457914148", new Object[]{this});
    }
    ...
    public EventHandler getEventHandler() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2137863523")) {
            return this.eventHandler;
        }
        return (EventHandler) ipChange.ipc$dispatch("-2137863523", new Object[]{this});
    }
    ...
    public Bundle getExtra() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1491561592")) {
            return this.extra;
        }
        return (Bundle) ipChange.ipc$dispatch("1491561592", new Object[]{this});
    }
    ...
    public IModule<ModuleValue> getModule() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1069746627")) {
            return getComponent().getModule();
        }
        return (IModule) ipChange.ipc$dispatch("1069746627", new Object[]{this});
    }

    @Nullable
    public final Node getNode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1935676016")) {
            return this.node;
        }
        return (Node) ipChange.ipc$dispatch("-1935676016", new Object[]{this});
    }
    ...
    public IContext getPageContext() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "60782060")) {
            return this.pageContext;
        }
        return (IContext) ipChange.ipc$dispatch("60782060", new Object[]{this});
    }
    ...
    public VALUE getProperty() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1199204345")) {
            return (VALUE) ((ItemValue) ipChange.ipc$dispatch("1199204345", new Object[]{this}));
        }
    ...
    public final Node getRawNode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "242335750")) {
            return this.rawNode;
        }
        return (Node) ipChange.ipc$dispatch("242335750", new Object[]{this});
    }
    ...
    public RequestBuilder getRequestBuilder() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1916615997")) {
            return this.requestBuilder;
        }
        return (RequestBuilder) ipChange.ipc$dispatch("-1916615997", new Object[]{this});
    }
    ...
    public int getType() {
        ...
        return typeConvertManager.convertType(i, property2, node2 == null ? null : node2.getData());
    }
    ...
    public void initProperties(@NotNull Node node2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1004344177")) {
            ipChange.ipc$dispatch("1004344177", new Object[]{this, node2});
            return;
        }
        k21.i(node2, "data");
    ...
    public void setEventHandler(@Nullable EventHandler eventHandler2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "625682087")) {
            ipChange.ipc$dispatch("625682087", new Object[]{this, eventHandler2});
            return;
        }
    ...
    public final void setNode(@Nullable Node node2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "568986980")) {
            ipChange.ipc$dispatch("568986980", new Object[]{this, node2});
            return;
        }
        this.node = node2;
    }
    ...
    public final void setRawNode(@Nullable Node node2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-955944938")) {
            ipChange.ipc$dispatch("-955944938", new Object[]{this, node2});
            return;
        }
        this.rawNode = node2;
    }
    ...
    public void setRequestBuilder(@Nullable RequestBuilder requestBuilder2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-950402773")) {
            ipChange.ipc$dispatch("-950402773", new Object[]{this, requestBuilder2});
            return;
        }
    ...
    public GenericItem(@NotNull IContext iContext, @NotNull Node node2) {
        k21.i(iContext, com.youku.arch.v3.data.Constants.PAGE_CONTEXT);
        k21.i(node2, "node");
        setPageContext(iContext);
        this.node = node2;
