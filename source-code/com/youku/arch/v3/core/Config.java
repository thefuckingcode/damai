...
public final class Config<T> {
    ...
    public final IContext getContext() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "59806001")) {
            return this.context;
        }
        return (IContext) ipChange.ipc$dispatch("59806001", new Object[]{this});
    }

    public final T getData() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "238866698")) {
            return this.data;
        }
        return (T) ipChange.ipc$dispatch("238866698", new Object[]{this});
    }

    public final int getIndex() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-527796903")) {
            return this.index;
        }
        return ((Integer) ipChange.ipc$dispatch("-527796903", new Object[]{this})).intValue();
    }

    public final int getType() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1843629685")) {
            return this.type;
        }
        return ((Integer) ipChange.ipc$dispatch("-1843629685", new Object[]{this})).intValue();
    }

    public final boolean isMerge() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "972603230")) {
            return this.isMerge;
        }
        return ((Boolean) ipChange.ipc$dispatch("972603230", new Object[]{this})).booleanValue();
    }
    ...
    public /* synthetic */ Config(IContext iContext, int i, Object obj, int i2, boolean z, int i3, m40 m40) {
