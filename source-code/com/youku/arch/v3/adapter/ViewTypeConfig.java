...
public class ViewTypeConfig {
    ...
    public Class<?> getDefaultHolderClass() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "706251859")) {
            return this.defaultHolderClass;
        }
        return (Class) ipChange.ipc$dispatch("706251859", new Object[]{this});
    }

    public int getDefaultLayoutResId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1358993452")) {
            return this.defaultLayoutResId;
        }
        return ((Integer) ipChange.ipc$dispatch("-1358993452", new Object[]{this})).intValue();
    }

    @Nullable
    public String getLayoutHelper() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1291440519")) {
            return this.layoutHelper;
        }
        return (String) ipChange.ipc$dispatch("1291440519", new Object[]{this});
    }
    ...
    public Integer getLayoutResId() {
        ...
        if (this.layoutResId == null) {
            ...
            String layoutResString2 = getLayoutResString();
            if (layoutResString2 == null || layoutResString2.length() == 0) {
                z = true;
            }
            if (!z) {
    ...
    public Integer getLayoutResIdOpt() {
        ...
        if (this.layoutResIdOpt == null) {
            ...
            String layoutResStringOpt2 = getLayoutResStringOpt();
            if (layoutResStringOpt2 == null || layoutResStringOpt2.length() == 0) {
                z = true;
            }
            if (!z) {
    ...
    public String getLayoutResString() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1853011534")) {
            return this.layoutResString;
        }
        return (String) ipChange.ipc$dispatch("1853011534", new Object[]{this});
    }

    @Nullable
    public String getLayoutResStringOpt() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "305375611")) {
            return this.layoutResStringOpt;
        }
        return (String) ipChange.ipc$dispatch("305375611", new Object[]{this});
    }

    @Nullable
    public String getModel() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1040275792")) {
            return this.model;
        }
        return (String) ipChange.ipc$dispatch("-1040275792", new Object[]{this});
    }

    @Nullable
    public String getModelOpt() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2081310169")) {
            return this.modelOpt;
        }
        return (String) ipChange.ipc$dispatch("2081310169", new Object[]{this});
    }

    @Nullable
    public HashMap<String, Object> getParams() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1959084786")) {
            return this.params;
        }
        return (HashMap) ipChange.ipc$dispatch("-1959084786", new Object[]{this});
    }
    ...
    public Class<?> getPreRenderClass() {
        ...
        if (!isInitPreRenderClass()) {
            String preRenderClassName2 = getPreRenderClassName();
            if (preRenderClassName2 == null || preRenderClassName2.length() == 0) {
                z = true;
            }
            if (!z) {
    ...
    public String getPreRenderClassName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2527257")) {
            return this.preRenderClassName;
        }
        return (String) ipChange.ipc$dispatch("2527257", new Object[]{this});
    }

    @Nullable
    public String getPresenter() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-554124625")) {
            return this.presenter;
        }
        return (String) ipChange.ipc$dispatch("-554124625", new Object[]{this});
    }

    @Nullable
    public String getPresenterOpt() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1913963142")) {
            return this.presenterOpt;
        }
        return (String) ipChange.ipc$dispatch("-1913963142", new Object[]{this});
    }

    @Nullable
    public String getRenderPluginFactory() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1808014616")) {
            return this.renderPluginFactory;
        }
        return (String) ipChange.ipc$dispatch("-1808014616", new Object[]{this});
    }

    @Nullable
    public String getView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1316735028")) {
            return this.view;
        }
        return (String) ipChange.ipc$dispatch("1316735028", new Object[]{this});
    }
    ...
    public Class<?> getViewHolderClass() {
        ...
        if (!isInitViewHolderClass()) {
            ...
            String viewHolderClassName2 = getViewHolderClassName();
            if (viewHolderClassName2 == null || viewHolderClassName2.length() == 0) {
                z = true;
            }
            if (!z) {
    ...
    public String getViewHolderClassName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1664574073")) {
            return this.viewHolderClassName;
        }
        return (String) ipChange.ipc$dispatch("1664574073", new Object[]{this});
    }

    @Nullable
    public String getViewOpt() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1370326485")) {
            return this.viewOpt;
        }
        return (String) ipChange.ipc$dispatch("1370326485", new Object[]{this});
    }

    public int getViewType() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "261928133")) {
            return this.viewType;
        }
        return ((Integer) ipChange.ipc$dispatch("261928133", new Object[]{this})).intValue();
    }

    public boolean isInitPreRenderClass() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1823152078")) {
            return this.isInitPreRenderClass;
        }
        return ((Boolean) ipChange.ipc$dispatch("1823152078", new Object[]{this})).booleanValue();
    }

    public boolean isInitViewHolderClass() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1090598334")) {
            return this.isInitViewHolderClass;
        }
        return ((Boolean) ipChange.ipc$dispatch("1090598334", new Object[]{this})).booleanValue();
    }
    ...
    public final HashMap<String, Object> wrapParams(@Nullable HashMap<String, Object> hashMap) {
        ...
        if (params3 != null) {
            hashMap.put("param", params3);
            if (params3.containsKey("span")) {
                Object obj = params3.get("span");
