...
public class ViewTypeSupport {
    ...
    @NotNull
    private final ViewTypeConfigCreatorManager viewTypeConfigCreatorManager = new ViewTypeConfigCreatorManager();
    @NotNull
    private final SparseArray<ViewTypeConfig> viewTypeConfigs = new SparseArray<>(160);
    ...
    public static final class Companion {
        ...
        public final boolean isEnableViewTypeConfigLazyParser() {
            ...
            if (AppInfoProviderProxy.isDebuggable()) {
                LogUtil.w("createViewConfig", k21.r("isEnableViewTypeConfigLazyParser: v = ", Boolean.valueOf(config)));
            }
            return config;
        }
    }
    ...
    public ViewTypeSupport(@NotNull String str) {
        ...
        ComponentConfigBean componentConfig2 = ComponentConfigManager.Companion.getInstance().getComponentConfig(application, str);
        if (componentConfig2 != null) {
            this.componentConfig = componentConfig2;
            initViewConfig(application, componentConfig2);
        }
    }
    ...
    private final ViewTypeConfig createViewTypeConfig(Context context, ComponentConfigBean.ComponentBean componentBean, ComponentConfigBean.ComponentBean.ItemBean itemBean, boolean z, boolean z2) {
        ...
        if (!z2) {
            Class<?> cls2 = this.defaultHolderClass;
            if (!(viewHolder == null || viewHolder.length() == 0)) {
                cls2 = ReflectionUtil.INSTANCE.tryGetClassForName(viewHolder);
            }
            viewTypeConfig.setViewHolderClass(cls2);
        }
        ...
        if (!z2) {
            ...
            if (!z3) {
                cls = ReflectionUtil.INSTANCE.tryGetClassForName(itemBean.getPreRender());
            }
    ...
    public ViewTypeConfig getViewTypeConfig(int i) {
        ...
        } else if (this.viewTypeConfigs.get(i) != null) {
    ...
    public final SparseArray<ViewTypeConfig> getViewTypeConfigs() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-712367019")) {
            return this.viewTypeConfigs;
        }
        return (SparseArray) ipChange.ipc$dispatch("-712367019", new Object[]{this});
    }
    ...
    public final void registerViewTypeConfigCreator(@NotNull TypeRange typeRange, @NotNull ViewTypeConfigCreator viewTypeConfigCreator) {
        ...
        k21.i(typeRange, "typeRange");
        k21.i(viewTypeConfigCreator, "viewTypeConfigCreator");
    ...
    public ViewTypeSupport(@NotNull ComponentConfigBean componentConfigBean) {
        k21.i(componentConfigBean, "componentConfig");
        this.componentConfig = componentConfigBean;
        Application application = AppInfoProviderProxy.getApplication();
        this.defaultLayoutResId = ViewUtil.getIdentifier(application, Constants.RES_DEFAULT_LAYOUT, "layout");
        this.defaultHolderClass = ReflectionUtil.INSTANCE.tryGetClassForName(Constants.CLASS_DEFAULT_VIEW_HOLDER);
        k21.h(application, WPKFactory.INIT_KEY_CONTEXT);
