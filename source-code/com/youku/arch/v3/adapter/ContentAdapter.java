...
public final class ContentAdapter extends DelegateAdapter {
    ...
    private final void addAdapterAfter(int i, List<? extends VBaseAdapter<?, ?>> list) {
        ...
        if (!z) {
            ...
            while (it.hasNext()) {
                i2 += ((VBaseAdapter) it.next()).dataCount;
            }
            addAdapters(i, list);
    ...
    private final void removeAdapterAfter(int i, List<? extends VBaseAdapter<?, ?>> list) {
        ...
        Iterator<? extends VBaseAdapter<?, ?>> it = list.iterator();
        while (it.hasNext()) {
            i3 += ((VBaseAdapter) it.next()).dataCount;
        }
        removeAdapters(list);
    ...
    public final VirtualLayoutManager getLayoutManager() {
        ...
        k21.h(virtualLayoutManager, "mLayoutManager");
        return virtualLayoutManager;
    }

    public final boolean hasConsistItemType() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1823967600")) {
            return this.hasConsistItemType;
        }
        return ((Boolean) ipChange.ipc$dispatch("1823967600", new Object[]{this})).booleanValue();
    }
