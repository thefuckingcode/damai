...
public final class ViewTypeConfigCreatorManager {
    ...
    public final ViewTypeConfig create(int i) {
        ...
        while (true) {
            ...
            T next = it.next();
            if (i <= next.getTypeEnd() && next.getTypeStart() <= i) {
                ViewTypeConfigCreator viewTypeConfigCreator = this.viewTypeConfigCreators.get(next);
                if (viewTypeConfigCreator != null) {
                    viewTypeConfig = viewTypeConfigCreator.create(i);
                }
