...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\n\u0018\u0000 \u00102\u00020\u0001:\u0001\u0010B\u0007¢\u0006\u0004\b\u000e\u0010\u000fJ\u0006\u0010\u0003\u001a\u00020\u0002J\u0006\u0010\u0005\u001a\u00020\u0004J\u0006\u0010\u0006\u001a\u00020\u0004R\"\u0010\b\u001a\u00020\u00078\u0006@\u0006X\u000e¢\u0006\u0012\n\u0004\b\b\u0010\t\u001a\u0004\b\n\u0010\u000b\"\u0004\b\f\u0010\r¨\u0006\u0011"}, d2 = {"Lcom/youku/arch/v3/ChildState;", "", "", "hasChanged", "Ltb/ur2;", "clearChanged", "setChanged", "Ljava/util/concurrent/atomic/AtomicInteger;", "changeCount", "Ljava/util/concurrent/atomic/AtomicInteger;", "getChangeCount", "()Ljava/util/concurrent/atomic/AtomicInteger;", "setChangeCount", "(Ljava/util/concurrent/atomic/AtomicInteger;)V", "<init>", "()V", "Companion", "konearch_release"}, k = 1, mv = {1, 5, 1})
...
public final class ChildState {
    ...
    public final void clearChanged() {
        ...
        if (AppInfoProviderProxy.isDebuggable()) {
            LogUtil.v(TAG, k21.r("clearChanged ", Integer.valueOf(this.changeCount.get())));
        }
    }
    ...
    public final AtomicInteger getChangeCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1178998904")) {
            return this.changeCount;
        }
        return (AtomicInteger) ipChange.ipc$dispatch("1178998904", new Object[]{this});
    }

    public final boolean hasChanged() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "543910337")) {
            return this.changeCount.get() > 0;
        }
        return ((Boolean) ipChange.ipc$dispatch("543910337", new Object[]{this})).booleanValue();
    }
    ...
    public final void setChanged() {
        ...
        if (AppInfoProviderProxy.isDebuggable()) {
            LogUtil.v(TAG, k21.r("setChanged ", Integer.valueOf(this.changeCount.get())));
        }
    }
}
