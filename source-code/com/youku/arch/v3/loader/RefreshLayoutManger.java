...
public final class RefreshLayoutManger implements ILoadingViewListener {
    ...
    public final RefreshLayout getRefreshLayout() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1285772939")) {
            return this.refreshLayout;
        }
        return (RefreshLayout) ipChange.ipc$dispatch("-1285772939", new Object[]{this});
    }
    ...
    public final void setRefreshLayout(@Nullable RefreshLayout refreshLayout2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1875537961")) {
            ipChange.ipc$dispatch("-1875537961", new Object[]{this, refreshLayout2});
            return;
        }
