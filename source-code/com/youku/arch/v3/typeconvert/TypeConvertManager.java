...
public final class TypeConvertManager {
    ...
    public final void addTypeConvert(int i, @NotNull ITypeConvertRule<Node, JSONObject> iTypeConvertRule) {
        ...
        k21.i(iTypeConvertRule, "typeConvertRule");
