...
public final class StyleManager implements LifecycleObserver {
    ...
    @NotNull
    private final List<IScene> scenes = new ArrayList();

    public StyleManager(@NotNull LifecycleOwner lifecycleOwner) {
        k21.i(lifecycleOwner, "host");
