...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007¢\u0006\u0004\b\u000e\u0010\u000fJ\u0014\u0010\u0005\u001a\u0004\u0018\u00010\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0003H\u0002J\u0016\u0010\t\u001a\u00020\b2\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00020\u0006H\u0016J\u000e\u0010\r\u001a\u00020\f2\u0006\u0010\u000b\u001a\u00020\n¨\u0006\u0010"}, d2 = {"Lcom/youku/arch/v3/data/RemoteFileDataLoader;", "Lcom/youku/arch/v3/data/DataLoader;", "Lcom/youku/arch/v3/data/RequestContext;", "", a.V, "getJSONData", "Lcom/youku/arch/v3/data/Chain;", "chain", "Ltb/ur2;", "process", "Ljava/io/InputStream;", "inStream", "", lf1.OPERATION_READ, "<init>", "()V", "konearch_release"}, k = 1, mv = {1, 5, 1})
...
public final class RemoteFileDataLoader implements DataLoader<RequestContext> {
    ...
    public void process(@NotNull Chain<RequestContext> chain) {
        ...
        if (!(bundle == null || (uri = (Uri) bundle.getParcelable("uri")) == null || (!k21.d("http", uri.getScheme()) && !k21.d("https", uri.getScheme())))) {
            ...
            if (z) {
                ...
                jSONObject.put((Object) "data", (Object) new JSONObject());
            } else {
                build.setRetCode("SUCCESS");
                build.setRetMessage("调用成功");
                jSONObject.put((Object) "data", (Object) JSON.parseObject(jSONData));
            }
    ...
    public final byte[] read(@NotNull InputStream inputStream) throws Exception {
        ...
        while (true) {
            ...
            if (read != -1) {
                ...
                k21.h(byteArray, "outStream.toByteArray()");
                return byteArray;
            }
        }
    }
