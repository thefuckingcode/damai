...
public final class DataLoaderChain<T extends RequestContext> implements Chain<T> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: java.util.List<? extends com.youku.arch.v3.data.DataLoader<T extends com.youku.arch.v3.data.RequestContext>> */
    /* JADX WARN: Multi-variable type inference failed */
    public DataLoaderChain(@NotNull List<? extends DataLoader<T>> list, int i) {
        k21.i(list, "interceptors");
    ...
    public T getParam() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-493346269")) {
            return (T) ((RequestContext) ipChange.ipc$dispatch("-493346269", new Object[]{this}));
        }
        T t = this.param;
        if (t != null) {
            return t;
