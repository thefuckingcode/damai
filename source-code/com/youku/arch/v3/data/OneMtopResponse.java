...
public final class OneMtopResponse extends Response implements IMtopResponse {
    ...
    public static final class Builder extends Response.Builder {
        ...
        public Response build() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "-1852499855")) {
                return new OneMtopResponse(this);
            }
            return (Response) ipChange.ipc$dispatch("-1852499855", new Object[]{this});
        }

        @Nullable
        public final String getMappingCode() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "-2132942174")) {
                return this.mappingCode;
            }
            return (String) ipChange.ipc$dispatch("-2132942174", new Object[]{this});
        }

        public final int getResponseCode() {
            IpChange ipChange = $ipChange;
            if (!AndroidInstantRuntime.support(ipChange, "485987158")) {
                return this.responseCode;
            }
            return ((Integer) ipChange.ipc$dispatch("485987158", new Object[]{this})).intValue();
        }
    ...
    public String getMappingCode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "871283737")) {
            return this.mappingCode;
        }
        return (String) ipChange.ipc$dispatch("871283737", new Object[]{this});
    }

    @Override // com.youku.arch.v3.io.IMtopResponse
    public int getResponseCode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "289422029")) {
            return this.responseCode;
        }
        return ((Integer) ipChange.ipc$dispatch("289422029", new Object[]{this})).intValue();
    }
