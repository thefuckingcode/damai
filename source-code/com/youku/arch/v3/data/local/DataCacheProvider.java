...
public final class DataCacheProvider extends ContentProvider {
    ...
    public int delete(@NotNull Uri uri, @NotNull String str, @NotNull String[] strArr) {
        ...
        LogUtil.e(TAG, k21.r("Unknown Uri:", uri));
        return 0;
    }
    ...
    public final CacheDBHelper getDbHelper() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1589521101")) {
            return this.dbHelper;
        }
        return (CacheDBHelper) ipChange.ipc$dispatch("1589521101", new Object[]{this});
    }
    ...
    public boolean onCreate() {
        ...
        if (getContext() != null) {
            MATCHER.addURI(k21.r(getContext().getPackageName(), AUTHORITY), TABLE_NAME, 1);
        }
    ...
    public Cursor query(@NotNull Uri uri, @NotNull String[] strArr, @NotNull String str, @NotNull String[] strArr2, @NotNull String str2) {
        ...
        k21.i(uri, "uri");
        k21.i(strArr, "projection");
        k21.i(str, "selection");
        k21.i(strArr2, "selectionArgs");
        k21.i(str2, "sortOrder");
        CacheDBHelper cacheDBHelper = this.dbHelper;
