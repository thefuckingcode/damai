...
public class Response implements IResponse {
    ...
    public static class Builder {
        ...
        public Response build() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "1946519943")) {
                return new Response(this);
            }
            return (Response) ipChange.ipc$dispatch("1946519943", new Object[]{this});
        }
        ...
        public final Builder setTraceId(@NotNull String str) {
            ...
            k21.i(str, ParamsConstants.Key.PARAM_TRACE_ID);
            this.traceId = str;
            return this;
        }
    }
    ...
    public final String getCacheTag() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1606941082")) {
            return this.cacheTag;
        }
        return (String) ipChange.ipc$dispatch("1606941082", new Object[]{this});
    }

    @Override // com.youku.arch.v3.io.IResponse
    public final long getId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-997949641")) {
            return this.id;
        }
        return ((Long) ipChange.ipc$dispatch("-997949641", new Object[]{this})).longValue();
    }
    ...
    public final String getRawData() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1956377914")) {
            return this.rawData;
        }
        return (String) ipChange.ipc$dispatch("-1956377914", new Object[]{this});
    }
    ...
    public final IRequest getRequest() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1455565772")) {
            return this.request;
        }
        return (IRequest) ipChange.ipc$dispatch("1455565772", new Object[]{this});
    }
    ...
    public final String getRetCode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-487231742")) {
            return this.retCode;
        }
        return (String) ipChange.ipc$dispatch("-487231742", new Object[]{this});
    }
    ...
    public final String getRetMessage() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-70101944")) {
            return this.retMessage;
        }
        return (String) ipChange.ipc$dispatch("-70101944", new Object[]{this});
    }
    ...
    public final String getSource() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2024823613")) {
            return this.source;
        }
        return (String) ipChange.ipc$dispatch("2024823613", new Object[]{this});
    }

    @Override // com.youku.arch.v3.io.IResponse
    public final long getTimestamp() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "27984810")) {
            return this.timestamp;
        }
        return ((Long) ipChange.ipc$dispatch("27984810", new Object[]{this})).longValue();
    }
    ...
    public final String getTraceId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-73839340")) {
            return this.traceId;
        }
        return (String) ipChange.ipc$dispatch("-73839340", new Object[]{this});
    }

    @Override // com.youku.arch.v3.io.IResponse
    public boolean isSuccess() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1198293599")) {
            return k21.d("SUCCESS", this.retCode);
        }
        return ((Boolean) ipChange.ipc$dispatch("1198293599", new Object[]{this})).booleanValue();
    }
