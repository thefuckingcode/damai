...
public final class Request implements IRequest {
    ...
    public static final class Builder {
        ...
        public final Request build() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "1161702197")) {
                return new Request(this);
            }
            return (Request) ipChange.ipc$dispatch("1161702197", new Object[]{this});
        }
        ...
        @NotNull
        public final Builder setBundle(@Nullable Bundle bundle2) {
            IpChange ipChange = $ipChange;
            if (AndroidInstantRuntime.support(ipChange, "2126991782")) {
                return (Builder) ipChange.ipc$dispatch("2126991782", new Object[]{this, bundle2});
            }
            this.bundle = bundle2;
            return this;
        }
    ...
    public String getApiName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1628354141")) {
            return this.apiName;
        }
        return (String) ipChange.ipc$dispatch("-1628354141", new Object[]{this});
    }
    ...
    public Bundle getBundle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "925989450")) {
            return this.bundle;
        }
        return (Bundle) ipChange.ipc$dispatch("925989450", new Object[]{this});
    }
    ...
    public String getCacheTag() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1028122704")) {
            return this.cacheTag;
        }
        return (String) ipChange.ipc$dispatch("1028122704", new Object[]{this});
    }
    ...
    public String getCustomDomain() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "435751981")) {
            return this.customDomain;
        }
        return (String) ipChange.ipc$dispatch("435751981", new Object[]{this});
    }
    ...
    public Map<String, Object> getDataParams() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1988859475")) {
            return this.dataParams;
        }
        return (Map) ipChange.ipc$dispatch("-1988859475", new Object[]{this});
    }
    ...
    public Map<String, String> getHeaders() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-384185743")) {
            return this.headers;
        }
        return (Map) ipChange.ipc$dispatch("-384185743", new Object[]{this});
    }

    @Override // com.youku.arch.v3.io.IRequest
    public long getId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1947114175")) {
            return this.id;
        }
        return ((Long) ipChange.ipc$dispatch("-1947114175", new Object[]{this})).longValue();
    }

    @Override // com.youku.arch.v3.io.IRequest
    public long getStrategy() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1637410217")) {
            return this.strategy;
        }
        return ((Long) ipChange.ipc$dispatch("1637410217", new Object[]{this})).longValue();
    }

    @Override // com.youku.arch.v3.io.IRequest
    public int getTimeout() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "452927860")) {
            return this.timeout;
        }
        return ((Integer) ipChange.ipc$dispatch("452927860", new Object[]{this})).intValue();
    }
    ...
    public String getVersion() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "539382582")) {
            return this.version;
        }
        return (String) ipChange.ipc$dispatch("539382582", new Object[]{this});
    }

    @Override // com.youku.arch.v3.io.IRequest
    public boolean isNeedCache() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-78983808")) {
            return this.isNeedCache;
        }
        return ((Boolean) ipChange.ipc$dispatch("-78983808", new Object[]{this})).booleanValue();
    }

    @Override // com.youku.arch.v3.io.IRequest
    public boolean isNeedECode() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1403781360")) {
            return this.isNeedECode;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1403781360", new Object[]{this})).booleanValue();
    }

    @Override // com.youku.arch.v3.io.IRequest
    public boolean isNeedSession() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1203231828")) {
            return this.isNeedSession;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1203231828", new Object[]{this})).booleanValue();
    }

    @Override // com.youku.arch.v3.io.IRequest
    public boolean isSync() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1240941835")) {
            return this.isSync;
        }
        return ((Boolean) ipChange.ipc$dispatch("1240941835", new Object[]{this})).booleanValue();
    }
    ...
    public void setBundle(@Nullable Bundle bundle2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1837016294")) {
            ipChange.ipc$dispatch("-1837016294", new Object[]{this, bundle2});
            return;
        }
        this.bundle = bundle2;
    }
