...
public class RequestContext {
    ...
    public final DataLoadCallback getCallback() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1725123518")) {
            return this.callback;
        }
        return (DataLoadCallback) ipChange.ipc$dispatch("1725123518", new Object[]{this});
    }

    public final long getId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-562913544")) {
            return this.id;
        }
        return ((Long) ipChange.ipc$dispatch("-562913544", new Object[]{this})).longValue();
    }

    @NotNull
    public final IRequest getRequest() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1368468587")) {
            return this.request;
        }
        return (IRequest) ipChange.ipc$dispatch("1368468587", new Object[]{this});
    }

    @Nullable
    public final IResponse getResponse() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2057719417")) {
            return this.response;
        }
        return (IResponse) ipChange.ipc$dispatch("2057719417", new Object[]{this});
    }
