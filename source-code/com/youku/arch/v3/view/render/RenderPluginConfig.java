...
public final class RenderPluginConfig {
    ...
    public final boolean isSupportRenderPlugin(@NotNull IContext iContext, @NotNull String str) {
        ...
        String renderPluginFactory2 = viewTypeConfig.getRenderPluginFactory();
        if (renderPluginFactory2 == null || renderPluginFactory2.length() == 0) {
            z = true;
        }
        if (!z) {
    ...
    public final void setSupportRenderPlugin(@NotNull String str, @NotNull RenderPluginFactory renderPluginFactory2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "736813164")) {
            ipChange.ipc$dispatch("736813164", new Object[]{this, str, renderPluginFactory2});
            return;
        }
        k21.i(str, "type");
        k21.i(renderPluginFactory2, "renderPluginFactory");
        this.renderPluginFactoryMap.put(str, renderPluginFactory2);
    }
    ...
    public final void setSupportRenderPlugin(@NotNull String str, @NotNull String str2) {
        ...
        k21.i(str, "type");
        k21.i(str2, "renderPluginClassName");
