...
public abstract class AbsRenderPlugin<DATA, CONFIG extends RenderConfig> {
    ...
    public void bindData(@Nullable Context context, @NotNull DATA data2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1098347345")) {
            ipChange.ipc$dispatch("-1098347345", new Object[]{this, context, data2});
            return;
        }
        k21.i(data2, "data");
        setData(data2);
    ...
    @Nullable
    public abstract View createView(@NotNull Context context, @NotNull CONFIG config2, @NotNull ViewGroup viewGroup);
    ...
    public final CONFIG getConfig() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "331250299")) {
            return (CONFIG) ((RenderConfig) ipChange.ipc$dispatch("331250299", new Object[]{this}));
        }
        CONFIG config2 = this.config;
        if (config2 != null) {
            return config2;
        }
        k21.A(com.youku.arch.v3.core.Constants.CONFIG);
        return null;
    }
    ...
    public final DATA getData() {
        ...
        k21.A("data");
        return (DATA) ur2.INSTANCE;
    }

    @Nullable
    public final OnRenderListener getOnRenderListener() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-38516271")) {
            return this.onRenderListener;
        }
        return (OnRenderListener) ipChange.ipc$dispatch("-38516271", new Object[]{this});
    }

    public final void setConfig(@NotNull CONFIG config2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1575629829")) {
            ipChange.ipc$dispatch("1575629829", new Object[]{this, config2});
            return;
        }
        k21.i(config2, "<set-?>");
        this.config = config2;
    ...
    public final void setData(@NotNull DATA data2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1688124930")) {
            ipChange.ipc$dispatch("-1688124930", new Object[]{this, data2});
            return;
        }
        k21.i(data2, "<set-?>");
        this.data = data2;
    ...
    public final void setOnRenderListener(@Nullable OnRenderListener onRenderListener2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-204363987")) {
            ipChange.ipc$dispatch("-204363987", new Object[]{this, onRenderListener2});
            return;
        }
