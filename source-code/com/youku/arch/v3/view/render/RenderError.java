...
public final class RenderError implements Serializable {
    ...
    public final int getErrorCode() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-530547769")) {
            return this.errorCode;
        }
        return ((Integer) ipChange.ipc$dispatch("-530547769", new Object[]{this})).intValue();
    }

    @NotNull
    public final String getErrorMsg() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "175147064")) {
            return this.errorMsg;
        }
        return (String) ipChange.ipc$dispatch("175147064", new Object[]{this});
    }
}
