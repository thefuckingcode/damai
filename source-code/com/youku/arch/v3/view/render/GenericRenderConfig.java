...
public class GenericRenderConfig extends RenderConfig {
    ...
    public final HashMap<String, Object> getExtra() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "287385337")) {
            return this.extra;
        }
        return (HashMap) ipChange.ipc$dispatch("287385337", new Object[]{this});
    }

    @Nullable
    public final Integer getLayoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1517126022")) {
            return this.layoutId;
        }
        return (Integer) ipChange.ipc$dispatch("1517126022", new Object[]{this});
    }

    @Nullable
    public final Integer getLayoutIdOpt() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1638508481")) {
            return this.layoutIdOpt;
        }
        return (Integer) ipChange.ipc$dispatch("-1638508481", new Object[]{this});
    }

    @Nullable
    public final String getLayoutStr() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-74095135")) {
            return this.layoutStr;
        }
        return (String) ipChange.ipc$dispatch("-74095135", new Object[]{this});
    }

    @Nullable
    public final String getLayoutStrOpt() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "698445064")) {
            return this.layoutStrOpt;
        }
        return (String) ipChange.ipc$dispatch("698445064", new Object[]{this});
    }

    @Nullable
    public final String getMClassName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "322565106")) {
            return this.mClassName;
        }
        return (String) ipChange.ipc$dispatch("322565106", new Object[]{this});
    }

    @Nullable
    public final String getMClassNameOpt() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2146313897")) {
            return this.mClassNameOpt;
        }
        return (String) ipChange.ipc$dispatch("-2146313897", new Object[]{this});
    }

    @Nullable
    public final String getPClassName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "356513487")) {
            return this.pClassName;
        }
        return (String) ipChange.ipc$dispatch("356513487", new Object[]{this});
    }

    @Nullable
    public final String getPClassNameOpt() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-107410086")) {
            return this.pClassNameOpt;
        }
        return (String) ipChange.ipc$dispatch("-107410086", new Object[]{this});
    }

    @Nullable
    public final String getVClassName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "424410249")) {
            return this.vClassName;
        }
        return (String) ipChange.ipc$dispatch("424410249", new Object[]{this});
    }

    @Nullable
    public final String getVClassNameOpt() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-324569760")) {
            return this.vClassNameOpt;
        }
        return (String) ipChange.ipc$dispatch("-324569760", new Object[]{this});
    }
