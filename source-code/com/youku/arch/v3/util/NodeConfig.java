...
public class NodeConfig {
    ...
    public static String getConfig(IItem<ItemValue> iItem, String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "415438517")) {
            return getConfig(iItem, str, "");
        }
        return (String) ipChange.ipc$dispatch("415438517", new Object[]{iItem, str});
    }
    ...
    public static String getConfig(IComponent<ComponentValue> iComponent, String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1768510071")) {
            return getConfig(iComponent, str, "");
        }
        return (String) ipChange.ipc$dispatch("1768510071", new Object[]{iComponent, str});
    }
    ...
    public static String getConfig(IModule<ModuleValue> iModule, String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1416684110")) {
            return getConfig(iModule, str, "");
        }
        return (String) ipChange.ipc$dispatch("1416684110", new Object[]{iModule, str});
    }
}
