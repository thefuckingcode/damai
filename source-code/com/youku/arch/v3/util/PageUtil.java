...
public final class PageUtil {
    ...
    public final GenericFactory<VBaseAdapter<IItem<ItemValue>, VBaseHolder<IItem<ItemValue>, GenericRenderConfig>>, Map<String, Object>> getDefaultAdapterFactory(@NotNull IContext iContext) {
        SparseArray<ICreator<?, ?>> sparseArray;
        int size;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v2, resolved type: com.youku.arch.v3.GenericFactory<com.youku.arch.v3.IComponent<com.youku.arch.v3.core.ComponentValue>, com.youku.arch.v3.core.Node> */
    /* JADX WARN: Multi-variable type inference failed */
    @NotNull
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v2, resolved type: com.youku.arch.v3.GenericFactory<com.youku.arch.v3.IItem<com.youku.arch.v3.core.ItemValue>, com.youku.arch.v3.core.Node> */
    /* JADX WARN: Multi-variable type inference failed */
    @NotNull
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v2, resolved type: com.youku.arch.v3.GenericFactory<com.youku.arch.v3.IModule<com.youku.arch.v3.core.ModuleValue>, com.youku.arch.v3.core.Node> */
    /* JADX WARN: Multi-variable type inference failed */
    @NotNull
    ...
    public final int getItemTypeByConfig(@NotNull GenericRenderConfig genericRenderConfig) {
        ...
        k21.i(genericRenderConfig, Constants.CONFIG);
        String type = genericRenderConfig.getType();
        if (type == null) {
            return 0;
        }
        if (Integer.parseInt(type) > 32768) {
