...
public class NetworkUtil {
    ...
    public static boolean isMobile(Application application) {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) application.getSystemService("connectivity");
        if (connectivityManager == null || (activeNetworkInfo = com.alibaba.wireless.security.aopsdk.replace.android.net.ConnectivityManager.getActiveNetworkInfo(connectivityManager)) == null || activeNetworkInfo.getType() != 0) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isNetworkAvailable(Application application) {
        NetworkInfo activeNetworkInfo;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "440475363")) {
            return ((Boolean) ipChange.ipc$dispatch("440475363", new Object[]{application})).booleanValue();
        }
        if (application == null || (activeNetworkInfo = com.alibaba.wireless.security.aopsdk.replace.android.net.ConnectivityManager.getActiveNetworkInfo((ConnectivityManager) application.getSystemService("connectivity"))) == null || !activeNetworkInfo.isConnected()) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isNetworkError(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1656536593")) {
            return "ANDROID_SYS_NETWORK_ERROR".equals(str) || "ANDROID_SYS_NO_NETWORK".equals(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("-1656536593", new Object[]{str})).booleanValue();
    }
    ...
    public static boolean isWifi(Application application) {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) application.getSystemService("connectivity");
        if (connectivityManager == null || (activeNetworkInfo = com.alibaba.wireless.security.aopsdk.replace.android.net.ConnectivityManager.getActiveNetworkInfo(connectivityManager)) == null || activeNetworkInfo.getType() != 1) {
            return false;
        }
        return true;
    }
