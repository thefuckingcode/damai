...
public class StatusBarUtils {
    ...
    public static boolean isFlyme4Later() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "2065379048")) {
            return ((Boolean) ipChange.ipc$dispatch("2065379048", new Object[0])).booleanValue();
        }
        if (Build.FINGERPRINT.contains("Flyme_OS_4") || Build.VERSION.INCREMENTAL.contains("Flyme_OS_4") || pattern.matcher(Build.DISPLAY).find()) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isMIUI6Later() {
        ...
        try {
            int parseInt = Integer.parseInt(((String) Class.forName("android.os.SystemProperties").getMethod(gl1.TYPE_OPEN_URL_METHOD_GET, String.class).invoke(null, "ro.miui.ui.version.name")).replaceAll("[vV]", ""));
    ...
    public static int mixtureColor(int i, @FloatRange(from = 0.0d, to = 1.0d) float f) {
        ...
        return (i & 16777215) | (((int) (((float) ((-16777216 & i) == 0 ? 255 : i >>> 24)) * f)) << 24);
    }
