...
public final class Data {
    ...
    public final long getAverageTime() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "654914951")) {
            return this.averageTime;
        }
        return ((Long) ipChange.ipc$dispatch("654914951", new Object[]{this})).longValue();
    }

    public final int getCount() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1555248865")) {
            return this.count;
        }
        return ((Integer) ipChange.ipc$dispatch("1555248865", new Object[]{this})).intValue();
    }

    public final long getMaxTime() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "893695072")) {
            return this.maxTime;
        }
        return ((Long) ipChange.ipc$dispatch("893695072", new Object[]{this})).longValue();
    }

    public final long getMinTime() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-929272910")) {
            return this.minTime;
        }
        return ((Long) ipChange.ipc$dispatch("-929272910", new Object[]{this})).longValue();
    }
