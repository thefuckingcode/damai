...
public final class DimenStrategyTokenManager extends StrategyTokenManager<Integer> {
    ...
    @NotNull
    private static final Lazy<DimenStrategyTokenManager> instance$delegate = b.a(LazyThreadSafetyMode.SYNCHRONIZED, DimenStrategyTokenManager$Companion$instance$2.INSTANCE);
    ...
    public static final class Companion {
        ...
        public final DimenStrategyTokenManager getInstance() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "-277237119")) {
                return (DimenStrategyTokenManager) DimenStrategyTokenManager.instance$delegate.getValue();
            }
            return (DimenStrategyTokenManager) ipChange.ipc$dispatch("-277237119", new Object[]{this});
        }
    }
