...
public final class ColorStrategyTokenManager extends StrategyTokenManager<Integer> {
    ...
    @NotNull
    private static final Lazy<ColorStrategyTokenManager> instance$delegate = b.a(LazyThreadSafetyMode.SYNCHRONIZED, ColorStrategyTokenManager$Companion$instance$2.INSTANCE);
    ...
    public static final class Companion {
        ...
        public final ColorStrategyTokenManager getInstance() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "-266091619")) {
                return (ColorStrategyTokenManager) ColorStrategyTokenManager.instance$delegate.getValue();
            }
            return (ColorStrategyTokenManager) ipChange.ipc$dispatch("-266091619", new Object[]{this});
        }
    }
