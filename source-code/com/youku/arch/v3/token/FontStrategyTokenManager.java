...
public final class FontStrategyTokenManager extends StrategyTokenManager<Integer> {
    ...
    @NotNull
    private static final Lazy<FontStrategyTokenManager> instance$delegate = b.a(LazyThreadSafetyMode.SYNCHRONIZED, FontStrategyTokenManager$Companion$instance$2.INSTANCE);
    ...
    public static final class Companion {
        ...
        public final FontStrategyTokenManager getInstance() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "176565059")) {
                return (FontStrategyTokenManager) FontStrategyTokenManager.instance$delegate.getValue();
            }
            return (FontStrategyTokenManager) ipChange.ipc$dispatch("176565059", new Object[]{this});
        }
    }
