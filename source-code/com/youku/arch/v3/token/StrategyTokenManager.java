...
public abstract class StrategyTokenManager<T> {
    ...
    public final String getDeviceType() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1581352517")) {
            return this.deviceType;
        }
        return (String) ipChange.ipc$dispatch("-1581352517", new Object[]{this});
    }
    ...
    public final String getMapAsStringValue(@NotNull Context context) {
        ...
        for (String str : this.tokenMap.keySet()) {
            k21.h(str, "token");
            jSONObject.put((Object) str, (Object) String.valueOf(getToken(context, str)));
        }
        String jSONString = jSONObject.toJSONString();
        k21.h(jSONString, "jsonObject.toJSONString()");
        return jSONString;
    }
    ...
    public final T getToken(@NotNull Context context, @NotNull String str) {
        ...
        k21.f(strategyTokenJavaBean);
        k21.h(strategyTokenJavaBean, "tokenMap[tokenKey]!!");
