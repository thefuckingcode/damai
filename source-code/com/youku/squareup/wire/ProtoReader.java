    ...
    public long readVarint64() throws IOException {
        ...
        if (i == 0 || i == 2) {
            ...
            for (int i2 = 0; i2 < 64; i2 += 7) {
                ...
                this.pos++;
                byte readByte = this.source.readByte();
                j |= ((long) (readByte & z7.DEL)) << i2;
                if ((readByte & as2.MAX_POWER_OF_TWO) == 0) {
                    afterPackableScalar(0);
                    return j;
                }
            }
