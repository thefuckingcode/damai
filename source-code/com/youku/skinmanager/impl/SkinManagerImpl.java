...
public class SkinManagerImpl implements ISkinManager {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        /* class com.youku.skinmanager.impl.SkinManagerImpl.AnonymousClass1 */
        ...
        public void onReceive(Context context, Intent intent) {
            if (!TextUtils.isEmpty(intent.getAction())) {
                ...
                if (action.equals(IPassport.ACTION_USER_LOOUT)) {
                    ...
                    } else if (!TextUtils.isEmpty(SkinManagerImpl.this.mSkinDTO.getType()) && SkinManagerImpl.this.mSkinDTO.getType().startsWith("vip")) {
