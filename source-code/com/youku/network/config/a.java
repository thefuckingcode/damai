...
public class a {
    ...
    static {
        ...
        b.put(oz0.FAIL_SYS_FLOWLIMIT, -4007);
        ...
        b.put(oz0.FAIL_SYS_TRAFFIC_LIMIT, -4017);
        ...
        b.put(oz0.FAIL_SYS_SERVICE_TIMEOUT, -4047);
        b.put(oz0.FAIL_SYS_SERVICE_FAULT, -4048);
        b.put("FAIL_SYS_HTTP_QUERYIP_ERROR", -4049);
        b.put("FAIL_SYS_HTTP_REQUESTSUBMIT_FAILED", -4050);
        b.put("FAIL_SYS_HTTP_INVOKE_ERROR", -4051);
        b.put(oz0.FAIL_SYS_HTTP_RESPONSE_TIMEOUT, -4052);
        b.put(oz0.FAIL_SYS_HTTP_CONNECT_TIMEOUT, -4053);
