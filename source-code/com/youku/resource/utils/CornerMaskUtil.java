...
public class CornerMaskUtil {
    ...
    public static void drawCornerMask(Context context, Canvas canvas, int i, String str, int i2, int i3, int i4) {
        if (!isInited) {
            ...
            int i5 = dpRad;
            gradientDrawable.setCornerRadii(new float[]{0.0f, 0.0f, (float) i5, (float) i5, 0.0f, 0.0f, (float) i5, (float) i5});
            isInited = true;
        }
        canvas.drawBitmap(makeTopRightBitmap(str, i2, i3, i4), (((float) i) - loc[2]) - ((float) (dp1 * 2)), 0.0f, getRTPaint());
    }
    ...
    private static Paint getRTPaint() {
        if (mRTPaint == null) {
            ...
            mRTPaint.setColor(-1);
            mRTPaint.setTextSize((float) dp9);
    ...
    private static float[] updateTopRight(String str) {
        ...
        fArr[2] = rTPaint.measureText(str);
        float f2 = fArr[2];
        int i = dp20;
        int i2 = dp4;
        if (f2 < ((float) (i - i2))) {
        ...
        int i3 = dp1;
        fArr[0] = ((float) i3) + (f / 2.0f);
        fArr[1] = (((((float) dp16) - fontMetrics.bottom) - fontMetrics.top) / 2.0f) - ((float) i3);
        return fArr;
    }
    ...
    public static void drawCornerMask(Context context, Canvas canvas, int i, String str, int i2) {
        ...
        canvas.drawBitmap(makeTopRightBitmap(str, Utils.getStartColor(context, i2), Utils.getEndColor(context, i2), i2 == 3 ? Color.parseColor("#FF4E2D03") : -1), (((float) i) - loc[2]) - ((float) (dp1 * 2)), 0.0f, getRTPaint());
    }
}
