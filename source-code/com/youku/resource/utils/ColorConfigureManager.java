...
public class ColorConfigureManager {
    ...
    public int getColorIntWithAlpha(String str, int i) {
        ...
        return getColorIntWithAlpha(intValue, i);
    }
    ...
    public String getColorMapLikeStringVaule() {
        ...
        for (Map.Entry<String, Integer> entry : this.colorMap.entrySet()) {
            ...
            float f = (float) ((intValue >> 24) & 255);
            float f2 = f == -1.0f ? 1.0f : f / 255.0f;
            jSONObject.put(entry.getKey(), (Object) ("rgba(" + ((16711680 & intValue) >> 16) + "," + ((65280 & intValue) >> 8) + "," + (intValue & 255) + "," + f2 + jl1.BRACKET_END_STR));
        }
