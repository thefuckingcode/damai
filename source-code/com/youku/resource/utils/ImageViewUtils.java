...
public final class ImageViewUtils {
    ...
    private static ThreadLocal<StringBuilder> sAppendingUrl = new ThreadLocal<StringBuilder>() {
        /* class com.youku.resource.utils.ImageViewUtils.AnonymousClass1 */
    ...
    public static boolean setImageUrlInBackgroundWithSize(TUrlImageView tUrlImageView, String str, int i, int i2) {
        ...
        if (appendSizeParamForR1YkimgCom != str) {
            return true;
        }
        return false;
    }
