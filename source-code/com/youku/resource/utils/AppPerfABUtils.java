...
public class AppPerfABUtils {
    ...
    private static boolean isDegradeDevice() {
        ...
        if (!TextUtils.isEmpty(model)) {
            ...
            while (true) {
                if (i3 >= length) {
                    break;
                } else if (model.equalsIgnoreCase(split[i3].trim())) {
                    i = 1;
                    break;
                } else {
                    i3++;
    ...
    public static boolean isForbidAutoPlay() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && mAutoPlayScore <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isForbidChannelPreload() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && sForbidChannelPreload <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isForbidDetailNotify() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && mDetailNotifyScore <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isForbidFeedPreload() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && mFeedPreloadScore <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isForbidGifImg() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && mForbidGifImg <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isForbidGuide() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && mGuideScore <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isForbidPoplayer() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && mForbidPoplayerScore <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isForbidRoundCorner() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && mRoundCornerScore <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isForbidUcModule() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && mForbidUcModule <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isNoOptLessRequestLayout() {
        ...
        if (mNoOptLessRequestLayout > 0 || !isOpenPerf()) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isNoResizeR1YkimgCom() {
        ...
        if (mNoResizeR1YkimgCom > 0 || !isOpenPerf()) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isOpenBackgroundSetImageUrlDouble() {
        ...
        if (sForbidBackgroundSetImageUrlDouble > 0 || !isOpenPerf()) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isOpenChannelVHPreload() {
        ...
        if (sForbidChannelVHPreload > 0 || !isOpenPerf()) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isOpenComponentFilter() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && mOpenComponentFilter <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    private static boolean isOpenDefaultDegrade() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && mDefaultDegradeScore <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    private static boolean isOpenDegradeSwitch() {
        if (isOpenDegradeMode == -1) {
            ...
            if (!isOpenPerf() || isOpenDegradeMode != 1) {
                return false;
            }
            return true;
        } else if (!isOpenPerf() || isOpenDegradeMode != 1) {
            return false;
        } else {
            return true;
        }
    ...
    public static boolean isOpenDoubleFeedImgPreload() {
        ...
        if (sForbidDoubleFeedImgPreload > 0 || !isOpenPerf()) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isOpenDoubleFeedVHPreload() {
        ...
        if (sForbidDoubleFeedVHPreload > 0 || !isOpenPerf()) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isOpenFeedVHPreload() {
        ...
        if (sForbidFeedVHPreload > 0 || !isOpenPerf()) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isOpenHomeLoadMoreAsynic() {
        ...
        if (sForbidHomeLoadMoreAsynic > 0 || !isOpenPerf()) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isOpenHomeVHPreload() {
        ...
        if (sForbidHomeVHPreload > 0 || !isOpenPerf()) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isOptHomeFrameTask() {
        ...
        if (!isOpenDegradeSwitch() || (!isDegradeDevice() && sOptHomeFrameTask <= getDeviceScore())) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isPreLoadFeedImg() {
        ...
        if (getDegradeMode() != 2 && isOpenPerf() && !isForbidPreLoadFeedImg()) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isPreLoadMore() {
        ...
        if (getDegradeMode() != 2 && isOpenPerf() && !isForbidPreLoadMore()) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isUseDoubleFeedVisualOpti() {
        return !isOpenDegrade() && !isForbidRoundCorner();
    }

    public static boolean isUseManualParse(boolean z) {
        if (z) {
            return isOpenPerf() && !isForbidManualParseFeed();
        }
        if (!isOpenPerf() || isForbidManualParse()) {
            return false;
        }
        return true;
    }
    ...
    public static void savePerfNobelAb() {
        ...
        } else if (!hitAB.equals(getDegradePrefs(NOBEL_KEY_LIGHT_WIDGET_BY_DEVICE, "none"))) {
        ...
        } else if (!hitAB2.equals(getDegradePrefs(NOBEL_KEY_DOUBLE_FEED_RELOAD, "none"))) {
