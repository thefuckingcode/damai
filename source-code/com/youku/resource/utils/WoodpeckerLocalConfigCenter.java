...
public class WoodpeckerLocalConfigCenter implements Serializable {
    ...
    public static String getCheckedVal(String str) {
        ArrayList arrayList;
        try {
            arrayList = (ArrayList) JSON.parseObject(HighPerfSPProviderProxy.getString(SP_NAME_SPACE, SP_CONFIGS_KEY, ""), new TypeReference<ArrayList<ConfigItem>>() {
                /* class com.youku.resource.utils.WoodpeckerLocalConfigCenter.AnonymousClass1 */
            }, new Feature[0]);
