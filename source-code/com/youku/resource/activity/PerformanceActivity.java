...
public class PerformanceActivity extends FragmentActivity {
    ...
    public class Demo2Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public Demo2Adapter(Context context2) {
    ...
    public class DemoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public DemoAdapter(Context context2) {
            this.context = context2;
            this.width = ((PerformanceActivity.this.mScreenWidth - (PerformanceActivity.this.dp3 * 4)) - ((PerformanceActivity.this.dp3 * 3) * 2)) / 4;
        }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void logPerTime(long j, long j2) {
        this.totalNumber++;
        this.totalTime = (this.totalTime + j) - j2;
        this.per_time.setText("平均耗时微秒==" + ((this.totalTime / 1000) / ((long) this.totalNumber)));
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        initAdapter();
        findViewById(R.id.custom_back).setOnClickListener(new View.OnClickListener() {
            /* class com.youku.resource.activity.PerformanceActivity.AnonymousClass1 */

            public void onClick(View view) {
                PerformanceActivity.this.finish();
            }
        });
        findViewById(R.id.custom_right).setOnClickListener(new View.OnClickListener() {
            /* class com.youku.resource.activity.PerformanceActivity.AnonymousClass2 */

            public void onClick(View view) {
                PerformanceActivity.this.totalNumber = 0;
                PerformanceActivity.this.totalTime = 0;
