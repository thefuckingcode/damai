...
public class DemoActivity extends FragmentActivity {
    ...
    public class DemoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public class ErrorViewHolder extends RecyclerView.ViewHolder {
            ...
            public ErrorViewHolder(View view2) {
                super(view2);
                this.view = view2;
            }
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        findViewById(R.id.custom_title).setOnClickListener(new View.OnClickListener() {
            /* class com.youku.resource.activity.DemoActivity.AnonymousClass1 */
        ...
        findViewById(R.id.custom_back).setOnClickListener(new View.OnClickListener() {
            /* class com.youku.resource.activity.DemoActivity.AnonymousClass2 */
        ...
        findViewById(R.id.custom_right).setOnClickListener(new View.OnClickListener() {
            /* class com.youku.resource.activity.DemoActivity.AnonymousClass3 */
