...
public class YKPlayListImageView extends YKImageView {
    ...
    private void drawPlayListHintInfo(Canvas canvas) {
        GradientDrawable playListBg2 = getPlayListBg();
        if (playListBg2 != null) {
            int i = this.width;
            playListBg2.setBounds(i - (this.dp20 * 4), 0, i, this.height);
            playListBg2.draw(canvas);
        }
        this.paint.setTextSize((float) this.dp16);
        canvas.drawText(this.playlist_text_num, this.playlist_num_x, this.playlist_num_y, this.paint);
        this.paint.setTextSize((float) this.dp10);
        canvas.drawText(this.playlist_tx, this.playlist_x, this.playlist_num_y + ((float) this.numHeight) + ((float) this.dp3), this.paint);
    }
    ...
    private void initPlayList() {
        if (!TextUtils.isEmpty(this.playlist_text_num)) {
            ...
            int i2 = this.dp34;
            int i3 = this.dp30;
            this.playlist_num_x = (float) (((double) (i - i2)) + (((double) (((float) i3) - f)) / 2.0d));
            this.playlist_x = (float) (((double) (i - i2)) + (((double) (((float) i3) - f2)) / 2.0d));
            this.playlist_num_y = (float) (this.height / 2);
        }
    }
    ...
    @Override // com.youku.resource.widget.YKRatioImageView, com.youku.resource.widget.YKImageView
