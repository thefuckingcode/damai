...
public class PhoneCommonTitlesWidget extends View implements ICssSetter2 {
    ...
    private void drawOneLineTitle(Canvas canvas, Paint paint, Paint.FontMetrics fontMetrics, float f) {
        if ((!sIsDegrade || this.mHorizontalGravity != 1) && !calculateTitleLine(-1, true)) {
            ...
            if (textLineArr[0].size > 0) {
                canvas.drawText(textLineArr[0].text, 0, textLineArr[0].size, (float) (this.mTitleStartPadding + getTitleXOffset(0)), f, paint);
                return;
            }
            return;
        }
        canvas.drawText(this.mTitle, (float) (this.mTitleStartPadding + getTitleXOffset(0)), f, paint);
    }
    ...
    private void drawOneLineTitleWithPrefix(Canvas canvas, Paint paint, Paint.FontMetrics fontMetrics, float f) {
        if ((!sIsDegrade || this.mHorizontalGravity != 1) && !calculateTitleLine(getMeasuredWidth() - getTitlePrefixOffset(), true)) {
            TextLine[] textLineArr = this.mLines;
            if (textLineArr[0].size > 0) {
                canvas.drawText(textLineArr[0].text, 0, textLineArr[0].size, (float) (this.mTitleStartPadding + getTitlePrefixOffset()), f, paint);
                return;
            }
            return;
        }
        canvas.drawText(this.mTitle, (float) (this.mTitleStartPadding + getTitlePrefixOffset()), f, paint);
    }
    ...
    private void drawSubtitle(Canvas canvas) {
        ...
        if (this.mNeedShowSubtitle && !TextUtils.isEmpty(this.mSubtitle)) {
            ...
            float f = ((float) ((this.mTitleTopPadding + this.mTitleHeight) + this.mSubtitleTopPadding)) - subtitlePaint.getFontMetrics().ascent;
            if ((!sIsDegrade || this.mHorizontalGravity != 1) && !calculateSubtitleLine(-1, drawSubtitlePrefix)) {
                TextLine[] textLineArr = this.mLines;
                canvas.drawText(textLineArr[1].text, 0, textLineArr[1].size, (float) (this.mSubtitleStartPadding + drawSubtitlePrefix + getSubtitleXOffset()), f, subtitlePaint);
                return;
            }
            canvas.drawText(this.mSubtitle, (float) (this.mSubtitleStartPadding + drawSubtitlePrefix + getSubtitleXOffset()), f, subtitlePaint);
        }
    }

    private int drawSubtitlePrefix(Canvas canvas) {
        TextPaint subtitlePrefixPaint = getSubtitlePrefixPaint();
        float f = ((float) ((this.mTitleTopPadding + this.mTitleHeight) + this.mSubtitleTopPadding)) - subtitlePrefixPaint.getFontMetrics().ascent;
        if (calculateLine(-1, subtitlePrefixPaint, this.mSubtitlePrefix, 2, this.mSubtitleStartPadding, 0.0f)) {
            canvas.drawText(this.mSubtitlePrefix, (float) (this.mSubtitleStartPadding + getSubtitleXOffset()), f, subtitlePrefixPaint);
        } else {
            TextLine[] textLineArr = this.mLines;
            canvas.drawText(textLineArr[2].text, 0, textLineArr[2].size, (float) (this.mSubtitleStartPadding + getSubtitleXOffset()), f, subtitlePrefixPaint);
        }
    ...
    private void drawTitle(Canvas canvas) {
        if (!TextUtils.isEmpty(this.mTitle)) {
            ...
            float f = ((float) this.mTitleTopPadding) - titleFontMetrics.ascent;
    ...
    private void drawTitlePrefix(Canvas canvas) {
        ...
        int i2 = (int) (((float) (mStrokeRadius << 1)) + f4);
        int i3 = this.mTitleTopPadding;
        int i4 = i3 + ((i - i2) >> 1);
        float f5 = (((float) i3) + ((((float) i) - f4) / 2.0f)) - f3;
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            f = f5;
            canvas.drawRoundRect((float) i5, (float) i4, (float) (i5 + this.mLinesWidth[3] + (mTitlePrefixPadding << 1)), (float) (i2 + i4), (float) i6, (float) i6, titlePrefixBgPaint);
        } else {
            f = f5;
            int i7 = this.mTitleStartPadding;
            canvas.drawRect((float) i7, (float) i4, (float) (i7 + this.mLinesWidth[3] + (mTitlePrefixPadding << 1)), (float) (i2 + i4), titlePrefixBgPaint);
        }
        canvas.drawText(this.mTitlePrefix, (float) (this.mSubtitleStartPadding + mTitlePrefixPadding), f, titlePrefixTextPaint);
    }
    ...
    private void drawTwoLineTitles(Canvas canvas, Paint paint, Paint.FontMetrics fontMetrics, float f) {
        ...
        canvas.drawText(textLineArr2[1].text, 0, textLineArr2[1].size, (float) getTitleXOffset(1), ((f + fontMetrics.descent) - fontMetrics.ascent) + fontMetrics.leading, paint);
    }
    ...
    private void drawTwoLineTitlesWithPrefix(Canvas canvas, Paint paint, Paint.FontMetrics fontMetrics, float f) {
        ...
        TextLine[] textLineArr = this.mLines;
        canvas.drawText(textLineArr[0].text, 0, textLineArr[0].size, (float) (this.mTitleStartPadding + getTitleXOffset(0) + getTitlePrefixOffset()), f, paint);
        TextLine[] textLineArr2 = this.mLines;
        canvas.drawText(textLineArr2[1].text, 0, textLineArr2[1].size, (float) getTitleXOffset(1), ((f + fontMetrics.descent) - fontMetrics.ascent) + fontMetrics.leading, paint);
    }
    ...
    private TextPaint getSubtitlePaint() {
        if (this.mSubtitlePaint == null) {
            ...
            this.mSubtitlePaint.setTextSize((float) this.mSubtitleTextSize);
    ...
    private TextPaint getSubtitlePrefixPaint() {
        if (this.mSubtitlePrefixPaint == null) {
            ...
            this.mSubtitlePrefixPaint.setTextSize((float) this.mSubtitlePrefixTextSize);
    ...
    private TextPaint getTitlePrefixTextPaint() {
        if (this.mTitlePrefixTextPaint == null) {
            ...
            textPaint.setAntiAlias(true);
            this.mTitlePrefixTextPaint.setTextSize((float) mTitlePrefixTextSize);
    ...
    private void initProps(Context context, AttributeSet attributeSet) {
        ...
        this.mSubtitleTextSize = (int) obtainStyledAttributes.getDimension(R.styleable.PhoneCommonTitlesWidget_subtitleTextSize, (float) sDefaultSubtitleTextSize);
        this.mSubtitlePrefixTextSize = (int) obtainStyledAttributes.getDimension(R.styleable.PhoneCommonTitlesWidget_subtitlePrefixTextSize, (float) sDefaultSubtitleTextSize);
        this.mTitleHeight = (int) obtainStyledAttributes.getDimension(R.styleable.PhoneCommonTitlesWidget_titleHeight, (float) sDefaultTitleHeight);
        this.mSubtitleHeight = (int) obtainStyledAttributes.getDimension(R.styleable.PhoneCommonTitlesWidget_subtitleHeight, (float) sDefaultSubtitleHeight);
        ...
        this.mTitleTopPadding = (int) obtainStyledAttributes.getDimension(R.styleable.PhoneCommonTitlesWidget_titleTopPadding, (float) sDefaultTitleTopPadding);
        this.mSubtitleTopPadding = (int) obtainStyledAttributes.getDimension(R.styleable.PhoneCommonTitlesWidget_subtitleTopPadding, (float) sDefaultSubtitleTopPadding);
    ...
    private void initValues(@NonNull Context context, AttributeSet attributeSet) {
        if (sDefaultTitleTextSize <= 0 || sDefaultTitleTextColor != getResources().getColor(R.color.ykn_primary_info)) {
            ...
            sDefaultSubtitleHeight = (int) (((double) f) * 14.25d);
    ...
    public boolean calculateTitleLines(int i) {
        ...
        if (!sIsDegrade || this.mHorizontalGravity != 1) {
            ...
            if (breakText < length) {
                ...
                line.appendChars(this.mTitle, i2, breakText);
                line.appendChar(ELLIPSIZE_TEXT, 0);
            } else {
                line.appendChars(this.mTitle, i2, breakText);
        ...
        line2.size = 0;
        line2.appendChars(this.mTitle, i2, length);
        return false;
    }
    ...
    public boolean calculateTitleLines(int i, int i2) {
        ...
        if (!sIsDegrade || this.mHorizontalGravity != 1) {
            ...
            if (breakText < length) {
                ...
                line.appendChars(this.mTitle, i3, breakText);
                line.appendChar(ELLIPSIZE_TEXT, 0);
            } else {
                line.appendChars(this.mTitle, i3, breakText);
                this.mLinesWidth[1] = (int) this.mTextWidth[0];
        ...
        TextLine line2 = getLine(1);
        line2.size = 0;
        line2.appendChars(this.mTitle, i3, length);
        return false;
    }
}
