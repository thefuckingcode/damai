...
public class YKButton extends AppCompatButton implements YKCustomizedView {
    ...
    private boolean pressedMask = true;
    ...
    private StateListDrawable getStateListDrawable(String str) {
        ...
        switch (c) {
            ...
            case '\r':
                ...
                gradientDrawable = Utils.getDrawable(color, colorIntWithAlpha, dimensionPixelOffset, resources3.getDimension(i3) / 2.0f, 255);
                drawable = Utils.getDrawable(getResources().getColor(i), ColorConfigureManager.getInstance().getColorIntWithAlpha(StaticColorDefine.CB_1, 30), getResources().getDimensionPixelOffset(i2), getResources().getDimension(i3) / 2.0f, 127);
            ...
            case 1:
                ...
                gradientDrawable = Utils.getDrawable(color2, color3, dimensionPixelOffset2, resources6.getDimension(i6) / 2.0f, 255);
                drawable = Utils.getDrawable(getResources().getColor(i4), getResources().getColor(i4), getResources().getDimensionPixelOffset(i5), getResources().getDimension(i6) / 2.0f, 127);
                drawable2 = gradientDrawable;
                break;
            case 2:
            case '\b':
            ...
            case 16:
                ...
                drawable2 = Utils.getDrawable(orientation, iArr, 0, 0, resources9.getDimension(i9) / 2.0f, 255);
                drawable = Utils.getDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{getResources().getColor(i7), getResources().getColor(i8)}, 0, 0, getResources().getDimension(i9) / 2.0f, 127);
                break;
            case 3:
                ...
                gradientDrawable = Utils.getDrawable(colorIntWithAlpha2, colorIntWithAlpha3, dimensionPixelOffset3, resources11.getDimension(i11) / 2.0f, 255);
                drawable = Utils.getDrawable(ColorConfigureManager.getInstance().getColorIntWithAlpha(StaticColorDefine.CB_1, 10), ColorConfigureManager.getInstance().getColorIntWithAlpha(StaticColorDefine.CB_1, 30), getResources().getDimensionPixelOffset(i10), getResources().getDimension(i11) / 2.0f, 127);
                drawable2 = gradientDrawable;
                break;
            case 4:
            case '\t':
            ...
            case 17:
                ...
                drawable2 = Utils.getDrawable(color4, color5, dimensionPixelOffset4, resources15.getDimension(i15) / 2.0f, 255);
                drawable = Utils.getDrawable(getResources().getColor(i12), getResources().getColor(i13), getResources().getDimensionPixelOffset(i14), getResources().getDimension(i15) / 2.0f, 127);
                break;
            case 5:
                Resources resources16 = getResources();
                int i16 = R.drawable.yk_button_gradient;
                drawable2 = resources16.getDrawable(i16);
                Resources resources17 = getResources();
                int i17 = R.dimen.button_large_h;
                ((GradientDrawable) drawable2).setCornerRadius(resources17.getDimension(i17) / 2.0f);
                drawable = getResources().getDrawable(i16);
                drawable.setAlpha(127);
                ((GradientDrawable) drawable).setCornerRadius(getResources().getDimension(i17) / 2.0f);
                break;
            case 6:
            case 7:
            case 18:
                ...
                drawable2 = Utils.getDrawable(color6, color7, dimensionPixelOffset5, resources20.getDimension(i20) / 2.0f, 255);
                drawable = Utils.getDrawable(getResources().getColor(i18), getResources().getColor(i18), getResources().getDimensionPixelOffset(i19), getResources().getDimension(i20) / 2.0f, 127);
                break;
            case 14:
                ...
                drawable2 = Utils.getDrawable(color8, 0, 0, resources22.getDimension(i22) / 2.0f, 255);
                drawable = Utils.getDrawable(getResources().getColor(i21), 0, 0, getResources().getDimension(i22) / 2.0f, 127);
                break;
            case 15:
                ...
                GradientDrawable drawable3 = Utils.getDrawable(orientation2, iArr2, 0, 0, resources23.getDimension(i23) / 2.0f, 255);
                drawable = Utils.getDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{Color.parseColor("#FFFABE96"), Color.parseColor("#FFFFE0CB")}, 0, 0, getResources().getDimension(i23) / 2.0f, 127);
                drawable2 = drawable3;
                break;
            case 19:
            case 21:
            case 22:
                ...
                drawable2 = Utils.getDrawable(color9, 0, 0, resources25.getDimension(i25) / 2.0f, 255);
                drawable = Utils.getDrawable(getResources().getColor(i24), 0, 0, getResources().getDimension(i25) / 2.0f, 127);
                break;
            case 20:
                ...
                drawable2 = Utils.getDrawable(orientation3, iArr3, 0, 0, resources28.getDimension(i28) / 2.0f, 255);
                drawable = Utils.getDrawable(GradientDrawable.Orientation.TL_BR, new int[]{getResources().getColor(i26), getResources().getColor(i27)}, 0, 0, getResources().getDimension(i28) / 2.0f, 127);
                break;
            default:
                drawable2 = null;
                drawable = null;
        ...
        Drawable newDrawable = drawable2 != null ? drawable2.getConstantState().newDrawable() : null;
        ...
        stateListDrawable.addState(iArr4[2], drawable2);
        stateListDrawable.addState(iArr4[3], drawable);
