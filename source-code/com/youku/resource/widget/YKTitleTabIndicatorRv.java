...
public class YKTitleTabIndicatorRv extends RecyclerView {
    ...
    private class CenterSmoothScroller extends LinearSmoothScroller {
        ...
        public int calculateTimeForScrolling(int i) {
            return (int) Math.ceil((double) (((float) Math.abs(i)) * (100.0f / ((float) YKTitleTabIndicatorRv.this.getResources().getDisplayMetrics().densityDpi))));
        }
    }
    ...
    private void init(Context context, AttributeSet attributeSet, int i) {
        ...
        try {
            ...
            this.mSliderWidthMin = obtainStyledAttributes.getDimension(R.styleable.YKTitleTabIndicator_slider_min_width, (float) dp2px(5.0f));
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            /* class com.youku.resource.widget.YKTitleTabIndicatorRv.AnonymousClass2 */
            ...
            public void onPageScrolled(int i, float f, int i2) {
                ...
                YKTitleTabIndicatorRv yKTitleTabIndicatorRv2 = YKTitleTabIndicatorRv.this;
                yKTitleTabIndicatorRv2.mHandler.postDelayed(yKTitleTabIndicatorRv2.scrollRunnable, 50);
            }

            @Override // androidx.viewpager.widget.ViewPager.OnPageChangeListener
            public void onPageSelected(final int i) {
                u91.a("YKTitleTabIndicator", "onPageSelected position:" + i + "  mClickedPosition:" + YKTitleTabIndicatorRv.this.mClickedPosition, new Object[0]);
                YKTitleTabIndicatorRv yKTitleTabIndicatorRv = YKTitleTabIndicatorRv.this;
                yKTitleTabIndicatorRv.mClickedPosition = i;
                yKTitleTabIndicatorRv.postDelayed(new Runnable() {
                    /* class com.youku.resource.widget.YKTitleTabIndicatorRv.AnonymousClass2.AnonymousClass1 */

                    public void run() {
                        YKTitleTabIndicatorRv yKTitleTabIndicatorRv = YKTitleTabIndicatorRv.this;
                        yKTitleTabIndicatorRv.currentPosition = i;
                        yKTitleTabIndicatorRv.adjustCenterPosition();
                    }
                }, 100);
            }
        });
    ...
    public YKTitleTabIndicatorRv(Context context, AttributeSet attributeSet, int i) {
        ...
        this.scrollRunnable = new Runnable() {
            /* class com.youku.resource.widget.YKTitleTabIndicatorRv.AnonymousClass1 */
            ...
            public void run() {
                ...
                YKTitleTabIndicatorRv.this.mHandler.postDelayed(this, 50);
            }
        };
        this.isDefaultColor = true;
