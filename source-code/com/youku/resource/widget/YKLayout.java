...
public class YKLayout extends FrameLayout {
    ...
    private Drawable getTopLeftDrawable(int i) {
        ...
        path.close();
        int leftStartColor = getLeftStartColor(i);
        int leftEndColor = getLeftEndColor(i);
        new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{leftStartColor, leftEndColor});
    ...
    public void setBottomLeftText(String str) {
        ...
        this.bottom_left.setTextSize(0, (float) getResources().getDimensionPixelSize(R.dimen.resource_size_11));
    ...
    public void setBottomRightText(String str) {
        ...
        this.bottom_right.setTextSize(0, (float) getResources().getDimensionPixelSize(R.dimen.resource_size_11));
    ...
    public void setReputation(String str) {
        ...
        this.bottom_right.setTextSize(0, (float) getResources().getDimensionPixelSize(R.dimen.resource_size_13));
        this.bottom_right.setText(str);
    }
