...
public class YKTabLayout extends HorizontalScrollView {
    ...
    private void drawDivider(Canvas canvas) {
        if (this.mLightMode && this.needDrawDivider) {
            ...
            canvas.drawRect(0.0f, (float) (getHeight() - this.mDividerHeight), (float) this.mContainer.getMeasuredWidth(), (float) getHeight(), this.mDividerPaint);
        }
    }
    ...
    private void drawLine(Canvas canvas) {
        ...
        if (this.mContainer.getChildCount() != 0) {
            ...
            if (childAt2 != null) {
                float right = (float) ((childAt2.getRight() - (childAt2.getWidth() / 2)) + getPaddingLeft());
                ...
                if (this.currentPositionOffset > 0.0f && this.currentPosition < this.mContainer.getChildCount() - 1 && (childAt = this.mContainer.getChildAt(this.currentPosition + 1)) != null) {
                    float right2 = (float) ((childAt.getRight() - (childAt.getWidth() / 2)) + getPaddingLeft());
                ...
                if (f3 - f2 <= this.mSliderWidthMin + this.mSliderCompat) {
                    ...
                    RectF rectF = new RectF(f2, (float) ((height - i) - this.mSliderHeightStill), f3, (float) (height - i));
                    int i2 = this.mSliderBottomMargin;
                    canvas.drawRoundRect(rectF, (float) i2, (float) i2, this.rectPaint);
                    return;
                }
                this.rectPaint.setShader(new LinearGradient(0.0f, 0.0f, this.mSliderWidthMax, (float) this.mSliderHeightMoving, Color.parseColor("#ff37e8ff"), Color.parseColor("#fff586ff"), Shader.TileMode.MIRROR));
                int i3 = this.mSliderBottomMargin;
                int i4 = this.mSliderHeightStill;
                int i5 = this.mSliderHeightMoving;
                RectF rectF2 = new RectF(f2, (float) ((height - i3) - ((i4 + i5) / 2)), f3, (float) ((height - i3) - ((i4 - i5) / 2)));
                int i6 = this.mSliderBottomMargin;
                canvas.drawRoundRect(rectF2, (float) i6, (float) i6, this.rectPaint);
            }
        }
    }
    ...
    private void init() {
        try {
            this.mSliderWidthMax = (float) getResources().getDimensionPixelSize(R.dimen.resource_size_60);
            Resources resources = getResources();
            int i = R.dimen.resource_size_5;
            this.mSliderWidthMin = (float) resources.getDimensionPixelSize(i);
    ...
    private void measureChildWidth(List<String> list) {
        if (list != null && list.size() > 0) {
            ...
            textPaint.setTextSize((float) this.mTextSizeDef);
            float f = 0.0f;
            int dimensionPixelSize = getResources().getDimensionPixelSize(R.dimen.resource_size_10);
            int size = list.size();
            float f2 = (float) (this.mScreenWidth - (this.mSlidePadding * 2));
            ...
            while (true) {
                ...
                if (str != null && !TextUtils.isEmpty(str)) {
                    ...
                    f += measureText + ((float) (dimensionPixelSize * 2));
                    if (f > f2) {
                        break;
                    }
                }
    ...
    public void scrollToPosition(int i) {
        ...
        if (linearLayout != null && i < linearLayout.getChildCount()) {
            ...
            childAt.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                /* class com.youku.resource.widget.YKTabLayout.AnonymousClass5 */
                ...
                public void onGlobalLayout() {
                    ...
                    yKTabLayout.mHandler.postDelayed(yKTabLayout.scrollRunnable, 50);
    ...
    public void sendUtExposeStatics() {
    }
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            /* class com.youku.resource.widget.YKTabLayout.AnonymousClass3 */
            ...
            public void onPageScrolled(int i, float f, int i2) {
                ...
                yKTabLayout2.mHandler.postDelayed(yKTabLayout2.scrollRunnable, 50);
            }
    ...
    public YKTabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.scrollRunnable = new Runnable() {
            /* class com.youku.resource.widget.YKTabLayout.AnonymousClass1 */
            ...
            public void run() {
                ...
                YKTabLayout.this.mHandler.postDelayed(this, 50);
            }
        };
        this.mScrollViewListener = new ScrollViewListener() {
            /* class com.youku.resource.widget.YKTabLayout.AnonymousClass2 */
        ...
        this.mTabClickListener = new View.OnClickListener() {
            /* class com.youku.resource.widget.YKTabLayout.AnonymousClass4 */

            public void onClick(View view) {
                YKTabLayout yKTabLayout;
                int i;
                int indexOfChild = YKTabLayout.this.mContainer.indexOfChild(view);
                YKTabLayout yKTabLayout2 = YKTabLayout.this;
                if (indexOfChild != yKTabLayout2.mClickedPosition) {
                    yKTabLayout2.mIsClicked = true;
                    yKTabLayout2.mClickedPosition = indexOfChild;
                    ViewPager viewPager = yKTabLayout2.mViewPager;
                    if (!(viewPager == null || viewPager.getCurrentItem() == (i = (yKTabLayout = YKTabLayout.this).mClickedPosition))) {
                        yKTabLayout.mViewPager.setCurrentItem(i, false);
                    }
