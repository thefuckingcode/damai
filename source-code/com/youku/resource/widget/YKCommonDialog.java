        ...
        if (getWindow() != null) {
            ...
            if (window.findViewById(i) != null) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    getWindow().findViewById(i).setOutlineProvider(new ViewOutlineProvider() {
                        /* class com.youku.resource.widget.YKCommonDialog.AnonymousClass1 */

                        @TargetApi(21)
                        public void getOutline(View view, Outline outline) {
                            outline.setAlpha(0.0f);
                            outline.setRoundRect(0, 0, view.getWidth(), view.getHeight(), (float) dimensionPixelOffset);
                        }
                    });
                }
            }
