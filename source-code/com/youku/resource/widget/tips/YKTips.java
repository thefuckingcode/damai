...
public class YKTips extends YKTextView {
    ...
    public void showAnimation() {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, "translationY", translationY - ((float) resources.getDimensionPixelOffset(i)), translationY + ((float) getResources().getDimensionPixelOffset(i)));
