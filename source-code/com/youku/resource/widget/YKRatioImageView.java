...
public class YKRatioImageView extends TUrlImageView {
    ...
    private static boolean sDegrade = AppPerfABUtils.isOpenDegrade();
    private static boolean sNoEnableLayoutOptimize = AppPerfABUtils.isNoSetEnableLayoutOptimize();
    private static boolean sNoOptLessRequestLayout = AppPerfABUtils.isNoOptLessRequestLayout();
    private int D;
    private int M;
    ...
    public void drawLeftDown(Canvas canvas) {
        if (this.isLeftBottomCorner && this.roundLeftBottomCornerRadius > 0) {
            ...
            drawCornerPath.moveTo(0.0f, (float) (height2 - this.roundLeftBottomCornerRadius));
            float f = (float) height2;
            drawCornerPath.lineTo(0.0f, f);
            drawCornerPath.lineTo((float) this.roundLeftBottomCornerRadius, f);
            int i = this.roundLeftBottomCornerRadius;
            drawCornerPath.arcTo(new RectF(0.0f, (float) (height2 - (i * 2)), (float) (i * 2), f), 90.0f, 90.0f);
    ...
    public void drawLeftUp(Canvas canvas) {
        if (this.isLeftTopCorner && this.roundLeftTopCornerRadius > 0) {
            Path drawCornerPath = getDrawCornerPath();
            drawCornerPath.moveTo(0.0f, (float) this.roundLeftTopCornerRadius);
            drawCornerPath.lineTo(0.0f, 0.0f);
            drawCornerPath.lineTo((float) this.roundLeftTopCornerRadius, 0.0f);
            int i = this.roundLeftTopCornerRadius;
            drawCornerPath.arcTo(new RectF(0.0f, 0.0f, (float) (i * 2), (float) (i * 2)), -90.0f, -90.0f);
            drawCornerPath.close();
            canvas.drawPath(drawCornerPath, roundPaint);
        }
    }
    ...
    public void drawRightDown(Canvas canvas) {
        if (this.isRightBottomCorner && this.roundRightBottomRadius > 0) {
            ...
            Path drawCornerPath = getDrawCornerPath();
            float f = (float) height2;
            drawCornerPath.moveTo((float) (width2 - this.roundRightBottomRadius), f);
            float f2 = (float) width2;
            drawCornerPath.lineTo(f2, f);
            drawCornerPath.lineTo(f2, (float) (height2 - this.roundRightBottomRadius));
            int i = this.roundRightBottomRadius;
            drawCornerPath.arcTo(new RectF((float) (width2 - (i * 2)), (float) (height2 - (i * 2)), f2, f), 0.0f, 90.0f);
            drawCornerPath.close();
            canvas.drawPath(drawCornerPath, roundPaint);
        }
    }
    ...
    public void drawRightUp(Canvas canvas) {
        if (this.isRightTopCorner && this.roundRightTopCornerRadius > 0) {
            int width2 = getWidth();
            Path drawCornerPath = getDrawCornerPath();
            drawCornerPath.moveTo((float) (width2 - this.roundRightTopCornerRadius), 0.0f);
            float f = (float) width2;
            drawCornerPath.lineTo(f, 0.0f);
            drawCornerPath.lineTo(f, (float) this.roundRightTopCornerRadius);
            int i = this.roundRightTopCornerRadius;
            drawCornerPath.arcTo(new RectF((float) (width2 - (i * 2)), 0.0f, f, (float) (i * 2)), 0.0f, -90.0f);
            drawCornerPath.close();
            canvas.drawPath(drawCornerPath, roundPaint);
        }
    }
    ...
    public void setViewRoundedCorner(View view, final int i, final float f) {
        if (Build.VERSION.SDK_INT >= 21 && view != null && i >= 0) {
            ...
            view.setOutlineProvider(new ViewOutlineProvider() {
                /* class com.youku.resource.widget.YKRatioImageView.AnonymousClass1 */
