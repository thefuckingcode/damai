...
public class CornerMaskUtil {
    ...
    public static void setCornerMark(Context context, final int i, final String str, final ImageView imageView, final View view, boolean z) {
        ...
        tp1.o().s(i42.r(i2)).Q(new IPhenixListener<ug2>() {
            /* class com.youku.utils.CornerMaskUtil.AnonymousClass3 */
            ...
            public boolean onHappen(ug2 ug2) {
                ...
                if (drawable == null) {
                    ...
                    if (bitmap == null) {
                        Bitmap createBitmap = Bitmap.createBitmap((int) (paint.measureText(str) + ((float) (dimensionPixelOffset * 2))), dimensionPixelSize2, Bitmap.Config.ARGB_8888);
                        createBitmap.eraseColor(cornerColor);
                        bitmap = CornerMaskUtil.getRoundBitmap(createBitmap, dimensionPixelSize4);
                        float width = ((float) (bitmap.getWidth() / 2)) - (paint.measureText(str) / 2.0f);
                        Canvas canvas = new Canvas(bitmap);
                        Paint.FontMetrics fontMetrics = paint.getFontMetrics();
                        float f = fontMetrics.descent;
                        canvas.drawText(str, width, (((float) (dimensionPixelSize2 / 2)) - f) + ((f - fontMetrics.ascent) / 2.0f), paint);
                        canvas.save(31);
                        canvas.restore();
                    ...
                    drawable.setBounds(width2 - bitmap.getWidth(), i, width2, dimensionPixelSize2 + i);
                ...
                imageView.post(new Runnable() {
                    /* class com.youku.utils.CornerMaskUtil.AnonymousClass3.AnonymousClass1 */
        ...
        if (view == null) {
            if (imageView.getHeight() > 0) {
                ...
                imageView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    /* class com.youku.utils.CornerMaskUtil.AnonymousClass1 */
            ...
            view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                /* class com.youku.utils.CornerMaskUtil.AnonymousClass2 */
