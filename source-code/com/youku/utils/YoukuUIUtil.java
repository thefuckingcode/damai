...
public class YoukuUIUtil {
    ...
    public static void getPaletteColor(BitmapDrawable bitmapDrawable, final onPaletteGeneratedListener onpalettegeneratedlistener) {
        ...
        if (bitmapDrawable != null && bitmapDrawable.getBitmap() != null) {
            ...
            if (min > 0 && (createBitmap = Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), min)) != null) {
                try {
                    Palette.from(createBitmap).generate(new Palette.PaletteAsyncListener() {
                        /* class com.youku.utils.YoukuUIUtil.AnonymousClass4 */
                        ...
                        public void onGenerated(Palette palette) {
                            ...
                            if (mutedSwatch != null) {
                                ...
                                onPaletteGeneratedListener onpalettegeneratedlistener = onpalettegeneratedlistener;
    ...
    private static String getXiaomiVersion() {
        try {
            ...
            return (String) cls.getMethod(gl1.TYPE_OPEN_URL_METHOD_GET, String.class).invoke(cls, "ro.miui.ui.version.name");
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
    ...
    public static void setViewTouchDelegate(final TouchDelegateGroup touchDelegateGroup, final View view, final View view2, final int i, final int i2, final int i3, final int i4) {
        if (view != null) {
            view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                /* class com.youku.utils.YoukuUIUtil.AnonymousClass1 */
    ...
    public static void setCornerMarkData(final Context context, final int i, final String str, final WithCornerMaskImageView withCornerMaskImageView, final View view) {
        if (view == null) {
            if (withCornerMaskImageView.getHeight() > 0) {
                ...
                withCornerMaskImageView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    /* class com.youku.utils.YoukuUIUtil.AnonymousClass2 */
            ...
            view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                /* class com.youku.utils.YoukuUIUtil.AnonymousClass3 */
