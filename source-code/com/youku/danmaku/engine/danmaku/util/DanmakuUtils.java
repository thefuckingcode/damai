...
public class DanmakuUtils {
    ...
    private static boolean checkHitAtTime(IDisplayer iDisplayer, BaseDanmaku baseDanmaku, BaseDanmaku baseDanmaku2, long j) {
        ...
        if ((danmakuSettingPlugin.isNewTypesetting() || danmakuSettingPlugin.isNewCompose()) && rectAtTime == null && !baseDanmaku.isMeasured()) {
            return true;
        }
        return false;
    }
    ...
    public static boolean willHitInDuration(IDisplayer iDisplayer, BaseDanmaku baseDanmaku, BaseDanmaku baseDanmaku2, long j, long j2) {
        ...
        if (type == 5 || type == 4 || checkHitAtTime(iDisplayer, baseDanmaku, baseDanmaku2, j2) || checkHitAtTime(iDisplayer, baseDanmaku, baseDanmaku2, baseDanmaku.time + baseDanmaku.getDuration())) {
            return true;
        }
        return false;
    }
    ...
    public static boolean willHitInUniformSpeed(IDisplayer iDisplayer, BaseDanmaku baseDanmaku, BaseDanmaku baseDanmaku2, long j) {
        ...
        if (baseDanmaku instanceof AutoStopR2LDanmaku) {
            ...
            if (!autoStopR2LDanmaku.isStopped()) {
                ...
                if (checkHitAtTime(iDisplayer, baseDanmaku, baseDanmaku2, j) || checkHitAtTimeForUniform(iDisplayer, baseDanmaku, baseDanmaku2, j, stopDurationTime + j)) {
                    return true;
                }
                return false;
            }
