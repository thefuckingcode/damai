...
public class R2LDanmaku extends BaseDanmaku {
    ...
    public float getAccurateLeft(IDisplayer iDisplayer, long j) {
        ...
        return ((float) iDisplayer.getWidth()) - (((float) j2) * this.mStepX);
    }
    ...
    public float getBottom() {
        ...
        return baseExtraStyle != null ? f + ((float) baseExtraStyle.getTopPadding()) : f;
    }
    ...
    public void measure(IDisplayer iDisplayer, boolean z) {
        ...
        if (f <= 0.0f) {
            ...
            this.duration.value = (long) (((float) this.mDistance) / uniformSpeed);
            return;
        }
        this.duration.value = (long) (((float) this.mDistance) / f);
    }
    ...
    public void setDistanceOffset(float f) {
        this.mDistance = (int) (((float) this.mDistance) + f);
    }
    ...
    public void setSpeedAndChangeDuration(float f) {
        ...
        if (danmakuTimer != null) {
            ...
            long j2 = this.time;
            this.mStepX = f;
            duration.value = (long) (((float) this.mDistance) / f);
            long j3 = danmakuTimer.currMillisecond;
            this.time = (long) (((float) j3) - ((((float) (j3 - j2)) * f2) / f));
            if (Log.isDebug()) {
