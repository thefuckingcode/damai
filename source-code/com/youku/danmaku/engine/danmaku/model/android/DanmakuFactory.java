...
public class DanmakuFactory {
    ...
    static DanmakuFactory create(DanmakuContext danmakuContext) {
    ...
    public BaseDanmaku createDanmaku(int i, int i2, DanmakuContext danmakuContext) {
        ...
        return createDanmaku(i, i2, (float) displayer.getWidth(), (float) this.sLastDisp.getHeight(), this.mCurrentDispSizeFactor, danmakuContext.scrollSpeedFactor / danmakuContext.getPlaySpeed());
    }
