...
public class DanmakuRendererNew extends Renderer {
    ...
    private final DanmakusRetainer.Verifier verifier = new DanmakusRetainer.Verifier() {
        /* class com.youku.danmaku.engine.danmaku.renderer.android.DanmakuRendererNew.AnonymousClass1 */
                ...
                if (!(baseDanmaku == null || baseDanmaku.duration == null)) {
                    ...
                    if (!baseDanmaku.isFiltered()) {
                        ...
                        if (z && baseDanmaku.isFilter) {
                            ...
                            if (baseDanmaku.lines != null || baseDanmaku.getBottom() <= ((float) iDisplayer.getHeight())) {
                ...
                if (baseDanmaku.isTimeOut()) {
                    ...
                    if (baseDanmaku.isFiltered()) {
                        ...
                        if (baseDanmaku.isBombed) {
                            ...
                            this.mDanmakusRetainer.fix(baseDanmaku, iDisplayer, this.mVerifier);
                            if (baseDanmaku.isShown() && ((baseDanmaku.lines != null || baseDanmaku.getBottom() <= ((float) iDisplayer.getHeight())) && ((this.mContext.getDanmakuSettingPlugin() == null || baseDanmaku.lines != null || baseDanmaku.getDanmakuLine() < this.mContext.getDanmakuSettingPlugin().getLineCount()) && !baseDanmaku.isSelected))) {
