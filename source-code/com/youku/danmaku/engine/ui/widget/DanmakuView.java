...
public class DanmakuView extends View implements IDanmakuView, IDanmakuViewController {
    ...
    private boolean mDanmakuVisible = false;
    ...
    private long mPreFrameTime = -1;
    private Rect mRect;
    private boolean mRequestRender = false;
    private Runnable mResumeRunnable = new Runnable() {
        /* class com.youku.danmaku.engine.ui.widget.DanmakuView.AnonymousClass2 */
        ...
        public void run() {
            if (DanmakuView.this.handler != null) {
                ...
                if (DanmakuView.this.mResumeTryCount > 4 || DanmakuView.super.isShown()) {
                    ...
                    ((Handler) DanmakuView.this.handler).postDelayed(this, (long) (DanmakuView.this.mResumeTryCount * 100));
                }
            }
        }
    };
    ...
    private List<Integer> mTotalFrameRate = new ArrayList();
    private DanmakuTouchHelper mTouchHelper;
    private long mUiThreadId;
    private boolean mWaitDrawing = false;
    ...
    private float fps() {
        ...
        if (longValue > 0.0f) {
            return ((float) (this.mDrawTimes.size() * 1000)) / longValue;
        }
        return 0.0f;
    }
    ...
    private void prepare() {
        if (this.handler == null) {
            ...
            if (iDanmakuSettingPlugin != null) {
                z = iDanmakuSettingPlugin.isNewHandler();
            }
            if (z) {
    ...
    private void recodeDrawJank() {
        Choreographer.getInstance().postFrameCallback(new Choreographer.FrameCallback() {
            /* class com.youku.danmaku.engine.ui.widget.DanmakuView.AnonymousClass1 */
