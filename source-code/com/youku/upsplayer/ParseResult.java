...
public class ParseResult {
    ...
    public static VideoInfo parseJson2(String str) {
        ...
        videoInfo.setStreamJson(jSONObject.getJSONArray(lf1.RESOURCE_STREAM));
    ...
    public static List<MinVideoInfo> parseMulFirstSliceJSon(String str) {
        ...
        for (int i = 0; i < jSONArray.size(); i++) {
            ...
            if (intValue == 0) {
                minVideoInfo.setDuration(jSONObject.getLong("duration") == null ? 0 : jSONObject.getLong("duration").longValue());
    ...
    public static List<VideoCacheInfo> parseMulUPSJSon(String str) {
        ...
        for (int i = 0; i < parseArray.size(); i++) {
            ...
            videoCacheInfo.videoInfoStr = jSONObject.getString(js2.MAIN);
    ...
    public static List<SimpleVideoInfo> parseMultiJSon(String str) {
        ...
        for (String str2 : jSONObject.keySet()) {
            ...
            simpleVideoInfo.setStream((Stream) parseSafety(jSONObject.getJSONObject(str2).getJSONObject(lf1.RESOURCE_STREAM), Stream.class));
