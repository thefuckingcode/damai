...
public class UpsInfoRequest implements IUpsInfoRequest {
    ...
    private static Set<String> sEncodeParams = new HashSet<String>() {
        /* class com.youku.upsplayer.UpsInfoRequest.AnonymousClass1 */
    ...
    public UpsInfoRequest(Context context, INetworkTask iNetworkTask, boolean z) {
        ...
        this.request = null;
        this.GetInfoRunnable = new Runnable() {
            /* class com.youku.upsplayer.UpsInfoRequest.AnonymousClass2 */
    ...
    private String getCkey(PlayVideoInfo playVideoInfo) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private String getUrl(PlayVideoInfo playVideoInfo) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private VideoInfo processData(GetInfoResult getInfoResult) {
        ...
        try {
            ...
            parseData.setStream(parseStream(parseData.getStreamJson()));
            return parseData;
        } catch (Exception e) {
