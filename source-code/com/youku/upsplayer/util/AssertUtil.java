    ...
    public static String getCaller(int i) {
        while (true) {
            ...
            if (!stackTraceElement.getMethodName().contains("$")) {
                return jl1.ARRAY_START_STR + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ":" + stackTraceElement.getMethodName() + jl1.ARRAY_END_STR;
            }
            i++;
        }
    }
