...
public class GetUps {
    ...
    private static Set<String> adEncodeParam = new HashSet<String>() {
        /* class com.youku.upsplayer.GetUps.AnonymousClass1 */
    ...
    private Runnable GetInfoRunnable = new Runnable() {
        /* class com.youku.upsplayer.GetUps.AnonymousClass4 */
    ...
    private Runnable mGetMultiInfoRunnable = new Runnable() {
        /* class com.youku.upsplayer.GetUps.AnonymousClass2 */
    ...
    private Runnable mGetMultiUPSVideoInfoRunnable = new Runnable() {
        /* class com.youku.upsplayer.GetUps.AnonymousClass3 */
    ...
    protected INetworkTask networkTask = null;
    private RequestData request = null;
    private UpsTimeTraceBean timeTraceBean;
    private int upsType = 1;

    public GetUps(Context context2, INetworkTask iNetworkTask) {
        this.networkTask = iNetworkTask;
        this.context = context2;
        if (!AssertUtil.mInited) {
            AssertUtil.setAllowCrash(AssertUtil.isApkDebuggable(context2));
        }
    }
    ...
    private MTopUpsRequest getMTopUpsResquest() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private String getMultiInfoUrl() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private String getMultiUPSInfoUrl() {
        StringBuilder sb = new StringBuilder(this.mHost);
