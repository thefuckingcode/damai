...
public class ConfigBinder {
    ...
    public static class FieldHolder {
        ...
        public void update(String str) {
            try {
                ...
                ConfigBinder.updateField(field2, obj, str);
    ...
    public static class UpdateHolder {
        ...
        ConfigFetcher.OnConfigUpdatedListener mUpdatedListener = new ConfigFetcher.OnConfigUpdatedListener() {
            /* class com.youku.media.arch.instruments.binding.ConfigBinder.UpdateHolder.AnonymousClass1 */
