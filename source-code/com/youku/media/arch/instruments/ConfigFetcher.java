...
public class ConfigFetcher {
    ...
    public static class CachedConfigGetter implements ConfigGetter {
        ...
        private OnConfigUpdatedListener mDefaultConfigUpdateListener = new OnConfigUpdatedListener() {
            /* class com.youku.media.arch.instruments.ConfigFetcher.CachedConfigGetter.AnonymousClass1 */
        ...
        private Map<String, String> getNamespaceValueMap(String str) {
