...
public class RelationList implements Parcelable {
    public static final Parcelable.Creator<RelationList> CREATOR = new Parcelable.Creator<RelationList>() {
        /* class com.youku.passport.family.RelationList.AnonymousClass1 */
    ...
    protected RelationList(Parcel parcel) {
        ...
        this.showAuthPage = parcel.readInt() != 1 ? false : true;
