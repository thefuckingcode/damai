...
public class LoginArgument implements Parcelable {
    public static final Parcelable.Creator<LoginArgument> CREATOR = new Parcelable.Creator<LoginArgument>() {
        /* class com.youku.passport.libs.LoginArgument.AnonymousClass1 */
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeByte(this.isLoginMobile ? (byte) 1 : 0);
