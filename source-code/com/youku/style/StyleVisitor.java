...
public class StyleVisitor<STYLE extends Map> extends BaseStyleVisitor<STYLE> {
    ...
    public StyleVisitor(STYLE style) {
        super(style);
        CssBinder<STYLE> cssBinder2 = CssCache.getCssBinder(style);
        this.cssBinder = cssBinder2;
        if (cssBinder2 == null) {
    ...
    public void bindStyle(View view, String str) {
        ...
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            cssBinder2.bindCss(view, tokenToScene(str));
        }
    }
    ...
    public void bindStyleAlpha(View view, String str, String str2, @IntRange(from = 0, to = 100) int i) {
        ...
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            cssBinder2.bindCssToField(view, tokenToScene(str), str2, String.valueOf(i));
        }
    }
    ...
    public Css findStyle(String str) {
        ...
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            return cssBinder2.findCss(tokenToScene(str));
        }
        return null;
    }
    ...
    public STYLE getContainerCurrentStyle() {
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            return cssBinder2.getContainerCurrentStyle();
        }
        return null;
    }
    ...
    public IStyleManager<STYLE> getContainerStyleManager() {
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            return cssBinder2.getContainerStyleManager();
        }
        return null;
    }
    ...
    public String getStyleLabel() {
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            return cssBinder2.getStyleLabel();
        }
        return null;
    }
    ...
    public String getStyleStringValueByToken(String str) {
        Css css;
        if (!hasStyleStringByToken(str) || (css = getCssMap().get(tokenToScene(str))) == null) {
            return "";
        }
        return isBgColorToken(str) ? css.backgroundColor : css.color;
    }
    ...
    public Long getUpdateTime() {
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            return cssBinder2.getUpdateTime();
        }
        return null;
    }
    ...
    public boolean isMerged() {
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        return cssBinder2 != null && cssBinder2.isMerged();
    }
    ...
    public void setContainer(IStyleContainer<STYLE> iStyleContainer) {
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null && iStyleContainer != null) {
            cssBinder2.setContainer(iStyleContainer);
        }
    }
    ...
    public void setContainerStyleManager(IStyleManager<STYLE> iStyleManager) {
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            cssBinder2.setContainerStyleManager(iStyleManager);
        }
    }
    ...
    public void bindStyle(IStyleView iStyleView, String str) {
        ...
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            cssBinder2.bindCss(iStyleView, tokenToScene(str));
        }
    }
    ...
    public void bindStyle(View view, String str, String str2) {
        ...
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            cssBinder2.bindCssToField(view, tokenToScene(str), str2);
        }
    }
    ...
    public void bindStyle(View view, String str, String str2, String str3) {
        ...
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            cssBinder2.bindCssToField(view, tokenToScene(str), str2, str3);
        }
    }
    ...
    public void bindStyle(View view, String str, String str2, String str3, @IntRange(from = 0, to = 100) int i) {
        ...
        CssBinder<STYLE> cssBinder2 = this.cssBinder;
        if (cssBinder2 != null) {
            cssBinder2.bindCssToField(view, tokenToScene(str), str2, str3, String.valueOf(i));
        }
    }
}
