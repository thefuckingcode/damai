...
public class PluginManager {
    ...
    public boolean addPlugin2Layer(IPlugin iPlugin) throws LMLayerDataSourceException {
    ...
    public void createRealPlugin() {
        if (getPluginConfigs() != null && getPluginConfigs().size() > 0) {
            ...
            Collections.sort(arrayList, new Comparator<Map.Entry<String, PluginConfig>>() {
                /* class com.youku.alixplugin.PluginManager.AnonymousClass1 */
            ...
            AnonymousClass2 r3 = new Runnable() {
                /* class com.youku.alixplugin.PluginManager.AnonymousClass2 */
                ...
                public void run() {
                    ...
                    for (Map.Entry entry : arrayList) {
                        ...
                        Log.v(PluginManager.TAG, String.format("cost %5d ms for create plugin [%s]", Long.valueOf(System.currentTimeMillis() - currentTimeMillis), name));
                    }
                }
            };
            if (Looper.getMainLooper() == Looper.myLooper()) {
                ...
                this.mHandler.postAtFrontOfQueue(r3);
            } else {
                this.mHandler.post(r3);
            }
        }
    }
    ...
    /* access modifiers changed from: package-private */
    public boolean removePlugin2Layer(IPlugin iPlugin) throws LMLayerDataSourceException {
