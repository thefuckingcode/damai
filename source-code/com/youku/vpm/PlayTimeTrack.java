...
public class PlayTimeTrack implements IPlayTimeTrack {
    ...
    private Map<String, Double> mFastPlayTimes = new ConcurrentHashMap<String, Double>() {
        /* class com.youku.vpm.PlayTimeTrack.AnonymousClass1 */
    ...
    private Map<String, Double> mPlayerCoreTimes = new ConcurrentHashMap<String, Double>() {
        /* class com.youku.vpm.PlayTimeTrack.AnonymousClass3 */
    ...
    private Map<String, Long> mPlayerCoreTimestamp = new ConcurrentHashMap<String, Long>() {
        /* class com.youku.vpm.PlayTimeTrack.AnonymousClass2 */
    };
    ...
    public PlayTimeTrack(IVpmInfo iVpmInfo) {
        String[] strArr = sBusinessTimestampKeys;
        for (String str : strArr) {
            putTimestamp(str, getTimestampFromInfo(iVpmInfo, str));
        }
        String[] strArr2 = sPreloadTsKeys;
