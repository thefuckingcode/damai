...
public class BaseTrack {
    ...
    private void addBaseDimensions(Map<String, String> map) {
        ...
        String str = "0";
        map.put(TableField.MEDIA_TYPE, vpmInfo.getString(TableField.MEDIA_TYPE, str));
        ...
        map.put("isAuto", vpmInfo.getString("isAuto", str));
        if (getTrack().isVip()) {
            str = "1";
        }
        map.put(TableField.IS_VIP, str);
    ...
    /* access modifiers changed from: protected */
    public String getValueFromInfo(IVpmInfo iVpmInfo, IVpmFullInfo iVpmFullInfo, String str) {
