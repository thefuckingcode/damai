...
public class OnePlayTrack extends BaseTrack implements BaseTrack.OnExtrasBuildCallback {
    ...
    private void commitPlayKeyStatistics(String str, int i) {
        ...
        measures.put("bufferLatency", Double.valueOf((double) this.bufferLatency));
        measures.put("videoFirstFrameDuration", Double.valueOf((double) this.videoFirstFrameDuration));
        ...
        measures.put("beginStage", Double.valueOf((double) i));
        ...
        measures.put("adPlayDuration", Double.valueOf((double) this.mTrack.getAdTrack().getEndPreAdTime()));
    ...
    private void onFirstFrame() {
        if (!this.mIsPlay) {
            ...
            this.mFeelingStartDuration = (double) (timestamp2 > 0 ? currentTimeMillis - timestamp2 : currentTimeMillis - this.mPlayTimeTrack.getTimestamp("playTs"));
