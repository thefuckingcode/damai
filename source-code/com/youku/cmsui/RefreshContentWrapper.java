...
public class RefreshContentWrapper implements ValueAnimator.AnimatorUpdateListener, RefreshContent, CoordinatorLayoutListener {
    protected n52 mBoundaryAdapter = new n52();
    ...
    public void moveSpinner(int i) {
        this.mRealContentView.setTranslationY((float) i);
    ...
    public void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        try {
            ...
            if (view instanceof AbsListView) {
                cc2.scrollListBy((AbsListView) view, intValue - this.mLastSpinner);
            } else {
    ...
    public void setScrollBoundaryDecider(ScrollBoundaryDecider scrollBoundaryDecider) {
        if (scrollBoundaryDecider instanceof n52) {
            this.mBoundaryAdapter = (n52) scrollBoundaryDecider;
        } else {
    ...
    public void setUpComponent(RefreshKernel refreshKernel, View view, View view2) {
        ...
        if (view != null || view2 != null) {
            ...
            if (view != null) {
                ...
                layoutParams2.height = cc2.measureViewHeight(view);
            ...
            if (view2 != null) {
                ...
                layoutParams3.height = cc2.measureViewHeight(view2);
