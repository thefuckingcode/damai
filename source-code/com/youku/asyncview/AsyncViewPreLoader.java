...
public class AsyncViewPreLoader {
    ...
    public static LayoutInflater getAsyncViewLayoutInflater(Context context, LayoutInflater layoutInflater) {
        if (getAsyncViewPreLoader(context) == null) {
            return layoutInflater;
        }
        return new AsyncViewPreLoaderLayoutInflater(layoutInflater, context);
    }
    ...
    public void asyncPreLoaderView(final int i, ViewGroup viewGroup, int i2) {
        ...
        asyncPlusLayoutInflater.setOnFastFinishedListener(new AsyncPlusLayoutInflater.OnFastFinishedListener() {
            /* class com.youku.asyncview.AsyncViewPreLoader.AnonymousClass1 */
