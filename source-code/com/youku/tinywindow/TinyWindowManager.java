...
public class TinyWindowManager implements TinyWindowHelperListener {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        /* class com.youku.tinywindow.TinyWindowManager.AnonymousClass1 */
                ...
                switch (c) {
                    ...
                    case 1:
                        ...
                        if (!TinyWindowManager.this.isInTinyWindowMode()) {
                            ...
                            return;
                        } else if (TinyWindowManager.this.mConfig == null || TinyWindowManager.this.mTinyWindowHelper == null) {
                            TinyLogger.log(TinyWindowManager.TAG, "TinyWindowManager onReceive mute--no config abort");
                            return;
                        } else if (TinyWindowManager.this.mConfig.isSurportMute()) {
                    ...
                    case 3:
                        ...
                        if (!TinyWindowManager.this.isInTinyWindowMode()) {
                            ...
                            return;
                        } else if (intent.getExtras().getInt("hashCode") != TinyWindowManager.this.mConfig.getLivePlayer().getPlayer().hashCode()) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setPlayerPause(boolean z) {
        TinyWindowConfig tinyWindowConfig = this.mConfig;
        if (tinyWindowConfig == null) {
            return;
        }
