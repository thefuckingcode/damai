...
public class FloatWindowManager {
    ...
    public static void createFloatWindow(Context context, View view, int i, int i2, boolean z, boolean z2, final FloatingWindowClickCallBack floatingWindowClickCallBack) {
        ...
        ((RelativeLayout) mFloatLayout.findViewById(R.id.btn_close_layout)).setOnClickListener(new View.OnClickListener() {
            /* class com.youku.tinywindow.floatwindow.FloatWindowManager.AnonymousClass1 */

            public void onClick(View view) {
                FloatingWindowClickCallBack floatingWindowClickCallBack = floatingWindowClickCallBack;
                if (floatingWindowClickCallBack != null) {
                    floatingWindowClickCallBack.onCloseBtnClick();
                }
            }
        });
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            /* class com.youku.tinywindow.floatwindow.FloatWindowManager.AnonymousClass2 */
            ...
            public void onClick(View view) {
                ...
                FloatingWindowClickCallBack floatingWindowClickCallBack = floatingWindowClickCallBack;
                if (floatingWindowClickCallBack != null) {
                    floatingWindowClickCallBack.onMuteBtnClick(FloatWindowManager.mIsMute);
                }
            }
        });
    ...
    public static void removeFloatWindowManager() {
        ...
        if (floatingLayout != null) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                z = floatingLayout.isAttachedToWindow();
            }
            if (mHasShown && z && (windowManager = mWindowManager) != null) {
