...
public class FloatingWindowPermissionManager {
    ...
    private void ROM360PermissionApply(final Context context) {
        showConfirmDialog(context, new OnConfirmResult() {
            /* class com.youku.tinywindow.floatwindow.permission.FloatingWindowPermissionManager.AnonymousClass1 */
    ...
    private void commonROMPermissionApply(final Context context) {
        if (RomUtils.checkIsMeizuRom()) {
            ...
            showConfirmDialog(context, new OnConfirmResult() {
                /* class com.youku.tinywindow.floatwindow.permission.FloatingWindowPermissionManager.AnonymousClass6 */
    ...
    private void huaweiROMPermissionApply(final Context context) {
        showConfirmDialog(context, new OnConfirmResult() {
            /* class com.youku.tinywindow.floatwindow.permission.FloatingWindowPermissionManager.AnonymousClass2 */
    ...
    private void meizuROMPermissionApply(final Context context) {
        showConfirmDialog(context, new OnConfirmResult() {
            /* class com.youku.tinywindow.floatwindow.permission.FloatingWindowPermissionManager.AnonymousClass3 */
    ...
    private void miuiROMPermissionApply(final Context context) {
        showConfirmDialog(context, new OnConfirmResult() {
            /* class com.youku.tinywindow.floatwindow.permission.FloatingWindowPermissionManager.AnonymousClass4 */
    ...
    private void oppoROMPermissionApply(final Context context) {
        showConfirmDialog(context, new OnConfirmResult() {
            /* class com.youku.tinywindow.floatwindow.permission.FloatingWindowPermissionManager.AnonymousClass5 */
    ...
    private void showConfirmDialog(Context context, String str, final OnConfirmResult onConfirmResult) {
        ...
        AlertDialog create = new AlertDialog.Builder(context).setCancelable(true).setTitle("").setMessage(str).setPositiveButton("现在去开启", new DialogInterface.OnClickListener() {
            /* class com.youku.tinywindow.floatwindow.permission.FloatingWindowPermissionManager.AnonymousClass8 */
            ...
            /* class com.youku.tinywindow.floatwindow.permission.FloatingWindowPermissionManager.AnonymousClass7 */
