...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u0007\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u001a\u0010\u001bJ\f\u0010\u0003\u001a\u00020\u0002*\u00020\u0002H\u0002J\f\u0010\u0004\u001a\u00020\u0002*\u00020\u0002H\u0002J\u0014\u0010\b\u001a\u00020\u00072\n\b\u0002\u0010\u0006\u001a\u0004\u0018\u00010\u0005H\u0002J\u000e\u0010\t\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005J\u000e\u0010\n\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005J\u000e\u0010\u000b\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005J\u000e\u0010\f\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005J\b\u0010\t\u001a\u00020\u0002H\u0007J\b\u0010\n\u001a\u00020\u0002H\u0007J\b\u0010\u000b\u001a\u00020\u0002H\u0007J\b\u0010\f\u001a\u00020\u0002H\u0007J\u000e\u0010\u000e\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\u0002J\u000e\u0010\u0010\u001a\u00020\u00022\u0006\u0010\u000f\u001a\u00020\u0002R\u0016\u0010\u0012\u001a\u00020\u00118\u0002@\u0002XT¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u0016\u0010\u0014\u001a\u00020\u00028\u0002@\u0002X\u000e¢\u0006\u0006\n\u0004\b\u0014\u0010\u0015R\u0016\u0010\u0016\u001a\u00020\u00028\u0002@\u0002X\u000e¢\u0006\u0006\n\u0004\b\u0016\u0010\u0015R\u0016\u0010\u0018\u001a\u00020\u00178\u0002@\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0018\u0010\u0019¨\u0006\u001c"}, d2 = {"Lcom/youku/gaiax/common/utils/ScreenUtils;", "", "", "convertDpToPixel", "convertPixelsToDp", "Landroid/content/Context;", WPKFactory.INIT_KEY_CONTEXT, "Ltb/ur2;", "initScreen", "getScreenWidthPx", "getScreenHeightPx", "getScreenHeightDP", "getScreenWidthDP", "dp", "toPx", "px", "toDp", "", "TAG", "Ljava/lang/String;", "screenWidth", UTConstant.Args.UT_SUCCESS_F, "screenHeight", "Landroid/util/DisplayMetrics;", "dm", "Landroid/util/DisplayMetrics;", "<init>", "()V", "GaiaX-Android"}, k = 1, mv = {1, 5, 1})
...
public final class ScreenUtils {
    ...
    private final void initScreen(Context context) {
        ...
        if (activity != null) {
            screenWidth = (float) activity.getWindow().getDecorView().getMeasuredWidth();
            ...
            if (Build.VERSION.SDK_INT >= 24 && activity.isInMultiWindowMode()) {
                screenWidth = (float) Math.round(((double) (((float) activity.getResources().getConfiguration().screenWidthDp) * activity.getResources().getDisplayMetrics().density)) + 0.5d);
            ...
            float f = (float) com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getwidthPixels(displayMetrics);
            screenWidth = f;
            float f2 = (float) com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getheightPixels(displayMetrics);
            screenHeight = f2;
            if (!(f == 0.0f)) {
                if (f2 != 0.0f) {
                    z = false;
        ...
        if (applicationContext != null) {
            ...
            if (windowManager != null) {
                ...
                screenWidth = (float) com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getwidthPixels(displayMetrics2);
                screenHeight = (float) com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getheightPixels(displayMetrics2);
            }
        }
    }
