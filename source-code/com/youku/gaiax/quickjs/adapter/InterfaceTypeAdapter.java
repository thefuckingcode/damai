...
public class InterfaceTypeAdapter extends TypeAdapter<Object> {
    public static final TypeAdapter.Factory FACTORY = new TypeAdapter.Factory() {
        /* class com.youku.gaiax.quickjs.adapter.InterfaceTypeAdapter.AnonymousClass1 */
    ...
    static Map<String, Method> getInterfaceMethods(Type type) {
        ...
        java.lang.reflect.Method[] methods2 = rawType2.getMethods();
    ...
    public Object fromJSValue(final TypeAdapter.Depot depot, final TypeAdapter.Context context, final JSValue jSValue) {
        ...
        return Proxy.newProxyInstance(this.rawType.getClassLoader(), new Class[]{this.rawType, JSValueHolder.class}, new InvocationHandler() {
            /* class com.youku.gaiax.quickjs.adapter.InterfaceTypeAdapter.AnonymousClass2 */
