...
public final class GaiaXRemoteCacheUtils {
    ...
    public final String getCachePath() {
        ...
        if (applicationContext != null) {
            ...
            k21.h(absolutePath, "File(getCacheRootPath(co…EMPLATE_DIR).absolutePath");
            return absolutePath;
        }
        String absolutePath2 = new File(GAIAX_TEMPLATE_DIR).getAbsolutePath();
        k21.h(absolutePath2, "File(GAIAX_TEMPLATE_DIR).absolutePath");
        return absolutePath2;
    }
            ...
            if (decode != null) {
                ...
                if (genTemplateFile.exists()) {
                    if (genTemplateFile.length() > 0) {
                        ...
                        k21.h(absolutePath, "unzipFile.absolutePath");
