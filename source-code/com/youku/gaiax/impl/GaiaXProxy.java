...
public final class GaiaXProxy {
    ...
    private final <T> T tryToCreateClazz(String str) {
        ...
        if (log.isLaunchLog()) {
            log.d("[GaiaX]", k21.r("GaiaX初始化逻辑 - 配置 = ", str));
        }
        if (str == null) {
            return null;
        }
    ...
    public final void initModules() {
        IProxyApp iProxyApp = this.f1065app;
        if (iProxyApp != null) {
            iProxyApp.appInit();
        }
