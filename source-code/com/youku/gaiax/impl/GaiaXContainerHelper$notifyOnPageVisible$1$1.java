...
public final class GaiaXContainerHelper$notifyOnPageVisible$1$1 extends Lambda implements Function1<GXViewHolder, ur2> {
    public static final GaiaXContainerHelper$notifyOnPageVisible$1$1 INSTANCE = new GaiaXContainerHelper$notifyOnPageVisible$1$1();

    GaiaXContainerHelper$notifyOnPageVisible$1$1() {
        super(1);
    }
    ...
    public final void invoke(@NotNull GXViewHolder gXViewHolder) {
        ...
        GaiaXContainerHelper.access$onPageVisible(GaiaXContainerHelper.INSTANCE, gXViewHolder);
    }
}
