...
final class QuickJSTimer$SetInterval$invoke$1 extends Lambda implements Function0<ur2> {
    final /* synthetic */ JSFunction $func;
    final /* synthetic */ JSContext $jsContext;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    QuickJSTimer$SetInterval$invoke$1(JSFunction jSFunction, JSContext jSContext) {
        super(0);
