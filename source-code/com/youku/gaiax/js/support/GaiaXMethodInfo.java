...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0011\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\t\b\u0010\u0018\u00002\u00020\u0001:\u0003%&'B\u0017\u0012\u0006\u0010\n\u001a\u00020\t\u0012\u0006\u0010\u000f\u001a\u00020\u000e¢\u0006\u0004\b#\u0010$J\u001a\u0010\u0006\u001a\u0004\u0018\u00010\u00022\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0016J\u0010\u0010\b\u001a\u00020\u00072\u0006\u0010\u0005\u001a\u00020\u0004H\u0016R\u0019\u0010\n\u001a\u00020\t8\u0006@\u0006¢\u0006\f\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\rR\u0019\u0010\u000f\u001a\u00020\u000e8\u0006@\u0006¢\u0006\f\n\u0004\b\u000f\u0010\u0010\u001a\u0004\b\u0011\u0010\u0012R\u0019\u0010\u0014\u001a\u00020\u00138\u0006@\u0006¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017R,\u0010\u0019\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\u0002\u0018\u00010\u00188\u0006@\u0006X\u000e¢\u0006\u0012\n\u0004\b\u0019\u0010\u001a\u001a\u0004\b\u001b\u0010\u001c\"\u0004\b\u001d\u0010\u001eR\u0013\u0010\"\u001a\u00020\u001f8F@\u0006¢\u0006\u0006\u001a\u0004\b \u0010!¨\u0006("}, d2 = {"Lcom/youku/gaiax/js/support/GaiaXMethodInfo;", "Lcom/youku/gaiax/js/api/IGaiaXModuleMethod;", "", "obj", "Lcom/alibaba/fastjson/JSONArray;", "args", "invoke", "Ltb/ur2;", "convertArgsToArguments", "", "id", "J", "getId", "()J", "Ljava/lang/reflect/Method;", "rawMethod", "Ljava/lang/reflect/Method;", "getRawMethod", "()Ljava/lang/reflect/Method;", "Lcom/youku/gaiax/js/support/GaiaXMethod;", "method", "Lcom/youku/gaiax/js/support/GaiaXMethod;", "getMethod", "()Lcom/youku/gaiax/js/support/GaiaXMethod;", "", "arguments", "[Ljava/lang/Object;", "getArguments", "()[Ljava/lang/Object;", "setArguments", "([Ljava/lang/Object;)V", "", "getName", "()Ljava/lang/String;", "name", "<init>", "(JLjava/lang/reflect/Method;)V", "GaiaXAsyncMethodInfo", "GaiaXPromiseMethodInfo", "GaiaXSyncMethodInfo", "GaiaX-Android-JS"}, k = 1, mv = {1, 5, 1})
...
public class GaiaXMethodInfo implements IGaiaXModuleMethod {
    ...
    public GaiaXMethodInfo(long j, @NotNull Method method2) {
        k21.i(method2, "rawMethod");
        this.id = j;
        this.rawMethod = method2;
        method2.setAccessible(true);
        GaiaXMethod create = GaiaXMethod.create(method2.getReturnType(), method2);
        k21.h(create, "create(rawMethod.returnType, rawMethod)");
        this.method = create;
    }
    ...
    public void convertArgsToArguments(@NotNull JSONArray jSONArray) {
        ...
        if (jSONArray.size() == this.method.parameterTypes.length) {
            ...
            k21.h(typeArr, "method.parameterTypes");
    ...
    public Object invoke(@NotNull Object obj, @NotNull JSONArray jSONArray) {
        ...
        Method method2 = this.rawMethod;
        Object[] objArr = this.arguments;
        k21.f(objArr);
        return method2.invoke(obj, Arrays.copyOf(objArr, objArr.length));
    }
