...
public final class GaiaXMethod {
    ...
    public static GaiaXMethod create(Type type, Method method) {
        ...
        return new GaiaXMethod(resolve, name2, typeArr);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.returnType.equals(gaiaXMethod.returnType) || !this.name.equals(gaiaXMethod.name) || !Arrays.equals(this.parameterTypes, gaiaXMethod.parameterTypes)) {
            return false;
        }
        return true;
    }
