...
public final class GaiaXJS$startEngine$1$2 extends Lambda implements Function1<Long, ur2> {
    public static final GaiaXJS$startEngine$1$2 INSTANCE = new GaiaXJS$startEngine$1$2();

    GaiaXJS$startEngine$1$2() {
        super(1);
    }
