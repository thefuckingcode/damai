...
public class GaiaXCustomDialogView extends Dialog {
    ...
    private int getWidth() {
        ...
        return DeviceInfoProviderProxy.getWindowWidth();
    }
    ...
    private GaiaX.Params.Builder initGaiaXBuilder() {
        ...
        String string2 = this.params.getString(if1.DIMEN_BIZ);
        ...
        return getHeightBuilder(new GaiaX.Params.Builder().templateId(string).templateBiz(string2).container(this.mContainer).width((float) getWidth()).data(getTemplateData()).mode(LoadType.SYNC_NORMAL));
    }

    /* access modifiers changed from: protected */
    public void doEvent(@NonNull EventParams eventParams) {
    ...
    /* access modifiers changed from: protected */
    public void doTrack(@NonNull TrackParams trackParams) {
    ...
    public GaiaX.IEventDelegate getEventDelegate() {
        return new GaiaX.IEventDelegate() {
            /* class com.youku.gaiax.provider.module.js.GaiaXCustomDialogView.AnonymousClass1 */
    ...
    public GaiaX.ITrackDelegate3 getTrackDelegate() {
        return new GaiaX.ITrackDelegate3() {
            /* class com.youku.gaiax.provider.module.js.GaiaXCustomDialogView.AnonymousClass2 */
