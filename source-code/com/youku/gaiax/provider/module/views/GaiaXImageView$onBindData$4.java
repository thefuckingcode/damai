...
final class GaiaXImageView$onBindData$4 extends Lambda implements Function2<ImageView, String, ur2> {
    final /* synthetic */ JSONObject $data;
    final /* synthetic */ GaiaXImageView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GaiaXImageView$onBindData$4(JSONObject jSONObject, GaiaXImageView gaiaXImageView) {
        super(2);
    ...
    public final void invoke(@NotNull ImageView imageView, @NotNull String str) {
        ...
        if (str.length() == 0) {
            this.this$0.setImageDrawable(new ColorDrawable(0));
        }
    }
}
