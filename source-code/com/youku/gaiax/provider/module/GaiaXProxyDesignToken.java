...
public final class GaiaXProxyDesignToken implements IProxyDesignToken {
    ...
    private final Integer getDimenToken(String str) {
        try {
            DimenStrategyTokenManager instance = DimenStrategyTokenManager.Companion.getInstance();
            Context appContext = AppInfoProviderProxy.getAppContext();
            k21.h(appContext, "getAppContext()");
            return (Integer) instance.getToken(appContext, str);
    ...
    private final Integer getFontToken(String str) {
        try {
            FontStrategyTokenManager instance = FontStrategyTokenManager.Companion.getInstance();
            Context appContext = AppInfoProviderProxy.getAppContext();
            k21.h(appContext, "getAppContext()");
            return (Integer) instance.getToken(appContext, str);
        } catch (Exception unused) {
    ...
    public Float designTokenDimen(@NotNull String str) {
        ...
        return Float.valueOf((float) deviceToken.intValue());
    }
