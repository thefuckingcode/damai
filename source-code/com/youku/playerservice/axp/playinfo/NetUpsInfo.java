...
public class NetUpsInfo {
    ...
    private void pretreatmentMainStreamInfo(VideoInfo videoInfo) {
        ...
        if (!enableAutoUpsStreamType() || videoInfo == null || videoInfo.getController() == null || !videoInfo.getController().getStream_config()) {
                ...
                while (it.hasNext()) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (TextUtils.isEmpty(next2)) {
                            ...
                            str2 = "isStreamExt is NULL,不参与清晰度映射更新,langCode=[" + key + "],streamType=[" + next2 + jl1.ARRAY_END_STR;
                        } else {
            ...
            str = "PretreatmentStreamInfo time consuming is:" + (currentTimeMillis2 - currentTimeMillis) + "  ,time begin is:" + currentTimeMillis + "  ,time end is:" + currentTimeMillis2;
        }
