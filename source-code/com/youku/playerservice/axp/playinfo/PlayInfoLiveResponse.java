...
public class PlayInfoLiveResponse extends PlayInfoResponse {
    ...
    private List<LiveItem> getLiveItems(PlayParams playParams, boolean z, LivePlayControl livePlayControl) {
        ...
        if (!z2 || TextUtils.isEmpty(defaultQuality.h265PlayUrl)) {
            ...
            str = defaultQuality.h264TSUrl;
        } else {
            str2 = defaultQuality.h265PlayUrl;
            str = defaultQuality.h265TSUrl;
            codec = Codec.H265;
        }
    ...
    public List<LiveItem> getPlayItem(PlayParams playParams) {
        ...
        if ("live".equals(livePlayControl2.streamMode)) {
                ...
                while (it2.hasNext()) {
                    ...
                    if (TextUtils.isEmpty(livePlayControl2.sceneId) || !livePlayControl2.sceneId.equals(next.sceneId)) {
                        ...
                        try {
                            ...
                            String string4 = parseObject3.getJSONObject("data").getJSONObject("data").getString(lf1.RESOURCE_STREAM);
                            JSONArray parseArray = JSON.parseArray(string4);
                            String string5 = playParams.getPlayIdParams().getString("targetSceneId");
                            String str = livePlayControl2.sceneId;
                            ...
                            while (true) {
                                ...
                                if ("1".equals(jSONObject2.getString("templateType"))) {
                                    ...
                                    while (true) {
                                        ...
                                        livePlayControl = livePlayControl2;
                                        JSONArray jSONArray2 = jSONArray.getJSONObject(i2).getJSONArray("positionNormalized");
                                        float parseFloat = Float.parseFloat(jSONArray2.getString(0));
                                        float parseFloat2 = Float.parseFloat(jSONArray2.getString(1));
                                        if (parseFloat == 0.0f && parseFloat2 == 0.0f && string5.equals(jSONArray.getJSONObject(i2).getString("sceneId"))) {
                            ...
                            String str2 = (doMtopRequest == null || (parseObject = JSON.parseObject(new String(doMtopRequest.getBytedata()))) == null || !parseObject.containsKey("data") || (jSONObject = parseObject.getJSONObject("data")) == null) ? "unknow" : jSONObject.getString("code") + JSMethod.NOT_SET + jSONObject.getString("msg");
                            PlayInfoError playInfoError = new PlayInfoError();
                            playInfoError.setErrorCode(Math.abs((int) fe0.ERROR_IO_EXCEPTION) + 60000);
            ...
            return liveItems;
        } else if (!"mic".equals(livePlayControl2.streamMode)) {
            return arrayList;
        } else {
            ...
            String str3 = livePlayControl2.micInfo.po.get(0);
            ...
            for (int i3 = 0; i3 < arrayList2.size(); i3++) {
                String str4 = "rtp".equals(str3) ? ((MicPlayInfo) arrayList2.get(i3)).rtp.Url : "httpFlv".equals(str3) ? ((MicPlayInfo) arrayList2.get(i3)).flv.Url : "artp".equals(str3) ? ((MicPlayInfo) arrayList2.get(i3)).artp.Url : "grtn".equals(str3) ? ((MicPlayInfo) arrayList2.get(i3)).grtn.Url : "";
                PlayDefinition.PlayFormat playFormatByProtocol = PlayDefinition.PlayFormat.getPlayFormatByProtocol(str3);
                LiveItem liveItem = new LiveItem(playParams, str4);
