...
public class QGetUpsRequest extends AbsPlayInfoRequest {
    ...
    public void request(PlayParams playParams) {
        if (!this.mIsCancel && playParams != null) {
            ...
            String str = "0";
            requestParams.put("skh", PlayerUtil.isSkipHeadAndTail(this.mContext) ? "1" : str);
            ...
            if (this.mPlayerConfig.isSupport("h265")) {
                str = "1";
            }
            requestParams.put("h265", str);
            ...
            if (Utils.isYoukuOrHuaweiBaipai(this.mContext) && TextUtils.isEmpty((CharSequence) requestParams.get(IRequestConst.STOKEN))) {
            ...
            final String str3 = generateEncryptRClient.R1;
            requestParams.put("encryptR_client", str2);
            requestParams.put("key_index", generateEncryptRClient.keyIndex);
            this.mUpsQGetRequest.a(requestParams, createNetworkParam(), new a<List<VideoCacheInfo>>() {
                /* class com.youku.playerservice.axp.playinfo.request.QGetUpsRequest.AnonymousClass1 */
