...
public class MultiGetUpsRequest extends AbsPlayInfoRequest {
    ...
    private GetUps mUps = new GetUps(this.mContext, new OkHttpTask(this.mContext, getTimeOut(), null));
    ...
    public void request(final PlayParams playParams) {
        ...
        this.mUps.getMultiVideoInfo(playVideoInfo, hashMap, createNetworkParam, new IMultiVideoInfoCallBack() {
            /* class com.youku.playerservice.axp.playinfo.request.MultiGetUpsRequest.AnonymousClass1 */
