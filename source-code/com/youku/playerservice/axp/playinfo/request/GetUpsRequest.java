        ...
        if (!this.mIsCancel) {
            ...
            if (dlnaParams == null || dlnaParams.size() <= 0) {
                ...
                for (int i2 = 0; i2 < 9; i2++) {
                    ...
                    String str3 = dlnaParams.get(str2);
            ...
            try {
                if (this.mPlayerConfig.getDrmConfig() != null) {
                    ...
                    requestParams.put("encryptR_client", str5);
            ...
            this.mRequest = (TextUtils.isEmpty(string) || TextUtils.isEmpty(string2)) ? new b(this.mContext, mockTask, z) : new b(this.mContext, mockTask, z, string, string2);
            ...
            this.mRequest.a(requestParams, requestParams2, createNetworkParam, new a<VideoInfo>() {
                /* class com.youku.playerservice.axp.playinfo.request.GetUpsRequest.AnonymousClass1 */
