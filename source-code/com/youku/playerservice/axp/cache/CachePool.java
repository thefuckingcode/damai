...
public class CachePool {
    ...
    private String getCookieParam(Context context) {
        ...
        String str = "1";
        String str2 = VipUserService.getInstance().isVip() ? VipUserService.getInstance().isLightVip() ? "2" : str : "0";
        if (!Passport.isLogin()) {
            str = "0";
        }
    ...
    private synchronized void removeCachedResponse(String str) {
        ...
        CacheLocalController cacheLocalController2 = this.cacheLocalController;
        if (cacheLocalController2 != null) {
            cacheLocalController2.cleanPlayInfo(str);
        }
    }
    ...
    public synchronized void savePlayInfoResponseList(Context context, List<PlayInfoResponse> list) {
        CacheLocalController cacheLocalController2;
        if (ApsUtil.enablePlayInfoResponseCache()) {
            if (!(list == null || list.size() == 0)) {
                ...
                Boolean bool = this.enableLocalCache;
                if (!(bool == null || !bool.booleanValue() || (cacheLocalController2 = this.cacheLocalController) == null)) {
                    cacheLocalController2.savePlayInfoResponse(list, (Map<String, String>) null, (Map<String, String>) null);
                }
            }
        }
    }
