...
public class VideoStoreDao_Impl implements VideoStoreDao {
    ...
    public VideoStoreDao_Impl(RoomDatabase roomDatabase) {
        ...
        this.__insertionAdapterOfVideoUpsInfoEntity = new EntityInsertionAdapter<VideoUpsInfoEntity>(roomDatabase) {
            /* class com.youku.playerservice.axp.cache.local.db.dao.VideoStoreDao_Impl.AnonymousClass1 */
        ...
        this.__preparedStmtOfDeleteExpiredCache = new SharedSQLiteStatement(roomDatabase) {
            /* class com.youku.playerservice.axp.cache.local.db.dao.VideoStoreDao_Impl.AnonymousClass2 */
        ...
        this.__preparedStmtOfDeleteCache = new SharedSQLiteStatement(roomDatabase) {
            /* class com.youku.playerservice.axp.cache.local.db.dao.VideoStoreDao_Impl.AnonymousClass3 */
    ...
    public List<VideoUpsInfoEntity> getUpsCacheData(String str, long j) {
        ...
        try {
            ...
            int columnIndexOrThrow4 = query.getColumnIndexOrThrow(kn2.KEY_EXTRA_PARAMS);
            int columnIndexOrThrow5 = query.getColumnIndexOrThrow("rawData");
            int columnIndexOrThrow6 = query.getColumnIndexOrThrow(e03.EXTRA_DATA_DIMEN);
