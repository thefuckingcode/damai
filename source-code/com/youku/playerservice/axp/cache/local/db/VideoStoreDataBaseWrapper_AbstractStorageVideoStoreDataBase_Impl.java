...
public class VideoStoreDataBaseWrapper_AbstractStorageVideoStoreDataBase_Impl extends VideoStoreDataBaseWrapper.AbstractStorageVideoStoreDataBase {
    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new RoomOpenHelper.Delegate(1) {
            /* class com.youku.playerservice.axp.cache.local.db.VideoStoreDataBaseWrapper_AbstractStorageVideoStoreDataBase_Impl.AnonymousClass1 */
            ...
            public void validateMigration(SupportSQLiteDatabase supportSQLiteDatabase) {
                ...
                hashMap.put(kn2.KEY_EXTRA_PARAMS, new TableInfo.Column(kn2.KEY_EXTRA_PARAMS, "TEXT", false, 0));
                hashMap.put("rawData", new TableInfo.Column("rawData", "TEXT", false, 0));
                hashMap.put(e03.EXTRA_DATA_DIMEN, new TableInfo.Column(e03.EXTRA_DATA_DIMEN, "TEXT", false, 0));
