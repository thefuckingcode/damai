...
public class MediaMap {
    ...
    private static final List<Quality> mBitStreamOrderList = new ArrayList<Quality>() {
        /* class com.youku.playerservice.axp.item.MediaMap.AnonymousClass1 */
    ...
    private static final Quality[] mQualityOrderList = {Quality.AUTO, Quality.HD3GP, Quality.SD, Quality.SD_HDR, Quality.HD, Quality.HD_HDR, Quality.HD2, Quality.HD2_HDR, Quality.HD2_HDR_HFR, Quality.HD2_PW_HDR, Quality.HD2_PW_HDR_HFR, Quality.HD3, Quality.HD3_HDR, Quality.HD3_HDR_HFR, Quality.HD3_PW_HDR, Quality.HD3_PW_HDR_HFR, Quality.DOLBY, Quality.HD4K, Quality.HD4K_HDR, Quality.HD4K_HDR_HFR, Quality.HD4K_PW_HDR, Quality.HD4K_PW_HDR_HFR, Quality.HD3_HBR};
    ...
    public static class MediaFormat {
        ...
        private MediaFormat(String str, Quality quality2) {
            this(str, quality2, Codec.H264, HdrType.NO_HDR);
        }

        private MediaFormat(String str, Quality quality2, Codec codec) {
            this(str, quality2, codec, HdrType.NO_HDR);
        }

        public MediaFormat(String str, Quality quality2, Codec codec, HdrType hdrType2) {
            this(str, quality2, codec, hdrType2, 8);
        }

        public MediaFormat(String str, Quality quality2, Codec codec, HdrType hdrType2, int i) {
            this.bitDepth = 8;
            this.streamType = str;
