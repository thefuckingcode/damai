...
public class BitStream {
    ...
    public PlayDefinition.PlayFormat getPlayFormat() {
        ...
        return str != null ? str.contains("#EXT-X-STREAM-INF") ? PlayDefinition.PlayFormat.HLS : "1".equals(Uri.parse(this.mM3u8Url).getQueryParameter("sm")) ? PlayDefinition.PlayFormat.HLS : PlayDefinition.PlayFormat.getPlayFormatByUrl(this.mM3u8Url) : PlayDefinition.PlayFormat.MP4;
    }
