...
public class PlayParams {
    private Map<String, String> mExtConfigMap = new HashMap();
    private boolean mIsForcePlay = true;
    ...
    private boolean mReusedPlayer = true;
    private String mSessionId;
    private long mStartTime = -1;
    private Map<String, String> mStringMap = new ConcurrentHashMap();
    private UpsProxyInfo mUpsProxyInfo;
    private final IVpmInfo mVpmInfo = new IVpmInfo() {
        /* class com.youku.playerservice.axp.playparams.PlayParams.AnonymousClass1 */
