...
public class FrameProcessingModule extends BaseModule {
    ...
    private static HashMap<Integer, String> MISS_MATCH_MAP = new HashMap() {
        /* class com.youku.playerservice.axp.modules.postprocessing.FrameProcessingModule.AnonymousClass1 */
    ...
    private InteractionDataManager mDataManager = null;
    ...
    public void processData(byte[] bArr, Map<Integer, String> map, long j, long j2, long j3, long j4, long j5) {
        ...
        if (interactionDataManager != null) {
            workInGeneralMode(interactionDataManager, (((double) j) * 1.0d) / ((double) j2), map);
        }
    }
}
