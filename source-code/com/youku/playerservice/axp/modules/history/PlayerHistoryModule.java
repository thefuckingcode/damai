...
public class PlayerHistoryModule extends BaseModule {
    ...
    private final Runnable mUpdateHistoryRunnable = new Runnable() {
        /* class com.youku.playerservice.axp.modules.history.PlayerHistoryModule.AnonymousClass1 */
    ...
    private void addPlayHistory(int i, int i2, @UploadChanceConstants.UploadChanceType String str) {
        VideoInfo videoInfo;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void addPlayHistory(int i, @UploadChanceConstants.UploadChanceType String str) {
    ...
    public void onRealVideoStart() {
        ...
        if (this.mWritePlayerHistory && (handler = this.mHandlder) != null) {
            handler.post(new Runnable() {
                /* class com.youku.playerservice.axp.modules.history.PlayerHistoryModule.AnonymousClass2 */
    ...
    public void onSeekTo(final int i) {
        if (this.mWritePlayerHistory && this.mHandlder != null) {
            ...
            this.mHandlder.post(new Runnable() {
                /* class com.youku.playerservice.axp.modules.history.PlayerHistoryModule.AnonymousClass3 */
