...
public class LoadingMoreFooter extends LinearLayout implements FooterImpl {
    ...
    private boolean hasBottomPadding = false;
    ...
    public LoadingMoreFooter(Context context2) {
        super(context2);
    ...
    public void initView() {
        ...
        this.mText.setTextSize(0, (float) getResources().getDimensionPixelOffset(R$dimen.home_card_item_text_size));
    ...
    public LoadingMoreFooter(Context context2, boolean z) {
        super(context2);
        this.context = context2;
        this.hasBottomPadding = z;
        initView();
    ...
    public LoadingMoreFooter(Context context2, AttributeSet attributeSet) {
