...
public class HintRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private void smoothScrollTo(int i) {
        ...
        ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.youku.widget.HintRefreshHeader.AnonymousClass3 */
    ...
    public void refreshComplete(SpannableStringBuilder spannableStringBuilder) {
        ...
        new Handler().postDelayed(new Runnable() {
            /* class com.youku.widget.HintRefreshHeader.AnonymousClass1 */
    ...
    public void reset() {
        smoothScrollTo(0);
        new Handler().postDelayed(new Runnable() {
            /* class com.youku.widget.HintRefreshHeader.AnonymousClass2 */
