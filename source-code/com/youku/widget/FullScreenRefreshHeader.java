...
public class FullScreenRefreshHeader extends ArrowRefreshHeader {
    public boolean isEnableFullPull = false;
    ...
    public void initView() {
        ...
        this.mArrowRotateHeight = (int) ((((float) i) * 0.1f) + ((float) i2));
        this.mRefreshingHeight = (int) ((((float) i) * 0.1f) + ((float) i2));
    ...
    @Override // com.youku.widget.BaseRefreshHeader, com.youku.widget.ArrowRefreshHeader
    public boolean releaseAction() {
        ...
        if (this.mState == 2 && ((float) visibleHeight) >= (((float) this.mMaxPullDownDistance) * 0.2f) + ((float) this.mInitHeight) && this.isEnableFullPull) {
            setState(3);
        }
    ...
    public void resetInitHeight(int i) {
        ...
        this.mArrowRotateHeight = (int) ((((float) i2) * 0.1f) + ((float) i3));
        this.mRefreshingHeight = (int) ((((float) i2) * 0.1f) + ((float) i3));
