...
public class d {
    ...
    private d() {
        this.a = new ConfigFetcher.ConfigGetter() {
            /* class com.youku.player.util.d.AnonymousClass1 */
    ...
    public Map<String, String> a(String str) {
        ...
        try {
            ...
            sb.append(", fetcher:");
            String str2 = "null";
            sb.append(ConfigFetcher.getInstance() == null ? str2 : ConfigFetcher.getInstance().toString());
            ...
            if (ConfigFetcher.getInstance() != null) {
                ...
                sb2.append(getterFactory == null ? str2 : getterFactory.toString());
