...
public class OPRBitmapUtils {
    ...
    private static Bitmap drawText(String str, int i, int i2, String str2, boolean z, int i3, int i4) {
        ...
        int[] iArr = {i3, i4};
        if (z) {
            linearGradient = new LinearGradient((float) i5, (float) i6, (float) i7, (float) i8, iArr, (float[]) null, Shader.TileMode.CLAMP);
        } else {
        ...
        float abs = (((Math.abs(fontMetrics.ascent) + f2) / 2.0f) - f2) + ((float) (i9 / 2));
