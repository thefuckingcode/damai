...
public class Utils {
        ...
        try {
            if (get == null) {
                synchronized (Utils.class) {
                    if (get == null) {
                        get = Class.forName("android.os.SystemProperties").getDeclaredMethod(gl1.TYPE_OPEN_URL_METHOD_GET, String.class, String.class);
                    }
                }
            }
    ...
    private static int getNetworkType(Context context) {
        try {
            ...
            if (Build.VERSION.SDK_INT < 30) {
                return com.alibaba.wireless.security.aopsdk.replace.android.telephony.TelephonyManager.getNetworkType(telephonyManager);
            }
    ...
    public static String getUpsNetworkType(Context context) {
        ...
        if (netType != 1) {
            return (netType == 2 || netType == 3 || netType == 4 || netType == 5) ? UpsConstant.UPS_NETWORK_4G : UpsConstant.UPS_NETWORK_UNKOWN;
        }
        return "1000";
    }
