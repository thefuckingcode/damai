...
public final class CookieUtil {
    ...
    public static void checkMarkSDK(Context context) {
        try {
            ...
            String cookie = instance.getCookie(DOMAIN_YOUKU);
            if (TextUtils.isEmpty(cookie) || !cookie.contains("passport_sdk=Android")) {
                setCookie(instance, COOKIE_KEY_SDK, COOKIE_VALUE_SDK, false);
                instance.setCookie(DOMAIN_SECURITY, generateCookie(DOMAIN_SECURITY, COOKIE_KEY_DEVICE, SysUtil.getDeviceId(context), false));
                instance.setCookie(DOMAIN_SECURITY, generateCookie(DOMAIN_SECURITY, COOKIE_KEY_APPID, PassportManager.getInstance().getConfig().mAppId, false));
    ...
    public static void clearCookie(Context context) {
        try {
            CookieSyncManager createInstance = CookieSyncManager.createInstance(context);
            CookieManager instance = CookieManager.getInstance();
            setCookie(instance, "P_sck", "", true);
            setCookie(instance, COOKIE_KEY_YKTK, "", false);
            setCookie(instance, COOKIE_KEY_PTOKEN, "", false);
            if (Build.VERSION.SDK_INT >= 21) {
                instance.flush();
            } else {
                createInstance.sync();
    ...
    public static void clearExtraCookie(Context context, JSONObject jSONObject) {
        if (jSONObject != null) {
            try {
                ...
                while (keys.hasNext()) {
                    instance.setCookie(DOMAIN_YOUKU, generateCookie(DOMAIN_YOUKU, keys.next(), "", false));
                }
                if (Build.VERSION.SDK_INT >= 21) {
                    instance.flush();
                } else {
    ...
    public static void markSDK(Context context, String str, boolean z) {
        try {
            ...
            setCookie(instance, COOKIE_KEY_SDK, COOKIE_VALUE_SDK, false);
            instance.setCookie(DOMAIN_SECURITY, generateCookie(DOMAIN_SECURITY, COOKIE_KEY_DEVICE, SysUtil.getDeviceId(context), false));
            instance.setCookie(DOMAIN_SECURITY, generateCookie(DOMAIN_SECURITY, COOKIE_KEY_APPID, str, false));
            if (Build.VERSION.SDK_INT >= 21) {
                instance.flush();
            } else {
                createInstance.sync();
    ...
    public static void syncCookie(Context context, String str, String str2) {
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                setCookie(instance, "P_sck", str, true);
                setCookie(instance, COOKIE_KEY_PTOKEN, "", false);
            }
            if (!TextUtils.isEmpty(str2)) {
                setCookie(instance, COOKIE_KEY_YKTK, str2, false);
            }
            if (Build.VERSION.SDK_INT >= 21) {
                instance.flush();
            } else {
        ...
        if (jSONObject != null) {
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    instance.setCookie(DOMAIN_YOUKU, generateCookie(DOMAIN_YOUKU, next, jSONObject.optString(next), false));
                }
                if (Build.VERSION.SDK_INT >= 21) {
                    instance.flush();
                } else {
