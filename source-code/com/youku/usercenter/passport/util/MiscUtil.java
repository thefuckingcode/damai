...
public final class MiscUtil {
    ...
    public static String getHiddenEmail(String str) {
        ...
        return ((Object) str2.subSequence(0, 3)) + "***" + o70.DINAMIC_PREFIX_AT + split[1];
    }
    ...
    public static String securityRead(Context context, String str) {
        ...
        try {
            ...
            PassportAppMonitor.commitSecurityIOError(lf1.OPERATION_READ, "normal", str, i);
            return null;
        } catch (Exception e2) {
    ...
    private static String securityReadEx(Context context, String str) {
        ...
        try {
            ...
            PassportAppMonitor.commitSecurityIOError(lf1.OPERATION_READ, "extend", str, i);
            return null;
        } catch (Exception e2) {
            Logger.e("ali security read normal exception!");
    ...
    public static boolean securitySave(Context context, String str, String str2) {
        int i;
        try {
            boolean securitySaveEx = securitySaveEx(context.getApplicationContext(), str, str2);
            int putString = SecurityGuardManager.getInstance(context).getDynamicDataStoreComp().putString(str, str2);
            if (securitySaveEx || putString == 1) {
                return true;
            }
            return false;
        } catch (SecException e) {
            ...
            PassportAppMonitor.commitSecurityIOError(lf1.OPERATION_WRITE, "normal", str, i);
            return false;
        } catch (Exception e2) {
