    ...
    public static abstract class Stub extends Binder implements IPassportService {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i != 1598968902) {
                ...
                Intent intent = null;
                PassportConfig passportConfig2 = null;
                switch (i) {
                    case 1:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (parcel.readInt() != 0) {
                            passportConfig = PassportConfig.CREATOR.createFromParcel(parcel);
                        }
                        init(passportConfig);
                    ...
                    case 2:
                        ...
                        if (parcel.readInt() != 0) {
                            passportConfig2 = PassportConfig.CREATOR.createFromParcel(parcel);
                        }
                        initWithCallback(asInterface, passportConfig2);
                        parcel2.writeNoException();
                        return true;
                    case 3:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 29:
                        ...
                        bindSNS(asInterface2, readString, readString2, z);
                        parcel2.writeNoException();
                        return true;
                    case 30:
                        parcel.enforceInterface(DESCRIPTOR);
