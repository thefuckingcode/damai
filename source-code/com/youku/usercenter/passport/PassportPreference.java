...
public final class PassportPreference {
    ...
    public long getCookieRefreshInterval() {
        return this.mPreference.getLong(COOKIE_REFRESH_INTERVAL, 864000000);
    }

    public long getCookieRefreshTime() {
        return this.mPreference.getLong(COOKIE_REFRESH_TIME, 0);
    }
    ...
    public LoginRecord getLoginRecord() {
        return (LoginRecord) JSON.parseObject(this.mPreference.getString(LAST_LOGIN_RECORD, ""), new TypeReference<LoginRecord>() {
            /* class com.youku.usercenter.passport.PassportPreference.AnonymousClass1 */
        }, new Feature[0]);
    }
    ...
    public long getServerSyncTime() {
        return this.mPreference.getLong(SERVER_SYNC_TIME, -1);
    }

    public long getServerTime() {
        return this.mPreference.getLong(SERVER_TIME, -1);
    }
