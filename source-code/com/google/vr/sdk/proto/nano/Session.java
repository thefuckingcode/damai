...
public class Session {
    ...
    public static final class Pose extends ExtendableMessageNano<Pose> implements Cloneable {
        ...
        public final int computeSerializedSize() {
            int computeSerializedSize = Session.super.computeSerializedSize();
            float[] fArr = this.q;
        ...
        public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Session.super.writeTo(codedOutputByteBufferNano);
        }
        ...
        public final Pose mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                if (readTag == 10) {
                    ...
                    fArr8[length4] = codedInputByteBufferNano.readFloat();
                    this.p = fArr8;
                } else if (!Session.super.storeUnknownField(codedInputByteBufferNano, readTag)) {
                    return this;
                }
            }
        }
        ...
        public final Pose clone() {
            try {
                Pose clone = Session.super.clone();
                float[] fArr = this.q;
                if (fArr != null && fArr.length > 0) {
                    clone.q = (float[]) fArr.clone();
                }
                float[] fArr2 = this.p;
                if (fArr2 != null && fArr2.length > 0) {
                    clone.p = (float[]) fArr2.clone();
                }
                return clone;
    ...
    public static final class RecenteredState extends ExtendableMessageNano<RecenteredState> implements Cloneable {
        ...
        public final RecenteredState clone() {
            try {
                RecenteredState clone = Session.super.clone();
                Pose pose = this.headRecenterPoseInTrackingSpace;
                if (pose != null) {
                    clone.headRecenterPoseInTrackingSpace = pose.clone();
                }
                return clone;
            } catch (CloneNotSupportedException e) {
                throw new AssertionError(e);
    ...
    public static final class TrackerState extends ExtendableMessageNano<TrackerState> implements Cloneable {
        ...
        public final TrackerState clone() {
            try {
                TrackerState clone = Session.super.clone();
                double[] dArr = this.q;
                if (dArr != null && dArr.length > 0) {
                    clone.q = (double[]) dArr.clone();
                }
                double[] dArr2 = this.gyroscopeBias;
                if (dArr2 != null && dArr2.length > 0) {
                    clone.gyroscopeBias = (double[]) dArr2.clone();
                }
                float[] fArr = this.lensOffset;
                if (fArr != null && fArr.length > 0) {
                    clone.lensOffset = (float[]) fArr.clone();
                }
                double[] dArr3 = this.lastGyroscopeSample;
                if (dArr3 != null && dArr3.length > 0) {
                    clone.lastGyroscopeSample = (double[]) dArr3.clone();
                }
                double[] dArr4 = this.magnetometerBias;
                if (dArr4 != null && dArr4.length > 0) {
                    clone.magnetometerBias = (double[]) dArr4.clone();
                }
                float[] fArr2 = this.rightLensOffset;
                if (fArr2 != null && fArr2.length > 0) {
                    clone.rightLensOffset = (float[]) fArr2.clone();
                }
                return clone;
            } catch (CloneNotSupportedException e) {
                throw new AssertionError(e);
