...
public class Preferences {
    ...
    public static final class DeveloperPrefs extends ExtendableMessageNano<DeveloperPrefs> implements Cloneable {
        ...
        public final int computeSerializedSize() {
            int computeSerializedSize = Preferences.super.computeSerializedSize();
            ...
            SafetyCylinderParams safetyCylinderParams2 = this.safetyCylinderParams;
            return safetyCylinderParams2 != null ? computeSerializedSize + CodedOutputByteBufferNano.computeMessageSize(10, safetyCylinderParams2) : computeSerializedSize;
        }
        ...
        public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (safetyCylinderParams2 != null) {
                codedOutputByteBufferNano.writeMessage(10, safetyCylinderParams2);
            }
            Preferences.super.writeTo(codedOutputByteBufferNano);
        }
            ...
            while (true) {
                ...
                switch (readTag) {
                    ...
                    case 82:
                        ...
                        break;
                    default:
                        if (Preferences.super.storeUnknownField(codedInputByteBufferNano, readTag)) {
                            break;
                        } else {
                            return this;
                        }
        ...
        public final DeveloperPrefs clone() {
            try {
                DeveloperPrefs clone = Preferences.super.clone();
                SafetyCylinderParams safetyCylinderParams2 = this.safetyCylinderParams;
                if (safetyCylinderParams2 != null) {
                    clone.safetyCylinderParams = safetyCylinderParams2.clone();
                }
                return clone;
    ...
    public static final class SafetyCylinderParams extends ExtendableMessageNano<SafetyCylinderParams> implements Cloneable {
        ...
        public final SafetyCylinderParams mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                } else if (!Preferences.super.storeUnknownField(codedInputByteBufferNano, readTag)) {
                    return this;
                }
            }
        }
        ...
        public final SafetyCylinderParams clone() {
            try {
                SafetyCylinderParams clone = Preferences.super.clone();
                float[] fArr = this.innerFogColor;
                if (fArr != null && fArr.length > 0) {
                    clone.innerFogColor = (float[]) fArr.clone();
                }
                float[] fArr2 = this.outerFogColor;
                if (fArr2 != null && fArr2.length > 0) {
                    clone.outerFogColor = (float[]) fArr2.clone();
                }
                return clone;
            } catch (CloneNotSupportedException e) {
                throw new AssertionError(e);
    ...
    public static final class UserPrefs extends ExtendableMessageNano<UserPrefs> implements Cloneable {
        ...
        public final int computeSerializedSize() {
            ...
            DeveloperPrefs developerPrefs2 = this.developerPrefs;
            return developerPrefs2 != null ? computeSerializedSize + CodedOutputByteBufferNano.computeMessageSize(2, developerPrefs2) : computeSerializedSize;
        }
        ...
        public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            DeveloperPrefs developerPrefs2 = this.developerPrefs;
            if (developerPrefs2 != null) {
                codedOutputByteBufferNano.writeMessage(2, developerPrefs2);
            }
            Preferences.super.writeTo(codedOutputByteBufferNano);
        }
        ...
        public final UserPrefs clone() {
            try {
                UserPrefs clone = Preferences.super.clone();
                DeveloperPrefs developerPrefs2 = this.developerPrefs;
                if (developerPrefs2 != null) {
                    clone.developerPrefs = developerPrefs2.clone();
                }
                return clone;
            } catch (CloneNotSupportedException e) {
                throw new AssertionError(e);
