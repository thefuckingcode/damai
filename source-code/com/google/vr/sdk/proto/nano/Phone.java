...
public class Phone {
    ...
    public static final class PhoneParams extends ExtendableMessageNano<PhoneParams> implements Cloneable {
        ...
        public final int computeSerializedSize() {
            int computeSerializedSize = Phone.super.computeSerializedSize();
        ...
        public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            Phone.super.writeTo(codedOutputByteBufferNano);
        }
        ...
        public final PhoneParams mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                } else if (!Phone.super.storeUnknownField(codedInputByteBufferNano, readTag)) {
                    return this;
                }
            }
        }
        ...
        public final PhoneParams clone() {
            try {
                PhoneParams clone = Phone.super.clone();
                float[] fArr = this.dEPRECATEDGyroBias;
                if (fArr != null && fArr.length > 0) {
                    clone.dEPRECATEDGyroBias = (float[]) fArr.clone();
                }
                return clone;
