...
public class CardboardDevice {
    ...
    public static final class CardboardInternalParams extends ExtendableMessageNano<CardboardInternalParams> implements Cloneable {
        ...
        public final int computeSerializedSize() {
            int computeSerializedSize = CardboardDevice.super.computeSerializedSize();
        ...
        public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            CardboardDevice.super.writeTo(codedOutputByteBufferNano);
        }
        ...
        public final CardboardInternalParams mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                if (readTag == 8) {
                    ...
                    this.bitField0_ |= 16;
                } else if (!CardboardDevice.super.storeUnknownField(codedInputByteBufferNano, readTag)) {
                    return this;
                }
            }
        }
        ...
        public final CardboardInternalParams clone() {
            try {
                CardboardInternalParams clone = CardboardDevice.super.clone();
                int[] iArr = this.eyeOrientations;
                if (iArr != null && iArr.length > 0) {
                    clone.eyeOrientations = (int[]) iArr.clone();
                }
                return clone;
    ...
    public static final class DaydreamInternalParams extends ExtendableMessageNano<DaydreamInternalParams> implements Cloneable {
        ...
        public final DaydreamInternalParams clone() {
            try {
                DaydreamInternalParams clone = CardboardDevice.super.clone();
                ScreenAlignmentMarker[] screenAlignmentMarkerArr = this.alignmentMarkers;
                if (screenAlignmentMarkerArr != null && screenAlignmentMarkerArr.length > 0) {
                    clone.alignmentMarkers = new ScreenAlignmentMarker[screenAlignmentMarkerArr.length];
                    int i = 0;
                    while (true) {
                        ...
                        if (screenAlignmentMarkerArr2[i] != null) {
                            clone.alignmentMarkers[i] = screenAlignmentMarkerArr2[i].clone();
                        }
                        i++;
                    }
                }
    ...
    public static final class DeviceParams extends ExtendableMessageNano<DeviceParams> implements Cloneable {
            ...
            while (true) {
                ...
                switch (readTag) {
                    ...
                    case 1575066:
                        ...
                        break;
                    default:
                        if (CardboardDevice.super.storeUnknownField(codedInputByteBufferNano, readTag)) {
                            break;
                        } else {
                            return this;
                        }
        ...
        public final DeviceParams clone() {
            try {
                DeviceParams clone = CardboardDevice.super.clone();
                float[] fArr = this.leftEyeFieldOfViewAngles;
                if (fArr != null && fArr.length > 0) {
                    clone.leftEyeFieldOfViewAngles = (float[]) fArr.clone();
                }
                float[] fArr2 = this.distortionCoefficients;
                if (fArr2 != null && fArr2.length > 0) {
                    clone.distortionCoefficients = (float[]) fArr2.clone();
                }
                float[] fArr3 = this.greenDistortionCoefficients;
                if (fArr3 != null && fArr3.length > 0) {
                    clone.greenDistortionCoefficients = (float[]) fArr3.clone();
                }
                float[] fArr4 = this.blueDistortionCoefficients;
                if (fArr4 != null && fArr4.length > 0) {
                    clone.blueDistortionCoefficients = (float[]) fArr4.clone();
                }
                CardboardInternalParams cardboardInternalParams = this.internal;
                if (cardboardInternalParams != null) {
                    clone.internal = cardboardInternalParams.clone();
                }
                DaydreamInternalParams daydreamInternalParams = this.daydreamInternal;
                if (daydreamInternalParams != null) {
                    clone.daydreamInternal = daydreamInternalParams.clone();
                }
                return clone;
            } catch (CloneNotSupportedException e) {
                throw new AssertionError(e);
    ...
    public static final class ScreenAlignmentMarker extends ExtendableMessageNano<ScreenAlignmentMarker> implements Cloneable {
        ...
        public final ScreenAlignmentMarker clone() {
            try {
                return CardboardDevice.super.clone();
            } catch (CloneNotSupportedException e) {
                throw new AssertionError(e);
            }
        }
