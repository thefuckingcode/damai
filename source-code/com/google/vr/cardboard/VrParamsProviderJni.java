...
public class VrParamsProviderJni {
    ...
    private static DisplayMetrics a(Context context) {
        ...
        return i90.c(((WindowManager) context.getSystemService(v.ATTACH_MODE_WINDOW)).getDefaultDisplay());
    }
    ...
    private static byte[] readDeviceParams(Context context) {
        VrParamsProvider a2 = ww2.a(context);
    ...
    private static void readPhoneParams(Context context, long j) {
        if (context == null) {
            ...
            b(j, Resources.getSystem().getDisplayMetrics(), i90.a(null));
            return;
        }
        DisplayMetrics a2 = a(context);
        VrParamsProvider a3 = ww2.a(context);
