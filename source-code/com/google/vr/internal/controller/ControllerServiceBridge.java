...
public class ControllerServiceBridge implements ServiceConnection {
    ...
    private final Runnable g = new Runnable() {
        /* class com.google.vr.internal.controller.ControllerServiceBridge.AnonymousClass1 */
    ...
    private final Runnable h = new Runnable() {
        /* class com.google.vr.internal.controller.ControllerServiceBridge.AnonymousClass2 */
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        try {
            ...
            if (initialize != 0) {
                String str = i;
                String valueOf = String.valueOf(jn.a(initialize));
