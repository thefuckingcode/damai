...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            RectF rectF = this.currentStartBounds;
            float f6 = evaluate.currentStartWidth;
            rectF.set(f4 - (f6 / 2.0f), f5, (f6 / 2.0f) + f4, evaluate.currentStartHeight + f5);
            RectF rectF2 = this.currentEndBounds;
            FitModeResult fitModeResult2 = this.fitModeResult;
            float f7 = fitModeResult2.currentEndWidth;
            rectF2.set(f4 - (f7 / 2.0f), f5, f4 + (f7 / 2.0f), fitModeResult2.currentEndHeight + f5);
        ...
        private TransitionDrawable(PathMotion pathMotion, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f2, @ColorInt int i, @ColorInt int i2, @ColorInt int i3, int i4, boolean z, boolean z2, FadeModeEvaluator fadeModeEvaluator2, FitModeEvaluator fitModeEvaluator2, ProgressThresholdsGroup progressThresholdsGroup, boolean z3) {
            ...
            this.displayWidth = (float) com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getwidthPixels(displayMetrics);
            this.displayHeight = (float) com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getheightPixels(displayMetrics);
            paint.setColor(i);
            paint2.setColor(i2);
            paint3.setColor(i3);
