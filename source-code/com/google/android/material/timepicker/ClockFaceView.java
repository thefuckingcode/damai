...
public class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    public void onMeasure(int i, int i2) {
        ...
        int max3 = (int) (((float) this.clockSize) / max3(((float) this.minimumHeight) / ((float) com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getheightPixels(displayMetrics)), ((float) this.minimumWidth) / ((float) com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getwidthPixels(displayMetrics)), 1.0f));
