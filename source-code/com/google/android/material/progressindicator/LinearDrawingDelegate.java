...
public final class LinearDrawingDelegate extends DrawingDelegate<LinearProgressIndicatorSpec> {
    ...
    public void adjustCanvas(@NonNull Canvas canvas, @FloatRange(from = 0.0d, to = 1.0d) float f) {
        ...
        this.trackLength = (float) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.width(clipBounds);
        float f2 = (float) ((LinearProgressIndicatorSpec) this.spec).trackThickness;
        canvas.translate(((float) clipBounds.left) + (((float) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.width(clipBounds)) / 2.0f), ((float) clipBounds.top) + (((float) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(clipBounds)) / 2.0f) + Math.max(0.0f, ((float) (com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(clipBounds) - ((LinearProgressIndicatorSpec) this.spec).trackThickness)) / 2.0f));
