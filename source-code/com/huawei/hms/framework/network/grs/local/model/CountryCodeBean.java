...
public class CountryCodeBean {
    ...
    private void getLocaleCountryCode() {
        String str;
        String str2;
        if (!SystemPropUtils.getProperty(gl1.TYPE_OPEN_URL_METHOD_GET, "ro.build.version.emui", ANDRIOD_SYSTEMPROP, "").isEmpty()) {
        ...
        } else if (Build.VERSION.SDK_INT >= 28 || Build.VERSION.getRELEASE().charAt(0) >= '9') {
            getRegionSettingCountryCode();
            str2 = TAG;
    ...
    private void getProductCountryCode() {
        int lastIndexOf;
        this.countryCode = SystemPropUtils.getProperty(gl1.TYPE_OPEN_URL_METHOD_GET, LOCALE_REGION_COUNTRYSYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
        String str = TAG;
        ...
        if (TextUtils.isEmpty(this.countryCode) || "UNKNOWN".equals(this.countryCode)) {
            String property = SystemPropUtils.getProperty(gl1.TYPE_OPEN_URL_METHOD_GET, LOCALE_COUNTRYSYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
    ...
    private void getVendorCountryCode() {
        ...
        this.countryCode = SystemPropUtils.getProperty(gl1.TYPE_OPEN_URL_METHOD_GET, VENDORCOUNTRY_SYSTEMPROP, ANDRIOD_SYSTEMPROP, "UNKNOWN");
        String str = TAG;
