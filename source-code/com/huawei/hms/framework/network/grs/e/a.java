...
public class a {
    ...
    private void a(GrsBaseInfo grsBaseInfo, b bVar, Context context, String str) {
        ...
        if (e.a(l, 300000)) {
            this.e.a(new c(grsBaseInfo, context), null, str, this.d);
        }
        bVar.a(1);
    }

    private void a(GrsBaseInfo grsBaseInfo, String str, Context context) {
        if (e.a(this.b.get(str), 300000)) {
            this.e.a(new c(grsBaseInfo, context), null, null, this.d);
        }
    }
    ...
    public void b(GrsBaseInfo grsBaseInfo, Context context) {
        ...
        this.a.put(grsParasKey, com.huawei.hms.framework.network.grs.a.a(a2));
