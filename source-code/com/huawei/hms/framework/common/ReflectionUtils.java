...
public class ReflectionUtils {
        ...
        if (obj != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                AccessController.doPrivileged(new PrivilegedAction() {
                    /* class com.huawei.hms.framework.common.ReflectionUtils.AnonymousClass2 */
    ...
    public static Object getFieldObj(Object obj, String str) {
        ...
        try {
            final Field declaredField = obj.getClass().getDeclaredField(str);
            AccessController.doPrivileged(new PrivilegedAction() {
                /* class com.huawei.hms.framework.common.ReflectionUtils.AnonymousClass1 */
    ...
    public static Object getStaticFieldObj(String str, String str2) {
        ...
        try {
            ...
            AccessController.doPrivileged(new PrivilegedAction() {
                /* class com.huawei.hms.framework.common.ReflectionUtils.AnonymousClass3 */
