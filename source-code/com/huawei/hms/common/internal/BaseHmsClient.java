...
public abstract class BaseHmsClient implements AidlApiClient {
                ...
                if (intent != null) {
                    ...
                    if (activeActivity != null) {
                        ...
                        FailedBinderCallBack.getInstance().setCallBack(Long.valueOf(time), new FailedBinderCallBack.BinderCallBack() {
                            /* class com.huawei.hms.common.internal.BaseHmsClient.AnonymousClass1.AnonymousClass1 */
                    ...
                    BaseHmsClient.this.notifyFailed((BaseHmsClient) new ConnectionResult(10, PendingIntent.getActivity(BaseHmsClient.this.mContext, 11, intent, ConfigReporter.BIT_GETTER_IMP)));
                    BaseHmsClient.this.mService = null;
                    return;
                }
    ...
    private void resolution(AvailableAdapter availableAdapter, int i) {
        ...
        if (activeActivity != null) {
            availableAdapter.startResolution(activeActivity, new AvailableAdapter.AvailableCallBack() {
                /* class com.huawei.hms.common.internal.BaseHmsClient.AnonymousClass3 */
    ...
    public String getServiceAction() {
        HMSPackageManager instance = HMSPackageManager.getInstance(this.mContext);
        if (this.mClientSettings.isUseInnerHms()) {
