...
public class HMSLog {
    ...
    public static String a(Context context) {
        ...
        if (packageManager != null) {
            try {
                ...
                return "HMS-" + packageInfo.versionName + jl1.BRACKET_START_STR + packageInfo.versionCode + jl1.BRACKET_END_STR;
    ...
    public static void e(String str, long j, String str2) {
        a aVar = a;
        aVar.a(6, str, jl1.ARRAY_START_STR + j + "] " + str2);
    }

    public static void e(String str, long j, String str2, Throwable th) {
        a aVar = a;
        aVar.b(6, str, jl1.ARRAY_START_STR + j + "] " + str2, th);
    }
}
