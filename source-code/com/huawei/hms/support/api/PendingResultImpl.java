...
public abstract class PendingResultImpl<R extends Result, T extends IMessageEntity> extends InnerPendingResult<R> {
    ...
    public class c implements DatagramTransport.a {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v1, resolved type: com.huawei.hms.support.api.PendingResultImpl$d */
    ...
    public static class d<R extends Result> extends Handler {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: com.huawei.hms.support.api.PendingResultImpl$d<R extends com.huawei.hms.support.api.client.Result> */
        /* JADX WARN: Multi-variable type inference failed */
    ...
    private void setResult(int i, IMessageEntity iMessageEntity) {
        ...
        if (r != null && (status = r.getStatus()) != null && commonStatus != null) {
            ...
            if (statusCode != statusCode2) {
                HMSLog.e(TAG, "rstStatus code (" + statusCode + ") is not equal commonStatus code (" + statusCode2 + jl1.BRACKET_END_STR);
                HMSLog.e(TAG, "rstStatus msg (" + statusMessage + ") is not equal commonStatus msg (" + statusMessage2 + jl1.BRACKET_END_STR);
            } else if (TextUtils.isEmpty(statusMessage) && !TextUtils.isEmpty(statusMessage2)) {
                HMSLog.i(TAG, "rstStatus msg (" + statusMessage + ") is not equal commonStatus msg (" + statusMessage2 + jl1.BRACKET_END_STR);
