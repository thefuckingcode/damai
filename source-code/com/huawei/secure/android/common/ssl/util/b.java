...
public class b {
    ...
    public static boolean a(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
        try {
            ...
            String str = a;
            g.b(str, "verify: publickey CertificateException " + e.getMessage());
            return false;
        } catch (InvalidKeyException e2) {
            String str2 = a;
            g.b(str2, "verify: publickey InvalidKeyException " + e2.getMessage());
            return false;
        } catch (NoSuchAlgorithmException e3) {
            String str3 = a;
            g.b(str3, "verify: publickey NoSuchAlgorithmException " + e3.getMessage());
            return false;
        } catch (NoSuchProviderException e4) {
            String str4 = a;
            g.b(str4, "verify: publickey NoSuchProviderException " + e4.getMessage());
            return false;
        } catch (SignatureException e5) {
            String str5 = a;
            g.b(str5, "verify: publickey SignatureException " + e5.getMessage());
            return false;
        } catch (Exception e6) {
            String str6 = a;
