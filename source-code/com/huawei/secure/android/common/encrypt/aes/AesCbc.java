    ...
    public static byte[] encrypt(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        if (bArr == null) {
            ...
            try {
                ...
                b.b("CBC", "NoSuchAlgorithmException: " + e2.getMessage());
                return new byte[0];
            } catch (NoSuchPaddingException e3) {
                b.b("CBC", "NoSuchPaddingException: " + e3.getMessage());
                return new byte[0];
            } catch (InvalidKeyException e4) {
                b.b("CBC", "InvalidKeyException: " + e4.getMessage());
                return new byte[0];
            } catch (InvalidAlgorithmParameterException e5) {
                b.b("CBC", "InvalidAlgorithmParameterException: " + e5.getMessage());
                return new byte[0];
            } catch (IllegalBlockSizeException e6) {
                b.b("CBC", "IllegalBlockSizeException: " + e6.getMessage());
                return new byte[0];
            } catch (BadPaddingException e7) {
                b.b("CBC", "BadPaddingException: " + e7.getMessage());
                return new byte[0];
            }
        }
    }
