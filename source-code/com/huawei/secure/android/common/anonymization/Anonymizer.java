...
public class Anonymizer {
    ...
    public static String maskBirthday(String str) {
        ...
        String[] a2 = a.a(str, 4);
        return a.a("", a.a(a2, 0), a.a(a.a(a2, 1), "0123456789", jl1.MUL));
    }
    ...
    public static String maskIpV6(String str) {
        ...
        String[] b = a.b(str, (char) jl1.CONDITION_IF_MIDDLE);
        if (b.length <= 1) {
            return a.a(str, '*');
        }
        if (b.length != 8) {
            String[] a2 = a.a(str, str.indexOf(58) + 1);
            return a.a("", a.a(a2, 0), a.a(a.a(a2, 1), "0123456789ABCDEFabcdef", jl1.MUL));
        }
    ...
    public static String maskMac(String str) {
        ...
        int a2 = a.a(str, '-', 2);
        if (a2 < 0) {
            return a.a(str, "0123456789ABCDEFabcdef", jl1.MUL);
        }
        String[] a3 = a.a(str, a2);
        return a.a("", a.a(a3, 0), a.a(a.a(a3, 1), "0123456789ABCDEFabcdef", jl1.MUL));
    }
