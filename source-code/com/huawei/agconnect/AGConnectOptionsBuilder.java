...
public final class AGConnectOptionsBuilder {
    ...
    public AGConnectOptionsBuilder setCustomAuthProvider(final CustomAuthProvider customAuthProvider) {
        if (customAuthProvider != null) {
            this.customServices.add(Service.builder(AuthProvider.class, new AuthProvider() {
                /* class com.huawei.agconnect.AGConnectOptionsBuilder.AnonymousClass2 */
    ...
    public AGConnectOptionsBuilder setCustomCredentialProvider(final CustomCredentialsProvider customCredentialsProvider) {
        if (customCredentialsProvider != null) {
            this.customServices.add(Service.builder(CredentialsProvider.class, new CredentialsProvider() {
                /* class com.huawei.agconnect.AGConnectOptionsBuilder.AnonymousClass1 */
