                            ...
                            switch (i) {
                                ...
                                default:
                                    switch (i) {
                                        ...
                                        case e.DXError_EngineInitException /*{ENCODED_INT: 30002}*/:
                                            throw new AMapException(AMapException.AMAP_ENGINE_CONNECT_TIMEOUT, 2, str);
                                        case e.DXError_EngineSizeException /*{ENCODED_INT: 30003}*/:
                                            throw new AMapException(AMapException.AMAP_ENGINE_RETURN_TIMEOUT, 2, str);
                                        default:
                                            switch (i) {
                                                case LogType.UNEXP_KNOWN_REASON /*{ENCODED_INT: 32000}*/:
