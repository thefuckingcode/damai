...
public final class t extends Handler {
    ...
    private static void e(Message message) {
        ...
        if (bVar != null && (onBusStationSearchListener = bVar.b) != null) {
            ...
            onBusStationSearchListener.onBusStationSearched(busStationResult, i2);
        }
    }
    ...
    private static void j(Message message) {
        ...
        if (aVar != null && (onBusLineSearchListener = aVar.b) != null) {
            ...
            onBusLineSearchListener.onBusLineSearched(busLineResult, i2);
        }
    }
        ...
        if (onShareSearchListener != null) {
            switch (message.what) {
                ...
                case 1103:
                    ...
                    return;
                case SecExceptionCode.SEC_ERROE_OPENSDK_UNSUPPORTED_VERSION:
