...
public class dy {
    ...
    public static class b extends dx {
        @Override // com.amap.api.mapcore.util.dx, com.amap.api.mapcore.util.n.f
    ...
    public static class a extends dw {
        ...
        @Override // com.amap.api.mapcore.util.dw, com.amap.api.mapcore.util.n.e
        public EGLConfig chooseConfig(EGL10 egl10, EGLDisplay eGLDisplay) {
            int[] iArr;
            int[] iArr2;
            c a2 = a(egl10, eGLDisplay);
            if (a2 == null || (iArr = a2.a) == null) {
                return null;
            }
            int[] iArr3 = a2.b;
