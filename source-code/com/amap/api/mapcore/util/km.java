...
public final class km {
    ...
    public final kj a(byte[] bArr) {
        ...
        try {
            ...
            kjVar.setLongitude(kc.a(((double) wrap.getInt()) / 1000000.0d));
            kjVar.setLatitude(kc.a(((double) wrap.getInt()) / 1000000.0d));
            kjVar.setAccuracy((float) wrap.getShort());
            ...
            if (wrap.get() == 1) {
                ...
                kjVar.e(sb2.toString());
                String adCode = kjVar.getAdCode();
                kjVar.setAddress((adCode == null || adCode.trim().length() <= 0) ? sb2.toString() : sb2.toString().replace(" ", ""));
            }
