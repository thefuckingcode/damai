...
public final class gw {
    ...
    public static String a() {
        ...
        try {
            KeyGenerator instance = KeyGenerator.getInstance(gn.c("EQUVT"));
            instance.init(128, secureRandom);
            return gr.a(instance.generateKey().getEncoded());
    ...
    public static byte[] a(byte[] bArr) {
        try {
            ...
            Cipher instance = Cipher.getInstance(gn.c("SQUVTL0NCQy9QS0NTNVBhZGRpbmc"));
