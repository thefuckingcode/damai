...
public class ah {
    ...
    public static AbstractCameraUpdateMessage b(float f, Point point) {
        ae aeVar = new ae();
        aeVar.nowType = AbstractCameraUpdateMessage.Type.newCameraPosition;
        aeVar.geoPoint = new DPoint((double) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Point.getx(point), (double) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Point.gety(point));
        aeVar.bearing = f;
        return aeVar;
    }
