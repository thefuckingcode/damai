...
public class y {
    ...
    public y(IAMapDelegate iAMapDelegate) {
        ...
        this.j = false;
        this.h = new ThreadPoolExecutor(1, Runtime.getRuntime().availableProcessors() * 2, (long) 1, TimeUnit.SECONDS, this.g, new ed("AMapPboRenderThread"), new ThreadPoolExecutor.AbortPolicy());
    }
    ...
    private void g() {
        if (this.x != null) {
            ...
            int i3 = this.m;
            int i4 = 0;
            Bitmap a2 = eq.a(0, i2 - i3, this.l, i3);
            CrossOverlay.GenerateCrossImageListener generateCrossImageListener = this.x;
            if (!this.i) {
                i4 = -1;
            }
    ...
    public void a(int i2, int i3) {
        ...
        if (executorService != null && !executorService.isShutdown()) {
            this.h.execute(new Runnable() {
                /* class com.amap.api.mapcore.util.y.AnonymousClass1 */
    ...
    public void a() {
        ...
        if (executorService != null && !executorService.isShutdown()) {
            this.h.execute(new Runnable() {
                /* class com.amap.api.mapcore.util.y.AnonymousClass2 */
