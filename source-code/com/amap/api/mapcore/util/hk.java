...
public class hk implements hf {
    ...
    public void a(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            sQLiteDatabase.execSQL(String.format("CREATE TABLE IF NOT EXISTS %s (_id integer primary key autoincrement,b1 varchar(40), b2 integer,b3  integer,a1  varchar(20));", c.a));
