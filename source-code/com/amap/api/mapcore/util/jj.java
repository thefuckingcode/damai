...
public final class jj {
    ...
    private jk.a d = new jk.a() {
        /* class com.amap.api.mapcore.util.jj.AnonymousClass1 */
        ...
        public void b(jk jkVar) {
            jj.this.a((jj) jkVar, (jk) false);
        }

        @Override // com.amap.api.mapcore.util.jk.a
        public void c(jk jkVar) {
            jj.this.a((jj) jkVar, (jk) true);
        }
    };
    ...
    public void a(jk jkVar) throws gb {
        ...
        try {
            if (b(jkVar) || (executorService = this.b) == null) {
                return;
            }
    ...
    private synchronized void a(jk jkVar, boolean z) {
        try {
