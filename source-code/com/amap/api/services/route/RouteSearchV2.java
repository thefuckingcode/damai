...
public class RouteSearchV2 {
            ...
            try {
                ...
                if (list != null) {
                    for (SpeedCost speedCost : list) {
                        ...
                        jSONObject2.put("value", (double) speedCost.getValue());
                ...
                if (this.b != null) {
                    ...
                    jSONObject3.put(oj2.TAG_ACCESS, (double) this.b.getAccess());
                    jSONObject3.put("value", (double) this.b.getValue());
                    jSONObject.put("curve_cost", jSONObject3);
                }
                if (this.c != null) {
                    JSONObject jSONObject4 = new JSONObject();
                    jSONObject4.put("up", (double) this.c.getUp());
                    jSONObject4.put("down", (double) this.c.getDown());
                    jSONObject.put("slope_cost", jSONObject4);
                }
                jSONObject.put("aux_cost", (double) this.d);
                if (this.e != null) {
                    JSONObject jSONObject5 = new JSONObject();
                    jSONObject5.put(oj2.TAG_ACCESS, (double) this.e.getAccess());
                    jSONObject5.put("decess", (double) this.e.getDecess());
                    jSONObject.put("trans_cost", jSONObject5);
                }
                jSONObject.put("ferry_cost", (double) this.f);
                if (this.g != null) {
                    JSONArray jSONArray2 = new JSONArray();
                    JSONObject jSONObject6 = new JSONObject();
                    jSONObject6.put("powerdemand", this.g.getPowerDemand());
                    jSONObject6.put("value", (double) this.g.getPowerDemandValue());
    ...
    public static class DriveRouteQuery implements Parcelable, Cloneable {
        public static final Parcelable.Creator<DriveRouteQuery> CREATOR = new Parcelable.Creator<DriveRouteQuery>() {
            /* class com.amap.api.services.route.RouteSearchV2.DriveRouteQuery.AnonymousClass1 */
        ...
        public boolean equals(Object obj) {
            ...
            if (list2 != null) {
                return list2.equals(driveRouteQuery.d) && this.g == driveRouteQuery.isUseFerry() && this.h == driveRouteQuery.h && this.j == driveRouteQuery.j;
            }
        ...
        public DriveRouteQuery clone() {
            try {
                ...
                i.a(e2, "RouteSearchV2", "DriveRouteQueryclone");
            }
    ...
    public static class FromAndTo implements Parcelable, Cloneable {
        public static final Parcelable.Creator<FromAndTo> CREATOR = new Parcelable.Creator<FromAndTo>() {
            /* class com.amap.api.services.route.RouteSearchV2.FromAndTo.AnonymousClass1 */
        ...
        public FromAndTo clone() {
            try {
                ...
                i.a(e2, "RouteSearchV2", "FromAndToclone");
            }
