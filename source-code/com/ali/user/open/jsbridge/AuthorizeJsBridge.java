    ...
    private void authorizeAction(final int i, final String str, final WVCallBackContext wVCallBackContext) {
        if (!KernelContext.sdkInitialized.booleanValue()) {
            ...
            AliMemberSDK.init(this.mContext.getApplicationContext(), new InitResultCallback() {
                /* class com.ali.user.open.jsbridge.AuthorizeJsBridge.AnonymousClass1 */

                @Override // com.ali.user.open.core.callback.FailureCallback
                public void onFailure(int i, String str) {
                    AuthorizeJsBridge.this.onFailCallback(wVCallBackContext, i, str);
                }
        ...
        if (wVCallBackContext != null) {
            if (!TextUtils.isEmpty(str)) {
                try {
                    ...
                    ((AuthorizeService) AliMemberSDK.getService(AuthorizeService.class)).authorizeWithScene(str2, (Map) null, new AuthorizeCallback() {
                        /* class com.ali.user.open.jsbridge.AuthorizeJsBridge.AnonymousClass2 */
