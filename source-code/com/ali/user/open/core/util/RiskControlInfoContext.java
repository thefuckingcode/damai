...
public class RiskControlInfoContext {
    public static String buildRiskControlInfo() {
        ...
        jSONObject.put(a90.BSSID, (Object) SystemUtils.getBSSID(applicationContext));
    ...
    public static void getRiskControlInfo(final MemberCallback<String> memberCallback) {
        ...
        if (memberCallback != null && (storageService = (StorageService) AliMemberSDK.getService(StorageService.class)) != null) {
            storageService.getWUAData(new MemberCallback<RichWUA>() {
                /* class com.ali.user.open.core.util.RiskControlInfoContext.AnonymousClass1 */

                @Override // com.ali.user.open.core.callback.FailureCallback
                public void onFailure(int i, String str) {
                    memberCallback.onSuccess(RiskControlInfoContext.getCommon().toJSONString());
                }
                ...
                public void onSuccess(RichWUA richWUA) {
                    ...
                    memberCallback.onSuccess(common.toJSONString());
                }
            });
        }
    }
