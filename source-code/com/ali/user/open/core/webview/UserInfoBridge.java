...
public class UserInfoBridge {
    ...
    public final void getNetworkType(BridgeCallbackContext bridgeCallbackContext, String str) {
        ...
        try {
            ...
            if (optBoolean) {
                try {
                    ...
                    if (connectionInfo != null) {
                        ...
                        jSONObject.put(a90.BSSID, connectionInfo.getBSSID());
                    }
            ...
            if (optBoolean2) {
                try {
                    ...
                    for (int i = 0; i < scanResults.size(); i++) {
                        ...
                        jSONObject3.put(a90.BSSID, scanResults.get(i).BSSID);
            ...
            try {
                networkInfo = ConnectivityManager.getActiveNetworkInfo((android.net.ConnectivityManager) applicationContext.getSystemService("connectivity"));
            } catch (Throwable th) {
