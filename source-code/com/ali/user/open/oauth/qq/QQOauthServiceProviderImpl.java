...
public class QQOauthServiceProviderImpl extends BaseOauthServiceProviderImpl {
    ...
    private class BaseUiListener implements IUiListener {
        ...
        public BaseUiListener(OauthCallback oauthCallback2) {
        ...
        public void onCancel() {
            ...
            if (oauthCallback2 != null) {
                oauthCallback2.onFail(Site.QQ, 504, "");
            }
        }
        ...
        public void onComplete(Object obj) {
            if (obj != null) {
                try {
                    ...
                    OauthCallback oauthCallback2 = this.oauthCallback;
                    if (oauthCallback2 != null) {
                        oauthCallback2.onFail(Site.QQ, 503, "");
                    }
                }
            }
        }
        ...
        public void onError(UiError uiError) {
            OauthCallback oauthCallback2 = this.oauthCallback;
            if (oauthCallback2 != null) {
                oauthCallback2.onFail(Site.QQ, 503, uiError.errorMessage);
            }
        }
    }
