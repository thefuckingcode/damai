...
public class WeiboOauthServiceProviderImpl extends BaseOauthServiceProviderImpl {
    ...
    private static class SelfWbAuthListener implements WbAuthListener {
        ...
        public SelfWbAuthListener(OauthCallback oauthCallback2) {
        ...
        public void onCancel() {
            ...
            if (oauthCallback2 != null) {
                oauthCallback2.onFail(Site.WEIBO, 604, "");
            }
        }
        ...
        public void onComplete(Oauth2AccessToken oauth2AccessToken) {
            if (!oauth2AccessToken.isSessionValid()) {
                OauthCallback oauthCallback2 = this.oauthCallback;
                if (oauthCallback2 != null) {
                    oauthCallback2.onFail(Site.WEIBO, 603, "");
                }
            } else if (this.oauthCallback != null) {
        ...
        public void onError(UiError uiError) {
            OauthCallback oauthCallback2 = this.oauthCallback;
            if (oauthCallback2 != null) {
                oauthCallback2.onFail(Site.WEIBO, 603, uiError != null ? uiError.errorMessage : "");
            }
        }
    }
