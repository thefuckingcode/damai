...
public class TaobaoOauthServiceProviderImpl extends BaseOauthServiceProviderImpl {
    ...
    private void authTask(Activity activity, final String str, AppCredential appCredential, Map<String, String> map, final OauthCallback oauthCallback) {
        ((TbAuthService) AliMemberSDK.getService(TbAuthService.class)).auth(map, new LoginCallback() {
            /* class com.ali.user.open.oauth.taobao.TaobaoOauthServiceProviderImpl.AnonymousClass1 */
    ...
    public void tokenLogin(String str, String str2, String str3, Map<String, String> map, final OauthCallback oauthCallback) {
        ((TbAuthService) AliMemberSDK.getService(TbAuthService.class)).tokenLogin(0, str, str2, str3, new LoginCallback() {
            /* class com.ali.user.open.oauth.taobao.TaobaoOauthServiceProviderImpl.AnonymousClass2 */

            @Override // com.ali.user.open.core.callback.FailureCallback
            public void onFailure(int i, String str) {
                oauthCallback.onFail("taobao", i, str);
            }
