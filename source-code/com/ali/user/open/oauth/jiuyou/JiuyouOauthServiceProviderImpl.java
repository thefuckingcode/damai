...
public class JiuyouOauthServiceProviderImpl extends BaseOauthServiceProviderImpl {
    ...
    @Override // com.ali.user.open.oauth.OauthServiceProvider
    public void oauth(Activity activity, String str, AppCredential appCredential, Map<String, String> map, OauthCallback oauthCallback2) {
        if (activity == null) {
            oauthCallback2.onFail("jiuyou", 801, "activity is null");
        } else if (appCredential == null) {
            oauthCallback2.onFail("jiuyou", 802, "appCredential is null");
        } else {
            this.oauthCallback = oauthCallback2;
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        OauthCallback oauthCallback2 = this.oauthCallback;
        if (oauthCallback2 != null) {
            oauthCallback2.onFail("jiuyou", -1, "");
            this.oauthCallback = null;
        }
    }
}
