...
public class UccWebViewActivity extends BaseWebViewActivity {
    ...
    private boolean overrideCallback(Uri uri) {
        ...
        if (TextUtils.isEmpty(string) || TextUtils.equals("quit", string)) {
            ...
            if (TextUtils.equals("login", string)) {
                ...
                generateMap.put("needSession", str);
                ...
                if (ApiConstants.ApiName.BIND_BY_REQUEST_TOKEN.equals(serialBundle.getString("api"))) {
                    ...
                    if (map != null && TextUtils.equals(map.get("scene"), ParamsConstants.UrlConstant.NEW_YOUKU_UPGRADE)) {
                        generateMap2.put("needSession", str);
                    }
                ...
                if (TextUtils.equals(this.mNeedSession, str)) {
                ...
                if (!TextUtils.isEmpty(string10) && TextUtils.equals(this.mNeedToast, str)) {
                ...
                generateMap3.put("needSession", str);
                ...
                if (!this.isReassignNeedSession || TextUtils.isEmpty(this.mNeedSession)) {
                    generateMap4.put("needSession", str);
                } else {
                ...
                if ("rpc".equals(string20)) {
                    ...
                    if ("true".equals(string18)) {
                        generateMap4.put(ParamsConstants.Key.PARAM_H5ONLY, str);
                    }
                    if (!TextUtils.isEmpty(string19)) {
                        String str2 = string19 + "&request_token=" + string15;
                        String string22 = serialBundle.getString("env");
                        if (!TextUtils.isEmpty(string22)) {
                            str2 = str2 + "&env=" + string22;
                        }
                        String string23 = serialBundle.getString("appEntrance");
                        if (!TextUtils.isEmpty(string23)) {
                            str2 = str2 + "&appEntrance=" + string23;
                        }
                        String string24 = serialBundle.getString("needTopToken");
                        if (!TextUtils.isEmpty(string24)) {
                            str2 = str2 + "&needTopToken=" + string24;
                        }
                        if (!TextUtils.isEmpty(serialBundle.getString("topTokenAppName"))) {
                            str2 = str2 + "&topTokenAppName=" + serialBundle.getString("topTokenAppName");
                        }
                        String string25 = serialBundle.getString("redirectUri");
                        if (!TextUtils.isEmpty(string25)) {
                            str2 = str2 + "&redirectUri=" + string25;
                        }
                        generateMap4.put(UccConstants.PARAM_BIND_URL, str2);
                    }
                ...
                map4.put("needSession", str);
                if (!UccOauthLoginPresenter.isCookieOnly(this.mParams)) {
                    str = "0";
                }
                map4.put(ParamsConstants.Key.PARAM_NEED_LOCAL_COOKIE_ONLY, str);
                map4.put(ParamsConstants.Key.PARAM_NEED_TOAST, "0");
                UccServiceImpl instance = UccServiceImpl.getInstance();
                UccParams uccParams4 = this.mUccParams;
                instance.bind(this, uccParams4.userToken, uccParams4.bindSite, map4, uccCallback8);
                return true;
            }
        }
    }
    ...
    /* access modifiers changed from: protected */
    @Override // androidx.activity.ComponentActivity, androidx.core.app.ComponentActivity, androidx.fragment.app.FragmentActivity, com.ali.user.open.core.webview.BaseWebViewActivity
    ...
    /* access modifiers changed from: protected */
    @Override // androidx.appcompat.app.AppCompatActivity, androidx.fragment.app.FragmentActivity, com.ali.user.open.core.webview.BaseWebViewActivity
    ...
    /* access modifiers changed from: protected */
    @Override // androidx.fragment.app.FragmentActivity, com.ali.user.open.core.webview.BaseWebViewActivity
