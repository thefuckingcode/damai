...
public class WebViewTransparentActivity extends UccWebViewActivity {
    ...
    public void initViews(Bundle bundle) {
        ...
        ((ImageView) findViewById(R.id.ali_ucc_close)).setOnClickListener(new View.OnClickListener() {
            /* class com.ali.user.open.ucc.webview.WebViewTransparentActivity.AnonymousClass1 */
