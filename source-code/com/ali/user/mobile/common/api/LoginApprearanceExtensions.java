...
public class LoginApprearanceExtensions extends WidgetExtension {
    ...
    public boolean needHelp() {
        BooleanOrangeResult needHelp2 = DataProviderFactory.getOrangeConfig().needHelp();
        return needHelp2.orangeExist ? needHelp2.value : this.needHelp;
    }

    public boolean needRegister() {
        BooleanOrangeResult needRegister2 = DataProviderFactory.getOrangeConfig().needRegister();
        return needRegister2.orangeExist ? needRegister2.value : this.needRegister;
    }
