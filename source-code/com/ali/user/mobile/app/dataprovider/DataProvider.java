...
public class DataProvider implements IDataProvider {
    ...
    public String getAppkey() {
        if (TextUtils.isEmpty(this.appKey)) {
            int envType2 = getEnvType();
            if (envType2 == 0 || envType2 == 1) {
    ...
    public int getMaxSessionSize() {
        IntOrangeResult maxSessionSize2 = DataProviderFactory.getOrangeConfig().getMaxSessionSize();
        return maxSessionSize2.orangeExist ? maxSessionSize2.value : this.maxSessionSize;
    }
    ...
    public boolean isNeedUpdateUTAccount() {
        BooleanOrangeResult isNeedUpdateUTAccount2 = DataProviderFactory.getOrangeConfig().isNeedUpdateUTAccount();
        return isNeedUpdateUTAccount2.orangeExist ? isNeedUpdateUTAccount2.value : this.isNeedUpdateUTAccount;
    }
    ...
    public boolean needEnterPriseRegister() {
        BooleanOrangeResult needEnterPriseRegister2 = DataProviderFactory.getOrangeConfig().needEnterPriseRegister();
        return needEnterPriseRegister2.orangeExist ? needEnterPriseRegister2.value : this.needEnterPriseRegister;
    }

    @Override // com.ali.user.mobile.app.dataprovider.IDataProvider
    public boolean registerSidToMtop() {
        BooleanOrangeResult registerSidToMtop2 = DataProviderFactory.getOrangeConfig().registerSidToMtop();
        return registerSidToMtop2.orangeExist ? registerSidToMtop2.value : this.registerSidToMtop;
    }
