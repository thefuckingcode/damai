...
public class AliUserRegisterSMSVerificationFragment extends BaseFragment implements View.OnClickListener, RegisterFormView {
    ...
    private void addShowVoice(final int i) {
        this.mSendSMSCodeBtn.setTickListener(new CountDownButton.CountListener() {
            /* class com.ali.user.mobile.register.ui.AliUserRegisterSMSVerificationFragment.AnonymousClass2 */

            @Override // com.ali.user.mobile.ui.widget.CountDownButton.CountListener
            public void onTick(long j) {
                if (((long) i) == j / 1000 && AliUserRegisterSMSVerificationFragment.this.mVoiceTV != null) {
    ...
    public void initViews(View view) {
        ...
        this.mSmsCodeView.setOnCompletedListener(new AliUserSmsCodeView.OnCompletedListener() {
            /* class com.ali.user.mobile.register.ui.AliUserRegisterSMSVerificationFragment.AnonymousClass1 */
    ...
    public boolean onBackPressed() {
        alert(getString(R.string.aliuser_exit_smscode_hint), "", getString(R.string.aliuser_wait_a_moment), new DialogInterface.OnClickListener() {
            /* class com.ali.user.mobile.register.ui.AliUserRegisterSMSVerificationFragment.AnonymousClass3 */
            ...
            /* class com.ali.user.mobile.register.ui.AliUserRegisterSMSVerificationFragment.AnonymousClass4 */
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (AliUserRegisterSMSVerificationFragment.this.getActivity() != null) {
                    ...
                    String str = "";
                    UserTrackAdapter.sendUT(AliUserRegisterSMSVerificationFragment.this.getPageName(), "single_register_cancel", str, AliUserRegisterSMSVerificationFragment.this.getRegType(), properties);
                    ...
                    if (mobileRegisterPresenter != null) {
                        str = mobileRegisterPresenter.getSessionId();
                    }
    ...
    public void onSendSMSSuccess(long j, SmsApplyResult smsApplyResult) {
        ...
        if (isActive() && (countDownButton = this.mSendSMSCodeBtn) != null) {
            countDownButton.startCountDown(j, 1000);
