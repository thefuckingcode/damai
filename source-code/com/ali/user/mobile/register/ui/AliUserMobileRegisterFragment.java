...
public class AliUserMobileRegisterFragment extends BaseFragment implements View.OnClickListener, RegisterFormView {
    ...
    public void onCheckLogin(final int i) {
        ...
        rrotocolFragment.setNagetive(new View.OnClickListener() {
            /* class com.ali.user.mobile.register.ui.AliUserMobileRegisterFragment.AnonymousClass1 */
        ...
        rrotocolFragment.setPositive(new View.OnClickListener() {
            /* class com.ali.user.mobile.register.ui.AliUserMobileRegisterFragment.AnonymousClass2 */
    ...
    public void onGetRegion(List list) {
        if (isActive()) {
            ...
            regionDialogFragment.setRegionListener(new RegionListener() {
                /* class com.ali.user.mobile.register.ui.AliUserMobileRegisterFragment.AnonymousClass7 */
        ...
        if (isActive()) {
            if (rpcResponse != null && rpcResponse.code == 458825) {
                ...
                alert(rpcResponse.message, "", getString(R.string.aliuser_re_enter), new DialogInterface.OnClickListener() {
                    /* class com.ali.user.mobile.register.ui.AliUserMobileRegisterFragment.AnonymousClass4 */
                    ...
                    /* class com.ali.user.mobile.register.ui.AliUserMobileRegisterFragment.AnonymousClass5 */
        ...
        if (!this.isVoice) {
            ...
            if (DataProviderFactory.getDataProvider().isEnableVoiceMsg() && !"CN".equals(getCountryCode())) {
                this.mSendSMSCodeBtn.setTickListener(new CountDownButton.CountListener() {
                    /* class com.ali.user.mobile.register.ui.AliUserMobileRegisterFragment.AnonymousClass3 */
                    ...
                    public void onTick(long j) {
                        ...
                        AliUserMobileRegisterFragment aliUserMobileRegisterFragment = AliUserMobileRegisterFragment.this;
                        if (!aliUserMobileRegisterFragment.isVoice && 29 == j / 1000 && !"CN".equals(aliUserMobileRegisterFragment.getCountryCode()) && TextUtils.isEmpty(trim)) {
    ...
    public void resizeMobileETPadding() {
        this.mRegionTV.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            /* class com.ali.user.mobile.register.ui.AliUserMobileRegisterFragment.AnonymousClass6 */
