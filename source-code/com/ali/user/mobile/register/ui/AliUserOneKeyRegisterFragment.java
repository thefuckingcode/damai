...
public class AliUserOneKeyRegisterFragment extends BaseFragment implements View.OnClickListener, RegisterFormView {
    ...
    @Override // com.ali.user.mobile.register.ui.RegisterFormView, com.ali.user.mobile.base.ui.BaseFragment
    ...
    public boolean onBackPressed() {
        alert(getString(R.string.aliuser_onekey_reg_retain_title), "", getString(R.string.aliuser_reg_continue), new DialogInterface.OnClickListener() {
            /* class com.ali.user.mobile.register.ui.AliUserOneKeyRegisterFragment.AnonymousClass2 */
            ...
            /* class com.ali.user.mobile.register.ui.AliUserOneKeyRegisterFragment.AnonymousClass3 */
    ...
    public void onCheckLogin(final int i) {
        ...
        rrotocolFragment.setNagetive(new View.OnClickListener() {
            /* class com.ali.user.mobile.register.ui.AliUserOneKeyRegisterFragment.AnonymousClass4 */
        ...
        rrotocolFragment.setPositive(new View.OnClickListener() {
            /* class com.ali.user.mobile.register.ui.AliUserOneKeyRegisterFragment.AnonymousClass5 */
    ...
    public void registerAction() {
        ...
        if (currentTimeMillis - this.lastClickRegisterBtnTime >= 1000) {
            ...
            if (ServiceFactory.getService(NumberAuthService.class) != null) {
                ...
                ((NumberAuthService) ServiceFactory.getService(NumberAuthService.class)).getLoginToken("openRegView", new NumAuthTokenCallback() {
                    /* class com.ali.user.mobile.register.ui.AliUserOneKeyRegisterFragment.AnonymousClass1 */
                    ...
                    public void onGetAuthTokenFail(int i, String str) {
                        ...
                        UserTrackAdapter.sendUT(AliUserOneKeyRegisterFragment.this.getPageName(), UTConstans.CustomEvent.UT_REG_GET_ACCESSCODE_FAIL, properties);
                    ...
                    public void onGetAuthTokenSuccess(String str) {
                        ...
                        UserTrackAdapter.sendUT(AliUserOneKeyRegisterFragment.this.getPageName(), UTConstans.CustomEvent.UT_REG_GET_ACCESSCODE_SUCCESS, properties);
                        ...
                        if (AliUserOneKeyRegisterFragment.this.isActivityAvaiable()) {
                            try {
                                ...
                                UserTrackAdapter.sendUT(AliUserOneKeyRegisterFragment.this.getPageName(), UTConstans.CustomEvent.UT_REG_RPC_COMMIT, "", AliUserOneKeyRegisterFragment.this.getRegType(), properties2);
                                UserTrackAdapter.sendUT(AliUserOneKeyRegisterFragment.this.getPageName(), "single_register_commit", "", AliUserOneKeyRegisterFragment.this.getRegType(), properties2);
