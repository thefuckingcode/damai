    ...
    public void login() {
        if (LoginSwitch.isInABTestRegion("api", 10000)) {
            ...
            if (baseLoginView != null && baseLoginView.isActive()) {
                LoginApi.nickSmsLogin(this.mLoginParam.clone(), buildTrackingModel(), this.mViewer, new LoginTasksCallback<LoginReturnData>() {
                    /* class com.ali.user.mobile.login.presenter.SMSNickLoginPresenter.AnonymousClass1 */
                    ...
                    public void onFail(LoginException<LoginReturnData> loginException) {
                        BaseLoginView baseLoginView = SMSNickLoginPresenter.this.mViewer;
                        if (baseLoginView != null && baseLoginView.isActive()) {
