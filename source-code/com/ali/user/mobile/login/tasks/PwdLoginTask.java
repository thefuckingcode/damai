...
public class PwdLoginTask extends BaseLoginTask {
    ...
    public void buildLoginParam(final CommonDataCallback commonDataCallback) {
        BackgroundExecutor.execute(new Runnable() {
            /* class com.ali.user.mobile.login.tasks.PwdLoginTask.AnonymousClass1 */
            ...
            public void run() {
                ...
                String str2 = trackingModel == null ? str : trackingModel.pageName;
                ...
                MainThreadExecutor.execute(new Runnable() {
                    /* class com.ali.user.mobile.login.tasks.PwdLoginTask.AnonymousClass1.AnonymousClass1 */
