...
public class LoginDataRepository {
    ...
    public void finger(final LoginParam loginParam, RpcRequestCallback rpcRequestCallback) {
        ...
        rpcRequest.addAfter(new IAfterFilter() {
            /* class com.ali.user.mobile.login.LoginDataRepository.AnonymousClass7 */
    ...
    public void loginByToken(final LoginParam loginParam, RpcRequestCallback rpcRequestCallback) {
        ...
        buildLoginByTokenRequest.addAfter(new IAfterFilter() {
            /* class com.ali.user.mobile.login.LoginDataRepository.AnonymousClass3 */
    ...
    public void simLogin(final LoginParam loginParam, Map<String, String> map, RpcRequestCallback rpcRequestCallback) {
        ...
        buildSimLoginRequestInner.addAfter(new IAfterFilter() {
            /* class com.ali.user.mobile.login.LoginDataRepository.AnonymousClass1 */
    ...
    public void simLoginWithUserInput(final LoginParam loginParam, RpcRequestCallback rpcRequestCallback) {
        ...
        buildSimLoginWithUserInputRequest.addAfter(new IAfterFilter() {
            /* class com.ali.user.mobile.login.LoginDataRepository.AnonymousClass4 */
    ...
    public void unifyLoginWithTaobaoGW(final LoginParam loginParam, RpcRequestCallback rpcRequestCallback) {
        ...
        buildPwdLoginRequest.addAfter(new IAfterFilter() {
            /* class com.ali.user.mobile.login.LoginDataRepository.AnonymousClass2 */
    ...
    public void unifySsoTokenLogin(final LoginParam loginParam, RpcRequestCallback<LoginReturnData> rpcRequestCallback) {
        ...
        buildUnifySsoTokenLoginRequest.addAfter(new IAfterFilter() {
            /* class com.ali.user.mobile.login.LoginDataRepository.AnonymousClass6 */
    ...
    public void simLogin(final LoginParam loginParam, RpcRequestCallback rpcRequestCallback) {
        ...
        buildSimLoginRequest.addAfter(new IAfterFilter() {
            /* class com.ali.user.mobile.login.LoginDataRepository.AnonymousClass5 */
