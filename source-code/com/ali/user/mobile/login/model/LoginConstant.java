...
public class LoginConstant {
    ...
    public static String FILE_NAME = "getAppLaunch_first";
    public static String FILE_NAME_HISTORY = "getAppLaunch_history";
    ...
    public static final String LAUCNH_USER_LOGIN_IS_CAR = "isCar";
