                    ...
                    for (String str3 : map.keySet()) {
                        ...
                        if (length > indexOf) {
                            ...
                            spannableString.setSpan(new ClickableSpan() {
                                /* class com.ali.user.mobile.utils.ProtocolHelper.AnonymousClass2 */
                        ...
                        if (protocolModel.protocolTitle.length() != length) {
                            spannableString.setSpan(new ClickableSpan() {
                                /* class com.ali.user.mobile.utils.ProtocolHelper.AnonymousClass3 */
    ...
    public static void setCheckBox(BaseFragment baseFragment, CheckBox checkBox, final String str, final String str2, boolean z, boolean z2) {
        if (checkBox != null) {
            ...
            checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                /* class com.ali.user.mobile.utils.ProtocolHelper.AnonymousClass1 */
