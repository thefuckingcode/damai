...
public class AppInfo {
    ...
    private void generateUmidToken(final DataCallback<String> dataCallback) {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
            /* class com.ali.user.mobile.info.AppInfo.AnonymousClass1 */

            public void run() {
                DataCallback dataCallback;
                if (atomicBoolean.compareAndSet(false, true) && (dataCallback = dataCallback) != null) {
                    dataCallback.result(AppInfo.this.mUmidToken);
                }
            }
        }, 2000);
            ...
            if (uMIDComp != null) {
                try {
                    uMIDComp.initUMID(i, new IUMIDInitListenerEx() {
                        /* class com.ali.user.mobile.info.AppInfo.AnonymousClass2 */
                        ...
                        public void onUMIDInitFinishedEx(String str, int i) {
                            ...
                            if (i == 200) {
                                ...
                                UserTrackAdapter.sendUT("initUMID_failure", i + "");
                            }
