...
public class WebViewActivity extends BaseActivity {
            ...
            if (!(webView.getContext() instanceof Activity) || !((Activity) webView.getContext()).isFinishing()) {
                try {
                    ...
                    builder.setTitle(KEY_FROM + host).setMessage(str2).setPositiveButton(KEY_CONFIRM, new DialogInterface.OnClickListener() {
                        /* class com.ali.user.mobile.webview.WebViewActivity.LoginWebChromeClient.AnonymousClass1 */
                    ...
                    builder.setOnCancelListener(new DialogInterface.OnCancelListener() {
                        /* class com.ali.user.mobile.webview.WebViewActivity.LoginWebChromeClient.AnonymousClass2 */
    ...
    public void goConsumeIV(final VerifyParam verifyParam) {
        new CoordinatorWrapper().execute(new AsyncTask<Object, Void, VerifyTokenConsumedResponse>() {
            /* class com.ali.user.mobile.webview.WebViewActivity.AnonymousClass2 */
    ...
    public boolean onPanelKeyDown() {
        ...
        loginWebView.evaluateJavascript("(function() {if(typeof(_windvane_backControl)!=='undefined') return _windvane_backControl(); else return 'false';})()", new ValueCallback<String>() {
            /* class com.ali.user.mobile.webview.WebViewActivity.AnonymousClass1 */
    ...
    @Override // androidx.fragment.app.FragmentActivity, com.ali.user.mobile.base.ui.BaseActivity
    ...
    public boolean overrideUrlLoading(WebView webView, String str) {
        ...
        if (startsWith) {
            UserTrackAdapter.sendUT(str4, "SMS");
            try {
            ...
            if ("open_password_logincheck".equals(string6)) {
                        ...
                        if (!TextUtils.isEmpty(this.mOriginalLoginParam)) {
                            ...
                            if (loginParam != null) {
                                ...
                                if (!TextUtils.isEmpty(loginParam.loginSourcePage)) {
                                    str4 = loginParam.loginSourcePage;
                                }
                                UserTrackAdapter.sendUT(str4, UTConstant.CustomEvent.UT_LOGIN_TO_H5_QUIT, properties);
                            }
                        } else {
                            UserTrackAdapter.sendUT(str4, UTConstant.CustomEvent.UT_LOGIN_TO_H5_QUIT);
                        }
                ...
                UserTrackAdapter.sendUT(str4, "LoginH5_Relogin");
                ...
                UserTrackAdapter.sendUT(str4, "LoginH5_MobileConfirmLogin");
                if (TextUtils.isEmpty(string3) || string3.equals("null")) {
                    str3 = this.mLoginId;
                } else {
                    str3 = string3;
                }
                goLogin(str3, string4, this.mLoginType, true, "1014", null, false, true, false, this.mTokenType);
                return true;
                ...
                if (!this.skipLogin || !TextUtils.equals(this.mScene, "changePassword")) {
                    ...
                    goLogin(str2, string4, this.mLoginType, true, str5, null, false, true, false, this.mTokenType);
                    return true;
                }
                ...
                UserTrackAdapter.sendUT(str4, "LoginH5_passIVToken");
