...
public final class Base64 {
    ...
    public static byte[] decode(String str) {
        ...
        if (isData(c7) && isData(c8)) {
            ...
            bArr4[i4 + 1] = (byte) (((b9 >> 2) & 15) | ((b6 & 15) << 4));
            return bArr4;
        } else if ((b6 & 15) != 0) {
            return null;
        } else {
    ...
    public static String encode(byte[] bArr) {
        ...
        while (i3 < i2) {
            ...
            byte b4 = (byte) (b2 & 15);
            byte b5 = (byte) (b & 3);
            int i9 = b & as2.MAX_POWER_OF_TWO;
            int i10 = b >> 2;
            if (i9 != 0) {
                i10 ^= 192;
            }
            byte b6 = (byte) i10;
            int i11 = b2 & as2.MAX_POWER_OF_TWO;
            int i12 = b2 >> 4;
            if (i11 != 0) {
                i12 ^= GlMapUtil.DEVICE_DISPLAY_DPI_MEDIAN;
            }
            byte b7 = (byte) i12;
            int i13 = (b3 & as2.MAX_POWER_OF_TWO) == 0 ? b3 >> 6 : (b3 >> 6) ^ 252;
            int i14 = i5 + 1;
        ...
        if (i == 8) {
            byte b8 = bArr[i4];
            byte b9 = (byte) (b8 & 3);
            int i17 = b8 & as2.MAX_POWER_OF_TWO;
            int i18 = b8 >> 2;
            if (i17 != 0) {
                i18 ^= 192;
            }
            ...
            byte b13 = (byte) (b10 & 3);
            int i21 = b10 & as2.MAX_POWER_OF_TWO;
            int i22 = b10 >> 2;
            if (i21 != 0) {
                i22 ^= 192;
            }
            byte b14 = (byte) i22;
            int i23 = b11 & as2.MAX_POWER_OF_TWO;
            int i24 = b11 >> 4;
            if (i23 != 0) {
