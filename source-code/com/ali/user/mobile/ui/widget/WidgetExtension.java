...
public class WidgetExtension {
    ...
    protected Class<?> fingerFragment;
    ...
    private Class<?> fullyCustomizeTwoStepMobileLoginFragment;
    ...
    public Class<?> getFullyCustomizeTwoStepMobileLoginFragment() {
        return this.fullyCustomizeTwoStepMobileLoginFragment;
    }
    ...
    public void setFingerFragment(Class<?> cls) {
        this.fingerFragment = cls;
    }
    ...
    public void setFullyCustomizeTwoStepMobileLoginFragment(Class<?> cls) {
        this.fullyCustomizeTwoStepMobileLoginFragment = cls;
    }
