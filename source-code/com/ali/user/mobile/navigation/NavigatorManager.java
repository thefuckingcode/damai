...
public class NavigatorManager {
    ...
    public void navToLoginPage(final Context context, Bundle bundle, final String str, boolean z) {
        if (context != null) {
            ...
            if (AliUserLogin.getInstance().getPreOpenLoginPageFiler() != null) {
                AliUserLogin.getInstance().getPreOpenLoginPageFiler().handleIntent(context, callingIntent, new DataCallback<Intent>() {
                    /* class com.ali.user.mobile.navigation.NavigatorManager.AnonymousClass1 */
    ...
    public void waitLoginPhone(final Context context, final Intent intent, final boolean z) {
        ...
        ((NumberAuthService) ServiceFactory.getService(NumberAuthService.class)).getLoginMaskPhone(2000, new CommonDataCallback() {
            /* class com.ali.user.mobile.navigation.NavigatorManager.AnonymousClass2 */
    ...
    public void waitRegisterPhone(final Context context, final Intent intent, final Properties properties) {
        ...
        ((NumberAuthService) ServiceFactory.getService(NumberAuthService.class)).getLoginMaskPhone(i, "openRegView", new CommonDataCallback() {
            /* class com.ali.user.mobile.navigation.NavigatorManager.AnonymousClass3 */
            ...
            public void onFail(int i, String str) {
                ...
                UserTrackAdapter.sendUT(UTConstant.PageName.UT_PAGE_EXTEND, "get_register_number_fail", properties);
                UserTrackAdapter.sendUT(UTConstant.PageName.UT_PAGE_EXTEND, "get_register_number_failure", i + "", String.valueOf(i), properties);
                context.startActivity(intent);
            }
