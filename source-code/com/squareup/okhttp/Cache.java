...
public final class Cache {
    ...
    public final class CacheRequestImpl implements CacheRequest {
        ...
        public CacheRequestImpl(final DiskLruCache.Editor editor2) throws IOException {
            ...
            this.body = new c(newSink, Cache.this) {
    ...
    public static class CacheResponseBody extends ResponseBody {
        ...
        public CacheResponseBody(final DiskLruCache.Snapshot snapshot2, String str, String str2) {
            ...
            this.bodySource = h.d(new d(snapshot2.getSource(1)) {
    ...
    public static final class Entry {
        ...
        public void writeTo(DiskLruCache.Editor editor) throws IOException {
            ...
            c.writeByte(10);
            c.writeDecimalLong((long) this.varyHeaders.size());
            c.writeByte(10);
            ...
            c.writeByte(10);
            c.writeDecimalLong((long) this.responseHeaders.size());
            c.writeByte(10);
