...
public final class DiskLruCache implements Closeable {
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        return h.c(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) {
    ...
    private synchronized void rebuildJournal() throws IOException {
        ...
        try {
            ...
            c.writeDecimalLong((long) this.appVersion).writeByte(10);
            c.writeDecimalLong((long) this.valueCount).writeByte(10);
            c.writeByte(10);
