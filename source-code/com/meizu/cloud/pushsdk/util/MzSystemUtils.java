...
public class MzSystemUtils {
    ...
    public static String getMzPushServicePackageName(Context context) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(servicesByPackageName) && servicesByPackageName.contains(PUSH_SERVICE_PROCESS_NAME)) {
                return str;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static boolean isBrandMeizu(Context context) {
        boolean z;
        if (TextUtils.isEmpty(i.a("ro.meizu.product.model")) && TextUtils.isEmpty(i.a("ro.vendor.meizu.product.model"))) {
            String brand = com.alibaba.wireless.security.aopsdk.replace.android.os.Build.getBRAND();
            if (!"meizu".equalsIgnoreCase(brand) && !"魅蓝".equalsIgnoreCase(brand) && !"22c4185e".equalsIgnoreCase(brand)) {
                z = false;
                if (!z) {
    ...
    public static boolean isMeizuAndFlyme() {
        d<Boolean> b = com.meizu.cloud.pushsdk.b.a.b();
        if (b.a) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:8:0x001c A[Catch:{ Exception -> 0x0042 }] */
