...
public class PlatformMessageSender {
    ...
    public static void a(Context context, String str, final PushSwitchStatus pushSwitchStatus) {
        a(context, str, new a() {
            /* class com.meizu.cloud.pushsdk.platform.PlatformMessageSender.AnonymousClass1 */
    ...
    public static void a(Context context, String str, final RegisterStatus registerStatus) {
        a(context, str, new a() {
            /* class com.meizu.cloud.pushsdk.platform.PlatformMessageSender.AnonymousClass2 */
    ...
    public static void a(Context context, String str, final SubAliasStatus subAliasStatus) {
        a(context, str, new a() {
            /* class com.meizu.cloud.pushsdk.platform.PlatformMessageSender.AnonymousClass5 */
    ...
    public static void a(Context context, String str, final SubTagsStatus subTagsStatus) {
        a(context, str, new a() {
            /* class com.meizu.cloud.pushsdk.platform.PlatformMessageSender.AnonymousClass4 */
    ...
    public static void a(Context context, String str, final UnRegisterStatus unRegisterStatus) {
        a(context, str, new a() {
            /* class com.meizu.cloud.pushsdk.platform.PlatformMessageSender.AnonymousClass3 */
