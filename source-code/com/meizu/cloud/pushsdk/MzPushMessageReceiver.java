...
public abstract class MzPushMessageReceiver extends BroadcastReceiver {
    ...
    private a getAbstractAppLogicListener() {
        return new a() {
            /* class com.meizu.cloud.pushsdk.MzPushMessageReceiver.AnonymousClass2 */
    ...
    public void onReceive(Context context, final Intent intent) {
        ...
        b.a().execute(new Runnable() {
            /* class com.meizu.cloud.pushsdk.MzPushMessageReceiver.AnonymousClass1 */
