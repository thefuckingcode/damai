...
public class a {
    ...
    private static com.meizu.cloud.pushsdk.d.e.a a(com.meizu.cloud.pushsdk.d.b.a aVar, c cVar, Context context) {
        return new com.meizu.cloud.pushsdk.d.e.a.a(new a.C0190a(aVar, "PushAndroidTracker", context.getPackageCodePath(), context, com.meizu.cloud.pushsdk.d.e.a.a.class).a(b.VERBOSE).a(Boolean.FALSE).a(cVar).a(4));
    }
    ...
    private static void a(Context context, final com.meizu.cloud.pushsdk.d.e.a aVar) {
        if (b == null) {
            b = new BroadcastReceiver() {
                /* class com.meizu.cloud.pushsdk.d.a.AnonymousClass1 */
    ...
    private static com.meizu.cloud.pushsdk.d.b.a b(Context context, com.meizu.cloud.pushsdk.c.c.a aVar, f fVar) {
        a.C0187a a2 = new a.C0187a(a(), context, com.meizu.cloud.pushsdk.d.b.a.a.class).a(fVar).a(aVar).a(1);
