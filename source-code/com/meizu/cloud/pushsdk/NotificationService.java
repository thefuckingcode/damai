...
public class NotificationService extends IntentService {
    ...
    public void a(Intent intent) {
        ...
        try {
            ...
            com.meizu.cloud.pushsdk.b.b.d a2 = a.a(a).a((Class<?>[]) null).a(null);
            if (a2.a && a2.b != null) {
                DebugLogger.i("NotificationService", "Reflect MzPushReceiver true");
                a.a((Object) a2.b).a("onReceive", Context.class, Intent.class).a(a2.b, getApplicationContext(), intent);
            }
        } catch (Exception e) {
                    ...
                    if (!PushConstants.MZ_PUSH_ON_UNREGISTER_ACTION.equals(intent.getAction())) {
                        ...
                        if (!TextUtils.isEmpty(stringExtra) && "reflect_receiver".equals(stringExtra) && z) {
                            ...
                            if (!TextUtils.isEmpty(stringExtra2)) {
                                com.meizu.cloud.pushsdk.d.a.a(this, new b(stringExtra2, null, null).b().c());
                            }
                            a(intent);
                            return;
                        }
