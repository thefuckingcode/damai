...
public class AdglMapAnimPivotZoom extends AbstractAdglAnimation {
    ...
    public void doAnimation(Object obj) {
        ...
        if (gLMapState != null) {
            ...
            if (!this.isOver) {
                ...
                float f = ((float) uptimeMillis) / ((float) this.duration);
                if (f > 1.0f) {
                    this.isOver = true;
                    f = 1.0f;
                }
                if (f >= 0.0f && f <= 1.0f) {
                    ...
                    if (!this.zoomCenter) {
                        ...
                        gLMapState.setMapGeoCenter((double) (i2 + i3), (double) (i5 + ((int) (((float) (i4 - i5)) * f2))));
                    }
    ...
    public void setToMapZoomAndPivot(float f, int i, android.graphics.Point point) {
        ...
        this.mapLevelTo = f;
        if (point != null) {
            this.winPivotX = (float) Point.getx(point);
            this.winPivotY = (float) Point.gety(point);
