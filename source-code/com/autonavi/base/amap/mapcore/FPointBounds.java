...
public class FPointBounds {
    ...
    private boolean intersect(FPointBounds fPointBounds) {
        ...
        double d = (double) (((f2 - f3) + f) - f3);
        float f4 = ((PointF) fPoint).y;
        float f5 = ((PointF) fPoint2).y;
        float f6 = ((PointF) fPoint3).y;
        float f7 = ((PointF) fPoint4).y;
        double d2 = (double) (((f4 + f5) - f6) - f7);
        double d3 = (double) (((f6 - f7) + f4) - f5);
        if (Math.abs((double) (((((PointF) fPoint2).x + f) - f2) - f3)) >= d || Math.abs(d2) >= d3) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "southwest = (" + ((PointF) this.southwest).x + "," + ((PointF) this.southwest).y + ") northeast = (" + ((PointF) this.northeast).x + "," + ((PointF) this.northeast).y + jl1.BRACKET_END_STR;
    }
