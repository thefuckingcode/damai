...
public final class a {
    ...
    public static void a(Context context) {
        if (i.a().b(UCCore.OPTION_USE_UC_PLAYER) && !b && SDKFactory.b() && 2 != SDKFactory.e()) {
            File b2 = b(context);
    ...
    private static File a(File file, File file2) {
        ...
        if (file.exists() && file.isDirectory()) {
            File file4 = new File(file, "libu3player.so");
            if (file4.exists() && UpdateFlagMarker.isFinished(file, "libu3player.so")) {
                if (file2 == null) {
                    file3 = null;
                } else {
                    file3 = new File(file2, "libu3player.so");
                }
