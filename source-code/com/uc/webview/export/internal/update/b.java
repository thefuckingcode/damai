...
public final class b {
    ...
    public static final File a(Context context) throws UCSetupException {
        String str = (String) i.a().a(UCCore.OPTION_UC_PLAYER_ROOT);
        if (!p.a(str)) {
            return new File(str);
        }
        return p.a(context, "ucplayer");
    }
        ...
        if (b == null) {
            try {
                ...
                try {
                    ...
                    b = UpdateServiceImpl.class.getDeclaredMethod("create", new Class[0]);
                }
    ...
    static /* synthetic */ void b(Context context, String str, Callable callable, Map map, Map map2) throws UCSetupException {
    ...
    static /* synthetic */ void a(Map map, String str, Object obj) {
    ...
    static /* synthetic */ void b(Context context, String str, Callable callable, Map map) throws UCSetupException {
        ...
        if (a2 != null) {
            g gVar = new g();
            File a3 = a(context);
            a2.setup(UpdateService.OPTION_CONTEXT, context.getApplicationContext()).setup("url", str).setup(UpdateService.OPTION_ROOT_DIR, a3).setup(UpdateService.OPTION_CHECK_FILE, "libu3player.so").setup(UpdateService.OPTION_CHECK_LAST_MODIFIED, Boolean.valueOf(i.a().b(UCCore.OPTION_EXACT_LAST_MODIFIED_CHECK))).setup(UpdateService.OPTION_CONNECT_TIME_OUT, Integer.valueOf(p.c())).setup(UpdateService.OPTION_READ_TIME_OUT, Integer.valueOf(p.d())).setCallback(new h(context, callable, map, a3, gVar)).start();
            return;
        }
