...
public class af {
    ...
    public static void a(ConcurrentHashMap<String, Object> concurrentHashMap) {
        ...
        b = !p.b((Boolean) d.get(UCCore.OPTION_USE_SDK_SETUP));
        e = j.a(p.a(concurrentHashMap, UCCore.OPTION_HARDWARE_ACCELERATED));
    ...
    public static d.a c(Throwable th) {
        ...
        if (k == null && l == null) {
            ...
            if (k != null) {
                ...
                sb.append(UCCyclone.getFileInfo(new File(k)));
                sb.append("\n\n");
            }
            if (l != null) {
                sb.append("outDir=");
                ...
                if (!l.contains("ucmsdk")) {
                    UCCyclone.listAllFiles(sb, new File(l));
                }
            }
            str = sb.toString();
        }
        d.a b3 = b2.b("zip info", str).b("quick path", m.a(a));
    ...
    public static void a(a aVar, Object... objArr) {
        Log.i("SetupController", "initStatus: [" + aVar + jl1.ARRAY_END_STR);
        aVar.toString();
        h = aVar;
        ...
        if (i2 == 1) {
            ...
            b.a(196, th != null ? th.toString() : "");
            a(3);
            if ((i.a().c(UCCore.OPTION_INIT_FAILED_LOG_POLICY) & 1) != 0) {
                b(th);
            }
        } else if (i2 == 8) {
            Throwable th2 = (Throwable) objArr[0];
            b.a(197, th2 != null ? th2.toString() : "");
            a(4);
            if ((i.a().c(UCCore.OPTION_INIT_FAILED_LOG_POLICY) & 1) != 0) {
                b(th2);
            }
