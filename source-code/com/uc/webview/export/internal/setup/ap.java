...
public class ap extends bh {
    ...
    @Override // com.uc.webview.export.internal.setup.UCAsyncTask, com.uc.webview.export.internal.setup.bh
    public void run() {
        long j;
        Log.d(c, "==run.");
        long j2 = e;
        ...
        try {
            if (!p.a(UCCore.getParam(CDParamKeys.CD_KEY_SHARE_CORE_CLIENT_BAK_KRL_DIR))) {
                j = f;
                String str = c;
                ...
                super.run();
            } else if (!p.a(UCCore.getParam(CDParamKeys.CD_KEY_SHARE_CORE_CLIENT_BAK_ZIP_FPATH))) {
                j = g;
                String str2 = c;
