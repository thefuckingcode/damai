...
public abstract class UCSetupTask<RETURN_TYPE extends UCSetupTask<RETURN_TYPE, CALLBACK_TYPE>, CALLBACK_TYPE extends UCSetupTask<RETURN_TYPE, CALLBACK_TYPE>> extends BaseSetupTask<RETURN_TYPE, CALLBACK_TYPE> {
    ...
    public void setupGlobalOnce() {
        if (!i.getAndSet(true)) {
            ...
            sb.setLength(0);
            if (i.a().c(UCCore.OPTION_INIT_FAILED_LOG_POLICY) == 0) {
    ...
    public synchronized RETURN_TYPE start() {
        if (getParent() == null) {
            ...
            if (!p.a((String) this.mOptions.get(UCCore.OPTION_UCM_UPD_URL))) {
                bool = Boolean.TRUE;
            }
            if (bool != null) {
            ...
            setParent(root);
            b.a(330);
            RETURN_TYPE return_type = (RETURN_TYPE) ((UCSetupTask) super.start());
            root.start();
            return return_type;
        }
        return (RETURN_TYPE) ((UCSetupTask) super.start());
    }
}
