...
public final class j {
        ...
        public final void requestLocationUpdates(String str, long j, float f, LocationListener locationListener) {
            ...
            if (locationManager != null) {
                try {
                    ...
                    com.alibaba.wireless.security.aopsdk.replace.android.location.LocationManager.requestLocationUpdates(this.a, 0, 0.0f, criteria, locationListener, Looper.getMainLooper());
                }
            }
        }
    ...
    private static int e() {
        Integer num = (Integer) i.a().a(UCCore.OPTION_VIDEO_HARDWARE_ACCELERATED);
        if (num != null) {
            return num.intValue();
        }
        return -1;
