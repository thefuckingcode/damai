...
public class UCMRunningInfo {
    ...
    public UCMRunningInfo(Context context, bt btVar, ClassLoader classLoader2, ClassLoader classLoader3, boolean z, boolean z2, UCMobileWebKit uCMobileWebKit, int i, boolean z3, int i2) {
