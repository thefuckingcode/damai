    ...
    public static void a(a aVar) {
        ...
        try {
            ...
            if (a2 != null && (c2 = c()) != null) {
                ...
                stringBuffer.append("--- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---\nException message:\nBack traces starts.\n");
                stringBuffer.append(Log.getStackTraceString(aVar.c));
                ...
                Log.d("CrashSdkUtils", "generateCustomeLogInfo size:" + stringBuffer.length());
            }
        } catch (Throwable th) {
            Log.rInfo("CrashSdkUtils", "generateCustomeLogInfo failed", th);
        }
    }
