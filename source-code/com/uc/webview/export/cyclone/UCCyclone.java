...
public class UCCyclone {
    ...
    /* JADX WARNING: Can't wrap try/catch for region: R(8:0|1|2|(1:4)(1:5)|6|7|8|(1:20)(4:12|(2:14|15)|17|21)) */
    ...
    public static void deleteUnusedFiles(Context context) {
        ...
        File[] listFiles = context.getCacheDir().listFiles(new FilenameFilter() {
            /* class com.uc.webview.export.cyclone.UCCyclone.AnonymousClass1 */
            ...
            while (true) {
                try {
                    ...
                    if (read != -1) {
                        ...
                        return String.format(Locale.CHINA, str2, new BigInteger(1, instance.digest()));
                    }
                } catch (Throwable th2) {
                    th = th2;
                    try {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:25:0x009f A[Catch:{ all -> 0x0147 }] */
