...
public class Log {
    ...
    public static final class CallbackChannel {
        ...
        private volatile ConcurrentLinkedQueue<Message> mMessages;
        ...
        private Runnable getAsyncTask() {
            return new Runnable() {
                /* class com.uc.webview.export.cyclone.Log.CallbackChannel.AnonymousClass1 */
    ...
    private static byte[] decryptLogConfigfile(byte[] bArr) throws Exception {
        ...
        instance.init(2, KeyFactory.getInstance("RSA").generatePublic(x509EncodedKeySpec));
    ...
    public static final class Logcat {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:5:?, code lost:
            com.uc.webview.export.cyclone.Log.Logcat.mMtds[r3] = r4.getMethod(r0, r5);
         */
