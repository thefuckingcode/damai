...
public class hy implements iu<hy, Object>, Serializable, Cloneable {
    ...
    public int compareTo(hy hyVar) {
        ...
        int compareTo = Boolean.valueOf(m594a()).compareTo(Boolean.valueOf(hyVar.m594a()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (m594a() && (a7 = iv.a(this.f545a, hyVar.f545a)) != 0) {
            return a7;
        }
                ...
                if (s != 2) {
                    if (s != 3) {
                        if (s != 4) {
                            if (s != 5) {
                                if (s == 7 && b2 == 11) {
                                    this.f551d = jfVar.m716a();
                                    jfVar.g();
                                }
                            } else if (b2 == 2) {
                                this.f548a = jfVar.m720a();
                                b(true);
                                jfVar.g();
                            }
                        } else if (b2 == 11) {
                            this.f550c = jfVar.m716a();
                            jfVar.g();
                        }
                    } else if (b2 == 11) {
                        this.f549b = jfVar.m716a();
                        jfVar.g();
                    }
                } else if (b2 == 11) {
                    this.f546a = jfVar.m716a();
                    jfVar.g();
                }
            } else if (b2 == 10) {
                this.f545a = jfVar.m710a();
                a(true);
                jfVar.g();
            }
            ji.a(jfVar, b2);
