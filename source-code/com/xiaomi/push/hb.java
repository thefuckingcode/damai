...
public class hb {
    ...
    private static com.xiaomi.push.providers.a m542a(Context context) {
    ...
    /* renamed from: a  reason: collision with other method in class */
    private static synchronized String m543a(Context context) {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static void m544a(Context context) {
        a = b(context);
    }
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static synchronized void m545a(String str) {
        synchronized (hb.class) {
            if (!m.m740d() && !TextUtils.isEmpty(str)) {
                f448a = str;
            }
        }
    }
