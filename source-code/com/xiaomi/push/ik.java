...
public class ik implements iu<ik, Object>, Serializable, Cloneable {
    ...
    public int compareTo(ik ikVar) {
        ...
        int compareTo = Boolean.valueOf(m649a()).compareTo(Boolean.valueOf(ikVar.m649a()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (m649a() && (a21 = iv.a(this.f682a, ikVar.f682a)) != 0) {
            return a21;
        }
        int compareTo2 = Boolean.valueOf(m651b()).compareTo(Boolean.valueOf(ikVar.m651b()));
        if (compareTo2 != 0) {
            return compareTo2;
        }
        if (m651b() && (a20 = iv.a(this.f681a, ikVar.f681a)) != 0) {
            return a20;
        }
        int compareTo3 = Boolean.valueOf(m652c()).compareTo(Boolean.valueOf(ikVar.m652c()));
        if (compareTo3 != 0) {
            return compareTo3;
        }
        if (m652c() && (a19 = iv.a(this.f688b, ikVar.f688b)) != 0) {
            return a19;
        }
        ...
        while (true) {
            ...
            switch (a2.f801a) {
                ...
                case 21:
                    if (b2 == 15) {
                        jd a3 = jfVar.m712a();
                        this.f684a = new ArrayList(a3.f802a);
                        for (int i2 = 0; i2 < a3.f802a; i2++) {
                            this.f684a.add(jfVar.m716a());
                        }
                        jfVar.i();
                        continue;
                        jfVar.g();
    ...
    /* renamed from: a  reason: collision with other method in class */
    public boolean m650a(ik ikVar) {
        if (ikVar == null) {
            return false;
        }
        boolean a2 = m649a();
        boolean a3 = ikVar.m649a();
        if ((a2 || a3) && (!a2 || !a3 || !this.f682a.equals(ikVar.f682a))) {
            return false;
        }
        boolean b2 = m651b();
        boolean b3 = ikVar.m651b();
        if ((b2 || b3) && (!b2 || !b3 || !this.f681a.m595a(ikVar.f681a))) {
            return false;
        }
        boolean c2 = m652c();
        boolean c3 = ikVar.m652c();
        if ((c2 || c3) && (!c2 || !c3 || !this.f688b.equals(ikVar.f688b))) {
            return false;
        }
        boolean d2 = d();
        boolean d3 = ikVar.d();
    ...
    public void b(jf jfVar) {
        m648a();
        jfVar.a(f678a);
        if (this.f682a != null && m649a()) {
            jfVar.a(a);
            jfVar.a(this.f682a);
            jfVar.b();
        }
        if (this.f681a != null && m651b()) {
            jfVar.a(b);
            this.f681a.b(jfVar);
            jfVar.b();
        }
