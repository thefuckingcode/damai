...
public class bk {
    ...
    public static <T> T a(Class<?> cls, String str, Object... objArr) {
        return (T) a(cls, str, a(objArr)).invoke(null, m286a(objArr));
    }
    ...
    private static Object[] m286a(Object... objArr) {
        if (objArr == null || objArr.length <= 0) {
            return null;
        }
    ...
    public static <T> T b(Object obj, String str, Object... objArr) {
        return (T) a(obj.getClass(), str, a(objArr)).invoke(obj, m286a(objArr));
    }
