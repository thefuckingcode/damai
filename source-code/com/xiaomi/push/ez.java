        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            case SystemMessageConstants.H5_LOGIN_FAILURE:
                            ...
                            default:
                                switch (i) {
                                    case ErrorConstants.REQUEST_ERROR_CODE_NO_RESPONSE /*{ENCODED_INT: 20101}*/:
                                        return CONN_TCP_NOACCESS;
                                    case 20102:
                                        return CONN_TCP_NETUNREACH;
                                    case ErrorConstants.REQUEST_ERROR_CODE_SOCKET_TIMEOUT /*{ENCODED_INT: 20103}*/:
