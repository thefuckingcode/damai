...
public class hz implements iu<hz, Object>, Serializable, Cloneable {
    ...
    public int compareTo(hz hzVar) {
        ...
        int compareTo = Boolean.valueOf(m596a()).compareTo(Boolean.valueOf(hzVar.m596a()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (m596a() && (a21 = iv.a(this.f557a, hzVar.f557a)) != 0) {
            return a21;
        }
        ...
        while (true) {
            ...
            switch (a2.f801a) {
                ...
                case 23:
                    if (b2 == 13) {
                        je a3 = jfVar.m713a();
                        this.f559a = new HashMap(a3.f803a * 2);
                        for (int i2 = 0; i2 < a3.f803a; i2++) {
                            this.f559a.put(jfVar.m716a(), jfVar.m716a());
                        }
                        jfVar.h();
                        continue;
                        jfVar.g();
    ...
    /* renamed from: a  reason: collision with other method in class */
    public boolean m597a(hz hzVar) {
        if (hzVar == null) {
            return false;
        }
        boolean a2 = m596a();
        boolean a3 = hzVar.m596a();
        if ((a2 || a3) && (!a2 || !a3 || !this.f557a.equals(hzVar.f557a))) {
            return false;
        }
        boolean b2 = b();
        boolean b3 = hzVar.b();
        if ((b2 || b3) && (!b2 || !b3 || !this.f555a.m595a(hzVar.f555a))) {
            return false;
        }
        boolean c2 = c();
        boolean c3 = hzVar.c();
        ...
        boolean h2 = h();
        boolean h3 = hzVar.h();
        if ((h2 || h3) && (!h2 || !h3 || !this.f556a.m658a(hzVar.f556a))) {
            return false;
        }
        boolean i2 = i();
        boolean i3 = hzVar.i();
