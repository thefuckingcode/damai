...
public class ij implements iu<ij, Object>, Serializable, Cloneable {
    ...
    public int compareTo(ij ijVar) {
        ...
        int compareTo = Boolean.valueOf(m642a()).compareTo(Boolean.valueOf(ijVar.m642a()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (m642a() && (a30 = iv.a(this.f652a, ijVar.f652a)) != 0) {
            return a30;
        }
        int compareTo2 = Boolean.valueOf(m644b()).compareTo(Boolean.valueOf(ijVar.m644b()));
        if (compareTo2 != 0) {
            return compareTo2;
        }
        if (m644b() && (a29 = iv.a(this.f651a, ijVar.f651a)) != 0) {
            return a29;
        }
        int compareTo3 = Boolean.valueOf(m645c()).compareTo(Boolean.valueOf(ijVar.m645c()));
        if (compareTo3 != 0) {
            return compareTo3;
        }
        if (m645c() && (a28 = iv.a(this.f658b, ijVar.f658b)) != 0) {
            return a28;
        }
                ...
                default:
                    switch (s2) {
                        case 100:
                            if (b2 == 13) {
                                je a3 = jfVar.m713a();
                                this.f654a = new HashMap(a3.f803a * 2);
                                for (int i2 = 0; i2 < a3.f803a; i2++) {
                                    this.f654a.put(jfVar.m716a(), jfVar.m716a());
                                }
                                jfVar.h();
                                break;
                            }
    ...
    /* renamed from: a  reason: collision with other method in class */
    public boolean m643a(ij ijVar) {
        if (ijVar == null) {
            return false;
        }
        boolean a2 = m642a();
        boolean a3 = ijVar.m642a();
        if ((a2 || a3) && (!a2 || !a3 || !this.f652a.equals(ijVar.f652a))) {
            return false;
        }
        boolean b2 = m644b();
        boolean b3 = ijVar.m644b();
        if ((b2 || b3) && (!b2 || !b3 || !this.f651a.m595a(ijVar.f651a))) {
            return false;
        }
        boolean c2 = m645c();
        boolean c3 = ijVar.m645c();
        if ((c2 || c3) && (!c2 || !c3 || !this.f658b.equals(ijVar.f658b))) {
            return false;
        }
        boolean d2 = d();
        boolean d3 = ijVar.d();
    ...
    public void b(jf jfVar) {
        m641a();
        jfVar.a(f647a);
        if (this.f652a != null && m642a()) {
            jfVar.a(a);
            jfVar.a(this.f652a);
            jfVar.b();
        }
        if (this.f651a != null && m644b()) {
            jfVar.a(b);
            this.f651a.b(jfVar);
            jfVar.b();
        }
