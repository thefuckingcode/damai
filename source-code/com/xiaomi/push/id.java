...
public class id implements iu<id, Object>, Serializable, Cloneable {
    ...
    public int compareTo(id idVar) {
        ...
        int compareTo = Boolean.valueOf(m609a()).compareTo(Boolean.valueOf(idVar.m609a()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (m609a() && (a11 = iv.a(this.f594a, idVar.f594a)) != 0) {
            return a11;
        }
        ...
        while (true) {
            ...
            switch (a2.f801a) {
                ...
                case 6:
                    if (b2 == 15) {
                        jd a3 = jfVar.m712a();
                        this.f597a = new ArrayList(a3.f802a);
                        for (int i2 = 0; i2 < a3.f802a; i2++) {
                            this.f597a.add(jfVar.m716a());
                        }
                        jfVar.i();
                        continue;
                        jfVar.g();
    ...
    /* renamed from: a  reason: collision with other method in class */
    public boolean m610a(id idVar) {
        if (idVar == null) {
            return false;
        }
        boolean a2 = m609a();
        boolean a3 = idVar.m609a();
        if ((a2 || a3) && (!a2 || !a3 || !this.f594a.m595a(idVar.f594a))) {
            return false;
        }
        boolean b2 = b();
        boolean b3 = idVar.b();
