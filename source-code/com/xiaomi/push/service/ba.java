...
public class ba {
    ...
    public long a(int i, long j) {
        try {
            String a2 = a(i);
            return this.b.contains(a2) ? this.b.getLong(a2, 0) : this.f912a.contains(a2) ? this.f912a.getLong(a2, 0) : j;
        } catch (Exception e) {
            b.m182a(i + " oc long error " + e);
            return j;
        }
    }
    ...
    public void a(List<Pair<hp, Integer>> list, List<Pair<Integer, Object>> list2) {
        if (ag.a(list) || ag.a(list2)) {
            b.m182a("not update oc, because versions or configs are empty");
            return;
        }
