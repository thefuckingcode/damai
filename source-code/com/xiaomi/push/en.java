...
public class en {
    ...
    public static Config a(Context context) {
        boolean a2 = ba.a(context).a(ho.PerfUploadSwitch.a(), false);
        boolean a3 = ba.a(context).a(ho.EventUploadNewSwitch.a(), false);
        int a4 = ba.a(context).a(ho.PerfUploadFrequency.a(), 86400);
        return Config.getBuilder().setEventUploadSwitchOpen(a3).setEventUploadFrequency((long) ba.a(context).a(ho.EventUploadFrequency.a(), 86400)).setPerfUploadSwitchOpen(a2).setPerfUploadFrequency((long) a4).build(context);
    }
    ...
    public static ht m442a(String str) {
        if (f303a == null) {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static String m443a(int i) {
    ...
    private static void a(Context context, hn hnVar) {
        if (m445a(context.getApplicationContext())) {
            ca.a(context.getApplicationContext(), hnVar);
            return;
        }
        a aVar = a;
        if (aVar != null) {
