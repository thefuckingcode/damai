...
public class MiPushClient4Hybrid {
    ...
    public static void registerPush(Context context, String str, String str2, String str3) {
        if (b.m219a(context).m224a(str2, str3, str)) {
            ...
            if (a != null) {
                arrayList.add(a.c);
                MiPushCommandMessage generateCommandMessage = PushMessageHelper.generateCommandMessage(ey.COMMAND_REGISTER.f325a, arrayList, 0, null, null, null);
                MiPushCallback miPushCallback = sCallback;
                if (miPushCallback != null) {
        ...
        if (Math.abs(currentTimeMillis - (sRegisterTimeMap.get(str) != null ? sRegisterTimeMap.get(str).longValue() : 0)) < DanmakuFactory.DEFAULT_DANMAKU_DURATION_V) {
        ...
        iiVar2.b(b.m219a(context).m220a());
    ...
    public static void reportMessageArrived(Context context, MiPushMessage miPushMessage, boolean z) {
        ...
        try {
            ...
            ao.a(context).a((iu) hzVar, hj.AckMessage, false, br.a(PushMessageHelper.generateMessage(miPushMessage)));
