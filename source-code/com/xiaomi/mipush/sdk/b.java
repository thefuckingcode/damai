...
public class b {
    ...
    public static class a {
        ...
        private String a() {
            ...
            return h.m537a(context, context.getPackageName());
        }
        ...
        public boolean m234a(String str, String str2) {
            ...
            boolean z3 = TextUtils.equals(this.f, j.j(this.f64a)) || TextUtils.equals(this.f, j.i(this.f64a));
    ...
    private void c() {
        ...
        if (!TextUtils.isEmpty(this.f61a.f) && j.a(this.f61a.f)) {
            this.f61a.f = j.j(this.f60a);
    ...
    public boolean m223a() {
        ...
        return !TextUtils.equals(h.m537a(context, context.getPackageName()), this.f61a.e);
    }

    public boolean a(String str, String str2) {
        return this.f61a.m234a(str, str2);
    }
    ...
    public boolean m229d() {
        return !TextUtils.isEmpty(this.f61a.f65a) && !TextUtils.isEmpty(this.f61a.b) && !TextUtils.isEmpty(this.f61a.c) && !TextUtils.isEmpty(this.f61a.d);
    }
