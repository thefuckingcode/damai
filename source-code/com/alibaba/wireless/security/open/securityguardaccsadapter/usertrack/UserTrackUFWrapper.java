    ...
    private static void runPeriodTask(final int i) {
        ...
        if (mHandler != null) {
            mHandler.postDelayed(new Runnable() {
                /* class com.alibaba.wireless.security.open.securityguardaccsadapter.usertrack.UserTrackUFWrapper.AnonymousClass1 */
        ...
        if (mTimer == null) {
            if (i > 0) {
                ...
                AnonymousClass2 r2 = new TimerTask() {
                    /* class com.alibaba.wireless.security.open.securityguardaccsadapter.usertrack.UserTrackUFWrapper.AnonymousClass2 */
                ...
                mTimerTask = r2;
                mTimer.schedule(r2, 0, (long) (i * 1000));
            }
        } else if (i != mUpdatePeriod) {
            if (i > 0) {
                mTimerTask.cancel();
                AnonymousClass3 r22 = new TimerTask() {
                    /* class com.alibaba.wireless.security.open.securityguardaccsadapter.usertrack.UserTrackUFWrapper.AnonymousClass3 */
                ...
                mTimerTask = r22;
                mTimer.schedule(r22, 0, (long) (i * 1000));
            } else {
                mTimerTask.cancel();
            }
        }
