...
public class ConfigManager extends Observable {
    ...
    public class a extends Thread {
        ...
        public void run() {
            ...
            if (z && (a2 = ConfigManager.this.a()) != null) {
                try {
    ...
    public class b extends Thread {
        ...
        public void run() {
            try {
                ...
                instance.init(1, new SecretKeySpec(ConfigManager.s.getBytes(), "AES"), new IvParameterSpec(ConfigManager.s.getBytes()));
                String encodeToString = Base64.encodeToString(instance.doFinal(this.a.getBytes()), 0);
    ...
    public class e implements a.b {
        ...
        public void a(String str, String str2, String str3) {
            String a2 = com.alibaba.wireless.security.aopsdk.e.a.a().a(ConfigManager.m, ConfigManager.CONFIG_KEY, "");
            if (ConfigManager.DEBUG) {
    ...
    public class f implements a.b {
        ...
        @Override // com.alibaba.wireless.security.aopsdk.e.a.b
        public void a(String str, String str2, String str3) {
            boolean a2 = com.alibaba.wireless.security.aopsdk.e.a.a().a(ConfigManager.m, ConfigManager.SWITCH_KEY, true);
            HashMap hashMap = new HashMap();
    ...
    public class g implements c.b {
        ...
        public void a(String str, Map<String, String> map) {
            ...
            if (a2 != null) {
                ConfigManager.this.a((ConfigManager) a2);
            }
        }
    }
        ...
        if (this.h) {
            ...
            if (!TextUtils.isEmpty(string)) {
                try {
                    ...
                    Cipher instance = Cipher.getInstance("AES/CBC/PKCS5PADDING");
                    instance.init(2, new SecretKeySpec(s.getBytes(), "AES"), new IvParameterSpec(s.getBytes()));
    ...
    /* JADX WARNING: Removed duplicated region for block: B:44:0x00ab A[DONT_GENERATE] */
            ...
            try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (readObject instanceof Map) {
                                ...
                                Log.i("AOP-CONFIG", "LoadPersistentConfig cost " + (System.currentTimeMillis() - j2) + " ms");
                                return map;
                            }
                        } catch (Throwable th) {
                            th = th;
                ...
                if (fileInputStream != null) {
                    try {
                        ...
                        Log.e("AOP-CONFIG", "stream close failed", e8);
                    }
                }
                if (objectInputStream != null) {
                    try {
                        ...
                        Log.e("AOP-CONFIG", "stream close failed", e9);
                    }
                }
                if (DEBUG) {
                    Log.i("AOP-CONFIG", "LoadPersistentConfig cost " + (System.currentTimeMillis() - j2) + " ms");
    ...
    private void a(int i2) {
        ...
        if (scheduledExecutorService != null) {
            scheduledExecutorService.schedule(new c(), (long) i2, TimeUnit.SECONDS);
        }
    }
