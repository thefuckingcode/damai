...
public class AopBridge {
    ...
    private final d ruleManager = d.a();
    ...
    public void applyRulesToInvocation(Invocation invocation) {
        ...
        a.b(TAG, "Strategy get for " + invocation.getProxyName() + " with " + (a != null ? a.size() : 0) + " strategies");
        ...
        for (d.b bVar : a) {
            for (d.a aVar : bVar.b) {
                a.b(TAG, "Start to process rule " + aVar.a);
                if (aVar.b.c()) {
                    a.b(TAG, "Sampling check passed");
    ...
    public boolean callBeforeBridge(Invocation invocation) {
        ...
        if (invocationConfig.shouldBlock) {
            ...
            a.b(TAG, "block call for " + invocation.getProxyName());
        }
        return true;
    }
    ...
    public void report(Invocation invocation) {
        ...
        if (invocation.shouldReport) {
            ...
            if (invocationConfig != null) {
                i = invocationConfig.matchedStrategyId;
            } else {
                i = 0;
            }
            if (invocationConfig != null) {
                i2 = invocationConfig.getRuleId();
            }
            ReportManager.a(invocation, i, i2, invocation.invokeTimeCost, invocation.basicIncTimeCost, nanoTime);
        }
    }
    ...
    public boolean shouldSampleDefault(Invocation invocation) {
        ...
        if (c == null || (cVar = c.f) == null || !cVar.c()) {
            return false;
        }
        return true;
    }
