    ...
    public static boolean a(Context context, Activity activity) {
        ...
        if (!values.isEmpty()) {
            for (Object obj : values) {
                if (obj != null && Boolean.FALSE.equals(a(obj, DXRecyclerLayout.LOAD_MORE_STOPED))) {
                    if (activity == null || a(obj, "activity") != activity) {
                        return true;
                    }
                }
            }
