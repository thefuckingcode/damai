        ...
        if (obj == null) {
            ...
            if ((SerializerFeature.UseISO8601DateFormat.mask & i) != 0) {
                ...
                if (i8 != 0) {
                    ...
                    SerializeWriter.getChars((long) i8, 23, cArr);
                    SerializeWriter.getChars((long) i7, 19, cArr);
                    SerializeWriter.getChars((long) i6, 16, cArr);
                    SerializeWriter.getChars((long) i5, 13, cArr);
                    SerializeWriter.getChars((long) i4, 10, cArr);
                    SerializeWriter.getChars((long) i3, 7, cArr);
                    SerializeWriter.getChars((long) i2, 4, cArr);
