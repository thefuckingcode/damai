    ...
    public void call(String str, String str2) {
        ...
        if (wXSDKInstance != null && wXSDKInstance.getContext() != null && !TextUtils.isEmpty(str)) {
            if (this.mEntryManager == null) {
                this.mIWVWebView = new wx2(this.mWXSDKInstance);
            ...
            if (parseObject != null) {
                ...
                if (MtopWVPlugin.API_SERVER_NAME.equalsIgnoreCase(wVCallMethodContext.objectName) && "send".equalsIgnoreCase(wVCallMethodContext.methodName)) {
                    ...
                    z = true;
                    WVJsBridge.getInstance().exCallMethod(this.mEntryManager, wVCallMethodContext, new a(this.mWXSDKInstance.getInstanceId(), str2, false, z), new a(this.mWXSDKInstance.getInstanceId(), str2, false, z));
                }
            }
            z = false;
            WVJsBridge.getInstance().exCallMethod(this.mEntryManager, wVCallMethodContext, new a(this.mWXSDKInstance.getInstanceId(), str2, false, z), new a(this.mWXSDKInstance.getInstanceId(), str2, false, z));
        ...
        if (wXSDKInstance != null && wXSDKInstance.getContext() != null && !TextUtils.isEmpty(str2)) {
            ...
            try {
                ...
                if (TextUtils.isEmpty(str)) {
                    ...
                    WVJsBridge.getInstance().exCallMethod(this.mEntryManager, wVCallMethodContext, new a(this.mWXSDKInstance.getInstanceId(), str4, true, false), new a(this.mWXSDKInstance.getInstanceId(), str3, true, false));
                }
            } catch (Throwable th) {
