...
public class WXTitleBorderView extends LinearLayout {
    ...
    public WXTitleBorderView(Context context, WXComponent wXComponent) {
        ...
        int realPxByWidth = (int) WXViewUtils.getRealPxByWidth((float) ((Integer) getValue("textfontsize", 20)).intValue());
        this.realTextFontSize = realPxByWidth;
        this.mtextLineHeight = (int) WXViewUtils.getRealPxByWidth((float) ((Integer) getValue("textlineheight", Integer.valueOf(realPxByWidth))).intValue());
        ...
        this.titleText.setTextSize(0, WXViewUtils.getRealPxByWidth((float) ((Integer) getValue("textfontsize", 20)).intValue()));
