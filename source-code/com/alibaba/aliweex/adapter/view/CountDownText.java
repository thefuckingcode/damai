...
public class CountDownText implements Runnable {
    ...
    private void computeTime() {
        ...
        this.day = j2;
        int i2 = this.oneHour;
        long j3 = (j - (((long) i) * j2)) / ((long) i2);
        this.hour = j3;
        int i3 = this.oneMin;
        long j4 = ((j - (((long) i) * j2)) - (((long) i2) * j3)) / ((long) i3);
        this.min = j4;
        this.sec = (((j - (j2 * ((long) i))) - (j3 * ((long) i2))) - (j4 * ((long) i3))) % 60;
    }
    ...
    private void setCountTimeText() {
        ...
        if (!TextUtils.isEmpty(this.dataFormat)) {
            String str4 = new String(this.dataFormat);
            long j = this.day;
            String str5 = "00";
            if (j < 0 || j >= 10) {
                str = j < 0 ? str5 : String.valueOf(j);
            } else {
                str = "0" + this.day;
            }
            String replace = str4.replace("dd", str);
            long j2 = this.hour;
            if (j2 < 0 || j2 >= 10) {
                str2 = j2 < 0 ? str5 : String.valueOf(j2);
            } else {
                str2 = "0" + this.hour;
            }
            ...
            long j3 = this.min;
            if (j3 < 0 || j3 >= 10) {
                str3 = j3 < 0 ? str5 : String.valueOf(j3);
            } else {
                str3 = "0" + this.min;
            }
            ...
            String replace4 = replace3.replace("ss", str5);
