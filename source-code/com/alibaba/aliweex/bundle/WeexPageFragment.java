...
public class WeexPageFragment extends Fragment {
    ...
    private void registerBroadcastReceiver() {
        if (WXEnvironment.isApkDebugable()) {
            this.mRefreshReceiver = new BroadcastReceiver() {
                /* class com.alibaba.aliweex.bundle.WeexPageFragment.AnonymousClass2 */
        ...
        try {
            this.mReloadReceiver = new BroadcastReceiver() {
                /* class com.alibaba.aliweex.bundle.WeexPageFragment.AnonymousClass3 */
            ...
            if (!TextUtils.equals(str, wXErrorCode2.getErrorCode()) || TextUtils.isEmpty(str2) || !str2.contains("eagleRenderErr")) {
                ...
                if (!TextUtils.equals(str, wXErrorCode3.getErrorCode()) || TextUtils.isEmpty(str2) || !str2.contains("degradeToH5")) {
                    ...
                    if (!TextUtils.equals(str, wXErrorCode4.getErrorCode()) || TextUtils.isEmpty(str2) || !str2.contains("degradeToH5")) {
                        ...
                        WXExceptionUtils.commitCriticalExceptionRT(instanceId, wXErrorCode5, "shouldDegrade", wXErrorCode5.getErrorMsg() + "-- " + str2, null);
                    } else {
                        String instanceId2 = wXSDKInstance.getInstanceId();
                        WXExceptionUtils.commitCriticalExceptionRT(instanceId2, wXErrorCode4, "shouldDegrade", wXErrorCode4.getErrorMsg() + "-- " + str2, null);
                    }
                } else {
                ...
                WXExceptionUtils.commitCriticalExceptionRT(instanceId4, wXErrorCode2, "shouldDegrade", wXErrorCode2.getErrorMsg() + " -- " + str2, null);
            }
        } else {
            String instanceId5 = wXSDKInstance.getInstanceId();
            WXExceptionUtils.commitCriticalExceptionRT(instanceId5, wXErrorCode, "shouldDegrade", wXErrorCode.getErrorMsg() + " -- " + str2, null);
        }
        return true;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle bundle) {
        ...
        if (this.mRenderPresenter == null) {
            ...
            if (this.mErrorView == null) {
                this.mErrorView = new a(createRenderPresenter);
            }
    ...
    public void setNavBarAdapter(ox2 ox2) {
    }
