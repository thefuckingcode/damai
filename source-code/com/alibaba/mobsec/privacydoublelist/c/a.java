...
public class a {
    ...
    public a() {
        ...
        hashMap.put(PrivacyDoubleList.Methods.Settings_Secure_getString_ContentResolver_String, new C0089a(1, "android_id"));
        hashMap.put(PrivacyDoubleList.Methods.SystemProperties_get_String, new C0089a(0, "ro.serialno"));
        hashMap.put(PrivacyDoubleList.Methods.SensorManager_getDefaultSensor_int_boolean, new C0089a(0, "18", Constants.VIA_ACT_TYPE_NINETEEN));
        hashMap.put(PrivacyDoubleList.Methods.SensorManager_getDefaultSensor_int, new C0089a(0, "18", Constants.VIA_ACT_TYPE_NINETEEN));
