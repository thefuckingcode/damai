...
public class PrivacyDoubleList {
    ...
    public void disableAll() {
        cancelReportTimer();
        AopManager.getInstance().removeChainDelegate(a.a());
    }

    public void enableAll() {
        startReportTimer();
        AopManager.getInstance().addChainDelegate(a.a());
    }
    ...
    public void startReportTimer() {
        ...
        if (scheduledFuture == null || scheduledFuture.isCancelled()) {
            ...
            c = this.a.scheduleWithFixedDelay(new b(this), (long) PrivacyDoubleListReporter.getInstance().getReportInitDelay(), (long) PrivacyDoubleListReporter.getInstance().getReportDelay(), TimeUnit.SECONDS);
        }
    }
