...
public class PrivacyDoubleListReporter {
    ...
    public void report() {
        ...
        if (PdlEnvUtils.b) {
            ...
            com.alibaba.mobsec.privacydoublelist.e.c a2 = e.b().a();
            Map<String, d> map2 = a2.a;
            ArrayList arrayList = new ArrayList(a2.b.values());
            ...
            if (map.size() > 0) {
                ...
                try {
                    ...
                    for (String str5 : map.keySet()) {
                        if (str5.contains(jl1.BRACKET_START_STR)) {
