...
public class RestReqDataBuilder {
    ...
    public static String assembleWithFullFields(Map<String, String> map) {
        ...
        RestFieldsScheme restFieldsScheme22 = RestFieldsScheme.ARGS;
        if (map.containsKey(restFieldsScheme22.toString())) {
            stringBuffer.append(_fixVariableValue(StringUtils.convertObjectToString(map.get(restFieldsScheme22.toString()))));
            map.remove(restFieldsScheme22.toString());
            z = false;
        } else {
            z = true;
        }
        ...
        if (StringUtils.isEmpty(stringBuffer2) || !stringBuffer2.endsWith(jl1.OR)) {
    ...
    public static RestReqDataBuildResult buildMonkeyPostReqDataObj(String str, String str2, Context context, long j, String str3, int i, Object obj, Object obj2, Object obj3, Map<String, String> map) {
        ...
        try {
            ...
            if (str7 == null || !str7.contains(str8)) {
                str8 = "Android";
            }
            ...
            stringBuffer.append(jl1.OR);
            stringBuffer.append(qm.SDK_TYPE);
            stringBuffer.append(jl1.OR);
    ...
    public static String buildRequestData(String str, long j, String str2, int i, Object obj, Object obj2, Object obj3, Map<String, String> map) {
        ...
        try {
            ...
            hashMap.put(RestFieldsScheme.SDKTYPE.toString(), qm.SDK_TYPE);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:37:0x0017 A[SYNTHETIC] */
