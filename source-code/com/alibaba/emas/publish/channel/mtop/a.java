        ...
        if (syncRequest.isApiSuccess()) {
            try {
                ...
                if (TextUtils.isEmpty(str2)) {
                    publishMtopResponse.clientRetCode = pm.b;
                    publishMtopResponse.clientRetMsg = pm.c;
                ...
                if (parseObject.containsKey("data")) {
                    ...
                    if (jSONObject == null || !jSONObject.containsKey("updateInfo")) {
                        publishMtopResponse.clientRetCode = pm.d;
                        publishMtopResponse.clientRetMsg = pm.e;
                    } else {
                ...
                publishMtopResponse.clientRetCode = pm.a;
