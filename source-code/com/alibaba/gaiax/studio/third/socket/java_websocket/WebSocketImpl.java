...
public class WebSocketImpl implements WebSocket {
    ...
    private boolean decodeHandshake(ByteBuffer byteBuffer) {
        ...
        try {
            ...
            if (role2 == Role.SERVER) {
                ...
                if (draft2 == null) {
                    for (Draft draft3 : this.knownDrafts) {
                        Draft copyInstance = draft3.copyInstance();
                        try {
                            ...
                            if (copyInstance.acceptHandshakeAsServer(clientHandshake) == HandshakeState.MATCHED) {
                                ...
                                try {
                                    ...
                                    Log.e("[GaiaX]", "Closing due to internal server error", e2);
                                    this.wsl.onWebsocketError(this, e2);
            ...
            if (role2 == Role.CLIENT) {
                ...
                if (this.draft.acceptHandshakeAsClient(this.handshakerequest, serverHandshake) == HandshakeState.MATCHED) {
                    try {
                        ...
                        Log.e("[GaiaX]", "Closing due to invalid data exception. Possible handshake rejection", e3);
                        flushAndClose(e3.getCloseCode(), e3.getMessage(), false);
                        return false;
                    } catch (RuntimeException e4) {
                        Log.e("[GaiaX]", "Closing since client was never connected", e4);
            ...
            try {
                Log.e("[GaiaX]", "Closing due to invalid handshake", e5);
                close(e5);
    ...
    public synchronized void close(int i, String str, boolean z) {
        ...
        ReadyState readyState3 = ReadyState.CLOSING;
        if (readyState2 != readyState3 && this.readyState != ReadyState.CLOSED) {
