...
public final class GXSliderDefaultIndicatorView extends GXSliderBaseIndicatorView {
    ...
    public void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension((int) ((((float) (i3 - 1)) * INDICATOR_NORMAL_WIDTH) + INDICATOR_SELECTED_WIDTH + (((float) (i3 - 1)) * INDICATOR_SPACING)), (int) INDICATOR_HEIGHT);
    }
