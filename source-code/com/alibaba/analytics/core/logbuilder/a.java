...
public class a {
    ...
    public static String a(Map<String, String> map) {
        ...
        if (map != null && map.size() > 0) {
            ...
            if (b2 != null) {
                ...
                String str5 = map.get(LogField.RESERVES.toString());
                if (!zf2.f(str5)) {
                ...
                String str6 = map.get(uTMCLogFields.toString());
                if (str6 != null) {
                    if (sb.length() > 0) {
                        sb.append(",_did=");
                        sb.append(str6);
                ...
                String str8 = map.get(LogField.APPKEY.toString());
                String g = Variables.n().g();
                if (!TextUtils.isEmpty(str8) && !TextUtils.isEmpty(g) && !g.equalsIgnoreCase(str8)) {
                    if (sb.length() > 0) {
                        sb.append(",_mak=");
                        sb.append(g);
                    } else {
        ...
        while (true) {
            ...
            if (i >= length || (logField = values[i]) == LogField.ARGS) {
                ...
                if (c.containsKey(logField.toString())) {
                    str2 = zf2.c(c.get(logField.toString()));
                    c.remove(logField.toString());
                }
                stringBuffer.append(c(str2));
                stringBuffer.append(jl1.OR);
                i++;
            }
        }
        StringBuffer stringBuffer22 = new StringBuffer();
        LogField logField22 = LogField.ARGS;
        if (c.containsKey(logField22.toString())) {
            stringBuffer22.append(c(zf2.c(c.get(logField22.toString()))));
            c.remove(logField22.toString());
            z = false;
        } else {
            z = true;
        }
        for (String str3 : c.keySet()) {
            String c2 = c.containsKey(str3) ? zf2.c(c.get(str3)) : null;
            if (z) {
                if ("StackTrace".equals(str3)) {
                    stringBuffer22.append("StackTrace=====>");
                    stringBuffer22.append(c2);
                } else {
                    stringBuffer22.append(c(str3));
        ...
        if (length2 < 1) {
            ...
            if (!j(str4)) {
                if (!i(str4)) {
                    ...
                    str = stringBuffer22.substring(0, 40960);
                } else if (length2 > 245760) {
                    Logger.i("LogAssemble", "truncLog field", LogField.ARGS.toString(), "length", Integer.valueOf(length2));
                    str = stringBuffer22.substring(0, 245760);
                } else {
                ...
                Logger.i("LogAssemble", "truncLog field", LogField.ARGS.toString(), "length", Integer.valueOf(length2));
                str = stringBuffer22.substring(0, 409600);
                z3 = z2;
            } else {
                str = stringBuffer22.toString();
            }
    ...
    private static String[] g(String str, int i) {
        ...
        while (true) {
            ...
            int indexOf = str.indexOf(jl1.OR, i4);
            if (indexOf == -1) {
    ...
    private static void m(String str) {
        ...
        if (e != null) {
            ...
            LogStoreMgr.l().d(new u81("UT_ANALYTICS", "19999", "TRUNC_LOG", "", "", ib1.c(hashMap)));
        }
    }
