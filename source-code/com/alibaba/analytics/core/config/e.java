...
public class e implements SystemConfigMgr.IKVChangeListener {
    ...
    public static class b {
        ...
        private boolean b(String str) {
            ...
            if (list == null || list.contains(jl1.MUL) || this.b.contains(str)) {
                return true;
            }
            return false;
        }
        ...
        private boolean c(String str) {
            ...
            if (list.contains(jl1.MUL) || this.a.contains(str)) {
                return true;
            }
            return false;
        }
                        ...
                        if (!b(str2)) {
                            ...
                            if (map != null) {
                                ...
                                try {
                                    ...
                                    if (list != null) {
                                        for (String str3 : list) {
                                            if (!jl1.MUL.equalsIgnoreCase(str3)) {
                                ...
                                try {
                                    ...
                                    if (list2 != null) {
                                        for (String str4 : list2) {
                                            if (!jl1.MUL.equalsIgnoreCase(str4)) {
                                ...
                                if (list3 == null || list3.size() <= 0) {
                                    ...
                                    if (list4 != null && list4.size() > 0 && bVar.a.contains(jl1.MUL)) {
                                        this.c.add(str2);
                                    }
                                } else if (!bVar.b.contains(jl1.MUL)) {
                                    this.c.add(str2);
                                }
