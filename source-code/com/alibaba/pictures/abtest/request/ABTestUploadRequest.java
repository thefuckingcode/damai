...
public final class ABTestUploadRequest extends BaseRequest<ABTestExperiment> {
    ...
    public final String getAbUploadInfo() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-64599343")) {
            return this.abUploadInfo;
        }
        return (String) ipChange.ipc$dispatch("-64599343", new Object[]{this});
    }

    @Nullable
    public final String getScenario() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1369409519")) {
            return this.scenario;
        }
        return (String) ipChange.ipc$dispatch("-1369409519", new Object[]{this});
    }
