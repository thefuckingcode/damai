...
public final class ABTestExperimentRequest extends BaseRequest<ABTestScenarioResultList> {
    ...
    public final Boolean getPreload() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-178178941")) {
            return this.preload;
        }
        return (Boolean) ipChange.ipc$dispatch("-178178941", new Object[]{this});
    }

    @Nullable
    public final List<String> getScenarios() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1496473125")) {
            return this.scenarios;
        }
        return (List) ipChange.ipc$dispatch("-1496473125", new Object[]{this});
    }
