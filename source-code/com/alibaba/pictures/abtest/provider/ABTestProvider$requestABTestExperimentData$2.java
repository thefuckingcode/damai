...
public final class ABTestProvider$requestABTestExperimentData$2 extends Lambda implements Function1<fb0<ABTestScenarioResultList>, ur2> {
    private static transient /* synthetic */ IpChange $ipChange;
    public static final ABTestProvider$requestABTestExperimentData$2 INSTANCE = new ABTestProvider$requestABTestExperimentData$2();

    ABTestProvider$requestABTestExperimentData$2() {
        super(1);
    }
    ...
    public final void invoke(@NotNull fb0<ABTestScenarioResultList> fb0) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1500524529")) {
            ipChange.ipc$dispatch("-1500524529", new Object[]{this, fb0});
            return;
        }
