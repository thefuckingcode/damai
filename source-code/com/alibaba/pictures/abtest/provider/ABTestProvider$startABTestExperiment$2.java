...
public final class ABTestProvider$startABTestExperiment$2 extends Lambda implements Function1<fb0<ABTestExperiment>, ur2> {
    private static transient /* synthetic */ IpChange $ipChange;
    public static final ABTestProvider$startABTestExperiment$2 INSTANCE = new ABTestProvider$startABTestExperiment$2();

    ABTestProvider$startABTestExperiment$2() {
        super(1);
    }
    ...
    public final void invoke(@NotNull fb0<ABTestExperiment> fb0) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1244374758")) {
            ipChange.ipc$dispatch("1244374758", new Object[]{this, fb0});
            return;
        }
