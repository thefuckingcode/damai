...
public class PullToRefreshHeaderView extends FrameLayout implements RefreshTrigger {
    ...
    public static PullToRefreshHeaderView getInstance(Context context) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1967642073")) {
            return getInstance(context, false);
        }
        return (PullToRefreshHeaderView) ipChange.ipc$dispatch("1967642073", new Object[]{context});
    }
    ...
    private void initStatuBar(Activity activity) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1882345172")) {
            ...
            if (Build.VERSION.SDK_INT < 23) {
                ...
                this.statusHeight = me2.a(activity);
    ...
    public int getRefreshLayoutHeight() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1600008377")) {
            return getMeasuredHeight();
        }
        return ((Integer) ipChange.ipc$dispatch("1600008377", new Object[]{this})).intValue();
    }

    public int getStatusHeight() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1619223694")) {
            return this.statusHeight;
        }
        return ((Integer) ipChange.ipc$dispatch("-1619223694", new Object[]{this})).intValue();
    }
    ...
    public void onMove(boolean z, boolean z2, int i) {
        ...
        int i2 = this.mHeight;
        float f = (((float) i) / ((float) i2)) * 25.0f;
        if (i >= i2) {
    ...
    public static PullToRefreshHeaderView getInstance(Context context, boolean z) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "938578607")) {
            return getInstance(context, z, 17170445);
        }
        return (PullToRefreshHeaderView) ipChange.ipc$dispatch("938578607", new Object[]{context, Boolean.valueOf(z)});
    }
    ...
    public PullToRefreshHeaderView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        ((FrameLayout) findViewById(R$id.pull_to_refresh_view_layout)).setLayoutParams(new LinearLayout.LayoutParams(-1, u50.INSTANCE.b(context, mRefreshViweHeightUnitDp)));
    }

    public static PullToRefreshHeaderView getInstance(Context context, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-776924832")) {
            return getInstance(context, false, i);
        }
        return (PullToRefreshHeaderView) ipChange.ipc$dispatch("-776924832", new Object[]{context, Integer.valueOf(i)});
    }

    public static PullToRefreshHeaderView getInstance(Context context, boolean z, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1681846090")) {
            return getInstance(context, 70, z, i);
        }
        return (PullToRefreshHeaderView) ipChange.ipc$dispatch("1681846090", new Object[]{context, Boolean.valueOf(z), Integer.valueOf(i)});
    }
