    ...
    private void adaptiveViewParams(float f, int i, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10) {
        ...
        if (this.avatarLayout != null) {
            ...
            if (this.avatarYYmemberTag != null) {
                int a3 = u50.a(getContext(), f8);
                int a4 = u50.a(getContext(), f9);
                int a5 = u50.a(getContext(), f10);
        ...
        if (this.avatarImage != null) {
            ...
            int a6 = u502.a(getContext(), f);
            int a7 = u502.a(getContext(), f);
        ...
        if (this.avatarBorder != null) {
            ...
            float f11 = f + ((float) (i * 2));
            int a8 = u503.a(getContext(), f11);
            int a9 = u503.a(getContext(), f11);
        ...
        if (this.avatarCrown != null) {
            ...
            int a10 = u504.a(getContext(), f2);
            int a11 = u504.a(getContext(), f3);
            int a12 = u504.a(getContext(), f5);
        ...
        if (this.avatarVTag != null) {
            ...
            int a13 = u505.a(getContext(), f6);
            int a14 = u505.a(getContext(), f6);
            int a15 = u505.a(getContext(), f7);
