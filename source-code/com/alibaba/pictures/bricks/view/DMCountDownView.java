...
public class DMCountDownView extends LinearLayout {
    ...
    public DMCountDownView(Context context2) {
        this(context2, null);
    }
    ...
    private void countDown() {
        ...
        Thread thread = new Thread(new Runnable() {
            /* class com.alibaba.pictures.bricks.view.DMCountDownView.AnonymousClass1 */
            private static transient /* synthetic */ IpChange $ipChange;

            public void run() {
                String[] strArr;
                IpChange ipChange = $ipChange;
                if (AndroidInstantRuntime.support(ipChange, "1730251158")) {
                    ipChange.ipc$dispatch("1730251158", new Object[]{this});
                    return;
                }
                while (DMCountDownView.this.isContinue && !DMCountDownView.this.isPaused) {
                    try {
                        ...
                        if (DMCountDownView.this.showDayTv) {
                            strArr = wr.a(DMCountDownView.this.timeStamp);
                        } else {
                            strArr = wr.c(DMCountDownView.this.timeStamp);
                        }
    ...
    private void init() {
        ...
        ((LinearLayout.LayoutParams) this.hourColonTv.getLayoutParams()).bottomMargin = u50.a(this.context, 0.5f);
        ...
        ((LinearLayout.LayoutParams) this.minuteColonTv.getLayoutParams()).bottomMargin = u50.a(this.context, 0.5f);
    ...
    private void updateTvText(String str, TextView textView) {
        IpChange ipChange = $ipChange;
    ...
    public long getCountTime() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1399281226")) {
            return this.originalTime;
        }
        return ((Long) ipChange.ipc$dispatch("1399281226", new Object[]{this})).longValue();
    }

    public long getTimeStamp() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1421702256")) {
            return this.timeStamp;
        }
        return ((Long) ipChange.ipc$dispatch("-1421702256", new Object[]{this})).longValue();
    }
    ...
    public void setCountDownEndListener(CountDownEndListener countDownEndListener2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1468570904")) {
            ipChange.ipc$dispatch("1468570904", new Object[]{this, countDownEndListener2});
            return;
        }
        this.countDownEndListener = countDownEndListener2;
    }
    ...
    public DMCountDownView setHourColonTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "198434560")) {
            return setHourColonTvBackgroundColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("198434560", new Object[]{this, str});
    }
    ...
    public DMCountDownView setHourColonTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1178176863")) {
            return setHourColonTvTextColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("-1178176863", new Object[]{this, str});
    }
    ...
    public DMCountDownView setHourTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1706074523")) {
            return setHourTvBackgroundColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("-1706074523", new Object[]{this, str});
    }

    public DMCountDownView setHourTvBackgroundColorWithRadius(String str, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1884903932")) {
            return setHourTvBackgroundColorWithRadius(parseColor(str), i);
        }
        return (DMCountDownView) ipChange.ipc$dispatch("1884903932", new Object[]{this, str, Integer.valueOf(i)});
    }
    ...
    public DMCountDownView setHourTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "756720070")) {
            return setHourTvTextColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("756720070", new Object[]{this, str});
    }
    ...
    public DMCountDownView setMinuteColonTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2002833168")) {
            return setMinuteColonTvBackgroundColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("-2002833168", new Object[]{this, str});
    }
    ...
    public DMCountDownView setMinuteColonTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1043462289")) {
            return setMinuteColonTvTextColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("1043462289", new Object[]{this, str});
    }
    ...
    public DMCountDownView setMinuteTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1554737547")) {
            return setMinuteTvBackgroundColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("-1554737547", new Object[]{this, str});
    }
    ...
    public DMCountDownView setMinuteTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-802216490")) {
            return setMinuteTvTextColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("-802216490", new Object[]{this, str});
    }
    ...
    public DMCountDownView setSecondTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1555811349")) {
            return setSecondTvBackgroundColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("1555811349", new Object[]{this, str});
    }

    public DMCountDownView setSecondTvBackgroundColorWidthRadius(String str, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "829161976")) {
            return setSecondTvBackgroundColorWidthRadius(parseColor(str), i);
        }
        return (DMCountDownView) ipChange.ipc$dispatch("829161976", new Object[]{this, str, Integer.valueOf(i)});
    }
    ...
    public DMCountDownView setSecondTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1642654858")) {
            return setSecondTvTextColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("-1642654858", new Object[]{this, str});
    }
    ...
    public DMCountDownView setTimeTvBackgroundColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1305105244")) {
            return setTimeTvBackgroundColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("1305105244", new Object[]{this, str});
    }

    public DMCountDownView setTimeTvBackgroundColorWidthRadius(String str, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1010751167")) {
            return setTimeTvBackgroundColorWidthRadius(parseColor(str), i);
        }
        return (DMCountDownView) ipChange.ipc$dispatch("1010751167", new Object[]{this, str, Integer.valueOf(i)});
    }
    ...
    public DMCountDownView setTimeTvFontName(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            if (this.showDayTv) {
                an0.a(this.dayTv, str);
            }
            an0.a(this.hourTv, str);
            an0.a(this.minuteTv, str);
            an0.a(this.secondTv, str);
        }
        return this;
    }
    ...
    public DMCountDownView setTimeTvTextColor(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2125308931")) {
            return setTimeTvTextColor(parseColor(str));
        }
        return (DMCountDownView) ipChange.ipc$dispatch("-2125308931", new Object[]{this, str});
    }
    ...
    public DMCountDownView(Context context2, @Nullable AttributeSet attributeSet) {
        this(context2, attributeSet, 0);
    }

    public DMCountDownView(Context context2, @Nullable AttributeSet attributeSet, int i) {
