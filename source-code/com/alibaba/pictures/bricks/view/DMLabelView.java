...
public class DMLabelView extends FrameLayout {
    ...
    private int[] getColors() {
        ...
        if (dMLabelType == DMLabelType.LABEL_TYPE_UPCOMING_PERFORMANCE) {
            ...
            return new int[]{Color.parseColor("#FF2869"), Color.parseColor("#FF2869")};
    ...
    private void initDefault(Context context) {
        ...
        this.labelHeight = u50.b(context, 24);
        this.paddingLeft = u50.b(context, 4);
        this.paddingRight = u50.b(context, 4);
        int i = this.labelHeight;
        this.cornerRadii = new float[]{(float) (i / 2), (float) (i / 2), (float) (i / 2), (float) (i / 2), (float) (i / 2), (float) (i / 2), (float) u50.b(context, 2), (float) u50.b(context, 2)};
    ...
    public DMLabelView setCornerRadius(float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1628013219")) {
            return setCornerRadii(f, f, f, f);
        }
        return (DMLabelView) ipChange.ipc$dispatch("-1628013219", new Object[]{this, Float.valueOf(f)});
    }
