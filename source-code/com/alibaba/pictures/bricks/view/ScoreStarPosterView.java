...
public class ScoreStarPosterView extends LinearLayout {
    ...
    private void initView() {
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, u50.INSTANCE.b(getContext(), 80));
    ...
    public void setScoreStarMargin(float f, float f2) {
        ...
        if (this.mScoreLayout != null && context != null) {
            ...
            int a = u50.a(context, f);
            this.mScoreLayout.setPadding(u50.a(context, f2), 0, 0, a);
        }
    }
