...
public class RCRelativeLayoutView extends RelativeLayout implements Checkable, RCAttrs {
    ...
    public float getBottomLeftRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-464902863")) {
            return this.mRCHelper.a[4];
        }
        return ((Float) ipChange.ipc$dispatch("-464902863", new Object[]{this})).floatValue();
    }

    @Override // com.alibaba.pictures.bricks.view.rclayouthelper.RCAttrs
    public float getBottomRightRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "613582738")) {
            return this.mRCHelper.a[6];
        }
        return ((Float) ipChange.ipc$dispatch("613582738", new Object[]{this})).floatValue();
    }

    @Override // com.alibaba.pictures.bricks.view.rclayouthelper.RCAttrs
    public int getStrokeColor() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1284443859")) {
            return this.mRCHelper.f;
        }
        return ((Integer) ipChange.ipc$dispatch("-1284443859", new Object[]{this})).intValue();
    }

    @Override // com.alibaba.pictures.bricks.view.rclayouthelper.RCAttrs
    public int getStrokeWidth() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2042743830")) {
            return this.mRCHelper.h;
        }
        return ((Integer) ipChange.ipc$dispatch("-2042743830", new Object[]{this})).intValue();
    }

    @Override // com.alibaba.pictures.bricks.view.rclayouthelper.RCAttrs
    public float getTopLeftRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-250168409")) {
            return this.mRCHelper.a[0];
        }
        return ((Float) ipChange.ipc$dispatch("-250168409", new Object[]{this})).floatValue();
    }

    @Override // com.alibaba.pictures.bricks.view.rclayouthelper.RCAttrs
    public float getTopRightRadius() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1319583780")) {
            return this.mRCHelper.a[2];
        }
        return ((Float) ipChange.ipc$dispatch("-1319583780", new Object[]{this})).floatValue();
    }
    ...
    public boolean isChecked() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1487131202")) {
            return this.mRCHelper.l;
        }
        return ((Boolean) ipChange.ipc$dispatch("1487131202", new Object[]{this})).booleanValue();
    }

    @Override // com.alibaba.pictures.bricks.view.rclayouthelper.RCAttrs
    public boolean isClipBackground() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1966532533")) {
            return this.mRCHelper.i;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1966532533", new Object[]{this})).booleanValue();
    }

    @Override // com.alibaba.pictures.bricks.view.rclayouthelper.RCAttrs
    public boolean isRoundAsCircle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "114625017")) {
            return this.mRCHelper.d;
        }
        return ((Boolean) ipChange.ipc$dispatch("114625017", new Object[]{this})).booleanValue();
    }
