...
public class RoundImageView extends ImageView {
    ...
    public int dp2px(float f) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1831199404")) {
            return (int) TypedValue.applyDimension(1, f, getResources().getDisplayMetrics());
        }
        return ((Integer) ipChange.ipc$dispatch("1831199404", new Object[]{this, Float.valueOf(f)})).intValue();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (drawable != null && !(drawable instanceof GradientDrawable) && !(drawable instanceof AnimatedImageDrawable)) {
            ...
            int i4 = this.mRadius;
            canvas.drawCircle((float) i4, (float) i4, (float) i4, this.mBitmapPaint);
            if (this.mBorderWidth > 0) {
                int i5 = this.mRadius;
                canvas.drawCircle((float) i5, (float) i5, (float) i5, this.mBorderPaint);
            }
            ...
            if (z) {
                canvas.save();
                this.mGifClipRectF.set(0.0f, 0.0f, (float) width, (float) height);
                Path path = this.mGifClipPath;
                RectF rectF3 = this.mGifClipRectF;
                int i6 = this.mBorderRadius;
                path.addRoundRect(rectF3, (float) i6, (float) i6, Path.Direction.CW);
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (this.type == 1) {
            this.mRoundRect = new RectF(0.0f, 0.0f, (float) i, (float) i2);
        }
    }
    ...
    public void setBorder(float f, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "631406058")) {
            ...
            this.mBorderWidth = a;
            this.mBorderPaint.setStrokeWidth((float) a);
            invalidate();
        }
    }
