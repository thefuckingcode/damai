...
public class IRecyclerView extends RecyclerView {
    ...
    private int getMotionEventX(MotionEvent motionEvent, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-429552106")) {
            return (int) (MotionEventCompat.getX(motionEvent, i) + 0.5f);
        }
        return ((Integer) ipChange.ipc$dispatch("-429552106", new Object[]{this, motionEvent, Integer.valueOf(i)})).intValue();
    }

    private int getMotionEventY(MotionEvent motionEvent, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-78752169")) {
            return (int) (MotionEventCompat.getY(motionEvent, i) + 0.5f);
        }
        return ((Integer) ipChange.ipc$dispatch("-78752169", new Object[]{this, motionEvent, Integer.valueOf(i)})).intValue();
    }

    private String getStatusLog(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-164987818")) {
        ...
        return (String) ipChange.ipc$dispatch("-164987818", new Object[]{this, Integer.valueOf(i)});
    }

    private boolean isFingerDragging() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1861685879")) {
            return getScrollState() == 1;
        }
        return ((Boolean) ipChange.ipc$dispatch("1861685879", new Object[]{this})).booleanValue();
    }

    private boolean isRefreshTrigger(View view) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1762853960")) {
            return view instanceof RefreshTrigger;
        }
        return ((Boolean) ipChange.ipc$dispatch("1762853960", new Object[]{this, view})).booleanValue();
    }
    ...
    public RecyclerView.Adapter getIAdapter() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1012920501")) {
            return ((WrapperAdapter) getAdapter()).a();
        }
        return (RecyclerView.Adapter) ipChange.ipc$dispatch("1012920501", new Object[]{this});
    }

    public View getLoadMoreFooterView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1295746394")) {
            return this.mLoadMoreFooterView;
        }
        return (View) ipChange.ipc$dispatch("-1295746394", new Object[]{this});
    }

    public View getRefreshHeaderView() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1396807840")) {
            return this.mRefreshHeaderView;
        }
        return (View) ipChange.ipc$dispatch("-1396807840", new Object[]{this});
    }

    public WrapperAdapter getWrapAdapter() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2028387310")) {
            return (WrapperAdapter) getAdapter();
        }
        return (WrapperAdapter) ipChange.ipc$dispatch("2028387310", new Object[]{this});
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "186904468")) {
            return ((Boolean) ipChange.ipc$dispatch("186904468", new Object[]{this, motionEvent})).booleanValue();
        } else if (this.intercept) {
            return true;
        } else {
            int actionMasked = MotionEventCompat.getActionMasked(motionEvent);
            if (actionMasked == 0) {
                ...
                if (findPointerIndex < 0) {
                    String str = TAG;
                    Log.e(str, "Error processing scroll; pointer index for id " + findPointerIndex + " not found. Did any MotionEvents get skipped?");
                    return false;
                }
        ...
        if (z) {
            ...
            if (onLoadMoreScrollListener == null) {
                this.mOnLoadMoreScrollListener = new OnLoadMoreScrollListener() {
                    /* class com.alibaba.pictures.bricks.view.irecycler.IRecyclerView.AnonymousClass1 */
                    private static transient /* synthetic */ IpChange $ipChange;

                    @Override // com.alibaba.pictures.bricks.view.irecycler.OnLoadMoreScrollListener
                    public void b(RecyclerView recyclerView) {
                        IpChange ipChange = $ipChange;
                        if (AndroidInstantRuntime.support(ipChange, "1627836719")) {
                            ipChange.ipc$dispatch("1627836719", new Object[]{this, recyclerView});
