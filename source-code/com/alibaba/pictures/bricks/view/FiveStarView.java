...
public final class FiveStarView extends LinearLayout {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ FiveStarView(Context context, AttributeSet attributeSet, int i, int i2, m40 m40) {
    ...
    private final void initView(Context context) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (i != 4) {
                generateDefaultLayoutParams.setMarginEnd(u50.INSTANCE.a(context, 1.5f));
            }
    ...
    public final void updateView(double d) {
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                k21.h(subtract, "this.subtract(other)");
                if (subtract.compareTo(new BigDecimal("0.9")) <= 0) {
                    c = 2;
                } else {
                    c = subtract.compareTo(new BigDecimal("1.9")) <= 0 ? (char) 1 : 0;
                }
    ...
    public FiveStarView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        k21.h(obtainStyledAttributes, "context.obtainStyledAttr…R.styleable.FiveStarView)");
