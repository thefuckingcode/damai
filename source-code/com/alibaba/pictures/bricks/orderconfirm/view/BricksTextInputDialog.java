...
public final class BricksTextInputDialog extends AlertDialog {
    ...
    private final void c(Context context) {
        ...
        findViewById(R$id.tv_cancel).setOnClickListener(new wc(this));
        findViewById(R$id.tv_confirm).setOnClickListener(new xc(this));
    }
    ...
    public static final void d(BricksTextInputDialog bricksTextInputDialog, View view) {
        ...
        k21.i(bricksTextInputDialog, "this$0");
