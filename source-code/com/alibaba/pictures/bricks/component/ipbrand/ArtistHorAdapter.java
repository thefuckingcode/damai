...
public class ArtistHorAdapter extends RecyclerView.Adapter<IpDramaBrandArtistHorViewHolder> {
    ...
    public class IpDramaBrandArtistHorViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private static transient /* synthetic */ IpChange $ipChange;
        private Context a;
        private TextView b = ((TextView) this.itemView.findViewById(R$id.ip_brand_artist_name));
        private TextView c = ((TextView) this.itemView.findViewById(R$id.ip_brand_artist_fancount));
        private DMAvatar d = ((DMAvatar) this.itemView.findViewById(R$id.ip_brand_artist_avatar));
        private DMPosterView e = ((DMPosterView) this.itemView.findViewById(R$id.drama_image));
    ...
    public IpDramaBrandArtistHorViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1203541440")) {
            return new IpDramaBrandArtistHorViewHolder(this.b, viewGroup);
        }
        return (IpDramaBrandArtistHorViewHolder) ipChange.ipc$dispatch("-1203541440", new Object[]{this, viewGroup, Integer.valueOf(i)});
    }
