...
public class IpDramaBrandView extends AbsView<IItem<ItemValue>, IpDramaBrandContract.Model<IItem<ItemValue>>, IpDramaBrandContract.Presenter<IItem<ItemValue>, IpDramaBrandContract.Model<IItem<ItemValue>>>> implements IpDramaBrandContract.View {
    ...
    public class c implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (contentInfo == null || TextUtils.isEmpty(contentInfo.schema)) {
                action.setActionUrl(new Uri.Builder().scheme("damai").authority(gr.DISCOVER_CONTENT_DETAIL).build().toString());
    ...
    public IpDramaBrandView(View view) {
        ...
        ArtistHorAdapter artistHorAdapter2 = new ArtistHorAdapter(this.context);
        this.artistHorAdapter = artistHorAdapter2;
        this.ircArtist.setAdapter(artistHorAdapter2);
    ...
    public void artistView(String str, ArrayList<BaccountInfo> arrayList) {
        ...
        } else if ("brand".equals(str) || t71.a(arrayList) <= 1) {
    ...
    public RelativeLayout getContentLayout() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-922193879")) {
            return this.ip_brand_quickreport;
        }
        return (RelativeLayout) ipChange.ipc$dispatch("-922193879", new Object[]{this});
    }

    @Override // com.alibaba.pictures.bricks.component.ipbrand.IpDramaBrandContract.View
    public LinearLayout getTopLayout() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1071005996")) {
            return this.ip_brand_top_layout;
        }
        return (LinearLayout) ipChange.ipc$dispatch("-1071005996", new Object[]{this});
    }
    ...
    public void informationView(String str, ArrayList<VideoAlbum> arrayList) {
        ...
        } else if (!"brand".equals(str) || t71.a(arrayList) <= 0 || arrayList.get(0) == null) {
                ...
                if (i == 1) {
                    ...
                    if (videoAlbum.getVideoInfo() != null) {
                        ...
                        if (videoAlbum.getVideoInfo().getVideoTime() > 0) {
                            this.ip_brand_video_time.setText(wf2.INSTANCE.h(videoAlbum.getVideoInfo().getVideoTime()));
                            setViewGone(this.ip_brand_video_time, 0);
                        } else {
    ...
    public void ipBrandRightView(String str, String str2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-722404327")) {
            ...
            try {
                this.ip_brand_score_star_view.updateView((double) Float.parseFloat(str2));
