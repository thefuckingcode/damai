...
public final class CouponInfoViewHolder extends RecyclerView.ViewHolder {
    ...
    public CouponInfoViewHolder(@NotNull View view) {
        ...
        k21.h(findViewById, "itemView.findViewById(R.…pt_coupon_service_layout)");
    ...
    public static final void c(CouponInfoViewHolder couponInfoViewHolder, View view) {
        ...
        k21.i(couponInfoViewHolder, "this$0");
        ...
        if (couponInfoBean.getServiceNoteList() == null) {
            ...
            if (serviceNoteList != null) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    textView11.setText(serviceNoteList.get(i2).getTitle());
    ...
    public final void e(int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1023502938")) {
            ipChange.ipc$dispatch("-1023502938", new Object[]{this, Integer.valueOf(i2)});
            return;
        }
        View view = this.itemView;
        view.setPadding(view.getPaddingLeft(), i2, this.itemView.getPaddingRight(), this.itemView.getPaddingBottom());
    }
}
