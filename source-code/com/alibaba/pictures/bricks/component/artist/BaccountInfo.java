...
public class BaccountInfo implements Serializable {
    ...
    public boolean isHasFollow() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1222413563")) {
            return !TextUtils.isEmpty(this.followStatus) && !"0".equals(this.followStatus);
        }
        return ((Boolean) ipChange.ipc$dispatch("-1222413563", new Object[]{this})).booleanValue();
    }
    ...
    public boolean isShowVTag() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "762037953")) {
            return !TextUtils.isEmpty(this.vaccount) && !"0".equals(this.vaccount);
        }
        return ((Boolean) ipChange.ipc$dispatch("762037953", new Object[]{this})).booleanValue();
    }
}
