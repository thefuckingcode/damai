...
public final class PurchaseInstructionsView extends AbsView<GenericItem<ItemValue>, FoldTextViewModel, FoldTextViewPresent> implements PurchaseInstructionsContract.View {
    ...
    private final TextView content = ((TextView) this.itemView.findViewById(R$id.content));
    @NotNull
    ...
    public final View getItemView() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-564004958")) {
            return this.itemView;
        }
        return (View) ipChange.ipc$dispatch("-564004958", new Object[]{this});
    }
