...
public final class ScriptModel extends AbsModel<GenericItem<ItemValue>, SearchScriptBean> implements ScriptContract.Model {
    ...
    public SearchScriptBean getData() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-638061608")) {
            return (SearchScriptBean) getValue();
        }
        return (SearchScriptBean) ipChange.ipc$dispatch("-638061608", new Object[]{this});
    }
}
