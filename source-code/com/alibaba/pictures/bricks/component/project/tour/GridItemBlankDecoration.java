...
public class GridItemBlankDecoration extends RecyclerView.ItemDecoration {
    ...
    public static class b {
        ...
        public GridItemBlankDecoration a() {
            ...
            if (!AndroidInstantRuntime.support(ipChange, "1185105685")) {
                return new GridItemBlankDecoration(this.b, this.c, this.d);
            }
            return (GridItemBlankDecoration) ipChange.ipc$dispatch("1185105685", new Object[]{this});
        }
