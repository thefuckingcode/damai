...
public class ProjectModel extends AbsModel<IItem<ItemValue>, Object> implements ProjectContract.Model<IItem<ItemValue>> {
    ...
    public long getNativeDiffTime() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1693403858")) {
            return this.nativeDiffTime;
        }
        return ((Long) ipChange.ipc$dispatch("-1693403858", new Object[]{this})).longValue();
    }

    @Override // com.alibaba.pictures.bricks.component.project.ProjectContract.Model
    public ProjectItemBean getProjectItemBean() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2113871823")) {
            return this.projectItemBean;
        }
        return (ProjectItemBean) ipChange.ipc$dispatch("-2113871823", new Object[]{this});
    }

    @Override // com.alibaba.pictures.bricks.component.project.ProjectContract.Model
    public long getServerTime() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "171578311")) {
            return this.serverTime;
        }
        return ((Long) ipChange.ipc$dispatch("171578311", new Object[]{this})).longValue();
    }
