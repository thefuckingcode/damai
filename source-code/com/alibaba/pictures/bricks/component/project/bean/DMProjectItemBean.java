...
public class DMProjectItemBean implements Serializable {
    ...
    public String gotMarketUTValue() {
        ...
        if (projectTagModel != null && !t71.b(projectTagModel.marketPromotionTags)) {
    ...
    public boolean hasWantSee() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1655056400")) {
            return TextUtils.equals(this.wantSee, "true");
        }
        return ((Boolean) ipChange.ipc$dispatch("-1655056400", new Object[]{this})).booleanValue();
    }
    ...
    public boolean judgeIsSnapUp() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2067920269")) {
            return this.snapUpInfo != null;
        }
        return ((Boolean) ipChange.ipc$dispatch("-2067920269", new Object[]{this})).booleanValue();
    }
