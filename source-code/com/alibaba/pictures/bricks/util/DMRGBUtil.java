...
public class DMRGBUtil {
    ...
    public static void f(@FloatRange(from = 0.0d, to = 1.0d) final float f, final Bitmap bitmap, @NonNull final String str, final OnFetchColorListener onFetchColorListener) {
        ...
        if (TextUtils.isEmpty(str) || (num = b.get(c(str))) == null || num.intValue() == 0) {
            ps1.a(new PriorityTask("TASK_FETCH_IMAGE_ALL_PIXEL_AVERAGE_COLOR", null) {
                /* class com.alibaba.pictures.bricks.util.DMRGBUtil.AnonymousClass1 */
                private static transient /* synthetic */ IpChange $ipChange;

                @Override // com.alibaba.pictures.bricks.util.PriorityTask
                public void doTask() {
                    IpChange ipChange = $ipChange;
                    if (AndroidInstantRuntime.support(ipChange, "1142289135")) {
                        ipChange.ipc$dispatch("1142289135", new Object[]{this});
                        return;
                    }
                    ...
                    DMRGBUtil.a.post(new Runnable() {
                        /* class com.alibaba.pictures.bricks.util.DMRGBUtil.AnonymousClass1.AnonymousClass1 */
                        private static transient /* synthetic */ IpChange $ipChange;

                        public void run() {
                            IpChange ipChange = $ipChange;
                            if (AndroidInstantRuntime.support(ipChange, "-1020839245")) {
                                ipChange.ipc$dispatch("-1020839245", new Object[]{this});
                                return;
                            }
