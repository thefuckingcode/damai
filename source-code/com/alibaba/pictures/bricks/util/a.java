...
public class a {
    ...
    private static String d(String str, DMImageStrategyConfig dMImageStrategyConfig) {
        ...
        if (dMImageStrategyConfig.b && (dMImageCropType = dMImageStrategyConfig.c) != null) {
            if (dMImageCropType.equals(DMImageStrategyConfig.DMImageCropType.cy500)) {
                ...
                str2 = dMImageStrategyConfig.c.equals(DMImageStrategyConfig.DMImageCropType.cy100) ? "cy100i" : str3;
            }
    ...
    private static String e(String str, DMImageStrategyConfig dMImageStrategyConfig) {
        String str2;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1066673764")) {
            return (String) ipChange.ipc$dispatch("1066673764", new Object[]{str, dMImageStrategyConfig});
        }
        StringBuilder sb = new StringBuilder(str);
        ...
        int[] a2 = a(dMImageStrategyConfig.g, dMImageStrategyConfig.f, true);
        if (a2[0] > 0 && a2[1] > 0) {
            sb.append("/resize");
            sb.append(",");
            sb.append("w_");
