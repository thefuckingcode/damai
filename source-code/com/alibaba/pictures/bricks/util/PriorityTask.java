...
public abstract class PriorityTask implements Runnable, Comparable<PriorityTask> {
    ...
    public Object getParam() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1104399482")) {
            return this.param.get();
        }
        return ipChange.ipc$dispatch("1104399482", new Object[]{this});
    }

    public int getPriority() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1881715540")) {
            return this.priority;
        }
        return ((Integer) ipChange.ipc$dispatch("1881715540", new Object[]{this})).intValue();
    }
