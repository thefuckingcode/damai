...
public final class OrderDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int i) {
        ...
        if (obj != null) {
            ...
            if (k21.d(cls, Goods.class)) {
                return 3;
            }
            if (k21.d(cls, CouponOrderInfoBean.class)) {
                return 8;
            }
            if (k21.d(cls, FaqBean.class)) {
                return 7;
            }
            if (k21.d(cls, Notice.class)) {
                return 5;
            }
            if (k21.d(cls, CouponRuleBean.class)) {
                return 4;
            }
            if (k21.d(cls, ShopDetailJson.class)) {
                return 6;
            }
            if (k21.d(cls, GaiaXBean.class)) {
                return 9;
            }
        }
    ...
    public void onBindViewHolder(@NotNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (viewHolder instanceof GroupCouponsViewHolder) {
            ...
            if (trackInfo2 != null) {
                ((NoticeViewHolder) viewHolder).c((Notice) obj, zl1.a(trackInfo2));
            }
            ...
            int i2 = DisplayMetrics.getwidthPixels(wm2.INSTANCE.b(this.a));
            ...
            if (!z) {
                ...
                if (render2 != null) {
                    gxRender = render2.get(0);
                }
                if (gxRender != null && (gxTemplate = gxRender.getGxTemplate()) != null) {
                    remoteNativeGaiaXViewHolder.c(gxTemplate, gaiaXBean.getData(), (float) i2, i);
                }
            }
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            ...
            case 5:
                ...
                k21.h(inflate2, "from(parent.context)\n   …es_layout, parent, false)");
            ...
            default:
                ...
                k21.h(inflate3, "from(parent.context)\n   …ty_layout, parent, false)");
                return new EmptyViewHolder(inflate3);
            case 7:
                return new CouponQuestionViewHolder(viewGroup, new og0(this.a, this.g));
            case 8:
