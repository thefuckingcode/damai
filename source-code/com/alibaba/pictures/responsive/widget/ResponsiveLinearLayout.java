...
public final class ResponsiveLinearLayout extends LinearLayout {
    ...
    public final b12 getResponsiveSizeManager() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "765308242")) {
            return this.responsiveSizeManager;
        }
        return (b12) ipChange.ipc$dispatch("765308242", new Object[]{this});
    }
    ...
    public final void setResponsiveSizeManager(@NotNull b12 b12) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1660346422")) {
            ipChange.ipc$dispatch("1660346422", new Object[]{this, b12});
            return;
        }
        k21.i(b12, "<set-?>");
        this.responsiveSizeManager = b12;
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ ResponsiveLinearLayout(Context context, AttributeSet attributeSet, int i, m40 m40) {
