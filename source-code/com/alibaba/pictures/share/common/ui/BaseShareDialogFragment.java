...
public abstract class BaseShareDialogFragment extends DialogFragment implements View.OnClickListener, IShareMenu.MenuCallback, ShareHelperCallback {
    ...
    public final Pair<String, Object>[] getShareExtra() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-22550349")) {
            return this.shareExtra;
        }
        return (Pair[]) ipChange.ipc$dispatch("-22550349", new Object[]{this});
    }
    ...
    public int layoutId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-263606647")) {
            return R$layout.layout_base_share_dialog;
        }
        return ((Integer) ipChange.ipc$dispatch("-263606647", new Object[]{this})).intValue();
    }
    ...
    public void onStart() {
        ...
        if (dialog != null && (window = dialog.getWindow()) != null) {
            ...
            if (iShareMenu != null) {
                iShareMenu.setAnimation(z ? 100 : 300);
            }
        }
    }
    ...
    public void shareComplete(int i) {
        ...
        IShareResult iShareResult2 = this.iShareResult;
        if (iShareResult2 != null) {
            iShareResult2.shareComplete(i);
        }
    }
    ...
    public void shareException(int i, @Nullable ShareException shareException) {
        ...
        IShareResult iShareResult2 = this.iShareResult;
        if (iShareResult2 != null) {
            iShareResult2.shareException(i, shareException);
        }
    }
    ...
    public void shareStart(int i) {
        ...
        if (context != null) {
            k21.h(context, "this");
            new s92(context).c(i, getShareContentInfo(i), getShareExtra(i));
        }
        dismiss();
    }
    ...
    public void show(@NotNull FragmentManager fragmentManager, @Nullable String str) {
        ...
        if (getDialog() == null || (dialog = getDialog()) == null || !dialog.isShowing()) {
            try {
                ...
                pairArr[0] = do2.a("error", message);
                ba2.c("BaseDialogFragment", x.m(pairArr));
            }
        }
    }
    ...
    public Pair<String, Object>[] getShareExtra(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "430977120")) {
            return this.shareExtra;
        }
        return (Pair[]) ipChange.ipc$dispatch("430977120", new Object[]{this, Integer.valueOf(i)});
    }
}
