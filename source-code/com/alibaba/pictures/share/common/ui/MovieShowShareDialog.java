...
public class MovieShowShareDialog extends BaseShareDialogFragment {
    ...
    public MovieShowShareDialog(@NotNull Context context, @Nullable IShareAction iShareAction2) {
    ...
    public final IShareAction getIShareAction() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-399226402")) {
            return this.iShareAction;
        }
        return (IShareAction) ipChange.ipc$dispatch("-399226402", new Object[]{this});
    }
    ...
    public /* synthetic */ MovieShowShareDialog(Context context, IShareAction iShareAction2, int i, m40 m40) {
        this(context, (i & 2) != 0 ? null : iShareAction2);
    }
}
