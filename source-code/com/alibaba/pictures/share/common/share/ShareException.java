...
public class ShareException extends RuntimeException {
    ...
    public final int getStatusCode() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "103690328")) {
            return this.statusCode;
        }
        return ((Integer) ipChange.ipc$dispatch("103690328", new Object[]{this})).intValue();
    }

    @NotNull
    public final String getStatusMsg() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "378337993")) {
            return this.statusMsg;
        }
        return (String) ipChange.ipc$dispatch("378337993", new Object[]{this});
    }
