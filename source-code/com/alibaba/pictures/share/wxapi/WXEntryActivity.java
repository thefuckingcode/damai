...
public final class WXEntryActivity extends Activity implements IWXAPIEventHandler {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\bf\u0018\u00002\u00020\u0001J\u0012\u0010\u0005\u001a\u00020\u00042\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002H&J\b\u0010\u0006\u001a\u00020\u0004H&¨\u0006\u0007"}, d2 = {"Lcom/alibaba/pictures/share/wxapi/WXEntryActivity$GetWeixinUserPicListener;", "", "", "picUrl", "Ltb/ur2;", "onSuccess", "onFail", "share_release"}, k = 1, mv = {1, 4, 2})
    /* compiled from: Taobao */
    ...
    private final void a(BaseResp baseResp) {
        ...
        String str = this.b;
        v92.g(str, "handleShare resp = " + baseResp);
        int i = baseResp.errCode;
        if (i == -4) {
            df.a(ShareChannel.WEIXIN, 1002);
        } else if (i == -2) {
            df.a(ShareChannel.WEIXIN, 1001);
        } else if (i != 0) {
            df.a(ShareChannel.WEIXIN, 1003);
        } else {
            df.b(ShareChannel.WEIXIN);
        }
    }
    ...
    public void onResp(@Nullable BaseResp baseResp) {
        ...
        if (baseResp != null) {
            String str = this.b;
            v92.g(str, "resp = " + baseResp.errCode);
            a(baseResp);
        }
        finish();
    }
