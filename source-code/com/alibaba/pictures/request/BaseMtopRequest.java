...
public class BaseMtopRequest<BizResponse> extends MtopRequest implements DoloresRequest<BizResponse> {
    ...
    public final String getAsac() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-965845070")) {
            return this.asac;
        }
        return (String) ipChange.ipc$dispatch("-965845070", new Object[]{this});
    }

    @NotNull
    public final String getPlatform() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-742249135")) {
            return this.platform;
        }
        return (String) ipChange.ipc$dispatch("-742249135", new Object[]{this});
    }

    @Nullable
    public final String getTpp_page() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1558355416")) {
            return this.tpp_page;
        }
        return (String) ipChange.ipc$dispatch("1558355416", new Object[]{this});
    }
    ...
    public String markRequestLabel() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1082771424")) {
            return "tpp";
        }
        return (String) ipChange.ipc$dispatch("1082771424", new Object[]{this});
    }
