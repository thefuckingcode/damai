...
public final class RegionPicMo implements Serializable {
    ...
    public final String getCityCode() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "-1008669573")) {
            return this.cityCode;
        }
        return (String) ipChange.ipc$dispatch("-1008669573", new Object[]{this});
    }

    public final long getId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "16951990")) {
            return this.id;
        }
        return ((Long) ipChange.ipc$dispatch("16951990", new Object[]{this})).longValue();
    }

    public final long getParentId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-620644820")) {
            return this.parentId;
        }
        return ((Long) ipChange.ipc$dispatch("-620644820", new Object[]{this})).longValue();
    }

    @Nullable
    public final String getPinYin() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "546635660")) {
            return this.pinYin;
        }
        return (String) ipChange.ipc$dispatch("546635660", new Object[]{this});
    }

    @Nullable
    public final String getRegionName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-678448478")) {
            return this.regionName;
        }
        return (String) ipChange.ipc$dispatch("-678448478", new Object[]{this});
    }
