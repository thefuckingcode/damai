...
public final class PrefetchPageMo implements Serializable {
    ...
    public final long getExpireTime() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1449832697")) {
            return this.expireTime;
        }
        return ((Long) ipChange.ipc$dispatch("1449832697", new Object[]{this})).longValue();
    }

    @Nullable
    public final String getPageId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1308204217")) {
            return this.pageId;
        }
        return (String) ipChange.ipc$dispatch("1308204217", new Object[]{this});
    }

    @Nullable
    public final ArrayList<PrefetchRequestBuilder<?>> getRequestList() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "537481286")) {
            return this.requestList;
        }
        return (ArrayList) ipChange.ipc$dispatch("537481286", new Object[]{this});
    }
