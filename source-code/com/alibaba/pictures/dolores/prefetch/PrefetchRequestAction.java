...
public interface PrefetchRequestAction extends PrefetchRequestBuilder<Object> {
    ...
    @Nullable
    Function2<Bundle, PrefetchPageMo, ur2> getRequestAction();

    void setRequestAction(@Nullable Function2<? super Bundle, ? super PrefetchPageMo, ur2> function2);
}
