...
public final class AgooMessage implements Serializable {
    ...
    public final String getBigPicUrl() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "761297141")) {
            return this.bigPicUrl;
        }
        return (String) ipChange.ipc$dispatch("761297141", new Object[]{this});
    }

    @Nullable
    public final String getChannel() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1146599315")) {
            return this.channel;
        }
        return (String) ipChange.ipc$dispatch("1146599315", new Object[]{this});
    }

    @Nullable
    public final Object getExtObj() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1958269838")) {
            return this.extObj;
        }
        return ipChange.ipc$dispatch("1958269838", new Object[]{this});
    }

    @Nullable
    public final String getImgUrl() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "863017362")) {
            return this.imgUrl;
        }
        return (String) ipChange.ipc$dispatch("863017362", new Object[]{this});
    }

    @Nullable
    public final String getMsgBody() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-970553517")) {
            return this.msgBody;
        }
        return (String) ipChange.ipc$dispatch("-970553517", new Object[]{this});
    }

    @Nullable
    public final String getMsgId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-311695924")) {
            return this.msgId;
        }
        return (String) ipChange.ipc$dispatch("-311695924", new Object[]{this});
    }

    @Nullable
    public final String getMsgTaskId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1912996529")) {
            return this.msgTaskId;
        }
        return (String) ipChange.ipc$dispatch("1912996529", new Object[]{this});
    }

    @Nullable
    public final String getNotifyChannelId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-516516667")) {
            return this.notifyChannelId;
        }
        return (String) ipChange.ipc$dispatch("-516516667", new Object[]{this});
    }

    @Nullable
    public final String getNotifyChannelName() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1914572405")) {
            return this.notifyChannelName;
        }
        return (String) ipChange.ipc$dispatch("1914572405", new Object[]{this});
    }

    @Nullable
    public final Integer getNotifyId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "402903709")) {
            return this.notifyId;
        }
        return (Integer) ipChange.ipc$dispatch("402903709", new Object[]{this});
    }

    @Nullable
    public final Integer getNotifyImportance() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-743585052")) {
            return this.notifyImportance;
        }
        return (Integer) ipChange.ipc$dispatch("-743585052", new Object[]{this});
    }

    public final int getPendingIntentId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "863518517")) {
            return this.pendingIntentId;
        }
        return ((Integer) ipChange.ipc$dispatch("863518517", new Object[]{this})).intValue();
    }

    @Nullable
    public final Integer getSound() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-224032568")) {
            return this.sound;
        }
        return (Integer) ipChange.ipc$dispatch("-224032568", new Object[]{this});
    }

    @Nullable
    public final String getTag() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1859996886")) {
            return this.tag;
        }
        return (String) ipChange.ipc$dispatch("-1859996886", new Object[]{this});
    }

    @Nullable
    public final String getText() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-840522669")) {
            return this.text;
        }
        return (String) ipChange.ipc$dispatch("-840522669", new Object[]{this});
    }

    @Nullable
    public final String getTicker() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "504246000")) {
            return this.ticker;
        }
        return (String) ipChange.ipc$dispatch("504246000", new Object[]{this});
    }

    @Nullable
    public final String getTitle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-401298008")) {
            return this.title;
        }
        return (String) ipChange.ipc$dispatch("-401298008", new Object[]{this});
    }

    @Nullable
    public final String getUrl() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "154303615")) {
            return this.url;
        }
        return (String) ipChange.ipc$dispatch("154303615", new Object[]{this});
    }
