...
public final class PermissionModel {
    ...
    public final String getDescribe() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1529552947")) {
            return this.describe;
        }
        return (String) ipChange.ipc$dispatch("1529552947", new Object[]{this});
    }

    @Nullable
    public final Integer getIconResId() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2137493609")) {
            return this.iconResId;
        }
        return (Integer) ipChange.ipc$dispatch("-2137493609", new Object[]{this});
    }

    @NotNull
    public final String[] getPermission() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "149504344")) {
            return this.permission;
        }
        return (String[]) ipChange.ipc$dispatch("149504344", new Object[]{this});
    }

    @Nullable
    public final String getTitle() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1727067610")) {
            return this.title;
        }
        return (String) ipChange.ipc$dispatch("-1727067610", new Object[]{this});
    }
