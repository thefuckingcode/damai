...
public class JSMath {
    ...
    static void applyOrientationValuesToScope(Map<String, Object> map, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9, double d10) {
    ...
    static void applyRotationInDegreesToScope(Map<String, Object> map, double d2) {
        map.put(UploadQueueMgr.MSGTYPE_REALTIME, Double.valueOf(d2));
    }

    static void applyScaleFactorToScope(Map<String, Object> map, double d2) {
        map.put("s", Double.valueOf(d2));
    }

    static void applyScrollValuesToScope(Map<String, Object> map, double d2, double d3, double d4, double d5, double d6, double d7, PlatformManager.IDeviceResolutionTranslator iDeviceResolutionTranslator) {
    ...
    static void applySpringValueToScope(Map<String, Object> map, double d2, double d3) {
        map.put("p", Double.valueOf(d2));
        map.put("v", Double.valueOf(d3));
    }

    static void applyTimingValuesToScope(Map<String, Object> map, double d2) {
        map.put("t", Double.valueOf(d2));
    }

    static void applyXYToScope(Map<String, Object> map, double d2, double d3, PlatformManager.IDeviceResolutionTranslator iDeviceResolutionTranslator) {
        map.put(Constants.Name.X, Double.valueOf(iDeviceResolutionTranslator.nativeToWeb(d2, new Object[0])));
        map.put(Constants.Name.Y, Double.valueOf(iDeviceResolutionTranslator.nativeToWeb(d3, new Object[0])));
        map.put("internal_x", Double.valueOf(d2));
        map.put("internal_y", Double.valueOf(d3));
