...
public final class o {
    ...
    @Nullable
    public static Map<String, ag0> c(@NonNull Map<String, Object> map) {
        ag0 ag0;
        ...
        for (Map.Entry entry : ((Map) obj).entrySet()) {
            ...
            if ((key instanceof String) && (value instanceof Map)) {
                try {
                    ag0 = e((Map) value, DXTraceUtil.TYPE_EXPRESSION_STRING);
                } catch (Exception unused) {
                    ag0 = null;
                }
                if (ag0 != null) {
                    hashMap.put((String) key, ag0);
                }
            }
        }
        return hashMap;
    ...
    @Nullable
    public static ag0 e(@NonNull Map<String, Object> map, @NonNull String str) {
        ...
        try {
            ...
            f91.c("unexpected json parse error.", th);
            jSONObject = null;
        }
        if (jSONObject == null) {
            return ag0.a(null, null);
        }
        ...
        if (opt instanceof JSONObject) {
            return ag0.b(optString, (JSONObject) opt);
        }
        if (opt instanceof String) {
            return ag0.a(optString, (String) opt);
        }
        return ag0.a(optString, String.valueOf(obj));
    }
