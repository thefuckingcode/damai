...
public class RotationGestureDetector {
    ...
    private void e(MotionEvent motionEvent) {
        ...
        if (findPointerIndex != -1 && findPointerIndex2 != -1) {
            ...
            double d2 = -Math.atan2((double) (motionEvent.getY(findPointerIndex2) - motionEvent.getY(findPointerIndex)), (double) (motionEvent.getX(findPointerIndex2) - x));
