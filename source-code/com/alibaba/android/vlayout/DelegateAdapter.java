...
public class DelegateAdapter extends VirtualLayoutAdapter<RecyclerView.ViewHolder> {
    ...
    public static abstract class Adapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
        ...
        public abstract a onCreateLayoutHelper();
    }
    ...
    public long getItemId(int i) {
        ...
        return of.a((long) ((AdapterDataObserver) findAdapterByPosition.first).b, itemId);
    }

    /* JADX DEBUG: Multi-variable search result rejected for r1v4, resolved type: android.util.SparseArray<com.alibaba.android.vlayout.DelegateAdapter$Adapter> */
    ...
    public int getItemViewType(int i) {
        ...
        if (!this.mHasConsistItemType) {
            return (int) of.a((long) itemViewType, (long) ((AdapterDataObserver) findAdapterByPosition.first).b);
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        of.b((long) i, this.cantorReverse);
    ...
    public void setAdapters(@Nullable List<Adapter> list) {
        ...
        for (Adapter adapter : list) {
            ...
            a onCreateLayoutHelper = adapter.onCreateLayoutHelper();
    ...
    public class AdapterDataObserver extends RecyclerView.AdapterDataObserver {
        ...
        private boolean a() {
            ...
            a aVar = (a) linkedList.get(findAdapterPositionByIndex);
    ...
    public static Adapter<? extends RecyclerView.ViewHolder> simpleAdapter(@NonNull View view, @NonNull a aVar) {
    ...
    static class a extends Adapter<RecyclerView.ViewHolder> {
        ...
        public a(@NonNull View view, @NonNull a aVar) {
            this.a = view;
            this.b = aVar;
        }
