...
public class WebpMimeType {
    ...
    public static final MimeType WEBPD = new MimeType("WEBP", "WEBPD", true, new String[]{"WEBPD"}, (MimeType.MimeTypeChecker) new MimeType.MimeTypeChecker() {
        /* class com.alibaba.youku.webp4pexode.WebpMimeType.AnonymousClass1 */
