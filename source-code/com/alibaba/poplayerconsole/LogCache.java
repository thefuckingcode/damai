...
public class LogCache {
    ...
    public static String d(WVCallMethodContext wVCallMethodContext, String str) {
        if (TextUtils.isEmpty(str)) {
            return String.format("%s.WVPlugin{%s}.method{%s}.call.params{%s}", "WindVane", wVCallMethodContext.objectName, wVCallMethodContext.methodName, wVCallMethodContext.params);
        }
        return String.format("%s.WVPlugin{%s}.method{%s}.callback.params{%s}.result{%s}", "WindVane", wVCallMethodContext.objectName, wVCallMethodContext.methodName, wVCallMethodContext.params, str);
    }
