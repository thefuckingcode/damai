...
public abstract class StandOutWindow extends Service {
    ...
    public class c implements Animation.AnimationListener {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r4v4, resolved type: tb.pz2 */
    ...
    public static Intent q(Context context, Class<? extends StandOutWindow> cls, int i2) {
        ...
        if (d2) {
            uri = Uri.parse("standout://" + cls + v00.DIR + i2);
        } else {
            uri = null;
        }
    ...
    public boolean A(int i2, Window window, View view, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            an2 an22 = window.touchInfo;
            int rawY = ((int) motionEvent.getRawY()) - an22.d;
            ...
            if (i3 >= layoutParams.minWidth && i3 <= layoutParams.maxWidth) {
                an22.c = (int) motionEvent.getRawX();
            }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v4, resolved type: tb.pz2 */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v2, resolved type: tb.pz2 */
    /* JADX DEBUG: Multi-variable search result rejected for r5v4, resolved type: tb.pz2 */
    /* JADX WARN: Multi-variable type inference failed */
    public final synchronized void c(int i2) {
        Window r = r(i2);
        if (r == null) {
            throw new IllegalArgumentException("Tried to close(" + i2 + ") a null window.");
        } else if (r.visibility != 2) {
            if (u(i2, r)) {
    ...
    public final synchronized boolean g(int i2) {
        ...
        } else if (gu2.a(r.flags, vd2.FLAG_WINDOW_FOCUSABLE_DISABLE)) {
            return false;
        } else {
            Window window = i;
            if (window != null) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: tb.pz2 */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public final synchronized void s(int i2) {
        ...
        if (r == null) {
            ...
            if (gu2.a(r.flags, vd2.FLAG_WINDOW_HIDE_ENABLE)) {
                r.visibility = 2;
                Notification m = m(i2);
    ...
    public boolean z(int i2, Window window, View view, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (motionEvent.getPointerCount() == 1) {
                ...
                if (z && gu2.a(window.flags, vd2.FLAG_WINDOW_BRING_TO_FRONT_ON_TAP)) {
                    b(i2);
                }
            } else if (gu2.a(window.flags, vd2.FLAG_WINDOW_BRING_TO_FRONT_ON_TOUCH)) {
                b(i2);
            }
        } else if (action == 2) {
            int rawX = ((int) motionEvent.getRawX()) - window.touchInfo.c;
            an2 an23 = window.touchInfo;
            int rawY = ((int) motionEvent.getRawY()) - an23.d;
            an23.c = (int) motionEvent.getRawX();
            window.touchInfo.d = (int) motionEvent.getRawY();
            if (window.touchInfo.j || Math.abs(i3) >= layoutParams.threshold || Math.abs(i4) >= layoutParams.threshold) {
                window.touchInfo.j = true;
                if (gu2.a(window.flags, vd2.FLAG_BODY_MOVE_ENABLE)) {
                    if (motionEvent.getPointerCount() == 1) {
    ...
    public class StandOutLayoutParams extends WindowManager.LayoutParams {
        ...
        public StandOutLayoutParams(int i) {
            ...
            setFocusFlag(false);
            if (!gu2.a(i2, vd2.FLAG_WINDOW_EDGE_LIMITS_ENABLE)) {
