...
public class RetrofitInvokeHandler implements InvocationHandler {
    ...
    public RetrofitInvokeHandler(AbsRPCInvoker absRPCInvoker2) {
        this.absRPCInvoker = absRPCInvoker2;
    }
    ...
    public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
        ...
        AbsRPCInvoker absRPCInvoker2 = this.absRPCInvoker;
        if (absRPCInvoker2 != null) {
            absRPCInvoker2.enqueue(analyzeRequest, retrofitHttpCallback);
        }
        return null;
    }
}
