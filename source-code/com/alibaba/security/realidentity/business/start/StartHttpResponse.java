...
public class StartHttpResponse extends AbsHttpResponse {
    ...
    public static class ResultBean implements Serializable {
        ...
        public void setUploadToken(UploadToken uploadToken2) {
            this.uploadToken = uploadToken2;
        }
    ...
    public boolean isLimited() {
        return TextUtils.equals(this.retCode, a.d);
    }

    public boolean isNeedLogin() {
        return TextUtils.equals(this.retCode, a.e);
    }
    ...
    public boolean isRepeatedSubmitted() {
        ...
        if (this.result == null || (extraInfoBean = getExtraInfoBean()) == null || (rpStatusResult = extraInfoBean.getRpStatusResult()) == null || (rpAuditStatus = rpStatusResult.getRpAuditStatus()) == null || rpAuditStatus.getCode() != 1) {
            return false;
        }
        return true;
    }
    ...
    public boolean isSuccessful() {
        ...
        if (!isRepeatedSubmitted() && (resultBean = this.result) != null && resultBean.steps != null && !this.result.steps.isEmpty()) {
            return true;
        }
        return false;
    }
