...
public class b extends a<DynamicResponse> {
    ...
    public static final String[] g = {a.U, a.V, a.W, a.X, a.T};
    ...
    private void c(DynamicResponse dynamicResponse) {
        ...
        if (bc == null || TextUtils.isEmpty(bc.getBcContent())) {
            ...
            if (rpsdkCollectLocalImage == null || "1".equals(rpsdkCollectLocalImage)) {
                z = true;
            }
            GetCacheDataManager.getInstance().setNeedCollectLocalImage(z);
        }
    }
    ...
    public /* bridge */ /* synthetic */ void onPostExecute(DynamicResponse dynamicResponse) {
    ...
    private Object a(DynamicHttpRequest dynamicHttpRequest) {
        ...
        try {
            i.a.a.e().dynamic(new BusinessHttpWrapper(DynamicHttpResponse.class, new BusinessRequest(DynamicHttpRequest.class, dynamicHttpRequest)), new RetrofitHttpCallback() {
                /* class com.alibaba.security.realidentity.business.dynamic.b.AnonymousClass1 */
    ...
    private static void a(DynamicResponse dynamicResponse) {
        String h5_domain;
        if (dynamicResponse != null && (h5_domain = dynamicResponse.getH5_DOMAIN()) != null) {
            g.a.a.f = h5_domain;
