...
public final class d extends b {
    ...
    public final void a(c cVar, final b.a aVar) {
        ...
        for (e eVar : arrayList) {
            ...
            eVar.g = new a.AbstractC0106a() {
                /* class com.alibaba.security.realidentity.business.upload.d.AnonymousClass1 */

                @Override // com.alibaba.security.realidentity.business.upload.a.AbstractC0106a
                public final void a() {
                    d.this.a(TrackLog.createBioMonitorUploadFinishLog(new CommonTrackResult(), true, System.currentTimeMillis() - currentTimeMillis));
                    d.this.e.setUploadTaskList(arrayList);
