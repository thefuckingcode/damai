...
public class f extends b {
    ...
    private final ThreadPoolExecutor m = new ThreadPoolExecutor(1, 1, 10, TimeUnit.SECONDS, new LinkedBlockingQueue(), new ThreadFactory() {
        /* class com.alibaba.security.realidentity.a.f.AnonymousClass1 */
    ...
    private final Runnable o = new Runnable() {
        /* class com.alibaba.security.realidentity.a.f.AnonymousClass2 */
    ...
    public final void b() {
        ...
        if (stringBuffer.length() != 0) {
            ...
            this.m.execute(new Runnable() {
                /* class com.alibaba.security.realidentity.a.f.AnonymousClass3 */
    ...
    public final void a(int i2, String str, String str2, Map<String, Object> map) {
        ...
        if (stringBuffer.length() > 1024) {
            ...
            this.f.postDelayed(this.o, 10000);
        }
    }
