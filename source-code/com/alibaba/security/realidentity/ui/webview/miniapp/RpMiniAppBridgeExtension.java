            ...
            if (!(page == null || page.getApp() == null)) {
                if (page.getApp().getAppContext() != null) {
                    ...
                    if (context == null) {
                        ...
                        RPVerify.start(context, str, null, a.C0103a.c, new RPEventListener() {
                            /* class com.alibaba.security.realidentity.ui.webview.miniapp.RpMiniAppBridgeExtension.AnonymousClass1 */
