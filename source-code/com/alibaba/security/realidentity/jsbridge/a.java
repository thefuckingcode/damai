...
public abstract class a {
    ...
    public h an;
    public Context ao;
    protected HandlerC0108a ar = new HandlerC0108a(this);
    private String as;
    private long at;
    ...
    static {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(1, 2, 10, TimeUnit.SECONDS, new LinkedBlockingQueue(), new ThreadFactory() {
            /* class com.alibaba.security.realidentity.jsbridge.a.AnonymousClass1 */
    ...
    public static void a(String str, Exception exc) {
        g.a.a.a(TrackLog.createSdkExceptionLog(str, b.a(exc), ""));
    }

    protected static WVResult a(h hVar) {
