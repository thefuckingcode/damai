...
public abstract class a {
    ...
    public final void a(Context context) {
        ...
        try {
            ...
            initializer.registerInitFinishListener(new IInitializeComponent.IInitFinishListener() {
                /* class com.alibaba.security.realidentity.d.a.AnonymousClass1 */
    ...
    public final void b() {
        try {
            SecurityGuardManager instance = SecurityGuardManager.getInstance(this.c, null);
            if (instance != null) {
                ((ISecurityBodyComponent) instance.getInterface(ISecurityBodyComponent.class)).leaveRiskScene(2);
            }
        } catch (Throwable th) {
    ...
    public final Pair<Boolean, String> a() {
        try {
            ...
            return new Pair<>(bool2, "SecurityGuard enter risk scene exception, error code is: " + b.a(th));
        }
    }
    ...
    private void a(String str, Throwable th) {
        TrackLog createSdkExceptionLog = TrackLog.createSdkExceptionLog(str, b.a(th), "");
        createSdkExceptionLog.setCode(-1);
        com.alibaba.security.realidentity.e.a aVar = this.f;
        if (aVar != null) {
            aVar.b(createSdkExceptionLog);
