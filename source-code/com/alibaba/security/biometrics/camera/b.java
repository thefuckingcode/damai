...
public final class b extends a {
    ...
    @Override // com.alibaba.security.biometrics.camera.c, com.alibaba.security.biometrics.camera.a
                ...
                try {
                    ...
                    try {
                        ...
                        if (rotation != 0) {
                            ...
                            this.i = i5;
                            this.p.setDisplayOrientation(i5);
                        ...
                        this.i = i52;
                        this.p.setDisplayOrientation(i52);
                        List<String> supportedFocusModes2 = this.w.getSupportedFocusModes();
                        this.w.setFocusMode("continuous-video");
                        this.s = (Camera.CameraInfo) a.first;
                        this.p.setParameters(this.w);
                        this.j = this.s.orientation;
    ...
    public final void a(SurfaceTexture surfaceTexture) {
        if (this.p != null && !this.k) {
            try {
                ...
                this.p.setPreviewCallback(new Camera.PreviewCallback() {
                    /* class com.alibaba.security.biometrics.camera.b.AnonymousClass1 */
    ...
    @Override // com.alibaba.security.biometrics.camera.c
    public final void a(com.alibaba.security.common.e.b bVar, boolean z2) {
        if (this.o) {
            this.o = false;
            VideoRecorderService videoRecorderService = this.n;
            if (videoRecorderService != null) {
                videoRecorderService.release(bVar, z2);
            }
            this.n = null;
        } else if (bVar != null) {
