...
public class ALBiometricsActivity extends BaseBioNavigatorActivity {
    ...
    public void onConfigurationChanged(@NonNull Configuration configuration) {
        ...
        a.a(a, "width:" + d.a(this, (float) configuration.screenWidthDp) + "\nheight:" + d.a(this, (float) configuration.screenHeightDp));
    ...
    @Override // com.alibaba.security.biometrics.activity.BaseBioNavigatorActivity, com.alibaba.security.biometrics.activity.BaseAlBioActivity
    public void onCreate(Bundle bundle) {
        ...
        if (aLBiometricsEventListener == null) {
            String str2 = ALBiometricsRuntime.mALBiometricsEventListener != null ? "ALBiometricsRuntime.mALBiometricsEventListener.get() is null " : "ALBiometricsRuntime.mALBiometricsEventListener is null";
            if (a(bundle)) {
                str = "The process to restart";
            }
            a(str2, str);
    ...
    private static boolean a(Bundle bundle) {
        ...
        if (bundle == null || bundle.getInt(b, 0) == myPid) {
            return false;
        }
        return true;
    }
