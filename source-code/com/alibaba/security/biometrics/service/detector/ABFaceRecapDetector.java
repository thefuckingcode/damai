...
public class ABFaceRecapDetector {
    ...
    private boolean generatingResult;
    ...
    protected StringBuilder mRecapLogString;
    ...
    private ABFaceRecapDetector() {
        this.detectTotalTime = 0;
        this.detecting = false;
        this.generatingResult = false;
        this.lastDetectTime = 0;
        this.mRecapLogString = new StringBuilder(1024);
        this.frameCount = 0;
        this.detectTotalTime = 0;
    }
    ...
    private void initRecap(Context context) {
        ...
        faceRecapNetImpl.prepare(context, new OnLocalRecapPreparedListener() {
            /* class com.alibaba.security.biometrics.service.detector.ABFaceRecapDetector.AnonymousClass1 */
    ...
    public int doDetect(final byte[] bArr, final int i, final int i2, final int i3, float[] fArr, float[] fArr2) {
        ...
        newRecapHandler();
        this.mRecapHandler.post(new Runnable() {
            /* class com.alibaba.security.biometrics.service.detector.ABFaceRecapDetector.AnonymousClass2 */
    ...
    public void getRecapResult(final OnEventListener onEventListener) {
        ...
        if (ALBiometricsJni.isLoaded() && ALBiometricsJni.IsEnabled() && this.frameCount > 0 && (handler = this.mRecapHandler) != null) {
            ...
            handler.post(new Runnable() {
                /* class com.alibaba.security.biometrics.service.detector.ABFaceRecapDetector.AnonymousClass3 */
                ...
                public void run() {
                    ...
                    if (onEventListener != null) {
                        onEventListener.onResult(0, new float[]{recapResult}, ABFaceRecapDetector.this.mRecapLogString.toString());
                    }
                }
            });
    ...
    public void release() {
        ...
        if (!(this.mFaceRecapNet == null || (handler = this.mRecapHandler) == null)) {
            handler.post(new Runnable() {
                /* class com.alibaba.security.biometrics.service.detector.ABFaceRecapDetector.AnonymousClass4 */
