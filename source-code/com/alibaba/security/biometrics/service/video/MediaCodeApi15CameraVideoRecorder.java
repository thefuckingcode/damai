...
public class MediaCodeApi15CameraVideoRecorder extends BaseCameraVideoRecorder {
    ...
    private boolean initMediaCodec(int i, int i2, int i3, int i4, String str) {
        try {
            ...
            AnonymousClass1 r8 = new Thread("video_record_thread") {
                /* class com.alibaba.security.biometrics.service.video.MediaCodeApi15CameraVideoRecorder.AnonymousClass1 */
    ...
    private void encodeVideoData(byte[] bArr) {
