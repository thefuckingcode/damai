...
public class ABLogRecorder implements ABLogRecorderKeys {
    ...
    private ABLogRecorder() {
        HandlerThread handlerThread2 = new HandlerThread("ab_log_recorder");
    ...
    public static void releaseI() {
        ...
        try {
            ...
            if (!(aBLogRecorder == null || (handlerThread2 = aBLogRecorder.handlerThread) == null)) {
    ...
    public void copyData(String str, Bundle bundle) {
    ...
    public void recordStartDetect(ALBiometricsParams aLBiometricsParams) {
        ...
        bundle.putFloat("act_th", aLBiometricsParams.activeActionThreshold);
        bundle.putFloat("act_wr_th", aLBiometricsParams.inactiveActionThreshold);
        bundle.putFloat("no_face_th", (float) aLBiometricsParams.noFaceThreshold);
        bundle.putFloat("qua_th", (float) aLBiometricsParams.minQuality);
    ...
    /* access modifiers changed from: protected */
    public void timeStat(String str, Bundle bundle) {
        try {
            if ("10003".equals(str)) {
        ...
        if (this.mOnLogRecordListener != null) {
            try {
                ...
                this.handler.post(new Runnable() {
                    /* class com.alibaba.security.biometrics.service.common.ABLogRecorder.AnonymousClass1 */
