...
public class MineInfo implements Serializable {
    ...
    public String toString() {
        ...
        return "Mine [minetype=" + this.mt + "(0:ACTIONBLEND,1:NOTVIDEO,2:TIMEOUT,3:NOTLIVE,4:BADCOLOR,5:BAD3D,-1:UNKNOWN), time=" + simpleDateFormat.format(new Date(this.t)) + jl1.ARRAY_END_STR;
    }
}
