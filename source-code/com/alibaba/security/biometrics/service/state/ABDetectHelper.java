...
public class ABDetectHelper {
    ...
    private ABListenerOperator mListenerOperator = new ABListenerOperator(this.mABService);
    private ABShakeListener mShakeListener = new ABShakeListener(this.mContext);
    ...
    public void doDetectContinue(byte[] bArr, int i, int i2, int i3) {
        ...
        byte[] byteArray;
        try {
            ABDetectContext instance = ABDetectContext.getInstance();
            if (this.mDetector != null && instance != null && instance.isNeedContinueImage()) {
                int qualityImageCount = instance.getQualityImageCount();
                ALBiometricsParams aLBiometricsParams = this.mABParams;
                int i6 = aLBiometricsParams.imageCount;
                if (qualityImageCount < i6) {
                    if (i6 <= 3) {
                        int i7 = i6 - 1;
                        int i8 = aLBiometricsParams.imageIntervals;
                        long qualityImageTime = instance.getQualityImageTime();
                        long j = (long) i8;
                        long currentTimeMillis = System.currentTimeMillis();
                        int i9 = 0;
                        if (currentTimeMillis > ((long) (i7 * i8)) + qualityImageTime + j) {
                            instance.setNeedContinueImage(false);
                            return;
                        }
                        while (i9 < i7) {
                            int i10 = i9 + 1;
                            long j2 = ((long) (i10 * i8)) + qualityImageTime;
                            long j3 = j2 + j;
                            if (currentTimeMillis <= j2 || currentTimeMillis >= j3 || instance.getQualityImageCount() >= i9 + 2) {
                                i5 = i8;
                            } else {
                                i5 = i8;
                                ...
                                if (!(doDetectContinue == null || (byteArray = doDetectContinue.getByteArray("img")) == null)) {
                                    ...
                                    if (saveDataToImageResult(byteArray, "continue".concat(String.valueOf(i9)), aBImageResult)) {
                                        instance.setQualityImageCount(instance.getQualityImageCount() + 1);
                                        if (instance.getResult() != null) {
                                            instance.getResult().getContinueImages().add(aBImageResult);
                                        }
    ...
    public boolean isDistanceOK(ABFaceFrame aBFaceFrame) {
        ...
        try {
            ...
            if (((float) (Rect.width(aBFaceFrame.getFaceSize()) * 2)) < this.mABParams.reflectDistanceThreshold * ((float) min)) {
                return false;
            }
            return true;
    ...
    public boolean saveQualityImage(ABDetector aBDetector) {
        ...
        try {
            ...
            if (this.mABParams.lessImageMode) {
                bArr = aBDetector.getQualityImage();
                ABDetectContext.getInstance().getResult().getQi().setLandmarks(aBDetector.getQualityImageLandmarks());
            } else {
                bArr = aBDetector.getOriginImage();
                ABDetectContext.getInstance().getResult().getQi().setLandmarks(aBDetector.getOriginImageLandmarks());
            }
            if (bArr == null) {
                return false;
            }
            saveQualityImageData(ABDetectContext.getInstance().getResult(), bArr);
            if (this.mABParams.needOriginalImage && (originImage = aBDetector.getOriginImage()) != null) {
                saveOriginImageData(ABDetectContext.getInstance().getResult(), originImage);
            }
