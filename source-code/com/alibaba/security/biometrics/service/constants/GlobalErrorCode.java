...
public final class GlobalErrorCode {
    ...
    public static String mappingResultCode(int i) {
        ...
        switch (i) {
            case ERROR_BUSINESS_RETRY_REACH_THRESHOLD /*{ENCODED_INT: -10407}*/:
            case ERROR_USER_RETRY_LIMITED /*{ENCODED_INT: -10405}*/:
                return "-50";
            case ERROR_DETECT_INTERRUPT /*{ENCODED_INT: -10406}*/:
            case ERROR_REPEAT_VERIFY /*{ENCODED_INT: -10404}*/:
            case ERROR_SG /*{ENCODED_INT: -10403}*/:
            case ERROR_URL_EMPTY /*{ENCODED_INT: -10402}*/:
            case ERROR_TOKEN_EMPTY /*{ENCODED_INT: -10401}*/:
            case ERROR_INIT /*{ENCODED_INT: -10400}*/:
                return "-40";
            default:
                switch (i) {
                    case ERROR_VERIFY_BIO_DATA /*{ENCODED_INT: -10302}*/:
                    case ERROR_UPLOAD_BIO_PIC_ERROR /*{ENCODED_INT: -10301}*/:
                    case ERROR_ONLINE_NET_ERROR /*{ENCODED_INT: -10300}*/:
                        return "-30";
                    default:
                        switch (i) {
                            case ERROR_BIO_TIMEOUT /*{ENCODED_INT: -10217}*/:
                            case ERROR_ALGO_RECAP_INIT_FAIL /*{ENCODED_INT: -10216}*/:
                            case ERROR_TOUCH_TOO_MUCH_MINE_OCCLUSION /*{ENCODED_INT: -10215}*/:
                            case ERROR_TOUCH_TOO_MUCH_MINE_FACE /*{ENCODED_INT: -10214}*/:
                            case ERROR_TOUCH_TOO_MUCH_MINE_ACTION /*{ENCODED_INT: -10213}*/:
                            case ERROR_DETECT_NOT_ENOUNGH_IMAGE /*{ENCODED_INT: -10212}*/:
                                return "-20";
                            default:
                                switch (i) {
                                    case ERROR_ALGO_REFLECT_NO_FACE /*{ENCODED_INT: -10210}*/:
                                    case ERROR_ALGO_RECAP_FAIL /*{ENCODED_INT: -10209}*/:
                                    case ERROR_ALGO_ONLINE_RECOGNIZE_ERROR /*{ENCODED_INT: -10208}*/:
                                    case ERROR_ALGO_MODEL_COPY_FAIL /*{ENCODED_INT: -10207}*/:
                                    case ERROR_ALGO_MUCH_MINE /*{ENCODED_INT: -10206}*/:
                                    case ERROR_ALGO_TIMEOUT_ADJUST /*{ENCODED_INT: -10205}*/:
                                    case ERROR_ALGO_TIMEOUT_ACTION /*{ENCODED_INT: -10204}*/:
                                    case ERROR_ALGO_DETECTING_FAIL /*{ENCODED_INT: -10203}*/:
                                    case ERROR_ALGO_CONFIG_FAIL /*{ENCODED_INT: -10202}*/:
                                    case ERROR_ALGO_INIT_FAIL /*{ENCODED_INT: -10201}*/:
                                    case ERROR_ALGO_SO_LOAD_FAIL /*{ENCODED_INT: -10200}*/:
                                        return "-20";
                                    default:
                                        switch (i) {
                                            case ERROR_DEVICE_HW_MAGIC_WINDOW /*{ENCODED_INT: -10107}*/:
                                            case ERROR_DEVICE_CAMERA_DATA_FAIL /*{ENCODED_INT: -10106}*/:
                                            case ERROR_DEVICE_NOT_SUPPORT_X86 /*{ENCODED_INT: -10105}*/:
                                            case ERROR_DEVICE_CPU_NOT_SUPPORT /*{ENCODED_INT: -10104}*/:
                                            case ERROR_DEVICE_CAMERA_NO_PERMISSION /*{ENCODED_INT: -10103}*/:
                                            case ERROR_DEVICE_CAMERA_INIT /*{ENCODED_INT: -10102}*/:
                                            case ERROR_DEVICE_NO_CAMERA /*{ENCODED_INT: -10101}*/:
                                            case ERROR_DEVICE_NOT_SUPPORT_NEON /*{ENCODED_INT: -10100}*/:
                                                return "-10";
                                            default:
                                                switch (i) {
                                                    case 2:
