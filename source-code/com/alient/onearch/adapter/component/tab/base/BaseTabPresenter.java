...
public abstract class BaseTabPresenter<I extends GenericItem<ItemValue>, M extends IContract.Model<I>, V extends IContract.View> extends AbsPresenter<I, M, V> {
    @NotNull
    private List<JSONArray> childComponentBtns = new ArrayList();
    @NotNull
    private List<Node> childComponentNodes = new ArrayList();
    @NotNull
    private List<RichTitle> childComponentTitles = new ArrayList();
