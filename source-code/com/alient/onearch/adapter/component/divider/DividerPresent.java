...
public final class DividerPresent extends AbsPresenter<GenericItem<ItemValue>, DividerModel, DividerContract.View> implements DividerContract.Presenter {
    ...
    public void init(@NotNull GenericItem<ItemValue> genericItem) {
        ...
        ((DividerContract.View) getView()).renderDividerColor(((DividerModel) getModel()).getDividerColor());
        ((DividerContract.View) getView()).renderDividerHeight(((DividerModel) getModel()).getDividerHeight());
    }
}
