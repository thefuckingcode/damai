...
public final class GenericBannerView extends BaseBannerView implements GenericBannerContract.View {
    ...
    public GenericBannerView(@NotNull View view) {
        ...
        k21.h(findViewById, "view.findViewById(R.id.banner_container)");
