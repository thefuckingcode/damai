...
public class GenericFooterPresent extends AbsPresenter<GenericItem<ItemValue>, GenericFooterModel, GenericFooterView> implements GenericFooterContract.Presenter {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0007\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0007\u0010\bR\u0016\u0010\u0003\u001a\u00020\u00028\u0006@\u0006XT¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0016\u0010\u0005\u001a\u00020\u00028\u0006@\u0006XT¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004R\u0016\u0010\u0006\u001a\u00020\u00028\u0006@\u0006XT¢\u0006\u0006\n\u0004\b\u0006\u0010\u0004¨\u0006\t"}, d2 = {"Lcom/alient/onearch/adapter/component/footer/v2/GenericFooterPresent$Companion;", "", "", "KEY_COLLAPSE_CONTENT", "Ljava/lang/String;", "KEY_EXPEND_CONTENT", "KEY_EXPEND_STATE", "<init>", "()V", "onearch-adapter_release"}, k = 1, mv = {1, 4, 2})
    /* compiled from: Taobao */
    ...
    public void init(@NotNull GenericItem<ItemValue> genericItem) {
        ...
        if (!(rawJson == null || (string = rawJson.getString("type")) == null)) {
            for (T t : genericItem.getComponent().getModule().getComponents()) {
                if (k21.d(String.valueOf(t.getType()), string)) {
                    this.targetComponent = t;
                    ComponentValue property = t.getProperty();
