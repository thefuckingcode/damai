...
public class GenericFooterModel extends AbsModel<GenericItem<ItemValue>, Object> implements GenericFooterContract.Model {
    ...
    public void parseModelImpl(GenericItem<ItemValue> genericItem) {
        ...
        if (data != null) {
            ...
            if (jSONObject != null) {
                ...
                this.result = jSONObject.getJSONArray(str);
            }
        }
    }
    ...
    public void parseTrackInfo(GenericItem<ItemValue> genericItem) {
        ...
        if (data != null) {
            ...
            if (jSONObject2 != null) {
                try {
                    setActions((Map) bh0.INSTANCE.b(jSONObject2.toJSONString(), new TypeReference<HashMap<String, Action>>() {
                        /* class com.alient.onearch.adapter.component.footer.GenericFooterModel.AnonymousClass1 */
                    }));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            JSONObject a = (property.getData() == null || (jSONObject = property.getData().getJSONObject("globalConfig")) == null || TextUtils.isEmpty(jSONObject.getString("pabBucket"))) ? null : bh0.INSTANCE.a(jSONObject.getString("pabBucket"));
            if (property2.getData() != null && !TextUtils.isEmpty(property2.getData().getString("abBucket"))) {
                jSONObject3 = bh0.INSTANCE.a(property2.getData().getString("abBucket"));
            }
            if (getActions() != null) {
