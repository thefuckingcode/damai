...
public class ClassicsFooter extends InternalClassics<ClassicsFooter> implements RefreshFooter {
    ...
    public void setPrimaryColors(@ColorInt int... iArr) {
        if (this.mSpinnerStyle == gd2.FixedBehind) {
    ...
    public ClassicsFooter(Context context, AttributeSet attributeSet) {
        ...
        this.mSpinnerStyle = gd2.values[obtainStyledAttributes.getInt(R$styleable.ClassicsFooter_srlClassicsSpinnerStyle, this.mSpinnerStyle.a)];
