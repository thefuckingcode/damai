...
public class DeliveryHeader extends InternalAbstract implements RefreshHeader {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        int sin = (int) (((double) (this.mHeaderHeight / 13)) * Math.sin((double) this.mAppreciation));
        ...
        if (refreshState == refreshState2 || refreshState == RefreshState.RefreshFinish) {
            ...
            this.mCloudDrawable.draw(canvas);
            canvas.rotate(((float) Math.sin((double) (this.mAppreciation / 2.0f))) * 5.0f, (float) (width / 2), (float) ((this.mHeaderHeight / 2) - Rect.height(this.mUmbrellaDrawable.getBounds())));
    ...
    public void setPrimaryColors(@ColorInt int... iArr) {
        if (iArr.length > 0) {
            ...
            if (iArr.length > 1) {
                ...
                if (drawable instanceof ap1) {
                    ((ap1) drawable).e(iArr[1]);
                }
            }
        }
    }
