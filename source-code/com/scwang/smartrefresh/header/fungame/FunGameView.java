...
public abstract class FunGameView<T extends FunGameView> extends FunGameBase {
    ...
    @Override // com.scwang.smartrefresh.layout.api.RefreshInternal, com.scwang.smartrefresh.layout.internal.InternalAbstract, com.scwang.smartrefresh.header.fungame.FunGameBase
    ...
    public void onStartAnimator(@NonNull RefreshLayout refreshLayout, int i, int i2) {
        ...
        animatorSet.play(ObjectAnimator.ofFloat(textView, "translationY", textView.getTranslationY(), (float) (-this.mHalfHeaderHeight))).with(ObjectAnimator.ofFloat(textView2, "translationY", textView2.getTranslationY(), (float) this.mHalfHeaderHeight)).with(ObjectAnimator.ofFloat(view, "alpha", view.getAlpha(), 0.0f));
    ...
    @Override // com.scwang.smartrefresh.layout.internal.InternalAbstract, com.scwang.smartrefresh.layout.listener.OnStateChangedListener, com.scwang.smartrefresh.header.fungame.FunGameBase
