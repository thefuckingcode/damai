...
public class UTPluginConfigMgr {
    ...
    UTPluginConfigMgr() {
        UTClientConfigMgr.d().f(new UTClientConfigMgr.IConfigChangeListener() {
            /* class com.ut.mini.module.plugin.UTPluginConfigMgr.AnonymousClass1 */
        ...
        UTClientConfigMgr.d().f(new UTClientConfigMgr.IConfigChangeListener() {
            /* class com.ut.mini.module.plugin.UTPluginConfigMgr.AnonymousClass2 */
    ...
    private synchronized void parseUTPlugin2Config(String str) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private synchronized void parseUTPluginConfig(String str) {
