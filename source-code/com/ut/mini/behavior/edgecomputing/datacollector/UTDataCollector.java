...
public class UTDataCollector {
    ...
    public static synchronized void init(Context context, AbstractDataCollectorAdapter abstractDataCollectorAdapter) {
        synchronized (UTDataCollector.class) {
            if (!_initialized && context != null) {
                if (abstractDataCollectorAdapter != null) {
                    _context = context;
                    mDataCollectorAdapter = abstractDataCollectorAdapter;
                    initTables();
                    init();
                    GlobalData.cold_start_id = yi.c().e();
    ...
    private static void initTables() {
        UTDataStoreHelper.postRunnable(new Runnable() {
            /* class com.ut.mini.behavior.edgecomputing.datacollector.UTDataCollector.AnonymousClass1 */
    ...
    private static void init() {
        ...
        UTPluginMgr.getInstance().registerPlugin(new UTPlugin() {
            /* class com.ut.mini.behavior.edgecomputing.datacollector.UTDataCollector.AnonymousClass2 */
        ...
        UTTrackerListenerMgr.getInstance().registerListener(new UTTrackerListener() {
            /* class com.ut.mini.behavior.edgecomputing.datacollector.UTDataCollector.AnonymousClass3 */
