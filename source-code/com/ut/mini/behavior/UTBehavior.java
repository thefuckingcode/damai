        ...
        synchronized (UTBehavior.class) {
            if (!bInit) {
                ...
                UTPluginMgr.getInstance().registerPlugin(new UTPlugin() {
                    /* class com.ut.mini.behavior.UTBehavior.AnonymousClass1 */
                ...
                UTPluginMgr.getInstance().registerPlugin(new UTPlugin() {
                    /* class com.ut.mini.behavior.UTBehavior.AnonymousClass2 */
                ...
                UTTrackerListenerMgr.getInstance().registerListener(new UTTrackerListener() {
                    /* class com.ut.mini.behavior.UTBehavior.AnonymousClass3 */
