...
public class AuthActivity extends Activity {
    ...
    private void a() {
        this.b.put("action_common_channel", new ActionHandler() {
            /* class com.tencent.tauth.AuthActivity.AnonymousClass1 */
        ...
        if (!(uri == null || uri.toString() == null)) {
            ...
            if (!uri.toString().equals(str)) {
                ...
                if (string == null) {
                    ...
                    if (string.equals("shareToQzone") && k.a((Context) this, "com.tencent.mobileqq") != null && k.c(this, th2.BASE_TB_VERSION) < 0) {
                        int i = a + 1;
                        a = i;
                        if (i == 2) {
                            a = 0;
