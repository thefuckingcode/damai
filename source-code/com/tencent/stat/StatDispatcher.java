...
public class StatDispatcher {
    ...
    private StatDispatcher() {
        try {
            ...
            defaultHttpClient.setKeepAliveStrategy(new DefaultConnectionKeepAliveStrategy() {
                /* class com.tencent.stat.StatDispatcher.AnonymousClass1 */

                public long getKeepAliveDuration(HttpResponse httpResponse, HttpContext httpContext) {
                    long keepAliveDuration = StatDispatcher.super.getKeepAliveDuration(httpResponse, httpContext);
    ...
    public void send(final List<String> list, final StatDispatchCallback statDispatchCallback) {
        Handler handler2;
        if (!list.isEmpty() && (handler2 = this.handler) != null) {
            handler2.post(new Runnable() {
                /* class com.tencent.stat.StatDispatcher.AnonymousClass2 */
    ...
    /* access modifiers changed from: package-private */
    public void sendHttpPost(List<String> list, StatDispatchCallback statDispatchCallback) {
        boolean z;
        ...
        statLogger.i(jl1.ARRAY_START_STR + statReportUrl + "]Send request(" + sb.toString().length() + "bytes):" + sb.toString());
