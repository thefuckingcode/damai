...
public class Env {
    ...
    public static class BasicEnv {
        ...
        public void encode(JSONObject jSONObject) throws JSONException {
            jSONObject.put("sr", com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getwidthPixels(this.display) + jl1.MUL + com.alibaba.wireless.security.aopsdk.replace.android.util.DisplayMetrics.getheightPixels(this.display));
