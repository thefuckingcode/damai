    ...
    private String getLoggerClassInfo() {
        ...
        for (StackTraceElement stackTraceElement : stackTrace) {
            if (!stackTraceElement.isNativeMethod() && !stackTraceElement.getClassName().equals(Thread.class.getName()) && !stackTraceElement.getClassName().equals(StatLogger.class.getName())) {
                return jl1.ARRAY_START_STR + Thread.currentThread().getName() + jl1.BRACKET_START_STR + Thread.currentThread().getId() + "): " + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + jl1.ARRAY_END_STR;
            }
        }
        return null;
    }
