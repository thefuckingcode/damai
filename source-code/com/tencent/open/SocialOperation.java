    ...
    public void bindQQGroup(final Activity activity, String str, String str2, final IUiListener iUiListener) {
        ...
        if (!a.a("openSDK_LOG.GameAppOperation", iUiListener)) {
            ...
            if (TextUtils.isEmpty(a)) {
                ...
                AnonymousClass3 r12 = new DefaultUiListener() {
                    ...
                    public void onComplete(Object obj) {
                        ...
                        if (obj == null) {
                            ...
                            try {
                                SocialOperation.this.a((SocialOperation) activity, (Activity) Constants.REQUEST_BIND_GROUP, (int) intent, (Intent) false);
                            } catch (Exception e) {
                ...
                HttpUtils.requestAsync(this.c, activity, "https://openmobile.qq.com/cgi-bin/qunopensdk/check_group", a2, "GET", new BaseApi.TempRequestListener(r12));
    ...
    public void joinGroup(final Activity activity, String str, final IUiListener iUiListener) {
        ...
        if (!a.a("openSDK_LOG.GameAppOperation", iUiListener)) {
            if (activity == null) {
                ...
                AnonymousClass2 r3 = new DefaultUiListener() {
                    ...
                    public void onComplete(Object obj) {
                        ...
                        if (obj == null) {
                            ...
                            try {
                                SocialOperation.this.a((SocialOperation) activity, (Activity) Constants.REQUEST_JOIN_GROUP, (int) intent, (Intent) false);
                            } catch (Exception e) {
                ...
                HttpUtils.requestAsync(this.c, activity, "https://openmobile.qq.com/cgi-bin/qunopensdk/check_group", a, "GET", new BaseApi.TempRequestListener(r3));
    ...
    public void unBindGroup(Context context, String str, final IUiListener iUiListener) {
        ...
        if (!a.a("openSDK_LOG.GameAppOperation", iUiListener)) {
            if (context == null) {
                ...
                AnonymousClass1 r2 = new DefaultUiListener() {
                ...
                a.putString("appid", appId);
                a.putString("orgid", str);
                HttpUtils.requestAsync(this.c, context, "https://openmobile.qq.com/cgi-bin/qunopensdk/unbind", a, "GET", new BaseApi.TempRequestListener(r2));
