...
public class Draft_76 extends Draft_75 {
    ...
    @Override // com.alipay.android.phone.mobilesdk.socketcraft.drafts.Draft, com.alipay.android.phone.mobilesdk.socketcraft.drafts.Draft_75
        ...
        if (this.e == null) {
            ...
            if (byteBuffer.remaining() <= this.e.remaining()) {
                ...
                if (this.e.hasRemaining()) {
                    ...
                    return list;
                } else if (Arrays.equals(this.e.array(), i)) {
