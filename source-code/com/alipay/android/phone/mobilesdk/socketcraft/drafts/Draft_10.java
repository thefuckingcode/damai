...
public class Draft_10 extends Draft {
    ...
    public ByteBuffer createBinaryFrame(Framedata framedata) {
        ...
        byte b2 = as2.MAX_POWER_OF_TWO;
        allocate.put((byte) (((byte) (isFin ? a.g : 0)) | b));
        byte[] d2 = d((long) payloadData.remaining(), i2);
        if (i2 == 1) {
            byte b3 = d2[0];
            if (!z) {
                b2 = 0;
    ...
    public Framedata translateSingleFrame(ByteBuffer byteBuffer) {
        ...
        if (remaining >= 2) {
            ...
            boolean z = (b >> 8) != 0;
            byte b2 = (byte) ((b & z7.DEL) >> 4);
            if (b2 == 0) {
                byte b3 = byteBuffer.get();
                boolean z2 = (b3 & as2.MAX_POWER_OF_TWO) != 0;
                int i2 = (byte) (b3 & z7.DEL);
