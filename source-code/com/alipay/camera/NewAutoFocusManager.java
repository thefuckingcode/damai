...
public class NewAutoFocusManager extends AntCamera.AutoFocusCallbackProxy implements CameraHandler.OnMessageHandleCallback {
    ...
    public NewAutoFocusManager(AntCamera antCamera, CameraHandler cameraHandler) {
        MPaasLogger.d(TAG, new Object[]{"AutoFocus-New:(", Long.valueOf(SystemClock.elapsedRealtime()), jl1.BRACKET_END_STR});
        this.e = antCamera;
    ...
    private void a(boolean z) {
        ...
        if (this.e != null) {
            ...
            if (MPaasLogger.isDebuggable() && (parameters = this.e.getParameters()) != null) {
                try {
                    MPaasLogger.d(TAG, new Object[]{"AutoFocus-Length:(", Float.valueOf(parameters.getFocalLength()), jl1.BRACKET_END_STR});
                    ...
                    MPaasLogger.d(TAG, new Object[]{"AutoFocus-Distance:(", Float.valueOf(fArr[0]), ",", Float.valueOf(fArr[1]), ",", Float.valueOf(fArr[2]), jl1.BRACKET_END_STR});
                } catch (Exception e2) {
                    c2 = 0;
            ...
            if (z) {
                sendMessageDelayed(CameraHandler.AUTO_FOCUS_CHECK.intValue(), 2000);
            }
        }
    }
    ...
    public void onAutoFocusProxy(boolean z, AntCamera antCamera) {
        ...
        MPaasLogger.d(TAG, new Object[]{"AutoFocus-Callback:(", Boolean.valueOf(z), jl1.BRACKET_END_STR});
        sendMessageDelayed(CameraHandler.AUTO_FOCUS_MESSAGE.intValue(), 1000);
        if (!this.g) {
    ...
    public void onHandleMessage(Message message) {
        if (message != null) {
            ...
            if (i == num.intValue()) {
                ...
                sendMessageDelayed(num.intValue(), 2000);
            }
        }
    }
