...
public class Camera2ConfigurationUtils {
    ...
    public static void setAfAeRegion(Camera2CharacteristicsCache camera2CharacteristicsCache, CaptureRequest.Builder builder, Point point, Rect rect, Rect rect2) {
        ...
        int min = (int) (((((float) Math.min(com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.width(rect2), com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(rect2))) * 0.5f) * ((float) a)) / 10.0f);
        ...
        float f = ((float) (centerY - yVar)) / ((float) yVar);
        int centerX2 = (int) (((float) rect2.centerX()) * ((((float) (centerX - xVar)) / ((float) xVar)) + 1.0f));
        int centerY2 = (int) (((float) rect2.centerY()) * (f + 1.0f));
    ...
    public static Rect setZoom(Camera2CharacteristicsCache camera2CharacteristicsCache, CaptureRequest.Builder builder, int i) {
        ...
        if (i != 0) {
            ...
            float f = (((((float) i) * 1.0f) / 100.0f) * 0.5f * (maxZoom - 1.0f)) + 1.0f;
            ...
            int width = ((int) (((float) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.width(cropRegionForNonZoom)) / f)) / 2;
            int height = ((int) (((float) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(cropRegionForNonZoom)) / f)) / 2;
