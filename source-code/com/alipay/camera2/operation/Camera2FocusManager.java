...
public class Camera2FocusManager implements CameraHandler.OnMessageHandleCallback {
        ...
        if (requestBuilder != null && captureSession != null) {
            try {
                ...
                try {
                    ...
                    if (camera2Operation != null) {
                        captureCallback = camera2Operation.getCaptureCallback();
                    }
                    captureSession.capture(build, captureCallback, this.d.getCameraHandler());
                } catch (CameraAccessException e2) {
                    MPaasLogger.e("Camera2FocusManager", new Object[]{"startAutoFocus with exception:"}, e2);
    ...
    private void c(float f2, float f3, long j2, long j3, long j4, long j5, float f4, int i2, boolean z) {
        ...
        if (this.a != null && (camera2FocusParameterConfig = this.b) != null && camera2FocusParameterConfig.secondFocusModeIsAuto()) {
            ...
            if (!this.e && !z2) {
                ...
                MPaasLogger.d("Camera2FocusManager", new Object[]{"Camera2AutoFocus changeToSecondFocusMode:", ", previewDuration:", Long.valueOf(j2), ", durationOfBlur:", Long.valueOf(j3), ", nonNeedCheckBlurDuration:", Long.valueOf(j4), ", frameCount:", Long.valueOf(j5), ", mMaxFocusDistance:", Float.valueOf(this.c), ", maxProportion:", Float.valueOf(f2), ", maxProportionFocusDistance:", Float.valueOf(f3), ", mAutoFocusEnabled:", Boolean.valueOf(this.e), ", whetherFocusAbnormal:", Boolean.valueOf(z)});
                if (this.e) {
                    WalletBury.addWalletBury("recordCamera2SecondFocusModeInfo", new Class[]{String.class}, new Object[]{"###secondFocusMode=" + String.valueOf(this.b.getSecondFocusMode()) + "###maxProportion=" + String.valueOf(f2) + "###maxProportionFocusDistance=" + String.valueOf(f3) + "###currentFocusDistance=" + String.valueOf(f4) + "###previewDuration=" + String.valueOf(j2) + "###blurDuration=" + String.valueOf(j3) + "###nonNeedCheckBlurDuration=" + String.valueOf(j4) + "###frameCount=" + String.valueOf(j5) + "###whetherFocusAbnormal=" + String.valueOf(z)});
                }
            }
        }
    }
    ...
    public void offerFocusDistanceInfo(float f2, float f3, float f4, long j2, int i2, long j3, long j4, long j5) {
        long currentTimeMillis = System.currentTimeMillis() - j2;
        boolean whetherFocusAbnormal = this.h.whetherFocusAbnormal(j4, j5, currentTimeMillis, f2, f3);
        if (!i) {
            return;
        }
        if (whetherFocusAbnormal || currentTimeMillis > ((long) j)) {
            c(f2, f3, currentTimeMillis, j4, j5, j3, f4, i2, whetherFocusAbnormal);
        }
    }
