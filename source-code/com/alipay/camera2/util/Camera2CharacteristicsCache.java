...
public class Camera2CharacteristicsCache {
    ...
    private boolean e(CameraCharacteristics cameraCharacteristics) {
        int[] iArr;
        if (cameraCharacteristics == null || (iArr = (int[]) cameraCharacteristics.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)) == null || iArr.length <= 1) {
            return false;
        }
        return true;
    }
    ...
    public Range<Integer> getFpsRange(Size size) {
        ...
        StreamConfigurationMap streamConfigurationMap = this.z;
        Range<Integer> range = null;
        if (!(streamConfigurationMap == null || (rangeArr = this.y) == null || rangeArr.length == 0)) {
            try {
                int outputMinFrameDuration = ((int) (1.0E9d / ((double) streamConfigurationMap.getOutputMinFrameDuration(this.d, size)))) + 1;
                Range<Integer>[] rangeArr2 = this.y;
                int i2 = 0;
                for (Range<Integer> range2 : rangeArr2) {
                    if (range2.getUpper().intValue() <= outputMinFrameDuration) {
    ...
    public boolean supportCamera2() {
        int i2 = this.c;
        return (i2 < 0 || this.z == null || i2 == 2) ? false : true;
    }
