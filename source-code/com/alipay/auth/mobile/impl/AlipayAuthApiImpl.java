...
public class AlipayAuthApiImpl implements IAlipayAuthAPI {
    ...
    public boolean isAlipayAppSurpportAPI() {
        ...
        try {
            ...
            } else if (alipayAuthLoginSupportVersion != 0 || (packageInfo = this.a.getPackageManager().getPackageInfo("com.eg.android.AlipayGphone", 16384)) == null || packageInfo.versionCode <= 93) {
                return false;
            } else {
                return true;
            }
