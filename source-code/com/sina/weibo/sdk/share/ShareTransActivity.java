...
public class ShareTransActivity extends BaseActivity {
    ...
    private Handler x = new Handler(Looper.getMainLooper()) {
        /* class com.sina.weibo.sdk.share.ShareTransActivity.AnonymousClass1 */
        ...
        public final void handleMessage(Message message) {
            ...
            if (message.what == 1) {
                ...
                if (obj instanceof Intent) {
                    ShareTransActivity.this.b((ShareTransActivity) ((Intent) obj));
                    return;
                }
            }
    ...
    /* access modifiers changed from: protected */
    @Override // com.sina.weibo.sdk.share.BaseActivity
    public void onCreate(Bundle bundle) {
        ...
        if (intent == null) {
            ...
            d dVar2 = new d(this, new b() {
                /* class com.sina.weibo.sdk.share.ShareTransActivity.AnonymousClass2 */

                @Override // com.sina.weibo.sdk.share.b
                public final void a(c cVar) {
                    ShareTransActivity.this.u.setVisibility(4);
                    if (cVar == null) {
                        ShareTransActivity.this.c((ShareTransActivity) "Trans result is null.");
                    } else if (cVar.z) {
                        ShareTransActivity.this.a((ShareTransActivity) cVar.A);
                    } else if (TextUtils.isEmpty(cVar.errorMessage)) {
                        ShareTransActivity.this.c((ShareTransActivity) "Trans resource fail.");
                    } else {
                        ShareTransActivity.this.c((ShareTransActivity) cVar.errorMessage);
                    }
                }
            });
            this.v = dVar2;
    ...
    private void a(WeiboMultiMessage weiboMultiMessage) {
        ...
        try {
            ...
            String f = d.f(String.valueOf((Math.random() * 10000.0d) + ((double) System.currentTimeMillis())));
            this.w = f;
    ...
    private boolean a(Intent intent) {
        ...
        if (!TextUtils.equals(this.w, intent.getStringExtra("share_back_flag"))) {
            return false;
        }
        return true;
    }
