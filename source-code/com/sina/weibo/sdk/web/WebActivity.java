...
public class WebActivity extends Activity implements a {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.an.setOnClickListener(new View.OnClickListener() {
            /* class com.sina.weibo.sdk.web.WebActivity.AnonymousClass2 */
        ...
        button.setOnClickListener(new View.OnClickListener() {
            /* class com.sina.weibo.sdk.web.WebActivity.AnonymousClass3 */
        ...
        this.ap.setWebChromeClient(new WebChromeClient() {
            /* class com.sina.weibo.sdk.web.WebActivity.AnonymousClass4 */
        ...
        if (this.ar.t()) {
            this.ar.a(new b.a() {
                /* class com.sina.weibo.sdk.web.WebActivity.AnonymousClass1 */
