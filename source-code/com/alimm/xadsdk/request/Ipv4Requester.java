...
public class Ipv4Requester {
    ...
    public static void getIpv4() {
        ...
        autoRedirect.build().asyncCall(AdSdkManager.getInstance().getConfig().getRequestConfig().getNetAdapter(), new INetCallback() {
            /* class com.alimm.xadsdk.request.Ipv4Requester.AnonymousClass2 */
    ...
    public static void getIpv4Async() {
        AdThreadPoolExecutor.post(new Runnable() {
            /* class com.alimm.xadsdk.request.Ipv4Requester.AnonymousClass1 */
