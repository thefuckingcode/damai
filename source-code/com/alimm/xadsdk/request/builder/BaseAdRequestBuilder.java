...
public abstract class BaseAdRequestBuilder implements IRequestBuilder {
    ...
    private HashMap<String, String> getCommonParams() {
        ...
        if (AdSdkManager.getInstance().getConfig().isThirdPartyApp()) {
            String str = "";
            hashMap.put(IRequestConst.ATOKEN, GlobalInfoManager.getInstance().getAToken() == null ? str : GlobalInfoManager.getInstance().getAToken());
            hashMap.put("client_id", AdSdkManager.getInstance().getConfig().getClientId() == null ? str : AdSdkManager.getInstance().getConfig().getClientId());
            if (AdSdkManager.getInstance().getConfig().getCCode() != null) {
                str = AdSdkManager.getInstance().getConfig().getCCode();
            }
    ...
    /* access modifiers changed from: protected */
    public String getNewUrlDomain(boolean z) {
    ...
    /* access modifiers changed from: protected */
    public void setRequestControlParams(AdNetwork.Builder builder, RequestInfo requestInfo) {
    ...
    /* access modifiers changed from: protected */
    public void setRequestHeader(AdNetwork.Builder builder, @NonNull RequestInfo requestInfo) {
    ...
    /* access modifiers changed from: protected */
    public void setRequestUrl(AdNetwork.Builder builder, @NonNull RequestInfo requestInfo, boolean z) {
