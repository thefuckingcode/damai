...
public class LogUtils {
    ...
    public static void d(String str, String str2) {
        Log.d(LOG_TAG, jl1.ARRAY_START_STR + str + "] " + str2);
    }

    public static void d(String str, String str2, Throwable th) {
        Log.d(LOG_TAG, jl1.ARRAY_START_STR + str + "] " + str2, th);
    }
    ...
    public static void e(String str, String str2) {
        Log.e(LOG_TAG, jl1.ARRAY_START_STR + str + "] " + str2);
    }

    public static void e(String str, String str2, Throwable th) {
        Log.e(LOG_TAG, jl1.ARRAY_START_STR + str + "] " + str2, th);
    }
    ...
    public static void i(String str, String str2) {
        Log.i(LOG_TAG, jl1.ARRAY_START_STR + str + "] " + str2);
    }

    public static void i(String str, String str2, Throwable th) {
        Log.i(LOG_TAG, jl1.ARRAY_START_STR + str + "] " + str2, th);
    }
    ...
    public static void v(String str, String str2) {
        Log.v(LOG_TAG, jl1.ARRAY_START_STR + str + "] " + str2);
    }

    public static void v(String str, String str2, Throwable th) {
        Log.v(LOG_TAG, jl1.ARRAY_START_STR + str + "] " + str2, th);
    }
    ...
    public static void w(String str, String str2) {
        Log.w(LOG_TAG, jl1.ARRAY_START_STR + str + "] " + str2);
    }

    public static void w(String str, String str2, Throwable th) {
        Log.w(LOG_TAG, jl1.ARRAY_START_STR + str + "] " + str2, th);
    }
