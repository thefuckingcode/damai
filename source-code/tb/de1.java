...
public class de1 implements View.OnClickListener {
    ...
    private View b;
    private TextView c;
    private ImageView d = ((ImageView) this.b.findViewById(R$id.iv_vip_subtitle));
    private ImageView e = ((ImageView) this.b.findViewById(R$id.iv_vip_title));
    private ImageView f = ((ImageView) this.b.findViewById(R$id.iv_vip_title_bg));

    public de1(Activity activity, View view) {
        this.a = activity;
    ...
    public void onClick(View view) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1553290298")) {
            ...
            c.e().x(yd1.x().j0(view.getTag() != null ? (String) view.getTag() : "0"));
            if (LoginManager.k().q()) {
                DMNav.from(this.a).toUri(h03.j());
            } else {
                DMNav.from(this.a).withExtras(new Bundle()).toUri(gr.f());
            }
        }
    }
}
