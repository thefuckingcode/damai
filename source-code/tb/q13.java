...
public final class q13 {
    public static final String a = v1.v("SYmFja3Vwcw");
    public static final String b = v1.v("SLmFkaXU");
    public static final String c = v1.v("JIw");
    ...
    private static String a(Context context) {
        ...
        if (i >= 31 || (context.getApplicationInfo().targetSdkVersion >= 30 && i >= 30)) {
            ...
            try {
                ...
                Method method = storageManager.getClass().getMethod(v1.v("FZ2V0Vm9sdW1lTGlzdA"), new Class[0]);
                Method method2 = cls.getMethod(v1.v("ZZ2V0UGF0aA"), new Class[0]);
                Method method3 = cls.getMethod(v1.v("AaXNSZW1vdmFibGUK"), new Class[0]);
    ...
    public static synchronized void b(Context context, String str, String str2) {
        ...
        synchronized (q13.class) {
            if (Build.VERSION.SDK_INT < 19 || (context != null && context.checkCallingOrSelfPermission(v1.v("EYW5kcm9pZC5wZXJtaXNzaW9uLldSSVRFX0VYVEVSTkFMX1NUT1JBR0U=")) == 0 && context.checkCallingOrSelfPermission(v1.v("EYW5kcm9pZC5wZXJtaXNzaW9uLlJFQURfRVhURVJOQUxfU1RPUkFHRQ==")) == 0)) {
                String a2 = a(context);
