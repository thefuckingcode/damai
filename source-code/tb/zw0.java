...
public class zw0 extends b {
    ...
    public static zw0 B() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1128425349")) {
            return (zw0) ipChange.ipc$dispatch("-1128425349", new Object[0]);
        }
        if (b == null) {
            b = new zw0();
        }
        ...
        if (AndroidInstantRuntime.support(ipChange, "-55283468")) {
            ...
            try {
                ...
                if (z) {
                    ...
                    hashMap.put(za.PRE_CONTENT_ID, str4);
    ...
    public void F(TrackInfo trackInfo, View view, String str, String str2, String str3, String str4, String str5, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-725729264")) {
            ipChange.ipc$dispatch("-725729264", new Object[]{this, trackInfo, view, str, str2, str3, str4, str5, Integer.valueOf(i)});
        } else if (trackInfo != null) {
            try {
                HashMap hashMap = new HashMap();
                hashMap.put("city", d20.d() + "市");
    ...
    public void G(TrackInfo trackInfo, View view, TextView textView, String str, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1222059032")) {
            ipChange.ipc$dispatch("1222059032", new Object[]{this, trackInfo, view, textView, str, Integer.valueOf(i), Integer.valueOf(i2)});
            return;
        }
        try {
    ...
    public void O(TrackInfo trackInfo, View view, VideoInfo videoInfo, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1105482935")) {
            ...
            hashMap.put("item_id", str);
            hashMap.put(za.PRE_CONTENT_ID, vid);
            hashMap.put(za.PRE_CONTENT_TYPE, "video");
            TrackType trackType = TrackType.expose;
            f(trackInfo, hashMap, trackType);
    ...
    public void P(String str, String str2, String str3, String str4, VideoInfo videoInfo, long j, String str5) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "424527002")) {
            ...
            HashMap<String, String> g = a03.g();
            a03.h(g, "item_id", str4);
            if (!TextUtils.isEmpty(videoInfo.getVid())) {
                a03.h(g, "videoId", videoInfo.getVid());
            } else {
                a03.h(g, "videoId", videoInfo.getVideoUrl());
            }
            a03.h(g, "videoTitle", videoInfo.getTitle());
            a03.h(g, "duration", j + "");
            a03.h(g, "spm-url", "a2o4t." + str + "." + str2 + ".playend");
            a03.h(g, "play_session_id", str5);
            c e = c.e();
    ...
    public void Q(String str, String str2, String str3, String str4, VideoInfo videoInfo, boolean z, String str5) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "673625219")) {
            ...
            a03.h(g, "videoTitle", videoInfo.getTitle());
            a03.h(g, "is_auto_play", z ? "1" : "0");
            a03.h(g, "spm-url", "a2o4t." + str + "." + str2 + ".playstart");
            a03.h(g, "play_session_id", str5);
            c e = c.e();
    ...
    public void m(TrackInfo trackInfo, String str, String str2, String str3, String str4, String str5, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1085623776")) {
            ipChange.ipc$dispatch("-1085623776", new Object[]{this, trackInfo, str, str2, str3, str4, str5, Integer.valueOf(i)});
        } else if (trackInfo != null) {
            HashMap hashMap = new HashMap();
            hashMap.put("city", d20.d() + "市");
            hashMap.put("titlelabel", str);
    ...
    public void z(TrackInfo trackInfo, String str, String str2, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-174922064")) {
            ipChange.ipc$dispatch("-174922064", new Object[]{this, trackInfo, str, str2, Integer.valueOf(i), Integer.valueOf(i2)});
            return;
        }
        try {
            HashMap<String, String> f = a03.f();
