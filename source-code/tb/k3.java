    ...
    public static Map<String, Object> a(Activity activity) {
        ...
        if (activity != null) {
            ...
            if (intent != null) {
                ...
                hashMap.put("navStartTime", Long.valueOf(intent.getLongExtra("NAV_TO_URL_START_TIME", -1)));
                hashMap.put("navStartActivityTime", Long.valueOf(intent.getLongExtra("NAV_START_ACTIVITY_TIME", -1)));
