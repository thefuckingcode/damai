...
public class ux2 implements IWXUserTrackAdapter {
    private static boolean a = false;
    private static String b = "false";
    private static boolean c;

    public ux2() {
        String string = a.l().b().getString(R$string.weex_performance_log_switch);
        b = string;
    ...
    private void a() {
        if (!a) {
            ...
            WXPerformance.Measure[] values = WXPerformance.Measure.values();
            for (WXPerformance.Measure measure : values) {
    ...
    public void commit(Context context, String str, String str2, WXPerformance wXPerformance, Map<String, Serializable> map) {
        try {
            ...
            if ("load".equals(str2) && wXPerformance != null) {
                ...
                wXPerformance.pageName = tx2.c(wXPerformance.pageName);
            ...
            } else if (IWXUserTrackAdapter.INVOKE_MODULE.equals(str2) || IWXUserTrackAdapter.INIT_FRAMEWORK.equals(str2)) {
                AppMonitor.Alarm.commitFail("weex", str2, (String) map.get("arg"), (String) map.get("errCode"), (String) map.get("errMsg"));
            } else if (IWXUserTrackAdapter.COUNTER.equals(str2) && str != null) {
