...
public class jg {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1251166917")) {
            ...
            if (i == 1) {
                ...
                while (i3 < a.size()) {
                    ...
                    if (categoryNewTitleBean2 != null && categoryNewTitleBean2.type == 2) {
                        i2 = i3;
                    }
                    i3++;
                }
                ...
                while (i3 < a.size()) {
                    ...
                    if (categoryNewTitleBean3 != null && categoryNewTitleBean3.type == 3 && categoryNewTitleBean3.categoryId != null && !TextUtils.isEmpty(str) && str.equals(categoryNewTitleBean3.categoryId)) {
                        i4 = i3;
                    }
                    i3++;
                }
    ...
    public static List<CategoryNewTitleBean> b(CategoryNewTitleListBean categoryNewTitleListBean) {
        ...
        } else if (categoryNewTitleListBean == null || s71.a(categoryNewTitleListBean.data)) {
            return null;
        } else {
            ArrayList arrayList = new ArrayList();
            if (xf2.e(categoryNewTitleListBean.data) > 0) {
    ...
    public static boolean c(CategoryPerformBean categoryPerformBean, CategoryEntity categoryEntity) {
        ...
        if (!(categoryPerformBean == null || xf2.e(categoryPerformBean.statistics) == 0 || categoryEntity == null)) {
    ...
    public static void d(View view, int i) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(view, "translationY", (float) i, (float) (-i));
