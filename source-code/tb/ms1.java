...
public class ms1 implements Comparator<Runnable> {
    private int b(@NonNull PriorityFutureTask priorityFutureTask, @NonNull PriorityFutureTask priorityFutureTask2) {
        ...
        if (!(priority == null && priority2 == null)) {
            ...
            int compareTo = priority.compareTo((Enum) priority2) * -1;
            if (compareTo != 0) {
                return compareTo;
            }
        }
    ...
    public int compare(Runnable runnable, Runnable runnable2) {
        ...
        int compareTo = goupPriority.compareTo((Enum) goupPriority2) * -1;
