...
import cn.damai.projectfiltercopy.floatview.b;
...
public class ii0<T> implements FloatListener, FilterBtnClickListener {
    ...
    public ii0(Type type, FilterModel filterModel, FloatContainer floatContainer, FilterBtn filterBtn, FloatLayer<T> floatLayer, GetTFromModel<T> getTFromModel) {
        this.a = type;
    ...
    public static ii0<CityBean> b(Context context, FloatContainer floatContainer, FilterModel filterModel) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "431922897")) {
            return (ii0) ipChange.ipc$dispatch("431922897", new Object[]{context, floatContainer, filterModel});
        }
        Type type = Type.CITY;
        return new ii0<>(type, filterModel, floatContainer, new gi0(context, type, filterModel), new CityFloatLayer(context), new CityModel(filterModel));
    }

    public static ii0<CalendarBean> c(Context context, FloatContainer floatContainer, FilterModel filterModel, CalendarInitBean calendarInitBean) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1714884150")) {
            return (ii0) ipChange.ipc$dispatch("-1714884150", new Object[]{context, floatContainer, filterModel, calendarInitBean});
        }
        Type type = Type.DATE;
        return new ii0<>(type, filterModel, floatContainer, new gi0(context, type, filterModel), new pe(context, calendarInitBean), new DateModel(filterModel));
    }

    public static ii0<CalendarBean> d(Context context, FloatContainer floatContainer, FilterModel filterModel, CalendarInitBean calendarInitBean) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-71877427")) {
            return (ii0) ipChange.ipc$dispatch("-71877427", new Object[]{context, floatContainer, filterModel, calendarInitBean});
        }
        Type type = Type.DATE_HOR_CALENDAR;
        return new ii0<>(type, filterModel, floatContainer, new fi0(context, type, filterModel), new pe(context, calendarInitBean), new DateModel(filterModel));
    }

    public static ii0<HashMap<String, List<FilterBean>>> e(Context context, FloatContainer floatContainer, FilterModel filterModel, FilterItemBean filterItemBean) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "841084599")) {
            return (ii0) ipChange.ipc$dispatch("841084599", new Object[]{context, floatContainer, filterModel, filterItemBean});
        }
        Type type = Type.FILTER;
        return new ii0<>(type, filterModel, floatContainer, new gi0(context, type, filterModel), new li0(context, filterItemBean), new FilterT(filterModel));
    }

    public static ii0<CategoryDataAssembler> f(Context context, FloatContainer floatContainer, FilterModel filterModel) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "178699386")) {
            return (ii0) ipChange.ipc$dispatch("178699386", new Object[]{context, floatContainer, filterModel});
        }
        Type type = Type.NEW_CATEGORY;
        return new ii0<>(type, filterModel, floatContainer, new gi0(context, type, filterModel), new fg(context, filterModel.mCatAssembler), new CategoryNewT(filterModel));
    }

    public static ii0<SortBean> g(Context context, FloatContainer floatContainer, FilterModel filterModel, List<SortBean> list) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1016657269")) {
            return (ii0) ipChange.ipc$dispatch("1016657269", new Object[]{context, floatContainer, filterModel, list});
        }
        Type type = Type.SORT;
        return new ii0<>(type, filterModel, floatContainer, new gi0(context, type, filterModel), new b(context, list), new SortT(filterModel));
    }
