...
public final class wt1 {
    ...
    public static boolean c(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1120011540")) {
            return xf2.n(str) >= 100000000;
        }
        return ((Boolean) ipChange.ipc$dispatch("1120011540", new Object[]{str})).booleanValue();
    }
}
