...
public class kf1 {
    ...
    public void b(String str, double d, long j) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "349737590")) {
            ...
            create2.setValue("size", (double) j);
    ...
    public void c(String str, long j) {
        ...
        b(str, (double) (System.currentTimeMillis() - this.a), j);
    }

    public boolean h() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1659942721")) {
            return this.b;
        }
        return ((Boolean) ipChange.ipc$dispatch("-1659942721", new Object[]{this})).booleanValue();
    }
