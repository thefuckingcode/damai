...
public class j92 extends cn.damai.common.user.b {
    ...
    public static final j92 g() {
        ...
        return AndroidInstantRuntime.support(ipChange, "-2002163291") ? (j92) ipChange.ipc$dispatch("-2002163291", new Object[0]) : b.a;
    }

    public a.b f() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1910556014")) {
            return b(MY_ABOUT_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("-1910556014", new Object[]{this});
    }
    ...
    public a.b i() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1723528090")) {
            return b(MESSAGE_PUSH_SETTING_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("-1723528090", new Object[]{this});
    }
    ...
    public a.b l() {
        ...
        return e("setting", "list", yd1.MY_ACCOUTMANAGE_SAFE_PAGE, hashMap, Boolean.TRUE);
    }
    ...
    public a.b t() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1773097391")) {
            return b("setting");
        }
        return (a.b) ipChange.ipc$dispatch("1773097391", new Object[]{this});
    }
