...
public class t3 implements MultiClickUt, OnMultiListClickListener {
    private static transient /* synthetic */ IpChange $ipChange;
    private Activity a;
    private MultiClickUt b;

    public t3(Activity activity, MultiClickUt multiClickUt) {
        this.a = activity;
        this.b = multiClickUt;
    }
    ...
    public void onThemeClick(ThemeBean themeBean, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-386841195")) {
            ...
            DMNav.from(this.a).toUri(NavUri.b(gr.DISCOVER_THEME));
        }
    }
