...
public final class s13 {
    ...
    public static String b() {
        ...
        try {
            ...
            return b.a(instance.generateKey().getEncoded());
    ...
    private static byte[] f(byte[] bArr) {
        try {
            if (a == null) {
                a = v1.v("YAAAAAAAAAAAAAAAAAAAAAA").getBytes();
            }
            IvParameterSpec ivParameterSpec = new IvParameterSpec(a);
            SecretKeySpec secretKeySpec = new SecretKeySpec(e(i()).getBytes("UTF-8"), v1.v("EQUVT"));
    ...
    public static String h(String str) {
        try {
            return b.a(f(str.getBytes("UTF-8")));
        } catch (Throwable unused) {
            return null;
        }
    }
