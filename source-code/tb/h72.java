...
public class h72 {
    ...
    /* compiled from: Taobao */
    public static abstract class c extends i32 {
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private static SVGPaintData c(int i2) {
        ...
        try {
            return new cn.damai.commonbusiness.seatbiz.view.svgview.core.helper.parser.b().b(xs0.a().getResources().openRawResource(i2)).a().getSvgPaintData();
        } catch (Exception e2) {
            e2.printStackTrace();
            return null;
        }
    ...
    private boolean e() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-17865946")) {
            return (m == null || n == null || o == null || p == null || q == null) ? false : true;
        }
        return ((Boolean) ipChange.ipc$dispatch("-17865946", new Object[]{this})).booleanValue();
    }

    private boolean f(byte b2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1097977954")) {
            return b2 == 16;
        }
        return ((Boolean) ipChange.ipc$dispatch("1097977954", new Object[]{this, Byte.valueOf(b2)})).booleanValue();
    }

    private boolean g(byte b2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-589980443")) {
            return b2 == 12 || b2 == 15 || b2 == 13;
        }
        return ((Boolean) ipChange.ipc$dispatch("-589980443", new Object[]{this, Byte.valueOf(b2)})).booleanValue();
    }

    private boolean h(byte b2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1619520691")) {
            return b2 == 11 || b2 == 13;
        }
        return ((Boolean) ipChange.ipc$dispatch("1619520691", new Object[]{this, Byte.valueOf(b2)})).booleanValue();
    }

    private boolean j() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2116607359")) {
            return (j == null || k == null || i == null || h == null || l == null) ? false : true;
        }
        return ((Boolean) ipChange.ipc$dispatch("2116607359", new Object[]{this})).booleanValue();
    }

    private boolean k(byte b2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "663946123")) {
            return b2 == 14 || b2 == 15;
        }
        return ((Boolean) ipChange.ipc$dispatch("663946123", new Object[]{this, Byte.valueOf(b2)})).booleanValue();
    }
    ...
    private Bitmap p(Bitmap bitmap, float f2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-2086644615")) {
            ...
            matrix.postRotate(f2, (float) (bitmap.getWidth() / 2), (float) (bitmap.getHeight() / 2));
    ...
    public Bitmap a(int i2, float f2, byte b2, boolean z) {
        ...
        long a2 = mz0.a(i2, (short) ((int) f2), b2, z);
        ...
        if (bitmap2 == null) {
            ...
            if (i3 == 3) {
                if (k(b2)) {
                    this.d.h(z);
                    bitmap = p(n(f2, g(b2), false, false, this.d), f2);
                } else {
                    this.d.g(i2, z);
                    bitmap = p(n(f2, g(b2), h(b2), f(b2), this.d), f2);
                }
            } else if (i3 == 1) {
                if (k(b2)) {
                    this.f.h(z);
                ...
                bitmap = l(i2, g(b2), h(b2), f(b2), this.f);
            } else {
                bitmap = m(i2, b2, z);
            }
            bitmap2 = bitmap;
    ...
    public Bitmap b(float f2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1056527448")) {
            return a(0, f2, (byte) 16, false);
        }
        return (Bitmap) ipChange.ipc$dispatch("-1056527448", new Object[]{this, Float.valueOf(f2)});
    }
    ...
    public boolean i() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "854871083")) {
            return this.a == 3;
        }
        return ((Boolean) ipChange.ipc$dispatch("854871083", new Object[]{this})).booleanValue();
    }
