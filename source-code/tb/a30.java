...
public class a30 {
    ...
    private static final DateFormat[] a = new SimpleDateFormat[22];
    ...
    public static Date b(String str) {
        ...
        int i = 0;
        if (trim.length() > 10) {
            if ((trim.substring(trim.length() - 5).indexOf(jl1.PLUS) == 0 || trim.substring(trim.length() - 5).indexOf("-") == 0) && trim.substring(trim.length() - 5).indexOf(":") == 2) {
            ...
            if ((substring.indexOf("-") == 0 || substring.indexOf(jl1.PLUS) == 0) && substring.indexOf(":") == 3 && !TimeZones.GMT_ID.equals(trim.substring(trim.length() - 9, trim.length() - 6))) {
