...
public class rc implements IConverter<BaseResponse, BaseSection, GlobalConfig, List<Node>> {
    ...
    public List<Node> convert(BaseResponse baseResponse, BaseSection baseSection, GlobalConfig globalConfig, qa qaVar) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "455710367")) {
            return (List) ipChange.ipc$dispatch("455710367", new Object[]{this, baseResponse, baseSection, globalConfig, qaVar});
        }
        ...
        if (item != null) {
            ...
            if (jSONArray != null && jSONArray.size() > 0) {
                arrayList.addAll(new qa().l(baseSection2, globalConfig));
                for (int i = 0; i < jSONArray.size(); i++) {
                    ...
                    if (jSONObject2 != null) {
                        ...
                        jSONObject3.put(qa.KEY_PROJECT, (Object) jSONObject2);
