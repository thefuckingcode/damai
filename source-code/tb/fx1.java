...
public class fx1 {
    ...
    public void a(int i, String str, int i2, int i3, double d2, int i4) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1086039886")) {
            ipChange.ipc$dispatch("1086039886", new Object[]{this, Integer.valueOf(i), str, Integer.valueOf(i2), Integer.valueOf(i3), Double.valueOf(d2), Integer.valueOf(i4)});
            return;
        }
        if (i == 1) {
            com.alibaba.pictures.bricks.view.DMLabelView bgColor = this.b.setLabelHeight(m42.a(this.a, 24.0f)).setPaddingLeft(m42.a(this.a, 9.0f)).setPaddingRight(m42.a(this.a, 18.0f)).setBgColor("#FF5A5A", "#FF42B0");
            bgColor.setLabelName("NO." + i).setLabelTextSize(14.0f);
        } else if (i == 2) {
            com.alibaba.pictures.bricks.view.DMLabelView bgColor2 = this.b.setLabelHeight(m42.a(this.a, 24.0f)).setPaddingLeft(m42.a(this.a, 9.0f)).setPaddingRight(m42.a(this.a, 18.0f)).setBgColor("#FF833C", "#FF4A72");
            bgColor2.setLabelName("NO." + i).setLabelTextSize(14.0f);
        } else if (i != 3) {
            com.alibaba.pictures.bricks.view.DMLabelView bgColor3 = this.b.setLabelHeight(m42.a(this.a, 24.0f)).setPaddingLeft(m42.a(this.a, 9.0f)).setPaddingRight(m42.a(this.a, 18.0f)).setBgColor("#6A7A99", "#98A7C2");
            bgColor3.setLabelName("NO." + i).setLabelTextSize(14.0f);
        } else {
            com.alibaba.pictures.bricks.view.DMLabelView bgColor4 = this.b.setLabelHeight(m42.a(this.a, 24.0f)).setPaddingLeft(m42.a(this.a, 9.0f)).setPaddingRight(m42.a(this.a, 18.0f)).setBgColor("#FFDA00", "#FFAD00");
        ...
        if (i4 == 3) {
            if (i3 == 0 || d2 == 0.0d) {
                ...
                this.f.setStarMark(((float) i3) / 2.0f);
        ...
        if (i2 > 0) {
            ...
            this.e.setPadding(0, m42.a(this.a, 6.0f), 0, 0);
        } else {
            this.e.setVisibility(8);
        }
        this.f.setVisibility(8);
