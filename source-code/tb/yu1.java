...
public class yu1 extends b {
    ...
    private static class a {
        private static final yu1 a = new yu1();
    }

    public static final yu1 f() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "2052402459") ? (yu1) ipChange.ipc$dispatch("2052402459", new Object[0]) : a.a;
    }
    ...
    public void l(View view, String str, String str2) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("user_type", str2);
        c.e().G(view, MemberGuideInfo.authorize, "center", str, hashMap);
    }
