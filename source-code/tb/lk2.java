...
public class lk2 {
    ...
    public static lk2 c() {
        ...
        return AndroidInstantRuntime.support(ipChange, "11167579") ? (lk2) ipChange.ipc$dispatch("11167579", new Object[0]) : f;
    }
    ...
    public String a() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-942056449")) {
            return e() ? c : b;
        }
        return (String) ipChange.ipc$dispatch("-942056449", new Object[]{this});
    }
    ...
    public String b(String str) {
        ...
        String str2 = null;
        if (this.a == null) {
            this.a = SecurityGuardManager.getInstance(xs0.a());
        }
    ...
    public boolean d(String str) {
        ...
        try {
            packageInfo = xs0.a().getPackageManager().getPackageInfo(str, 0);
        } catch (Exception e2) {
            e2.printStackTrace();
            packageInfo = null;
        }
    ...
    public String f() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-922718625")) {
            return b("QQ_APP_ID");
        }
        return (String) ipChange.ipc$dispatch("-922718625", new Object[]{this});
    }

    public String g() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1150390036")) {
            return b("QQ_APP_SECRET");
        }
        return (String) ipChange.ipc$dispatch("1150390036", new Object[]{this});
    }
