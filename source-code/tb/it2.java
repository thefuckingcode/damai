...
public class it2 {
    ...
    public String a = gt2.USER_HOME_PAGE;
    public Map b;
    ...
    public static void e(Context context, String str, String str2, String str3, boolean z, Map map, Map map2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "157164500")) {
            ...
            if (map != null) {
                ...
                hashMap.put(wz1.VIEW_TYPE, map.get("self") + "");
            }
            if (map2 != null) {
                hashMap.putAll(map2);
            }
            if (str == null) {
                str = gt2.USER_HOME_PAGE;
            }
            c.e().x(new b().e(str, str2, str3, hashMap, Boolean.valueOf(z)));
        }
    }
    ...
    public void d(int i, Activity activity) {
        ...
        if (i == 5) {
            this.a = wz1.REPERTOITE;
        } else if (i != 1) {
            this.a = "business_homepage";
        }
        c.e().L(activity, this.a);
    }
