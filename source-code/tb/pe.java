...
public class pe extends cn.damai.projectfiltercopy.floatview.a<CalendarBean> implements View.OnClickListener {
    ...
    public class a implements CalendarPopView.OnDateClickListener {
        ...
        public void onDateClick(int i, String str, String str2, int i2, String str3) {
            ...
            pe.this.getListener().onFloatCall(pe.this.getType(), filterData);
        }
    }

    public pe(Context context, CalendarInitBean calendarInitBean) {
        super(context);
    ...
    public Type getType() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-574076776")) {
            return Type.DATE;
        }
        return (Type) ipChange.ipc$dispatch("-574076776", new Object[]{this});
    }
