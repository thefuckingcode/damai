...
public class dn extends ym2<ContentTour.ContentTopic> {
    ...
    public int a() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "2004716392")) {
            return R$layout.live_content_detail_theme;
        }
        return ((Integer) ipChange.ipc$dispatch("2004716392", new Object[]{this})).intValue();
    }
    ...
    public void onClick(View view) {
        ...
        if (contentTopic != null) {
            c.e().x(getLiveUt().H(contentTopic.name, contentTopic.id));
            Bundle bundle = new Bundle();
            bundle.putString("themeId", contentTopic.id);
            DMNav.from(this.a).withExtras(bundle).toUri(NavUri.b(gr.DISCOVER_THEME));
        }
    }
}
