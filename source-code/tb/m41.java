...
public class m41 implements OnJpgRegionUiListener {
    ...
    public void showPriceList(List<? extends PriceLevel> list, PriceLevel priceLevel, h72 h72) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1362439765")) {
            ipChange.ipc$dispatch("1362439765", new Object[]{this, list, priceLevel, h72});
            return;
        }
        OnJpgRegionUiListener onJpgRegionUiListener = this.a;
        if (onJpgRegionUiListener != null) {
            onJpgRegionUiListener.showPriceList(list, priceLevel, h72);
        }
    }
