...
public class ji0<T> implements FloatListener, FilterBtnClickListener {
    ...
    public ji0(Type type, FilterModel filterModel, FloatContainer floatContainer, FilterBtn filterBtn, FloatLayer<T> floatLayer, GetTFromModel<T> getTFromModel) {
        this.a = type;
    ...
    public static ji0<CityBean> b(Context context, FloatContainer floatContainer, FilterModel filterModel) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-789594991")) {
            return (ji0) ipChange.ipc$dispatch("-789594991", new Object[]{context, floatContainer, filterModel});
        }
        Type type = Type.CITY;
        return new ji0<>(type, filterModel, floatContainer, new hi0(context, type, filterModel), new CityFloatLayer(context), new CityModel(filterModel));
    }

    public static ji0<CalendarBean> c(Context context, FloatContainer floatContainer, FilterModel filterModel, List<CalendarYearBean> list) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1571195835")) {
            return (ji0) ipChange.ipc$dispatch("-1571195835", new Object[]{context, floatContainer, filterModel, list});
        }
        Type type = Type.DATE;
        return new ji0<>(type, filterModel, floatContainer, new hi0(context, type, filterModel), new qe(context, list), new DateModel(filterModel));
    }

    public static ji0<HashMap<String, List<FilterBean>>> d(Context context, FloatContainer floatContainer, FilterModel filterModel, FilterItemBean filterItemBean) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "930485260")) {
            return (ji0) ipChange.ipc$dispatch("930485260", new Object[]{context, floatContainer, filterModel, filterItemBean});
        }
        Type type = Type.FILTER;
        return new ji0<>(type, filterModel, floatContainer, new hi0(context, type, filterModel), new ki0(context, filterItemBean), new FilterT(filterModel));
    }

    public static ji0<CategoryDataAssembler> e(Context context, FloatContainer floatContainer, FilterModel filterModel) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1631710012")) {
            return (ji0) ipChange.ipc$dispatch("-1631710012", new Object[]{context, floatContainer, filterModel});
        }
        Type type = Type.NEW_CATEGORY;
        return new ji0<>(type, filterModel, floatContainer, new hi0(context, type, filterModel), new gg(context, filterModel.mCatAssembler), new CategoryNewT(filterModel));
    }

    public static ji0<SortBean> f(Context context, FloatContainer floatContainer, FilterModel filterModel, List<SortBean> list) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1676534219")) {
            return (ji0) ipChange.ipc$dispatch("-1676534219", new Object[]{context, floatContainer, filterModel, list});
        }
        Type type = Type.SORT;
        return new ji0<>(type, filterModel, floatContainer, new hi0(context, type, filterModel), new wc2(context, list), new SortT(filterModel));
    }
