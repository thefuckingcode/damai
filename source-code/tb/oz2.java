...
public class oz2 {
    ...
    public static boolean b() {
        ...
        try {
            d = Double.valueOf(J.getConfig(kx2.WXAPM_CONFIG_GROUP, "new_ws_sampling", MessageService.MSG_DB_COMPLETE)).doubleValue();
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (random < d) {
    ...
    private static boolean e(WXSDKInstance wXSDKInstance) {
        ...
        String config = J.getConfig(kx2.WXAPM_CONFIG_GROUP, "ws_white_list", null);
