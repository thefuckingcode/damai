...
public class bt2 implements IUploaderStatistics {
    ...
    public void onCommit(String str, String str2, Map<String, Double> map, Map<String, String> map2) {
        try {
            if (this.a.get()) {
                ...
                cls.getMethod("commitFlow", Context.class, String.class, Boolean.TYPE, String.class, cls2, cls2).invoke(method.invoke(cls, new Object[0]), ws2.d, TLogConstant.TOKEN_TYPE_ARUP, Boolean.FALSE, TLogConstant.TOKEN_TYPE_ARUP, Long.valueOf(d.longValue()), Long.valueOf(d2.longValue()));
            }
        } catch (Throwable th) {
