...
import cn.damai.baseview.abcpullrefresh.library.a;
...
public class v2 {
    ...
    public v2 a(Activity activity, PullToRefreshLayout pullToRefreshLayout, View view, OnRefreshListener onRefreshListener) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "676182465")) {
            return (v2) ipChange.ipc$dispatch("676182465", new Object[]{this, activity, pullToRefreshLayout, view, onRefreshListener});
        }
        a.a(activity).d(view).b(onRefreshListener).c(pullToRefreshLayout);
        return this;
    }
