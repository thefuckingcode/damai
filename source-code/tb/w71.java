...
public class w71 extends za {
    ...
    private void k(Map<String, String> map) {
        ...
        za.h(za.CNT_CONTENT_TYPE, "note", map);
        za.h(za.CNT_CONTENT_ID, this.b, map);
        za.h(za.PUBLISHER_ID, this.c, map);
    }
    ...
    private void l(Map<String, String> map) {
        ...
        za.h(za.PRE_CONTENT_TYPE, "note", map);
        za.h(za.PRE_CONTENT_ID, this.b, map);
        za.h(za.PUBLISHER_ID, this.c, map);
    }
    ...
    public a.b A(int i, String str) {
        ...
        za.h(za.PUBLISHER_ID, this.c, hashMap);
        if (i == 0) {
            za.h("repertoire_id", str, hashMap);
        } else if (i == 1) {
            za.h("music_ip", str, hashMap);
        } else if (i == 2) {
    ...
    public a.b B() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1262520660")) {
            return (a.b) ipChange.ipc$dispatch("-1262520660", new Object[]{this});
        }
        return new a.b().j(C()).a(d20.d()).i("content");
    }
    ...
    public a.b I() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1827955769")) {
            return e("content", "top", "DNAshow", a03.g(), Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("1827955769", new Object[]{this});
    }
    ...
    public void M(View view) {
        ...
        try {
            ...
            hashMap.put("usercode", d20.E());
            k(hashMap);
            c.e().G(view, "favorite", "center", "content", hashMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void N(View view, String str, String str2, int i) {
        ...
        try {
            ...
            hashMap.put("usercode", d20.E());
            k(hashMap);
            za.h(za.PRE_CONTENT_TYPE, "note", hashMap);
            za.h(za.PRE_CONTENT_ID, str2, hashMap);
            c e = c.e();
    ...
    public void O(View view) {
        ...
        try {
            ...
            hashMap.put("usercode", d20.E());
            k(hashMap);
            c.e().G(view, "award_share", "center", "content", hashMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void P(View view) {
        ...
        try {
            c.e().G(view, "DNAshow", "top", "content", a03.g());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void m(View view, String str) {
        ...
        try {
            ...
            za.h("scriptId", str, hashMap);
            k(hashMap);
            c.e().G(view, "item", "scriptkill", "content", hashMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void n(View view, String str) {
        ...
        try {
            ...
            za.h("storeId", str, hashMap);
            k(hashMap);
            c.e().G(view, "item", "scriptkill_store", "content", hashMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void o(View view, String str, String str2) {
        ...
        try {
            ...
            za.f(hashMap);
            za.g(hashMap);
            za.h("titlelabel", str, hashMap);
            za.h(za.PRE_CONTENT_TYPE, "theme", hashMap);
            za.h(za.PRE_CONTENT_ID, str2, hashMap);
            k(hashMap);
            c.e().G(view, "theme", "center", "content", hashMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
