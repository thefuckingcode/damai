...
public class su0 {
    ...
    public static void a() {
        ...
        switch (LoginManager.k().l()) {
            case 100:
                str2 = LOGIN_NORMAL_FAILED_CODE;
                str = LOGIN_NORMAL_FAILED_MSG;
                break;
            case 101:
                str2 = LOGIN_ALIPAY_FAILED_CODE;
                str = LOGIN_ALIPAY_FAILED_MSG;
                break;
            case 102:
                str2 = LOGIN_TAOBAO_FAILED_CODE;
                str = LOGIN_TAOBAO_FAILED_MSG;
                break;
            case 103:
                str2 = LOGIN_WEIBO_FAILED_CODE;
                str = LOGIN_WEIBO_FAILED_MSG;
                break;
            case 104:
                str2 = LOGIN_QQ_FAILED_CODE;
                str = LOGIN_QQ_FAILED_MSG;
                break;
            case 105:
                str2 = LOGIN_WECHAT_FAILED_CODE;
                str = LOGIN_WECHAT_FAILED_MSG;
                break;
            default:
                str2 = "";
                str = str2;
        ...
        yz2.a("", str2, str + "  原因：" + HavanaProxy.v().u());
    }
}
