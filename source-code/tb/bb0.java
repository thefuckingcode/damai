...
public final class bb0 {
    ...
    @NotNull
    public static final bb0 INSTANCE = new bb0();
    ...
    @JvmStatic
    public static final <BizResponse> void c(@Nullable String str, @Nullable fb0<BizResponse> fb0, @Nullable String str2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "2002422654")) {
            ipChange.ipc$dispatch("2002422654", new Object[]{str, fb0, str2});
            return;
        }
        IMtopMonitor iMtopMonitor = a;
        if (iMtopMonitor != null) {
            iMtopMonitor.mtopRequestAndResponse(str, fb0, str2);
        }
    }
    ...
    @JvmStatic
    public static final void g(@Nullable String str, @Nullable String str2, @Nullable zl2 zl2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "169138757")) {
            ipChange.ipc$dispatch("169138757", new Object[]{str, str2, zl2});
            return;
        }
        IMtopMonitor iMtopMonitor = a;
        if (iMtopMonitor != null) {
            iMtopMonitor.mtopRequestTime(str, str2, zl2);
        }
    }
    ...
    public static final void j(@NotNull IMtopMonitor iMtopMonitor) {
        ...
        k21.i(iMtopMonitor, "monitorDelegate");
        a = iMtopMonitor;
    }
}
