...
public class ju2 {
        ...
        try {
            for (Map.Entry<String, String> entry : map.entrySet()) {
                if (entry.getKey() != null) {
                    ...
                    sb.append("=");
                    sb.append(URLEncoder.encode(f(entry.getValue()), str).replace(jl1.PLUS, "%20"));
                    sb.append("&");
                }
            }
    ...
    public static String g(String str) {
        ...
        sb.reverse();
        return sb.toString().replace('-', jl1.CONDITION_IF_MIDDLE).replace('*', jl1.CONDITION_IF_MIDDLE);
    }
}
