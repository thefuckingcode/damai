...
public class ka0 {
    ...
    public static String a(String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "736505813")) {
            return (String) ipChange.ipc$dispatch("736505813", new Object[]{str});
        } else if (!TextUtils.isEmpty(str) && a.containsKey(str)) {
            return a.get(str);
        } else {
            return "";
        }
    ...
    public static String b(String str) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1833176939")) {
            return (String) ipChange.ipc$dispatch("1833176939", new Object[]{str});
