...
public class ue extends b {
    ...
    public static ue i() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-784696741")) {
            return (ue) ipChange.ipc$dispatch("-784696741", new Object[0]);
        }
        if (b == null) {
            b = new ue();
        }
    ...
    public a.b f() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "756691653")) {
            return new a.b().i(CALENDAR_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("756691653", new Object[]{this});
    }
