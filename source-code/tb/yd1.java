...
public class yd1 extends cn.damai.common.user.b {
    ...
    public static class b {
        private static final yd1 a = new yd1();
    }

    public static final yd1 x() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-1243186603") ? (yd1) ipChange.ipc$dispatch("-1243186603", new Object[0]) : b.a;
    }
    ...
    public a.b B() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-273075862")) {
            return b(MY_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("-273075862", new Object[]{this});
    }

    public a.b C() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1975086500")) {
            return e(MY_COUPON_PAGE, "top", "coupon_exchange", new HashMap(), Boolean.FALSE);
        }
        return (a.b) ipChange.ipc$dispatch("1975086500", new Object[]{this});
    }
    ...
    public a.b F() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "426493455")) {
            return b(MY_FEED_BACL_DETAIL_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("426493455", new Object[]{this});
    }

    public a.b G() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2023229980")) {
            return b(MY_FEED_BACL_LIST_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("2023229980", new Object[]{this});
    }

    public a.b H() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "503084406")) {
            return c(MY_PAGE, "top", "loginbutton", Boolean.FALSE);
        }
        return (a.b) ipChange.ipc$dispatch("503084406", new Object[]{this});
    }

    public a.b I() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-734916264")) {
            return c(MY_PAGE, "top", "message", Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("-734916264", new Object[]{this});
    }

    public a.b J() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-812071176")) {
            return c(MY_PAGE, "top", "more", Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("-812071176", new Object[]{this});
    }
    ...
    public void L(View view) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("usercode", d20.i());
        c.e().G(view, "entrance", "center", MY_PAGE, hashMap);
    }

    public a.b M() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-740804297")) {
            return b("point");
        }
        return (a.b) ipChange.ipc$dispatch("-740804297", new Object[]{this});
    }

    public a.b N() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "123199731")) {
            return b(REALNAME_AUTHCENTER_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("123199731", new Object[]{this});
    }
    ...
    public a.b Q() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1498567973")) {
            return b(REALNAME_AUTHFAIL_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("-1498567973", new Object[]{this});
    }

    public a.b R() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-359384898")) {
            return b(REALNAME_AUTH_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("-359384898", new Object[]{this});
    }
    ...
    public a.b V() {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("usercode", d20.E());
        return e(REALNAME_AUTHCENTER_PAGE, "top", wk.MY_ALIME_PAGE, hashMap, Boolean.FALSE);
    }
    ...
    public a.b Y() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "508094872")) {
            return b(REALNAME_FAILURE_REASON_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("508094872", new Object[]{this});
    }

    public a.b Z() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "582389932")) {
            return b(REALNAME_VERIFYFAIL_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("582389932", new Object[]{this});
    }

    public a.b a0() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1097731919")) {
            return b(REALNAME_VERIFY_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("1097731919", new Object[]{this});
    }
    ...
    public a.b d0() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1844774316")) {
            return e(MY_PAGE, "bottom", "submitbtn", null, Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("-1844774316", new Object[]{this});
    }
    ...
    public a.b f() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-252376387")) {
            return c(MY_ACCOUTMANAGE_SAFE_PAGE, "list", "loginpassword", Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("-252376387", new Object[]{this});
    }
    ...
    public a.b g() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "537433890")) {
            return c(MY_ACCOUTMANAGE_SAFE_PAGE, "list", "mobilebind", Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("537433890", new Object[]{this});
    }

    public a.b g0(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1999093045")) {
            return e(MY_PAGE, "listtools", str, null, Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("-1999093045", new Object[]{this, str});
    }

    public a.b h() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "769330620")) {
            return c(MY_ACCOUTMANAGE_SAFE_PAGE, "list", "paypassword", Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("769330620", new Object[]{this});
    }

    public a.b h0() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1450780918")) {
            return c(MY_PAGE, "center", "anouncement", Boolean.FALSE);
        }
        return (a.b) ipChange.ipc$dispatch("1450780918", new Object[]{this});
    }

    public a.b i() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2123595017")) {
            return c(MY_ACCOUTMANAGE_SAFE_PAGE, "list", REALNAME_AUTH_PAGE, Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("2123595017", new Object[]{this});
    }

    public a.b i0(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-939460989")) {
            return c(MY_PAGE, "top", str, Boolean.FALSE);
        }
        return (a.b) ipChange.ipc$dispatch("-939460989", new Object[]{this, str});
    }

    public a.b j() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1153927608")) {
            return b(MY_ACCOUTMANAGE_SAFE_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("-1153927608", new Object[]{this});
    }
    ...
    public a.b l0() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1138426835")) {
            return e(FEED_BACK_LIST_PAGE, "top", MY_FEED_BACL_LIST_PAGE, new HashMap(), Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("1138426835", new Object[]{this});
    }
    ...
    public void m0(View view) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("usercode", d20.E());
        c.e().G(view, "alert", "viptipalert", MY_ACCOUTMANAGE_SAFE_PAGE, hashMap);
    }

    public a.b n() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-89130042")) {
            return c(MY_ADDRESSMANAGE_PAGE, "bottom", "addaddress", Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("-89130042", new Object[]{this});
    }
    ...
    public void n0(View view) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("usercode", d20.E());
        c.e().G(view, "myvip", "list", MY_ACCOUTMANAGE_SAFE_PAGE, hashMap);
    }

    public a.b o() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1562665490")) {
            return b(MY_ADDRESSMANAGE_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("-1562665490", new Object[]{this});
    }
    ...
    public void o0(View view, String str) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("crowd_type", str);
        c.e().G(view, MemberGuideInfo.authorize, "bottom", MY_PAGE, hashMap);
    }

    public a.b p() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "825450023")) {
            return b(MY_COUPON_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("825450023", new Object[]{this});
    }
    ...
    public void p0(View view, String str) {
        ...
        hashMap.put("usercode", d20.E());
        hashMap.put("vip_status", str);
        c.e().G(view, "vipcenter", "listtools", MY_PAGE, hashMap);
    }
    ...
    public a.b r() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "368352434")) {
            return e(MY_PAGE, "center", "more_item", null, Boolean.FALSE);
        }
        return (a.b) ipChange.ipc$dispatch("368352434", new Object[]{this});
    }
    ...
    public a.b t() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1997659345")) {
            return b(FEED_BACK_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("-1997659345", new Object[]{this});
    }
    ...
    public a.b w() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1131502960")) {
            return b(FEED_BACK_LIST_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("-1131502960", new Object[]{this});
    }

    public a.b y() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1333510595")) {
            return b(LOGISTICS_DETAIL);
        }
        return (a.b) ipChange.ipc$dispatch("1333510595", new Object[]{this});
    }
