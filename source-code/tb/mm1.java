...
public class mm1 {
    ...
    public class a implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            context.startActivity(xj1.a(context));
        }
    }
    ...
    public static boolean c(String str) {
        ...
        return !TextUtils.isEmpty(str) && !v20.a("yyyyMMdd").equals(d20.B(OrderDetailActivity.REFUND_POPWINDPW));
    }
    ...
    public static void d(Context context, String str, boolean z) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-2124298336")) {
            ...
            DMNav.from(context).withExtras(bundle).toUri(NavUri.b(gr.M));
        }
    }
    ...
    public static void e(Context context, String str, String str2, String str3) {
        ...
        DMNav.from(context).withExtras(bundle).forResult(1001).toUri(NavUri.b(gr.j));
    }
    ...
    public static void f(Context context, String str, String str2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "770589137")) {
            ...
            DMNav.from(context).withExtras(bundle).toUri(NavUri.b(gr.i));
        }
    }
    ...
    public static void g(Context context, String str, String str2) {
        ...
        DMNav.from(context).withExtras(bundle).toUri(NavUri.b(gr.b));
    }
    ...
    public static void h(Context context, PurchaseNotice purchaseNotice) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1464798011")) {
            ...
            c.e().x(ln2.r().I(purchaseNotice.orderId, purchaseNotice.itemId));
            Bundle bundle = new Bundle();
    ...
    public static void i(Context context) {
        ...
        DMNav.from(context).withExtras(bundle).forResult(1002).toUri(NavUri.b(gr.d));
    }
    ...
    public static void j(Context context, String str) {
        ...
        Bundle bundle = new Bundle();
        bundle.putString("orderId", str);
        DMNav.from(context).withExtras(bundle).toUri(NavUri.b(gr.Z));
    }
    ...
    public static void k(Context context, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1906890750")) {
            ...
            DMNav.from(context).withExtras(bundle).toUri(NavUri.b(gr.t));
        }
    }
    ...
    public static void l(Context context) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1622153454")) {
            ...
            dMDialog.v(PurchaseConstants.NORMAL_WARNING_TITLE);
            dMDialog.q("您未打开通知权限，为了保证第一时间收到选座通知，请您先打开通知权限");
            dMDialog.n("打开", new a(context));
            dMDialog.i("关闭", null);
            dMDialog.show();
        } else if (context != null) {
            DMDialog dMDialog2 = new DMDialog(context);
            dMDialog2.q("选座前将通过APP消息通知您，请您不要关闭通知哦");
            dMDialog2.n("知道了", new b());
            dMDialog2.show();
        }
    }
