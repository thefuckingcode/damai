...
public class zh implements IConverter<BaseResponse, BaseSection, GlobalConfig, List<Node>> {
    ...
    public List<Node> convert(BaseResponse baseResponse, BaseSection baseSection, GlobalConfig globalConfig, qa qaVar) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-199472700")) {
            return (List) ipChange.ipc$dispatch("-199472700", new Object[]{this, baseResponse, baseSection, globalConfig, qaVar});
        }
            ...
            for (int i = 0; i < jSONArray.size(); i++) {
                ...
                if (jSONObject != null) {
                    ...
                    if (TextUtils.equals("1", string)) {
                        baseSection.setComponentId(wj2.BIG_NOTE_C_ID);
                        ...
                        baseSection.setComponentId(wj2.BIG_THEME_C_ID);
                        baseSection.setItem(jSONObject.getJSONObject("data"));
                        ...
                        baseSection.setComponentId(wj2.DISCUSS_C_ID);
                        baseSection.setItem(jSONObject.getJSONObject("data"));
                        ...
                        baseSection.setComponentId(wj2.BIG_VOTE_C_ID);
                        baseSection.setItem(jSONObject.getJSONObject("data"));
