...
public class r6 implements IAppInfo {
    ...
    public Context getAppContext() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2037194345")) {
            return pn.INSTANCE.a();
        }
        return (Context) ipChange.ipc$dispatch("2037194345", new Object[]{this});
    }
    ...
    public String getAppKey() {
        ...
        String appKey = pn.INSTANCE.b().getAppKey();
    ...
    public Application getApplication() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1841092054")) {
            return pn.INSTANCE.a();
        }
        return (Application) ipChange.ipc$dispatch("-1841092054", new Object[]{this});
    }
    ...
    public String getChannelId() {
        ...
        String channelId = pn.INSTANCE.b().getChannelId();
    ...
    public EnvMode getEnv() {
        ...
        EnvMode env = pn.INSTANCE.b().getEnv();
    ...
    public String getTTID() {
        ...
        String ttid = pn.INSTANCE.b().getTTID();
