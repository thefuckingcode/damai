...
public class s72 {
    ...
    public static boolean a() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "903279131")) {
            return ((Boolean) ipChange.ipc$dispatch("903279131", new Object[0])).booleanValue();
        }
    ...
    public static void f(String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "520118545")) {
            ...
            g91.c("SeatLog", (jl1.ARRAY_START_STR + Thread.currentThread().getName() + "] ") + str);
        }
    }
