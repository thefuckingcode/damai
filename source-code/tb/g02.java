...
public class g02 implements AccsDataListener {
    public static a4 b;
    public Map<String, ICallback> a = new HashMap();

    public g02(Context context) {
        if (b == null) {
            b = new a4(context.getApplicationContext());
        }
    }

    private void a(JSONObject jSONObject, ICallback iCallback) throws JSONException {
        String string = JsonUtility.getString(jSONObject, s4.JSON_PUSH_USER_TOKEN, null);
            ...
            if (NotifManager.getServiceId(GlobalClientInfo.getContext(), TaobaoConstants.SERVICE_ID_DEVICECMD).equals(str)) {
                ...
                if (i == 200) {
                    ...
                    if (!"success".equals(string)) {
                        ...
                        return;
                    } else if (s4.JSON_CMD_SETALIAS.equals(string2)) {
                        ...
                        return;
                    } else if (s4.JSON_CMD_REMOVEALIAS.equals(string2)) {
                        ...
                        return;
                    } else if ((gh2.JSON_CMD_ENABLEPUSH.equals(string2) || gh2.JSON_CMD_DISABLEPUSH.equals(string2)) && iCallback != null) {
                        iCallback.onSuccess();
                    }
                } else if (iCallback != null) {
