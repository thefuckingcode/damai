...
public class d20 implements ShareperfenceConstants {
    private static transient /* synthetic */ IpChange $ipChange;

    private static SharedPreferences A(String str, int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1131056003")) {
            return SPProviderProxy.getSharedPreferences(str);
        }
        return (SharedPreferences) ipChange.ipc$dispatch("1131056003", new Object[]{str, Integer.valueOf(i)});
    }
    ...
    public static String B(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1989397082")) {
            return SPProviderProxy.getPreferenceString(str);
        }
        return (String) ipChange.ipc$dispatch("1989397082", new Object[]{str});
    }
        ...
        if (AndroidInstantRuntime.support(ipChange, "-153119917")) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(string)) {
                    return I.dynamicDecryptDDp(string);
                }
                return "";
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public static String E() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1713837227")) {
            return (String) ipChange.ipc$dispatch("1713837227", new Object[0]);
        }
        return A(ShareperfenceConstants.USER_SHAREPERFENCE, 0).getString(ShareperfenceConstants.USERCODE, "");
    }

    public static String F() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1881604489")) {
            return (String) ipChange.ipc$dispatch("-1881604489", new Object[0]);
        }
        return A(ShareperfenceConstants.USER_SECURITY_KEY, 0).getString(ShareperfenceConstants.USER_SECURITY_KEY, "");
    }

    public static int G() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1548932143")) {
            return ((Integer) ipChange.ipc$dispatch("-1548932143", new Object[0])).intValue();
        }
        return A(ShareperfenceConstants.USER_SHAREPERFENCE, 0).getInt(ShareperfenceConstants.USER_VTAG, 0);
    }
    ...
    public static String H() {
        ...
        return !TextUtils.isEmpty(string) ? z10.a(string) : string;
    }
    ...
    private static IDynamicDataEncryptComponent I() {
        ...
        try {
            SecurityGuardManager instance = SecurityGuardManager.getInstance(xs0.a());
            if (instance != null) {
    ...
    public static String J() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "37712784")) {
            return (String) ipChange.ipc$dispatch("37712784", new Object[0]);
        }
        return A(ShareperfenceConstants.FIRST_QQ_SHAREPREFENCE, 0).getString(ShareperfenceConstants.FIRST_QQ_SHOW, null);
    }

    public static boolean K() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1196768299")) {
            return ((Boolean) ipChange.ipc$dispatch("1196768299", new Object[0])).booleanValue();
        }
        return A(ShareperfenceConstants.USER_SHAREPERFENCE, 0).getBoolean(ShareperfenceConstants.DM_APP_RECOMMEND_SWITCH_STATUS, true);
    }

    public static boolean L() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1149194278")) {
            return ((Boolean) ipChange.ipc$dispatch("-1149194278", new Object[0])).booleanValue();
        }
        return A(ShareperfenceConstants.HOMEPAGE_DETAILED_COLLECT, 0).getBoolean(ShareperfenceConstants.KEY_DETAILED_COLLECT_PAGE, false);
    }
    ...
    public static void a() {
        ...
        edit.putLong(Constants.PARAM_EXPIRES_IN, 1);
    ...
    public static String c() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "91326265")) {
            return (String) ipChange.ipc$dispatch("91326265", new Object[0]);
        }
        return A(ShareperfenceConstants.CITY_SHAREPREFENCE, 0).getString(ShareperfenceConstants.CITY_ID, "852");
    }
    ...
    public static String d() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1936077801")) {
            return (String) ipChange.ipc$dispatch("1936077801", new Object[0]);
        }
        return A(ShareperfenceConstants.CITY_SHAREPREFENCE, 0).getString(ShareperfenceConstants.CITY_NAME, bk2.b(xs0.a().getApplicationContext(), R$string.damai_addreceipt_beijing));
    }
    ...
    public static boolean e() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-160123516")) {
            return ((Boolean) ipChange.ipc$dispatch("-160123516", new Object[0])).booleanValue();
        }
        return A(ShareperfenceConstants.ADDRESS_LIST_PROMPT, 0).getBoolean(ShareperfenceConstants.KEY_CLOSED_INVALID_ADDRESS_PROMPT, false);
    }
    ...
    public static boolean j() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-386931706")) {
            return ((Boolean) ipChange.ipc$dispatch("-386931706", new Object[0])).booleanValue();
        }
        return xs0.a().getApplicationContext().getSharedPreferences("homepage_pre", 0).getBoolean("homepage_pre", false);
    }
    ...
    public static String k() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-662134325")) {
            return (String) ipChange.ipc$dispatch("-662134325", new Object[0]);
        }
        return xs0.a().getApplicationContext().getSharedPreferences("homepage_pre_time", 0).getString("homepage_pre_time", "");
    }
    ...
    public static void l0(boolean z) {
        ...
        xs0.a().getApplicationContext().getSharedPreferences("homepage_pre", 0).edit().putBoolean("homepage_pre", z).commit();
    }

    public static long m() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-592760083")) {
            return ((Long) ipChange.ipc$dispatch("-592760083", new Object[0])).longValue();
        }
        return A(ShareperfenceConstants.LATEST_PROJECT_INFO, 0).getLong("sellStartTime", 0);
    }
    ...
    public static double n() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1021391359")) {
            return ((Double) ipChange.ipc$dispatch("-1021391359", new Object[0])).doubleValue();
        }
        return Double.parseDouble(A("location", 0).getString(ShareperfenceConstants.LOCATION_LAT, "39.907325"));
    }
    ...
    public static double o() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1009772869")) {
            return ((Double) ipChange.ipc$dispatch("-1009772869", new Object[0])).doubleValue();
        }
        return Double.parseDouble(A("location", 0).getString(ShareperfenceConstants.LOCATION_LNG, "116.39145"));
    }
    ...
    public static String p() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1684076595")) {
            return (String) ipChange.ipc$dispatch("1684076595", new Object[0]);
        }
        return A("location", 0).getString(ShareperfenceConstants.LOCATION_NAME, "北京市");
    }
    ...
    public static String q() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-817112183")) {
            return (String) ipChange.ipc$dispatch("-817112183", new Object[0]);
        }
        return A(ShareperfenceConstants.USER_SHAREPERFENCE, 0).getString(ShareperfenceConstants.LOGIN_KEY, "");
    }
    ...
    public static String s() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "2145260924")) {
            return (String) ipChange.ipc$dispatch("2145260924", new Object[0]);
        }
        return xs0.a().getApplicationContext().getSharedPreferences(ShareperfenceConstants.MTOP_PROJECT, 0).getString(ShareperfenceConstants.MTOP_PROJECT, "");
    }
    ...
    public static boolean t() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "2058281666")) {
            return ((Boolean) ipChange.ipc$dispatch("2058281666", new Object[0])).booleanValue();
        }
        return xs0.a().getApplicationContext().getSharedPreferences(ShareperfenceConstants.MTOP_PROJECT_TAG, 0).getBoolean(DamaiConstants.MTOP_PROJECT_TAG_CHECK, false);
    }
    ...
    public static boolean u() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1413909657")) {
            return ((Boolean) ipChange.ipc$dispatch("1413909657", new Object[0])).booleanValue();
        }
        return xs0.a().getApplicationContext().getSharedPreferences(ShareperfenceConstants.MTOP_SWITCH_PROTOCOL_CONFIG, 0).getBoolean(DamaiConstants.MTOP_PROTOCOL_CHECK, false);
    }
    ...
    public static String x() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-654597312")) {
            return (String) ipChange.ipc$dispatch("-654597312", new Object[0]);
        }
        return A(ShareperfenceConstants.USER_SHAREPERFENCE, 0).getString(ShareperfenceConstants.OLD_LOGIN_KEY, "");
    }
    ...
    public static String y() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "49880165")) {
            return (String) ipChange.ipc$dispatch("49880165", new Object[0]);
        }
        return A(ShareperfenceConstants.PROJECT_PAGE_SHAREPREFENCE, 0).getString(ShareperfenceConstants.PROJECT_NAT_DATA, "");
    }
    ...
    public static int z() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1663384625")) {
            return ((Integer) ipChange.ipc$dispatch("1663384625", new Object[0])).intValue();
        }
        return A(ShareperfenceConstants.RED_PACKAGE_TYPE, 0).getInt(ShareperfenceConstants.RED_PACKAGE_TYPE, 0);
    }
