...
public final class a12 {
    ...
    public final int b() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-476578771")) {
            return this.c;
        }
        return ((Integer) ipChange.ipc$dispatch("-476578771", new Object[]{this})).intValue();
    }

    public final int c() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1935395260")) {
            return this.b;
        }
        return ((Integer) ipChange.ipc$dispatch("1935395260", new Object[]{this})).intValue();
    }

    public final int d() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1913922471")) {
            return this.a;
        }
        return ((Integer) ipChange.ipc$dispatch("1913922471", new Object[]{this})).intValue();
    }
