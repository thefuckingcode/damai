...
public final class e31 implements IJSONParser {
    private static transient /* synthetic */ IpChange $ipChange;

    /* compiled from: Taobao */
    public static final class a extends TypeReference<ArrayList<T>> {
        a() {
        }
    }
    ...
    public <T> ArrayList<T> parseArrayList(@Nullable String str, @NotNull Class<T> cls) {
        ...
        try {
            ...
            e91.e("JSONParerImpl", "parseArray:" + e2);
            return null;
        }
    }
    ...
    public Boolean[] parseBooleanArray(@Nullable String str) {
        ...
        try {
            ...
            e91 e91 = e91.INSTANCE;
            e91.e("JSONParerImpl", "parseIntArray-type:" + e2);
            return null;
        }
    }
    ...
    public <T> T parseJson(@Nullable String str, @NotNull Class<T> cls) {
        ...
        try {
            ...
            e91 e91 = e91.INSTANCE;
            e91.e("JSONParerImpl", "parseJson-cls:" + e2);
            return null;
        }
    }
    ...
    public Object parseJsonObject(@Nullable String str) {
        ...
        try {
            ...
            e91 e91 = e91.INSTANCE;
            e91.e("JSONParerImpl", "parseJsonObject:" + e2);
            return null;
        }
    }
    ...
    public String[] parseStringArray(@Nullable String str) {
        ...
        try {
            ...
            e91 e91 = e91.INSTANCE;
            e91.e("JSONParerImpl", "parseStringArray-type:" + e2);
            return null;
        }
    }
    ...
    public String toJsonString(@Nullable Object obj) {
        ...
        try {
            ...
            e91 e91 = e91.INSTANCE;
            e91.e("JSONParerImpl", "toJsonString:" + e2);
            return null;
        }
    }
    ...
    public <T> T parseJson(@Nullable String str, @NotNull Type type) {
        ...
        try {
            ...
            e91 e91 = e91.INSTANCE;
            e91.e("JSONParerImpl", "parseJson-type:" + e2);
            return null;
        }
    }
}
