...
public class xu0 implements View.OnClickListener {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            xu0.this.d.getClickEvent().setValue(15);
        }
    }
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            xu0.this.d.getClickEvent().setValue(6);
        }
    }
    ...
    public class c implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            xu0.this.d.getClickEvent().setValue(8);
        }
    }
    ...
    public class d implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            } else if (xu0.this.c != null && xu0.this.c.focusNum > 0) {
                xu0.this.d.getClickEvent().setValue(10);
            }
        }
    }
    ...
    public class e implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            } else if (xu0.this.c != null && xu0.this.c.fansNum > 0) {
                xu0.this.d.getClickEvent().setValue(11);
            }
        }
    }
    ...
    public class f implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            } else if (xu0.this.c != null && xu0.this.c.fansNum > 0 && xu0.this.c.vaccount && xu0.this.c.mySelf) {
                xu0.this.d.getClickEvent().setValue(11);
            }
        }
    }
    ...
    public class g implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            } else if (xu0.this.c != null && xu0.this.c.focusNum > 0 && xu0.this.c.vaccount && xu0.this.c.mySelf) {
                xu0.this.d.getClickEvent().setValue(10);
            }
        }
    }

    public xu0(UserResponse userResponse, UserIndexActivity userIndexActivity, int i) {
        this.a = userResponse;
    ...
    private <T extends View> T e(@IdRes int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-601572169")) {
            return (T) ((View) ipChange.ipc$dispatch("-601572169", new Object[]{this, Integer.valueOf(i)}));
        }
    ...
    private int h(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2126454221")) {
            return this.b.getResources().getDimensionPixelOffset(i);
        }
        return ((Integer) ipChange.ipc$dispatch("-2126454221", new Object[]{this, Integer.valueOf(i)})).intValue();
    }
    ...
    public void b() {
        ...
        if (i == 1) {
            ...
            bundle2.putString(p21.ISSUE_PARAM_IPID, this.c.bid + "");
        ...
        if (this.f.getCount() > 1) {
            ...
            if (i2 > -1) {
                ...
                } else if (userData4 != null && userData4.projectCount == 0) {
                    viewPager.setCurrentItem(1);
                }
            } else {
    ...
    public void d(int i) {
        ...
        UserData userData = this.c;
        if (userData.type == 1) {
            vu0.h(this.b, userData, e(R$id.rl_header_c), i);
        } else if (userData.mySelf) {
            vu0.h(this.b, userData, e(R$id.rl_header_b), i);
        } else {
            vu0.h(this.b, userData, e(R$id.rl_header_b_other), i);
        }
    }
    ...
    public void f(int i) {
        ...
        if (this.c.type != 1) {
            ...
            if (this.c.mySelf) {
                ...
                int i4 = R$id.rl_header_b_other;
                e(i4).setVisibility(0);
                UserData userData = this.c;
                if (userData.lat > 0.0d && userData.lng > 0.0d) {
                    e(i4).findViewById(R$id.user_tv_desc).setOnClickListener(new a());
                }
            }
            ...
            if (!this.c.mySelf) {
                i3 = h(R$dimen.USER_HEADER_HC) + h(R$dimen.NAVBAR_H) + i;
                layoutParams.setMargins(0, 0, 0, 0);
            } else {
                i3 = v50.a(this.b, 322.0f);
                e(R$id.user_tv_add).setVisibility(8);
                e(R$id.ll_div).setVisibility(8);
                int i5 = R$id.rl_header_c;
                RelativeLayout.LayoutParams layoutParams2 = (RelativeLayout.LayoutParams) e(i5).getLayoutParams();
                layoutParams2.setMargins(0, h(R$dimen.NAVBAR_H) + i + v50.a(this.b, 6.0f), 0, 0);
                layoutParams2.height = i3;
                e(i5).setLayoutParams(layoutParams2);
            }
            e(R$id.rl_header_b).setVisibility(8);
            e(R$id.rl_header_b_other).setVisibility(8);
