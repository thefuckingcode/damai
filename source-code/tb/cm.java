...
public class cm {
    ...
    public static BizPriManager e;
    public static FileCacheManager f;
    public static TaskManager g;
    public static DownloadFactory h;
    public static DnsService i;
    public static CloundConfigAdapter j;
    public static boolean k;
    public static Class<? extends DLConnection> l;
}
