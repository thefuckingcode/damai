...
public class o80 {
    ...
    public static JSONObject c(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1850851288")) {
            return d.get(str);
        }
        return (JSONObject) ipChange.ipc$dispatch("-1850851288", new Object[]{str});
    }
    ...
    public static DXTemplateItem e(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-727130645")) {
            return a.get(Integer.valueOf(i));
        }
        return (DXTemplateItem) ipChange.ipc$dispatch("-727130645", new Object[]{Integer.valueOf(i)});
    }
    ...
    public static boolean g(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "480381512")) {
            return d.containsKey(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("480381512", new Object[]{str})).booleanValue();
    }
