...
public abstract class xa extends BaseMonitorPoint {
    @Nullable
    ...
    public void release() {
        try {
            if (getExtraDataMap() != null) {
                HashMap<String, String> extraDataMap2 = getExtraDataMap();
                if (extraDataMap2 != null) {
                    extraDataMap2.clear();
                }
                fillExtraData(getExtraDataMap());
            }
            e03.Companion.a().g(this);
    ...
    @NotNull
    public xa setResultExpected(boolean z) {
        if (z) {
            this.successState = 1;
            this.failCount = 0;
            this.successCount = 1;
    ...
    public String toString() {
        HashMap<String, String> extraDataMap2 = getExtraDataMap();
        String e = extraDataMap2 != null ? bh0.INSTANCE.e(extraDataMap2) : "";
        return getPointName() + '-' + ((Object) getBizScene()) + '-' + ((Object) getBizCode()) + '-' + ((Object) getPageName()) + '-' + e;
    }
}
