...
public class rv2 extends Drawable {
    ...
    public rv2() {
        ...
        this.e = m42.a(xs0.a(), 62.0f);
        this.f = m42.a(xs0.a(), 26.0f);
        this.d.setColor(-1);
        this.d.setTextSize((float) m42.a(xs0.a(), 10.0f));
    ...
    public void setAlpha(int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-926388874")) {
            ipChange.ipc$dispatch("-926388874", new Object[]{this, Integer.valueOf(i2)});
        }
    }
