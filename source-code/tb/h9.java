...
public class h9 {
    ...
    public static void R(String str) {
        if (ss0.j() && !TextUtils.isEmpty(str)) {
            try {
                ...
                for (int i2 = 0; i2 < length; i2++) {
                    ...
                    if (ju2.a(string)) {
                        d.b().c(string, ConnProtocol.valueOf(jSONObject.getString("protocol"), jSONObject.getString("rtt"), jSONObject.getString("publicKey")));
                        if (jSONObject.getBoolean("isKeepAlive")) {
                            c.k().C(a92.a(string, true, false, null, null, null));
                        }
                    } else {
                        return;
                    }
    ...
    public static boolean y(String str) {
        ...
        if (H.contains(str) || H.contains(jl1.MUL)) {
            return true;
        }
        return false;
    }
