...
public class lk1 {
    ...
    public static SpannableStringBuilder e(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1402081829")) {
            return f(str, Color.parseColor("#FF993A"), Color.parseColor("#9C9CA5"));
        }
        return (SpannableStringBuilder) ipChange.ipc$dispatch("1402081829", new Object[]{str});
    }
