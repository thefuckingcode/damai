...
public class m6 {
    ...
    public static final String model = g70.b();
    public static String n = "";
    public static String o = "";
    public static final String osVersion = g70.e();
    ...
    public static String a(int i2) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1122864208")) {
            return i2 != 1 ? i2 != 2 ? i2 != 3 ? i2 != 4 ? i2 != 5 ? APN_UNKNOWN : APN_WIFI : APN_WAP : APN_3G_WAP : APN_3G_NET : APN_NET;
        }
        return (String) ipChange.ipc$dispatch("1122864208", new Object[]{Integer.valueOf(i2)});
    }
    ...
    public static String c() {
        ...
        if (TextUtils.isEmpty(m)) {
            ou2.d("apn", "before version: " + m);
            m = AppConfig.q();
            ou2.d("apn", "after version: " + m);
        }
    ...
    public static Map<String, String> d(boolean z) {
        ...
        if (!xf2.j(d20.F())) {
            hashMap.put(IRequestConst.COOKIE, "damai_cn_user=" + d20.F());
        }
        if (!z) {
            hashMap.put("imei", l);
            hashMap.put("x-hm-imei", l);
        }
        ou2.d("apn", " head map = " + hashMap);
        return hashMap;
    }
    ...
    public static String f() {
        ...
        if (TextUtils.isEmpty(q)) {
            ou2.d("apn", "before language: " + q);
            q = "zh";
            ou2.d("apn", "after language: " + q);
        }
        ...
        try {
            ...
            if (i2 == 1) {
                ...
                if (str == null) {
                    ...
                    if (!str.contains(c) && !str.contains(g)) {
                        if (!str.contains(i)) {
                            if (str.contains(e)) {
                                a = 3;
                            } else {
                                if (!str.contains(d) && !str.contains(h)) {
                                    if (!str.contains(j)) {
                                        if (str.contains(f)) {
                                            a = 2;
                                        } else {
            ...
            ou2.a("Apn", "init() called with: e = " + e2.getMessage());
            e2.printStackTrace();
        }
    }
    ...
    private static boolean h(int i2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "929699467")) {
            return i2 == 4 || i2 == 0;
        }
        return ((Boolean) ipChange.ipc$dispatch("929699467", new Object[]{Integer.valueOf(i2)})).booleanValue();
    }
}
