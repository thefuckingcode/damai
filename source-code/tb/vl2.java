...
public class vl2 {
    ...
    public static final String TICKLET_FLOAT_BRING_DATA_ERROR_MSG = "数据获取失败";
    ...
    public static final String TICKLET_PERFORM_DETAIL_RENDER_DATA_FAIL_MSG = "票详情接口返回data数据为null";
    ...
    public static void a(String str, String str2, String str3, String str4) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1990306915")) {
            ...
            yz2.c("damai-android", str, str2, str3, str4);
        }
    }
    ...
    public static String e(String str, String str2, String str3) {
        ...
        return "ticklet" + ":jsondata={apiName: " + str + ", retCode: " + str2 + ", retMsg: " + str3 + ", loginKey: " + d20.q() + "}";
    }
