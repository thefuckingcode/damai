...
public class hi2 {
    ...
    public static void a(Context context, Application application, String str) {
        ...
        try {
            ...
            TLogInitializer.getInstance().builder(context, logLevel, "logs", str, AppConfig.c(), AppConfig.q()).setApplication(application).setSecurityKey(g).setUserNick(d20.E()).setUtdid(UTDevice.getUtdid(context)).init();
