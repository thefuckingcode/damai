...
public class rx0 {
    ...
    public static String a(String str, String str2, String str3, String str4) {
        ...
        sb.append(str4);
        sb.append("}");
        yz2.a(sb.toString(), HOMEPAGE_CHANNEL_FEED_FAIL_CODE, HOMEPAGE_CHANNEL_FEED_FAIL_MSG);
        return sb.toString();
    }
    ...
    public static void b(String str, String str2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-874688923")) {
            ...
            a = true;
            yz2.a("homepage" + ":jsondata={retCode:" + "-1100" + ", retMsg:" + str + ", lottieUrl:" + str2 + ", cityId:" + d20.c() + "}", "-1100", HOME_LOTTIE_BITMAP_LOAD_FAIL_MSG);
        }
    }
    ...
    public static void c(String str) {
        ...
        yz2.a("homepage" + ":jsondata={retCode:" + "-1011" + ", retMsg:" + str + ", cityId:" + d20.c() + "}", "-1011", HOME_BOTTOM_TAB_FEN_WEI_FAIL_MSG);
    }
    ...
    public static String d(String str, String str2, String str3, String str4) {
        ...
        sb.append(str4);
        sb.append("}");
        yz2.a(sb.toString(), "-1000", "首页不显示（首屏接口)");
        return sb.toString();
    }
    ...
    public static void e(String str, String str2) {
        ...
        yz2.a("homepage" + ":jsondata={retCode:" + HOME_LOTTIE_ZIP_DECOMPRESS_FAIL + ", retMsg:" + str2 + ", zipUrl:" + str + ", cityId:" + d20.c() + "}", HOME_LOTTIE_ZIP_DECOMPRESS_FAIL, HOME_LOTTIE_ZIP_DECOMPRESS_FAIL_MSG);
    }
}
