...
public class rc1 {
    ...
    public void a(String str, long j) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "859317671")) {
            ...
            if (!this.a) {
                this.a = true;
                DimensionSet addDimension = DimensionSet.create().addDimension("type");
                AppMonitor.register("damai_member", this.c, MeasureSet.create().addMeasure("loadTime"), addDimension);
            }
            ...
            g91.b("damai_member", "type= " + str + " loadTime = " + j);
        }
    }
