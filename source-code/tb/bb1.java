...
public class bb1 {
    ...
    public sb.b b(String str, String str2, String str3, Map<String, String> map, Boolean bool) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "787554902")) {
            return (sb.b) ipChange.ipc$dispatch("787554902", new Object[]{this, str, str2, str3, map, bool});
        }
        a(map);
        return new sb.b().c(str).a(str2).e(str3).b(bool.booleanValue()).d(map);
    }
}
