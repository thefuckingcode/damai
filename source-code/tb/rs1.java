...
public class rs1 {
    ...
    public static String b() {
        ...
        return f.getString("privacy_agreement_change_index", "");
    }
    ...
    public static String c() {
        ...
        return f.getString("home_agreement_time_json", "");
    }
    ...
    private static SharedPreferences f() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-1692151922") ? (SharedPreferences) ipChange.ipc$dispatch("-1692151922", new Object[0]) : g(xs0.a());
    }

    private static SharedPreferences g(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "818237730")) {
            return context.getApplicationContext().getSharedPreferences("privacy_dialog", 0);
        }
        return (SharedPreferences) ipChange.ipc$dispatch("818237730", new Object[]{context});
    }
