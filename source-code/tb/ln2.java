...
public class ln2 extends ta {
    ...
    public static class a {
        private static final ln2 a = new ln2();
    }

    private void N1(String str, View view, String str2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "2108389716")) {
            ...
            c.e().G(view, str, "bottom", ta.PROJECT_PAGE, hashMap);
        }
    }

    private void O1(String str, View view, String str2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1102657150")) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put("item_id", str2);
            c.e().G(view, str, "center", ta.PROJECT_PAGE, hashMap);
        }
    }

    private Map<String, String> n(String str, String str2, String str3, String str4, boolean z) {
        IpChange ipChange = $ipChange;
    ...
    public static final ln2 r() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "1661241019") ? (ln2) ipChange.ipc$dispatch("1661241019", new Object[0]) : a.a;
    }
    ...
    public a.b A0(long j) {
        ...
        return e(ta.PROJECT_PAGE, "center", PROJECT_TICKET_PAGE, hashMap, Boolean.TRUE);
    }

    public a.b A1(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
        ...
        return e(ta.PROJECT_PAGE, "center", "score_description", hashMap, Boolean.TRUE);
    }
    ...
    public a.b B(String str, String str2, boolean z) {
        IpChange ipChange = $ipChange;
    ...
    public a.b B0(long j) {
        ...
        hashMap.put("item_id", String.valueOf(j));
        hashMap.put("usercode", d20.E());
        return e(ta.PROJECT_PAGE, "top", "entrance", hashMap, Boolean.TRUE);
    }
    ...
    public void B1(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1182199865")) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put("item_id", str);
            c.e().G(view, "addtocalendar", "remindme", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b C(String str, String str2) {
        ...
        hashMap.put("orderid", str2);
        return e(ORDER_DETAL_PAGE, wk.MY_ALIME_PAGE, wk.MY_ALIME_PAGE, hashMap, Boolean.TRUE);
    }
    ...
    public a.b C0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "center", "perform", hashMap, Boolean.TRUE);
    }
    ...
    public void C1(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-223637527")) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put("item_id", str);
            c.e().G(view, "announcement", "top", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b D0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "top", "poster", hashMap, Boolean.FALSE);
    }
    ...
    public void D2(long j, Activity activity, String str) {
        IpChange ipChange = $ipChange;
        ...
        a.b bVar = new a.b();
        bVar.d(String.valueOf(j)).i(ta.PROJECT_PAGE).j(hashMap);
        c.e().l(activity, bVar);
    }
    ...
    public a.b E0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "bottom", "vipbuy", hashMap, Boolean.FALSE);
    }

    public void E1(View view, String str, String str2, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "2146399168")) {
            ...
            c e = c.e();
            e.G(view, "comment_" + i, PROJECT_EVALUATE, ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b F0(long j, String str, String str2) {
        IpChange ipChange = $ipChange;
        ...
        return e(ta.PROJECT_PAGE, "vip", "confimbtn", hashMap, Boolean.FALSE);
    }

    public void F1(View view, String str, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1328100309")) {
            ...
            hashMap.put("item_id", str);
            c e = c.e();
            e.G(view, "commonproblem_" + i, "commonproblem", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b G0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "bottom", "vipselect", hashMap, Boolean.FALSE);
    }

    public a.b G1(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
    ...
    public a.b H0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return d(ta.PROJECT_PAGE, "vip", "buy", "vip_buy", hashMap, Boolean.TRUE);
    }
    ...
    public a.b I0(String str, String str2, String str3, int i) {
        IpChange ipChange = $ipChange;
        ...
        return e(ta.PROJECT_PAGE, "rec", "item_" + i, hashMap, Boolean.TRUE);
    }
    ...
    public void I1(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1701614373")) {
            ...
            hashMap.put("usercode", d20.E());
            hashMap.put("item_id", str);
            c.e().G(view, "award_share", "center", ORDER_LIST_PAGE, hashMap);
        }
    }
    ...
    public a.b J0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "bottom", "saleremind", hashMap, Boolean.FALSE);
    }
    ...
    public void J1(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "26489499")) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put("item_id", str);
            c.e().G(view, "perform", "center", ta.PROJECT_PAGE, hashMap);
        }
    }

    public Map<String, String> K(String str, String str2, String str3, boolean z) {
        IpChange ipChange = $ipChange;
        ...
        return n(str, str2, "false", str3, z);
    }
    ...
    public a.b K0(long j, boolean z) {
        ...
        return e(ta.PROJECT_PAGE, "center", "seatmap", hashMap, Boolean.FALSE);
    }
    ...
    public void K1(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1021171853")) {
            ...
            c.e().G(view, "poster", "top", ta.PROJECT_PAGE, hashMap);
        }
    }

    public Map<String, String> L(String str, String str2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "399099754")) {
            return n(str, str2, "true", null, false);
        }
        return (Map) ipChange.ipc$dispatch("399099754", new Object[]{this, str, str2});
    }

    public a.b L0(long j) {
        IpChange ipChange = $ipChange;
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "bottom", "service", hashMap, Boolean.TRUE);
    }

    public void L1(View view, int i, String str) {
        String str2;
        String str3;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "49296431")) {
            ...
            if (i != 0) {
                ...
                str2 = str3;
                c.e().G(view, str2, "anchor", ta.PROJECT_PAGE, hashMap);
            }
            str2 = "details";
            c.e().G(view, str2, "anchor", ta.PROJECT_PAGE, hashMap);
        }
    ...
    public Map<String, String> M(String str, String str2, boolean z) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "270938996")) {
            return n(str, str2, "true", null, z);
        }
        return (Map) ipChange.ipc$dispatch("270938996", new Object[]{this, str, str2, Boolean.valueOf(z)});
    }
    ...
    public a.b M0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "center", "servicedivbtn", hashMap, Boolean.FALSE);
    }
    ...
    public void M1(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-417359223")) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put("item_id", str);
            c.e().G(view, hf1.MODULE_BANNER, "center", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b N0(String str, int i) {
        IpChange ipChange = $ipChange;
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", str);
        return e(ta.PROJECT_PAGE, "center", "tour_item_" + i, hashMap, Boolean.TRUE);
    }
    ...
    public a.b O(String str) {
        ...
        hashMap.put("usercode", d20.E());
        hashMap.put("orderid", str);
        return e(ORDER_DETAL_PAGE, "distribution_info", yd1.LOGISTICS_DETAIL, hashMap, Boolean.TRUE);
    }

    public a.b O0(Intent intent) {
        IpChange ipChange = $ipChange;
        ...
        try {
            a.b b = b("venuemap");
            long longExtra = intent.getLongExtra("projectId", 0);
            if (longExtra != 0) {
    ...
    public a.b P0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "center", "venuenamebtn", hashMap, Boolean.TRUE);
    }
    ...
    public void P1(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-705977002")) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put("item_id", str);
            c.e().G(view, "license_tag", "top", ta.PROJECT_PAGE, hashMap);
        }
    }

    public a.b Q(String str, String str2, String str3, boolean z) {
        IpChange ipChange = $ipChange;
    ...
    public a.b Q0(long j, String str) {
        IpChange ipChange = $ipChange;
    ...
    public void Q1(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1866276148")) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put("item_id", str);
            c.e().G(view, "evaluate_list", PROJECT_EVALUATE, ta.PROJECT_PAGE, hashMap);
        }
    }

    public a.b R(String str, String str2, int i) {
        IpChange ipChange = $ipChange;
    ...
    public a.b R0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "center", PROJECT_PAGE_WARM_PROMPT, hashMap, Boolean.TRUE);
    }
    ...
    public void R1(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "2297224")) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put("item_id", str);
            c.e().G(view, "moreitem", "details", ta.PROJECT_PAGE, hashMap);
        }
    }

    public a.b S(String str, String str2, int i) {
        IpChange ipChange = $ipChange;
    ...
    public a.b S0(long j) {
        ...
        hashMap.put("item_id", String.valueOf(j));
        hashMap.put("usercode", d20.E());
        return e(ta.PROJECT_PAGE, "center", "ranklist", hashMap, Boolean.TRUE);
    }
    ...
    public void S1(String str, long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", str);
        c.e().C("gotoopen_tips", "bottom", ta.PROJECT_PAGE, "1.0", System.currentTimeMillis() - j, hashMap, 2201);
    }
    ...
    public a.b T0(String str, String str2, boolean z) {
        IpChange ipChange = $ipChange;
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", str);
        return e(ta.PROJECT_PAGE, AgooConstants.MESSAGE_POPUP, str2, hashMap, Boolean.valueOf(z));
    }
    ...
    public void T1(long j, String str, String str2, String str3) {
        ...
        c.e().A(hashMap, "yhtc_project_discountinfo", ta.PROJECT_PAGE);
    }
    ...
    public a.b U0(long j, String str) {
        IpChange ipChange = $ipChange;
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "center", str, hashMap, Boolean.TRUE);
    }
    ...
    public void U1(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-694238928")) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put("item_id", str);
            c.e().G(view, "award_share", "top", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b V0(String str, int i) {
        IpChange ipChange = $ipChange;
        ...
        hashMap.put("item_id", str);
        hashMap.put("usercode", d20.E());
        return e(ta.PROJECT_PAGE, "score", "evaluate_" + i, hashMap, Boolean.FALSE);
    }
    ...
    public void V1(View view, String str, String str2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1206794302")) {
            ...
            c.e().G(view, "remind_tips", "bottom", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b W0(String str, int i) {
        IpChange ipChange = $ipChange;
        ...
        hashMap.put("item_id", str);
        hashMap.put("usercode", d20.E());
        return e(ta.PROJECT_PAGE, "score", "tags_" + i, hashMap, Boolean.FALSE);
    }

    public a.b W1(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
        ...
        return e(ta.PROJECT_PAGE, "preemption_area", "exchangebtn", hashMap, Boolean.FALSE);
    }
    ...
    public a.b X(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, ILocatable.ADDRESS, "item", hashMap, Boolean.TRUE);
    }

    public a.b X0(String str) {
        IpChange ipChange = $ipChange;
        ...
        hashMap.put("item_id", str);
        hashMap.put("usercode", d20.E());
        return e(ta.PROJECT_PAGE, "top", "award_share", hashMap, Boolean.TRUE);
    }
    ...
    public void X1(View view, String str, String str2, String str3) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-44782862")) {
            ...
            hashMap.put("preemption_stage", str2);
            hashMap.put("preemption_btn_status", str3);
            c.e().G(view, "exchangebtn", "preemption_area", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b Y0() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "85610656")) {
            return b(ORDER_LIST_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("85610656", new Object[]{this});
    }
    ...
    public a.b Y1(String str) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", str);
        return e(ta.PROJECT_PAGE, "bottom", "resetaudiencealert", hashMap, Boolean.FALSE);
    }
    ...
    public a.b Z(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "anchor", "details", hashMap, Boolean.FALSE);
    }

    public a.b Z0(String str, String str2) {
        IpChange ipChange = $ipChange;
        ...
        return e(ta.PROJECT_PAGE, "preemption_area", "addtoremind", hashMap, Boolean.FALSE);
    }
    ...
    public void Z1(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1648549579")) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put("item_id", str);
            c.e().G(view, "resetaudiencealert", "bottom", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b a0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "anchor", PROJECT_EVALUATE, hashMap, Boolean.FALSE);
    }

    public a.b a1(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1995455089")) {
            return new a.b().d(str).i(PROJECT_FILL_INFORMATION);
        }
        return (a.b) ipChange.ipc$dispatch("-1995455089", new Object[]{this, str});
    }
    ...
    public void a2(View view, String str, String str2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-958495673")) {
            ...
            c.e().G(view, "score_description", "center", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b b0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "anchor", "notice", hashMap, Boolean.FALSE);
    }

    public a.b b1(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1175526607")) {
            return new a.b().d(str).i(PROJECT_TICKET_STRATEGY);
        }
        return (a.b) ipChange.ipc$dispatch("-1175526607", new Object[]{this, str});
    }

    public void b2(View view, String str, String str2, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1686091540")) {
            ...
            hashMap.put("titlelabel", str2);
            c e = c.e();
            e.G(view, "tags_" + i, "score", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b c0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "anchor", "recommend", hashMap, Boolean.FALSE);
    }

    public a.b c1(long j, boolean z) {
        IpChange ipChange = $ipChange;
        ...
        hashMap.put("item_id", String.valueOf(j));
        hashMap.put("usercode", d20.E());
        return e(ta.PROJECT_PAGE, "top", Constants.Event.RETURN, hashMap, Boolean.valueOf(z));
    }
    ...
    public a.b d0(String str, String str2, String str3, int i, String str4) {
        IpChange ipChange = $ipChange;
        ...
        return e(ta.PROJECT_PAGE, StarIndexFragment.Default_PAGE, "artistdetail_" + i, hashMap, Boolean.TRUE);
    }

    public a.b d1(long j, boolean z) {
        IpChange ipChange = $ipChange;
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "top", "license_tag", hashMap, Boolean.valueOf(z));
    }
    ...
    public a.b e0(String str) {
        ...
        return e(ta.PROJECT_PAGE, "center", hf1.MODULE_BANNER, hashMap, Boolean.TRUE);
    }

    public a.b e1(String str, String str2, int i) {
        IpChange ipChange = $ipChange;
    ...
    public void e2(View view, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "95765916")) {
            ...
            HashMap hashMap = new HashMap();
            hashMap.put("item_id", str);
            c.e().G(view, "servicedivbtn", "center", ta.PROJECT_PAGE, hashMap);
        }
    }

    public a.b f0(long j) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2432545")) {
            return f(j, ta.PROJECT_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("-2432545", new Object[]{this, Long.valueOf(j)});
    }

    public a.b f1(String str, String str2, int i) {
        IpChange ipChange = $ipChange;
    ...
    public a.b f2(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
    ...
    public a.b g0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "bottom", "buy", hashMap, Boolean.TRUE);
    }

    public a.b g1(String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    public a.b h0(long j, boolean z) {
        IpChange ipChange = $ipChange;
        ...
        return e(ta.PROJECT_PAGE, "top", "favorite", hashMap, Boolean.FALSE);
    }

    public a.b h1(String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    public void h2(View view, String str) {
        ...
        N1("stock_checkin", view, str);
    }

    public a.b i0(long j, int i) {
        IpChange ipChange = $ipChange;
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "commonproblem", "commonproblem_" + i, hashMap, Boolean.TRUE);
    }

    public a.b i1(String str, String str2) {
        IpChange ipChange = $ipChange;
        ...
        hashMap.put("orderid", str2);
        return e(ORDER_MODIFY_ADDRESS_PAGE, "new_address", ma0.DM_ADDRESS_LIST_PAGE, hashMap, Boolean.TRUE);
    }

    public void i2(View view, String str, int i) {
        IpChange ipChange = $ipChange;
        ...
        O1("tour_item_" + i, view, str);
    }

    public void j(View view, String str, InFieldCommentsBean inFieldCommentsBean, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "153947558")) {
            ...
            c e = c.e();
            e.G(view, str2 + i, "tips", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b j0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "commonproblem", "commonproblem_more", hashMap, Boolean.TRUE);
    }

    public a.b j1(String str, String str2, long j) {
        IpChange ipChange = $ipChange;
    ...
    public a.b k(long j) {
        ...
        hashMap.put("item_id", String.valueOf(j));
        hashMap.put("usercode", d20.E());
        return e(ta.PROJECT_PAGE, "remindme", "addtocalendar", hashMap, Boolean.FALSE);
    }
    ...
    public a.b k0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, PROJECT_EVALUATE, "evaluate_list", hashMap, Boolean.TRUE);
    }
    ...
    public a.b l0(String str, long j, String str2, String str3, String str4, String str5, int i) {
        IpChange ipChange = $ipChange;
        ...
        return e(ta.PROJECT_PAGE, PROJECT_EVALUATE, "enter_circle_" + i, hashMap, Boolean.TRUE);
    }
    ...
    public void l2(View view, String str) {
        ...
        O1(PROJECT_PAGE_WARM_PROMPT, view, str);
    }
    ...
    public a.b m(long j) {
        ...
        hashMap.put("item_id", String.valueOf(j));
        hashMap.put("usercode", d20.E());
        return e(ta.PROJECT_PAGE, "remindme", "cancel", hashMap, Boolean.FALSE);
    }

    public a.b m0(String str, long j, String str2, String str3, String str4, int i) {
        IpChange ipChange = $ipChange;
        ...
        return e(ta.PROJECT_PAGE, PROJECT_EVALUATE, "comment_" + i, hashMap, Boolean.TRUE);
    }

    public a.b m1(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
    ...
    public void m2(View view, String str, long j) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1759735383")) {
            ...
            c.e().G(view, "favorite_cnt", "center", ta.PROJECT_PAGE, hashMap);
        }
    }

    public a.b n0(String str, long j, String str2, String str3, String str4, int i) {
        IpChange ipChange = $ipChange;
        ...
        hashMap.put("titlelabel", str2 + "&" + str3);
        hashMap.put("commenttype", String.valueOf(str4));
        return e(ta.PROJECT_PAGE, PROJECT_EVALUATE, "release_pages_" + i, hashMap, Boolean.FALSE);
    }
    ...
    public void n2(View view, String str, boolean z) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1025507223")) {
            ...
            c.e().G(view, "favorite", "bottom", ta.PROJECT_PAGE, hashMap);
        }
    }

    public a.b o(String str, int i, String str2, String str3) {
        IpChange ipChange = $ipChange;
    ...
    public a.b o0(String str, long j, String str2, String str3, String str4, int i) {
        IpChange ipChange = $ipChange;
        ...
        hashMap.put("titlelabel", str2 + "&" + str3);
        hashMap.put("commenttype", String.valueOf(str4));
        return e(ta.PROJECT_PAGE, PROJECT_EVALUATE, "likes_" + i, hashMap, Boolean.FALSE);
    }

    public a.b o1(String str, String str2, String str3, int i) {
        IpChange ipChange = $ipChange;
    ...
    public void o2(View view, String str, String str2, String str3, int i, String str4) {
        IpChange ipChange = $ipChange;
        ...
        hashMap.put("project_category", str4);
        c e = c.e();
        e.G(view, "artistdetail_" + i, StarIndexFragment.Default_PAGE, ta.PROJECT_PAGE, hashMap);
    }

    public a.b p() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "899271442")) {
            return new a.b().i(ORDER_INVOICE_DETAIL_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("899271442", new Object[]{this});
    }

    public a.b p0(long j, String str, String str2) {
        IpChange ipChange = $ipChange;
        ...
        hashMap.put("usercode", str);
        hashMap.put("titlelabel", str2);
        return e(ta.PROJECT_PAGE, PROJECT_EVALUATE, "my_comment", hashMap, Boolean.TRUE);
    }

    public a.b p1(String str) {
        IpChange ipChange = $ipChange;
    ...
    public void p2(View view, String str, List<PromotionItemBean> list) {
        IpChange ipChange = $ipChange;
        int i = 0;
        if (AndroidInstantRuntime.support(ipChange, "395933185")) {
            ...
            c.e().G(view, "entrance", "top", ta.PROJECT_PAGE, hashMap);
        }
    }
    ...
    public a.b q0(String str, long j, String str2, String str3, String str4, int i) {
        ...
        hashMap.put("titlelabel", str2 + "&" + str3);
        hashMap.put("commenttype", String.valueOf(str4));
        return e(ta.PROJECT_PAGE, PROJECT_EVALUATE, "sharecomment_" + i, hashMap, Boolean.TRUE);
    }

    public a.b q1(String str) {
        IpChange ipChange = $ipChange;
    ...
    public void q2(View view, String str) {
        ...
        hashMap.put("usercode", d20.E());
        hashMap.put("item_id", str);
        c.e().G(view, "ranklist", "center", ta.PROJECT_PAGE, hashMap);
    }
    ...
    public a.b r0(String str, long j, String str2, String str3, String str4, int i) {
        ...
        hashMap.put("titlelabel", str2 + "&" + str3);
        hashMap.put("commenttype", String.valueOf(str4));
        return e(ta.PROJECT_PAGE, PROJECT_EVALUATE, "evaluate_pic_" + i, hashMap, Boolean.TRUE);
    }
    ...
    public void r2(View view, long j, String str) {
        IpChange ipChange = $ipChange;
    ...
    public a.b s(long j) {
        ...
        hashMap.put("item_id", String.valueOf(j));
        hashMap.put("usercode", d20.E());
        return e(ta.PROJECT_PAGE, "details", "video", hashMap, Boolean.TRUE);
    }

    public a.b s0(String str, long j, String str2, String str3, String str4, int i) {
        IpChange ipChange = $ipChange;
        ...
        hashMap.put("titlelabel", str2 + "&" + str3);
        hashMap.put("commenttype", String.valueOf(str4));
        return e(ta.PROJECT_PAGE, PROJECT_EVALUATE, "reply_" + i, hashMap, Boolean.TRUE);
    }
    ...
    public void s2(View view, String str) {
        ...
        hashMap.put("usercode", d20.E());
        hashMap.put("item_id", str);
        c.e().G(view, PROJECT_TICKET_STRATEGY, "center", ta.PROJECT_PAGE, hashMap);
    }
    ...
    public a.b t(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "bottom", "gotoopen_tips", hashMap, Boolean.TRUE);
    }
    ...
    public a.b t0(String str, long j, String str2, String str3, String str4, int i) {
        ...
        hashMap.put("titlelabel", str2 + "&" + str3);
        hashMap.put("commenttype", String.valueOf(str4));
        return e(ta.PROJECT_PAGE, PROJECT_EVALUATE, "portrait_" + i, hashMap, Boolean.TRUE);
    }

    public a.b t1(String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    public void t2(View view, String str, String str2) {
        IpChange ipChange = $ipChange;
        ...
        hashMap.put("item_id", str);
        hashMap.put("titlelabel", str2);
        c.e().G(view, "venuenamebtn", "center", ta.PROJECT_PAGE, hashMap);
    }
    ...
    public a.b u0(long j, int i) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "details", "projectposter_" + i, hashMap, Boolean.TRUE);
    }
    ...
    public a.b u2(String str, InFieldCommentsBean inFieldCommentsBean, int i) {
        IpChange ipChange = $ipChange;
        ...
        return e(ta.PROJECT_PAGE, "tips", str2 + i, hashMap, Boolean.TRUE);
    }

    public a.b v(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
    ...
    public a.b v0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "details", "moreitem", hashMap, Boolean.FALSE);
    }
    ...
    public a.b v2(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
    ...
    public a.b w(String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    public a.b w0(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(str));
        return e(ta.PROJECT_PAGE, str2, str3, hashMap, Boolean.TRUE);
    }

    public a.b w1(String str) {
        IpChange ipChange = $ipChange;
    ...
    public a.b x(String str, String str2, boolean z) {
        IpChange ipChange = $ipChange;
    ...
    public a.b x0(long j, int i) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "details", "itemimages_" + i, hashMap, Boolean.TRUE);
    }
    ...
    public a.b y(String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    public a.b y0(long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "center", "more_service", hashMap, Boolean.FALSE);
    }
    ...
    public a.b z(String str, String str2, String str3, boolean z) {
        IpChange ipChange = $ipChange;
    ...
    public a.b z0(long j) {
        ...
        HashMap hashMap = new HashMap(1);
        hashMap.put("item_id", String.valueOf(j));
        return e(ta.PROJECT_PAGE, "top", "announcement", hashMap, Boolean.FALSE);
    }
