...
public class h03 {
    ...
    private static String a() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "244382864")) {
            return (String) ipChange.ipc$dispatch("244382864", new Object[0]);
        }
        return OrangeConfigCenter.c().b(SWITCH_ORANGE_VIP_URL, SWITCH_ORANGE_VIP_KEY, "");
    }

    private static String b() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1348688996")) {
            return (String) ipChange.ipc$dispatch("1348688996", new Object[0]);
        }
        return OrangeConfigCenter.c().b(SWITCH_ORANGE_VIP_URL, SWITCH_ORANGE_VIP_SECOND_KEY, "");
    }
    ...
    public static boolean d(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-152834927")) {
            return !TextUtils.isEmpty(str) && !"0".equals(str);
        }
        return ((Boolean) ipChange.ipc$dispatch("-152834927", new Object[]{str})).booleanValue();
    }
    ...
    public static void e(Activity activity) {
        ...
        DMNav.from(activity).setTransition(0, 0).toHost(gr.q);
    }
    ...
    public static void g(Context context, Activity activity, String str, MemberAuthPopWindow.ICustomDialogEventListener iCustomDialogEventListener) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-417888479")) {
            ...
            DMNav.from(activity).withExtras(new Bundle()).toUri(gr.f());
        }
    }
    ...
    public static String i() {
        ...
        String str = a;
        String a2 = a();
        g91.c(TAG, "memberUrl form orange [" + a2 + jl1.ARRAY_END_STR);
    ...
    public static String j() {
        ...
        String str = d;
        String b2 = b();
        g91.c(TAG, "memberUrl form orange [" + b2 + jl1.ARRAY_END_STR);
