...
public final class gy0 {
    ...
    @NotNull
    public static final gy0 INSTANCE = new gy0();
    ...
    public final boolean a(int i) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1804145166")) {
            return i >= 50;
        }
        return ((Boolean) ipChange.ipc$dispatch("1804145166", new Object[]{this, Integer.valueOf(i)})).booleanValue();
    }
}
