...
public class c30 {
    ...
    public static c30 a() {
        ...
        return AndroidInstantRuntime.support(ipChange, "-1253178937") ? (c30) ipChange.ipc$dispatch("-1253178937", new Object[0]) : new c30();
    }
    ...
    public View b(Context context, Day day) {
        ...
        if (i == 0) {
            ...
            findViewById2.setPadding(s50.a(context, 3.0f), 0, 0, 0);
            ...
            findViewById.setVisibility(0);
            findViewById2.setVisibility(0);
            findViewById2.setPadding(0, 0, s50.a(context, 3.0f), 0);
        ...
        if (day.showType != 0) {
            ...
            if (day.tipBg != null) {
                ...
                gradientDrawable.setCornerRadius((float) s50.a(context, 4.0f));
