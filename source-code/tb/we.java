...
public class we {
    ...
    public static List<Day> a(List<CalendarEntity> list, List<CalendarYearBean> list2) {
        ...
        if (!e92.d(list)) {
            for (CalendarEntity calendarEntity : list) {
                ...
                List<Day> c = c(calendarEntity.year, calendarEntity.month, null, !e92.e(hashMap3) ? (CalendarMonthBean) hashMap3.get(Integer.valueOf(calendarEntity.month)) : null);
                if (!e92.d(c)) {
                    arrayList.addAll(c);
                }
            }
    ...
    public static List<Day> c(int i, int i2, List<Day> list, CalendarMonthBean calendarMonthBean) {
        ...
        for (int i4 = 1; i4 <= i3; i4++) {
            ...
            if (calendarMonthBean != null && e92.c(calendarMonthBean.days) > 0) {
    ...
    public static String e(int i, int i2, CalendarBean calendarBean) {
        ...
        if (calendarBean != null && e92.c(calendarBean.calendar) > 0) {
            for (int i3 = 0; i3 < calendarBean.calendar.size(); i3++) {
                ...
                if (calendarYearBean != null && calendarYearBean.year == i && e92.c(calendarYearBean.months) > 0) {
    ...
    public static int m() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-299937345")) {
            return ((Integer) ipChange.ipc$dispatch("-299937345", new Object[0])).intValue();
        }
    ...
    public static int n() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1273918737")) {
            return ((Integer) ipChange.ipc$dispatch("1273918737", new Object[0])).intValue();
        }
    ...
    public static int o() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1693831595")) {
            return ((Integer) ipChange.ipc$dispatch("1693831595", new Object[0])).intValue();
        }
    ...
    public static int p() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-829613886")) {
            return ((Integer) ipChange.ipc$dispatch("-829613886", new Object[0])).intValue();
        }
