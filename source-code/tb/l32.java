...
public class l32 {
    ...
    public l32(SvgDecryptBean svgDecryptBean, String str, long j) {
    ...
    public boolean b() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1608852536")) {
            return ((Boolean) ipChange.ipc$dispatch("-1608852536", new Object[]{this})).booleanValue();
        } else if (TextUtils.isEmpty(this.b) || TextUtils.isEmpty(this.c) || TextUtils.isEmpty(this.e) || TextUtils.isEmpty(this.f)) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean c() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-112276534")) {
            return this.a;
        }
        return ((Boolean) ipChange.ipc$dispatch("-112276534", new Object[]{this})).booleanValue();
    }
}
