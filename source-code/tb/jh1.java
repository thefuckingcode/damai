...
public class jh1 {
    ...
    private void d(View view, WishHeaPricetBean wishHeaPricetBean, int i, int i2) {
        ...
        fh1 fh1 = new fh1((LinearLayout) view.findViewById(R$id.layout_heat_icon));
        ...
        fh1.b(wishHeaPricetBean.heat);
    }

    public View a() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "2093833492")) {
            return this.a;
        }
        return (View) ipChange.ipc$dispatch("2093833492", new Object[]{this});
    }
