...
public class k20 {
    ...
    public static BaseResponse a(BaseResponse baseResponse) {
        ...
        if (baseResponse == null || s71.a(baseResponse.layers)) {
            BaseResponse j = jx0.j();
            return j != null ? j : baseResponse;
        }
                ...
                if (!f92.d(sections)) {
                    for (BaseSection baseSection3 : sections) {
                        if (baseSection3 != null) {
                            ...
                            if (TextUtils.equals(wj2.DM_HOME_BANNER_CID, componentId)) {
                                baseLayer = next;
                            } else if (TextUtils.equals(wj2.DM_HOME_FIVE_ENTRY_CID, componentId)) {
                                baseLayer2 = next;
                            }
                        }
                    }
        ...
        if (baseLayer == null || baseLayer2 == null) {
            BaseResponse j2 = jx0.j();
            BaseSection d = jx0.d(wj2.DM_HOME_BANNER_CID, j2);
            baseSection = jx0.d(wj2.DM_HOME_FIVE_ENTRY_CID, j2);
            baseSection2 = d;
        } else {
            baseSection = null;
        }
        ...
        if (!(baseLayer == null || baseLayer2 != null || baseSection == null)) {
            ...
            if (!f92.d(sections3)) {
                ...
                while (true) {
                    ...
                    if (baseSection4 != null && TextUtils.equals(wj2.DM_HOME_BANNER_CID, baseSection4.getComponentId())) {
                        i = i2;
                        break;
                    }
                    i2++;
        ...
        for (int i3 = 0; i3 < baseResponse.layers.size(); i3++) {
            try {
                ...
                if (baseLayer4 != null && !s71.a(baseLayer4.getSections())) {
    ...
    public static int b(BaseResponse baseResponse) {
        ...
        if (baseResponse != null && !s71.a(baseResponse.layers)) {
            for (int i2 = 0; i2 < baseResponse.layers.size(); i2++) {
                ...
                if (baseLayer != null && !s71.a(baseLayer.getSections())) {
    ...
    public static HomeHeaderBg c(HomeConfigBean homeConfigBean) {
        ...
        } else if (homeConfigBean.headLottie == null && homeConfigBean.headStyle == null) {
            return null;
        } else {
    ...
    public static void g(HomeConfigBean homeConfigBean) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-292121640")) {
            ...
            if (rs1.h()) {
                rs1.m();
                rs1.k(JSON.toJSONString(homeConfigBean.agreement));
                return;
            }
            String c = rs1.c();
            ArrayList arrayList = new ArrayList();
            ...
            if (!TextUtils.isEmpty(c)) {
                ...
                if (xf2.e(arrayList) > 0) {
                    if (rs1.d()) {
                        rs1.j(JSON.toJSON(arrayList).toString());
                    } else {
                        try {
                            String b = rs1.b();
                            if (!TextUtils.isEmpty(b)) {
                                ...
                                for (int i = 0; i < xf2.e(arrayList2); i++) {
