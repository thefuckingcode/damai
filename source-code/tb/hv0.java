...
public class hv0 {
    ...
    public hv0(Context context, LayoutInflater layoutInflater) {
        this.a = context;
    ...
    public View a() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-616157236")) {
            return this.b;
        }
        return (View) ipChange.ipc$dispatch("-616157236", new Object[]{this});
    }

    public hv0 c(HnInvoiceApplyInfoResult hnInvoiceApplyInfoResult) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-475680490")) {
            return (hv0) ipChange.ipc$dispatch("-475680490", new Object[]{this, hnInvoiceApplyInfoResult});
        } else if (hnInvoiceApplyInfoResult == null) {
            return this;
        } else {
            this.c.setText(hnInvoiceApplyInfoResult.orderId);
            String str = "¥" + hnInvoiceApplyInfoResult.amount + " (" + hnInvoiceApplyInfoResult.itemMessage + jl1.BRACKET_END_STR;
