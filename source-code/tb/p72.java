...
public class p72 extends ta {
    private static transient /* synthetic */ IpChange $ipChange = null;
    public static final String PROJECT_SITESELECT_PAGE = "seatselect";

    /* compiled from: Taobao */
    private static class a {
        private static final p72 a = new p72();
    }

    public static final p72 l() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-1996080149") ? (p72) ipChange.ipc$dispatch("-1996080149", new Object[0]) : a.a;
    }
    ...
    public void t(UtCalculator utCalculator) {
        ...
        try {
            ...
            c.e().x(e("seatselect", "seat_calculate", "result", hashMap, Boolean.FALSE));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void u(UtDynamic utDynamic) {
        ...
        try {
            ...
            c.e().x(e("seatselect", "dynamic_mtop", "result", hashMap, Boolean.FALSE));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    public void v(UtExtra<vz0> utExtra) {
        IpChange ipChange = $ipChange;
        ...
        try {
            ...
            kl1<Extra> kl1 = utExtra.option;
            HashMap hashMap = new HashMap();
            hashMap.put("success", z + "");
            hashMap.put("itemId", tbParams.itemId + "");
            hashMap.put(TicketDetailExtFragment.PERFORM_ID, tbParams.performId + "");
            hashMap.put("useMemoryCache", "" + kl1.e());
            hashMap.put("picUrl", kl1.d());
            if (!z) {
                hashMap.put("errCode", utExtra.errorCode);
                hashMap.put("errMsg", utExtra.errorMsg);
            }
            c.e().x(e("seatselect", "pic_load", "result", hashMap, Boolean.FALSE));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    public void w(UtExtra<f72> utExtra) {
        IpChange ipChange = $ipChange;
        ...
        try {
            ...
            hashMap.put(TicketDetailExtFragment.PERFORM_ID, tbParams.performId + "");
            hashMap.put("useMemoryCache", "" + kl1.e());
            hashMap.put("seatUrl", kl1.d());
            if (!z) {
                hashMap.put("errCode", utExtra.errorCode);
                hashMap.put("errMsg", utExtra.errorMsg);
            }
            c.e().x(e("seatselect", "seat_load", "result", hashMap, Boolean.FALSE));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void x(UtStatus utStatus) {
        ...
        try {
            ...
            c.e().x(e("seatselect", "status_mtop", "result", hashMap, Boolean.FALSE));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
