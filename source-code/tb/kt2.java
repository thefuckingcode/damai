...
public class kt2 extends b {
    ...
    public kt2(int i, @Nullable String str) {
    ...
    private boolean n(int i) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-395629404")) {
            return i == 2001;
        }
        return ((Boolean) ipChange.ipc$dispatch("-395629404", new Object[]{this, Integer.valueOf(i)})).booleanValue();
    }
    ...
    public a.b f(BannerItem bannerItem, int i) {
        ...
        String str = this.b;
        return e(str, hf1.MODULE_BANNER, "item_" + i, hashMap, Boolean.valueOf(n(2001)));
    }
    ...
    public void m(View view) {
        ...
        HashMap hashMap = new HashMap();
        q(hashMap);
        c.e().G(view, "more", "recent", this.b, hashMap);
    }
