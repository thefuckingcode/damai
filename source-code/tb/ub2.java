...
public class ub2 {
    ...
    public static boolean b(long j) {
        ...
        sb.append("youku|");
        sb.append(j);
        return !TextUtils.isEmpty(d20.B(sb.toString()));
    }
    ...
    public static void c(long j) {
        ...
        PreferenceManager.getDefaultSharedPreferences(xs0.a().getApplicationContext()).edit().remove("sku|" + j).commit();
    }
    ...
    public static void d(long j, SkuSaveInfo skuSaveInfo) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "710730439")) {
            ...
            d20.T("sku|" + j, JSON.toJSONString(skuSaveInfo));
        }
    }
