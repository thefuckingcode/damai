...
public class sj {
    ...
    public static int b(@FloatRange(from = 0.0d, to = 1.0d) float f, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1627474860")) {
            return ((Integer) ipChange.ipc$dispatch("1627474860", new Object[]{Float.valueOf(f), Integer.valueOf(i)})).intValue();
        }
