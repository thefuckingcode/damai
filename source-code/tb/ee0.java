...
public class ee0 implements ResponseErrorPage.ErrorRefreshListener, ErrorControlView {
    ...
    public ee0(ErrorControlView errorControlView) {
        this.c = errorControlView;
    }

    private boolean a() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1438932952")) {
            return (getErrContainer() == null || getErrContainerActivity() == null) ? false : true;
        }
        return ((Boolean) ipChange.ipc$dispatch("1438932952", new Object[]{this})).booleanValue();
    }
    ...
    public void showDialogLoading(boolean z) {
        ...
        try {
            ...
            if (errContainerActivity == null) {
                return;
            }
            if (!errContainerActivity.isFinishing()) {
                if (z) {
                    if (this.d == null) {
