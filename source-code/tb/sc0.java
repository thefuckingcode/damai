...
public class sc0 {
    ...
    public static final String TAG = "sc0";

    public static byte[] a() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "1608349508") ? (byte[]) ipChange.ipc$dispatch("1608349508", new Object[0]) : ui2.d(CMD_GET_UID);
    }
}
