...
public class iy0 implements Html.TagHandler {
    ...
    public iy0(String str, Context context) {
        this.a = str;
        this.e = context;
    }
    ...
    public void a(String str, Editable editable, XMLReader xMLReader) {
        ...
        if (!TextUtils.isEmpty(str3)) {
            try {
                editable.setSpan(new AbsoluteSizeSpan(u50.INSTANCE.b(this.e, Integer.parseInt(str3))), this.b, this.c, 33);
