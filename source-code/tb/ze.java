...
public class ze {
            ...
            if (calendarMonthBean != null && xf2.e(calendarMonthBean.days) > 0) {
                for (int i6 = 0; i6 < calendarMonthBean.days.size(); i6++) {
                    ...
                    if (calendarDayBean != null && calendarDayBean.day == i4) {
                        ...
                        if (xf2.e(calendarDayBean.desc) > 0 && calendarDayBean.desc.get(0) != null) {
    ...
    public static String l() {
        ...
        Calendar instance = Calendar.getInstance(TimeZone.getTimeZone("GMT+8"));
        instance.set(6, instance.get(6) + 29);
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(RetryMonitorDbHelper.DATE_FORMAT, Locale.CHINA);
        simpleDateFormat.setTimeZone(TimeZone.getTimeZone("GMT+08:00"));
        return simpleDateFormat.format(instance.getTime());
    }
    ...
    public static int n() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1118431620")) {
            return ((Integer) ipChange.ipc$dispatch("1118431620", new Object[0])).intValue();
        }
    ...
    public static int p() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "966062188")) {
            return ((Integer) ipChange.ipc$dispatch("966062188", new Object[0])).intValue();
        }
    ...
    public static int q() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "684475911")) {
            return ((Integer) ipChange.ipc$dispatch("684475911", new Object[0])).intValue();
        }
