...
public class uc1 {
    ...
    public static String a(Context context) {
        ...
        try {
            ...
            g91.b("MessageNoticeUtil", e.getMessage());
            return "";
        }
    }
    ...
    private static SharedPreferences b(Context context) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1817827579")) {
            return context.getSharedPreferences("messageNotice", 0);
        }
        return (SharedPreferences) ipChange.ipc$dispatch("1817827579", new Object[]{context});
    }
