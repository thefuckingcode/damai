...
public class xf2 {
    ...
    public static boolean i(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1737719085")) {
            return str != null && str.length() > 0;
        }
        return ((Boolean) ipChange.ipc$dispatch("1737719085", new Object[]{str})).booleanValue();
    }

    public static boolean j(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "337606443")) {
            return str == null || "".equals(str.trim()) || str.trim().length() == 0 || "null".equals(str.trim());
        }
        return ((Boolean) ipChange.ipc$dispatch("337606443", new Object[]{str})).booleanValue();
    }
