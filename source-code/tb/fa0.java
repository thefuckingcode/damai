...
public class fa0 {
    ...
    public fa0(DMComponent dMComponent) {
        this.a = dMComponent;
    }
    ...
    public IDMComponent c() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1246748203")) {
            return this.a;
        }
        return (IDMComponent) ipChange.ipc$dispatch("-1246748203", new Object[]{this});
    }
