...
public class ag1 implements IConverter<BaseResponse, BaseSection, GlobalConfig, List<Node>> {
    private static transient /* synthetic */ IpChange $ipChange;

    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0057, code lost:
        if (android.text.TextUtils.isEmpty(r2) == false) goto L_0x005c;
     */
    /* renamed from: a */
    public List<Node> convert(BaseResponse baseResponse, BaseSection baseSection, GlobalConfig globalConfig, qa qaVar) {
        String str;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1792214578")) {
            return (List) ipChange.ipc$dispatch("1792214578", new Object[]{this, baseResponse, baseSection, globalConfig, qaVar});
        }
        NodeData item = baseSection.getItem();
        if (item != null) {
            item.put("mainTitle", (Object) CardTitleBean.fromTetrisStyle(baseSection.getStyle()).title);
