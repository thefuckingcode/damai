...
public class tq2 {
    ...
    public static synchronized Map<String, String> b(Context context) {
        synchronized (tq2.class) {
            ...
            hashMap.put(LogField.IMEI.toString(), eq1.b(context));
            hashMap.put(LogField.IMSI.toString(), eq1.d(context));
            ...
            try {
                ...
                if (i2 > i) {
                    ...
                    hashMap.put(str, i2 + jl1.MUL + i);
                } else {
                    String str2 = LogField.RESOLUTION.toString();
                    hashMap.put(str2, i + jl1.MUL + i2);
                }
    ...
    private static String c() {
        String a2 = lh2.a("ro.aliyun.clouduuid");
        if (zf2.f(a2)) {
            a2 = lh2.a("ro.sys.aliyun.clouduuid");
        }
        return zf2.f(a2) ? d() : a2;
    }
    ...
    private static boolean h() {
        if ((System.getProperty("java.vm.name") == null || !System.getProperty("java.vm.name").toLowerCase().contains("lemur")) && TextUtils.isEmpty(System.getProperty("ro.yunos.version")) && TextUtils.isEmpty(lh2.a("ro.yunos.build.version"))) {
            return i();
        }
        return true;
    }
    ...
    private static boolean i() {
        return !TextUtils.isEmpty(lh2.a("ro.yunos.product.chip")) || !TextUtils.isEmpty(lh2.a("ro.yunos.hardware"));
    }
