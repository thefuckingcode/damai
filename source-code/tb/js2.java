...
public class js2 {
    ...
    public static String EMAS_PUBLISH = "EmasPublish";
    ...
    public static String UPDATE_EMAS_CONFIG_GROUP = "android_emas_publish";
    ...
    public static String UPDATE_MTOP_OPEN = "open_update_mtop";
}
