...
public class wk extends b {
    ...
    public static wk j() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1877799285")) {
            return (wk) ipChange.ipc$dispatch("1877799285", new Object[0]);
        }
        if (b == null) {
            b = new wk();
        }
    ...
    private a.b m(String str, String str2, String str3, String str4) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1538647952")) {
            return new a.b().k(str3).a(str2).d(str4).i(str);
        }
        return (a.b) ipChange.ipc$dispatch("1538647952", new Object[]{this, str, str2, str3, str4});
    }
    ...
    public a.b h() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-506489548")) {
            return e(FEED_BACK_SCROT_PAGE, FEED_BACK_SCROT_PAGE, "scrot4helpbtn", new HashMap(), Boolean.TRUE);
        }
        return (a.b) ipChange.ipc$dispatch("-506489548", new Object[]{this});
    }

    public a.b i() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1574231525")) {
            return b(FEED_BACK_SCROT_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("1574231525", new Object[]{this});
    }

    public a.b k() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "1426231309")) {
            return b(MY_ALIME_PAGE);
        }
        return (a.b) ipChange.ipc$dispatch("1426231309", new Object[]{this});
    }

    public a.b l(long j) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2147346134")) {
            return m("addbuyperson", null, null, String.valueOf(j));
        }
        return (a.b) ipChange.ipc$dispatch("-2147346134", new Object[]{this, Long.valueOf(j)});
    }

    public a.b n() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-795675066")) {
            return e("home", "performalert", "close", new HashMap(), Boolean.FALSE);
        }
        return (a.b) ipChange.ipc$dispatch("-795675066", new Object[]{this});
    }
