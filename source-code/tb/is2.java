...
public class is2 {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            try {
                ...
                try {
                    file2.delete();
                    if (i == 2) {
                        throw new IOException("Failed to copy file[src=" + file.getAbsolutePath() + ", dest=" + file2.getAbsolutePath() + jl1.ARRAY_END_STR, th);
                    }
                } finally {
                    if (fileChannel2 != null) {
                        fileChannel2.close();
    ...
    public static boolean i(Application application) {
        return g(application) && cy0.b(application);
    }
}
