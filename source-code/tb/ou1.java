...
public class ou1 extends DialogFragment implements View.OnClickListener {
    ...
    public static final ou1 c(ArrayList<ServiceNote> arrayList) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1636862473")) {
            return (ou1) ipChange.ipc$dispatch("1636862473", new Object[]{arrayList});
        }
        ou1 ou1 = new ou1();
        if (arrayList != null) {
            Bundle bundle = new Bundle();
            bundle.putParcelableArrayList("service_notes", arrayList);
            ou1.setArguments(bundle);
        }
        return ou1;
    }
    ...
    public void e(FragmentManager fragmentManager) {
        ...
        try {
            show(fragmentManager, ou1.class.getName());
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        int i = (int) (((double) DisplayMetrics.getheightPixels(n42.b(getActivity()))) * 0.75d);
