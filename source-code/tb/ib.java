...
public class ib implements BigNoteBindListener {
    ...
    private void d(NoteBean noteBean) {
        ...
        if (noteBean.relatedInfo != null) {
            ...
            bundle.putString(p21.ISSUE_PARAM_LIVE_THEME_NAME, noteBean.relatedInfo.value);
        }
        ...
        bundle.putString(p21.ISSUE_PARAM_COMMENT_ID, noteBean.sourceId);
    ...
    private void e(NoteBean noteBean) {
        ...
        try {
            ...
            bundle.putInt("targetType", lk1.j(noteBean.subType, 1));
    ...
    public void c(NoteBean noteBean, int i) {
        ...
        NavProxy.from(this.a).withExtras(bundle).toUri(INavUri.page(gr.DISCOVER_CONTENT_DETAIL));
    }
