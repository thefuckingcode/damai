...
public class xw1 implements IConverter<BaseResponse, BaseSection, GlobalConfig, List<Node>> {
    ...
    public List<Node> convert(BaseResponse baseResponse, BaseSection baseSection, GlobalConfig globalConfig, qa qaVar) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1031851160")) {
            return (List) ipChange.ipc$dispatch("-1031851160", new Object[]{this, baseResponse, baseSection, globalConfig, qaVar});
        }
        ...
        if (jSONArray.size() > 0) {
            for (int i = 0; i < jSONArray.size(); i++) {
                ...
                if (jSONObject != null) {
                    ...
                    baseSection.setComponentId(wj2.RANK_PROJECT_C_ID);
