...
public class gz0 extends YoukuPlayer {
    private static transient /* synthetic */ IpChange $ipChange;
    IYoukuPlayer a;
    private boolean b = false;

    public gz0(IYoukuPlayer iYoukuPlayer) {
        this.a = iYoukuPlayer;
    }

    public boolean a() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-338617548")) {
            return this.b;
        }
        return ((Boolean) ipChange.ipc$dispatch("-338617548", new Object[]{this})).booleanValue();
    }
    ...
    public boolean isPaused() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "258923305")) {
            return this.a.isPaused();
        }
        return ((Boolean) ipChange.ipc$dispatch("258923305", new Object[]{this})).booleanValue();
    }

    @Override // com.youku.youkuplayer.YoukuPlayer, com.youku.youkuplayer.IYoukuPlayer
    public boolean isStarted() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-2086575238")) {
            return this.a.isStarted();
        }
        return ((Boolean) ipChange.ipc$dispatch("-2086575238", new Object[]{this})).booleanValue();
    }
    ...
    public void start() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1601419051")) {
            ...
            g91.c(DMVideoPlayer.TAG, "player start : getSessionId=" + this.a.getSessionId());
            this.a.start();
        } else {
            g91.c(DMVideoPlayer.TAG, "player 为null");
        }
    }
