...
public class f81 extends za {
    ...
    public static void l(View view, String str, String str2, String str3, String str4, String str5) {
        ...
        za.f(hashMap);
        za.h("titlelabel", str4, hashMap);
        za.h("item_id", str5, hashMap);
        za.g(hashMap);
        c.e().G(view, str3, str2, str, hashMap);
    }
    ...
    public static void m(View view, int i, String str) {
        ...
        za.f(hashMap);
        za.g(hashMap);
        za.h("titlelabel", "关注", hashMap);
        za.h("rec_usercode", str, hashMap);
        c e = c.e();
    ...
    public static void n(View view, String str, int i) {
        ...
        za.g(hashMap);
        za.h("titlelabel", "关注", hashMap);
        za.h(za.PRE_CONTENT_ID, str, hashMap);
    ...
    public static void o(View view, String str, int i, String str2, String str3, int i2, CardType cardType) {
        ...
        HashMap hashMap = new HashMap();
        za.f(hashMap);
        za.h("titlelabel", str2, hashMap);
        za.g(hashMap);
        if (cardType != null) {
            za.h(za.PRE_CONTENT_TYPE, cardType.name(), hashMap);
            za.h(za.PRE_CONTENT_ID, str3, hashMap);
        } else {
            za.h("item_id", str3, hashMap);
        }
        c.e().G(view, "card_" + i2, "favorite_tab_" + i, str, hashMap);
    }
    ...
    public static void p(View view, String str, int i, String str2, String str3, int i2, CardType cardType, String str4, String str5) {
        ...
        za.h("titlelabel", str2, hashMap);
        za.g(hashMap);
        za.h("type", str4, hashMap);
        if (!TextUtils.isEmpty(str5)) {
            za.h("discount_type", str5, hashMap);
        }
        if (cardType != null) {
            za.h(za.PRE_CONTENT_TYPE, cardType.name(), hashMap);
            za.h(za.PRE_CONTENT_ID, str3, hashMap);
    ...
    public static f81 u() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-974419077")) {
            return (f81) ipChange.ipc$dispatch("-974419077", new Object[0]);
        }
        if (b == null) {
            b = new f81();
        }
    ...
    public a.b A(String str, @Nullable String str2, int i, String str3, int i2, String str4) {
        ...
        HashMap hashMap = new HashMap();
        za.f(hashMap);
        za.h("titlelabel", str3, hashMap);
        za.g(hashMap);
        za.h("type", str4 + "", hashMap);
        if (!TextUtils.isEmpty(str2)) {
            za.h("item_id", str2, hashMap);
        }
        return e(str, "favorite_tab_" + i, "card_" + i2, hashMap, Boolean.valueOf(za.i(2001)));
    }
    ...
    public a.b E(String str, int i, String str2) {
        ...
        za.g(hashMap);
        za.h("titlelabel", str2, hashMap);
        return e(str, "favorite_tab", "tab_" + i, hashMap, Boolean.valueOf(za.i(2101)));
    }
