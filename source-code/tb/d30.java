...
public class d30 {
    ...
    public static d30 a() {
        ...
        return AndroidInstantRuntime.support(ipChange, "-720859983") ? (d30) ipChange.ipc$dispatch("-720859983", new Object[0]) : new d30();
    }
    ...
    public View b(Context context, Day day) {
        ...
        if (i == 0) {
            ...
            findViewById2.setPadding(l42.a(context, 3.0f), 0, 0, 0);
            ...
            findViewById.setVisibility(0);
            findViewById2.setVisibility(0);
            findViewById2.setPadding(0, 0, l42.a(context, 3.0f), 0);
        ...
        if (day.showType != 0) {
            ...
            if (day.tipBg != null) {
                ...
                gradientDrawable.setCornerRadius((float) l42.a(context, 4.0f));
