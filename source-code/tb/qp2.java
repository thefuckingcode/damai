...
public class qp2 implements UINotify {
    private a a;
    ...
    public static class a {
        ...
        public void error(String str) {
            if (ns2.isNotificationPermissioned()) {
                this.e.setContentText(ns2.getAppNameString(R$string.update_notification_fail, UpdateRuntime.sAppName)).setProgress(0, 0, false).setSmallIcon(UpdateRuntime.sLogoResourceId);
                if (Build.VERSION.SDK_INT >= 26) {
        ...
        public void finish(String str) {
            if (ns2.isNotificationPermissioned()) {
                this.e.setContentTitle("点击安装").setContentText(ns2.getAppNameString(R$string.update_notification_finish, UpdateRuntime.sAppName)).setSmallIcon(UpdateRuntime.sLogoResourceId);
        ...
        public void updateProgress(int i) {
            if (ns2.isNotificationPermissioned()) {
                ...
                contentTitle.setContentText(ns2.getAppNameString(R$string.update_notification_downloading, UpdateRuntime.sAppName) + i + "%").setSmallIcon(UpdateRuntime.sLogoResourceId);
                ...
                if (i == 100) {
                    ...
                    this.e.setContentTitle("更新包校验中...").setContentText(ns2.getAppNameString(R$string.update_notification_finish, UpdateRuntime.sAppName)).setSmallIcon(UpdateRuntime.sLogoResourceId);
                    if (i2 >= 26) {
                        this.e.setChannelId(this.b);
                    }
                    this.e.setProgress(0, 0, false);
