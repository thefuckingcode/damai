...
public class ma0 extends cn.damai.common.user.b {
    ...
    private static class b {
        private static final ma0 a = new ma0();
    }

    public static final ma0 u() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "581874523") ? (ma0) ipChange.ipc$dispatch("581874523", new Object[0]) : b.a;
    }
    ...
    public a.b A(Context context) {
        ...
        hashMap.put("item_id", String.valueOf(w90.b(context)));
    ...
    public a.b D(Context context) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", w90.b(context) + "");
    ...
    public a.b h(boolean z, String str, String str2) {
        ...
        return e(z ? DM_PURCHASE_PAGE : ln2.ORDER_DETAL_PAGE, "answersdiv", "ticketanswertab", hashMap, Boolean.FALSE);
    }
    ...
    public a.b n(Context context) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", w90.b(context) + "");
        hashMap.put("is_seat", w90.a(context) ? "1" : "0");
