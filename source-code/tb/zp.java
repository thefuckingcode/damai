...
public abstract class zp implements FlutterPlugin, ActivityAware, MethodChannel.MethodCallHandler {
    ...
    public DMBaseFlutterActivity b() {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "1703900377")) {
            return this.b;
        }
        return (DMBaseFlutterActivity) ipChange.ipc$dispatch("1703900377", new Object[]{this});
    }
