...
public class a90 {
    ...
    public static String[][] c = {new String[]{ju2.e(203119206064L), ju2.e(203119211219L)}, new String[]{ju2.e(106011052006L)}, null};
    public static String[][] d = {new String[]{ju2.g("7f1*-00f-1004-8042"), ju2.g("77*-01f-1004-8042")}, new String[]{ju2.g("7f1*-00f-1004-8042"), ju2.g("77*-01f-1004-8042")}, null};
    public static final String serverPath = "/amdc/mobileDispatch";

    public static String a() {
        return b[ss0.e().getEnvMode()];
    }

    public static String[] b() {
        return c[ss0.e().getEnvMode()];
    }

    public static String[] c() {
        return d[ss0.e().getEnvMode()];
    }
