...
public class ke2 implements StateViewManager.IStateViewDelegate {
    ...
    public RefreshInternal createLoadingFooterView(@Nullable Activity activity) {
        ...
        if (!AndroidInstantRuntime.support(ipChange, "959039168")) {
            return new SimpleFooter(activity);
        }
        return (RefreshInternal) ipChange.ipc$dispatch("959039168", new Object[]{this, activity});
    }
    ...
    public RefreshInternal createLoadingHeaderView(@Nullable Activity activity) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "763051954")) {
            return new SimpleHeader(activity);
        }
        return (RefreshInternal) ipChange.ipc$dispatch("763051954", new Object[]{this, activity});
    }
    ...
    public void showLoadingDialog(@Nullable Activity activity, @Nullable String str, boolean z) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1568169031")) {
            ...
            try {
                ...
                DMProgressDialogV2 dMProgressDialogV2 = this.a;
                if (dMProgressDialogV2 != null && !dMProgressDialogV2.isShowing() && !activity.isFinishing()) {
