...
public class ne2 {
    ...
    private static boolean b() {
        ...
        try {
            ...
            String str = (String) cls.getDeclaredMethod(gl1.TYPE_OPEN_URL_METHOD_GET, String.class).invoke(cls, "ro.miui.ui.version.name");
            if (!str.contains("V") || Integer.parseInt(str.substring(str.indexOf("V") + 1)) < 6) {
                return false;
            }
            return true;
        } catch (Exception e) {
