...
public class am2 {
    ...
    public static void a(String str, String str2) {
        if (c) {
            ...
            if (l != null && l.longValue() > 0) {
                tr2.b(TAG, "结束-" + str + ": " + str2 + ", 耗时: " + (currentTimeMillis - l.longValue()));
            }
            if (l2 != null && l2.longValue() > 0) {
                long longValue = currentTimeMillis - l2.longValue();
                tr2.b(TAG, "从开始到结束" + str + ": " + str2 + ", 总耗时: " + longValue);
            }
            b.remove(str);
            a.remove(str);
        }
    ...
    public static void c(String str, String str2) {
        if (c) {
            ...
            if (l == null || l.longValue() <= 0) {
                tr2.b(TAG, "过程-" + str + ": " + str2 + ", no time");
            } else {
                tr2.b(TAG, "过程-" + str + ": " + str2 + ", 耗时: " + (currentTimeMillis - l.longValue()));
            }
    ...
    public static void d(String str, String str2) {
        if (c) {
            ...
            Long l = a.get(str);
            if (l == null) {
                tr2.b(TAG, "开始至过程-" + str + ": " + str2 + ", no time");
                return;
            }
            if (l.longValue() > 0) {
                tr2.b(TAG, "开始至过程-" + str + ": " + str2 + ", 耗时: " + (currentTimeMillis - l.longValue()));
            }
            b.put(str, Long.valueOf(currentTimeMillis));
        }
    }
