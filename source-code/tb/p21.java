...
public class p21 {
    public static final String ISSUE_FROM = "issue_from";
    public static final String ISSUE_FROM_HOME = "homepage";
    ...
    public static final String ISSUE_PARAM_COMMENT_TYPE_SCRIPT = "66";
    public static final String ISSUE_PARAM_EVALUATE_TIME_ADDRESS = "timeAddress";
    ...
    public static final String ISSUE_PARAM_LIVE_CIRCLE_ID = "circleId";
    public static final String ISSUE_PARAM_LIVE_CIRCLE_NAME = "circleName";
    public static final String ISSUE_PARAM_LIVE_THEME_ID = "themeId";
    public static final String ISSUE_PARAM_LIVE_THEME_NAME = "themeName";
    public static final String ISSUE_PARAM_ORDER_ID = "uniqueOrderId";
    public static final String ISSUE_PARAM_PERFORM_BEGIN_TIMR = "perform_beginTime";
    public static final String ISSUE_PARAM_PERFORM_TIMR = "performTime";
    ...
    public static final String ISSUE_PARAM_SCRIPT_ID = "scriptId";
    public static final String ISSUE_PARAM_STORE_ID = "storeId";
    public static final String ISSUE_PARAM_STORE_POSTER = "itemType";
    ...
    public static final String ISSUE_PARAM_TIMEDES = "timeDes";
    public static final String ISSUE_PARAM_TOAST_SWITCH = "isShowToast";
    public static final String ISSUE_PARAM_WATCH_ACTIVITY_ID = "watchActivityId";
    public static final String ISSUE_TEACH_GOOD_URL = "https://t.damai.cn/yep/page/m/youzhipingjia";
    ...
    public static String a = "issue_guide_show";
