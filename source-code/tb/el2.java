...
public class el2 {
    ...
    public static el2 b() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1211099227")) {
            return (el2) ipChange.ipc$dispatch("1211099227", new Object[0]);
        }
        if (f == null) {
            f = new el2();
        }
    ...
    public int c(String str) {
        ...
        } else if (str == null || !this.c.containsKey(str)) {
            return 1;
        } else {
    ...
    public int d(String str) {
        ...
        } else if (str == null || !this.a.containsKey(str)) {
    ...
    public int e(String str) {
        ...
        } else if (str == null || !this.b.containsKey(str)) {
            return 1;
        } else {
    ...
    public boolean g() {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-327838972")) {
            return f() > 600;
        }
        return ((Boolean) ipChange.ipc$dispatch("-327838972", new Object[]{this})).booleanValue();
    }
