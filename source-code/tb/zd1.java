...
public class zd1 {
    ...
    public static UserCenterDataBean b() {
        ...
        try {
            return (UserCenterDataBean) JSON.parseObject(d20.D(E), UserCenterDataBean.class);
    ...
    public static void e(UserCenterDataBean userCenterDataBean) {
        ...
        if (d() && !TextUtils.isEmpty(E) && userCenterDataBean != null) {
            if (userCenterDataBean.getUserInfo() != null) {
                ...
                d20.T(Login.getHeadPicLink(), str);
            }
            d20.w0(E, JSON.toJSONString(userCenterDataBean));
    ...
    public static void f(FragmentActivity fragmentActivity) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "24777046")) {
            ...
            try {
                ...
                n3.a("damai_member", "member_service_start", "mine_sync", e.getMessage());
            }
        }
    }
