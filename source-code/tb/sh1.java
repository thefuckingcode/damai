...
public class sh1 {
    ...
    public static boolean G(yy0 yy0) {
        ConcurrentHashMap<String, List<String>> concurrentHashMap;
        List<String> list;
        if (yy0 == null || (concurrentHashMap = s) == null || (list = concurrentHashMap.get(yy0.d())) == null) {
            return false;
        }
        if (list == l) {
            return true;
    ...
    public static boolean H(yy0 yy0) {
        ConcurrentHashMap<String, List<String>> concurrentHashMap;
        List<String> list;
        if (yy0 == null || (concurrentHashMap = j) == null || (list = concurrentHashMap.get(yy0.d())) == null) {
            return false;
        }
        if (list == l) {
            return true;
    ...
    public static void a0(String str) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                ...
                String string = jSONObject.getString(fw0.VALUE_MODEL_DEFAULT);
                if (!TextUtils.isEmpty(string)) {
                    Context c2 = ss0.c();
                    Boolean j2 = c.j(c2, "network_multi_path_" + string);
                    if (j2 != null) {
                        if (j2.booleanValue()) {
                            ...
                            JSONArray optJSONArray = jSONObject.optJSONArray(b.l);
    ...
    public static void e() {
        ...
        h = defaultSharedPreferences.getLong("Cache.Flag", 0);
        ...
        B = defaultSharedPreferences.getLong(MULTI_PATH_TRIGGER_TIME, 1500);
    ...
    public static boolean f(yy0 yy0) {
        List<String> list;
        ConcurrentHashMap<String, List<String>> concurrentHashMap = t;
        if (concurrentHashMap != null && concurrentHashMap.size() > 0 && (list = concurrentHashMap.get(yy0.d())) != null && list.size() > 0) {
            if (list == l) {
                return true;
            }
            for (String str : list) {
    ...
    public static boolean x(yy0 yy0) {
        if (yy0 == null) {
            return false;
        }
        return z(yy0) || y(yy0);
    ...
    private static boolean y(yy0 yy0) {
        List<Pair<String, String>> list;
        ConcurrentHashMap<String, List<Pair<String, String>>> concurrentHashMap = F;
        if (concurrentHashMap == null || (list = concurrentHashMap.get(yy0.d())) == null) {
            return false;
        }
        for (Pair<String, String> pair : list) {
            if (yy0.h().startsWith((String) pair.first)) {
    ...
    private static boolean z(yy0 yy0) {
        List<String> list;
