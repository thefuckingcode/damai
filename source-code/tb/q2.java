...
public class q2 {
    ...
    public static void a(String str, String str2, long j, double d) {
        ...
        if (!a) {
            a = true;
            n3.c("damai_member", "ticklet_accs_exchange_stat", MeasureSet.create().addMeasure("loadTime").addMeasure("userCode"), DimensionSet.create().addDimension("result").addDimension("baseType"));
        }
        DimensionValueSet create = DimensionValueSet.create();
        create.setValue("result", str);
        create.setValue("baseType", str2);
        MeasureValueSet create2 = MeasureValueSet.create();
        create2.setValue("loadTime", (double) j);
        create2.setValue("userCode", d);
        n3.b("damai_member", "ticklet_accs_exchange_stat", create, create2);
    }
}
