...
public class mi0 {
    ...
    public static mi0 a() {
        ...
        return AndroidInstantRuntime.support(ipChange, "-1720546012") ? (mi0) ipChange.ipc$dispatch("-1720546012", new Object[0]) : new mi0("drama", "selectbtn");
    }
    ...
    public void e(FilterMainBean filterMainBean, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-905775864")) {
            ...
            HashMap<String, String> f = a03.f();
            a03.b(f, filterMainBean.name);
            TrackProxy.ITrack a2 = TrackProxy.a();
            TrackType trackType = TrackType.click;
            String str = this.a;
            String str2 = this.b;
            a2.userTrack(trackType, null, str, str2, "sorttype_" + i, f, false);
        }
    }
    ...
    public void f(int i, String str) {
        ...
        String str2 = this.a;
        String str3 = this.b;
        a2.userTrack(trackType, null, str2, str3, "timerange_" + i, f, false);
    }
    ...
    public void g(FilterTagBean filterTagBean, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "892336223")) {
            ...
            HashMap<String, String> f = a03.f();
            a03.b(f, filterTagBean.name);
            TrackProxy.ITrack a2 = TrackProxy.a();
            TrackType trackType = TrackType.click;
            String str = this.a;
            String str2 = this.b;
            a2.userTrack(trackType, null, str, str2, "type_" + i, f, false);
        }
    }
}
