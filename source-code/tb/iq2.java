...
public class iq2 {
    ...
    public static void b(String str) {
        ...
        if (a2 != null && !a2.isEmpty()) {
            ...
            br2.d(a2.get("kn"));
            br2.e(a2.get("v"));
            br2.f(a2.get(br2.TYPE_FAR));
            UTAnalytics.getInstance().getDefaultTracker().addTPKItem(br2);
        }
    }
    ...
    public static void j(Context context, String str) {
        ...
        try {
            ...
            if (context != null) {
                ...
                q91.e(null, "cannot get pageObject");
            }
            h(context, a2);
            i(context);
        } catch (Throwable th) {
