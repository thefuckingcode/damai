...
public class vk implements VideoListener {
    ...
    public vk(Context context, ProxyVideoView proxyVideoView, String str, String str2) {
        this.a = context;
    ...
    public void onMuteClick(@Nullable VideoInfo videoInfo, boolean z) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1849963119")) {
            ...
            zw0.B().R(this.b, this.c, str, !z ? 1 : 0);
        }
    }
    ...
    public void onVideoEnd(ApiPlayer apiPlayer, VideoInfo videoInfo, int i) {
        ...
        zw0.B().P(this.b, this.c, "playend", null, videoInfo, (long) i, apiPlayer.getSessionId());
    }
    ...
    public void onVideoPlay(ApiPlayer apiPlayer, VideoInfo videoInfo, int i) {
        ...
        zw0.B().Q(this.b, this.c, "playstart", null, videoInfo, true, this.d.getSessionId());
    }
}
