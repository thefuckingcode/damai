...
public class hf1 {
    ...
    public static boolean b(String str) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1064441408")) {
            return ((Boolean) ipChange.ipc$dispatch("-1064441408", new Object[]{str})).booleanValue();
        } else if (TextUtils.isEmpty(str) || a.get(str) == null) {
            return false;
        } else {
            return true;
        }
