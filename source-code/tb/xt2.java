...
public final class xt2 {
    ...
    public static void a(Path path, float f2, float f3, float f4) {
        ...
        if (f2 == 1.0f && f3 == 0.0f) {
            ...
            if (min >= length && max >= length) {
                min = (float) he1.g(min, length);
                max = (float) he1.g(max, length);
            }
            if (min < 0.0f) {
                min = (float) he1.g(min, length);
            }
    ...
    public static void b(Path path, @Nullable n nVar) {
        if (nVar != null && !nVar.f()) {
    ...
    public static void n(Canvas canvas, RectF rectF, Paint paint, int i) {
        k61.a("Utils#saveLayer");
        if (Build.VERSION.SDK_INT < 23) {
            canvas.saveLayer(rectF, paint, i);
        } else {
            canvas.saveLayer(rectF, paint);
        }
        k61.b("Utils#saveLayer");
    }
}
