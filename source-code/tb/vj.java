...
public class vj {
    ...
    public static String b(String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "481647836")) {
            ...
            try {
                String[] split = str.replace("rgba(", "").replace(jl1.BRACKET_END_STR, "").split(",");
    ...
    private static String c(double d, int i, int i2, int i3) {
        ...
        String a = a(Integer.toHexString((int) Math.round((((double) Math.round(d * 100.0d)) / 100.0d) * 255.0d)).toUpperCase());
