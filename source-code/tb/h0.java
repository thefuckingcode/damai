...
public class h0 implements Cache {
    ...
    public Cache.Entry get(String str) {
        ...
        try {
            IAVFSCache a2 = a();
            if (a2 != null) {
                return (Cache.Entry) a2.objectForKey(ag2.h(str));
            }
        } catch (Exception e) {
    ...
    public void put(String str, Cache.Entry entry) {
        if (a) {
            try {
                IAVFSCache a2 = a();
                if (a2 != null) {
                    a2.setObjectForKey(ag2.h(str), entry, (IAVFSCache.OnObjectSetCallback) b);
                }
            } catch (Exception e) {
    ...
    public void remove(String str) {
        if (a) {
            try {
                IAVFSCache a2 = a();
                if (a2 != null) {
                    a2.removeObjectForKey(ag2.h(str), (IAVFSCache.OnObjectRemoveCallback) c);
                }
            } catch (Exception e) {
