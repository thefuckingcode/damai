...
public class dz {
    ...
    public static FalcoStage g(FalcoSpan falcoSpan, @Nullable JSONObject jSONObject) {
        if (falcoSpan != null) {
            try {
                if (k(jSONObject)) {
                    return falcoSpan.customStage(r41.c(jSONObject, TLogEventConst.PARAM_UPLOAD_STAGE, ""));
                }
            } catch (Throwable th) {
                vx.b(th);
            }
    ...
    public static void h(FalcoStage falcoStage) {
        if (falcoStage != null) {
            try {
                ry.g("DXOpenTracerUtil", "finishStage： " + falcoStage.name());
    ...
    public static boolean k(@Nullable JSONObject jSONObject) {
        return !TextUtils.isEmpty(r41.c(jSONObject, TLogEventConst.PARAM_UPLOAD_STAGE, ""));
    }
    ...
    public static void r(FalcoStage falcoStage) {
        if (falcoStage != null) {
            try {
                ry.g("DXOpenTracerUtil", "startStage： " + falcoStage.name());
