...
public class f5 {
    ...
    public class a implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            try {
                ...
                Log.e(f5.a, "Google Play Services is not installed, unable to download VrCore.");
            }
        }
    }
    ...
    private static int b(Context context) {
        ...
        while (true) {
            if (it.hasNext()) {
                if (((ApplicationInfo) it.next()).packageName.equals("com.google.vr.vrcore")) {
                    z = true;
                    break;
                }
            } else {
    ...
    public static void j(int i) {
        if (d()) {
            try {
                Method method = ActivityManager.class.getMethod("setVrThread", Integer.TYPE);
                try {
