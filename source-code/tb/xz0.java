...
public class xz0 {
    ...
    public xz0(Application application, IImageStrategySupport iImageStrategySupport) {
        this.a = iImageStrategySupport;
        TaobaoImageUrlStrategy.getInstance().initDip(application);
        u91.e(u91.COMMON_TAG, "construct ImageInitBusinss with IImageStrategySupport(webp support:%b)", Boolean.valueOf(this.a.isSupportWebP()));
    }
    ...
    public static xz0 e(Application application, IImageStrategySupport iImageStrategySupport) {
        if (d == null) {
            d = new xz0(application, iImageStrategySupport);
        }
        return d;
    }
