...
public abstract class ji1 extends i32 {
    ...
    public PriceSummary f(@Nullable ArrayList<PriceSummary> arrayList, @Nullable PriceLevel priceLevel) {
        ...
        if (!f92.d(arrayList) && priceLevel != null) {
    ...
    public ArrayList<PriceSummary> g(String str) {
        ...
        if (priceInfo == null || f92.f(priceInfo.standColor)) {
            return null;
        }
    ...
    public Region h(String str) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "248973599")) {
            return this.d.get(str);
        }
        return (Region) ipChange.ipc$dispatch("248973599", new Object[]{this, str});
    }
}
