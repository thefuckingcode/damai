...
public class yb0 {
    ...
    public static void b(boolean z) {
        ...
        r21.g(z, System.currentTimeMillis() - a);
    }
    ...
    public static boolean c(DraftExtra draftExtra, DraftExtra draftExtra2) {
        ...
        } else if (draftExtra == draftExtra2) {
            return true;
        } else {
            if (draftExtra == null || draftExtra2 == null || !d(draftExtra.targetId, draftExtra2.targetId) || !d(draftExtra.projectName, draftExtra2.projectName) || !d(draftExtra.imageUrl, draftExtra2.imageUrl) || !d(draftExtra.timeAddress, draftExtra2.timeAddress) || !d(draftExtra.privilegeType, draftExtra2.privilegeType)) {
                return false;
            }
            return true;
        }
    ...
    public static boolean d(String str, String str2) {
        IpChange ipChange = $ipChange;
        if (!AndroidInstantRuntime.support(ipChange, "-1446738308")) {
            return TextUtils.equals(str, str2);
        }
        return ((Boolean) ipChange.ipc$dispatch("-1446738308", new Object[]{str, str2})).booleanValue();
    }
    ...
    public static void f(Activity activity, OnDialogListener onDialogListener) {
        ...
        new f4(activity).e("将此次编辑保留？").h("保留", new d(onDialogListener)).f("不保留", new c(onDialogListener)).c(false).j();
        a = System.currentTimeMillis();
    }
