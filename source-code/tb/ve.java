...
public class ve {
    ...
    public static List<Day> c(int i, int i2, List<Day> list, CalendarMonthBean calendarMonthBean) {
        ...
        for (int i4 = 1; i4 <= i3; i4++) {
            ...
            if (calendarMonthBean != null && xf2.e(calendarMonthBean.days) > 0) {
    ...
    public static String e(int i, int i2, CalendarBean calendarBean) {
        ...
        if (calendarBean != null && xf2.e(calendarBean.calendar) > 0) {
            for (int i3 = 0; i3 < calendarBean.calendar.size(); i3++) {
                ...
                if (calendarYearBean != null && calendarYearBean.year == i && xf2.e(calendarYearBean.months) > 0) {
    ...
    public static int k() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1075654390")) {
            return ((Integer) ipChange.ipc$dispatch("-1075654390", new Object[0])).intValue();
        }
    ...
    public static int m() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1400753318")) {
            return ((Integer) ipChange.ipc$dispatch("1400753318", new Object[0])).intValue();
        }
    ...
    public static int n() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1627212938")) {
            return ((Integer) ipChange.ipc$dispatch("-1627212938", new Object[0])).intValue();
        }
        return Calendar.getInstance(TimeZone.getTimeZone("GMT+8")).get(7);
    }

    public static int o() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "144308877")) {
            return ((Integer) ipChange.ipc$dispatch("144308877", new Object[0])).intValue();
        }
    ...
    public static List<Day> p() {
        ...
        if (n() != 1) {
            ...
            instance2.set(7, 7);
            arrayList.add(new Day(instance2.get(1), instance2.get(2) + 1, instance2.get(5)));
        }
        Calendar instance3 = Calendar.getInstance(TimeZone.getTimeZone("GMT+8"));
        instance3.setFirstDayOfWeek(2);
        instance3.set(7, 1);
        arrayList.add(new Day(instance3.get(1), instance3.get(2) + 1, instance3.get(5)));
        return arrayList;
    }
    ...
    public static String q(long j, long j2) {
        ...
        long elapsedRealtime = j + (SystemClock.elapsedRealtime() - fm2.a);
        ...
        instance.set(12, 0);
        instance.set(13, 0);
        Calendar instance2 = Calendar.getInstance(TimeZone.getTimeZone("GMT+08:00"));
        instance2.setTimeInMillis(j2);
        instance2.set(10, 0);
        instance2.set(12, 0);
        instance2.set(13, 0);
        int timeInMillis = (int) (((instance2.getTimeInMillis() - instance.getTimeInMillis()) + DanmakuFactory.DEFAULT_DANMAKU_DURATION_V) / 86400000);
        ...
        if (timeInMillis == 0) {
            ...
            String str = instance2.get(7) == 7 ? "周六" : "";
    ...
    public static boolean r(int i, int i2) {
        ...
        Calendar instance = Calendar.getInstance(TimeZone.getTimeZone("GMT+8"));
        return instance.get(2) + 1 == i2 && instance.get(1) == i;
    }
