...
public class SwitchConfigManager {
    ...
    /* compiled from: Taobao */
    public static class SwitchConfigManagerInstanceHolder {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v8, resolved type: java.util.Map<java.lang.String, java.lang.String> */
    ...
    public void updateErrorMappingConfig() {
        ...
        if (StringUtils.isNotBlank(RemoteConfig.getInstance().errorMappingMsg)) {
            try {
                Map map = (Map) JSON.parseObject(RemoteConfig.getInstance().errorMappingMsg, new TypeReference<Map<String, String>>() {
                    /* class mtopsdk.config.baseswitch.SwitchConfigManager.AnonymousClass2 */
                }, new Feature[0]);
                if (map != null) {
    ...
    public void updateIndividualApiLockIntervalMap() {
        ...
        if (!StringUtils.isBlank(RemoteConfig.getInstance().individualApiLockInterval)) {
            try {
                Map map = (Map) JSON.parseObject(RemoteConfig.getInstance().individualApiLockInterval, new TypeReference<Map<String, String>>() {
                    /* class mtopsdk.config.baseswitch.SwitchConfigManager.AnonymousClass1 */
                }, new Feature[0]);
                if (map != null) {
                    for (Map.Entry entry : map.entrySet()) {
