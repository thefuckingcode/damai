...
public class ProductSignImpl extends AbstractSignImpl {
    ...
    private void initUmidToken(String str, String str2) {
        ...
        try {
            ...
            if (uMIDComp != null) {
                uMIDComp.initUMID(str, getEnv(), str2, new IUMIDInitListenerEx() {
                    /* class mtopsdk.security.ProductSignImpl.AnonymousClass1 */
                    ...
                    public void onUMIDInitFinishedEx(String str, int i) {
                        if (i == 200) {
                            ...
                            TBSdkLog.i(ProductSignImpl.TAG, instanceId + " [initUmidToken]IUMIDComponent initUMID succeed,UMID token=" + str);
                            return;
                        }
    ...
    public void init(@NonNull MtopConfig mtopConfig) {
        ...
        try {
            ...
            SecurityGuardManager instance = SecurityGuardManager.getInstance(this.mtopConfig.context);
            this.sgMgr = instance;
            String appKeyByIndex = instance.getStaticDataStoreComp().getAppKeyByIndex(mtopConfig.appKeyIndex, getAuthCode());
