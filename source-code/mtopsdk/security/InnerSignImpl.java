...
public class InnerSignImpl extends AbstractSignImpl {
        ...
        try {
            ...
            if (uMIDComp != null) {
                ...
                uMIDComp.initUMID(str, env, str2, new IUMIDInitListenerEx() {
                    /* class mtopsdk.security.InnerSignImpl.AnonymousClass2 */
    ...
    @Override // mtopsdk.security.ISign, mtopsdk.security.AbstractSignImpl
                    ...
                    if (sign != null) {
                        if (!sign.isEmpty()) {
                            ...
                            try {
                                ...
                                e2 = e4;
                                str2 = remove;
                                TBSdkLog.e(TAG, getInstanceId() + " [getSign]get sign failed and SecException errorCode " + e2.getErrorCode() + ",appKeyIndex=" + this.mtopConfig.appKeyIndex + ",authCode=" + this.mtopConfig.authCode, e2);
                                return str2;
                            }
                        }
                    }
                    ...
                    if (wua != null) {
                        if (!wua.isEmpty()) {
                            ...
                            try {
                                ...
                                e2 = e4;
                                str2 = remove;
                                TBSdkLog.e(TAG, getInstanceId() + " [getWua]get wua failed and SecException errorCode " + e2.getErrorCode() + ",appKeyIndex=" + this.mtopConfig.appKeyIndex + ",authCode=" + this.mtopConfig.authCode, e2);
                                return str2;
                            }
                        }
                    }
    ...
    public void init(@NonNull MtopConfig mtopConfig) {
        ...
        try {
            ...
            MtopSDKThreadPoolExecutorFactory.submit(new Runnable() {
                /* class mtopsdk.security.InnerSignImpl.AnonymousClass1 */
