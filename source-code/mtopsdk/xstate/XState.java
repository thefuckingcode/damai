    ...
    public static void init(Context context) {
        if (context == null) {
            ...
            if (asyncServiceBinder == null) {
                AnonymousClass1 r0 = new AsyncServiceBinder<IXState>(IXState.class, XStateService.class) {
                    /* class mtopsdk.xstate.XState.AnonymousClass1 */
                    ...
                    public void afterAsyncBind() {
                        ...
                        MtopSDKThreadPoolExecutorFactory.submit(new Runnable() {
                            /* class mtopsdk.xstate.XState.AnonymousClass1.AnonymousClass1 */
                ...
                asyncServiceBinder = r0;
                r0.asyncBind(context);
                return;
            }
            syncToRemote();
        }
