        ...
        if (this.uploadStats != null) {
            ...
            try {
                ...
                if (networkStats != null) {
                    ...
                    if (networkStats.isSSL) {
                        obj7 = obj2;
                    } else {
                        obj7 = "0";
                    }
                    hashMap.put("isSSL", obj7);
                ...
                if (Mtop.mIsFullTrackValid) {
                    ...
                    hashMap.put("appLaunchExternal", obj6);
                ...
                if (networkStats != null) {
                    ...
                    hashMap2.put(IFullTraceAnalysisV3.Stage.SERVE_RT, Double.valueOf((double) networkStats.serverRT));
                ...
                if (!ErrorConstant.isSuccess(this.retCode)) {
                    ...
                    hashMap3.put(obj, String.valueOf(this.isMain ? 1 : 0));
                ...
                hashMap4.put(if1.DIMEN_BIZ, !TextUtils.isEmpty(this.bizIdStr) ? this.bizIdStr : String.valueOf(this.bizId));
    ...
    private void registerMtopStats() {
        ...
        try {
            ...
            try {
                ...
                String str3 = "[registerMtopStats]register MtopStats executed.uploadStats=" + this.uploadStats;
                str = TAG;
                try {
