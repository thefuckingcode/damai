...
public class TLogImpl implements ILog {
    ...
    public TLogImpl() {
        ...
        this.releaseOpen = ((!EnvUtil.isAppDebug() && new File("/data/local/tmp/", ".release_open").exists()) || new File("/data/local/tmp/", ".all_windvane_log_open").exists()) ? true : z;
        TaoLog.setTagPre("");
    }
    ...
    public boolean isLogLevelEnabled(int i) {
        ...
        if (logLevel == null || (map = TaoLog.LogLevel) == null || map.get(logLevel) == null || TaoLog.LogLevel.get(logLevel).intValue() > i) {
            return false;
        }
        return true;
    }
