...
public class WVBluetooth extends WVApiPlugin {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        /* class android.taobao.windvane.jsbridge.api.WVBluetooth.AnonymousClass4 */
    ...
    public boolean execute(String str, String str2, WVCallBackContext wVCallBackContext) {
        if ("requestAuthorization".equals(str)) {
            ...
            return true;
        } else if (fw1.HOME_SCAN_PAGE.equals(str)) {
        ...
        if (bluetoothAdapter == null) {
            ...
            if (this.mLeScanCallback == null) {
                this.mLeScanCallback = new BluetoothAdapter.LeScanCallback() {
                    /* class android.taobao.windvane.jsbridge.api.WVBluetooth.AnonymousClass3 */
    ...
    public void requestAuthorization(String str, final WVCallBackContext wVCallBackContext) {
        try {
            PermissionProposer.buildPermissionTask(this.mContext, new String[]{"android.permission.BLUETOOTH", "android.permission.BLUETOOTH_ADMIN", "android.permission.ACCESS_FINE_LOCATION"}).setTaskOnPermissionGranted(new Runnable() {
                /* class android.taobao.windvane.jsbridge.api.WVBluetooth.AnonymousClass2 */
                ...
                /* class android.taobao.windvane.jsbridge.api.WVBluetooth.AnonymousClass1 */
