...
public class WVJsBridge implements Handler.Callback {
    ...
    private WVJsBridge() {
        ...
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(5, 5, 5, TimeUnit.SECONDS, new LinkedBlockingQueue());
    ...
    public boolean handleMessage(Message message) {
        ...
        switch (message.what) {
            case 0:
                ...
                WVApiPlugin wVApiPlugin = (WVApiPlugin) obj2;
                String str3 = wVCallMethodContext.methodName;
                if (!TextUtils.isEmpty(wVCallMethodContext.params)) {
                    str = wVCallMethodContext.params;
                }
                if (!wVApiPlugin.executeSafe(str3, str, wVCallBackContext)) {
                    if (TaoLog.getLogStatus()) {
                    ...
                    try {
                        ...
                        int i = 1;
                        String str4 = wVCallMethodContext.objectName + "." + wVCallMethodContext.methodName;
    ...
    private void callMethod(IWVWebView iWVWebView, String str, IJsApiSucceedCallBack iJsApiSucceedCallBack, IJsApiFailedCallBack iJsApiFailedCallBack) {
        ...
        if (enableGetParamByJs) {
            ...
            if (z) {
                iWVWebView.evaluateJavascript(String.format("javascript:window.WindVane&&window.WindVane.getParam(%s);", request.token), new ValueCallback<String>() {
                    /* class android.taobao.windvane.jsbridge.WVJsBridge.AnonymousClass1 */
                    ...
                    public void onReceiveValue(String str) {
                        ...
                        WVJsBridge.sExecutors.submit(new Runnable() {
                            /* class android.taobao.windvane.jsbridge.WVJsBridge.AnonymousClass1.AnonymousClass1 */
        ...
        sExecutors.submit(new Runnable() {
            /* class android.taobao.windvane.jsbridge.WVJsBridge.AnonymousClass2 */
