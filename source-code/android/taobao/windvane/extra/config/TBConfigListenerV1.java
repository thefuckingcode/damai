            ...
            try {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    if (!TextUtils.isEmpty(optString) || !TextUtils.isEmpty(optString2) || !TextUtils.isEmpty(optString3)) {
                        if (optString4 == null || "".equals(optString4) || jl1.MUL.equals(optString4)) {
                            optString4 = "0";
                        }
                        if (optString5 == null || "".equals(optString5) || jl1.MUL.equals(optString5)) {
                        ...
                        if (!TextUtils.isEmpty(appVersion)) {
                            ...
                            if ((compareVersion >= 0 && compareVersion2 > 0) || (compareVersion == compareVersion2 && compareVersion2 == 0)) {
                                ...
                                WVConfigManager instance = WVConfigManager.getInstance();
                                ...
                                instance.updateConfig("package", optString, null, wVConfigUpdateFromType);
