...
public class WVCookieConfig implements IConfig {
    ...
    public void init() {
        if (this.inited.compareAndSet(false, true)) {
            ...
            TaoLog.i(TAG, "get cookie config local = [" + stringVal + jl1.ARRAY_END_STR);
            parseConfig(stringVal);
            try {
                OrangeConfig.getInstance().registerListener(new String[]{WVConfigManager.CONFIGNAME_COOKIE}, new OrangeConfigListenerV1() {
                    /* class android.taobao.windvane.config.WVCookieConfig.AnonymousClass1 */
                    ...
                    public void onConfigUpdate(String str, boolean z) {
                        ...
                        TaoLog.i("WVConfig", "receive name=[" + str + "]; config=[" + jSONObject.toString() + jl1.ARRAY_END_STR);
                    }
                });
    ...
    public void setConfig(String str) {
        TaoLog.i(TAG, "receive cookie config = [" + str + jl1.ARRAY_END_STR);
        parseConfig(str);
