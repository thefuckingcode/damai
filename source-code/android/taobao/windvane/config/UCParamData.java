...
public class UCParamData {
    private static final String[] COMMON_CLIENT_APP_PACKAGE_NAMES = {th2.TMALLPACKAGENAME, AXPParamsProvider.ClientType.YOUKU, AXPParamsProvider.ClientType.YOUKU_HWBAIPAI, "cn.damai"};
    ...
    public String ucPageTimerCount = ERROR.MTOP_XFLUSH_SUCCESS_CODE;
    ...
    public void parse(String str) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                this.sdCopyPathCd = getSdCopyPathCd(jSONObject.optString("sdCopyPathCd", str2));
                this.hostUcmVersionsCd = jSONObject.optString("hostUcmVersionsCd", str2);
                if (needLoadNeedShareCoreApp()) {
                    str2 = "sc_lshco";
                }
                this.scLoadPolicyCd = jSONObject.optString("scLoadPolicyCd", str2);
