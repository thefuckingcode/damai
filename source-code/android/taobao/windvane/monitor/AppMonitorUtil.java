...
public class AppMonitorUtil {
    ...
    public static void commitPackageQueueInfo(String str, long j, long j2) {
        if (WVCommonConfig.commonConfig.monitorStatus != 0 && isAppMonitorEnabled) {
            try {
                ...
                create2.setValue(e03.POINT_SUCCESS_COUNT_MEASURE, (double) j2);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:31:0x0162  */
        ...
        if (WVCommonConfig.commonConfig.monitorStatus != 0 && isAppMonitorEnabled) {
            try {
                ...
                try {
                    ...
                    create.setValue(HiAnalyticsConstant.HaKey.BI_KEY_RESULT, String.valueOf(wVMonitorData.args.statusCode));
                    ...
                    try {
                        if (!TextUtils.isEmpty(wVMonitorData.performanceInfo)) {
                            ...
                            if (jSONObject != null) {
                                create2.setValue(c.a, (double) jSONObject.optInt(c.a, 0));
                            ...
                            if (TaoLog.getLogStatus() && wVMonitorData.stat != null) {
                    ...
                    AppMonitor.Stat.commit("WindVane", str32, create, create2);
    ...
    public static void commitWebPerfCheckInfo(String str, long j, String str2, String str3, String str4) {
        if (WVCommonConfig.commonConfig.monitorStatus != 0 && isAppMonitorEnabled) {
            try {
                ...
                MeasureValueSet create2 = MeasureValueSet.create();
                create2.setValue("score", (double) j);
    ...
    public static void commitZCacheDownLoadTime(String str, long j, long j2, long j3, String str2, boolean z) {
        if (WVCommonConfig.commonConfig.monitorStatus != 0 && isAppMonitorEnabled) {
            try {
                ...
                create.setValue(HiAnalyticsConstant.HaKey.BI_KEY_WAITTIME, (double) j);
    ...
    public static void init() {
        try {
            ...
            create2.addMeasure(createMeasuerWithRange(e03.POINT_SUCCESS_COUNT_MEASURE, 0.1d, 900.0d));
