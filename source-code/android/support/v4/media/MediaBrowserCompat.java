...
public final class MediaBrowserCompat {
        ...
        public void onReceiveResult(int i, Bundle bundle) {
            if (this.mCallback != null) {
                ...
                if (i == -1) {
                    ...
                    Log.w(MediaBrowserCompat.TAG, "Unknown result code: " + i + " (extras=" + this.mExtras + ", resultData=" + bundle + jl1.BRACKET_END_STR);
                } else {
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void connect() {
            ...
            throw new IllegalStateException("connect() called while neigther disconnecting nor disconnected (state=" + getStateLabel(this.mState) + jl1.BRACKET_END_STR);
        }
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException("getExtras() called while not connected (state=" + getStateLabel(this.mState) + jl1.BRACKET_END_STR);
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException("getRoot() called while not connected(state=" + getStateLabel(this.mState) + jl1.BRACKET_END_STR);
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException("getServiceComponent() called while not connected (state=" + this.mState + jl1.BRACKET_END_STR);
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException("getSessionToken() called while not connected(state=" + this.mState + jl1.BRACKET_END_STR);
        }
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (isConnected()) {
                ...
                throw new IllegalStateException("search() called while not connected (state=" + getStateLabel(this.mState) + jl1.BRACKET_END_STR);
            }
        }
