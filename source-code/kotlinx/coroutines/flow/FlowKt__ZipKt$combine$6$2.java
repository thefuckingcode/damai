...
public final class FlowKt__ZipKt$combine$6$2 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super ur2>, Object> {
    ...
    public final Object invoke(@NotNull FlowCollector<? super R> flowCollector, @NotNull T[] tArr, @Nullable Continuation<? super ur2> continuation) {
        ...
        return flowKt__ZipKt$combine$6$2.invokeSuspend(ur2.INSTANCE);
    }
