...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {AliMediaPlayer.UPLAYER_PROPERTY_TYPE_IS_WIFI}, m = "firstOrNull", n = {"result", "collector$iv"}, s = {"L$0", "L$1"})
