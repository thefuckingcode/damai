...
public final class ChannelsKt__Channels_commonKt$takeWhile$1 extends CoroutineImpl implements Function2<ProducerScope<? super E>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(ProducerScope<? super E> producerScope, Continuation<? super Unit> continuation) {
        ...
        ChannelsKt__Channels_commonKt$takeWhile$1 channelsKt__Channels_commonKt$takeWhile$1 = new ChannelsKt__Channels_commonKt$takeWhile$1(this.receiver$0, this.$predicate, continuation);
        channelsKt__Channels_commonKt$takeWhile$1.p$ = producerScope;
    ...
    public final Object invoke(ProducerScope<? super E> producerScope, Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(producerScope, "$receiver");
        Intrinsics.checkParameterIsNotNull(continuation, "continuation");
        return ((ChannelsKt__Channels_commonKt$takeWhile$1) create((ProducerScope) producerScope, continuation)).doResume(Unit.INSTANCE, null);
    }
        ...
        if (i != 0) {
            if (i == 1) {
                ...
                if (th == null) {
                    ...
                    channelsKt__Channels_commonKt$takeWhile$1.L$1 = obj;
                    channelsKt__Channels_commonKt$takeWhile$1.L$2 = channelIterator;
                    channelsKt__Channels_commonKt$takeWhile$1.label = 3;
                    invoke = function2.invoke(obj, channelsKt__Channels_commonKt$takeWhile$1);
                ...
                if (th == null) {
                    ...
                    if (!((Boolean) obj).booleanValue()) {
                        ...
                        if (producerScope.send(obj3, channelsKt__Channels_commonKt$takeWhile$1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        ...
                        if (!((Boolean) obj).booleanValue()) {
                            ...
                            obj = channelIterator.next(channelsKt__Channels_commonKt$takeWhile$1);
                            if (obj == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            Function2 function22 = channelsKt__Channels_commonKt$takeWhile$1.$predicate;
                            channelsKt__Channels_commonKt$takeWhile$1.L$0 = producerScope;
                            channelsKt__Channels_commonKt$takeWhile$1.L$1 = obj;
                            channelsKt__Channels_commonKt$takeWhile$1.L$2 = channelIterator;
                            channelsKt__Channels_commonKt$takeWhile$1.label = 3;
                            invoke = function22.invoke(obj, channelsKt__Channels_commonKt$takeWhile$1);
                            if (invoke != coroutine_suspended) {
                                return coroutine_suspended;
                            }
                            obj3 = obj;
