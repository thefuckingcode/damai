...
public final class ChannelsKt__Channels_commonKt$asReceiveChannel$2 extends CoroutineImpl implements Function2<ProducerScope<? super E>, Continuation<? super Unit>, Object> {
    Object L$0;
    Object L$1;
    Object L$2;
    ...
    ChannelsKt__Channels_commonKt$asReceiveChannel$2(Sequence sequence, Continuation continuation) {
    ...
    public final Continuation<Unit> create(ProducerScope<? super E> producerScope, Continuation<? super Unit> continuation) {
        ...
        ChannelsKt__Channels_commonKt$asReceiveChannel$2 channelsKt__Channels_commonKt$asReceiveChannel$2 = new ChannelsKt__Channels_commonKt$asReceiveChannel$2(this.receiver$0, continuation);
        channelsKt__Channels_commonKt$asReceiveChannel$2.p$ = producerScope;
    ...
    public final Object invoke(ProducerScope<? super E> producerScope, Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(producerScope, "$receiver");
        Intrinsics.checkParameterIsNotNull(continuation, "continuation");
        return ((ChannelsKt__Channels_commonKt$asReceiveChannel$2) create((ProducerScope) producerScope, continuation)).doResume(Unit.INSTANCE, null);
    }
