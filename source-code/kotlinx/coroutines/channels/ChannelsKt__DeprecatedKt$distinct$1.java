...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0004\n\u0002\b\u0003\u0010\u0002\u001a\u00028\u0000\"\u0004\b\u0000\u0010\u00002\u0006\u0010\u0001\u001a\u00028\u0000H@"}, d2 = {ExifInterface.LONGITUDE_EAST, AdvanceSetting.NETWORK_TYPE, "<anonymous>"}, k = 3, mv = {1, 5, 1})
...
final class ChannelsKt__DeprecatedKt$distinct$1 extends SuspendLambda implements Function2<E, Continuation<? super E>, Object> {
    ...
    public final Object invoke(E e, @Nullable Continuation<? super E> continuation) {
        return ((ChannelsKt__DeprecatedKt$distinct$1) create(e, continuation)).invokeSuspend(ur2.INSTANCE);
    }
