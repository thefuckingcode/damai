...
final class TickerChannelsKt$ticker$3 extends SuspendLambda implements Function2<ProducerScope<? super ur2>, Continuation<? super ur2>, Object> {
    ...
    public final Object invoke(@NotNull ProducerScope<? super ur2> producerScope, @Nullable Continuation<? super ur2> continuation) {
        return ((TickerChannelsKt$ticker$3) create(producerScope, continuation)).invokeSuspend(ur2.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            if (i2 == 1) {
                ...
                this.label = 1;
                if (TickerChannelsKt.b(j, j2, channel, this) == obj2) {
                    return obj2;
                }
            } else if (i2 == 2) {
                ...
                this.label = 2;
                if (TickerChannelsKt.c(j3, j4, channel2, this) == obj2) {
                    return obj2;
                }
            }
        } else if (i == 1 || i == 2) {
