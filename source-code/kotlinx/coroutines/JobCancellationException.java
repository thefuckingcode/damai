    ...
    public boolean equals(@Nullable Object obj) {
        if (obj != this) {
            if (obj instanceof JobCancellationException) {
                ...
                if (!k21.d(jobCancellationException.getMessage(), getMessage()) || !k21.d(jobCancellationException.job, this.job) || !k21.d(jobCancellationException.getCause(), getCause())) {
                    return false;
                }
            }
            return false;
