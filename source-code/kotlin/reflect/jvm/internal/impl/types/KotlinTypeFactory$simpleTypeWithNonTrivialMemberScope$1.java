...
public final class KotlinTypeFactory$simpleTypeWithNonTrivialMemberScope$1 extends Lambda implements Function1<i61, ib2> {
    ...
    public final ib2 invoke(@NotNull i61 i61) {
        ...
        k21.f(b);
        return KotlinTypeFactory.j(annotations, b, this.$arguments, this.$nullable, this.$memberScope);
    }
}
