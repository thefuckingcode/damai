...
/* synthetic */ class LazyJavaClassMemberScope$computeNonDeclaredFunctions$4 extends FunctionReference implements Function1<og1, Collection<? extends SimpleFunctionDescriptor>> {
    ...
    public final Collection<SimpleFunctionDescriptor> invoke(@NotNull og1 og1) {
        k21.i(og1, "p0");
        return ((LazyJavaClassMemberScope) this.receiver).B0(og1);
    }
}
