...
final class PredefinedEnhancementInfoKt$PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE$1$1$5$7 extends Lambda implements Function1<a.C0273a.C0274a, ur2> {
    ...
    public final void invoke(@NotNull a.C0273a.C0274a aVar) {
        ...
        aVar.c(this.$JFFunction, PredefinedEnhancementInfoKt.b, PredefinedEnhancementInfoKt.b, PredefinedEnhancementInfoKt.b);
        aVar.d(this.$JLObject, PredefinedEnhancementInfoKt.b);
    }
}
