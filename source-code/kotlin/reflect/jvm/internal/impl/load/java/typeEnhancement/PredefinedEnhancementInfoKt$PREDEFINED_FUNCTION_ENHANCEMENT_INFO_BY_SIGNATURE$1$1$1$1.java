...
final class PredefinedEnhancementInfoKt$PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE$1$1$1$1 extends Lambda implements Function1<a.C0273a.C0274a, ur2> {
    ...
    public final void invoke(@NotNull a.C0273a.C0274a aVar) {
        k21.i(aVar, "<this>");
        aVar.c(this.$JFConsumer, PredefinedEnhancementInfoKt.b(), PredefinedEnhancementInfoKt.b());
    }
}
