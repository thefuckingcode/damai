...
public final class JavaTargetAnnotationDescriptor extends JavaAnnotationDescriptor {
    ...
    public JavaTargetAnnotationDescriptor(@NotNull JavaAnnotation javaAnnotation, @NotNull x61 x61) {
        super(x61, javaAnnotation, c.a.target);
        k21.i(javaAnnotation, "annotation");
        k21.i(x61, com.huawei.hms.opendevice.c.a);
        this.g = x61.e().createLazyValue(new JavaTargetAnnotationDescriptor$allValueArguments$2(this));
    }
