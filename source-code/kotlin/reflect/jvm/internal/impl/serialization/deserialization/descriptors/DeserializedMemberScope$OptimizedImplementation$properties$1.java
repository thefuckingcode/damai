...
public final class DeserializedMemberScope$OptimizedImplementation$properties$1 extends Lambda implements Function1<og1, Collection<? extends PropertyDescriptor>> {
    ...
    @NotNull
    public final Collection<PropertyDescriptor> invoke(@NotNull og1 og1) {
        k21.i(og1, AdvanceSetting.NETWORK_TYPE);
        return this.this$0.g(og1);
    }
}
