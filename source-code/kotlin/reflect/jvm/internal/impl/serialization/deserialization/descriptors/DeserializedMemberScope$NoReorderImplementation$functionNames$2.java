...
public final class DeserializedMemberScope$NoReorderImplementation$functionNames$2 extends Lambda implements Function0<Set<? extends og1>> {
    ...
    public final Set<? extends og1> invoke() {
        ...
        List<MessageLite> list = noReorderImplementation.a;
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        DeserializedMemberScope deserializedMemberScope = noReorderImplementation.n;
        for (MessageLite messageLite : list) {
            linkedHashSet.add(qg1.b(deserializedMemberScope.a.g(), ((ProtoBuf$Function) messageLite).getName()));
        }
        return f0.i(linkedHashSet, this.this$1.n());
    }
}
