...
public interface Caller<M extends Member> {
    ...
    public static final class a {
        public static <M extends Member> void a(@NotNull Caller<? extends M> caller, @NotNull Object[] objArr) {
            k21.i(objArr, "args");
            if (gf.a(caller) != objArr.length) {
                throw new IllegalArgumentException("Callable expects " + gf.a(caller) + " arguments, but " + objArr.length + " were provided.");
            }
        }
    }
