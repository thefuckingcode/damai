...
public class AdaptedFunctionReference implements Serializable, FunctionBase {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.isTopLevel != adaptedFunctionReference.isTopLevel || this.arity != adaptedFunctionReference.arity || this.flags != adaptedFunctionReference.flags || !k21.d(this.receiver, adaptedFunctionReference.receiver) || !k21.d(this.owner, adaptedFunctionReference.owner) || !this.name.equals(adaptedFunctionReference.name) || !this.signature.equals(adaptedFunctionReference.signature)) {
            return false;
        }
        return true;
    }
