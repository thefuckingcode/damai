...
final class SlidingWindowKt$windowedIterator$1 extends RestrictedSuspendLambda implements Function2<s82<? super List<Object>>, Continuation<? super ur2>, Object> {
    ...
    @Nullable
    public final Object invoke(@NotNull s82<? super List<Object>> s82, @Nullable Continuation<? super ur2> continuation) {
        return ((SlidingWindowKt$windowedIterator$1) create(s82, continuation)).invokeSuspend(ur2.INSTANCE);
    }
