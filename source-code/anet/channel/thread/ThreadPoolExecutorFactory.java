...
public class ThreadPoolExecutorFactory {
    ...
    static {
        ...
        b = new ThreadPoolExecutor(2, 2, 60, timeUnit, new LinkedBlockingDeque(), new a("AWCN Worker(H)"));
        c = new PriorityExecutor(16, 16, 60, timeUnit, new PriorityBlockingQueue(), new a("AWCN Worker(M)"));
        d = new ThreadPoolExecutor(2, 2, 60, timeUnit, new LinkedBlockingDeque(), new a("AWCN Worker(L)"));
        e = new ThreadPoolExecutor(32, 32, 60, timeUnit, new LinkedBlockingDeque(), new a("AWCN Worker(Backup)"));
        f = new ThreadPoolExecutor(1, 1, 30, timeUnit, new LinkedBlockingDeque(), new a("AWCN Detector"));
        g = new ThreadPoolExecutor(1, 1, 30, timeUnit, new LinkedBlockingDeque(), new a("AWCN HR"));
        h = new ThreadPoolExecutor(1, 1, 30, timeUnit, new LinkedBlockingDeque(), new a("AWCN Cookie"));
        i = new ThreadPoolExecutor(1, 1, 30, timeUnit, new LinkedBlockingDeque(), new a("AWCN Monitor"));
        j = new ThreadPoolExecutor(1, 1, 60, timeUnit, new LinkedBlockingDeque(), new a("AWCN Callback"));
