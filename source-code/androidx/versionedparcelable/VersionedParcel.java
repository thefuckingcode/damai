...
public abstract class VersionedParcel {
    ...
    private Method getReadMethod(String str) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        Method declaredMethod = Class.forName(str, true, VersionedParcel.class.getClassLoader()).getDeclaredMethod(lf1.OPERATION_READ, VersionedParcel.class);
    ...
    private Method getWriteMethod(Class cls) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        System.currentTimeMillis();
        Method declaredMethod = findParcelClass.getDeclaredMethod(lf1.OPERATION_WRITE, cls, VersionedParcel.class);
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException reading a Serializable object (name = " + readString + jl1.BRACKET_END_STR, e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = " + readString + jl1.BRACKET_END_STR, e2);
        }
    }
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException writing serializable object (name = " + name + jl1.BRACKET_END_STR, e);
        }
    }
