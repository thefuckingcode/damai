...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public void draw(Canvas canvas) {
        ...
        if (com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.width(this.mTmpBounds) > 0 && com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(this.mTmpBounds) > 0) {
            ...
            int min = Math.min(2048, (int) (((float) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.width(this.mTmpBounds)) * abs));
            int min2 = Math.min(2048, (int) (((float) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(this.mTmpBounds)) * abs2));
            if (min > 0 && min2 > 0) {
                int save = canvas.save();
                Rect rect = this.mTmpBounds;
                canvas.translate((float) rect.left, (float) rect.top);
                if (needMirroring()) {
                    canvas.translate((float) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.width(this.mTmpBounds), 0.0f);
