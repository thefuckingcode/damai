...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame2.visibility == 8) {
            i11 = (int) (((float) i11) - (((float) i17) / 2.0f));
            i12 = (int) (((float) i12) - (((float) i18) / 2.0f));
            if (Float.isNaN(f7)) {
                i3 = i18;
                i4 = i17;
                f2 = 0.0f;
        ...
        if (widgetFrame3.visibility == 8) {
            i13 = (int) (((float) i13) - (((float) i4) / 2.0f));
            i14 = (int) (((float) i14) - (((float) i3) / 2.0f));
            i17 = i4;
            i18 = i3;
            if (Float.isNaN(f8)) {
                f8 = 0.0f;
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (findPreviousPosition != null) {
                ...
                i7 = i2;
                i12 = (int) (findPreviousPosition.y * ((float) i7));
            ...
            if (findNextPosition != null) {
                int i19 = (int) (findNextPosition.x * ((float) i8));
                int i20 = (int) (findNextPosition.y * ((float) i7));
            ...
            f5 = (f6 - ((float) i6)) / ((float) (i9 - i6));
        }
        widgetFrame.widget = widgetFrame2.widget;
        int i21 = (int) (((float) i5) + (((float) (i13 - i5)) * f5));
        widgetFrame.left = i21;
        int i22 = (int) (((float) i12) + (f5 * ((float) (i14 - i12))));
        widgetFrame.top = i22;
        float f10 = 1.0f - f;
        widgetFrame.right = i21 + ((int) ((((float) i4) * f10) + (((float) i17) * f)));
        widgetFrame.bottom = i22 + ((int) ((f10 * ((float) i3)) + (((float) i18) * f)));
