    ...
    public void addCycleValues(HashMap<String, KeyCycleOscillator> hashMap) {
        ...
        for (String str : hashMap.keySet()) {
            if (str.startsWith("CUSTOM")) {
                ...
                if (!(customVariable == null || customVariable.getType() != 901 || (keyCycleOscillator2 = hashMap.get(str)) == null)) {
                ...
                if (!Float.isNaN(value) && (keyCycleOscillator = hashMap.get(str)) != null) {
