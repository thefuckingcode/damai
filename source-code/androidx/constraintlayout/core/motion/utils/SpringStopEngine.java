...
public class SpringStopEngine implements StopEngine {
    ...
    private void compute(double d) {
        ...
        while (i < sqrt) {
            ...
            float f2 = this.mV;
            float f3 = this.mMass;
            double d6 = ((double) f2) + ((((((-d2) * (((double) f) - d5)) - (((double) f2) * d3)) / ((double) f3)) * d4) / 2.0d);
            double d7 = ((((-((((double) f) + ((d4 * d6) / 2.0d)) - d5)) * d2) - (d6 * d3)) / ((double) f3)) * d4;
            float f4 = (float) (((double) f2) + d7);
            this.mV = f4;
            float f5 = (float) (((double) f) + ((((double) f2) + (d7 / 2.0d)) * d4));
            this.mPos = f5;
