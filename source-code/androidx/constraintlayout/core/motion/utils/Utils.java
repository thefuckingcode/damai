...
public class Utils {
    ...
    public static void log(String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + jl1.BRACKET_END_STR + "    ".substring(Integer.toString(stackTraceElement.getLineNumber()).length()) + substring;
