...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.setTextSize((float) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(rect));
            ...
            canvas.drawText("?", ((((float) width) / 2.0f) - (((float) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.width(rect)) / 2.0f)) - ((float) rect.left), ((((float) height) / 2.0f) + (((float) com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(rect)) / 2.0f)) - ((float) rect.bottom), paint);
        }
    }
