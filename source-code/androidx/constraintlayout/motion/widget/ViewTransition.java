...
public class ViewTransition {
    ...
    private /* synthetic */ void lambda$applyTransition$0(View[] viewArr) {
        if (this.mSetsTag != -1) {
    ...
    public void applyTransition(ViewTransitionController viewTransitionController, MotionLayout motionLayout, int i, ConstraintSet constraintSet, View... viewArr) {
        if (!this.mDisabled) {
            ...
            motionLayout.transitionToEnd(new iw2(this, viewArr));
        }
    }
    ...
    public Interpolator getInterpolator(Context context) {
        ...
        if (i == -1) {
            ...
            return new Interpolator() {
                /* class androidx.constraintlayout.motion.widget.ViewTransition.AnonymousClass1 */
    ...
    public String toString() {
        return "ViewTransition(" + Debug.getName(this.mContext, this.mId) + jl1.BRACKET_END_STR;
    }
}
