    ...
    public void addCycleValues(HashMap<String, ViewOscillator> hashMap) {
        ...
        for (String str : hashMap.keySet()) {
            if (str.startsWith("CUSTOM")) {
                ...
                if (!(constraintAttribute == null || constraintAttribute.getType() != ConstraintAttribute.AttributeType.FLOAT_TYPE || (viewOscillator2 = hashMap.get(str)) == null)) {
                ...
                if (!Float.isNaN(value) && (viewOscillator = hashMap.get(str)) != null) {
