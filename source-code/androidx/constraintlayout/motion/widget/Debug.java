...
public class Debug {
    ...
    public static void dumpPoc(Object obj) {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str = ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + jl1.BRACKET_END_STR;
    ...
    public static String getCallFrom(int i) {
        ...
        return ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + jl1.BRACKET_END_STR;
    }
    ...
    public static String getName(Context context, int[] iArr) {
        String str;
        try {
            String str2 = iArr.length + jl1.ARRAY_START_STR;
            int i = 0;
            while (i < iArr.length) {
