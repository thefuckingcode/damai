...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    public void CGEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 125, i, i2, 0, 0, 0, i4, i5, i3, float2.x, float2.y, j3, j2, float22.x, float22.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CGERC(Float2 float2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 99, 0, 0, 0, 0, 0, y, x, 0, float2.x, float2.y, id2, id3, 0.0f, 0.0f, id, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void CGERU(Float2 float2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 98, 0, 0, 0, 0, 0, y, x, 0, float2.x, float2.y, id2, id3, 0.0f, 0.0f, id, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void CHEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 137, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, float2.x, float2.y, j3, j2, float22.x, float22.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHER2(int i, Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 102, 0, 0, 0, i, 0, 0, validateSYR2, 0, float2.x, float2.y, id2, id3, 0.0f, 0.0f, id, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CHER2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, float f, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 139, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, float2.x, float2.y, allocation.getID(this.mRS), j2, f, 0.0f, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHERK(int i, int i2, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 138, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, f, 0.0f, j2, 0, f2, 0.0f, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CHPR2(int i, Float2 float2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 103, 0, 0, 0, i, 0, 0, validateSPR2, 0, float2.x, float2.y, id2, id3, 0.0f, 0.0f, id, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void CSYR2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 128, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, float2.x, float2.y, j3, j2, float22.x, float22.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CSYRK(int i, int i2, Float2 float2, Allocation allocation, Float2 float22, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 127, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, float2.x, float2.y, id, 0, float22.x, float22.y, allocation2.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRMM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 129, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, float2.x, float2.y, id, id2, 0.0f, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void CTRSM(int i, int i2, int i3, int i4, Float2 float2, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 130, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, float2.x, float2.y, id, id2, 0.0f, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DGEMM(int i, int i2, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 119, i, i2, 0, 0, 0, i4, i5, i3, d, j3, j2, d2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DGER(double d, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 90, 0, 0, 0, 0, 0, y, x, 0, d, id2, id3, 0.0d, id, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void DSPR2(int i, double d, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 94, 0, 0, 0, i, 0, 0, validateSPR2, 0, d, id2, id3, 0.0d, id, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void DSYR2(int i, double d, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 93, 0, 0, 0, i, 0, 0, validateSYR2, 0, d, id2, id3, 0.0d, id, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void DSYR2K(int i, int i2, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 122, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, d, j3, j2, d2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DSYRK(int i, int i2, double d, Allocation allocation, double d2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 121, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, d, id, 0, d2, id2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRMM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 123, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, id2, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void DTRSM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 124, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, id2, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void SGEMM(int i, int i2, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 113, i, i2, 0, 0, 0, i4, i5, i3, f, j3, j2, f2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void SGER(float f, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 82, 0, 0, 0, 0, 0, y, x, 0, f, id2, id3, 0.0f, id, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void SSPR2(int i, float f, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 86, 0, 0, 0, i, 0, 0, validateSPR2, 0, f, id2, id3, 0.0f, id, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void SSYR2(int i, float f, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 85, 0, 0, 0, i, 0, 0, validateSYR2, 0, f, id2, id3, 0.0f, id, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void SSYR2K(int i, int i2, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 116, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, f, j3, j2, f2, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void SSYRK(int i, int i2, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 115, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, f, id, 0, f2, id2, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRMM(int i, int i2, int i3, int i4, float f, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 117, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, f, id, id2, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void STRSM(int i, int i2, int i3, int i4, float f, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 118, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, f, id, id2, 0.0f, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 131, i, i2, 0, 0, 0, i4, i5, i3, double2.x, double2.y, j3, j2, double22.x, double22.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZGERC(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 108, 0, 0, 0, 0, 0, y, x, 0, double2.x, double2.y, id2, id3, 0.0d, 0.0d, id, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZGERU(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 107, 0, 0, 0, 0, 0, y, x, 0, double2.x, double2.y, id2, id3, 0.0d, 0.0d, id, i, i2, 0, 0, isIncSupp);
    }
    ...
    public void ZHEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 140, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double2.x, double2.y, j3, j2, double22.x, double22.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 111, 0, 0, 0, i, 0, 0, validateSYR2, 0, double2.x, double2.y, id2, id3, 0.0d, 0.0d, id, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZHER2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, double d, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 142, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, double2.x, double2.y, allocation.getID(this.mRS), j2, d, 0.0d, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHERK(int i, int i2, double d, Allocation allocation, double d2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 141, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, d, 0.0d, j2, 0, d2, 0.0d, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZHPR2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 112, 0, 0, 0, i, 0, 0, validateSPR2, 0, double2.x, double2.y, id2, id3, 0.0d, 0.0d, id, i2, i3, 0, 0, isIncSupp);
    }
    ...
    public void ZSYR2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 134, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, double2.x, double2.y, j3, j2, double22.x, double22.y, j, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZSYRK(int i, int i2, Double2 double2, Allocation allocation, Double2 double22, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 133, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, double2.x, double2.y, id, 0, double22.x, double22.y, allocation2.getID(this.mRS), 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRMM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 135, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, double2.x, double2.y, id, id2, 0.0d, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
    ...
    public void ZTRSM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 136, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, double2.x, double2.y, id, id2, 0.0d, 0.0d, 0, 0, 0, 0, 0, isIncSupp);
    }
