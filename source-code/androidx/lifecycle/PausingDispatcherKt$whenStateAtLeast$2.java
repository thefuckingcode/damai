...
public final class PausingDispatcherKt$whenStateAtLeast$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Object obj) {
        return ((PausingDispatcherKt$whenStateAtLeast$2) create(coroutineScope, (Continuation) obj)).invokeSuspend(ur2.INSTANCE);
    }
        ...
        if (i == 0) {
            ...
            if (job != null) {
                ...
                try {
                    ...
                    this.label = 1;
                    obj = d.e(pausingDispatcher, function2, this);
                    if (obj == obj2) {
                        return obj2;
                    }
