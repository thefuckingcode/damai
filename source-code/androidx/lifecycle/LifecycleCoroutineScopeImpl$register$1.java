...
final class LifecycleCoroutineScopeImpl$register$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ur2>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ur2> continuation) {
        return ((LifecycleCoroutineScopeImpl$register$1) create(coroutineScope, continuation)).invokeSuspend(ur2.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (this.this$0.getLifecycle$lifecycle_runtime_ktx_release().getCurrentState().compareTo((Enum) Lifecycle.State.INITIALIZED) >= 0) {
                ...
                k41.d(coroutineScope.getCoroutineContext(), null, 1, null);
            }
            return ur2.INSTANCE;
        }
