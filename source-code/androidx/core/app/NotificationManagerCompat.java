...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public String toString() {
            return "NotifyTask[" + "packageName:" + this.packageName + ", id:" + this.id + ", tag:" + this.tag + jl1.ARRAY_END_STR;
        }
    }
    ...
    public static class CancelTask implements Task {
        ...
        @NonNull
        public String toString() {
            return "CancelTask[" + "packageName:" + this.packageName + ", id:" + this.id + ", tag:" + this.tag + ", all:" + this.all + jl1.ARRAY_END_STR;
        }
