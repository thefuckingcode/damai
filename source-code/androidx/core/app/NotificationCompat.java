...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (charSequence5 != null) {
                ...
                if (charSequence != null && i3 >= 16) {
                    ...
                    if (charSequence2 == null) {
                        ...
                        if (this.mBuilder.getWhenIfShowing() != 0) {
                            ...
                            int i9 = R.id.chronometer;
                            remoteViews.setViewVisibility(i9, 0);
                            remoteViews.setLong(i9, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            remoteViews.setBoolean(i9, "setStarted", true);
                            boolean z10 = this.mBuilder.mChronometerCountDown;
                            if (z10 && i3 >= 24) {
                                remoteViews.setChronometerCountDown(i9, z10);
                            }
                        }
                ...
                remoteViews.setViewVisibility(i102, i2);
                return remoteViews;
            }
            z5 = true;
            z4 = true;
    ...
    public static class MessagingStyle extends Style {
        ...
        private CharSequence makeMessageLine(@NonNull Message message) {
            ...
            spannableStringBuilder.append((CharSequence) AltriaXLaunchTime.SPACE).append(instance.unicodeWrap(charSequence));
