...
public final class SparseArrayKt {
    ...
    @NotNull
    public static final <T> r11 keyIterator(@NotNull SparseArrayCompat<T> sparseArrayCompat) {
        k21.j(sparseArrayCompat, "receiver$0");
    ...
    public static final <T> SparseArrayCompat<T> plus(@NotNull SparseArrayCompat<T> sparseArrayCompat, @NotNull SparseArrayCompat<T> sparseArrayCompat2) {
        k21.j(sparseArrayCompat, "receiver$0");
        k21.j(sparseArrayCompat2, "other");
