...
public final class Challenge {
    ...
    public Challenge(String str, String str2) {
        this(str, r3);
        Intrinsics.checkParameterIsNotNull(str, "scheme");
        Intrinsics.checkParameterIsNotNull(str2, "realm");
    ...
    public final Charset m1035deprecated_charset() {
        return charset();
    }
