...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1039deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1041deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean m1040deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
    ...
    public String toString() {
        ...
        return "ConnectionSpec(" + "cipherSuites=" + C$r8$backportedMethods$utility$Objects$2$toStringDefault.toString(cipherSuites(), "[all enabled]") + ", " + "tlsVersions=" + C$r8$backportedMethods$utility$Objects$2$toStringDefault.toString(tlsVersions(), "[all enabled]") + ", " + "supportsTlsExtensions=" + this.supportsTlsExtensions + ')';
    }
