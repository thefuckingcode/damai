...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (StringsKt.equals(HttpHeaders.HEAD_VALUE_CONNECTION_CLOSE, response.request().header(HttpHeaders.HEAD_KEY_CONNECTION), true) || StringsKt.equals(HttpHeaders.HEAD_VALUE_CONNECTION_CLOSE, Response.header$default(response, HttpHeaders.HEAD_KEY_CONNECTION, null, 2, null), true)) {
            exchange$okhttp.noNewExchangesOnConnection();
        }
