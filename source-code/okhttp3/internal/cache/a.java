...
public final class a implements Interceptor {
    ...
    public class C0293a implements Source {
        ...
        C0293a(a aVar, BufferedSource bufferedSource, CacheRequest cacheRequest, BufferedSink bufferedSink) {
    ...
    private q a(CacheRequest cacheRequest, q qVar) throws IOException {
        ...
        return qVar.m().b(new hx1(qVar.g("Content-Type"), qVar.a().f(), h.d(new C0293a(this, qVar.a().j(), cacheRequest, h.c(body))))).c();
    }
    ...
    public q intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (oVar == null && qVar2 == null) {
            return new q.a().q(chain.request()).o(Protocol.HTTP_1_1).g(504).l("Unsatisfiable Request (only-if-cached)").b(okhttp3.internal.a.EMPTY_RESPONSE).r(-1).p(System.currentTimeMillis()).c();
        }
        if (oVar == null) {
