...
public class AltriaXRealTime implements ICLRealTime, IELHomeRealTime, IELRealTime {
    ...
    private void dispatchReport() {
        AltriaXExecutor.ALTRIAX_EXECUTOR.execute(new Runnable() {
            /* class me.ele.altriax.launcher.real.time.data.AltriaXRealTime.AnonymousClass2 */
            ...
            public void run() {
                ...
                if (Discriminator.isExternalLinkH5) {
                    ...
                    ExternalLinkH5Monitor instance = ExternalLinkH5Monitor.getInstance();
                    instance.setGson(AltriaXRealTime.this.gson);
                    instance.addData(PolymerizationMonitor.DIMENSION_LAUNCH_STYLE, PolymerizationMonitor.LINK_H5);
                    instance.report();
                    if (AltriaXRealTime.this.procedure != null) {
                        AltriaXRealTime.this.procedure.addBiz(BaseMonitor.BIZ_ID, instance.getDataMap());
                    }
                    PolymerizationMonitor.getInstance().report(PolymerizationMonitor.LINK_H5);
                } else if (Discriminator.isExternalLinkHome) {
                    AltriaXRealTime.this.setExternalLinkUrl(Discriminator.externalLinkUrl);
                    ExternalLinkHomeMonitor instance2 = ExternalLinkHomeMonitor.getInstance();
                    instance2.setGson(AltriaXRealTime.this.gson);
                    instance2.addData(PolymerizationMonitor.DIMENSION_LAUNCH_STYLE, PolymerizationMonitor.LINK_HOME);
                    instance2.report();
                    if (AltriaXRealTime.this.procedure != null) {
                        AltriaXRealTime.this.procedure.addBiz(BaseMonitor.BIZ_ID, instance2.getDataMap());
                    }
                    PolymerizationMonitor.getInstance().report(PolymerizationMonitor.LINK_HOME);
                } else {
                    ColdLaunchMonitor instance3 = ColdLaunchMonitor.getInstance();
                    instance3.setGson(AltriaXRealTime.this.gson);
                    instance3.addData(PolymerizationMonitor.DIMENSION_LAUNCH_STYLE, PolymerizationMonitor.COLD);
                    instance3.report();
                    if (AltriaXRealTime.this.procedure != null) {
                        AltriaXRealTime.this.procedure.addBiz(BaseMonitor.BIZ_ID, instance3.getDataMap());
                    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setApmData(@Nullable IProcedure iProcedure) {
        if (iProcedure != null) {
    ...
    public void setApmEvents(@Nullable List<te0> list) {
    ...
    @Override // me.ele.altriax.launcher.real.time.data.core.IUniversalRealTime
    public void setApmStages(@Nullable List<td2> list) {
    ...
    @Override // me.ele.altriax.launcher.real.time.data.core.IELRealTime, me.ele.altriax.launcher.real.time.data.core.IUniversalRealTime
    ...
    public void setRenderComplete(long j, long j2) {
        ...
        if (handler != null) {
            handler.postDelayed(new Runnable() {
                /* class me.ele.altriax.launcher.real.time.data.AltriaXRealTime.AnonymousClass1 */
