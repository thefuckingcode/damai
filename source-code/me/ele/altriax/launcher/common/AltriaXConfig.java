...
public class AltriaXConfig {
    ...
    private static void registerAltriaXListenerInternal(@Nullable final List<String> list) {
        if (list != null && list.size() != 0) {
            ...
            OrangeConfig.getInstance().registerListener(new String[]{NAMESPACE}, new OConfigListener() {
                /* class me.ele.altriax.launcher.common.AltriaXConfig.AnonymousClass1 */

                @Override // com.taobao.orange.OConfigListener
                public void onConfigUpdate(String str, Map<String, String> map) {
                    AltriaXExecutor.ALTRIAX_EXECUTOR.execute(new Runnable() {
                        /* class me.ele.altriax.launcher.common.AltriaXConfig.AnonymousClass1.AnonymousClass1 */
                        ...
                        public void run() {
                            ...
                            for (String str : list) {
                                if (!TextUtils.isEmpty(str)) {
                                    ...
                                    AltriaXConfig.saveOrangeValue(str, str2);
                                    AltriaXLog.v(AltriaXLog.ALTRIAX, AltriaXLog.formatLog(AltriaXLog.ALTRIAX, "orange " + str, null, str2));
                                }
                            }
                        }
                    });
