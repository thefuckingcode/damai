...
public class AppDelegate implements AppDelegateInner, ActivityCreatedStrategy.ActivityCreatedListener, FirstActivityStrategy.FirstActivityCreatedListener {
    ...
    public void bindApp(Application application, Options options2) {
        this.options = options2;
        LauncherRuntime.init(application, options2.packageName, options2.processName, options2.startTime);
        ...
        LaunchScheduler create2 = LaunchScheduler.create(options2.processName, build);
        this.scheduler = create2;
        LauncherRuntime.sReceiver = create2.asReceiver();
        LauncherRuntime.sConfiguration = build;
        OnLineMonitorRegister onLineMonitorRegister2 = new OnLineMonitorRegister();
        this.onLineMonitorRegister = onLineMonitorRegister2;
        onLineMonitorRegister2.mOnBootFinishedListener = new OnLineMonitorRegister.OnBootFinishedListener() {
            /* class me.ele.altriax.launcher.bootstrap.ele.AppDelegate.AnonymousClass1 */
