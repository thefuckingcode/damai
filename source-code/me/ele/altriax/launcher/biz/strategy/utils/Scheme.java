...
public class Scheme {
    ...
    private static void schemeLog(@NonNull final String str, @Nullable final String str2, @Nullable final String str3) {
        AltriaXExecutor.ALTRIAX_EXECUTOR.execute(new Runnable() {
            /* class me.ele.altriax.launcher.biz.strategy.utils.Scheme.AnonymousClass1 */
            ...
            public void run() {
                ...
                AltriaXLog.v(AltriaXLog.ALTRIAX, AltriaXLog.formatLog(AltriaXLog.ALTRIAX, str2, null, str));
            }
        });
    }
